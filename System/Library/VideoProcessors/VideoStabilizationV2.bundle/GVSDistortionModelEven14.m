...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___GVSDistortionModelEven14;
  v2 = -[GVSDistortionModelEven14 init](&v5, "init");
  v3 = v2;
  if (v2) {
    -[GVSDistortionModelEven14 reset](v2, "reset");
  }
  return v3;
}
...
- (void)reset
{
  ...
  *(void *)self->_distortionCenter = 0LL;
...
- (void)updateWithCoefficients:(float *)a3 pixelSizeMm:(float)a4 center:
{
  ...
  {
    -[GVSDistortionModelEven14 reset](self, "reset");
  }
