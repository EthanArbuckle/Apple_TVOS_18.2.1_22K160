...
{
  retstr->var0 = 0;
  *(_OWORD *)&retstr->var1 = xmmword_37430;
  retstr->var5 = 0.65;
  return result;
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___GVSMotionBlurFilter;
  v4 = -[GVSMotionBlurFilter init](&v7, "init");
  v5 = v4;
  if (v4)
  {
    v4->_scale = a3->var4;
    ...
    v4->_isSuspended = 0;
    -[GVSMotionBlurFilter reset](v4, "reset");
  }
...
- (void)reset
{
  ...
  *(void *)self->_filteredBlurVector = 0LL;
...
- (id)updateBlurVector:(double)a3 atTime:
{
  ...
  if (!*(_BYTE *)(a1 + 56))
  {
    ...
    if (vaddv_f32(_D1) > 0.0000001)
    {
      ...
      {
        float32x2_t v14 = vmaxnm_f32( (float32x2_t)vdup_lane_s32( (int32x2_t)vdiv_f32( vadd_f32(v13, (float32x2_t)vdup_lane_s32((int32x2_t)v13, 1)),  vadd_f32(_D1, (float32x2_t)vdup_lane_s32((int32x2_t)_D1, 1))),  0),  0LL);
