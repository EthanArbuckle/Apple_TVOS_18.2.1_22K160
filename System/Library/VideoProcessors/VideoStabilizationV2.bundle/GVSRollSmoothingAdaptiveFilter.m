...
- (GVSRollSmoothingAdaptiveFilter)initWithMaxTimescale:(float)a3 minTimescale:(float)a4 transitionTime:(float)a5 analyzer:(id)a6 rampingSettings:(GVSRollSmoothingAdaptiveFilterRampingSettings *)a7
{
  id v13 = a6;
  v19.receiver = self;
  v19.super_class = (Class)&OBJC_CLASS___GVSRollSmoothingAdaptiveFilter;
  v14 = -[GVSRollSmoothingAdaptiveFilter init](&v19, "init");
  if (!v14)
  {
LABEL_8:
    v17 = v14;
  ...
  v15 = objc_alloc_init(&OBJC_CLASS___GVSIIR2FilterFloat);
  filter = v14->_filter;
  v14->_filter = v15;
  ...
  if (a4 > 0.0 && v14->_analyzer)
  {
    ...
    -[GVSRollSmoothingAdaptiveFilter reset](v14, "reset");
    goto LABEL_8;
  }
...
- (void)updateRoll:(float)prevRoll pitch:(float)a4 atTime:(double)a5
{
  ...
  if (a4 < 1.0472 && (double prevTime = self->_prevTime, prevTime <= a5))
  {
    ...
    if (vabds_f32(v6, prevRoll) > 3.14159265)
    {
      ...
      *(float *)&double v13 = v11 - prevRoll;
      -[GVSIIR2FilterFloat applyOffset:](self->_filter, "applyOffset:", v13);
      -[GVSIIR2FilterFloat filteredValue](self->_filter, "filteredValue");
    ...
    *(float *)&double v19 = v6;
    -[GVSIIR2FilterFloat updateValue:withPole:](self->_filter, "updateValue:withPole:", v19, v18);
    self->_filteredRoll = v20;
    *(float *)&double v21 = v6;
    -[GVSRollAnalyzer updateWithRoll:atTime:](self->_analyzer, "updateWithRoll:atTime:", v21, a5);
    if (self->_forcedRampDownTime >= a5) {
      BOOL v22 = 0;
    }
    else {
      BOOL v22 = -[GVSRollSmoothingAdaptiveFilter shouldRampUp](self, "shouldRampUp");
    }
  ...
  {
    -[GVSIIR2FilterFloat reset](self->_filter, "reset");
    -[GVSRollAnalyzer reset](self->_analyzer, "reset");
    -[GVSRollAnalyzer timeConstant](self->_analyzer, "timeConstant");
...
- (BOOL)shouldRampUp
{
  ...
  -[GVSRollAnalyzer rollEstimate](self->_analyzer, "rollEstimate");
  float v5 = (float)(filteredRoll - v4) * (float)(filteredRoll - v4);
  -[GVSRollAnalyzer rollRate](self->_analyzer, "rollRate");
  float v7 = v6;
  -[GVSRollAnalyzer rollRate](self->_analyzer, "rollRate");
  float v9 = v8;
  -[GVSRollAnalyzer timeVariance](self->_analyzer, "timeVariance");
  float v11 = v10;
  -[GVSRollAnalyzer rollVariance](self->_analyzer, "rollVariance");
