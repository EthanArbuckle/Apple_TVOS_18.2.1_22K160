...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___GVSRollAnalyzer;
  v6 = -[GVSRollAnalyzer init](&v9, "init");
  v7 = v6;
  if (v6)
  {
    v6->_timeConstant = a3;
    v6->_initVariance = a4;
    -[GVSRollAnalyzer reset](v6, "reset");
  }
...
- (void)updateWithRoll:(float)a3 atTime:(double)a4
{
  ...
  {
    -[GVSRollAnalyzer reset](self, "reset");
  }
