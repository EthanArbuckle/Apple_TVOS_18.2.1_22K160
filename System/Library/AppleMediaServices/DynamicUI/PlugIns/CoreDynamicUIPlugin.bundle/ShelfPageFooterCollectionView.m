...
- (_TtC19CoreDynamicUIPlugin29ShelfPageFooterCollectionView)init
{
  return (_TtC19CoreDynamicUIPlugin29ShelfPageFooterCollectionView *)sub_4A274();
}

- (_TtC19CoreDynamicUIPlugin29ShelfPageFooterCollectionView)initWithCoder:(id)a3
{
  return (_TtC19CoreDynamicUIPlugin29ShelfPageFooterCollectionView *)sub_4A2F8(a3);
}

- (_TtC19CoreDynamicUIPlugin29ShelfPageFooterCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4
{
  return (_TtC19CoreDynamicUIPlugin29ShelfPageFooterCollectionView *)sub_4A39C( a4,  a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
...
- (void)setContentSize:(CGSize)a3
{
  ...
  double v5 = self;
  sub_4A54C(width, height);
}

- (CGSize)intrinsicContentSize
{
  v2 = self;
  CGFloat v3 = sub_4A5E4();
  double v5 = v4;
