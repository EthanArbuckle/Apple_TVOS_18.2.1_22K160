...
{
  return objc_opt_self(&OBJC_CLASS____TtC18PFLASLExperimental20PFLAMDODMLTaskRunner);
}
...
unint64_t sub_100024FEC()
{
  ...
  {
    unint64_t result = swift_getWitnessTable(&unk_100028434, &type metadata for PFLASLExperimental);
...
unint64_t sub_100025088()
{
  ...
  if (!qword_1000326C0)
  {
    unint64_t result = swift_getWitnessTable(&unk_1000283F4, &type metadata for PFLASLExperimental);
...
uint64_t sub_100025154()
{
  ...
  if (v2)
  {
    ...
    *(void *)(v0 + 56) = &type metadata for PFLASLExperimental;
