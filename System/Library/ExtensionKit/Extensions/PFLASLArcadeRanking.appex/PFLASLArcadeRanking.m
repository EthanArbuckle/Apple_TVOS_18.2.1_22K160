...
{
  return objc_opt_self(&OBJC_CLASS____TtC19PFLASLArcadeRanking20PFLAMDODMLTaskRunner);
}
...
unint64_t sub_100024FEC()
{
  ...
  {
    unint64_t result = swift_getWitnessTable(&unk_100028444, &type metadata for PFLASLArcadeRanking);
...
unint64_t sub_100025088()
{
  ...
  if (!qword_1000326C0)
  {
    unint64_t result = swift_getWitnessTable("uC", &type metadata for PFLASLArcadeRanking);
...
uint64_t sub_100025154()
{
  ...
  if (v2)
  {
    ...
    *(void *)(v0 + 56) = &type metadata for PFLASLArcadeRanking;
