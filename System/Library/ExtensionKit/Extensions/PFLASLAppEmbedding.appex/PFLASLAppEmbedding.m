...
int64_t sub_100015384(id a1, NSArray *a2, NSArray *a3)
{
  location[1] = a1;
  location[0] = 0LL;
...
{
  return objc_opt_self(&OBJC_CLASS____TtC18PFLASLAppEmbedding20PFLAMDODMLTaskRunner);
}
...
uint64_t sub_100024600()
{
  ...
  if (!*(void *)(v0 + 16) || (unint64_t v1 = sub_100023BC8(0xD000000000000010LL, 0x800000010002AFA0LL), (v2 & 1) == 0))
  {
    __int128 v13 = 0u;
    __int128 v14 = 0u;
  ...
  uint64_t v5 = v12;
  if (*(void *)(v12 + 16) && (unint64_t v6 = sub_100023BC8(0xD000000000000015LL, 0x800000010002AFC0LL), (v7 & 1) != 0))
  {
...
unint64_t sub_100024FEC()
{
  ...
  {
    unint64_t result = swift_getWitnessTable(&unk_100028434, &type metadata for PFLASLAppEmbedding);
...
unint64_t sub_100025088()
{
  ...
  if (!qword_1000326C0)
  {
    unint64_t result = swift_getWitnessTable(&unk_1000283F4, &type metadata for PFLASLAppEmbedding);
...
uint64_t sub_100025154()
{
  ...
  if (v2)
  {
    ...
    *(void *)(v0 + 56) = &type metadata for PFLASLAppEmbedding;
    ...
    *(_OWORD *)(v14 + 16) = xmmword_1000283D0;
    ...
    *(void *)(v0 + 64) = v14;
    ...
    (*(void (**)(uint64_t, void, uint64_t))(v32 + 104))(v6, enum case for PFLTaskSource.CKProd(_:), v34);
    ...
    *(void *)(v24 + 24) = v36;
    *(void *)(v0 + 40) = v23;
    uint64_t v25 = sub_1000255B8( &qword_1000326F8,  (uint64_t (*)(uint64_t))type metadata accessor for PFLAMDODMLTaskRunner,  (uint64_t)&unk_100028378);
    *(void *)(v0 + 16) = v24;
    *(void *)(v0 + 48) = v25;
