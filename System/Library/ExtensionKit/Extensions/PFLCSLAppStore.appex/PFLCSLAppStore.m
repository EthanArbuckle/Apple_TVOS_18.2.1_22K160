...
{
  return objc_opt_self(&OBJC_CLASS____TtC14PFLCSLAppStore20PFLAMDODMLTaskRunner);
}
...
unint64_t sub_10002500C()
{
  ...
  {
    unint64_t result = swift_getWitnessTable(&unk_100028440, &type metadata for PFLCSLAppStore);
...
unint64_t sub_1000250A8()
{
  ...
  if (!qword_1000326C0)
  {
    unint64_t result = swift_getWitnessTable("yC", &type metadata for PFLCSLAppStore);
...
uint64_t sub_100025174()
{
  ...
  if (v2)
  {
    ...
    *(void *)(v0 + 56) = &type metadata for PFLCSLAppStore;
