...
dispatch_queue_t ____CFXNotificationCenterDarwinQueue_block_invoke()
{
  ...
  v2 = (dispatch_queue_attr_s *)dispatch_queue_attr_make_with_overcommit();
  dispatch_queue_t result = dispatch_queue_create_with_target_V2("com.apple.CFNotificationCenter", v2, 0LL);
