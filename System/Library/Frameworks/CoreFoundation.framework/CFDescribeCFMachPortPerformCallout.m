...
void *____CFDescribeCFMachPortPerformCallout_block_invoke()
{
  ...
  if (result)
  {
    ...
    __CFDescribeCFMachPortPerformCallout_foundationDescribeNSMachPortCallout = (uint64_t (*)(void, void, void, void, void, void))dlsym(v1, "__NSDescribeNSMachPortCallout");
