...
{
  unsigned __int8 v2 = atomic_load((unsigned __int8 *)(*(void *)(*(void *)(result + 64) + 8LL) + 24LL));
  if ((v2 & 1) == 0)
  {
    uint64_t v3 = result;
    ...
    result = __NSOrderedSetChunkIterate( *(void **)(result + 32),  *(void *)(result + 96),  v5,  v6,  *(void **)(result + 40),  *(void *)(result + 56),  0LL,  *(void **)(result + 48),  *(pthread_mutex_t **)(result + 104));
    atomic_store(result, (unsigned __int8 *)(*(void *)(*(void *)(v3 + 64) + 8LL) + 24LL));
  }
