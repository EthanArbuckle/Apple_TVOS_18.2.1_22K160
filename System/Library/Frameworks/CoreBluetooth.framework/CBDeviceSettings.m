...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___CBDeviceSettings;
...
- (void)encodeWithXPCObject:(id)a3
{
  ...
  uint64_t v11 = -[NSString UTF8String](name, "UTF8String");
  if (v11) {
...
- (id)description
{
  ...
  if (*(_OWORD *)&self->_deviceFlagsMask == 0LL)
  {
