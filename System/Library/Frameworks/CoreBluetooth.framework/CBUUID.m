...
- (CBUUID)initWithString:(id)a3
{
  return -[CBUUID initWithString:safe:](self, "initWithString:safe:", a3, 0LL);
}
...
- (CBUUID)initWithString:(id)a3 safe:(BOOL)a4
{
  id v7 = a3;
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___CBUUID;
...
LABEL_4:
  if (v10 == 8)
  {
    objc_msgSend( @"00000000-0000-1000-8000-00805F9B34FB",  "stringByReplacingCharactersInRange:withString:",  0,  8,  v9);
  ...
  {
    objc_msgSend( @"00000000-0000-1000-8000-00805F9B34FB",  "stringByReplacingCharactersInRange:withString:",  4,  4,  v9);
...
- (CBUUID)initWithData:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___CBUUID;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___CBUUID;
...
- (CBUUID)initWithNSUUID:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___CBUUID;
  id v5 = -[CBUUID init](&v8, sel_init);
  objc_super v6 = v5;
  if (v5)
  {
...
{
  v3 = theString;
  id v4 = -[CBUUID initWithString:](objc_alloc(&OBJC_CLASS___CBUUID), "initWithString:", v3);
...
{
  v3 = theData;
  id v4 = -[CBUUID initWithData:](objc_alloc(&OBJC_CLASS___CBUUID), "initWithData:", v3);
...
+ (CBUUID)UUIDWithCFUUID:(CFUUIDRef)theUUID
{
  return -[CBUUID initWithCFUUID:](objc_alloc(&OBJC_CLASS___CBUUID), "initWithCFUUID:", theUUID);
}

+ (CBUUID)UUIDWithNSUUID:(NSUUID *)theUUID
{
  v3 = theUUID;
  id v4 = -[CBUUID initWithNSUUID:](objc_alloc(&OBJC_CLASS___CBUUID), "initWithNSUUID:", v3);
...
- (NSData)data
{
  ...
  [MEMORY[0x189603F48] dataWithBytesNoCopy:(char *)self + qword_18702BF08[type] length:qword_18702BF20[type] freeWhenDone:0];
...
- (id)description
{
  if (qword_18C4B7DB0 != -1) {
    dispatch_once(&qword_18C4B7DB0, &__block_literal_global_2);
  }
  v3 = -[CBUUID UUIDString](self, "UUIDString");
  [(id)_MergedGlobals_1 objectForKeyedSubscript:v3];
...
void __21__CBUUID_description__block_invoke()
{
  ...
  uint64_t v0 = [MEMORY[0x189603F68] dictionaryWithObjects:v3 forKeys:v2 count:107];
