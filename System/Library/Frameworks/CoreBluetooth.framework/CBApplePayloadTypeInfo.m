...
LABEL_6:
  ...
  id v6 = v5;
  int v7 = -[CBApplePayloadTypeInfo applePayloadType](self, "applePayloadType");
  if (v7 == -[CBApplePayloadTypeInfo applePayloadType](v6, "applePayloadType"))
  {
    int v8 = -[CBApplePayloadTypeInfo rssiThreshold](self, "rssiThreshold");
    BOOL v9 = v8 == -[CBApplePayloadTypeInfo rssiThreshold](v6, "rssiThreshold");
  }
...
- (unint64_t)hash
{
  unint64_t v3 = -[CBApplePayloadTypeInfo applePayloadType](self, "applePayloadType");
