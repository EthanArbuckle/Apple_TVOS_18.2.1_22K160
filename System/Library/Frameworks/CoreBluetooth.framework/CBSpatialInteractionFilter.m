...
{
  id v6 = a3;
  v7 = -[CBSpatialInteractionFilter init](self, "init");
  if (!v7)
  {
    if (a4)
    {
...
LABEL_5:
  ...
  if (v4 != self)
  {
    ...
    {
      int v6 = -[CBSpatialInteractionFilter requiredSpatialFlags](v5, "requiredSpatialFlags");
      BOOL v7 = v6 == -[CBSpatialInteractionFilter requiredSpatialFlags](self, "requiredSpatialFlags");
