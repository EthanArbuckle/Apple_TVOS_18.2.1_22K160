    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled((os_log_t)CFNLog::logger, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 67109632;
        ...
        __int16 v20 = 1024;
        int v21 = v14;
        _os_log_error_impl( &dword_18298D000,  v9,  OS_LOG_TYPE_ERROR,  "sandbox_check_by_audit_token() returned %d for operation file-read-data for pid %d, errno %d",  buf,  0x14u);
      }
    }
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled((os_log_t)CFNLog::logger, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 67109632;
        ...
        __int16 v20 = 1024;
        int v21 = v15;
        _os_log_error_impl( &dword_18298D000,  v12,  OS_LOG_TYPE_ERROR,  "sandbox_check_by_audit_token() returned %d for operation file-write-data for pid %d, errno %d",  buf,  0x14u);
      }
