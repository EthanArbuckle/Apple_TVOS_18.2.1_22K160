...
- (_IOSurfaceDebugDescription)initWithBasicInfo:(id *)a3 layoutInfo:(id *)a4 name:(id)a5
{
  ...
  v19.receiver = self;
  v19.super_class = (Class)&OBJC_CLASS____IOSurfaceDebugDescription;
  v8 = -[_IOSurfaceDebugDescription init](&v19, sel_init);
  v9 = (_IOSurfaceDebugDescription *)v8;
  if (v8)
  {
    __int128 v10 = *(_OWORD *)&a3->var10;
    __int128 v12 = *(_OWORD *)&a3->var0;
    __int128 v11 = *(_OWORD *)&a3->var3;
    *(_OWORD *)(v8 + 40) = *(_OWORD *)&a3->var7;
    *(_OWORD *)(v8 + 56) = v10;
    *(_OWORD *)(v8 + 8) = v12;
    *(_OWORD *)(v8 + 24) = v11;
    __int128 v14 = *(_OWORD *)&a3->var18;
    __int128 v13 = *(_OWORD *)&a3->var20;
    __int128 v15 = *(_OWORD *)&a3->var16;
    *((void *)v8 + 15) = a3->var22;
    *(_OWORD *)(v8 + 88) = v14;
    *(_OWORD *)(v8 + 104) = v13;
    *(_OWORD *)(v8 + 72) = v15;
    __int128 v16 = *(_OWORD *)&a4->var4;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS____IOSurfaceDebugDescription;
...
- (id)description
{
  ...
  else if ((*(_DWORD *)(MEMORY[0x1895F8770] + 4 * v5 + 60) & 0x800) != 0)
  {
LABEL_3:
...
LABEL_5:
  ...
  if ((*(_DWORD *)(MEMORY[0x1895F8770] + 4 * v3 + 60) & 0x800) == 0) {
    goto LABEL_5;
  }
LABEL_3:
  __str[0] = BYTE3(pixelFormat);
