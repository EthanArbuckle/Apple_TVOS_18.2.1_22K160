...
- (SHServerMusicVideoResponse)initWithMusicVideoDictionary:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___SHServerMusicVideoResponse;
  v6 = -[SHServerMusicVideoResponse init](&v9, "init");
  v7 = v6;
  if (v6) {
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v10 = (void *)objc_claimAutoreleasedReturnValue(-[SHServerMusicVideoResponse musicVideoDictionary](self, "musicVideoDictionary", (void)v17));
        v11 = (void *)objc_claimAutoreleasedReturnValue([v10 objectForKeyedSubscript:v9]);

        if (v11)
        {
          v13 = objc_alloc(&OBJC_CLASS___SHMusicVideoResponseItem);
          v14 = (void *)objc_claimAutoreleasedReturnValue(-[SHServerMusicVideoResponse musicVideoDictionary](self, "musicVideoDictionary"));
          v15 = (void *)objc_claimAutoreleasedReturnValue([v14 objectForKeyedSubscript:v9]);
          v12 = -[SHMusicVideoResponseItem initWithMusicVideoItemDictionary:]( v13,  "initWithMusicVideoItemDictionary:",  v15);
