...
- (void)loadHapticsEndpointForClientIdentifier:(id)a3 clientType:(int64_t)a4 callback:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[SHRemoteConfiguration sharedInstance](&OBJC_CLASS___SHRemoteConfiguration, "sharedInstance"));
...
- (void)loadEndpointForClientIdentifier:(id)a3 clientType:(int64_t)a4 endpointType:(int64_t)a5 installationID:(id)a6 callback:(id)a7
{
  ...
  id v14 = a7;
  objc_initWeak(&location, self);
  id v15 = (void *)objc_claimAutoreleasedReturnValue(+[SHRemoteConfiguration sharedInstance](&OBJC_CLASS___SHRemoteConfiguration, "sharedInstance"));
...
{
  id v3 = a3;
  id v4 = (id)objc_claimAutoreleasedReturnValue(+[SHRemoteConfiguration sharedInstance](&OBJC_CLASS___SHRemoteConfiguration, "sharedInstance"));
...
- (SHStorefront)storefront
{
  ...
  if (!storefront)
  {
    id v4 = objc_alloc_init(&OBJC_CLASS___SHStorefront);
    v5 = self->_storefront;
    self->_storefront = v4;
