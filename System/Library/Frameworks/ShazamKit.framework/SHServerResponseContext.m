...
- (void)sh_setDefaultValuesWithCompletion:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[SHRemoteConfiguration sharedInstance](&OBJC_CLASS___SHRemoteConfiguration, "sharedInstance"));
...
- (void)sh_setCampaignTokenForClientIdentifier:(id)a3 completion:(id)a4
{
  ...
  id v7 = a4;
  objc_initWeak(&location, self);
  id v8 = (void *)objc_claimAutoreleasedReturnValue(+[SHRemoteConfiguration sharedInstance](&OBJC_CLASS___SHRemoteConfiguration, "sharedInstance"));
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SHServerResponseContext;
  v2 = -[SHServerResponseContext init](&v6, "init");
  v3 = v2;
  if (v2)
  {
