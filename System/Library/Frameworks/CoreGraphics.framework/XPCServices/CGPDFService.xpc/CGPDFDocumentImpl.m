...
- (CGPDFDocumentImpl)initWithData:(id)a3 requestQueue:(id)a4
{
  ...
  id v7 = a4;
  v20.receiver = self;
  v20.super_class = (Class)&OBJC_CLASS___CGPDFDocumentImpl;
  v8 = -[CGPDFDocumentImpl init](&v20, "init");
  v9 = v8;
  if (!v8) {
    goto LABEL_7;
  }
  objc_storeStrong((id *)&v8->_requestQueue, a4);
  uint64_t v10 = os_transaction_create("com.apple.CoreGraphics.CGPDFService.transaction");
...
- (id)getPageAtIndex:(int64_t)a3
{
  ...
  else
  {
    ...
    if (!Page)
    {
      ...
      if (Page)
      {
        Page = -[CGPDFPageImpl initWithCGPDFPage:requestQueue:]( objc_alloc(&OBJC_CLASS___CGPDFPageImpl),  "initWithCGPDFPage:requestQueue:",  Page,  self->_requestQueue);
...
{
  id v2 = (id)CGPDFDocumentCopyInfoDictionary(*(void *)(*(void *)(a1 + 32) + 24LL));
...
uint64_t __35__CGPDFDocumentImpl_getIsUnlocked___block_invoke(uint64_t a1)
{
  ...
  BOOL IsUnlocked = CGPDFDocumentIsUnlocked(*(CGPDFDocumentRef *)(*(void *)(a1 + 32) + 24LL));
  return (*(uint64_t (**)(uint64_t, BOOL))(v1 + 16))(v1, IsUnlocked);
}
...
{
  uint64_t v1 = *(void *)(a1 + 40);
  BOOL IsEncrypted = CGPDFDocumentIsEncrypted(*(CGPDFDocumentRef *)(*(void *)(a1 + 32) + 24LL));
  return (*(uint64_t (**)(uint64_t, BOOL))(v1 + 16))(v1, IsEncrypted);
}
...
{
  uint64_t v1 = *(void *)(a1 + 40);
  size_t NumberOfPages = CGPDFDocumentGetNumberOfPages(*(CGPDFDocumentRef *)(*(void *)(a1 + 32) + 24LL));
  return (*(uint64_t (**)(uint64_t, size_t))(v1 + 16))(v1, NumberOfPages);
}
...
{
  uint64_t v1 = *(void *)(a1 + 40);
  id v2 = (id)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) getPageAtIndex:*(void *)(a1 + 48)]);
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_transaction, 0LL);
  objc_storeStrong((id *)&self->_requestQueue, 0LL);
}
