...
- (id)description
{
  return -[NEIKEv2NoncePayload descriptionWithIndent:options:](self, "descriptionWithIndent:options:", 0LL, 14LL);
}
...
{
  if (self) {
    self = (NEIKEv2NoncePayload *)objc_getProperty(self, a2, 24LL, 1);
  }
  return self != 0LL;
}
...
LABEL_5:
  ...
  {
    *(_WORD *)v11 = 0;
    _os_log_error_impl(&dword_1876B1000, v10, OS_LOG_TYPE_ERROR, "NONCE payload missing required fields", v11, 2u);
  }
...
- (BOOL)parsePayloadData
{
  ...
  else
  {
    ...
    {
      int v8 = 136315138;
      char v9 = "-[NEIKEv2NoncePayload parsePayloadData]";
