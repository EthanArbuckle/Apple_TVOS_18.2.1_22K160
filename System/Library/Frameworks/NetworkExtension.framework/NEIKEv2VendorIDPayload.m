...
- (id)description
{
  return -[NEIKEv2VendorIDPayload descriptionWithIndent:options:](self, "descriptionWithIndent:options:", 0LL, 14LL);
}

- (BOOL)hasRequiredFields
{
  if (self) {
    self = (NEIKEv2VendorIDPayload *)objc_getProperty(self, a2, 24LL, 1);
  }
  return self != 0LL;
}
...
LABEL_5:
  ...
  {
    *(_WORD *)v11 = 0;
    _os_log_error_impl(&dword_1876B1000, v10, OS_LOG_TYPE_ERROR, "Vendor ID payload missing required fields", v11, 2u);
  }
...
- (BOOL)parsePayloadData
{
  ...
  else
  {
    ...
    {
      int v8 = 136315138;
      char v9 = "-[NEIKEv2VendorIDPayload parsePayloadData]";
