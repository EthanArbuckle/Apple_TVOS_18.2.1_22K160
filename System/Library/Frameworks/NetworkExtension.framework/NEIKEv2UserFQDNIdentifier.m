...
- (NEIKEv2UserFQDNIdentifier)initWithUserFQDN:(id)a3
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_fault_impl(&dword_1876B1000, v8, OS_LOG_TYPE_FAULT, "%s called with null userFQDN", buf, 0xCu);
    }
  ...
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___NEIKEv2UserFQDNIdentifier;
