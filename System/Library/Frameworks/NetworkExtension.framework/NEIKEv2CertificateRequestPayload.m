...
- (id)description
{
  return -[NEIKEv2CertificateRequestPayload descriptionWithIndent:options:]( self,  "descriptionWithIndent:options:",  0LL,  14LL);
}
...
LABEL_7:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl( &dword_1876B1000,  v12,  OS_LOG_TYPE_ERROR,  "Certificate Request payload missing required fields",  buf,  2u);
  }
