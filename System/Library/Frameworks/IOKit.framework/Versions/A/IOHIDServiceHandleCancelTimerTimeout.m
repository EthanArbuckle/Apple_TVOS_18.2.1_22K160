...
void ____IOHIDServiceHandleCancelTimerTimeout_block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  {
    v4 = (os_log_s *)_IOHIDLogCategory(0);
...
void ____IOHIDServiceHandleCancelTimerTimeout_block_invoke_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = v3;
  _os_log_fault_impl( &dword_182DAF000,  log,  OS_LOG_TYPE_FAULT,  "Service filter %@ never called cancel handler for service %@",  (uint8_t *)&v4,  0x16u);
