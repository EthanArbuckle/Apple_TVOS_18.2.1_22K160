...
- (id)generateSQLStringInContext:(id)a3
{
  ...
  NSUInteger v4 = -[NSArray count](self->_fetchColumns, "count");
  if (self->_isCount && v4 > 1) {
    return 0LL;
  }
  NSUInteger v6 = v4;
  v7 = (void *)[objc_alloc(MEMORY[0x189607940]) initWithString:@"SELECT "];
  v8 = v7;
  if (!self->_isCount)
  {
  ...
  if ((objc_msgSend( (id)objc_msgSend(-[NSArray lastObject](self->_fetchColumns, "lastObject"), "columnName"),  "isEqual:",  @"*") & 1) == 0) {
LABEL_8:
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSSQLSelectIntermediate;
