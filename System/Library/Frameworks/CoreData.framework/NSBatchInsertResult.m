...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___NSBatchInsertResult;
...
- (NSBatchInsertResult)initWithSubresults:(id)a3
{
  ...
  v49.receiver = self;
  v49.super_class = (Class)&OBJC_CLASS___NSBatchInsertResult;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSBatchInsertResult;
