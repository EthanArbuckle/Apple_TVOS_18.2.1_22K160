...
+ (void)initialize
{
  if (!_NSTheOneGarbageManager)
  {
    ...
    {
      v6.receiver = v3;
      v6.super_class = (Class)&OBJC_CLASS____PFGarbageManager;
      v4 = objc_msgSendSuper2(&v6, sel_init);
      if (v4)
      {
        v5 = v4;
        v4[2] = objc_alloc_init(MEMORY[0x189603FE0]);
        v5[1] = objc_alloc_init(MEMORY[0x189603FC8]);
      }
    }
  }
...
- (void)temporaryLinksDirectoryForStore:(id *)a1
{
  ...
  objc_super v6 = (void *)objc_msgSend( MEMORY[0x189604030],  "fileURLWithPath:isDirectory:",  -[NSString stringByAppendingPathComponent:]( -[NSString stringByAppendingPathComponent:](v5, "stringByAppendingPathComponent:", @".LINKS"),  "stringByAppendingPathComponent:",  +[_PFRoutines _getUUID]()),  1);
  if (!v6) {
    goto LABEL_11;
  }
  if ((objc_msgSend( (id)objc_msgSend(MEMORY[0x1896078A8], "defaultManager", 0),  "createDirectoryAtURL:withIntermediateDirectories:attributes:error:",  v6,  1,  0,  &v12) & 1) == 0)
  {
    objc_sync_exit(a1);
    return 0LL;
  }
