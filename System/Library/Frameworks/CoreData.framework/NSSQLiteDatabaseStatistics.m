...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___NSSQLiteDatabaseStatistics;
...
- (id)copy
{
  id result = -[NSSQLiteDatabaseStatistics initWithPageSize:]( objc_alloc(&OBJC_CLASS___NSSQLiteDatabaseStatistics),  "initWithPageSize:",  self->_pageSize);
...
- (id)databaseStatisticsBySubtracting:(id)a3
{
  if (a3)
  {
    objc_super v5 = -[NSSQLiteDatabaseStatistics initWithPageSize:]( objc_alloc(&OBJC_CLASS___NSSQLiteDatabaseStatistics),  "initWithPageSize:",  self->_pageSize);
  ...
  {
    objc_super v5 = -[NSSQLiteDatabaseStatistics copy](self, "copy");
  }
