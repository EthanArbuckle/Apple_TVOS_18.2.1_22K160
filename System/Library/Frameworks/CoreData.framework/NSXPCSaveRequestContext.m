...
{
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___NSXPCSaveRequestContext;
  ...
  if (v12)
  {
    ...
    v13->_changeCache = (NSMutableDictionary *)objc_msgSend( objc_alloc(MEMORY[0x189603FC8]),  "initWithCapacity:",  objc_msgSend((id)objc_msgSend(a4, "updatedObjects"), "count")
                                               + objc_msgSend((id)objc_msgSend(a4, "insertedObjects"), "count"));
    v13->_interrupts = 0LL;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSXPCSaveRequestContext;
...
- (void)_updateRollbackCacheForObjectWithID:(void *)a3 relationship:(void *)a4 withValuesFrom:
{
  ...
  if (v6)
  {
    ...
    v12 = (char *)v21 - ((8 * v11 + 15) & 0xFFFFFFFFFFFFFFF0LL);
    if (v8 > 0x200) {
      v12 = (char *)NSAllocateScannedUncollectable();
    }
    else {
      bzero((char *)v21 - ((8 * v11 + 15) & 0xFFFFFFFFFFFFFFF0LL), 8 * v10);
    }
    __int128 v24 = 0u;
    __int128 v25 = 0u;
    __int128 v23 = 0u;
    ...
    v19 = (Class *)0x189603FF0LL;
    if (!v18) {
      v19 = (Class *)0x189604010LL;
    }
...
- (void)_encodeObjectsForSave:(char)a3 forDelete:
{
  ...
  v72 = (void *)[MEMORY[0x189603FA8] array];
  ...
  if (v73)
  {
    ...
    do
    {
      for (uint64_t i = 0LL; i != v73; ++i)
      {
        ...
        {
          uint64_t v9 = v8;
          uint64_t v10 = objc_alloc(&OBJC_CLASS___NSIncrementalStoreNode);
          uint64_t v11 = (void *)[MEMORY[0x189603FC8] dictionary];
          v12 = (unint64_t *)[v7 entity];
          uint64_t v13 = v12;
          v77 = v10;
          if (v12) {
          ...
          if (v21)
          {
            for (unint64_t j = 0LL; j != v21; ++j)
            {
              __int128 v23 = *(void **)(v15 + 8 * j);
              _PF_Handler_Primitive_GetProperty((id **)v7, j, 0LL, *(void *)(v20 + 8 * j), v16, v17, v18, v19);
              if (v24) {
          ...
          if (v26 < v25 + v26)
          {
            do
            {
              ...
              _PF_Handler_Primitive_GetProperty((id **)v7, v26, 0LL, *(void *)(v20 + 8 * v26), v16, v17, v18, v19);
              if (v28) {
          ...
          v31 = -[NSXPCRow initWithNode:](objc_alloc(&OBJC_CLASS___NSXPCRow), "initWithNode:", v30);
        ...
        if (v7)
        {
          v32 = (void *)[MEMORY[0x189603FA8] array];
          v33 = (void *)[v7 entity];
          ...
          objc_msgSend(v32, "addObject:", objc_msgSend(MEMORY[0x189607968], "numberWithUnsignedLongLong:", v36));
          if (v33) {
            v37 = (void *)v33[14];
          }
          else {
          ...
          unint64_t v38 = v37[6];
          uint64_t v39 = v37[7];
          v40 = objc_alloc_init(&OBJC_CLASS____NSNoChangeToken);
          [v32 addObject:v40];
          ...
          if (v38 < v39 + v38)
          {
            ...
            do
            {
              ...
              uint64_t v45 = -[os_unfair_lock_s valueForPropertyDescription:](v35, "valueForPropertyDescription:", v43);
              if (v35
          ...
          if (v49 < v50 + v49)
          {
            ...
            do
            {
              ...
              uint64_t v54 = -[os_unfair_lock_s valueForPropertyDescription:](v35, "valueForPropertyDescription:", v52);
              if (v35
          ...
          if (v58 < v59 + v58)
          {
            ...
            do
            {
              ...
              v63 = (void *)[objc_alloc(MEMORY[0x189603FA8]) initWithCapacity:3];
              [v32 addObject:v63];

              if (!v62) {
                v62 = (void *)[MEMORY[0x189604010] set];
              }
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                if (-[os_unfair_lock_s count](v64, "count")) {
                  objc_exception_throw((id)[MEMORY[0x189603F70] exceptionWithName:*MEMORY[0x189603A58] reason:@"Array with content where there should be a set." userInfo:0]);
                }
                v64 = (os_unfair_lock_s *)[MEMORY[0x189604010] setWithArray:v64];
              }

              if (!v64) {
                v64 = (os_unfair_lock_s *)[MEMORY[0x189604010] set];
              }
...
LABEL_65:
              ...
              else
              {
                ...
                v65 = (void *)+[_PFRoutines newSetOfObjectIDsFromCollection:]((uint64_t)&OBJC_CLASS____PFRoutines, v62);
...
- (id)newEncodedSaveRequest
{
  if (result)
  {
    ...
    return +[_NSXPCStoreUtilities newSecureArchivedDataWithRootObject:]( (uint64_t)&OBJC_CLASS____NSXPCStoreUtilities,  (uint64_t)v3);
  }
