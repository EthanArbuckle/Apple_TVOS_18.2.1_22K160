...
- (NSEntityStoreMapping)initWithEntity:(id)a3
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___NSEntityStoreMapping;
  ...
  if (v8)
  {
    ...
    -[NSEntityStoreMapping setPrimaryKeys:]((uint64_t)v9, 0LL);
...
- (void)dealloc
{
  ...
  {
    self->_entity = 0LL;
    -[NSEntityStoreMapping setPropertyMappings:]((uint64_t)self, 0LL);
    -[NSEntityStoreMapping setPrimaryKeys:]((uint64_t)self, 0LL);
  ...
  {
    -[NSEntityStoreMapping setPropertyMappings:](0LL, 0LL);
    -[NSEntityStoreMapping setPrimaryKeys:](0LL, 0LL);
  }

  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___NSEntityStoreMapping;
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSEntityStoreMapping;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    id v6 = -[NSEntityStoreMapping entity](self, "entity");
    if (v6 == (id)[a3 entity]
      || (unsigned int v5 = objc_msgSend(-[NSEntityStoreMapping entity](self, "entity"), "isEqual:", objc_msgSend(a3, "entity"))) != 0)
    {
      id v7 = -[NSEntityStoreMapping propertyMappings](self, "propertyMappings");
      ...
      {
        id v8 = -[NSEntityStoreMapping primaryKeys](self, "primaryKeys");
        ...
        {
          int v9 = -[NSEntityStoreMapping isSingleTableEntity](self, "isSingleTableEntity");
          if (v9 == [a3 isSingleTableEntity])
          {
            id v10 = -[NSEntityStoreMapping subentityColumn](self, "subentityColumn");
            ...
            {
              unsigned int v11 = -[NSEntityStoreMapping subentityID](self, "subentityID");
