...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___NSPersistentCloudKitContainerEvent;
  ...
  if (v4)
  {
    ...
    if (objc_msgSend((id)objc_msgSend(a3, "errorDomain"), "length")) {
      v4->_error = (NSError *)objc_msgSend( objc_alloc(MEMORY[0x189607870]),  "initWithDomain:code:userInfo:",  objc_msgSend(a3, "errorDomain"),  objc_msgSend(a3, "errorCode"),  0);
    }
  }
...
- (void)dealloc
{
  ...
  self->_error = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSPersistentCloudKitContainerEvent;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      int v5 = -[NSUUID isEqual:](self->_identifier, "isEqual:", *((void *)a3 + 3));
      if (v5) {
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___NSPersistentCloudKitContainerEvent;
  objc_super v3 = (void *)objc_msgSend(-[NSPersistentCloudKitContainerEvent description](&v7, sel_description), "mutableCopy");
...
+ (id)eventTypeString:(int64_t)a3
{
  ...
  if (os_log_type_enabled((os_log_t)__pflogFaultLog, OS_LOG_TYPE_FAULT))
  {
    *(_DWORD *)buf = 134217984;
    int64_t v14 = a3;
    _os_log_fault_impl( &dword_186681000,  v12,  OS_LOG_TYPE_FAULT,  "CoreData: Unknown event type, cannot covert to string: %ld",  buf,  0xCu);
  }
