...
+ (id)exceptionWithName:(uint64_t)a3 code:(uint64_t)a4 reason:(void *)a5 userInfo:
{
  id v9 = objc_alloc((Class)objc_opt_self());
...
- (id)initWithName:(uint64_t)a3 code:(uint64_t)a4 reason:(void *)a5 userInfo:
{
  if (result)
  {
    ...
    v11 = (void *)[a5 objectForKey:*MEMORY[0x189607798]];
    if (!a3)
    {
      v12 = v11;
      if (v11)
      {
        ...
        if (v5)
        {
          v13 = (void *)[objc_alloc(MEMORY[0x189603FC8]) initWithDictionary:v5];
          if ([v12 userInfo]) {
    ...
    v14.receiver = v9;
    v14.super_class = (Class)&OBJC_CLASS____NSCoreDataException;
...
- (_NSCoreDataException)initWithName:(id)a3 reason:(id)a4 userInfo:(id)a5
{
  return (_NSCoreDataException *)-[_NSCoreDataException initWithName:code:reason:userInfo:]( self,  (uint64_t)a3,  0LL,  (uint64_t)a4,  a5);
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS____NSCoreDataException;
...
- (id)errorObjectWithUserInfo:(id)a3
{
  id v5 = (void *)-[_NSCoreDataException userInfo](self, "userInfo");
  if (a3)
  {
  ...
  if (self)
  {
    if (self->_domain) {
      ...
      domain = (NSString *)*MEMORY[0x189607460];
    }
    if (self->_code) {
      int64_t code = self->_code;
    }
    else {
      int64_t code = 134060LL;
    }
  }
  ...
  uint64_t v10 = (void *)[MEMORY[0x189607870] errorWithDomain:domain code:code userInfo:v7];
