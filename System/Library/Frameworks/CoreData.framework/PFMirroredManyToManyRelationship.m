...
- (PFMirroredManyToManyRelationship)initWithRecordID:(id)a3 recordType:(id)a4 managedObjectModel:(id)a5 andType:(unint64_t)a6
{
  ...
  v25.receiver = self;
  v25.super_class = (Class)&OBJC_CLASS___PFMirroredManyToManyRelationship;
  ...
  if (v10)
  {
    ...
    if (v11 > [@"CD_M2M_" length]
      && (v12 = (void *)objc_msgSend( (id)objc_msgSend(a4, "substringFromIndex:", objc_msgSend(@"CD_M2M_", "length")),  "componentsSeparatedByString:",  @"_"),  objc_msgSend(v12, "count") == 2)
      && (v13 = (void *)objc_msgSend( (id)objc_msgSend(a5, "entitiesByName"),  "objectForKey:",  objc_msgSend(v12, "objectAtIndex:", 0))) != 0 && (v14 = (void *)objc_msgSend( (id)objc_msgSend(v13, "relationshipsByName"),  "objectForKey:",  objc_msgSend(v12, "objectAtIndex:", 1))) != 0 && (v15 = v14, objc_msgSend(v14, "inverseRelationship")))
    {
      v26[0] = v15;
      v26[1] = [v15 inverseRelationship];
      v16 = (void *)[MEMORY[0x189603F18] arrayWithObjects:v26 count:2];
    }
    ...
    if (v17 && (v19 = (void *)v18) != 0LL)
    {
      ...
      v22 = (void *)objc_msgSend( objc_alloc(getCloudKitCKRecordIDClass()),  "initWithRecordName:zoneID:",  objc_msgSend(v21, "objectAtIndex:", 0),  objc_msgSend(a3, "zoneID"));
      v23 = (void *)objc_msgSend( objc_alloc(getCloudKitCKRecordIDClass()),  "initWithRecordName:zoneID:",  objc_msgSend(v21, "objectAtIndex:", 1),  objc_msgSend(a3, "zoneID"));
...
- (id)_setManyToManyRecordID:(void *)a3 manyToManyRecordType:(void *)a4 ckRecordID:(void *)a5 relatedCKRecordID:(void *)a6 relationshipDescription:(void *)a7 inverseRelationshipDescription:(uint64_t)a8 type:
{
  ...
  {
    _NSCoreDataLog(17LL, v16, v17, v18, v19, v20, v21, v22, (uint64_t)a2);
...
- (void)dealloc
{
  ...
  self->_manyToManyRecordID = 0LL;
  self->_manyToManyRecordType = 0LL;

  self->_ckRecordID = 0LL;
  self->_relatedCKRecordID = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___PFMirroredManyToManyRelationship;
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___PFMirroredManyToManyRelationship;
...
- (BOOL)updateRelationshipValueUsingImportContext:(id)a3 andManagedObjectContext:(id)a4 error:(id *)a5
{
    ...
    || [a3 isTemporaryID])
  {
    ...
    _NSCoreDataLog(17LL, v14, v15, v16, v17, v18, v19, v20, (uint64_t)v11);
    ...
    if (os_log_type_enabled((os_log_t)__pflogFaultLog, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v49 = 2112;
      id v50 = a3;
      _os_log_fault_impl( &dword_186681000,  v21,  OS_LOG_TYPE_FAULT,  "CoreData: Got temporary objectIDs back during import where we should have permanent ones: %@ / %@",  buf,  0x16u);
    }
  }

  uint64_t v22 = 134412LL;
  if (v11)
  {
    if (a3)
    {
      ...
      objc_super v25 = (void *)objc_msgSend( (id)objc_msgSend( v23,  "valueForKey:",  -[NSPropertyDescription name](self->_relationshipDescription, "name")),  "mutableCopy");
      id v26 = v25;
      ...
      else
      {
        if (type)
        {
          ...
          _NSCoreDataLog(17LL, v38, v39, v40, v41, v42, v43, v44, (uint64_t)self);
          v45 = (os_log_s *)__pflogFaultLog;
          if (os_log_type_enabled((os_log_t)__pflogFaultLog, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412290;
            v48 = self;
            _os_log_fault_impl( &dword_186681000,  v45,  OS_LOG_TYPE_FAULT,  "CoreData: New many to many relationship type?: %@",  buf,  0xCu);
          }
...
LABEL_27:
  ...
  {
    uint64_t v22 = 134413LL;
  }

  uint64_t v28 = [MEMORY[0x189607870] errorWithDomain:*MEMORY[0x189607460] code:v22 userInfo:0];
  if (!v28)
  {
    uint64_t v30 = [NSString stringWithUTF8String:"Illegal attempt to return an error without one in %s:%d"];
    _NSCoreDataLog( 17LL,  v30,  v31,  v32,  v33,  v34,  v35,  v36,  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Persistence/PFMirroredRelationship.m");
...
- (void)recordTypeToRecordID
{
  ...
  {
    v1 = result;
    v2 = (void *)objc_msgSend(objc_alloc(MEMORY[0x189603FA8]), "initWithObjects:", result[6], 0);
    ...
    if (!v4)
    {
      id v4 = (id)objc_msgSend(objc_alloc(MEMORY[0x189603FA8]), "initWithObjects:", v1[7], 0);
