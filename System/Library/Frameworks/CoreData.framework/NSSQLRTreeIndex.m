...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___NSSQLRTreeIndex;
  v6 = -[NSSQLIndex initForIndexDescription:sqlEntity:](&v8, sel_initForIndexDescription_sqlEntity_);
  if (v6) {
    v6[6] = [objc_alloc(NSString) initWithFormat:@"Z_%@_%@", objc_msgSend(a4, "name"), objc_msgSend(a3, "name")];
  }
  return v6;
}
...
- (void)dealloc
{
  self->_tableName = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSSQLRTreeIndex;
...
- (void)generateSQLStrings
{
  ...
  if (a1)
  {
    ...
    id v39 = objc_alloc_init(MEMORY[0x189603FA8]);
    id v40 = objc_alloc_init(MEMORY[0x189603FA8]);
    id v41 = objc_alloc_init(MEMORY[0x189603FA8]);
    v46 = (void *)[MEMORY[0x189607940] stringWithString:&stru_189EAC2E8];
    v43 = (void *)[MEMORY[0x189607940] stringWithString:&stru_189EAC2E8];
    v45 = (void *)[MEMORY[0x189607940] stringWithString:&stru_189EAC2E8];
    v44 = (void *)[MEMORY[0x189607940] stringWithString:&stru_189EAC2E8];
...
LABEL_14:
      ...
      {
LABEL_20:
        v18 = -[NSSQLiteStatement initWithEntity:sqlString:]( [NSSQLiteStatement alloc],  "initWithEntity:sqlString:",  [v1 sqlEntity],  objc_msgSend( MEMORY[0x189607940],  "stringWithFormat:",  @"CREATE VIRTUAL TABLE IF NOT EXISTS %@ USING RTREE (Z_PK INTEGER PRIMARY KEY, %@)",  v1[6],  v46));
        [v39 addObject:v18];

        v19 = objc_alloc(&OBJC_CLASS___NSSQLiteStatement);
        ...
        v23 = objc_alloc(&OBJC_CLASS___NSSQLiteStatement);
        ...
        v31 = objc_alloc(&OBJC_CLASS___NSSQLiteStatement);
        ...
        objc_setProperty_nonatomic(v1, v35, v39, 24LL);
        objc_setProperty_nonatomic(v1, v36, v40, 32LL);

        objc_setProperty_nonatomic(v1, v37, v41, 40LL);
...
- (id)generateStatementsForStore:(id)a3
{
  ...
  {
    -[NSSQLRTreeIndex generateSQLStrings](0LL);
    return 0LL;
  }
