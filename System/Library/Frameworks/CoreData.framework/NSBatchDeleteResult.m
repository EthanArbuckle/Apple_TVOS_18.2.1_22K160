...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___NSBatchDeleteResult;
...
- (NSBatchDeleteResult)initWithSubresults:(id)a3
{
  ...
  v49.receiver = self;
  v49.super_class = (Class)&OBJC_CLASS___NSBatchDeleteResult;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSBatchDeleteResult;
