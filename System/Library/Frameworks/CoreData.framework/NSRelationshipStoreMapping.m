...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSRelationshipStoreMapping;
...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___NSRelationshipStoreMapping;
  unsigned int v5 = -[NSPropertyStoreMapping isEqual:](&v11, sel_isEqual_);
  if (v5)
  {
    id v6 = -[NSRelationshipStoreMapping destinationEntityExternalName](self, "destinationEntityExternalName");
    ...
    {
      id v7 = -[NSRelationshipStoreMapping foreignKeys](self, "foreignKeys");
      ...
      {
        id v8 = -[NSRelationshipStoreMapping joins](self, "joins");
        if (v8 == (id)[a3 joins]
          || (unsigned int v5 = objc_msgSend( -[NSRelationshipStoreMapping joins](self, "joins"),  "isEqual:",  objc_msgSend(a3, "joins"))) != 0)
        {
          unsigned int v9 = -[NSRelationshipStoreMapping joinSemantic](self, "joinSemantic");
