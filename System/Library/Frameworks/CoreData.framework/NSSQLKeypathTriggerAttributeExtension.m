...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___NSSQLKeypathTriggerAttributeExtension;
  ...
  if (v8)
  {
    ...
    v8->_insertSQLStrings = (NSArray *)objc_alloc_init(MEMORY[0x189603F18]);
    v8->_dropSQLStrings = (NSArray *)objc_alloc_init(MEMORY[0x189603F18]);
    v8->_bulkUpdateSQLStrings = (NSArray *)objc_alloc_init(MEMORY[0x189603F18]);
  }
...
- (void)dealloc
{
  ...
  self->_keypath = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSSQLKeypathTriggerAttributeExtension;
...
- (NSString)description
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSSQLKeypathTriggerAttributeExtension;
  return -[NSString stringByAppendingFormat:]( -[NSSQLKeypathTriggerAttributeExtension description](&v3, sel_description),  "stringByAppendingFormat:",  @" %@.%@ = %@",  -[NSSQLEntity name](self->_entity, "name"),  -[NSSQLProperty name](self->_attribute, "name"),  self->_objectFromUserInfo);
}

- (BOOL)validate:(id *)a3
{
  v89[1] = *MEMORY[0x1895F89C0];
  v67 = 0LL;
  ...
  if (objectFromUserInfo)
  {
    if ([objectFromUserInfo isNSString])
    {
      if ([self->_objectFromUserInfo length])
      {
        ...
        v7 = (void *)[MEMORY[0x189607878] expressionWithFormat:self->_objectFromUserInfo];
        v8 = v7;
        if (v7)
        {
...
LABEL_23:
                        if ([v6 objectForKey:@"NSUnderlyingException"])
                        {
                          ...
                          uint64_t v74 = *MEMORY[0x1896075F0];
                          ...
                          uint64_t v46 = [MEMORY[0x189603F68] dictionaryWithObjects:v75 forKeys:&v74 count:1];
                          v67 = (void *)[v45 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v46];
                        }
                      ...
                      uint64_t v59 = [MEMORY[0x189603F68] dictionaryWithObjects:v89 forKeys:&v88 count:1];
                    }
                    ...
                    else
                    {
                      ...
                      uint64_t v59 = [MEMORY[0x189603F68] dictionaryWithObjects:&v87 forKeys:&v86 count:1];
                    }
                  }
                  ...
                  {
                    v58 = (void *)MEMORY[0x189607870];
                    uint64_t v84 = *MEMORY[0x1896075F0];
                    ...
                    uint64_t v59 = [MEMORY[0x189603F68] dictionaryWithObjects:&v85 forKeys:&v84 count:1];
                  }

                  uint64_t v36 = [v58 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v59];
                  if (v36) {
                    goto LABEL_20;
                  }
                  uint64_t v60 = [NSString stringWithUTF8String:"Illegal attempt to return an error without one in %s:%d"];
                  _NSCoreDataLog( 17LL,  v60,  v61,  v62,  v63,  v64,  v65,  v66,  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Persistence/NSSQLKeypathTriggerAttributeExtension.m");
                ...
                objc_super v11 = (void *)MEMORY[0x189607870];
                uint64_t v88 = *MEMORY[0x1896075F0];
                ...
                uint64_t v12 = [MEMORY[0x189603F68] dictionaryWithObjects:v89 forKeys:&v88 count:1];
              }
              ...
              else
              {
                ...
                uint64_t v12 = [MEMORY[0x189603F68] dictionaryWithObjects:&v87 forKeys:&v86 count:1];
              }
            }
            ...
            else
            {
              ...
              uint64_t v12 = [MEMORY[0x189603F68] dictionaryWithObjects:&v85 forKeys:&v84 count:1];
            }

            uint64_t v36 = [v11 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v12];
            if (v36)
            {
LABEL_20:
              v67 = (void *)v36;
LABEL_22:
            ...
            _NSCoreDataLog( 17LL,  v37,  v38,  v39,  v40,  v41,  v42,  v43,  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Persistence/NSSQLKeypathTriggerAttributeExtension.m");
            v44 = (os_log_s *)__pflogFaultLog;
            if (!os_log_type_enabled((os_log_t)__pflogFaultLog, OS_LOG_TYPE_FAULT)) {
              goto LABEL_22;
            }
...
LABEL_46:
          ...
          uint64_t v78 = *MEMORY[0x1896075F0];
          ...
          uint64_t v34 = [MEMORY[0x189603F68] dictionaryWithObjects:&v79 forKeys:&v78 count:1];
          uint64_t v32 = [v33 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v34];
        }

        else
        {
          v25 = (void *)MEMORY[0x189607870];
          uint64_t v76 = *MEMORY[0x1896075F0];
          v26 = (void *)NSString;
          id v27 = -[NSSQLEntity name](self->_entity, "name");
          id v28 = -[NSSQLProperty name](self->_attribute, "name");
          ...
          uint64_t v31 = [MEMORY[0x189603F68] dictionaryWithObjects:&v77 forKeys:&v76 count:1];
          uint64_t v32 = [v25 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v31];
        }
      ...
      uint64_t v23 = [MEMORY[0x189603F68] dictionaryWithObjects:&v73 forKeys:&v72 count:1];
      v15 = (void *)[v22 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v23];
    }
    ...
    else
    {
      ...
      v17 = (void *)NSString;
      id v18 = -[NSSQLEntity name](self->_entity, "name");
      id v19 = -[NSSQLProperty name](self->_attribute, "name");
      v20 = (objc_class *)objc_opt_class();
      uint64_t v71 = [v17 stringWithFormat:@"The trigger on %@.%@ is not valid: must be an instance of %@.", v18, v19, NSStringFromClass(v20)];
      uint64_t v21 = [MEMORY[0x189603F68] dictionaryWithObjects:&v71 forKeys:&v70 count:1];
      v15 = (void *)[v16 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v21];
    }
  }
  ...
  else
  {
    ...
    uint64_t v68 = *MEMORY[0x1896075F0];
    ...
    uint64_t v14 = [MEMORY[0x189603F68] dictionaryWithObjects:&v69 forKeys:&v68 count:1];
    v15 = (void *)[v13 errorWithDomain:*MEMORY[0x189607460] code:134060 userInfo:v14];
  }
...
LABEL_28:
    ...
    _NSCoreDataLog( 17LL,  v47,  v48,  v49,  v50,  v51,  v52,  v53,  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Persistence/NSSQLKeypathTriggerAttributeExtension.m");
    v54 = (os_log_s *)__pflogFaultLog;
    if (os_log_type_enabled((os_log_t)__pflogFaultLog, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 136315394;
      v81 = "/Library/Caches/com.apple.xbs/Sources/Persistence/NSSQLKeypathTriggerAttributeExtension.m";
      __int16 v82 = 1024;
      int v83 = 118;
      _os_log_fault_impl( &dword_186681000,  v54,  OS_LOG_TYPE_FAULT,  "CoreData: Illegal attempt to return an error without one in %s:%d",  buf,  0x12u);
    }
...
- (uint64_t)validateKeypath:(uint64_t)result
{
  ...
  if (result)
  {
    ...
    if (v6)
    {
      if (v6[24] - 7 > 2)
      {
        char v35 = (void *)MEMORY[0x189607870];
        uint64_t v36 = *MEMORY[0x189607460];
        uint64_t v95 = *MEMORY[0x1896075F0];
        ...
        uint64_t v37 = (void *)MEMORY[0x189603F68];
        uint64_t v38 = &v96;
        uint64_t v39 = &v95;
      }
        ...
        if (([v6 isToMany] & 1) != 0 || v7[24] == 9)
        {
          *(void *)(v3 + 64) = v7;
          ...
          if (v19 && *(_BYTE *)(v19 + 24) == 9)
          {
            ...
            id v22 = v9;
            uint64_t v84 = v9;
            uint64_t v23 = (void *)[objc_alloc(NSString) initWithFormat:@"%@_%@_INSERT_INCREMENT", v13, v20];
            uint64_t v79 = v10;
            BOOL v24 = (void *)[objc_alloc(NSString) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v23];
            ...
            uint64_t v77 = v20;
            id v28 = (void *)[objc_alloc(NSString) initWithFormat:@"%@_%@_DELETE_DECREMENT", v85, v20];
            id v29 = (void *)[objc_alloc(NSString) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v28];
            ...
            id v10 = v79;
            uint64_t v31 = (void *)[objc_alloc(NSString) initWithFormat:@"COUNT_%@", v85];
            uint64_t v32 = (void *)[objc_alloc(MEMORY[0x189607940]) initWithFormat:@"CREATE TEMP TABLE %@ AS", v31];
            [v32 appendFormat:@" SELECT %@, COUNT(DISTINCT(%@.%@)) AS COUNT", v76, v77, v81];
            [v32 appendFormat:@" FROM %@", v77];
            [v32 appendFormat:@" GROUP BY %@;", v76];
            [v79 addObject:v32];

            v33 = (void *)objc_msgSend( objc_alloc(MEMORY[0x189607940]),  "initWithFormat:",  @" CREATE INDEX %@_INDEX ON %@(%@,COUNT);",
                            v31,
                            v31,
                            v76);
            [v79 addObject:v33];

            uint64_t v34 = objc_msgSend( objc_alloc(MEMORY[0x189607940]),  "initWithFormat:",  @" UPDATE %@ SET %@ = IFNULL((SELECT COUNT FROM %@ WHERE %@ = %@),0);",
                    v12,
                    v83,
                    v31,
                    v30,
...
LABEL_24:
            ...
            uint64_t v86 = v13;
            v45 = (void *)[objc_alloc(NSString) initWithFormat:@"%@_INSERT_INCREMENT", v13];
            uint64_t v46 = (void *)[objc_alloc(NSString) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v45];
            ...
            uint64_t v50 = (void *)[objc_alloc(NSString) initWithFormat:@"%@_DELETE_DECREMENT", v86];
            uint64_t v51 = (void *)[objc_alloc(NSString) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v50];
            ...
            uint64_t v53 = (void *)[objc_alloc(NSString) initWithFormat:@"%@_%@_INSERT_INCREMENT", v86, v41];
            ...
            v56 = (void *)[objc_alloc(NSString) initWithFormat:@"%@_%@_UPDATE_INCREMENT", v86, v43];
            uint64_t v57 = v9;
            uint64_t v84 = v9;
            v58 = (void *)[objc_alloc(NSString) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v56];
            ...
            id v59 = objc_alloc_init(MEMORY[0x189607940]);
            uint64_t v60 = (void *)[objc_alloc(NSString) initWithFormat:@"%@_%@_UPDATE_DECREMENT", v86, v43];
            uint64_t v61 = (void *)[objc_alloc(NSString) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v60];
            ...
            uint64_t v31 = (void *)[objc_alloc(NSString) initWithFormat:@"COUNT_%@", v86];
            uint64_t v62 = (void *)[objc_alloc(MEMORY[0x189607940]) initWithFormat:@"CREATE TEMP TABLE %@ AS", v31];
            ...
            uint64_t v63 = (void *)objc_msgSend( objc_alloc(MEMORY[0x189607940]),  "initWithFormat:",  @" CREATE INDEX %@_INDEX ON %@(%@,COUNT);",
                            v31,
                            v31,
                            v43);
            [v80 addObject:v63];
          ...
          uint64_t v65 = (void *)[objc_alloc(MEMORY[0x189607940]) initWithFormat:@" DROP TABLE %@;", v31];
          [v10 addObject:v65];
        ...
        char v35 = (void *)MEMORY[0x189607870];
        uint64_t v36 = *MEMORY[0x189607460];
        uint64_t v97 = *MEMORY[0x1896075F0];
    ...
    else
    {
      char v35 = (void *)MEMORY[0x189607870];
      uint64_t v36 = *MEMORY[0x189607460];
      uint64_t v93 = *MEMORY[0x1896075F0];
    ...
    else
    {
      ...
      _NSCoreDataLog( 17LL,  v67,  v68,  v69,  v70,  v71,  v72,  v73,  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Persistence/NSSQLKeypathTriggerAttributeExtension.m");
      uint64_t v74 = (os_log_s *)__pflogFaultLog;
      ...
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v91 = 1024;
      int v92 = 221;
      _os_log_fault_impl( &dword_186681000,  v74,  OS_LOG_TYPE_FAULT,  "CoreData: Illegal attempt to return an error without one in %s:%d",  buf,  0x12u);
    }
...
{
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___NSSQLKeypathTriggerAttributeExtension;
