...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___PFHistoryAnalyzerDefaultObjectState;
  v4 = -[PFHistoryAnalyzerDefaultObjectState init](&v7, sel_init);
  if (v4)
  {
    v4->_analyzedObjectID = (NSManagedObjectID *)(id)[a3 changedObjectID];
    v4->_originalTransactionNumber = (NSNumber *)(id)objc_msgSend( MEMORY[0x189607968],  "numberWithLongLong:",  objc_msgSend( (id)objc_msgSend(a3, "transaction"),  "transactionNumber"));
...
- (void)dealloc
{
  self->_originalTransactionNumber = 0LL;
  self->_tombstone = 0LL;

  self->_finalChangeAuthor = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___PFHistoryAnalyzerDefaultObjectState;
  -[PFHistoryAnalyzerDefaultObjectState dealloc](&v3, sel_dealloc);
}

- (void)updateWithChange:(id)a3
{
  self->_finalTransactionNumber = (NSNumber *)(id)objc_msgSend( MEMORY[0x189607968],  "numberWithLongLong:",  objc_msgSend( (id)objc_msgSend(a3, "transaction"),  "transactionNumber"));
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___PFHistoryAnalyzerDefaultObjectState;
  objc_super v3 = (void *)objc_msgSend( MEMORY[0x189607940],  "stringWithString:",  -[PFHistoryAnalyzerDefaultObjectState description](&v5, sel_description));
