...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CDDCloudKitRegistrationMessage;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___CDDCloudKitRegistrationMessage;
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___CDDCloudKitRegistrationMessage;
