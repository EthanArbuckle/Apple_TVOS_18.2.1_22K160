...
- (TKHostTokenRegistryTransaction)initWithRegistry:(id)a3 name:(id)a4
{
  ...
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___TKHostTokenRegistryTransaction;
  v8 = -[TKHostTokenRegistryTransaction init](&v11, "init");
  v9 = v8;
  if (v8)
  {
...
- (void)commit
{
  ...
  objc_storeWeak((id *)p_registry, 0LL);
}
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_registry);
  v3 = (void *)objc_claimAutoreleasedReturnValue([WeakRetained tokenExtensions]);
...
- (void)dealloc
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___TKHostTokenRegistryTransaction;
  -[TKHostTokenRegistryTransaction dealloc](&v6, "dealloc");
}
