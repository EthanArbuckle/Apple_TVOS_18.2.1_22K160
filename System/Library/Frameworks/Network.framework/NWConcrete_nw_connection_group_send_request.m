...
- (NWConcrete_nw_connection_group_send_request)init
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_connection_group_send_request;
...
{
  v2.receiver = self;
  v2.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_connection_group_send_request;
  -[NWConcrete_nw_connection_group_send_request dealloc](&v2, sel_dealloc);
}

- (NSString)description
{
  return (NSString *)(id)CFStringCreateWithFormat( (CFAllocatorRef)*MEMORY[0x189604DB0],  0LL,  @"<nw_connection_group_send_request>");
}
