...
- (NWConcrete_nw_interface_status_monitor)init
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_interface_status_monitor;
...
{
  v2.receiver = self;
  v2.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_interface_status_monitor;
  -[NWConcrete_nw_interface_status_monitor dealloc](&v2, sel_dealloc);
}

- (NSString)description
{
  return (NSString *)(id)CFStringCreateWithFormat( (CFAllocatorRef)*MEMORY[0x189604DB0],  0LL,  @"<nw_interface_status_monitor %@>",  self->interface);
}
