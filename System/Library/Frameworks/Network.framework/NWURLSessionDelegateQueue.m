...
{
  v3 = *(void **)(a1 + 32);
  if (!v3 || !objc_getProperty(v3, a2, 16LL, 1))
  {
    id v5 = objc_alloc_init(MEMORY[0x189607988]);
    v6 = *(void **)(a1 + 32);
    if (v6) {
      objc_setProperty_atomic(v6, v4, v5, 16LL);
    }
    ...
    id v11 = *(id *)(a1 + 32);
    if (v11) {
      id v11 = objc_getProperty(v11, v10, 16LL, 1);
    }
