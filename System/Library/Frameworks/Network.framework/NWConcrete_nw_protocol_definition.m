...
- (NWConcrete_nw_protocol_definition)init
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_protocol_definition;
...
- (NSString)description
{
  return (NSString *)(id)CFStringCreateWithCString( (CFAllocatorRef)*MEMORY[0x189604DB0],  self->identifier.name,  0x8000100u);
}
...
- (void)dealloc
{
  ...
  if (common_state)
  {
    ...
    common_state->id var10 = 0LL;

    v5 = self->common_state;
    if (v5)
    {
      free(v5);
      self->common_state = 0LL;
    }
  }
  ...
  {
    free(extended_state);
    self->extended_state = 0LL;
  }

  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_protocol_definition;
