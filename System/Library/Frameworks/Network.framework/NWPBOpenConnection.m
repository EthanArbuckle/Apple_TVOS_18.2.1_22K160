...
- (id)description
{
  v3 = (void *)NSString;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___NWPBOpenConnection;
  v4 = -[NWPBOpenConnection description](&v8, sel_description);
  v5 = -[NWPBOpenConnection dictionaryRepresentation](self, "dictionaryRepresentation");
