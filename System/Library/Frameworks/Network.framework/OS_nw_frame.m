...
- (void)dealloc
{
  self[10].super.super.Class isa = 0LL;
  self[11].super.super.Class isa = 0LL;
  Class isa = self[12].super.super.isa;
  if (isa)
  {
    os_release(isa);
    self[12].super.super.Class isa = 0LL;
  }
  ...
  if (v5)
  {
    do
    {
      ...
      {
        os_release(v7);
        v5[6].super.super.Class isa = 0LL;
        Class v8 = v5->super.super.isa;
      }
  ...
  *(_OWORD *)&self[15].super.super.Class isa = 0u;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___OS_nw_frame;
