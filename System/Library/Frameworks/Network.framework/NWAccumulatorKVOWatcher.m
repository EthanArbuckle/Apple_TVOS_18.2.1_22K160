...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NWAccumulatorKVOWatcher;
...
- (id)description
{
  ...
  v4 = -[NWAccumulatorKVOWatcher name](self, "name");
  v5 = -[NWAccumulatorKVOWatcher object](self, "object");
  v6 = -[NWAccumulatorKVOWatcher keyPath](self, "keyPath");
  v7 = -[NWAccumulatorKVOWatcher state](self, "state");
