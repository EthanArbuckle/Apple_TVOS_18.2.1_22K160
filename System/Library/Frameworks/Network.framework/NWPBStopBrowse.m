...
- (id)description
{
  v3 = (void *)NSString;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___NWPBStopBrowse;
  v4 = -[NWPBStopBrowse description](&v8, sel_description);
  v5 = -[NWPBStopBrowse dictionaryRepresentation](self, "dictionaryRepresentation");
