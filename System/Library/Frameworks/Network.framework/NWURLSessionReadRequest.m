...
- (void)tryFulfillRequest
{
  ...
  if (v1)
  {
    if (*(void *)(a1 + 48))
    {
      ...
      objc_setProperty_nonatomic_copy((id)a1, v15, 0LL, 32LL);
      (*((void (**)(dispatch_data_t, void, void, void))data + 2))(data, 0LL, 0LL, *(void *)(a1 + 48));
    }
    ...
    else
    {
      ...
      *(void *)(a1 + 40) = 0LL;
      ...
      if (data)
      {
        ...
        if (v4 > v5)
        {
          ...
          *(void *)(a1 + 40) = subrange;
          ...
          dispatch_data_t v8 = dispatch_data_create_subrange(data, 0LL, *(void *)(a1 + 24));
      ...
      objc_setProperty_nonatomic_copy((id)a1, v14, 0LL, 32LL);
      v13[2](v13);
    }
  }
