...
- (NWConcrete_nw_write_request)init
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_write_request;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___NWConcrete_nw_write_request;
...
- (NSString)description
{
  ...
  return (NSString *)(id)CFStringCreateWithFormat( (CFAllocatorRef)*MEMORY[0x189604DB0],  0LL,  @"<nw_write_request%s%s>",  v2,  v3);
}
