...
{
  v4 = SecOTRPublicIdentityCopyFromPrivate(*MEMORY[0x189604DB0], *(void *)(*(void *)(a1 + 32) + 24LL), 0LL);
  v5[0] = MEMORY[0x1895F87A8];
  v5[1] = 0x40000000LL;
  v5[2] = __SecOTRVerifyAndExposeRaw_locked_block_invoke_2;
  v5[3] = &__block_descriptor_tmp_67_10764;
...
void __SecOTRVerifyAndExposeRaw_locked_block_invoke_2(void *a1, uint64_t a2)
{
  ...
  v4[3] = &__block_descriptor_tmp_66_10765;
...
void __SecOTRVerifyAndExposeRaw_locked_block_invoke_3(void *a1, uint64_t a2)
{
  ...
  v4 = (os_log_s *)secLogObjForScope("OTR");
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    __int128 v5 = (void *)a1[4];
    uint64_t v6 = a1[5];
    uint64_t v7 = v5[10];
    uint64_t v8 = v5[11];
    uint64_t v9 = v5[13];
    ...
    __int16 v28 = 2112;
    uint64_t v29 = v6;
    _os_log_impl( &dword_1804F4000,  v4,  OS_LOG_TYPE_DEFAULT,  "session[%p] failed to decrypt, session: %@, mk: %@, mpk: %@, tpk: %@, tk: %@, chose tktu: %@",  (uint8_t *)&v16,  0x48u);
  }

  v11 = (os_log_s *)secLogObjForScope("OTR");
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v24 = 2112;
    uint64_t v25 = v15;
    _os_log_impl( &dword_1804F4000,  v11,  OS_LOG_TYPE_DEFAULT,  "session[%p] failed to decrypt, mktu: %@, mpi: %@, tpi: %@, m: %@",  (uint8_t *)&v16,  0x34u);
  }
