...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___SecConcrete_sec_protocol_configuration_builder;
    ...
    if (MainBundle)
    {
      ...
      if (InfoDictionary)
      {
        ...
        if (_is_apple_bundle_onceToken != -1) {
          dispatch_once(&_is_apple_bundle_onceToken, &__block_literal_global_4208);
        }
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___SecConcrete_sec_protocol_configuration_builder;
