...
void __SecOTRVerifyAndExposeRawCompact_locked_block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v6[3] = &__block_descriptor_tmp_70_10760;
...
void __SecOTRVerifyAndExposeRawCompact_locked_block_invoke_2(uint64_t a1, uint64_t a2)
{
  ...
  v3[3] = &__block_descriptor_tmp_69_10761;
...
void __SecOTRVerifyAndExposeRawCompact_locked_block_invoke_3(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v30 = 2112;
    uint64_t v31 = v6;
    _os_log_impl( &dword_1804F4000,  v4,  OS_LOG_TYPE_DEFAULT,  "session[%p] failed to decrypt, session: %@, mk: %@, mpk: %@, tpk: %@, tk: %@, chose tktu: %@",  (uint8_t *)&v18,  0x48u);
  }

  char v11 = (os_log_s *)secLogObjForScope("OTR");
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v30 = 1024;
    LODWORD(v31) = v17;
    _os_log_impl( &dword_1804F4000,  v11,  OS_LOG_TYPE_DEFAULT,  "session[%p] failed to decrypt, mktu: %@, mpi: %@, tpi: %@, m: %@, tP: %@, tb: %hhx",  (uint8_t *)&v18,  0x44u);
  }
