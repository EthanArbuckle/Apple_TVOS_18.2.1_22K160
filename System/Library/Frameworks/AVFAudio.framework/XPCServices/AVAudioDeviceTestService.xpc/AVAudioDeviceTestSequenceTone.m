...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___AVAudioDeviceTestSequenceTone;
  result = -[AVAudioDeviceTestSequence init](&v3, "init");
  if (result)
  {
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___AVAudioDeviceTestSequenceTone;
  id v4 = a3;
  -[AVAudioDeviceTestSequence encodeWithCoder:](&v5, "encodeWithCoder:", v4);
...
- (AVAudioDeviceTestSequenceTone)initWithCoder:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___AVAudioDeviceTestSequenceTone;
  objc_super v5 = -[AVAudioDeviceTestSequence initWithCoder:](&v15, "initWithCoder:", v4);
  if (v5)
  {
