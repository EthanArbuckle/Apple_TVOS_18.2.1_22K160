...
- (LSSettingsStoreConfiguration)initWithEndpoint:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___LSSettingsStoreConfiguration;
...
- (LSSettingsStoreConfiguration)initWithCoder:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___LSSettingsStoreConfiguration;
  id v5 = -[LSSettingsStoreConfiguration init](&v9, sel_init);
  if (v5)
  {
...
- (NSXPCListenerEndpoint)endpoint
{
  return (NSXPCListenerEndpoint *)objc_getProperty(self, a2, 8LL, 1);
}
