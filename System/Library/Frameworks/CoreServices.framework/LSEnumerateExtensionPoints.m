...
void ___LSEnumerateExtensionPoints_block_invoke_2(uint64_t a1, uint64_t a2, int a3)
{
  ...
  if (v6)
  {
    ...
    if (v13)
    {
      ...
      {
        unint64_t v15 = ((_DWORD)v13 - 1) & v12;
      }
    ...
    v25[2] = v7;
    *((_DWORD *)v25 + 6) = a3;
    float v26 = (float)(unint64_t)(*(void *)(v8 + 72) + 1LL);
    ...
    if (*(void *)&prime <= v13)
    {
      ...
      {
        uint64_t v40 = 1LL << -(char)__clz(v38 - 1);
        if (v38 >= 2) {
          unint64_t v38 = v40;
        }
      }
    ...
    v32 = operator new(8LL * *(void *)&prime);
    v33 = *(void **)(v8 + 48);
    *(void *)(v8 + 48) = v32;
    if (v33) {
      operator delete(v33);
...
LABEL_80:
    ...
    {
      unint64_t v12 = ((_DWORD)v13 - 1) & v12;
    }
