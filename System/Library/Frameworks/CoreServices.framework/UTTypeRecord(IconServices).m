...
- (void)iconResourceBundleURLWithContext:()IconServices tableID:unitID:unitBytes:.cold.1( uint64_t a1,  unsigned int *a2,  os_log_t log)
{
  ...
  __int16 v6 = 2048;
  uint64_t v7 = v3;
  _os_log_debug_impl( &dword_183E58000,  log,  OS_LOG_TYPE_DEBUG,  "Cannot generate libraryURL for app %@ because it has no libraryPath path stored (%llx)",  (uint8_t *)&v4,  0x16u);
}
