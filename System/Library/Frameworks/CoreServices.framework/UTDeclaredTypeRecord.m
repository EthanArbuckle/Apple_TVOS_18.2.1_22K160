...
{
  char v7 = 0;
  uint64_t result = (*(uint64_t (**)(void, void, uint64_t, uint64_t, uint64_t, char *))(*(void *)(a1 + 32) + 16LL))( *(void *)(a1 + 32),  *(void *)(a1 + 40),  a2,  a3,  a4,  &v7);
  *a5 = v7;
  return result;
}
...
void __50___UTDeclaredTypeRecord_conformsToTypeIdentifier___block_invoke_2(uint64_t a1)
{
  ...
  {
    id v4 = v2;
    [*(id *)(a1 + 40) lowercaseString];
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    *(_BYTE *)(*(void *)(*(void *)(a1 + 48) + 8) + 24) = [v4 containsObject:v3];
