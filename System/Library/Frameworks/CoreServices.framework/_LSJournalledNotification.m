...
- (_LSJournalledNotification)initWithNotification:(int)a3 bundleIDs:(id)a4 plugins:(BOOL)a5 options:(id)a6
{
  ...
  id v12 = a6;
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS____LSJournalledNotification;
...
- (_LSJournalledNotification)initWithCoder:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS____LSJournalledNotification;
  id v5 = -[_LSJournalledNotification init](&v15, sel_init);
  if (v5)
  {
