void sub_1000016D8(id a1)
{
  SecureStorageProvider *v1;
  void *v2;
  v1 = objc_alloc_init(&OBJC_CLASS___SecureStorageProvider);
  v2 = (void *)qword_10003E1A0;
  qword_10003E1A0 = (uint64_t)v1;
}

id sub_100001AB0(uint64_t a1)
{
  id v2 = [[LACDTOMutableKVStoreReadRequest alloc] initWithKey:*(void *)(a1 + 40)];
  [v2 setConnection:*(void *)(a1 + 32)];
  return v2;
}

id sub_100001D14(void *a1)
{
  id v2 = [[LACDTOMutableKVStoreWriteRequest alloc] initWithKey:a1[6] value:a1[4]];
  [v2 setConnection:a1[5]];
  return v2;
}

id sub_100001E30(void *a1)
{
  id v2 = [[LACDTOMutableKVStoreWriteRequest alloc] initWithKey:a1[6] value:a1[4]];
...
id sub_100001F6C(void *a1)
{
  id v2 = [[LACDTOMutableKVStoreWriteRequest alloc] initWithKey:a1[7] value:a1[4]];
  [v2 setContextUUID:a1[5]];
  [v2 setConnection:a1[6]];
  return v2;
}

void sub_1000021C4( _Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, id location)
{
}
...
void sub_1000021E0(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, v10))
  {
    ...
    *(_DWORD *)buf = 67109634;
    ...
    __int16 v30 = 2112;
    id v31 = v6;
    _os_log_impl( (void *)&_mh_execute_header,  v9,  v10,  "Finished KVS query: { key: %d, result: %@, error: %@ }",  buf,  0x1Cu);
  }
  ...
  if (WeakRetained)
  {
    ...
    else if (v5)
    {
      ...
      if ((objc_opt_isKindOfClass(v5, v14) & 1) != 0)
      {
        ...
        id v16 = objc_msgSend( [LACDTOKVStoreValue alloc],  "initWithIntegerValue:",  objc_msgSend(v5, "integerValue"));
      ...
      else
      {
        ...
        char isKindOfClass = objc_opt_isKindOfClass(v5, v21);
        uint64_t v23 = *(void *)(a1 + 32);
        if ((isKindOfClass & 1) != 0)
        {
          id v24 = [[LACDTOKVStoreValue alloc] initWithData:v5];
          (*(void (**)(uint64_t, id, void))(v23 + 16))(v23, v24, 0LL);
        }

        else
        {
          id v24 = (id)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"Unexpected value type for KVS key: %d",  *(void *)(a1 + 56)));
          v25 = (void *)objc_claimAutoreleasedReturnValue( +[LAErrorHelper internalErrorWithMessage:]( &OBJC_CLASS___LAErrorHelper,  "internalErrorWithMessage:",  v24));
    ...
    else
    {
      ...
      id v18 = objc_alloc(&OBJC_CLASS___LACDTOKVStoreValue);
      v19 = objc_alloc_init(&OBJC_CLASS___NSData);
      id v20 = [v18 initWithData:v19];
      (*(void (**)(uint64_t, id, void))(v17 + 16))(v17, v20, 0LL);
    }
  }
}

void sub_1000025D4( _Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
}

void sub_1000025F8(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  uint64_t v7 = LACLogDTOStorage();
  ...
  if (os_log_type_enabled(v8, v10))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v6;
    _os_log_impl( (void *)&_mh_execute_header,  v9,  v10,  "Finished KVS update: { key: %d, result: %@, error: %@ }",  (uint8_t *)v14,  0x1Cu);
  }
...
LABEL_7:
  ...
  os_log_type_t v10 = objc_msgSend(v8, "isEqualToAuditTokenData:");
LABEL_6:
  uint64_t v11 = v10;
LABEL_8:
...
id sub_100002CE0()
{
  if (qword_10003E1C0 != -1) {
    dispatch_once(&qword_10003E1C0, &stru_100030898);
  }
  return (id)qword_10003E1C8;
}

void sub_100002F80(id a1)
{
  v1 = objc_opt_new(&OBJC_CLASS___NSMutableDictionary);
  id v2 = (void *)qword_10003E1B0;
  qword_10003E1B0 = (uint64_t)v1;
}

void sub_100002FF0(id a1)
{
  uint64_t v1 = LALogForCategory(0x40000LL);
  uint64_t v2 = objc_claimAutoreleasedReturnValue(v1);
  v3 = (void *)qword_10003E1C8;
  qword_10003E1C8 = v2;
}

void sub_100003058(id a1)
{
  uint64_t v1 = objc_opt_new(&OBJC_CLASS___EnvironmentManager);
  uint64_t v2 = (void *)qword_10003E1D0;
  qword_10003E1D0 = (uint64_t)v1;
}

LACDTOFeatureController *sub_1000038DC(uint64_t a1)
{
  id v2 = [[LACDTOFeatureRequirementsDataSource alloc] initWithDevice:*(void *)(*(void *)(a1 + 32) + 104) replyQueue:*(void *)(a1 + 40)];
  v3 = objc_alloc(&OBJC_CLASS___LACDTOFeatureController);
  uint64_t v4 = *(void *)(*(void *)(a1 + 32) + 40LL);
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[LACFlags sharedInstance](&OBJC_CLASS___LACFlags, "sharedInstance"));
  id v6 = -[LACDTOFeatureController initWithKVStore:requirementsDataSource:featureFlags:workQueue:]( v3,  "initWithKVStore:requirementsDataSource:featureFlags:workQueue:",  v4,  v2,  v5,  *(void *)(a1 + 40));

  -[LACDTOFeatureController setEventBus:](v6, "setEventBus:", *(void *)(*(void *)(a1 + 32) + 128LL));
  return v6;
}

LACDTOLostModeController *sub_100003988(uint64_t a1)
{
  uint64_t v7 = _NSConcreteStackBlock;
  uint64_t v8 = 3221225472LL;
  v9 = sub_100003A38;
  os_log_type_t v10 = &unk_100030908;
  id v11 = *(id *)(a1 + 32);
  id v12 = *(id *)(a1 + 40);
  id v2 = sub_100003A38((uint64_t)&v7);
  v3 = (void *)objc_claimAutoreleasedReturnValue(v2);
  uint64_t v4 = objc_alloc(&OBJC_CLASS___LACDTOLostModeController);
  id v5 = -[LACDTOLostModeController initWithLostModeProvider:store:workQueue:]( v4,  "initWithLostModeProvider:store:workQueue:",  v3,  *(void *)(*(void *)(a1 + 40) + 40LL),  *(void *)(a1 + 32),  v7,  v8,  v9,  v10);
...
{
  if (_os_feature_enabled_impl("AuthKit", "DTO")) {
    id v2 = [[LACDTOLostModeProviderAKAdapter alloc] initWithWorkQueue:*(void *)(a1 + 32) deviceInfo:*(void *)(*(void *)(a1 + 40) + 104)];
  }
  else {
    id v2 = [[LACDTOLostModeProviderKVSAdapter alloc] initWithKVStore:*(void *)(*(void *)(a1 + 40) + 40)];
  }
  return v2;
}

LACDTORatchetStateMonitor *sub_100003AA0(void *a1)
{
  id v2 = -[LACDTORatchetStateMonitor initWithRatchetStateProvider:workQueue:]( objc_alloc(&OBJC_CLASS___LACDTORatchetStateMonitor),  "initWithRatchetStateProvider:workQueue:",  a1[4],  a1[5]);
  -[LACDTORatchetStateMonitor setEventBus:](v2, "setEventBus:", *(void *)(a1[6] + 128LL));
  [*(id *)(a1[6] + 128) addEventHandler:v2];
  return v2;
}

LACDTOPendingPolicyEvaluationController *sub_100003AF4(void *a1)
{
  id v2 = -[LACDTOPendingPolicyEvaluationController initWithRatchetStateProvider:ratchetHandler:device:evaluationIdentifierFactory:persistentStore:workQueue:]( objc_alloc(&OBJC_CLASS___LACDTOPendingPolicyEvaluationController),  "initWithRatchetStateProvider:ratchetHandler:device:evaluationIdentifierFactory:persistentStore:workQueue:",  *(void *)(a1[4] + 80LL),  a1[5],  *(void *)(a1[4] + 104LL),  a1[6],  *(void *)(a1[4] + 56LL),  a1[7]);
  [*(id *)(a1[4] + 128) addEventHandler:v2];
  return v2;
}

LACDTODarwinNotificationsController *sub_100003B4C(uint64_t a1)
{
  id v2 = -[LACDTODarwinNotificationsController initWithNotificationCenter:]( objc_alloc(&OBJC_CLASS___LACDTODarwinNotificationsController),  "initWithNotificationCenter:",  *(void *)(a1 + 32));
  [*(id *)(*(void *)(a1 + 40) + 128) addEventHandler:v2];
  return v2;
}

LACDTOPolicyProcessorEmptyPasscode *sub_100003B94(uint64_t a1)
{
  id v2 = objc_alloc_init(&OBJC_CLASS___CredentialStore);
  v3 = -[LACDTOPolicyProcessorEmptyPasscode initWithCredentialStore:device:]( objc_alloc(&OBJC_CLASS___LACDTOPolicyProcessorEmptyPasscode),  "initWithCredentialStore:device:",  v2,  *(void *)(*(void *)(a1 + 32) + 104LL));

  return v3;
}

id sub_100003BE8(uint64_t a1)
{
  id v2 = (void *)objc_claimAutoreleasedReturnValue(+[LACKeyBagProvider sharedInstance](&OBJC_CLASS___LACKeyBagProvider, "sharedInstance"));
  id v3 = [v2 keybagForUserId:geteuid()];
  uint64_t v4 = (void *)objc_claimAutoreleasedReturnValue(v3);

  id v5 = objc_alloc(&OBJC_CLASS___LACDTOLocationPrewarmStrategy);
  uint64_t v6 = *(void *)(a1 + 32);
  uint64_t v7 = *(void *)(v6 + 32);
  uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue([*(id *)(v6 + 24) trustStateProvider]);
  id v9 = [v5 initWithFeatureStateProvider:v7 trustStateProvider:v8 device:*(void *)(*(void *)(a1 + 32) + 104) keybag:v4];
...
void sub_1000041D0( _Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, id location)
{
}

void sub_1000041F4(uint64_t a1)
{
  uint64_t v2 = LALogForCategory(256LL);
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    id v7 = WeakRetained;
    __int16 v8 = 1024;
    unsigned int v9 = [v5 hash];
    _os_log_impl( (void *)&_mh_execute_header,  v3,  OS_LOG_TYPE_INFO,  "MainServiceListner connection invalidated: %{public}@ hash: %x",  (uint8_t *)&v6,  0x12u);
  }
}

id sub_100004374(uint64_t a1)
{
  uint64_t v2 = (void *)objc_claimAutoreleasedReturnValue(+[RemoteUIManager sharedInstance](&OBJC_CLASS___RemoteUIManager, "sharedInstance"));
  id v3 = [[LAWeakBox alloc] initWithReceiver:*(void *)(a1 + 32)];
  [v2 setEndpointProvider:v3];

  return v2;
}

void sub_100004610( _Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location, id a17)
{
}

void sub_100004644(uint64_t a1)
{
  uint64_t v2 = LALogForCategory(256LL);
  id v3 = (os_log_s *)objc_claimAutoreleasedReturnValue(v2);
  ...
  uint64_t v4 = (void *)objc_claimAutoreleasedReturnValue(+[RemoteUIManager sharedInstance](&OBJC_CLASS___RemoteUIManager, "sharedInstance"));
  [v4 connectionToViewServiceInvalidated:&stru_100030A68];
}

uint64_t start()
{
  v0 = objc_autoreleasePoolPush();
  uint64_t v1 = (void *)objc_claimAutoreleasedReturnValue(+[DaemonServiceLocator sharedInstance](&OBJC_CLASS___DaemonServiceLocator, "sharedInstance"));
  [v1 startServices];

  uint64_t v2 = -[ListenerWithDelegate initWithMachServiceName:]( objc_alloc(&OBJC_CLASS___MainServiceListener),  "initWithMachServiceName:",  @"com.apple.CoreAuthentication.daemon");
  -[MainServiceListener resume](v2, "resume");
  id v3 = -[ListenerWithDelegate initWithMachServiceName:]( objc_alloc(&OBJC_CLASS___MainServiceListener),  "initWithMachServiceName:",  @"com.apple.CoreAuthentication.daemon.libxpc");
  -[MainServiceListener resume](v3, "resume");
  ...
  handler[2] = sub_10000486C;
  handler[3] = &unk_100030AB8;
  id v5 = v2;
  ...
  id v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSRunLoop currentRunLoop](&OBJC_CLASS___NSRunLoop, "currentRunLoop"));
  [v7 run];
...
void sub_10000486C(id *a1)
{
  ...
  {
    *(_WORD *)uint64_t v4 = 0;
    _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_DEFAULT, "Got SIGTERM, shutting down", v4, 2u);
  }
...
id sub_1000049C4()
{
  if (qword_10003E1E0 != -1) {
    dispatch_once(&qword_10003E1E0, &stru_100030B70);
  }
  return (id)qword_10003E1E8;
}

void sub_100004BB4( _Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
}

uint64_t sub_100004BD0(uint64_t result, uint64_t a2)
{
...
void sub_100004BE8(id a1, NSError *a2)
{
  uint64_t v2 = a2;
  id v3 = sub_1000049C4();
  uint64_t v4 = (os_log_s *)objc_claimAutoreleasedReturnValue(v3);
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR)) {
    sub_100020EE0((uint64_t)v2, v4);
  }
}

void sub_100004C38(uint64_t a1, void *a2)
{
}

void sub_100004D28(id a1)
{
  os_log_t v1 = os_log_create("com.apple.LocalAuthentication", "EndpointProvider");
  uint64_t v2 = (void *)qword_10003E1E8;
  qword_10003E1E8 = (uint64_t)v1;
}

void sub_100005474( _Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
}

uint64_t sub_10000548C(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0LL;
  return result;
...
void sub_1000054A4(uint64_t a1, uint64_t a2, uint64_t a3)
{
  uint64_t v4 = -[NSData initWithBytes:length:](objc_alloc(&OBJC_CLASS___NSData), "initWithBytes:length:", a2, a3);
...
void sub_100005EFC(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v20 = v6;
    __int16 v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( &OBJC_CLASS___NSNumber,  "numberWithInteger:",  LACPolicyOptionAuthenticationIdentifier));
    v23[0] = v8;
    v24[0] = *(void *)(a1 + 32);
    unsigned int v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( &OBJC_CLASS___NSNumber,  "numberWithInteger:",  LACPolicyOptionAuthenticationReason));
    v23[1] = v9;
    v24[1] = &stru_100031490;
    os_log_type_t v10 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( &OBJC_CLASS___NSNumber,  "numberWithInteger:",  LACPolicyOptionAuthenticationCallbackURL));
    v23[2] = v10;
    id v11 = objc_opt_new(&OBJC_CLASS___NSURL);
    v24[2] = v11;
    id v12 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( &OBJC_CLASS___NSNumber,  "numberWithInteger:",  LACPolicyOptionAuthenticationCallbackReason));
    v23[3] = v12;
    v24[3] = &stru_100031490;
    v13 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( &OBJC_CLASS___NSNumber,  "numberWithInteger:",  LACPolicyOptionBeginSecurityDelayImmediately));
    v23[4] = v13;
    v24[4] = &__kCFBooleanTrue;
    uint64_t v14 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( &OBJC_CLASS___NSNumber,  "numberWithInteger:",  LACPolicyOptionCallerAuditTokenUsage));
    v23[5] = v14;
    __int16 v15 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInteger:](&OBJC_CLASS___NSNumber, "numberWithInteger:", LACAuditTokenUsageNone));
    v24[5] = v15;
    id v16 = (os_log_s *)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  v24,  v23,  6LL));
    ...
    uint64_t v18 = v17;
    id v7 = v20;
    [v22 evaluatePolicy:v18 options:v16 uiDelegate:0 reply:v21];
  }

  else
  {
    uint64_t v19 = LACLogDTO();
    id v16 = (os_log_s *)objc_claimAutoreleasedReturnValue(v19);
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
      sub_100020F54((uint64_t)v7, v16);
    }
  }
}

void sub_10000617C(uint64_t a1, void *a2, void *a3)
{
  id v4 = a2;
  id v5 = a3;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl( (void *)&_mh_execute_header,  v7,  OS_LOG_TYPE_DEFAULT,  "Did finish security delay restart with result: %{public}@",  (uint8_t *)&v9,  0xCu);
  }
}
...
void sub_100006314(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  ...
  if (WeakRetained)
  {
    ...
    {
      id v7 = objc_alloc_init(&OBJC_CLASS___DTORatchetStateParser);
      uint64_t v8 = *(void *)(a1 + 32);
      int v9 = (void *)objc_claimAutoreleasedReturnValue(-[DTORatchetStateParser ratchetStateFromState:](v7, "ratchetStateFromState:", v10));
      (*(void (**)(uint64_t, void *, void))(v8 + 16))(v8, v9, 0LL);
    }
  }
}

void sub_100006488(_Unwind_Exception *a1)
{
}

void sub_1000064A4(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  ...
  if (WeakRetained)
  {
    ...
    {
      int v9 = (void *)*((void *)WeakRetained + 2);
...
void sub_1000065B0(_Unwind_Exception *a1)
{
}

void sub_1000065C4(id *a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
...
void sub_1000066F8(uint64_t a1, void *a2, void *a3)
{
  id v15 = a2;
  id v5 = a3;
  ...
  if (WeakRetained)
  {
    ...
    {
      id v7 = objc_alloc_init(&OBJC_CLASS___DTORatchetStateParser);
      uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue(-[DTORatchetStateParser watchdogPackFromState:](v7, "watchdogPackFromState:", *(void *)(a1 + 32)));
      int v9 = (void *)objc_claimAutoreleasedReturnValue(-[DTORatchetStateParser ratchetStateFromState:](v7, "ratchetStateFromState:", *(void *)(a1 + 32)));
      ...
      id v20 = *(id *)(a1 + 32);
      id v10 = v7;
      id v11 = sub_100006888((uint64_t)v16);
      id v12 = (void *)objc_claimAutoreleasedReturnValue(v11);
      uint64_t v13 = *(void *)(a1 + 48);
      id v14 = [[LACDTORatchetStateComposite alloc] initWithRatchetState:v9 gracePeriodState:v12 watchdogs:v8];
      (*(void (**)(uint64_t, id, void))(v13 + 16))(v13, v14, 0LL);
    }
  }
}

id sub_100006888(uint64_t a1)
{
  id v2 = objc_alloc_init(&OBJC_CLASS___LACDTOFeatureEnablementModeCoder);
  id v3 = (void *)objc_claimAutoreleasedReturnValue([v2 decode:*(void *)(a1 + 32)]);

  else {
    uint64_t v4 = objc_claimAutoreleasedReturnValue(+[LACDTOGracePeriodState nullInstance](&OBJC_CLASS___LACDTOGracePeriodState, "nullInstance"));
  }
  id v5 = (void *)v4;
...
void sub_100006EA8(void *a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v4;
    _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_INFO, "%{public}@ interrupted", (uint8_t *)&v9, 0xCu);
  }

  id v5 = (void *)objc_claimAutoreleasedReturnValue( +[LAErrorHelper errorWithCode:message:]( &OBJC_CLASS___LAErrorHelper,  "errorWithCode:message:",  -9LL,  @"Invalidated by client."));
  id v6 = (void *)objc_claimAutoreleasedReturnValue(+[AuthenticationManager sharedInstance](&OBJC_CLASS___AuthenticationManager, "sharedInstance"));
  [v6 cancelWithError:v5 originatorId:a1[7] reply:a1[6]];

  id v7 = (void *)objc_claimAutoreleasedReturnValue(+[DaemonServiceLocator sharedInstance](&OBJC_CLASS___DaemonServiceLocator, "sharedInstance"));
  uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue([v7 uiController]);
  [v8 terminateUserInterfaceWithUUID:a1[5] reason:@"Invalidated by client"];
}

void sub_1000072A4(void *a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = (os_log_s *)a1[4];
...
void sub_10000771C(uint64_t a1, void *a2, void *a3)
{
  id v5 = *(void **)(a1 + 32);
  id v6 = a3;
  id v9 = a2;
  id v7 = (void *)objc_claimAutoreleasedReturnValue([v5 analytics]);
...
void sub_1000077BC(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  ...
  if (v6 && *(void *)(a1 + 40))
  {
    int v10 = (void *)objc_claimAutoreleasedReturnValue(+[PreflightCache sharedInstance](&OBJC_CLASS___PreflightCache, "sharedInstance"));
...
void sub_100007C1C(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  ...
  int v10 = (void *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) analytics]);
  objc_msgSend(v10, "evaluationResult:", objc_msgSend(v6, "code"));

  id v11 = (void *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) analytics]);
  [v11 collectIfNeeded];

  if (v6 && *(void *)(a1 + 40))
  {
    __int16 v12 = (void *)objc_claimAutoreleasedReturnValue(+[PreflightCache sharedInstance](&OBJC_CLASS___PreflightCache, "sharedInstance"));
...
void sub_100007FD8( _Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, id location)
{
}

void sub_100007FFC(id *a1, void *a2)
{
  id v3 = a2;
  ...
  if (WeakRetained)
  {
    if ([v3 rawValue] == (id)1)
    {
      ...
      id v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( NSString,  "stringWithFormat:",  @"No result for request rid: %i",  [a1[4] identifier]));
      id v7 = (void *)objc_claimAutoreleasedReturnValue( +[LACError errorWithCode:debugDescription:]( &OBJC_CLASS___LACError,  "errorWithCode:debugDescription:",  v5,  v6));
...
void sub_100008180(_Unwind_Exception *a1)
{
}
...
void sub_100008194(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue([v7 value]);
    id v6 = (void *)objc_claimAutoreleasedReturnValue([v7 error]);
    (*(void (**)(uint64_t, void *, void *))(v4 + 16))(v4, v5, v6);
  }
}

void sub_1000083E4(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
...
void sub_10000867C(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
void sub_100008914(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
void sub_100008BB0(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
void sub_100008E58(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
void sub_10000911C(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
...
void sub_100009370(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
void sub_1000095E4(uint64_t a1, int a2, void *a3)
{
  uint64_t v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
{
  uint64_t v2 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
...
void sub_100009A34(uint64_t a1, void *a2, void *a3)
{
  id v5 = a3;
  id v6 = *(void **)(a1 + 32);
  id v7 = a2;
  id v8 = (os_log_s *)objc_claimAutoreleasedReturnValue([v6 log]);
  id v9 = v8;
  if (a2)
  {
  ...
  {
    sub_100020FC8((id *)(a1 + 32));
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16LL))();
}

void sub_100009CAC(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
...
void sub_100009F1C(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
...
void sub_10000A150(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  unsigned int v7 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  unsigned int v8 = v7;
  if (v5)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  ...
  {
    sub_100021034((id *)(a1 + 32));
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16LL))();
}

void sub_10000A3C0(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  unsigned int v7 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    unsigned int v8 = [*(id *)(a1 + 32) identifier];
    if (v5) {
      unsigned int v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInteger:]( NSNumber,  "numberWithUnsignedInteger:",  [v5 hash]));
    }
    else {
      unsigned int v9 = v6;
    }
...
void sub_10000A690(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
void sub_10000A924(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
...
void sub_10000AB70(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  unsigned int v7 = (os_log_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) log]);
...
void sub_10000ADC8( void *a1, uint64_t a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
}
...
void sub_10000B000(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  id v6 = v5;
  if (v10)
  {
    unsigned int v7 = (void *)objc_claimAutoreleasedReturnValue( +[LACEvaluationResult resultWithSuccess:]( &OBJC_CLASS___LACEvaluationResult,  "resultWithSuccess:",  v10));
  }
  ...
  else
  {
    ...
    {
      unsigned int v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( NSString,  "stringWithFormat:",  @"Missing either result or error for request rid: %i",  [*(id *)(a1 + 32) identifier]));
      id v8 = (id)objc_claimAutoreleasedReturnValue( +[LAErrorHelper errorWithCode:message:]( &OBJC_CLASS___LAErrorHelper,  "errorWithCode:message:",  -1000LL,  v9));
    }

    unsigned int v7 = (void *)objc_claimAutoreleasedReturnValue( +[LACEvaluationResult resultWithFailure:]( &OBJC_CLASS___LACEvaluationResult,  "resultWithFailure:",  v8));
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16LL))();
}

void sub_10000B418(uint64_t a1)
{
...
{
  os_log_t v1 = objc_opt_new(&OBJC_CLASS___Daemon);
  uint64_t v2 = (void *)qword_10003E1F8;
  qword_10003E1F8 = (uint64_t)v1;
}

BOOL sub_10000B6B8(id a1, NSString *a2)
{
  return 1;
}
...
id sub_10000BA18()
{
  if (qword_10003E208 != -1) {
    dispatch_once(&qword_10003E208, &stru_100031060);
  }
  return (id)qword_10003E210;
}

void sub_10000BA58(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  id v9 = a2;
  id v10 = a5;
  id v11 = a4;
  id v12 = a3;
  id v13 = sub_10000BA18();
  id v14 = (os_log_s *)objc_claimAutoreleasedReturnValue(v13);
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    if (v9) {
      id v15 = (void *)objc_claimAutoreleasedReturnValue([v9 description]);
    }
    else {
      id v15 = v10;
    }
    ...
    __int16 v19 = 1024;
    int v20 = v16;
    _os_log_impl( (void *)&_mh_execute_header,  v14,  OS_LOG_TYPE_INFO,  "returning %{public}@ on connection: %x",  (uint8_t *)&v17,  0x12u);
    if (v9) {
  }
    }
...
{
  id v3 = a2;
  uint64_t v4 = objc_alloc(&OBJC_CLASS___ContextProxy);
  ...
  __int128 v12 = *(_OWORD *)(a1 + 100);
  v18[0] = *(_OWORD *)(a1 + 84);
  v18[1] = v12;
  id v13 = -[ContextProxy initWithContext:processId:userId:auditSessionId:auditToken:cApiOrigin:checkEntitlementBlock:invalidationBlock:callback:clientId:]( v4,  "initWithContext:processId:userId:auditSessionId:auditToken:cApiOrigin:checkEntitlementBlock:invalidationBlock: callback:clientId:",  v3,  v5,  v6,  v7,  v18,  v8,  v9,  v10,  v11);
  id v14 = (void *)objc_claimAutoreleasedReturnValue(+[ContextManager sharedInstance](&OBJC_CLASS___ContextManager, "sharedInstance"));
  [v14 addContextProxy:v13];

  uint64_t v15 = *(void *)(a1 + 56);
  uint64_t v16 = (void *)objc_claimAutoreleasedReturnValue([v3 uuid]);

  int v17 = (void *)objc_claimAutoreleasedReturnValue(-[ContextProxy proxyId](v13, "proxyId"));
  (*(void (**)(uint64_t, ContextProxy *, void *, void *, void))(v15 + 16))(v15, v13, v16, v17, 0LL);
}

void sub_10000BC8C(uint64_t a1, void *a2)
{
  id v4 = a2;
  if (v4)
  {
    id v3 = (void *)objc_claimAutoreleasedReturnValue(+[ContextManager sharedInstance](&OBJC_CLASS___ContextManager, "sharedInstance"));
    [v3 addContext:v4];
...
{
  uint64_t v2 = (void *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) valueForEntitlement:a2]);
  id v3 = [v2 BOOLValue];
...
void sub_10000BFF4(uint64_t a1)
{
  ...
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue( +[LAErrorHelper errorWithCode:subcode:message:]( &OBJC_CLASS___LAErrorHelper,  "errorWithCode:subcode:message:",  -10LL,  20LL,  @"Invalidated due to exceeded number of allocated contexts."));
  [WeakRetained invalidatedWithError:v5];
}

void sub_10000C24C(uint64_t a1, char a2)
{
  if ((a2 & 1) != 0)
  {
    id v5 = (id)objc_claimAutoreleasedReturnValue( [*(id *)(a1 + 32) _proxyWithContext:*(void *)(a1 + 40) callback:*(void *)(a1 + 48) clientId:*(void *)(a1 + 80) request:*(void *)(a1 + 56)]);
    [*(id *)(a1 + 64) addContextProxy:v5];
    uint64_t v3 = *(void *)(a1 + 72);
    id v4 = (void *)objc_claimAutoreleasedReturnValue([v5 proxyId]);
    (*(void (**)(uint64_t, id, void *, void))(v3 + 16))(v3, v5, v4, 0LL);
  }
...
id sub_10000C4B0(uint64_t a1, uint64_t a2)
{
  return [*(id *)(a1 + 32) hasEntitlement:a2];
}

void sub_10000C4BC(uint64_t a1)
{
  id v2 = sub_10000BA18();
  ...
  id v4 = *(void **)(a1 + 48);
  id v5 = (void *)objc_claimAutoreleasedReturnValue( +[LAErrorHelper errorWithCode:subcode:message:]( &OBJC_CLASS___LAErrorHelper,  "errorWithCode:subcode:message:",  -10LL,  20LL,  @"Invalidated due to exceeded number of allocated contexts."));
  [v4 invalidatedWithError:v5];
}

id sub_10000C8FC()
{
  if (qword_10003E218 != -1) {
    dispatch_once(&qword_10003E218, &stru_100031080);
  }
  return (id)qword_10003E220;
}
...
uint64_t sub_10000CDC8(void *a1)
{
  id v2 = sub_10000C8FC();
  uint64_t v3 = (os_log_s *)objc_claimAutoreleasedReturnValue(v2);
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2114;
    uint64_t v13 = v6;
    _os_log_impl( (void *)&_mh_execute_header,  v3,  OS_LOG_TYPE_DEFAULT,  "Posted notification %{public}@, newValue: %{public}@, oldValue: %{public}@",  (uint8_t *)&v8,  0x20u);
  }

  return (*(uint64_t (**)(void))(a1[7] + 16LL))();
}

BOOL sub_10000CE90(id a1, Notification *a2, NSDictionary *a3)
{
  return !-[Notification suspended](a2, "suspended", a3);
}

void sub_10000CEAC(uint64_t a1)
{
  id v2 = (dispatch_queue_s *)objc_claimAutoreleasedReturnValue(+[DaemonUtils queue](&OBJC_CLASS___DaemonUtils, "queue"));
...
void sub_10000D39C(id a1)
{
  uint64_t v1 = LALogForCategory(256LL);
  uint64_t v2 = objc_claimAutoreleasedReturnValue(v1);
  uint64_t v3 = (void *)qword_10003E210;
  qword_10003E210 = v2;
}

void sub_10000D3C4(id a1)
{
  uint64_t v1 = LALogForCategory(0x40000LL);
  uint64_t v2 = objc_claimAutoreleasedReturnValue(v1);
  uint64_t v3 = (void *)qword_10003E220;
  qword_10003E220 = v2;
}

void sub_10000D42C(id a1)
{
  uint64_t v1 = objc_alloc_init(&OBJC_CLASS___DaemonServiceLocator);
  uint64_t v2 = (void *)qword_10003E228;
  qword_10003E228 = (uint64_t)v1;
}
...
void sub_10000DD3C(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    id v4 = -[Context initWithPlugin:processId:userId:auditSessionId:externalizedContext:]( objc_alloc(&OBJC_CLASS___Context),  "initWithPlugin:processId:userId:auditSessionId:externalizedContext:",  v3,  *(unsigned int *)(a1 + 48),  *(unsigned int *)(a1 + 52),  *(unsigned int *)(a1 + 56),  *(void *)(a1 + 32));
    id v5 = [*(id *)(a1 + 32) hash];
    ...
    id v10 = v6;
    id v7 = v4;
    -[Context _registerAcmHashInDaemon:completion:](v7, "_registerAcmHashInDaemon:completion:", v5, v8);
  }
...
void sub_10000E548(uint64_t a1, int a2, void *a3)
{
  id v4 = *(void **)(a1 + 32);
  if (a2)
  {
  ...
  {
    id v6 = a3;
    id v7 = (void *)objc_claimAutoreleasedReturnValue( +[LAErrorHelper errorWithCode:message:]( &OBJC_CLASS___LAErrorHelper,  "errorWithCode:message:",  -1LL,  @"Password authentication timed out."));
...
void sub_10000E788(uint64_t a1, void *a2)
{
  id v6 = a2;
  ...
  {
    id v4 = *(void **)(a1 + 40);
    id v5 = (void *)objc_claimAutoreleasedReturnValue([*(id *)(*(void *)(a1 + 48) + 8) objectForKeyedSubscript:v6]);
...
id sub_10000E918()
{
  if (qword_10003E240 != -1) {
    dispatch_once(&qword_10003E240, &stru_100031160);
  }
  return (id)qword_10003E248;
}

uint64_t sub_10000F060(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 + 32) + 16LL))();
}

void sub_10000F740(id a1)
{
  uint64_t v1 = LALogForCategory(256LL);
  uint64_t v2 = objc_claimAutoreleasedReturnValue(v1);
  id v3 = (void *)qword_10003E248;
  qword_10003E248 = v2;
}

void sub_10000F768( void *a1, os_log_s *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
}
...
void sub_10000F7C0(id a1)
{
  uint64_t v1 = objc_opt_new(&OBJC_CLASS___ContextManager);
  uint64_t v2 = (void *)qword_10003E250;
  qword_10003E250 = (uint64_t)v1;
}
...
{
  return qword_10003E260;
}

void *acm_mem_alloc_data(size_t __size)
{
  id result = calloc(1uLL, __size);
  if (result) {
    qword_10003E268 += __size;
  }
  return result;
}
...
void acm_mem_free_data(void *a1, rsize_t __n)
{
  if (a1)
  {
    ...
    free(a1);
    uint64_t v4 = qword_10003E268 - __n;
    if (qword_10003E268 < __n) {
      uint64_t v4 = 0LL;
    }
    qword_10003E268 = v4;
  }
...
void acm_mem_free(void *a1, rsize_t __n)
{
  if (a1)
  {
    memset_s(a1, __n, 0, __n);
    free(a1);
    uint64_t v4 = qword_10003E270 - __n;
    if (qword_10003E270 < __n) {
      uint64_t v4 = 0LL;
    }
    qword_10003E270 = v4;
  }
...
const char *acm_mem_alloc_info( const char *result, const void *a2, uint64_t a3, const char *a4, int a5, const char *a6)
{
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return (const char *)printf( "%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n",  "ACM",  "acm_mem_alloc_info",  v7,  a2,  a3,  qword_10003E260,  0,  qword_10003E268,  qword_10003E270,  v8,  a5,  v6);
  }
...
const char *acm_mem_free_info( const char *result, const void *a2, unint64_t a3, const char *a4, int a5, const char *a6)
{
  if (a2)
  {
    uint64_t v6 = qword_10003E260 - a3;
    if (qword_10003E260 < a3) {
      uint64_t v6 = 0LL;
    }
    qword_10003E260 = v6;
  }
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return (const char *)printf( "%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n",  "ACM",  "acm_mem_free_info",  v8,  a2,  a3,  qword_10003E260,  0,  qword_10003E268,  qword_10003E270,  v9,  a5,  v7);
  }
...
uint64_t GetSerializedVerifyPolicySize( uint64_t a1, char *__s1, uint64_t a3, uint64_t a4, _DWORD *a5, unsigned int a6, void *a7)
{
  ...
  if (a1 && __s1 && a7)
  {
    ...
    {
      size_t v13 = v12;
      uint64_t result = sub_100010D9C(a5, a6, &v14);
      if (!(_DWORD)result) {
        *a7 = v13 + v14 + 26;
      }
    }
...
uint64_t sub_100010D9C(_DWORD *a1, unsigned int a2, _DWORD *a3)
{
  if (a3)
  {
    *a3 = 0;
              ...
              *a7 = *a1;
              ...
              else
              {
                ...
                *(_DWORD *)(v19 + 1_Block_object_dispose(va, 8) = v15;
                size_t v20 = v18 + 22;
                uint64_t result = sub_100010FC4((uint64_t)a5, a6, (uint64_t)a7, (uint64_t *)&v20);
                if (!(_DWORD)result) {
                  *a8 = v20;
                }
              }
...
uint64_t sub_100010FC4(uint64_t a1, int a2, uint64_t a3, uint64_t *a4)
{
  LODWORD(v6) = a2;
  unsigned int v8 = 70;
    ...
    if ((_DWORD)v6)
    {
      ...
      while (1)
      {
        *(_OWORD *)__src = *(_OWORD *)a1;
        ...
        uint64_t v12 = sub_100013BE8(__src);
        if ((_DWORD)v12) {
          break;
        }
  ...
  if (a2 >= 0x10 && a1 && a3 && a4 && a5 && a6 && a7 && a8)
  {
    *a3 = *(_OWORD *)a1;
    ...
    else
    {
      ...
      uint64_t v8 = sub_1000112FC(a1, a2, &v29, &v28, &v27);
      if (!(_DWORD)v8)
      {
        void *v26 = v19;
        *size_t v20 = v21;
...
uint64_t sub_1000112FC(uint64_t a1, unint64_t a2, unint64_t *a3, void *a4, _DWORD *a5)
{
  uint64_t v10 = &off_10003E000;
  unsigned int v11 = 70;
...
LABEL_24:
  ...
  while (1)
  {
    ...
    *(void *)&v16[v17 + 8] = 0LL;
    ...
    uint64_t v21 = sub_100013BE8(&v16[v17]);
    if ((_DWORD)v21)
    {
      uint64_t v12 = v21;
      unsigned int v11 = 70;
...
uint64_t GetSerializedVerifyAclConstraintSize( int a1, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5, unsigned int a6, uint64_t a7, uint64_t a8, _DWORD *a9, unsigned int a10, void *a11)
{
  ...
  if (a3)
  {
    if (a11)
    {
      ...
      {
        uint64_t result = sub_100010D9C(a9, a10, &v18);
        if (!(_DWORD)result)
        {
          uint64_t v15 = 29LL;
          if (a1 == 32) {
...
uint64_t SerializeVerifyAclConstraint( int a1, _OWORD *a2, const void *a3, unsigned int a4, const void *a5, unsigned int a6, char a7, int a8, _DWORD *a9, unsigned int a10, uint64_t a11, void *a12)
{
  ...
  {
    unsigned int v31 = 0;
    uint64_t result = sub_100010D9C(a9, a10, &v31);
    if (!(_DWORD)result)
    {
      uint64_t v21 = 29LL;
      if (a1 == 32) {
      ...
      else
      {
        ...
        *(_DWORD *)(v26 + 1) = v28;
        uint64_t v30 = v24 + 5;
        uint64_t result = sub_100010FC4((uint64_t)a9, a10, a11, &v30);
        if (!(_DWORD)result) {
          *a12 = v30;
        }
      }
...
LABEL_19:
            if (v22 != v16)
            {
              ...
              if (v16 - (v22 + 1) >= 4)
              {
                ...
                unint64_t v34 = v22 + 5;
                uint64_t v12 = sub_1000112FC(a2, v16, &v34, &v33, &v32);
                if (!(_DWORD)v12)
                {
...
uint64_t GetSerializedProcessAclSize( uint64_t a1, uint64_t a2, unsigned int a3, uint64_t a4, unsigned int a5, uint64_t a6, _DWORD *a7, unsigned int a8, void *a9)
{
  ...
  {
    uint64_t result = sub_100010D9C(a7, a8, &v12);
    if (!(_DWORD)result) {
    ...
    if (!v15 && a8 <= 0xA && (a7 != 0LL) == (a8 != 0))
    {
      ...
      if (!(_DWORD)result)
      {
        ...
        else
        {
          ...
          *(_DWORD *)(a9 + v21) = v17;
          unint64_t v22 = v21 + 4;
          uint64_t result = sub_100010FC4((uint64_t)a7, a8, a9, (uint64_t *)&v22);
          if (!(_DWORD)result) {
            *a10 = v22;
          }
        }
...
LABEL_20:
                            ...
                            else
                            {
                              ...
                              unint64_t v40 = v21 + 4;
                              uint64_t v10 = sub_1000112FC(a1, v17, &v40, &v39, &v38);
                              if (!(_DWORD)v10)
                              {
          ...
          if ((_DWORD)v7 == *((_DWORD *)__s2 + 7))
          {
            ...
            switch(*(_DWORD *)__s1)
            {
              ...
              case 7:
                ...
                BOOL v9 = sub_100012A8C((unint64_t)(__s1 + 4), 0x20uLL, (unint64_t)(__s2 + 4), 32LL);
                if (!v9) {
                  goto LABEL_100;
                }
              ...
              case 0xA:
                ...
                BOOL v9 = sub_100012A8C((unint64_t)__s1 + 36, 0x10uLL, (unint64_t)__s2 + 36, 16LL);
                if (!v9) {
                  goto LABEL_100;
                }
...
LABEL_8:
              ...
              case 0x15:
                ...
                uint64_t v22 = 128LL;
LABEL_103:
                LOBYTE(v9) = sub_100012A8C((unint64_t)v13, v21, (unint64_t)v14, v22);
                goto LABEL_100;
              default:
                return v3;
            }
...
BOOL sub_100012A8C(unint64_t __s1, size_t __n, unint64_t __s2, uint64_t a4)
{
  if (__n != a4) {
    return 0LL;
  }
...
uint64_t LibSer_StorageSetData_GetSize(uint64_t a1, _DWORD *a2, unsigned int a3, void *a4)
{
  ...
  uint64_t result = sub_100010D9C(a2, a3, &v7);
  if (!(_DWORD)result) {
    *a4 = a1 + v7 + 28;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a7)
      {
        ...
        {
          unsigned int v18 = 0;
          uint64_t result = sub_100010D9C(a5, a6, &v18);
          if (!(_DWORD)result)
          {
            if (*a8 < a4 + v18 + 28)
            {
            ...
            else
            {
              ...
              *(_DWORD *)(a7 + 20) = a4;
              ...
              size_t v17 = a4 + 24;
              uint64_t result = sub_100010FC4((uint64_t)a5, a6, a7, (uint64_t *)&v17);
              if (!(_DWORD)result) {
                *a8 = v17;
              }
            }
...
uint64_t LibSer_StorageSetData_Deserialize( uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, void *a5, void *a6, void *a7, _DWORD *a8)
{
  ...
  if (a1 && a2 >= 0x18 && a6 && a3 && a4 && a5 && a7 && a8)
  {
    ...
    *a6 = v11;
    ...
    return sub_1000112FC(a1, a2, v14, a7, a8);
  }
...
uint64_t LibSer_StorageGetData_GetSize(_DWORD *a1, unsigned int a2, void *a3)
{
  ...
  uint64_t result = sub_100010D9C(a1, a2, &v5);
  if (!(_DWORD)result) {
    *a3 = v5 + 25LL;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a6)
      {
        ...
        {
          unsigned int v16 = 0;
          uint64_t result = sub_100010D9C(a4, a5, &v16);
          if (!(_DWORD)result)
          {
            ...
            else
            {
              ...
              *(_BYTE *)(a6 + 20) = a3;
              uint64_t v15 = 21LL;
              uint64_t result = sub_100010FC4((uint64_t)a4, a5, a6, &v15);
              if (!(_DWORD)result) {
                *a7 = v15;
              }
            }
...
uint64_t LibSer_StorageGetData_Deserialize( uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, BOOL *a5, void *a6, _DWORD *a7)
{
  ...
  if (a1 && a2 >= 0x15 && a3 && a4 && a5)
  {
    ...
    *a5 = *(_BYTE *)(a1 + 20) != 0;
    v11[0] = 21LL;
    return sub_1000112FC(a1, a2, v11, a6, a7);
  }
...
uint64_t LibSer_GetUnlockSecret_Serialize(_OWORD *a1, _DWORD *a2, unsigned int a3, _OWORD *a4, void *a5)
{
  ...
  if (a1)
  {
    if (a4)
    {
      ...
      {
        unsigned int v12 = 0;
        uint64_t result = sub_100010D9C(a2, a3, &v12);
        if (!(_DWORD)result)
        {
          ...
          else
          {
            *a4 = *a1;
            uint64_t v11 = 16LL;
            uint64_t result = sub_100010FC4((uint64_t)a2, a3, (uint64_t)a4, &v11);
            if (!(_DWORD)result) {
              *a5 = v11;
            }
          }
...
uint64_t LibSer_GetUnlockSecret_Deserialize( _OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5)
{
  ...
  if (a2 >= 0x10 && a3 && a4)
  {
    if (a5)
    {
      ...
      *a3 = *a1;
      v9[0] = 16LL;
      return sub_1000112FC((uint64_t)a1, a2, v9, a4, a5);
    }
  }
...
uint64_t LibSer_SEPControl_Serialize( _OWORD *a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6, void *a7)
{
  ...
  if (a6)
  {
    ...
    {
      unsigned int v18 = 0;
      uint64_t result = sub_100010D9C(a2, a3, &v18);
      if (!(_DWORD)result)
      {
        if (*a7 < a5 + v18 + 24)
        {
        ...
        else
        {
          ...
          uint64_t v17 = 16LL;
          uint64_t result = sub_100010FC4((uint64_t)a2, a3, a6, &v17);
          if (!(_DWORD)result)
          {
            uint64_t v15 = v17;
            *(_DWORD *)(a6 + v17) = a5;
...
uint64_t LibSer_SEPControl_Deserialize( _OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5, unint64_t *a6, void *a7)
{
  ...
  if (a2 >= 0x18 && a7 && a3 && a4 && a5 && a6)
  {
    *a3 = *a1;
    unint64_t v12 = 16LL;
    uint64_t result = sub_1000112FC((uint64_t)a1, a2, &v12, a4, a5);
    if (!(_DWORD)result)
    {
...
uint64_t sub_100013BE8(_DWORD *a1)
{
  if (!a1) {
    return 4294967293LL;
  }
...
{
  return sub_100014AE4(a1, a2, 0xBu, a3, a4, a5, 0LL, 0, a6, a7, a8, a9, a10);
}

uint64_t sub_100014AE4( uint64_t result, uint64_t a2, unsigned __int8 a3, _OWORD *a4, const void *a5, uint64_t a6, const void *a7, unsigned int a8, unsigned __int8 a9, _DWORD *a10, unsigned int a11, unsigned int a12, uint64_t a13)
{
...
{
  return sub_100014AE4(a1, a2, 0x20u, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);
}
...
LABEL_13:
  ...
  if (v17 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
...
{
  if (byte_10003E199 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
  ...
  uint64_t v6 = 0LL;
  uint64_t v2 = LibCall_ACMContextCreate( (uint64_t (*)(uint64_t, uint64_t, void, void, void, _BYTE *, uint64_t *))sub_1000165BC,  (uint64_t)&v6,  a1,  &byte_10003E199,  1);
  if ((_DWORD)v2)
  {
    sub_10001B4F4();
    unsigned int v3 = 70;
  ...
  if (v3 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    unsigned int v8 = "ACMLib";
    __int16 v9 = 2080;
...
uint64_t sub_1000165BC(uint64_t *a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10003E199 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315394;
  ...
  if (a1)
  {
    ...
    {
      uint64_t v16 = sub_100016F6C(*a1, a2, a3, a4, a5, a6, a7);
      if ((_DWORD)v16) {
        unsigned int v15 = 70;
      }
      else {
  ...
  if (v15 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315650;
    uint64_t v19 = "ACMLib";
    __int16 v20 = 2080;
...
_DWORD *ACMContextCreateWithExternalForm(_OWORD *a1, uint64_t a2)
{
  ...
  uint64_t v8 = 0LL;
  uint64_t v4 = LibCall_ACMContextCreateWithExternalForm( (uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, uint64_t, void *, uint64_t *))sub_1000165BC,  (uint64_t)&v8,  a1,  a2,  &byte_10003E199,  1);
  if (v4)
  {
    if (byte_10003E199 <= 0x28u && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
    {
      int v5 = v4[4];
      *(_DWORD *)buf = 136315650;
      rsize_t v10 = "ACMLib";
  ...
  if (v6 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    rsize_t v10 = "ACMLib";
    __int16 v11 = 2080;
...
{
  unsigned int v4 = byte_10003E199;
  if (byte_10003E199 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v12 = "ACMLib";
  ...
  rsize_t v10 = a1;
  uint64_t v7 = LibCall_ACMContextDelete( (void (*)(uint64_t, uint64_t, void, void *, uint64_t, void, void))sub_1000165BC,  (uint64_t)&v10,  a1,  a2);
  if ((_DWORD)v7) {
    unsigned int v8 = 70;
  }
  else {
  ...
  if (v8 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
...
void ACMContextGetExternalForm(const void *a1, uint64_t a2)
{
  ...
  if (!a1
    || !a2
    || sub_100016D8C()
    || sub_100016F6C((uint64_t)a1, 19, 0, a1, 0x10uLL, 0LL, 0LL))
  {
...
uint64_t sub_100016D8C()
{
  ...
  else
  {
    ...
    uint64_t v0 = IOServiceOpen(MatchingService, mach_task_self_, 0, (io_connect_t *)&dword_10003E278);
    if ((_DWORD)v0)
    {
      unsigned int v4 = 70;
      goto LABEL_10;
  ...
  unsigned int v4 = 10;
LABEL_10:
  if (v4 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v6 = 136315650;
    uint64_t v7 = "ACMLib";
    __int16 v8 = 2080;
...
uint64_t sub_100016F6C(uint64_t a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10003E199 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
  ...
  if (v14)
  {
    ...
    else
    {
      ...
      size_t v22 = v16;
      uint64_t v17 = IOConnectCallStructMethod(dword_10003E278, 0, v14, inputStructCnt, a6, &v22);
      uint64_t v18 = v17;
      if (a1) {
  ...
  if (v20 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    size_t v25 = "ACMLib";
    __int16 v26 = 2080;
...
uint64_t ACMContextAddCredentialWithScope(_OWORD *a1, unsigned int *a2, int a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedAddCredentialSize = sub_100016D8C();
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!(_DWORD)v13) {
          uint64_t v13 = sub_100016F6C((uint64_t)a1, 5, 0, v12, __size, 0LL, 0LL);
        }
        uint64_t v9 = v13;
        size_t v14 = __size;
...
uint64_t ACMContextRemoveCredentialsByTypeAndScope(_OWORD *a1, int a2, int a3)
{
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v7)
      {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_100016F6C((uint64_t)a1, 9, 0, v7, 0x18uLL, 0LL, 0LL);
  ...
  if (v9 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v11 = 136315650;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
  ...
  if (a2 && (v7 & 1) == 0)
  {
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!(_DWORD)v13) {
          uint64_t v13 = sub_100016F6C(a1, 6, 0, v12, __size, 0LL, 0LL);
        }
        uint64_t v9 = v13;
        size_t v14 = __size;
    ...
    else
    {
      ...
      if (v7)
      {
        *(_OWORD *)__int16 v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_100016F6C((uint64_t)a1, 4, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v7)
      {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_100016F6C((uint64_t)a1, 16, 0, v7, 0x18uLL, 0LL, 0LL);
...
uint64_t ACMContextReplacePassphraseCredentialsWithScope(uint64_t a1, _DWORD *a2, uint64_t a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedReplacePassphraseCredentialSize = sub_100016D8C();
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!(_DWORD)v13) {
          uint64_t v13 = sub_100016F6C(a1, 15, 0, v12, __size, 0LL, 0LL);
        }
        uint64_t v9 = v13;
        bzero(v12, __size);
        size_t v14 = __size;
    ...
    else
    {
      ...
      if (v7)
      {
        *(_OWORD *)char v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_100016F6C((uint64_t)a1, 13, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
...
uint64_t ACMContextVerifyPolicy(_OWORD *a1, char *a2, uint64_t a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextVerifyPolicy_Block( (uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_1000165BC,  (uint64_t)&v9,  a1,  a2,  a3);
  if ((_DWORD)v6) {
    unsigned int v7 = 70;
  }
  else {
  ...
  if (v7 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v11 = "ACMLib";
    __int16 v12 = 2080;
...
uint64_t ACMContextVerifyPolicyWithPreflight(_OWORD *a1, char *__s1, uint64_t a3, uint64_t a4)
{
  ...
  uint64_t v11 = a1;
  uint64_t v8 = LibCall_ACMContextVerifyPolicyWithPreflight_Block( (uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_1000165BC,  (uint64_t)&v11,  a1,  __s1,  a3,  a4);
  if ((_DWORD)v8) {
    unsigned int v9 = 70;
  }
  else {
...
void ACMContextVerifyPolicyEx( _OWORD *a1, char *__s1, uint64_t a3, _DWORD *a4, unsigned int a5, uint64_t a6, uint64_t a7)
{
  ...
  __int16 v14 = a1;
  LibCall_ACMContextVerifyPolicyEx_Block( (uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_1000165BC,  (uint64_t)&v14,  a1,  __s1,  a3,  a4,  a5,  a6,  a7);
  if (byte_10003E199 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    __int16 v16 = "ACMLib";
...
{
  unsigned int v9 = a1;
  return LibCall_ACMContextVerifyAclConstraint((uint64_t)sub_1000165BC, (uint64_t)&v9, a1, a2, a3, a4, a5, a6, a7, a8);
}
...
{
  uint64_t v11 = a1;
  return LibCall_ACMContextVerifyAclConstraintForOperation( (uint64_t)sub_1000165BC,  (uint64_t)&v11,  a1,  a2,  a3,  a4,  a5,  a6,  a7,  a8,  a9,  a10);
}
...
uint64_t ACMParseAclAndCopyConstraintCharacteristics(const void *a1, uint64_t a2, uint64_t a3)
{
  ...
  uint64_t SerializedProcessAclSize = sub_100016D8C();
...
LABEL_31:
  ...
  uint64_t v13 = sub_100016F6C(0LL, 20, 0, v9, __size, v12, &__n);
  size_t v11 = __n;
  if ((_DWORD)v13)
  {
    uint64_t v6 = v13;
...
LABEL_13:
  ...
  if (v5 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v8 = 136315650;
    unint64_t v9 = "ACMLib";
    __int16 v10 = 2080;
...
void ACMGetAclAuthMethod(__n128 *a1, uint64_t a2)
{
  ...
  uint64_t v4 = a1;
  LibCall_ACMGetAclAuthMethod_Block((uint64_t)sub_1000165BC, (uint64_t)&v4, a1, a2);
  if (byte_10003E199 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v6 = "ACMLib";
...
uint64_t ACMSetEnvironmentVariable(int a1, const void *a2, size_t a3)
{
  ...
  uint64_t v9 = 0LL;
  uint64_t v6 = LibCall_ACMSetEnvironmentVariable( (uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_1000165BC,  (uint64_t)&v9,  a1,  0LL,  0LL,  0LL,  a2,  a3);
  if ((_DWORD)v6) {
    unsigned int v7 = 70;
  }
  else {
...
uint64_t ACMSetEnvironmentVariableWithAccessPolicy( int a1, _OWORD *a2, _OWORD *a3, uint64_t a4, const void *a5, size_t a6)
{
  ...
  uint64_t v15 = 0LL;
  uint64_t v12 = LibCall_ACMSetEnvironmentVariable( (uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_1000165BC,  (uint64_t)&v15,  a1,  a2,  a3,  a4,  a5,  a6);
  if ((_DWORD)v12) {
    unsigned int v13 = 70;
  }
  else {
  ...
  if (v13 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315906;
    int v17 = "ACMLib";
    __int16 v18 = 2080;
...
uint64_t ACMGetEnvironmentVariable(int a1, uint64_t a2)
{
  ...
  uint64_t v7 = 0LL;
  uint64_t v4 = LibCall_ACMGetEnvironmentVariable_Block( (uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, uint64_t, uint64_t))sub_1000165BC,  (uint64_t)&v7,  a1,  a2);
  if ((_DWORD)v4) {
    unsigned int v5 = 70;
  }
  else {
...
uint64_t ACMKernelControl(int a1, const void *a2, size_t a3, uint64_t a4)
{
  ...
  uint64_t v11 = 0LL;
  uint64_t v8 = LibCall_ACMKernelControl_Block( (uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, uint64_t, uint64_t))sub_1000165BC,  (uint64_t)&v11,  a1,  a2,  a3,  a4);
  if ((_DWORD)v8) {
    unsigned int v9 = 70;
  }
  else {
...
{
  uint64_t v4 = 0LL;
  return LibCall_ACMSEPControl_Block( (uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_1000165BC,  (uint64_t)&v4,  a1,  a2,  0LL,  0LL,  0,  a3);
}

uint64_t ACMSEPControlEx(uint64_t a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6)
{
  uint64_t v7 = 0LL;
  return LibCall_ACMSEPControl_Block( (uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_1000165BC,  (uint64_t)&v7,  a4,  a5,  a1,  a2,  a3,  a6);
}
...
void ACMGlobalContextCredentialGetProperty(int a1, int a2, uint64_t a3)
{
  ...
  uint64_t v6 = 0LL;
  LibCall_ACMGlobalContextCredentialGetProperty_Block((uint64_t)sub_1000165BC, (uint64_t)&v6, a1, a2, a3);
  if (byte_10003E199 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v8 = "ACMLib";
...
void ACMContextCredentialGetProperty(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, uint64_t a4)
{
  ...
  {
    __int16 v9 = a1;
    uint64_t v8 = LibCall_ACMContextCredentialGetProperty( (uint64_t (*)(uint64_t, uint64_t, void, __n128 *, uint64_t, uint64_t, uint64_t, __n128))sub_1000165BC,  (uint64_t)&v9,  a1,  a2,  a3,  (uint64_t)buf,  (uint64_t)&v10);
...
uint64_t ACMContextSetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, const void *a5, size_t a6)
{
  ...
  __int16 v15 = a1;
  uint64_t v12 = LibCall_ACMContextSetData( (uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, void, void))sub_1000165BC,  (uint64_t)&v15,  a1,  a2,  a3,  a4,  a5,  a6);
  if ((_DWORD)v12) {
    unsigned int v13 = 70;
  }
  else {
...
uint64_t ACMContextGetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, uint64_t a5)
{
  ...
  uint64_t v21 = 4LL;
  int v19 = a1;
  uint64_t v10 = LibCall_ACMContextGetData( (uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_1000165BC,  (uint64_t)&v19,  a1,  a2,  1,  a3,  a4,  (uint64_t)&__size,  (uint64_t)&v21);
  if (!(_DWORD)v10)
  {
    uint64_t v11 = __size;
    if (__size)
    {
      ...
      uint64_t v20 = __size;
      __int16 v18 = a1;
      uint64_t v13 = LibCall_ACMContextGetData( (uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_1000165BC,  (uint64_t)&v18,  a1,  a2,  0,  a3,  a4,  (uint64_t)v12,  (uint64_t)&v20);
      uint64_t v14 = v13;
      if (a5 && !(_DWORD)v13) {
...
LABEL_11:
  unsigned int v16 = 70;
LABEL_15:
  if (v16 >= byte_10003E199 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
...
uint64_t ACMContextGetInfo(__int128 *a1, int a2, void *a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextGetInfo( (uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, _OWORD *, unint64_t *))sub_1000165BC,  (uint64_t)&v9,  a1,  a2,  a3);
  if ((_DWORD)v6) {
    unsigned int v7 = 70;
  }
  else {
...
{
  uint64_t v1 = 0LL;
  return LibCall_ACMPing( (uint64_t (*)(uint64_t, uint64_t, void, void, void, void, void))sub_1000165BC,  (uint64_t)&v1,  29LL);
}
...
void sub_10001B4F4()
{
  ...
  if (IOConnectCallScalarMethod(dword_10003E278, 2u, 0LL, 0, &output, &outputCnt)) {
    goto LABEL_8;
  }
  unsigned __int8 v0 = output;
  unsigned int v1 = output;
  byte_10003E199 = output;
...
LABEL_8:
    unsigned int v1 = byte_10003E199;
  }
...
{
  return sub_10001F284(a1, a2, 12, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, 0LL, 0LL);
}

uint64_t sub_10001F284( uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, int a3, _OWORD *a4, unsigned __int8 *a5, uint64_t a6, unsigned __int8 *a7, uint64_t a8, _DWORD *a9, unsigned int a10, unsigned int a11, _DWORD *a12, BOOL *a13, void *a14, unint64_t *a15)
{
...
LABEL_84:
  ...
  if (a5 && a13 && a6)
  {
    uint64_t v25 = sub_1000203AC(a1, a2, a5, a6, a13);
LABEL_76:
    if ((_DWORD)v25) {
      unsigned int v24 = 70;
    }
...
{
  return sub_10001F284(a1, a2, 30, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, a14);
}
...
uint64_t sub_1000203AC( uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, const void *a3, unsigned int a4, _BYTE *a5)
{
  int v19 = 0;
  uint64_t v18 = 4LL;
  size_t v10 = a4;
...
id sub_10002058C(uint64_t a1, uint64_t a2)
{
  uint64_t v10 = 0LL;
  uint64_t v11 = &v10;
  uint64_t v12 = 0x3032000000LL;
  unsigned int v13 = sub_1000206E8;
  uint64_t v14 = sub_1000206F8;
  id v15 = 0LL;
  unsigned int v4 = -[NSXPCConnection initWithMachServiceName:options:]( objc_alloc(&OBJC_CLASS___NSXPCConnection),  "initWithMachServiceName:options:",  @"com.apple.CoreAuthentication.daemon.EndpointProvider",  4096LL);
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSXPCInterface interfaceWithProtocol:]( &OBJC_CLASS___NSXPCInterface,  "interfaceWithProtocol:",  &OBJC_PROTOCOL___LAProtocolEndpointProviderServer));
  -[NSXPCConnection setRemoteObjectInterface:](v4, "setRemoteObjectInterface:", v5);

  -[NSXPCConnection resume](v4, "resume");
  uint64_t v6 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection synchronousRemoteObjectProxyWithErrorHandler:]( v4,  "synchronousRemoteObjectProxyWithErrorHandler:",  &stru_1000311B0));
  v9[0] = _NSConcreteStackBlock;
  v9[1] = 3221225472LL;
  _DWORD v9[2] = sub_100020790;
  unint64_t v9[3] = &unk_100030B50;
  v9[4] = &v10;
...
void sub_1000206D0( _Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
}

uint64_t sub_1000206E8(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0LL;
  return result;
...
void sub_1000206F8(uint64_t a1)
{
}

void sub_100020700(id a1, NSError *a2)
{
  uint64_t v2 = a2;
  id v3 = sub_100020750();
  unsigned int v4 = (os_log_s *)objc_claimAutoreleasedReturnValue(v3);
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG)) {
    sub_100020A94((uint64_t)v2, v4, v5, v6, v7, v8, v9, v10);
  }
}

id sub_100020750()
{
  if (qword_10003E280 != -1) {
    dispatch_once(&qword_10003E280, &stru_1000311D0);
  }
  return (id)qword_10003E288;
}

void sub_100020790(uint64_t a1, void *a2)
{
}

id sub_1000207A0(uint64_t a1)
{
  if (qword_10003E298 != -1) {
    dispatch_once(&qword_10003E298, &stru_1000311F0);
  }
  id v2 = sub_100020750();
  id v3 = (os_log_s *)objc_claimAutoreleasedReturnValue(v2);
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG)) {
    sub_100020C04(v3, v4, v5, v6, v7, v8, v9, v10);
  }

  if (!byte_10003E290)
  {
    if (qword_10003E2A8 != -1) {
      dispatch_once(&qword_10003E2A8, &stru_100031210);
    }
    id v11 = sub_100020750();
    uint64_t v12 = (os_log_s *)objc_claimAutoreleasedReturnValue(v11);
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG)) {
      sub_100020B90(v12, v13, v14, v15, v16, v17, v18, v19);
    }
  ...
  uint64_t v21 = (void *)objc_claimAutoreleasedReturnValue([v20 bundleIdentifier]);

  if (([v21 hasPrefix:@"com.apple.SecurityAgent"] & 1) != 0
    || ([v21 hasPrefix:@"com.apple.authorizationhost"] & 1) != 0)
  {
    unsigned int v22 = 1;
  }
  ...
  {
    unsigned int v22 = [v21 hasPrefix:@"com.apple.AppSSOAgent"];
  }

  id v23 = sub_100020750();
  uint64_t v24 = (os_log_s *)objc_claimAutoreleasedReturnValue(v23);
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG)) {
    sub_100020AF8((uint64_t)v21, v22, v24);
  }

  if (v22)
  {
    id v25 = sub_10002058C(a1, 0xFFFFFFFFLL);
...
void sub_100020934(id a1)
{
  os_log_t v1 = os_log_create("com.apple.LocalAuthentication", "EndpointProvider");
  id v2 = (void *)qword_10003E288;
  qword_10003E288 = (uint64_t)v1;
}

void sub_100020964(id a1)
{
  if (!vproc_swap_string(0LL, 6LL, 0LL, &__s1))
  {
    id v1 = sub_100020750();
    id v2 = (os_log_s *)objc_claimAutoreleasedReturnValue(v1);
    if (os_log_type_enabled(v2, OS_LOG_TYPE_DEBUG)) {
      sub_100020C78((uint64_t)&__s1, v2, v3, v4, v5, v6, v7, v8);
    }

    uint64_t v9 = __s1;
    byte_10003E290 = strcmp(__s1, "System") == 0;
    free(v9);
  }
...
void sub_1000209F4(id a1)
{
  if (!vproc_swap_string(0LL, 6LL, 0LL, &__s1))
  {
    ...
    id v2 = (os_log_s *)objc_claimAutoreleasedReturnValue(v1);
    if (os_log_type_enabled(v2, OS_LOG_TYPE_DEBUG)) {
      sub_100020CE0((uint64_t)&__s1, v2, v3, v4, v5, v6, v7, v8);
    }

    uint64_t v9 = __s1;
    byte_10003E2A0 = strcmp(__s1, "LoginWindow") == 0;
    free(v9);
  }

void sub_100020A84( void *a1, os_log_s *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
}

void sub_100020A94( uint64_t a1, os_log_s *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100020AF8(uint64_t a1, char a2, os_log_t log)
{
  uint64_t v3 = @"YES";
  if ((a2 & 1) == 0) {
    uint64_t v3 = @"NO";
...
void sub_100020B90( os_log_s *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_100020A84((void *)&_mh_execute_header, a1, a3, "runningInLoginWindowContext = %d", a5, a6, a7, a8, 0);
}

void sub_100020C04( os_log_s *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_100020A84((void *)&_mh_execute_header, a1, a3, "runningInSystemContext = %d", a5, a6, a7, a8, 0);
}

void sub_100020C78( uint64_t a1, os_log_s *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100020CE0( uint64_t a1, os_log_s *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100020D48(uint64_t a1, os_log_s *a2)
{
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  id v5 = WeakRetained;
...
void sub_100020EE0(uint64_t a1, os_log_s *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_100020F54(uint64_t a1, os_log_s *a2)
{
  int v2 = 138543362;
  uint64_t v3 = a1;
...
void sub_100020FC8(id *a1)
{
  sub_10000ADC8((void *)&_mh_execute_header, v1, v2, "credentialOfType rid:%u returned %{public}@", v3, v4, v5, v6, v7);
  sub_10000AE00();
}

void sub_100021034(id *a1)
{
  sub_10000ADC8( (void *)&_mh_execute_header,  v1,  v2,  "externalizedContextWithReply rid:%u returned %{public}@",  v3,  v4,  v5,  v6,  v7);
  sub_10000AE00();
}

void sub_1000210A0(id *a1)
{
  sub_10000ADC8( (void *)&_mh_execute_header,  v1,  v2,  "tokenForTransferToUnknownProcess rid:%u returned %{public}@",  v3,  v4,  v5,  v6,  v7);
  sub_10000AE00();
}

void sub_10002110C(uint64_t a1, os_log_s *a2)
{
  int v2 = *(_DWORD *)(a1 + 40);
  v3[0] = 67109120;
  v3[1] = v2;
...
void sub_100021184(uint64_t a1, os_log_s *a2)
{
...
void sub_100021234(uint64_t *a1, os_log_s *a2)
{
  uint64_t v2 = *a1;
  int v3 = 138412290;
  uint64_t v4 = v2;
...
void sub_1000212AC(uint64_t a1, uint64_t a2, os_log_t log)
{
  int v3 = 138543618;
  uint64_t v4 = a1;
  __int16 v5 = 2114;
...
void sub_100021330( uint64_t a1, os_log_s *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100021398( uint64_t a1, os_log_s *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100021400(uint64_t a1, os_log_s *a2)
{
  int v2 = 138543362;
  uint64_t v3 = a1;
...
void sub_100021474(uint64_t a1, uint64_t a2, os_log_t log)
{
  int v3 = 138543618;
  uint64_t v4 = a1;
  __int16 v5 = 2114;
...
id objc_msgSend__connectToExistingContext_callback_clientId_processId_userId_auditSessionId_auditToken_cApiOrigin_checkEntitlementBlock_invalidationBlock_connectionHash_reply_( void *a1, const char *a2, ...)
{
  return objc_msgSend( a1,  "_connectToExistingContext:callback:clientId:processId:userId:auditSessionId:auditToken:cApiOrigin:checkEntitl ementBlock:invalidationBlock:connectionHash:reply:");
}

id objc_msgSend_connectToExistingContext_userId_connection_checkEntitlementBlock_callback_clientId_reply_( void *a1, const char *a2, ...)
{
  return objc_msgSend(a1, "connectToExistingContext:userId:connection:checkEntitlementBlock:callback:clientId:reply:");
}

id objc_msgSend_environmentProviderWithLocationProvider_featureController_ratchetStateProvider_lostModeController_( void *a1, const char *a2, ...)
{
  return objc_msgSend( a1,  "environmentProviderWithLocationProvider:featureController:ratchetStateProvider:lostModeController:");
}

id objc_msgSend_initWithContext_processId_userId_auditSessionId_auditToken_cApiOrigin_checkEntitlementBlock_invalidationBlock_callback_clientId_( void *a1, const char *a2, ...)
{
  return objc_msgSend( a1,  "initWithContext:processId:userId:auditSessionId:auditToken:cApiOrigin:checkEntitlementBlock:invalidationBlock :callback:clientId:");
}

id objc_msgSend_initWithFeatureController_ratchetStateProvider_trustStateProvider_pendingEvaluationController_( void *a1, const char *a2, ...)
{
  return objc_msgSend( a1,  "initWithFeatureController:ratchetStateProvider:trustStateProvider:pendingEvaluationController:");
}

id objc_msgSend_initWithRatchetStateProvider_ratchetHandler_device_evaluationIdentifierFactory_persistentStore_workQueue_( void *a1, const char *a2, ...)
{
  return objc_msgSend( a1,  "initWithRatchetStateProvider:ratchetHandler:device:evaluationIdentifierFactory:persistentStore:workQueue:");
}

id objc_msgSend_managedContextWithExternalizedContext_processId_userId_auditSessionId_reply_( void *a1, const char *a2, ...)
{
  return objc_msgSend(a1, "managedContextWithExternalizedContext:processId:userId:auditSessionId:reply:");
}

id objc_msgSend_verifyPasswordUsingAKS_acmContext_userId_policy_options_bioLockoutRecovery_( void *a1, const char *a2, ...)
{
  return objc_msgSend(a1, "verifyPasswordUsingAKS:acmContext:userId:policy:options:bioLockoutRecovery:");
}
