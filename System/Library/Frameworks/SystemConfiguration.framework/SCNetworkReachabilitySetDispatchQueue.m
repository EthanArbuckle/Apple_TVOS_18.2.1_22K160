...
uint64_t ____SCNetworkReachabilitySetDispatchQueue_block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (*(_BYTE *)(v4 + 112))
  {
    ...
    nw_release(*(void **)(*(void *)(a1 + 32) + 248LL));
    *(void *)(*(void *)(a1 + 32) + 248LL) = nw_retain(a2);
    uint64_t v8 = *(void *)(a1 + 32);
    if (*(_DWORD *)(v8 + 80) <= 1u)
    {
      CrazyIvan46Path = __SCNetworkReachabilityCreateCrazyIvan46Path( *(nw_path **)(v8 + 248),  *(nw_endpoint **)(a1 + 40),  *(nw_parameters **)(v8 + 232),  1);
      uint64_t v8 = *(void *)(a1 + 32);
      if (CrazyIvan46Path)
      {
        v10 = CrazyIvan46Path;
        nw_release(*(void **)(v8 + 248));
        *(void *)(*(void *)(a1 + 32) + 248LL) = v10;
        uint64_t v8 = *(void *)(a1 + 32);
      }
    }
