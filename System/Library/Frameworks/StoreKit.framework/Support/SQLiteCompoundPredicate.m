...
- (unint64_t)hash
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[SQLiteCompoundPredicate predicates](self, "predicates"));
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](combinationOperation, "isEqual:")))
  {
    ...
    id v7 = (NSArray *)objc_claimAutoreleasedReturnValue([v4 predicates]);
    if (predicates == v7)
    {
...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableString stringWithString:](&OBJC_CLASS___NSMutableString, "stringWithString:", @"1"));
  }
