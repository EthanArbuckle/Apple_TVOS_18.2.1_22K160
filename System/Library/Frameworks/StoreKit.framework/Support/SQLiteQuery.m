...
- (void)enumerateMemoryEntitiesUsingBlock:(id)a3
{
  ...
  if (!v6) {
    uint64_t v6 = (objc_class *)objc_opt_class(&OBJC_CLASS___SQLiteMemoryEntity);
  }
  id v7 = (id)objc_claimAutoreleasedReturnValue(-[objc_class defaultProperties](v6, "defaultProperties"));
  -[SQLiteQuery enumerateMemoryEntitiesWithProperties:usingBlock:]( self,  "enumerateMemoryEntitiesWithProperties:usingBlock:",  v7,  v5);
}
...
- (void)enumerateMemoryEntitiesWithProperties:(id)a3 usingBlock:(id)a4
{
  id v11 = a3;
  id v6 = a4;
  id v7 = -[SQLiteQueryDescriptor memoryEntityClass](self->_descriptor, "memoryEntityClass");
  if (!v7) {
    id v7 = (objc_class *)objc_opt_class(&OBJC_CLASS___SQLiteMemoryEntity);
  }
  if ([v11 count])
  {
    ...
    v13[1] = v7;
    id v9 = v6;
    -[SQLiteQuery enumeratePersistentIDsAndProperties:usingBlock:]( self,  "enumeratePersistentIDsAndProperties:usingBlock:",  v11,  v12);
  }
  ...
  else
  {
    ...
    v15[1] = v7;
    id v10 = v6;
    -[SQLiteQuery enumeratePersistentIDsUsingBlock:](self, "enumeratePersistentIDsUsingBlock:", v14);
  }
}
