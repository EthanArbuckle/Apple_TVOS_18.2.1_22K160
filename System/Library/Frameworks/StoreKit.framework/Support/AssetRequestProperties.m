...
- (id)mutableCopyWithZone:(_NSZone *)a3
{
  ...
  objc_super v6 = (NSNumber *)-[NSNumber copyWithZone:](self->_bytesPerSecondLimit, "copyWithZone:", a3);
  ...
  v8 = (NSString *)-[NSString copyWithZone:](self->_duetBudgetingIdentifier, "copyWithZone:", a3);
  ...
  v10 = (NSNumber *)-[NSNumber copyWithZone:](self->_loadingPriority, "copyWithZone:", a3);
  loadingPriority = v5->_loadingPriority;
  v5->_loadingPriority = v10;

  v5->_locateAssetCache = self->_locateAssetCache;
  v12 = (NSString *)-[NSString copyWithZone:](self->_logKey, "copyWithZone:", a3);
  logKey = v5->_logKey;
  v5->_logKey = v12;

  v14 = (NSNumber *)-[NSNumber copyWithZone:](self->_maximumWatchCellularTransferSize, "copyWithZone:", a3);
  maximumWatchCellularTransferSize = v5->_maximumWatchCellularTransferSize;
  v5->_maximumWatchCellularTransferSize = v14;

  v16 = (NSString *)-[NSString copyWithZone:](self->_networkBudgetingIdentifier, "copyWithZone:", a3);
  networkBudgetingIdentifier = v5->_networkBudgetingIdentifier;
  v5->_networkBudgetingIdentifier = v16;

  v18 = (NSArray *)-[NSArray copyWithZone:](self->_protocolClasses, "copyWithZone:", a3);
  ...
  v20 = (NSNumber *)-[NSNumber copyWithZone:](self->_taskPriority, "copyWithZone:", a3);
...
- (AssetDataConsumer)dataConsumer
{
  return (AssetDataConsumer *)objc_getProperty(self, a2, 48LL, 1);
}
