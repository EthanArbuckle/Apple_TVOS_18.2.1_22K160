...
- (void)dealloc
{
  if (self->_database)
  {
    ...
    v3 = (void *)qword_100327BA0;
    if (os_log_type_enabled((os_log_t)qword_100327BA0, OS_LOG_TYPE_FAULT)) {
      sub_10025CAD8((uint64_t)self, v3);
    }
...
- (BOOL)finalizePreparedStatement:(id)a3 error:(id *)a4
{
  ...
  BOOL v9 = sub_100018B78([v7 finalizeStatement]);
  if (!v9)
  {
    id v10 = sub_1000188D8(self->_database);
...
- (BOOL)performSavepoint:(id)a3
{
  ...
  id v7 = (void *)objc_claimAutoreleasedReturnValue([v6 stringByReplacingOccurrencesOfString:@"-" withString:&stru_1002FBA48]);
...
- (void)performTransaction:(id)a3
{
  ...
  os_variant_has_internal_content("com.apple.StoreKit");
  int v6 = v4[2](v4);
...
- (BOOL)addFunction:(id)a3
{
  ...
  else
  {
    ...
    id v7 = (void *)qword_100327BA0;
    if (os_log_type_enabled((os_log_t)qword_100327BA0, OS_LOG_TYPE_FAULT)) {
      sub_10025CC90((uint64_t)self, v7);
    }
    BOOL v6 = 0;
  }
...
- (BOOL)removeFunction:(id)a3
{
  ...
  LOBYTE(self) = -[SQLiteConnection removeFunctionNamed:withArgumentCount:]( self,  "removeFunctionNamed:withArgumentCount:",  v5,  v6);
  return (char)self;
}
...
- (BOOL)removeFunctionNamed:(id)a3 withArgumentCount:(int64_t)a4
{
  ...
  else
  {
    ...
    id v10 = (void *)qword_100327BA0;
    if (os_log_type_enabled((os_log_t)qword_100327BA0, OS_LOG_TYPE_ERROR)) {
      sub_10025CD30((uint64_t)self, v10);
    }
    BOOL v9 = 0;
  }
...
- (BOOL)_close
{
  ...
  id v3 = (void *)qword_100327BA0;
  if (os_log_type_enabled((os_log_t)qword_100327BA0, OS_LOG_TYPE_DEFAULT))
  {
    int v4 = v3;
    v5 = (void *)objc_opt_class(self);
    options = self->_options;
    id v7 = v5;
    id v8 = (void *)objc_claimAutoreleasedReturnValue(-[SQLiteConnectionOptions databasePath](options, "databasePath"));
    int v11 = 138543618;
    uint64_t v12 = v5;
    __int16 v13 = 2114;
    uint64_t v14 = v8;
...
- (BOOL)_executeWithError:(id *)a3 usingBlock:(id)a4
{
  ...
  do
  {
    ...
    if (v10 <= 0x19)
    {
      switch(v10)
      {
        ...
        case 6u:
          ...
          break;
        case 0xAu:
          id v15 = sub_1000188D8(self->_database);
    ...
    if (v10 != 100)
    {
      ...
      {
LABEL_13:
        id v13 = sub_1000188D8(self->_database);
...
- (BOOL)_open
{
  ...
  id v4 = (void *)qword_100327BA0;
  if (os_log_type_enabled((os_log_t)qword_100327BA0, OS_LOG_TYPE_DEFAULT))
  {
    id v5 = v4;
    uint64_t v6 = (void *)objc_opt_class(self);
    options = self->_options;
    id v8 = v6;
  ...
  *(void *)db = 0LL;
  ...
  while (1)
  {
    int v11 = sub_10001899C((sqlite3 **)db, self->_options);
    BOOL v2 = v11 == 0;
    if (!v11) {
      break;
    }
    ...
    {
      char v13 = -[SQLiteConnection _performResetAfterCorruptionError](self, "_performResetAfterCorruptionError") & v10;
      char v10 = 0;
      if ((v13 & 1) != 0) {
        continue;
      }
  ...
  uint64_t v14 = *(sqlite3 **)db;
  self->_database = *(sqlite3 **)db;
  self->_didResetForCorruption = 0;
  sqlite3_create_function( v14,  "timestamp",  0,  1,  0LL,  (void (__cdecl *)(sqlite3_context *, int, sqlite3_value **))sub_100025038,  0LL,  0LL);
  return v2;
}
...
- (BOOL)_performResetAfterCorruptionError
{
  ...
  if ((v5 & 1) != 0)
  {
    ...
    uint64_t v6 = (void *)qword_100327B70;
    if (os_log_type_enabled((os_log_t)qword_100327B70, OS_LOG_TYPE_ERROR)) {
      sub_10025CDC4(v6);
    }
...
- (id)_prepareStatement:(id)a3 error:(id *)a4
{
  ...
  char v13 = sub_10002529C;
  uint64_t v14 = sub_1000252AC;
  id v15 = 0LL;
  id v6 = a3;
  v9[0] = _NSConcreteStackBlock;
  v9[1] = 3221225472LL;
