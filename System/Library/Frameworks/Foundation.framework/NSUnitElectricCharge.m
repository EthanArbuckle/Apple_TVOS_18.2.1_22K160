...
+ (void)initialize
{
  if (&OBJC_CLASS___NSUnitElectricCharge == a1) {
    objc_opt_class();
  }
}
...
+ (id)baseUnit
{
  return +[NSUnitElectricCharge coulombs](&OBJC_CLASS___NSUnitElectricCharge, "coulombs");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitElectricCharge baseUnit](NSUnitElectricCharge, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitElectricCharge baseUnit](NSUnitElectricCharge, "baseUnit"));
  }
  [v4 doubleValue];
  if (v6 >= 1000.0)
  {
    v7 = +[NSUnitElectricCharge kiloampereHours](&OBJC_CLASS___NSUnitElectricCharge, "kiloampereHours");
  }
  ...
  else
  {
    ...
    v7 = +[NSUnitElectricCharge milliampereHours](&OBJC_CLASS___NSUnitElectricCharge, "milliampereHours");
  }
