...
- (NSAttributedStringMarkdownSourcePosition)initWithStartLine:(NSInteger)startLine startColumn:(NSInteger)startColumn endLine:(NSInteger)endLine endColumn:(NSInteger)endColumn
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___NSAttributedStringMarkdownSourcePosition;
...
- (NSAttributedStringMarkdownSourcePosition)initWithStart:(id *)a3 end:(id *)a4
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___NSAttributedStringMarkdownSourcePosition;
  result = -[NSAttributedStringMarkdownSourcePosition init](&v11, sel_init);
  if (result)
  {
    __int128 v7 = *(_OWORD *)&a3->var0;
    __int128 v8 = *(_OWORD *)&a3->var2;
...
- ($915FBD377EA738B5CB203B2EF22C919A)endOffsets
{
  __int128 v3 = *(_OWORD *)&self[1].var3;
...
- (void)setOffsetsFromUTF8:(const char *)a3 size:(unint64_t)a4 usingCache:(id *)a5
{
  __int128 v9 = *(_OWORD *)&a5->var0;
  __int128 v10 = *(_OWORD *)&a5->var2;
  ...
  *(_OWORD *)&self->_startOffsets.utf8Offset = v9;
  ...
  __int128 v11 = *(_OWORD *)&a5->var0;
  __int128 v12 = *(_OWORD *)&a5->var2;
...
- (NSRange)rangeInString:(NSString *)string
{
  ...
  {
    __int128 v7 = -[NSString UTF8String](string, "UTF8String");
    __int128 v8 = (unsigned __int8 *)strlen(v7);
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSAttributedStringMarkdownSourcePosition;
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@{startLine=%lu, startColumn=%lu, endLine=%lu, endColumn=%lu}",  -[NSAttributedStringMarkdownSourcePosition description](&v3, sel_description),  self->_startOffsets.line,  self->_startOffsets.column,  self->_endOffsets.line,  self->_endOffsets.column);
}

- (id)debugDescription
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<%@ %p>{ startPosition = (%lu, %lu), endPosition = (%lu, %lu), utf8Offsets = (%lu, %lu), utf16Offsets = (%lu, %lu), nextCodePoints = (%lu, %lu), currentCodePointUTF16Lengths = (%lu, %lu) }",  objc_opt_class(),  self,  self->_startOffsets.line,  self->_startOffsets.column,  self->_endOffsets.line,  self->_endOffsets.column,  self->_startOffsets.utf8Offset,  self->_endOffsets.utf8Offset,  self->_startOffsets.utf16Offset,  self->_endOffsets.utf16Offset,  self->_startOffsets.utf8NextCodePoint,  self->_endOffsets.utf8NextCodePoint,  self->_startOffsets.utf16CurrentCodePointLength,  self->_endOffsets.utf16CurrentCodePointLength);
}
...
- (void)encodeWithCoder:(id)a3
{
  if ([a3 allowsKeyedCoding])
  {
    ...
    [a3 encodeInteger:self->_endOffsets.utf16CurrentCodePointLength forKey:@"NSEndUTF16CurrentCodePointLength"];
  }

  else
  {
    int64_t v5 = (void *)[MEMORY[0x189603F70] exceptionWithName:*MEMORY[0x189603A60], +[NSString stringWithFormat:]( NSString, "stringWithFormat:", @"%@ cannot be encoded by non-keyed archivers", objc_opt_class()), 0 reason userInfo];
    objc_exception_throw(v5);
    -[NSAttributedStringMarkdownSourcePosition initWithCoder:](v6, v7, v8);
  }
...
- (NSAttributedStringMarkdownSourcePosition)initWithCoder:(id)a3
{
  ...
  if (![a3 allowsKeyedCoding])
  {
    v21 = (void *)[MEMORY[0x189603F70] exceptionWithName:*MEMORY[0x189603A60], +[NSString stringWithFormat:]( NSString, "stringWithFormat:", @"%@ cannot be decoded by non-keyed archivers", objc_opt_class()), 0 reason userInfo];
  ...
  __int128 v26 = 0u;
  __int128 v27 = 0u;
  uint64_t v6 = [&unk_189D1EB40 countByEnumeratingWithState:&v26 objects:v25 count:16];
  if (v6)
  {
    uint64_t v7 = v6;
    ...
    while (2)
    {
      ...
      {
        if (*(void *)v27 != v8) {
          objc_enumerationMutation(&unk_189D1EB40);
        }
      ...
      uint64_t v7 = [&unk_189D1EB40 countByEnumeratingWithState:&v26 objects:v25 count:16];
      if (v7) {
        continue;
      }
      break;
  ...
  NSRange result = -[NSAttributedStringMarkdownSourcePosition initWithStartLine:startColumn:endLine:endColumn:]( objc_alloc(&OBJC_CLASS___NSAttributedStringMarkdownSourcePosition),  "initWithStartLine:startColumn:endLine:endColumn:",  v11,  v12,  v13,  v14);
...
- (unint64_t)hash
{
  ...
  NSInteger v4 = -[NSAttributedStringMarkdownSourcePosition startLine](self, "startLine");
  NSInteger v5 = -[NSAttributedStringMarkdownSourcePosition startColumn](self, "startColumn");
  NSInteger v6 = -[NSAttributedStringMarkdownSourcePosition endLine](self, "endLine");
  NSInteger v7 = -[NSAttributedStringMarkdownSourcePosition endColumn](self, "endColumn");
