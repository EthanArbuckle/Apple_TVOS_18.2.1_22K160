...
void *___NSAttributedStringLoadCMarkIfNeeded_block_invoke()
{
  ...
  if (result)
  {
    ...
    qword_18C496990 = (uint64_t)dlsym(v1, "cmark_node_next");
    ...
    qword_18C496998 = (uint64_t)dlsym(v1, "cmark_iter_get_event_type");
    qword_18C4969A0 = (uint64_t)dlsym(v1, "cmark_render_commonmark");
    ...
    off_18C4969A8 = (uint64_t (*)(void))dlsym(v1, "cmark_gfm_core_extensions_ensure_registered");
    ...
    qword_18C4969B0 = (uint64_t)dlsym(v1, "cmark_parser_new_with_mem");
    ...
    result = (void *)off_18C4969A8();
  }

  _NSAttributedStringLoadCMarkIfNeeded_cmarkLoaded = v1 != 0LL;
  return result;
}
