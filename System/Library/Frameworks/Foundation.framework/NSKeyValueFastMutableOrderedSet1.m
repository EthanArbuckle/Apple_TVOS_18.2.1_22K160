...
- (id)_proxyInitWithContainer:(id)a3 getter:(id)a4
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet1;
...
- (void)_proxyNonGCFinalize
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet1;
...
- (void)getObjects:(id *)a3 range:(_NSRange)a4
{
  ...
  {
    v5.receiver = self;
    v5.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet1;
    -[NSKeyValueFastMutableOrderedSet1 getObjects:range:](&v5, sel_getObjects_range_, a3, a4.location, a4.length);
  }

- (unint64_t)indexOfObject:(id)a3
{
  return (unint64_t)method_invoke(self->super.super._container, self->_nonmutatingMethods->indexOfObject, a3);
}
...
- (id)objectsAtIndexes:(id)a3
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet1;
  return -[NSKeyValueFastMutableOrderedSet1 objectsAtIndexes:](&v5, sel_objectsAtIndexes_, a3);
}
