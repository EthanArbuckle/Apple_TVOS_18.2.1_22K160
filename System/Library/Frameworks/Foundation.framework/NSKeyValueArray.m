...
- (id)_proxyInitWithContainer:(id)a3 getter:(id)a4
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___NSKeyValueArray;
...
- (void)dealloc
{
  ...
  {
    v3.receiver = self;
    v3.super_class = (Class)&OBJC_CLASS___NSKeyValueArray;
...
- (void)getObjects:(id *)a3 range:(_NSRange)a4
{
  ...
  {
    v5.receiver = self;
    v5.super_class = (Class)&OBJC_CLASS___NSKeyValueArray;
    -[NSKeyValueArray getObjects:range:](&v5, sel_getObjects_range_, a3, a4.location, a4.length);
  }
...
- (id)objectsAtIndexes:(id)a3
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___NSKeyValueArray;
  return -[NSKeyValueArray objectsAtIndexes:](&v5, sel_objectsAtIndexes_, a3);
}
