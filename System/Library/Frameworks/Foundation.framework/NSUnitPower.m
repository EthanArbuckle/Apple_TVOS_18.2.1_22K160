...
+ (void)initialize
{
  if (&OBJC_CLASS___NSUnitPower == a1) {
    objc_opt_class();
  }
}
...
+ (id)baseUnit
{
  return +[NSUnitPower watts](&OBJC_CLASS___NSUnitPower, "watts");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitPower baseUnit](NSUnitPower, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitPower baseUnit](NSUnitPower, "baseUnit"));
  }
  [v4 doubleValue];
  if (v6 >= 1000.0)
  {
    v7 = +[NSUnitPower kilowatts](&OBJC_CLASS___NSUnitPower, "kilowatts");
  }
  ...
  else
  {
    ...
    v7 = +[NSUnitPower milliwatts](&OBJC_CLASS___NSUnitPower, "milliwatts");
  }
