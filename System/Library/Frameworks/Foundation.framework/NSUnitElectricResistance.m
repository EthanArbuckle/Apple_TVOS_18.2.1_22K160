...
+ (void)initialize
{
  if (&OBJC_CLASS___NSUnitElectricResistance == a1) {
    objc_opt_class();
  }
}
...
+ (id)baseUnit
{
  return +[NSUnitElectricResistance ohms](&OBJC_CLASS___NSUnitElectricResistance, "ohms");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitElectricResistance baseUnit](NSUnitElectricResistance, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitElectricResistance baseUnit](NSUnitElectricResistance, "baseUnit"));
  }
  [v4 doubleValue];
  if (v6 >= 1000.0)
  {
    v7 = +[NSUnitElectricResistance kiloohms](&OBJC_CLASS___NSUnitElectricResistance, "kiloohms");
  }
  ...
  else
  {
    ...
    v7 = +[NSUnitElectricResistance milliohms](&OBJC_CLASS___NSUnitElectricResistance, "milliohms");
  }
