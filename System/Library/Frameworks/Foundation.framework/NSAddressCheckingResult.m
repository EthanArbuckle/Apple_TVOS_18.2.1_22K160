...
- (NSAddressCheckingResult)initWithRange:(_NSRange)a3 components:(id)a4 underlyingResult:(void *)a5
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___NSAddressCheckingResult;
...
- (NSAddressCheckingResult)initWithRange:(_NSRange)a3 components:(id)a4
{
  return -[NSAddressCheckingResult initWithRange:components:underlyingResult:]( self,  "initWithRange:components:underlyingResult:",  a3.location,  a3.length,  a4,  0LL);
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSAddressCheckingResult;
  -[NSAddressCheckingResult dealloc](&v3, sel_dealloc);
}

- (void)encodeWithCoder:(id)a3
{
  id v5 = -[NSAddressCheckingResult components](self, "components");
...
- (id)resultByAdjustingRangesWithOffset:(int64_t)a3
{
  unint64_t v6 = -[NSAddressCheckingResult range](self, "range");
  NSUInteger v8 = v7;
  ...
  return (id)-[NSAddressCheckingResult _adjustRangesWithOffset:](v14, v15, v16);
}
...
- (BOOL)_adjustRangesWithOffset:(int64_t)a3
{
  ...
  return -[NSAddressCheckingResult components](v9, v10);
}
