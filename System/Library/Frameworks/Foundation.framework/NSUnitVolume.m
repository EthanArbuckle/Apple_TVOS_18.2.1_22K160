...
+ (void)initialize
{
  if (&OBJC_CLASS___NSUnitVolume == a1) {
    objc_opt_class();
  }
}
...
+ (id)baseUnit
{
  return +[NSUnitVolume liters](&OBJC_CLASS___NSUnitVolume, "liters");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if (a4 == 2)
  {
    if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitVolume cups](NSUnitVolume, "cups")) & 1) == 0) {
      id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitVolume cups](NSUnitVolume, "cups"));
    }
    [v4 doubleValue];
    if (v9 >= 15.0)
    {
      v6 = +[NSUnitVolume gallons](&OBJC_CLASS___NSUnitVolume, "gallons");
      return (id)[v4 measurementByConvertingToUnit:v6];
    }

    if (v9 >= 8.0)
    {
      v6 = +[NSUnitVolume quarts](&OBJC_CLASS___NSUnitVolume, "quarts");
      return (id)[v4 measurementByConvertingToUnit:v6];
    }

    if (v9 <= 0.5)
    {
      v6 = +[NSUnitVolume fluidOunces](&OBJC_CLASS___NSUnitVolume, "fluidOunces");
      return (id)[v4 measurementByConvertingToUnit:v6];
    }
  ...
  if (a4 == 1)
  {
    if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitVolume imperialFluidOunces](NSUnitVolume, "imperialFluidOunces")) & 1) == 0) {
      id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitVolume imperialFluidOunces](NSUnitVolume, "imperialFluidOunces"));
    }
    [v4 doubleValue];
    if (v7 >= 160.0)
    {
      v6 = +[NSUnitVolume imperialGallons](&OBJC_CLASS___NSUnitVolume, "imperialGallons");
      return (id)[v4 measurementByConvertingToUnit:v6];
    }
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitVolume baseUnit](NSUnitVolume, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitVolume baseUnit](NSUnitVolume, "baseUnit"));
  }
  [v4 doubleValue];
  if (v5 >= 1000.0)
  {
    v6 = +[NSUnitVolume kiloliters](&OBJC_CLASS___NSUnitVolume, "kiloliters");
    return (id)[v4 measurementByConvertingToUnit:v6];
  }
  ...
  v6 = +[NSUnitVolume centiliters](&OBJC_CLASS___NSUnitVolume, "centiliters");
  return (id)[v4 measurementByConvertingToUnit:v6];
}
