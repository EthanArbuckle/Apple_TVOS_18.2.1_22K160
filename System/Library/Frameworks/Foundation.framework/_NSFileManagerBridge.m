...
- (BOOL)createDirectoryAtPath:(id)a3 withIntermediateDirectories:(BOOL)a4 attributes:(id)a5 error:(id *)a6
{
  ...
  uint64_t v14 = MEMORY[0x186E20F44]((char *)self + OBJC_IVAR____NSFileManagerBridge__impl);
  if (v14)
  {
...
- (id)attributesOfItemAtPath:(id)a3 error:(id *)a4
{
  ...
  uint64_t v9 = MEMORY[0x186E20F44]((char *)self + OBJC_IVAR____NSFileManagerBridge__impl);
  if (v9)
  {
...
- (id)attributesOfFileSystemForPath:(id)a3 error:(id *)a4
{
  id v5 = static String._unconditionallyBridgeFromObjectiveC(_:)(a3);
  unint64_t v7 = v6;
  uint64_t v8 = MEMORY[0x186E20F44]((char *)self + OBJC_IVAR____NSFileManagerBridge__impl);
  if (v8)
  {
    uint64_t v9 = (void *)v8;
...
- (id)destinationOfSymbolicLinkAtPath:(id)a3 error:(id *)a4
{
  id v5 = static String._unconditionallyBridgeFromObjectiveC(_:)(a3);
  unint64_t v7 = v6;
  unint64_t v8 = (char *)self + OBJC_IVAR____NSFileManagerBridge__impl;
  uint64_t v9 = MEMORY[0x186E20F44]((char *)self + OBJC_IVAR____NSFileManagerBridge__impl);
  if (v9)
  {
    id v10 = (void *)v9;
...
- (BOOL)changeCurrentDirectoryPath:(id)a3
{
  ...
  unint64_t v6 = v5;
  uint64_t v7 = MEMORY[0x186E20F44]((char *)self + OBJC_IVAR____NSFileManagerBridge__impl);
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = self;
    char v10 = specialized NSFileManager.withFileSystemRepresentation<A>(for:_:)( (uint64_t)v4,  v6,  (void (*)(_BYTE *))closure #1 in _FileManagerImpl.changeCurrentDirectoryPath(_:),  0LL);
...
- (id)displayNameAtPath:(id)a3
{
  ...
  swift_bridgeObjectRelease();
  Swift::String v8 = (void *)String._bridgeToObjectiveCImpl()();
  swift_bridgeObjectRelease();
  return v8;
}
...
{
  v2 = self;
  unint64_t v3 = static String.homeDirectoryPath(forUser:)(0LL, 0LL);
