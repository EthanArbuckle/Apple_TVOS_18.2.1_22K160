...
- (unsigned)characterAtIndex:(unint64_t)a3
{
  if (self->super.numBytes > a3) {
    return *(_WORD *)(_NSCStringCharToUnicharTable + 2LL * self->super.bytes[a3]);
  }
  ...
  -[NSConstantString getCharacters:range:](v5, v6, v7, v8);
  return result;
}
...
- (BOOL)canBeConvertedToEncoding:(unint64_t)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___NSConstantString;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v10.receiver = self;
      v10.super_class = (Class)&OBJC_CLASS___NSConstantString;
...
- (BOOL)isEqualToString:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___NSConstantString;
...
- (int64_t)compare:(id)a3 options:(unint64_t)a4 range:(_NSRange)a5
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___NSConstantString;
