...
+ (void)initialize
{
  if (&OBJC_CLASS___NSUnitElectricPotentialDifference == a1) {
    objc_opt_class();
  }
}
...
+ (id)baseUnit
{
  return +[NSUnitElectricPotentialDifference volts](&OBJC_CLASS___NSUnitElectricPotentialDifference, "volts");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitElectricPotentialDifference baseUnit](NSUnitElectricPotentialDifference, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitElectricPotentialDifference baseUnit]( NSUnitElectricPotentialDifference,  "baseUnit"));
  }
  [v4 doubleValue];
  if (v6 >= 1000.0)
  {
    v7 = +[NSUnitElectricPotentialDifference kilovolts](&OBJC_CLASS___NSUnitElectricPotentialDifference, "kilovolts");
  }
  ...
  else
  {
    ...
    v7 = +[NSUnitElectricPotentialDifference millivolts](&OBJC_CLASS___NSUnitElectricPotentialDifference, "millivolts");
  }
