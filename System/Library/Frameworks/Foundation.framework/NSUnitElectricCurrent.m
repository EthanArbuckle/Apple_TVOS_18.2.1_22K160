...
+ (void)initialize
{
  if (&OBJC_CLASS___NSUnitElectricCurrent == a1) {
    objc_opt_class();
  }
}
...
+ (id)baseUnit
{
  return +[NSUnitElectricCurrent amperes](&OBJC_CLASS___NSUnitElectricCurrent, "amperes");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitElectricCurrent baseUnit](NSUnitElectricCurrent, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitElectricCurrent baseUnit](NSUnitElectricCurrent, "baseUnit"));
  }
  [v4 doubleValue];
  if (v6 >= 1000.0)
  {
    v7 = +[NSUnitElectricCurrent kiloamperes](&OBJC_CLASS___NSUnitElectricCurrent, "kiloamperes");
  }
  ...
  else
  {
    ...
    v7 = +[NSUnitElectricCurrent milliamperes](&OBJC_CLASS___NSUnitElectricCurrent, "milliamperes");
  }
