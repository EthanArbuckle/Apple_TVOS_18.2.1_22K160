...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  if (&OBJC_CLASS___NSObservationBuffer == a1) {
    return +[NSObservationBuffer allocWithZone:](&OBJC_CLASS___NSConcreteObservationBuffer, "allocWithZone:", a3);
  }
  v4.receiver = a1;
...
+ (id)bufferWithMaximumObjectCount:(unint64_t)a3 fullPolicy:(int64_t)a4 outputQueue:(id)a5
{
  return (id)[objc_alloc((Class)a1) initWithMaximumObjectCount:a3 fullPolicy:a4 outputQueue:a5];
}
...
- (NSObservationBuffer)initWithMaximumObjectCount:(unint64_t)a3 fullPolicy:(int64_t)a4 outputQueue:(id)a5
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___NSObservationBuffer;
