...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  if (&OBJC_CLASS___NSOrderedSetChange == a1) {
    return +[NSOrderedSetChange allocWithZone:](&OBJC_CLASS___NSConcreteOrderedSetChange, "allocWithZone:", a3);
  }
  v4.receiver = a1;
...
- (NSOrderedSetChange)initWithType:(unint64_t)a3 sourceIndex:(unint64_t)a4 destinationIndex:(unint64_t)a5 value:(id)a6
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___NSOrderedSetChange;
