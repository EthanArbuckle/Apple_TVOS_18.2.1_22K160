...
+ (void)initialize
{
  if (&OBJC_CLASS___NSUnitFrequency == a1) {
    objc_opt_class();
  }
}
...
+ (id)baseUnit
{
  return +[NSUnitFrequency hertz](&OBJC_CLASS___NSUnitFrequency, "hertz");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitFrequency baseUnit](NSUnitFrequency, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitFrequency baseUnit](NSUnitFrequency, "baseUnit"));
  }
  [v4 doubleValue];
  if (v6 >= 1000.0)
  {
    v7 = +[NSUnitFrequency kilohertz](&OBJC_CLASS___NSUnitFrequency, "kilohertz");
  }
  ...
  else
  {
    ...
    v7 = +[NSUnitFrequency millihertz](&OBJC_CLASS___NSUnitFrequency, "millihertz");
  }
