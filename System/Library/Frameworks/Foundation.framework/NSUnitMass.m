...
+ (id)baseUnit
{
  return +[NSUnitMass kilograms](&OBJC_CLASS___NSUnitMass, "kilograms");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if (a4 == 2)
  {
    if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitMass poundsMass](NSUnitMass, "poundsMass")) & 1) == 0) {
      id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitMass poundsMass](NSUnitMass, "poundsMass"));
    }
    [v4 doubleValue];
    if (v8 >= 1000.0)
    {
      v6 = +[NSUnitMass shortTons](&OBJC_CLASS___NSUnitMass, "shortTons");
      return (id)[v4 measurementByConvertingToUnit:v6];
    }

    if (v8 <= 0.9)
    {
      v6 = +[NSUnitMass ounces](&OBJC_CLASS___NSUnitMass, "ounces");
      return (id)[v4 measurementByConvertingToUnit:v6];
    }
  ...
  if (a4 == 1)
  {
    if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitMass stones](NSUnitMass, "stones")) & 1) == 0) {
      id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitMass stones](NSUnitMass, "stones"));
    }
    [v4 doubleValue];
    if (v7 <= 0.25)
    {
      v6 = +[NSUnitMass ouncesTroy](&OBJC_CLASS___NSUnitMass, "ouncesTroy");
      return (id)[v4 measurementByConvertingToUnit:v6];
    }
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitMass baseUnit](NSUnitMass, "baseUnit")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitMass baseUnit](NSUnitMass, "baseUnit"));
  }
  [v4 doubleValue];
  if (v5 > 0.001) {
    return v4;
  }
  v6 = +[NSUnitMass grams](&OBJC_CLASS___NSUnitMass, "grams");
  return (id)[v4 measurementByConvertingToUnit:v6];
}
