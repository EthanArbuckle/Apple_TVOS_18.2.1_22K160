...
- (_NSSharedKeySetS)init
{
  ...
  {
    v2.receiver = self;
    v2.super_class = (Class)&OBJC_CLASS____NSSharedKeySetS;
...
- (void)initWithConfiguration:(void *)a1
{
  ...
  v8.receiver = a1;
  v8.super_class = (Class)&OBJC_CLASS____NSSharedKeySetS;
    ...
    *((_DWORD *)v3 + 12) = 0;
    if (a2)
    {
      ...
      *((_DWORD *)v3 + 27) = *(_DWORD *)(a2 + 92);
      if (*(void *)(a2 + 96))
      {
        id v5 = (id)-[_NSSharedKeySetS initWithConfiguration:]( objc_alloc(&OBJC_CLASS____NSSharedKeySetS),  *(void *)(a2 + 96));
        objc_setProperty_atomic(v4, v6, v5, 96LL);
      }
    }
  }
...
- (uint64_t)allKeys
{
  ...
  if (a1[12])
  {
    ...
    while (v3);
    v4 = (void *)[MEMORY[0x189603FA8] arrayWithCapacity:v2];
    unsigned int v5 = 0;
    uint64_t v6 = (a1[26] << (a1[27] == 0));
    unsigned int v7 = v2 - 1;
    do
    {
      objc_super v8 = (void *)MEMORY[0x189603F48];
      if (a1[27])
      {
        if (a1[12])
        {
...
- (unint64_t)indexForKey:(unsigned __int16 *)a3 length:(unint64_t)a4
{
  ...
  if (a4 >= 4)
  {
    ...
    do
    {
      int v7 = 67503105 * v7 + 16974593 * *v8 + 66049 * v8[1] + 257 * v8[2] + v8[3];
      v8 += 4;
    }
...
- (unint64_t)indexForBytes:(char *)a3 length:(unint64_t)a4
{
  ...
  if (a4 >= 4)
  {
    ...
    do
    {
      int v8 = 67503105 * v8 + 16974593 * *v9 + 66049 * v9[1] + (v9[2] | (v9[2] << 8)) + v9[3];
      v9 += 4;
      v7 += 4;
    }

    while (v9 < (unsigned __int8 *)&a3[a4 & 0xFFFFFFFC]);
  }

  if (v9 < (unsigned __int8 *)&a3[a4])
  {
