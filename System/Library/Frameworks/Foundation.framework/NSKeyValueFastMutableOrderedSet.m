...
- (id)_proxyInitWithContainer:(id)a3 getter:(id)a4
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet;
...
- (void)_proxyNonGCFinalize
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet;
...
- (void)insertObjects:(id)a3 atIndexes:(id)a4
{
  ...
  {
    v5.receiver = self;
    v5.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet;
    -[NSKeyValueFastMutableOrderedSet insertObjects:atIndexes:](&v5, sel_insertObjects_atIndexes_, a3, a4);
  }
...
- (void)removeObjectsAtIndexes:(id)a3
{
  ...
  {
    v4.receiver = self;
    v4.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet;
    -[NSKeyValueFastMutableOrderedSet removeObjectsAtIndexes:](&v4, sel_removeObjectsAtIndexes_, a3);
  }
...
- (void)replaceObjectAtIndex:(unint64_t)a3 withObject:(id)a4
{
  ...
  {
    -[NSKeyValueFastMutableOrderedSet removeObjectAtIndex:](self, "removeObjectAtIndex:", a3, v11[0]);
...
- (void)replaceObjectsAtIndexes:(id)a3 withObjects:(id)a4
{
  ...
  else
  {
    v5.receiver = self;
    v5.super_class = (Class)&OBJC_CLASS___NSKeyValueFastMutableOrderedSet;
    -[NSKeyValueFastMutableOrderedSet replaceObjectsAtIndexes:withObjects:]( &v5,  sel_replaceObjectsAtIndexes_withObjects_,  a3,  a4);
  }
