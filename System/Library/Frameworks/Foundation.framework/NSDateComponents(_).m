...
- (uint64_t)encodeWithCoder:()_
{
  if ([a3 allowsKeyedCoding])
  {
    ...
    return objc_msgSend( a3,  "encodeInteger:forKey:",  objc_msgSend(a1, "isLeapMonth"),  @"NS.leapMonth");
  }

  else
  {
    objc_exception_throw((id)[MEMORY[0x189603F70] exceptionWithName:*MEMORY[0x189603A60] reason:@"NSDateComponents requires a keyed encoder" userInfo:0]);
    return -[NSDateComponents(_) initWithCoder:]();
  }
...
- (void)initWithCoder:()_
{
  ...
  if ([a3 containsValueForKey:@"NS.calendar"])
  {
    ...
    if (!v5 || (uint64_t v6 = v5, (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      uint64_t v8 = (const __CFString **)v36;
      uint64_t v9 = &v35;
LABEL_11:
