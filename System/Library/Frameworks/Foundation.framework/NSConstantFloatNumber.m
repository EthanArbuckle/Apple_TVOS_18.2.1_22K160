...
- (void)getValue:(void *)a3 size:(unint64_t)a4
{
  ...
  {
    v4 = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"Cannot get value with size %zu. The type encoded as %s is expected to be %zu bytes",  a4,  "f",  4LL);
    objc_exception_throw((id)[MEMORY[0x189603F70] exceptionWithName:*MEMORY[0x189603A60] reason:v4 userInfo:0]);
    -[NSConstantFloatNumber decimalValue](v7, v5, v6);
  }

- ($2F068FC02377E22BA03580A8162C781E)decimalValue
{
  v5 = objc_alloc(&OBJC_CLASS___NSDecimalNumber);
