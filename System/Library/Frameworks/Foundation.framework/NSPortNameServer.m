...
+ (NSPortNameServer)systemDefaultPortNameServer
{
  ...
  {
    result = +[NSMachBootstrapServer sharedInstance](&OBJC_CLASS___NSMachBootstrapServer, "sharedInstance");
...
+ (id)defaultPortNameServer
{
  return +[NSPortNameServer systemDefaultPortNameServer](&OBJC_CLASS___NSPortNameServer, "systemDefaultPortNameServer");
}
