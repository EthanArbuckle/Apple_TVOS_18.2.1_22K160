...
LABEL_16:
  ...
  if (v10)
  {
    ...
    uint64_t v15 = [objc_alloc(MEMORY[0x189603F18]) _initByAdoptingBuffer:v10 count:v11 size:v11];
  }

  else
  {
    uint64_t v15 = [objc_alloc(MEMORY[0x189603F18]) initWithObjects:v8 count:v20[0]];
  }
