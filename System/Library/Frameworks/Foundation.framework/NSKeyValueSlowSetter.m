...
- (NSKeyValueSlowSetter)initWithContainerClassID:(id)a3 key:(id)a4 containerIsa:(Class)a5
{
  ...
  v12[2] = 0LL;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___NSKeyValueSlowSetter;
  v12[0] = a4;
  return -[NSKeyValueAccessor initWithContainerClassID:key:implementation:selector:extraArguments:count:]( &v11,  sel_initWithContainerClassID_key_implementation_selector_extraArguments_count_,  a3,  a4,  Implementation,  sel_setValue_forKey_,  v12,  1LL);
}
