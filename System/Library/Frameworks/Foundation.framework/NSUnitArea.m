...
+ (id)baseUnit
{
  return +[NSUnitArea squareMeters](&OBJC_CLASS___NSUnitArea, "squareMeters");
}
...
+ (id)_measurementWithNaturalScale:(id)a3 system:(unint64_t)a4
{
  ...
  if (a4 - 1 >= 2)
  {
    if (!a4)
    {
      if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitArea baseUnit](NSUnitArea, "baseUnit")) & 1) == 0) {
        id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitArea baseUnit](NSUnitArea, "baseUnit"));
      }
      [v4 doubleValue];
      if (v7 >= 1000.0)
      {
        v6 = +[NSUnitArea squareKilometers](&OBJC_CLASS___NSUnitArea, "squareKilometers");
        return (id)[v4 measurementByConvertingToUnit:v6];
      }

      if (v7 <= 0.001)
      {
        v6 = +[NSUnitArea squareCentimeters](&OBJC_CLASS___NSUnitArea, "squareCentimeters");
        return (id)[v4 measurementByConvertingToUnit:v6];
      }
    }
  ...
  if ((objc_msgSend( (id)objc_msgSend(a3, "unit"),  "isEqual:",  +[NSUnitArea squareFeet](NSUnitArea, "squareFeet")) & 1) == 0) {
    id v4 = (id)objc_msgSend( v4,  "measurementByConvertingToUnit:",  +[NSUnitArea squareFeet](NSUnitArea, "squareFeet"));
  }
  [v4 doubleValue];
  if (v5 >= 27880000.0)
  {
    v6 = +[NSUnitArea squareMiles](&OBJC_CLASS___NSUnitArea, "squareMiles");
    return (id)[v4 measurementByConvertingToUnit:v6];
  }

  if (v5 >= 900.0)
  {
    v6 = +[NSUnitArea squareYards](&OBJC_CLASS___NSUnitArea, "squareYards");
    return (id)[v4 measurementByConvertingToUnit:v6];
  }
  ...
  v6 = +[NSUnitArea squareInches](&OBJC_CLASS___NSUnitArea, "squareInches");
  return (id)[v4 measurementByConvertingToUnit:v6];
}
