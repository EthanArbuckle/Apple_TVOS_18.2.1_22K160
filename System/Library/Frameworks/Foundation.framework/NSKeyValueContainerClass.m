...
- (NSKeyValueContainerClass)initWithOriginalClass:(Class)a3
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___NSKeyValueContainerClass;
...
- (id)description
{
  ...
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<%@: Original class: %@, Notifying class: %@>",  v3,  originalClass,  var1);
}
