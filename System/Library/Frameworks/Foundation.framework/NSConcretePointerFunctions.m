...
+ (BOOL)initializeSlice:(NSSlice *)a3 withOptions:(unint64_t)a4
{
  ...
  unint64_t v8 = a4 & 0xFFFFFFFFFFFF0000LL;
...
+ (void)initializeBackingStore:(NSSlice *)a3 sentinel:(BOOL)a4 weakAutoreleasing:(BOOL)a5 dynamic:(BOOL)a6
{
  ...
  {
    unint64_t v8 = (__int128 *)&weakBarriers;
    int v9 = *((unsigned __int8 *)acquisitionProps + 2);
    if (a5)
    {
      unint64_t v8 = (__int128 *)&weakBarriersAutoreleasing;
...
LABEL_11:
  v12 = (NSSliceInternalProperties *)malloc(0x40uLL);
  __int128 v13 = v11[1];
  *(_OWORD *)v12 = *v11;
  *((_OWORD *)v12 + 1) = v13;
  __int128 v14 = v11[3];
...
- (NSConcretePointerFunctions)init
{
  return -[NSConcretePointerFunctions initWithOptions:](self, "initWithOptions:", 0LL);
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___NSConcretePointerFunctions;
  -[NSConcretePointerFunctions dealloc](&v3, sel_dealloc);
}

- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v4 = objc_alloc(&OBJC_CLASS___NSConcretePointerFunctions);
