...
LABEL_14:
  ...
  uint64_t MediaSubType = CMFormatDescriptionGetMediaSubType(v6);

  id v8 = +[NSString stringWithUTF8String:]( &OBJC_CLASS___NSString,  "stringWithUTF8String:",  RPStringUtility_FourccToCStr(MediaSubType));
