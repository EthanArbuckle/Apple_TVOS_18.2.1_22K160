...
- (DetermineIntent)init
{
  ...
  return -[DetermineIntent init](&v3, "init");
}
...
- (DetermineIntent)initWithCoder:(id)a3
{
  ...
  return -[DetermineIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (DetermineIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for DetermineIntent();
  v11 = -[DetermineIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (DetermineIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for DetermineIntent();
  v15 = -[DetermineIntent initWithDomain:verb:parametersByName:]( &v17,  "initWithDomain:verb:parametersByName:",  v12,  v13,  v14.super.isa);
