...
- (void)executor:(LNActionExecutor *)a3 environmentForViewSnippetWithCompletion:(id)a4
{
  ...
  id v7 = (void *)swift_allocObject(&unk_1F6D50, 40LL, 7LL);
  v7[2] = a3;
  v7[3] = v6;
  v7[4] = self;
  id v8 = a3;
...
{
  id v6 = _Block_copy(a4);
  uint64_t v7 = swift_allocObject(&unk_1F6D28, 24LL, 7LL);
  *(void *)(v7 + 16) = v6;
  id v8 = a3;
  id v9 = self;
  AnonymousConnectionDelegate.executor(_:needsAppProtectionUnlockWithCompletionHandler:)( (uint64_t)v9,  (uint64_t)partial apply for thunk for @escaping @callee_unowned @convention(block) (@unowned ObjCBool) -> (),  v7);
...
- (void).cxx_destruct
{
  __swift_destroy_boxed_opaque_existential_1Tm((Class *)((char *)&self->super.isa
                                                       + OBJC_IVAR____TtC18SiriLinkFlowPlugin27AnonymousConnectionDelegate_aceService));
