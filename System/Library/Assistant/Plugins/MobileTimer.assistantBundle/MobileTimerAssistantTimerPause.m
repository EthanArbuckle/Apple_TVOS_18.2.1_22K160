...
- (void)performWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG)) {
    sub_120AC(v6, v7, v8, v9, v10, v11, v12, v13);
  }

  -[MobileTimerAssistantTimerPause _performWithCompletion:](self, "_performWithCompletion:", v4);
  uint64_t v14 = MTLogForCategory(4LL);
  v15 = (os_log_s *)objc_claimAutoreleasedReturnValue(v14);
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
    sub_1203C(v15, v16, v17, v18, v19, v20, v21, v22);
  }
}
...
- (void)_performWithCompletion:(id)a3
{
  ...
  *((void *)&buf + 1) = &buf;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    sub_12170((uint64_t)self, v18, v40);
  }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    ...
    sub_1211C((uint64_t)self, v22, v39);
  }

  +[MTAnalytics incrementEventCount:](&OBJC_CLASS___MTAnalytics, "incrementEventCount:", kMTCASiriTimerPauses);
