...
- (void)performWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG)) {
    sub_106C8(v6, v7, v8, v9, v10, v11, v12, v13);
  }

  -[MobileTimerAssistantAlarmSnooze _performWithCompletion:](self, "_performWithCompletion:", v4);
  uint64_t v14 = MTLogForCategory(3LL);
  v15 = (os_log_s *)objc_claimAutoreleasedReturnValue(v14);
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
    sub_10658(v15, v16, v17, v18, v19, v20, v21, v22);
  }
}
...
- (void)_performWithCompletion:(id)a3
{
  ...
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue(-[MobileTimerAssistantAlarmSnooze description](self, "description"));
  uint64_t v6 = (void *)objc_claimAutoreleasedReturnValue(-[MobileTimerAssistantAlarmSnooze alarmIds](self, "alarmIds"));
  if ([v6 count])
  {
    uint64_t v7 = (void *)objc_claimAutoreleasedReturnValue(-[MobileTimerAssistantAlarmSnooze _alarmManager](self, "_alarmManager"));
    ...
    *(void *)&buf[16] = 0x3032000000LL;
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
      {
        ...
        sub_1078C((uint64_t)self, v21, v46);
      }
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
      {
        ...
        sub_10738((uint64_t)self, v25, v45);
      }
    }

    +[MTAnalytics incrementEventCount:]( &OBJC_CLASS___MTAnalytics,  "incrementEventCount:",  kMTCASiriAlarmSnoozes,  v28,  v30,  v31,  v32,  v33);
