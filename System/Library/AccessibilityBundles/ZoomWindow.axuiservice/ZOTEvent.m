...
- (id)_initWithDeviceIdentifier:(unint64_t)a3 andEventRepresentation:(id)a4
{
  id v6 = a4;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___ZOTEvent;
  v7 = -[ZOTEvent initWithDeviceIdentifier:](&v11, "initWithDeviceIdentifier:", a3);
  v8 = v7;
  if (v7)
  {
    -[ZOTEvent setRecord:](v7, "setRecord:", v6);
    -[ZOTEvent _addFingerInformation](v8, "_addFingerInformation");
    v9 = v8;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = objc_msgSend( objc_msgSend((id)objc_opt_class(self), "allocWithZone:", a3),  "_initWithDeviceIdentifier:andEventRepresentation:",  -[ZOTEvent deviceIdentifier](self, "deviceIdentifier"),  v5);
...
- (void)_addFingerInformation
{
  id v3 = (void *)objc_claimAutoreleasedReturnValue(-[AXEventRepresentation handInfo](self->_record, "handInfo"));
...
LABEL_15:
  ...
  if (*p_weCare)
  {
    ...
    if (v13 != 1 || v12 != 0)
    {
      ...
      __int128 v32 = 0u;
      __int128 v33 = 0u;
      v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "paths", 0));
...
- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"[%p] event type: %d - event rep: %@",  self,  -[AXEventRepresentation type](self->_record, "type"),  self->_record);
}
...
- (unsigned)handEventType
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[AXEventRepresentation handInfo](self->_record, "handInfo"));
