...
- (AUADSPAudioDevice)initWithDeviceUID:(id)a3 underlyingDevice:(id)a4 deviceDSPDatabase:(id)a5 plugin:(id)a6
{
  ...
  id v9 = a5;
  id v10 = a6;
  result = (AUADSPAudioDevice *)_swift_stdlib_reportUnimplementedInitializer( "AUASDCore.AUADSPAudioDevice",  27LL,  "init(deviceUID:underlyingDevice:deviceDSPDatabase:plugin:)",  58LL,  0LL);
  __break(1u);
  return result;
}
