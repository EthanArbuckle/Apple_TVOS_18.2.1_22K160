...
- (BOOL)changeScalarValue:(float)a3
{
  ...
  char v5 = self;
  *(float *)&double v6 = v4;
  unsigned int v7 = -[AUAGainControl changeDecibelValue:](v5, "changeDecibelValue:", v6);
  if (v7)
  {
    *(float *)&double v8 = a3;
    -[AUAGainControl setScalarValue:](v5, "setScalarValue:", v8);
  }
...
{
  id v10 = a9;
  result = (_TtC9AUASDCore14AUAGainControl *)_swift_stdlib_reportUnimplementedInitializer( "AUASDCore.AUAGainControl",  24LL,  "init(decibelValue:minimumValue:maximumValue:isSettable:forElement:inScope :with:andObjectClassID:)",  97LL,  0LL);
  __break(1u);
  return result;
}
