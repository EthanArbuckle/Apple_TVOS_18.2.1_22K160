...
{
  v5 = self;
  LOBYTE(a3) = sub_10001ED18((unsigned int *)a3);
...
{
  id v7 = a6;
  result = (_TtC9AUASDCore24AUAStreamSelectorControl *)_swift_stdlib_reportUnimplementedInitializer( "AUASDCore.AUAStreamSelectorControl",  34LL,  "init(isSettable:forElement:inScope:with:andObjectClassID:)",  58LL,  0LL);
  __break(1u);
  return result;
}
