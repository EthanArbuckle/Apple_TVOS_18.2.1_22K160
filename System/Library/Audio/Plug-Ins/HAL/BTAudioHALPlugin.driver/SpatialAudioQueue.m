...
- (SpatialAudioQueue)initWithStreamInfo:(id)a3
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___SpatialAudioQueue;
  v5 = -[SpatialAudioQueue init](&v11, "init");
  v6 = v5;
  if (v5)
  {
    v10[0] = 0LL;
    v10[1] = 0LL;
    sub_52B28((uint64_t)v10, (uint64_t)&v5->queueMutex);
    *(void *)&v6->_streamInfo.mClientProcessID = v4;
    *(_DWORD *)&v6->_streamInfo.mSpatializationStatus = v3;
    ++v6->_audioQueueRef;
    v7 = (os_log_s *)qword_95A80;
...
- (void)dealloc
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___SpatialAudioQueue;
  -[SpatialAudioQueue dealloc](&v8, "dealloc");
}
...
- (BOOL)updateStreamInfo:(id)a3
{
  ...
  v16[0] = 0LL;
  v16[1] = 0LL;
  sub_52B28((uint64_t)v16, (uint64_t)&self->queueMutex);
  if ((_BYTE)v3)
  {
  ...
  objc_super v8 = (os_log_s *)qword_95A80;
  if (os_log_type_enabled((os_log_t)qword_95A80, OS_LOG_TYPE_DEFAULT))
  {
    int mClientProcessID = self->_streamInfo.mClientProcessID;
    int mNumChannels = self->_streamInfo.mNumChannels;
...
- (void)setStreamInfo:(id)a3
{
  ...
  objc_copyStruct(&self->_streamInfo, &v3, 12LL, 1, 0);
}
