...
- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"usage: %ld, usagePage: %ld, collection:%ld, instance:%ld, controlType:%ld, rank:%ld",  -[SCROGenericHIDControlInfo usage](self, "usage"),  -[SCROGenericHIDControlInfo usagePage](self, "usagePage"),  -[SCROGenericHIDControlInfo collectionUsage](self, "collectionUsage"),  -[SCROGenericHIDControlInfo instanceNumber](self, "instanceNumber"),  -[SCROGenericHIDControlInfo controlType](self, "controlType"),  -[SCROGenericHIDControlInfo finalRank](self, "finalRank"));
}
