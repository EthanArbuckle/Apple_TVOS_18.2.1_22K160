...
- (VOTElementSnapshot)initWithLabel:(id)a3 value:(id)a4 traits:(unint64_t)a5 rowRange:(_NSRange)a6 frame:(CGRect)a7
{
  ...
  id v17 = a4;
  v24.receiver = self;
  v24.super_class = (Class)&OBJC_CLASS___VOTElementSnapshot;
  v18 = -[VOTElementSnapshot init](&v24, "init");
  if (v18)
  {
...
- (NSString)description
{
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[VOTElementSnapshot label](self, "label"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[VOTElementSnapshot value](self, "value"));
  v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedLongLong:]( &OBJC_CLASS___NSNumber,  "numberWithUnsignedLongLong:",  -[VOTElementSnapshot traits](self, "traits")));
  -[VOTElementSnapshot frame](self, "frame");
  v6 = NSStringFromCGRect(v10);
  v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"VOTElementSnapshot<%p>. Label:%@ Value:%@ traits:%@ frame:%@",  self,  v3,  v4,  v5,  v7));
