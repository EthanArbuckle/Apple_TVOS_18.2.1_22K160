...
- (BOOL)isCurrent:(unint64_t)a3 withHUDUpdateInterval:(double)a4
{
  double v7 = sub_100014AF4(a3 - -[HTHangHUDInfo receivedTimestamp](self, "receivedTimestamp"));
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
    sub_100016658((uint64_t)v8, v10, v7);
  }

  if (-[HTHangHUDInfo hangEndTime](self, "hangEndTime") == 0x7FFFFFFFFFFFFFFFLL
    || sub_100014AF4(a3 - -[HTHangHUDInfo hangEndTime](self, "hangEndTime")) >= 200.0)
  {
