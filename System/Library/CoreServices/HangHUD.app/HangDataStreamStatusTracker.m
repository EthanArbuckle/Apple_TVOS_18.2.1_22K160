...
+ (id)sharedInstance
{
  ...
  block[2] = sub_100002EC0;
  block[3] = &unk_100028898;
  block[4] = a1;
  if (qword_1000364A8 != -1) {
    dispatch_once(&qword_1000364A8, block);
  }
  return (id)qword_1000364A0;
}
...
- (BOOL)isHangEndedWithDuration:(double)a3 updateInterval:(double)a4 hangID:(id)a5
{
  ...
  {
    if (v20) {
      sub_1000158FC((uint64_t)v8, v19, v21, v22, v23, v24, v25, v26);
    }
  }
  ...
  {
    if (v20) {
      sub_100015894((uint64_t)v8, v19, v21, v22, v23, v24, v25, v26);
    }
