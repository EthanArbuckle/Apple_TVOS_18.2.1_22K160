...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_1000365B8 != -1) {
    dispatch_once(&qword_1000365B8, &stru_100029960);
  }
  return (NSArray *)(id)qword_1000365C0;
}
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0LL; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = -[__CFString isEqualToString:](v14, "isEqualToString:", &stru_100029C00);
        if (v15) {
          v16 = v29;
        }
        else {
  ...
  if (os_log_type_enabled((os_log_t)obj, OS_LOG_TYPE_DEBUG)) {
    sub_10001680C((uint64_t)v29, (uint64_t)a4, (os_log_t)obj);
  }
  v19 = 0LL;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (!-[NSString isEqualToString:](v9, "isEqualToString:", v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
      sub_100016890((uint64_t)v9, &self->_enablementPrefix, v11);
    }
  }
...
- (void)initPropertyReportPeriod:(HTPrefInit *)a3
{
  ...
  double v7 = v6 * 1000.0 / sub_100014A6C();
...
+ (id)sharedPrefs
{
  if (qword_1000365D0 != -1) {
    dispatch_once(&qword_1000365D0, &stru_100029980);
  }
  return (id)qword_1000365C8;
}
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *(_OWORD *)&result[13].var2.var0 = xmmword_10001C0D0;
...
- (void)__createInternalSettings
{
  ...
  CFPreferencesSetValue( @"HangTracerInternalSettingsVersion",  &off_10002D4E8,  self->__htTaskingDomain,  @"mobile",  kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0LL;
  ...
  notify_register_dispatch(off_100036480, v30 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_100036468, (int *)v39 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_100036470, v36 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_100036478, v33 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_100036488, v26 + 6, (dispatch_queue_t)self->__prefsQueue, v21);
  -[HTPrefs setShouldPostHTPrefsChangedNotification:](self, "setShouldPostHTPrefsChangedNotification:", 1LL);
