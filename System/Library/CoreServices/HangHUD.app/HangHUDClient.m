...
+ (id)sharedInstance
{
  ...
  block[2] = sub_10000BF18;
  block[3] = &unk_100028898;
  block[4] = a1;
  if (qword_100036560 != -1) {
    dispatch_once(&qword_100036560, block);
  }
  return (id)qword_100036558;
}
...
- (id)obtainKeepHangHUDAliveAssertion:(id)a3
{
  ...
  v9 = -[RBSAssertion initWithExplanation:target:attributes:](v4, "initWithExplanation:target:attributes:", v3, v6, v8);
...
- (void)sendHangHUDInfo:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG)) {
    sub_100016428(v9, v10, v11, v12, v13, v14, v15, v16);
  }
...
- (void)sendProcExitRecord:(id)a3 completion:(id)a4
{
  ...
  v9 = (os_log_s *)objc_claimAutoreleasedReturnValue(v8);
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG)) {
    sub_100016498(v9, v10, v11, v12, v13, v14, v15, v16);
  }
...
- (void)sendHudConfiguration:(id)a3 completion:(id)a4
{
  ...
  v9 = (os_log_s *)objc_claimAutoreleasedReturnValue(v8);
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG)) {
    sub_100016508(v9, v10, v11, v12, v13, v14, v15, v16);
  }
...
- (void)sendMonitoredStates:(id)a3 completion:(id)a4
{
  ...
  v9 = (os_log_s *)objc_claimAutoreleasedReturnValue(v8);
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG)) {
    sub_100016578(v9, v10, v11, v12, v13, v14, v15, v16);
  }
...
- (void)clearHUDWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG)) {
    sub_1000165E8(v6, v7, v8, v9, v10, v11, v12, v13);
  }
