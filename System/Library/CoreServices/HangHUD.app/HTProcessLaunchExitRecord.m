...
+ (void)fetchProcessRecords
{
  if (qword_1000364C0 != -1) {
    dispatch_once(&qword_1000364C0, &stru_1000288D8);
  }
  id v34 = 0LL;
  v35 = 0LL;
  uint64_t v36 = 0LL;
  ...
  else
  {
    ...
    if ((_DWORD)v36)
    {
      ...
      do
      {
        ...
        double v13 = sub_100014BA8(*(void *)&v10[v8 + 4]);
        double v14 = sub_100014BA8(*(void *)&v10[v8 + 12]);
    ...
    for (unint64_t i = 0; i < (unint64_t)[(id)qword_1000364C8 count]; ++i)
    {
      v19 = (void *)objc_claimAutoreleasedReturnValue([(id)qword_1000364C8 objectAtIndex:i]);
      ...
      LODWORD(v20) = sub_100014BA8((unint64_t)[v21 runloopHangTimeoutDurationMSec] + 30000) < (double)(v17 - (unint64_t)v20);

      if ((_DWORD)v20)
      {
        id v23 = sub_1000031C4();
        v24 = (os_log_s *)objc_claimAutoreleasedReturnValue(v23);
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          double v25 = sub_100014AF4(v22);
          ...
          v28 = (void *)objc_claimAutoreleasedReturnValue([(id)qword_1000364C8 getDescription:i]);
    ...
    [(id)qword_1000364C8 removeObjectsAtIndexes:v4];
    v29 = (void *)os_transaction_create("com.apple.hangreporter.launch-exit-records");
    [(id)qword_1000364C8 setTransaction:v29];
    ...
    v32 = (dispatch_source_s *)objc_claimAutoreleasedReturnValue([(id)qword_1000364C8 timer]);
...
+ (id)getProcessExitsAndLaunchesDuringHang:(unint64_t)a3 endTime:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218240;
    double v56 = sub_100014AF4(a3);
    __int16 v57 = 2048;
    double v58 = sub_100014AF4(a4);
  ...
  if ([(id)qword_1000364C8 count])
  {
    uint64_t v6 = 0LL;
    unsigned int v7 = 1;
    do
    {
      uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue([(id)qword_1000364C8 objectAtIndex:v6]);
      v53[0] = @"processName";
      ...
      v48 = (void *)objc_claimAutoreleasedReturnValue([(id)qword_1000364C8 dateFormatter]);
      id v9 = sub_100002D78((uint64_t)[v8 spawnTimestamp], v41, v39);
      v47 = (void *)objc_claimAutoreleasedReturnValue(v9);
      v46 = (void *)objc_claimAutoreleasedReturnValue([v48 stringFromDate:v47]);
      v54[2] = v46;
      v53[3] = @"exitTimestamp";
      v45 = (void *)objc_claimAutoreleasedReturnValue([(id)qword_1000364C8 dateFormatter]);
      id v10 = sub_100002D78((uint64_t)[v8 exitTimestamp], v41, v39);
      ...
      uint64_t v15 = +[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", v14, sub_100014B48(v13));
      ...
      v21 = +[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", v20, sub_100014B48(v19));
      unint64_t v22 = (void *)objc_claimAutoreleasedReturnValue(v21);
      v54[5] = v22;
      v53[6] = @"processUptime";
      id v23 = +[NSString stringWithFormat:]( NSString,  "stringWithFormat:",  @"%.3lfs",  sub_100014B48((_BYTE *)[v8 exitTimestamp] - (_BYTE *)objc_msgSend(v8, "spawnTimestamp")));
      v24 = (void *)objc_claimAutoreleasedReturnValue(v23);
      v54[6] = v24;
      v53[7] = @"exitReasonCode";
      id v25 = sub_10000DBCC((int)[v8 exitReasonNamespace], (uint64_t)objc_msgSend(v8, "exitReasonCode"));
      v26 = (void *)objc_claimAutoreleasedReturnValue(v25);
      v54[7] = v26;
      v53[8] = @"exitReasonNamespace";
      v27 = sub_10000CD58([v8 exitReasonNamespace]);
    ...
    while ((unint64_t)[(id)qword_1000364C8 count] > v7++);
  }
...
- (BOOL)isCurrent:(unint64_t)a3 withHUDUpdateInterval:(double)a4
{
  return sub_100014AF4(a3 - self->_requestedToRenderTimestamp) < 200.0;
}
