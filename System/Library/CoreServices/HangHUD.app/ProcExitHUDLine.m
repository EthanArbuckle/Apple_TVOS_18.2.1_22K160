...
- (ProcExitHUDLine)initWithProcExitRecord:(id)a3 theme:(id)a4 lineDelegate:(id)a5
{
  ...
  if (v11)
  {
    -[HUDLine setSpacing:](v11, "setSpacing:", sub_100014378());
    ...
    -[HUDLineDelegate setFont:](v11->super._lineDelegate, "setFont:", qword_100036530);
    sub_100013ED0();
    ...
    if (qword_100036548 != -1) {
      dispatch_once(&qword_100036548, &stru_100028D28);
    }
    [v16 setFont:qword_100036550];
    sub_100013ED0();
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue(+[NSSet setWithObject:](&OBJC_CLASS___NSSet, "setWithObject:", &off_10002D4D0));
    ...
    if ((v20 & 1) == 0)
    {
      id v21 = sub_10000CDB0([v8 exitReasonNamespace]);
    ...
    [v23 setFont:qword_100036540];
    sub_100013ED0();
    objc_msgSend(v23, "setFontSize:");
    -[HUDLine contentScaleForTexts](v11, "contentScaleForTexts");
    objc_msgSend(v23, "setContentsScale:");
    [v23 setAlignmentMode:kCAAlignmentRight];
    id v24 = sub_10000DD04((int)[v8 exitReasonNamespace], (uint64_t)objc_msgSend(v8, "exitReasonCode"));
