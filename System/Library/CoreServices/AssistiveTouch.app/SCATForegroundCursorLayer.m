...
- (void)updatePath:(id)a3 frame:(CGRect)a4 isSimpleRect:(BOOL)a5 animated:(BOOL)a6 options:(int)a7
{
  ...
  if (v15)
  {
    id v16 = v15;
    double v17 = -2.0;
    if (-[SCATCursorLayer usesHighVisibility](self, "usesHighVisibility"))
    {
      v18 = (void *)objc_claimAutoreleasedReturnValue(-[SCATCursorLayer styleProvider](self, "styleProvider"));
    ...
    if (v9)
    {
      ...
      v22 = (void *)objc_claimAutoreleasedReturnValue( +[UIBezierPath bezierPathWithRoundedRect:cornerRadius:]( &OBJC_CLASS___UIBezierPath,  "bezierPathWithRoundedRect:cornerRadius:",  v20 * 0.5,  v20 * 0.5,  width,  height,  v21));
    ...
    {
      id v23 = v16;
      v24 = (const void *)AX_CGCreatePathPathWithUniformInset([v23 CGPath], v17);
      v22 = (void *)objc_claimAutoreleasedReturnValue(+[UIBezierPath bezierPathWithCGPath:](&OBJC_CLASS___UIBezierPath, "bezierPathWithCGPath:", v24));
  ...
  v25.receiver = self;
  v25.super_class = (Class)&OBJC_CLASS___SCATForegroundCursorLayer;
...
{
  BOOL v6 = a5;
  BOOL v8 = (void *)objc_claimAutoreleasedReturnValue(-[SCATCursorLayer styleProvider](self, "styleProvider", a3, a4, a5, *(void *)&a6));
