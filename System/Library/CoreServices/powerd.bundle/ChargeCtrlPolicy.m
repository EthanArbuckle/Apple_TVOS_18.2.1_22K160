...
{
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___ChargeCtrlPolicy;
  v10 = -[ChargeCtrlPolicy init](&v16, "init");
  v11 = v10;
  if (v10)
  {
    v10->_drain = a4;
    ...
    v10->_owner = a6;
    v10->_terminated = 0;
    uint64_t v12 = objc_claimAutoreleasedReturnValue(+[NSUUID UUID](&OBJC_CLASS___NSUUID, "UUID"));
    token = v11->_token;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[ChargeCtrlPolicy reason](self, "reason"));
  [v4 encodeObject:v5 forKey:@"reason"];

  id v6 = (id)objc_claimAutoreleasedReturnValue(-[ChargeCtrlPolicy token](self, "token"));
...
- (ChargeCtrlPolicy)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ChargeCtrlPolicy;
  v5 = -[ChargeCtrlPolicy init](&v12, "init");
  if (v5)
  {
    ...
    uint64_t v6 = objc_claimAutoreleasedReturnValue([v4 decodeObjectForKey:@"reason"]);
    reason = v5->_reason;
    v5->_reason = (NSString *)v6;

    uint64_t v8 = objc_claimAutoreleasedReturnValue([v4 decodeObjectForKey:@"token"]);
    token = v5->_token;
    v5->_token = (NSUUID *)v8;
