...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___OSAStabilityRate;
  v6 = -[OSAStabilityRate init](&v11, "init");
  v7 = v6;
  if (v6)
  {
    v6->_uptime = a3;
    ...
    if (a4)
    {
      uint64_t v8 = objc_claimAutoreleasedReturnValue(+[NSNumber numberWithDouble:](&OBJC_CLASS___NSNumber, "numberWithDouble:", a3 / (double)a4));
      MTBF = v7->_MTBF;
