...
- (ACCHIDServerRemote)initWithXPCConnection:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___ACCHIDServerRemote;
  v6 = -[ACCHIDServerRemote init](&v9, "init");
  v7 = v6;
  if (v6)
  {
    if (v5)
...
{
  v4 = (void (**)(id, BOOL))a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[ACCHIDServer sharedServer](&OBJC_CLASS___ACCHIDServer, "sharedServer"));
  if ((objc_opt_respondsToSelector(v5, "shouldAcceptXPCConnection:") & 1) != 0)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACCHIDServerRemote XPCConnection](self, "XPCConnection"));
