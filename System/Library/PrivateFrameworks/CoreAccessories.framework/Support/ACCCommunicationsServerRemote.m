...
- (ACCCommunicationsServerRemote)initWithXPCConnection:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___ACCCommunicationsServerRemote;
  v6 = -[ACCCommunicationsServerRemote init](&v9, "init");
  v7 = v6;
  if (v6)
  {
    if (v5)
...
{
  v4 = (void (**)(id, BOOL))a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[ACCCommunicationsServer sharedServer](&OBJC_CLASS___ACCCommunicationsServer, "sharedServer"));
  if ((objc_opt_respondsToSelector(v5, "shouldAcceptXPCConnection:") & 1) != 0)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACCCommunicationsServerRemote XPCConnection](self, "XPCConnection"));
  ...
  if (v7)
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[ACCCommunicationsServer sharedServer](&OBJC_CLASS___ACCCommunicationsServer, "sharedServer"));
    [v13 sendUpdatedSubscriberList];

    v14 = (void *)objc_claimAutoreleasedReturnValue(+[ACCCommunicationsServer sharedServer](&OBJC_CLASS___ACCCommunicationsServer, "sharedServer"));
...
- (void)callStateDidChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    -[ACCCommunicationsServerRemote callStateDidChange:].cold.1((uint64_t)v3, v7, v9, v10, v11, v12, v13, v14);
  }
...
- (void)commStatusDidChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    -[ACCCommunicationsServerRemote commStatusDidChange:].cold.1((uint64_t)v3, v7, v9, v10, v11, v12, v13, v14);
  }
...
- (void)listUpdate:(id)a3 forType:(int)a4 coalesced:(BOOL)a5
{
  ...
  if (gLogObjects && gNumLogObjects >= 5)
  {
    uint64_t v12 = (os_log_s *)*(id *)(gLogObjects + 32);
  }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG)) {
    -[ACCCommunicationsServerRemote listUpdate:forType:coalesced:].cold.1( (uint64_t)v7,  v12,  v14,  v15,  v16,  v17,  v18,  v19);
  }
...
- (void)callStateDidChange:(uint64_t)a3 .cold.1( uint64_t a1,  os_log_s *a2,  uint64_t a3,  uint64_t a4,  uint64_t a5,  uint64_t a6,  uint64_t a7,  uint64_t a8)
{
}

- (void)commStatusDidChange:(uint64_t)a3 .cold.1( uint64_t a1,  os_log_s *a2,  uint64_t a3,  uint64_t a4,  uint64_t a5,  uint64_t a6,  uint64_t a7,  uint64_t a8)
{
}

- (void)listUpdate:(uint64_t)a3 forType:(uint64_t)a4 coalesced:(uint64_t)a5 .cold.1( uint64_t a1,  os_log_s *a2,  uint64_t a3,  uint64_t a4,  uint64_t a5,  uint64_t a6,  uint64_t a7,  uint64_t a8)
{
}
