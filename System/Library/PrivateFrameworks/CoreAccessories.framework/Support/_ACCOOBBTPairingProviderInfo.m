...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS____ACCOOBBTPairingProviderInfo;
  v2 = -[_ACCOOBBTPairingProviderInfo init](&v9, "init");
  v3 = v2;
  if (v2)
  {
...
- (void)dealloc
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS____ACCOOBBTPairingProviderInfo;
  -[_ACCOOBBTPairingProviderInfo dealloc](&v7, "dealloc");
}

- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<_ACCOOBBTPairingProviderInfo>[\n    _connection=%@\n    _remoteObject=%@\n    _serverRemote=%@\n    _providerUID=%@]",  self->_connection,  self->_remoteObject,  self->_serverRemote,  self->_providerUID);
}
