...
- (ACCVoiceOverServerRemote)initWithXPCConnection:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ACCVoiceOverServerRemote;
  v9 = -[ACCVoiceOverServerRemote init](&v12, "init");
  v10 = v9;
  if (v9)
  {
    if (v5)
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___ACCVoiceOverServerRemote;
  -[ACCVoiceOverServerRemote dealloc](&v4, "dealloc");
}
...
- (void)initConnection:(id)a3
{
  ...
  {
    BOOL v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACCVoiceOverServerRemote XPCConnection](self, "XPCConnection"));
  ...
  if (v7)
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[ACCVoiceOverServer sharedServer](&OBJC_CLASS___ACCVoiceOverServer, "sharedServer"));
...
- (void)update:(id)a3 info:(id)a4
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCVoiceOverInformationUpdateSpeakingVolumeKey"]);
  v11 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCVoiceOverInformationUpdateSpeakingRateKey"]);
  id v12 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCVoiceOverInformationUpdateEnabledKey"]);
  float v13 = 0.0;
  if (v10)
  {
    [v10 floatValue];
...
- (void)update:(id)a3 cursorInfo:(id)a4
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCVoiceOverCursorInformationUpdateLabelKey"]);
  v11 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCVoiceOverCursorInformationUpdateValueKey"]);
  id v12 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCVoiceOverCursorInformationUpdateHintKey"]);
  float v13 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCVoiceOverCursorInformationUpdateTraitsKey"]);
  float v14 = v13;
  int v15 = v10 != 0LL;
  if (v11) {
    v15 |= 2u;
    ...
    if (v17)
    {
      ...
      do
      {
        for (i = 0LL; i != v18; i = (char *)i + 1)
        {
          ...
          v19 |= 1 << (char)[*(id *)(*((void *)&v23 + 1) + 8 * (void)i) unsignedShortValue];
        }
