...
- (ACCPowerSiphoningControl)initWithDelegate:(id)a3
{
  id v5 = a3;
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___ACCPowerSiphoningControl;
  v6 = -[ACCPowerSiphoningControl init](&v17, "init");
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_delegate, a3);
    uint64_t v8 = objc_claimAutoreleasedReturnValue([v5 connectionUID]);
    connectionUID = v7->_connectionUID;
    v7->_connectionUID = (NSString *)v8;

    v7->_siphoningDebounceTimerTime = -1LL;
    uint64_t v10 = objc_claimAutoreleasedReturnValue(-[ACCPowerSiphoningControl siphoningDebounceTimerSource](v7, "siphoningDebounceTimerSource"));
    ...
    *(void *)&v7->_siphoningCurrentInmAOld = -1LL;
    *(void *)&v7->_chargerVoltageInmVOld = -1LL;
    v7->_siphoningCurrentNeedSend = 1;
    id USBCameraKitHubPluginInstance = _getUSBCameraKitHubPluginInstance();
    v13 = (void *)objc_claimAutoreleasedReturnValue(USBCameraKitHubPluginInstance);
    v14 = (void *)objc_claimAutoreleasedReturnValue(-[ACCPowerSiphoningControlDelegate endpointUID](v7->_delegate, "endpointUID"));
    [v13 initUSBCameraKitHubNotifications:v14];
    ...
    [v15 addObserver:v7 selector:"_powerInfoChangeNotificationHandler:" name:ACCPlatformPowerPlugin_USBCurrentLimitDidChangeNotification object:0];
    [v15 addObserver:v7 selector:"_powerInfoChangeNotificationHandler:" name:ACCPlatformPowerPlugin_PowerDidChangeNotification object:0];
    [v15 addObserver:v7 selector:"_cckHubChangeNotificationHandler:" name:@"ACCPlatformUSBCameraKitHubPlugin_HubChange" object:0];
    -[ACCPowerSiphoningControl _powerInfoChangeNotificationHandler:](v7, "_powerInfoChangeNotificationHandler:", 0LL);
    -[ACCPowerSiphoningControl _cckHubChangeNotificationHandler:](v7, "_cckHubChangeNotificationHandler:", 0LL);
  }
...
- (void)dealloc
{
  ...
  {
    dispatch_source_cancel((dispatch_source_t)siphoningDebounceTimerSource);
    v4 = self->_siphoningDebounceTimerSource;
    self->_siphoningDebounceTimerSource = 0LL;

    self->_siphoningDebounceTimerTime = -1LL;
  }

  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___ACCPowerSiphoningControl;
  -[ACCPowerSiphoningControl dealloc](&v5, "dealloc");
}
...
- (id)siphoningDebounceTimerSource
{
  ...
  if (!siphoningDebounceTimerSource)
  {
    ...
    self->_siphoningDebounceTimerTime = -1LL;
    dispatch_source_set_timer( (dispatch_source_t)self->_siphoningDebounceTimerSource,  0xFFFFFFFFFFFFFFFFLL,  0xFFFFFFFFFFFFFFFFLL,  0LL);
...
- (unsigned)calculateSiphoningCurrent:(unsigned int)a3
{
  ...
  if (self->_usbAccessoryDetected && self->_usbAccessorySiphoningNotRequired)
  {
    ...
    {
      uint64_t v8 = (os_log_s *)*(id *)(gLogObjects + 288);
    }
  ...
  if (gLogObjects && gNumLogObjects >= 37)
  {
    v12 = (os_log_s *)*(id *)(gLogObjects + 288);
  }
...
- (BOOL)getOverCurrentState
{
  return +[ACCPowerSiphoningControl _getUSBHubOverCurrentState:]( &OBJC_CLASS___ACCPowerSiphoningControl,  "_getUSBHubOverCurrentState:",  self->_connectionUID);
}
...
- (void)_powerInfoChangeNotificationHandler:(id)a3
{
  ...
  unsigned int v7 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:ACCPlatformPowerPlugin_ConnectionUUID]);
  if (gLogObjects && gNumLogObjects >= 37)
  {
    uint64_t v8 = (os_log_s *)*(id *)(gLogObjects + 288);
  }
  ...
  {
    -[ACCPowerSiphoningControl _updateSiphoningValues](self, "_updateSiphoningValues");
    -[ACCPowerSiphoningControl _sendChangedSiphoningValues](self, "_sendChangedSiphoningValues");
  }
}
...
- (void)_cckHubChangeNotificationHandler:(id)a3
{
  ...
  unsigned int v7 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"ACCPlatformUSBCameraKitHubPlugin_ConnectionUUID"]);
  if (gLogObjects && gNumLogObjects >= 37)
  {
    uint64_t v8 = (os_log_s *)*(id *)(gLogObjects + 288);
  }
  ...
  {
    dispatch_time_t v10 = dispatch_time(0LL, 200000000LL);
    unint64_t v11 = v10;
    ...
    int v14 = !v13;
    if (siphoningDebounceTimerTime == -1LL || v10 > siphoningDebounceTimerTime)
    {
      if (v14)
      {
        v16 = (os_log_s *)*(id *)(gLogObjects + 288);
      }
      ...
      v15 = (dispatch_source_s *)objc_claimAutoreleasedReturnValue( -[ACCPowerSiphoningControl siphoningDebounceTimerSource]( self,  "siphoningDebounceTimerSource"));
      dispatch_source_set_timer(v15, self->_siphoningDebounceTimerTime, 0xFFFFFFFFFFFFFFFFLL, 0LL);
    }
    ...
    else
    {
      if (v14)
      {
        v15 = (dispatch_source_s *)*(id *)(gLogObjects + 288);
      }
      ...
      else
      {
        ...
        v15 = (dispatch_source_s *)&_os_log_default;
      ...
      if (os_log_type_enabled((os_log_t)v15, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v23 = 2048;
        unint64_t v24 = v11;
        _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v15,  OS_LOG_TYPE_INFO,  "ignore timeout=%lld >= %lld",  (uint8_t *)&v21,  0x16u);
      }
    }
  }
}
...
- (void)_processPowerInfoChangeTimeout
{
  self->_unint64_t siphoningDebounceTimerTime = -1LL;
  uint64_t v3 = +[ACCPowerSiphoningControl _getUSBHubSiphoningCurrentRequirementInmA:]( &OBJC_CLASS___ACCPowerSiphoningControl,  "_getUSBHubSiphoningCurrentRequirementInmA:",  self->_connectionUID);
  unsigned int v4 = +[ACCPowerSiphoningControl _getUSBHubSiphoningCurrentActualRequirementInmA:]( &OBJC_CLASS___ACCPowerSiphoningControl,  "_getUSBHubSiphoningCurrentActualRequirementInmA:",  self->_connectionUID);
  unsigned int v5 = +[ACCPowerSiphoningControl _getUSBHubUnitLoadInmA:]( &OBJC_CLASS___ACCPowerSiphoningControl,  "_getUSBHubUnitLoadInmA:",  self->_connectionUID);
...
LABEL_13:
  ...
  if (usbAccessoryDetected != v10 || usbAccessorySiphoningNotRequired != self->_usbAccessorySiphoningNotRequired)
  {
    if (gLogObjects && gNumLogObjects >= 7)
    {
      __int16 v12 = (os_log_s *)*(id *)(gLogObjects + 48);
    }
  ...
  int v14 = -[ACCPowerSiphoningControl calculateSiphoningCurrent:](self, "calculateSiphoningCurrent:", v3);
  ...
  if (siphoningCurrentInmAOld == -1 || v14 != siphoningCurrentInmAOld)
  {
    if (siphoningCurrentInmAOld != -1 && v14 <= siphoningCurrentInmAOld)
    {
      ...
      unint64_t v25 = v24;
      unint64_t siphoningDebounceTimerTime = self->_siphoningDebounceTimerTime;
      if (siphoningDebounceTimerTime != -1LL && v24 <= siphoningDebounceTimerTime) {
        goto LABEL_41;
      }
      if (gLogObjects && gNumLogObjects >= 7)
      {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&v46[8] = 2048;
        ...
        __int16 v50 = 1024;
        int v51 = 1;
        _os_log_impl( (void *)&_mh_execute_header,  v27,  OS_LOG_TYPE_INFO,  "siphoningCurrentRequirement going down, debounce some more, usbRequiredCurrent=%d _siphoningCurrent=%d->%d, ti meout %lld -> %lld, _siphoningCurrentNeedSend %d -> %d",  (uint8_t *)&v39,  0x34u);
      }

      self->_unint64_t siphoningDebounceTimerTime = v25;
      unint64_t v22 = (dispatch_source_s *)objc_claimAutoreleasedReturnValue( -[ACCPowerSiphoningControl siphoningDebounceTimerSource]( self,  "siphoningDebounceTimerSource"));
      dispatch_source_set_timer(v22, self->_siphoningDebounceTimerTime, 0xFFFFFFFFFFFFFFFFLL, 0LL);
      BOOL v23 = 1;
LABEL_40:
...
- (void)_updateSiphoningValues
{
  if (gLogObjects && gNumLogObjects >= 37)
  {
    uint64_t v3 = (os_log_s *)*(id *)(gLogObjects + 288);
  }
  ...
  self->_int chargerCurrentInmA = +[ACCPowerSiphoningControl _getChargerCurrentInmA:]( &OBJC_CLASS___ACCPowerSiphoningControl,  "_getChargerCurrentInmA:",  self->_connectionUID);
  self->_int chargerVoltageInmV = +[ACCPowerSiphoningControl _getChargerVoltageInmV:]( &OBJC_CLASS___ACCPowerSiphoningControl,  "_getChargerVoltageInmV:",  self->_connectionUID);
  self->_int reserveCurrentInmA = +[ACCPowerSiphoningControl _getReserveCurrentInmA:]( &OBJC_CLASS___ACCPowerSiphoningControl,  "_getReserveCurrentInmA:",  self->_connectionUID);
  if (gLogObjects && gNumLogObjects >= 37)
  {
    uint64_t v8 = (os_log_s *)*(id *)(gLogObjects + 288);
  }
...
- (void)_sendChangedSiphoningValues
{
    ...
    || self->_chargerVoltageInmV != v4)
  {
    ...
    int v13 = (void *)objc_claimAutoreleasedReturnValue(-[ACCPowerSiphoningControlDelegate endpointUID](self->_delegate, "endpointUID"));
  ...
  if (reserveCurrentInmAOld == -1 || self->_reserveCurrentInmA != reserveCurrentInmAOld)
  {
    if (gLogObjects && gNumLogObjects >= 7)
    {
      __int16 v15 = (os_log_s *)*(id *)(gLogObjects + 48);
    }
    ...
    int v19 = (void *)objc_claimAutoreleasedReturnValue(-[ACCPowerSiphoningControlDelegate endpointUID](self->_delegate, "endpointUID"));
  ...
  if (minSiphoningCurrentInmAOld == -1 || self->_minSiphoningCurrentInmA != minSiphoningCurrentInmAOld)
  {
    if (gLogObjects && gNumLogObjects >= 7)
    {
      BOOL v21 = (os_log_s *)*(id *)(gLogObjects + 48);
    }
    ...
    else
    {
      ...
      BOOL v21 = (os_log_s *)&_os_log_default;
    ...
    unint64_t v25 = (void *)objc_claimAutoreleasedReturnValue(-[ACCPowerSiphoningControlDelegate endpointUID](self->_delegate, "endpointUID"));
  ...
  if (v5)
  {
    ...
    BOOL v29 = (void *)objc_claimAutoreleasedReturnValue(-[ACCPowerSiphoningControlDelegate endpointUID](self->_delegate, "endpointUID"));
...
{
  id v3 = a3;
  int v4 = (void *)objc_claimAutoreleasedReturnValue(+[ACCPlatformPluginManager sharedManager](&OBJC_CLASS___ACCPlatformPluginManager, "sharedManager"));
  int v5 = (void *)objc_claimAutoreleasedReturnValue( [v4 pluginInstanceWithProtocol:&OBJC_PROTOCOL___ACCPlatformPowerPluginProtocol fallbackToTransportPlugins:1]);
...
+ (unsigned)_getUSBHubUnitLoadInmA:(id)a3
{
  id v3 = a3;
  int v4 = (void *)objc_claimAutoreleasedReturnValue(+[ACCPlatformPluginManager sharedManager](&OBJC_CLASS___ACCPlatformPluginManager, "sharedManager"));
  int v5 = (void *)objc_claimAutoreleasedReturnValue( [v4 pluginInstanceWithProtocol:&OBJC_PROTOCOL___ACCPlatformUSBCameraKitHubPluginProtocol fallbackToTransportPlugins:1]);
...
{
  id v5 = a3;
  id v3 = (void *)objc_claimAutoreleasedReturnValue(+[ACCPlatformPluginManager sharedManager](&OBJC_CLASS___ACCPlatformPluginManager, "sharedManager"));
  int v4 = (void *)objc_claimAutoreleasedReturnValue( [v3 pluginInstanceWithProtocol:&OBJC_PROTOCOL___ACCPlatformUSBCameraKitHubPluginProtocol fallbackToTransportPlugins:1]);
