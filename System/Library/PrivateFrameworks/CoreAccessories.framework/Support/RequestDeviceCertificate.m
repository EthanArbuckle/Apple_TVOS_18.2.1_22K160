...
{
  DeviceDataCertificate = (const __CFData *)platform_auth_createDeviceDataCertificate(2LL);
  ...
  iAP2MsgInit(v5, 43537, *(void *)(v4 + 192), 0xFFFF, 0LL, 0LL);
  if (BytePtr && Length)
  {
    iAP2MsgAddDataParam(v5, 0LL, 0, BytePtr, (unsigned __int16)Length);
  }
