...
- (ACCBLEPairingServerRemote)initWithXPCConnection:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ACCBLEPairingServerRemote;
  v9 = -[ACCBLEPairingServerRemote init](&v12, "init");
  v10 = v9;
  if (v9)
  {
    if (v5)
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___ACCBLEPairingServerRemote;
  -[ACCBLEPairingServerRemote dealloc](&v4, "dealloc");
}

- (void)initConnection:(id)a3
{
  objc_super v4 = (void (**)(id, BOOL))a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[ACCBLEPairingServer sharedServer](&OBJC_CLASS___ACCBLEPairingServer, "sharedServer"));
  if ((objc_opt_respondsToSelector(v5, "shouldAcceptXPCConnection:") & 1) != 0)
  {
    BOOL v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACCBLEPairingServerRemote XPCConnection](self, "XPCConnection"));
  ...
  if (v7)
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[ACCBLEPairingServer sharedServer](&OBJC_CLASS___ACCBLEPairingServer, "sharedServer"));
...
- (void)startBLEUpdates:(id)a3 blePairingUUID:(id)a4 pairType:(unsigned __int8)a5 bRadioUpdatesOn:(BOOL)a6 bPairInfoUpdatesOn:(BOOL)a7
{
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue(+[ACCBLEPairingServer sharedServer](&OBJC_CLASS___ACCBLEPairingServer, "sharedServer"));
  ...
  else
  {
    if (gLogObjects && gNumLogObjects >= 5)
    {
      v19 = (os_log_s *)*(id *)(gLogObjects + 32);
    }
    ...
    {
      id v21 = -[NSXPCConnection hash](self->_XPCConnection, "hash");
      int v22 = 138412546;
      id v23 = v12;
      __int16 v24 = 2048;
      id v25 = v21;
...
- (void)devicePairingData:(id)a3 blePairingUUID:(id)a4 pairType:(unsigned __int8)a5 pairData:(id)a6
{
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue(+[ACCBLEPairingServer sharedServer](&OBJC_CLASS___ACCBLEPairingServer, "sharedServer"));
  ...
  else
  {
    if (gLogObjects && gNumLogObjects >= 5)
    {
      unsigned int v18 = (os_log_s *)*(id *)(gLogObjects + 32);
    }
    ...
    {
      id v20 = -[NSXPCConnection hash](self->_XPCConnection, "hash");
      int v21 = 138412546;
      id v22 = v10;
      __int16 v23 = 2048;
      id v24 = v20;
...
- (void)stopBLEUpdates:(id)a3 blePairingUUID:(id)a4
{
  ...
  id v11 = (void *)objc_claimAutoreleasedReturnValue(+[ACCBLEPairingServer sharedServer](&OBJC_CLASS___ACCBLEPairingServer, "sharedServer"));
  unsigned int v12 = [v11 accessoryReserved:v6 xpcConn:self->_XPCConnection];

  if (v12)
  {
    platform_blePairing_stopBLEUpdatesHandler(v6, v7);
    id v13 = (id)objc_claimAutoreleasedReturnValue(+[ACCBLEPairingServer sharedServer](&OBJC_CLASS___ACCBLEPairingServer, "sharedServer"));
  ...
  else
  {
    ...
    {
      id v15 = -[NSXPCConnection hash](self->_XPCConnection, "hash");
      int v16 = 138412546;
      id v17 = v6;
      __int16 v18 = 2048;
      id v19 = v15;
      _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v13,  OS_LOG_TYPE_DEFAULT,  "BLEPairing stopBLEUpdate: accessoryUID %@, NOT RESERVED connHash %lu",  (uint8_t *)&v16,  0x16u);
    }
  }
}
