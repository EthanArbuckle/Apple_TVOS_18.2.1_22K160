...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___ACCClientPortShimManager;
  v2 = -[ACCClientPortShimManager init](&v6, "init");
  if (v2)
  {
...
- (void)addClienPort:(id)a3 forUUID:(id)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_portList, "setObject:forKey:", v6, v7);
}
...
- (void)removeClienPortForUUID:(id)a3
{
  ...
  -[NSMutableDictionary removeObjectForKey:](self->_portList, "removeObjectForKey:", v4);
}

- (id)findClientPortForUUID:(id)a3
{
  return -[NSMutableDictionary objectForKey:](self->_portList, "objectForKey:", a3);
}
