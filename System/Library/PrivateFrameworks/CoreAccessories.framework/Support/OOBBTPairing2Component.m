...
- (OOBBTPairing2Component)initWithUID:(id)a3 componentID:(id)a4 name:(id)a5 macAddr:(id)a6
{
  ...
  id v14 = a6;
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___OOBBTPairing2Component;
  v15 = -[OOBBTPairing2Component init](&v18, "init");
  v16 = v15;
  if (v15)
  {
...
- (OOBBTPairing2Component)initWithComponentInfo:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___OOBBTPairing2Component;
  v5 = -[OOBBTPairing2Component init](&v15, "init");
  if (v5)
  {
    uint64_t v6 = objc_claimAutoreleasedReturnValue([v4 objectForKey:@"ACCOOBBTPairingComponentInfoUID"]);
    componentUID = v5->_componentUID;
    v5->_componentUID = (NSString *)v6;

    uint64_t v8 = objc_claimAutoreleasedReturnValue([v4 objectForKey:@"ACCOOBBTPairingComponentInfoID"]);
    componentID = v5->_componentID;
    v5->_componentID = (NSNumber *)v8;

    uint64_t v10 = objc_claimAutoreleasedReturnValue([v4 objectForKey:@"ACCOOBBTPairingComponentInfoName"]);
    componentName = v5->_componentName;
    v5->_componentName = (NSString *)v10;

    uint64_t v12 = objc_claimAutoreleasedReturnValue([v4 objectForKey:@"ACCOOBBTPairingComponentInfoMacAddr"]);
    macAddr = v5->_macAddr;
