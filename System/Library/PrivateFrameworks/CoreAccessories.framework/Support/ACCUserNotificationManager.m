  ...
  if (v6)
  {
    ...
    if (v16)
    {
      ...
      if (v17 > 2) {
        ...
        CFOptionFlags v18 = qword_10019E880[v17];
      }
      SInt32 error = 0;
      uint64_t v35 = 0LL;
      v36 = &v35;
...
+ (id)sharedManager
{
  ...
  return (id)sharedManager_sharedInstance_4;
}

void __43__ACCUserNotificationManager_sharedManager__block_invoke(uint64_t a1)
{
  id v1 = objc_alloc_init(*(Class *)(a1 + 32));
  CFOptionFlags v2 = (void *)sharedManager_sharedInstance_4;
  sharedManager_sharedInstance_4 = (uint64_t)v1;
}
