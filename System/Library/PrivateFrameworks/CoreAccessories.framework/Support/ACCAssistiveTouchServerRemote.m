...
- (ACCAssistiveTouchServerRemote)initWithXPCConnection:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ACCAssistiveTouchServerRemote;
  v9 = -[ACCAssistiveTouchServerRemote init](&v12, "init");
  v10 = v9;
  if (v9)
  {
    if (v5)
...
{
  v4 = (void (**)(id, BOOL))a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[ACCAssistiveTouchServer sharedServer](&OBJC_CLASS___ACCAssistiveTouchServer, "sharedServer"));
  if ((objc_opt_respondsToSelector(v5, "shouldAcceptXPCConnection:") & 1) != 0)
  {
    BOOL v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACCAssistiveTouchServerRemote XPCConnection](self, "XPCConnection"));
  ...
  if (v7)
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[ACCAssistiveTouchServer sharedServer](&OBJC_CLASS___ACCAssistiveTouchServer, "sharedServer"));
...
- (void)notifyEnabledState:(BOOL)a3 provider:(id)a4
{
  ...
  id v9 = (void *)objc_claimAutoreleasedReturnValue(+[ACCAssistiveTouchServer sharedServer](&OBJC_CLASS___ACCAssistiveTouchServer, "sharedServer"));
...
void __61__ACCAssistiveTouchServerRemote_notifyEnabledState_provider___block_invoke( uint64_t a1,  void *a2,  _BYTE *a3)
{
  *a3 = 1;
}
