...
- (ACCNavigationServerRemote)initWithXPCConnection:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ACCNavigationServerRemote;
  v9 = -[ACCNavigationServerRemote init](&v12, "init");
  v10 = v9;
  if (v9)
  {
    if (v5)
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___ACCNavigationServerRemote;
  -[ACCNavigationServerRemote dealloc](&v4, "dealloc");
}

- (void)initConnection:(id)a3
{
  objc_super v4 = (void (**)(id, BOOL))a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[ACCNavigationServer sharedServer](&OBJC_CLASS___ACCNavigationServer, "sharedServer"));
  if ((objc_opt_respondsToSelector(v5, "shouldAcceptXPCConnection:") & 1) != 0)
  {
    BOOL v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACCNavigationServerRemote XPCConnection](self, "XPCConnection"));
  ...
  if (v7)
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[ACCNavigationServer sharedServer](&OBJC_CLASS___ACCNavigationServer, "sharedServer"));
...
- (void)notifyOfProvider:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    -[ACCNavigationServerRemote notifyOfProvider:].cold.1((uint64_t)v4, v7);
  }

  BOOL v8 = (void *)objc_claimAutoreleasedReturnValue(+[ACCNavigationServer sharedServer](&OBJC_CLASS___ACCNavigationServer, "sharedServer"));
  id v9 = (void *)objc_claimAutoreleasedReturnValue(-[ACCNavigationServerRemote XPCConnection](self, "XPCConnection"));
