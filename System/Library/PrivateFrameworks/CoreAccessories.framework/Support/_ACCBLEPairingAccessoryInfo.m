...
- (_ACCBLEPairingAccessoryInfo)initWithUID:(id)a3 blePairingUUID:(id)a4 accInfoDict:(id)a5 supportedPairTypes:(id)a6
{
  ...
  id v14 = a6;
  v19.receiver = self;
  v19.super_class = (Class)&OBJC_CLASS____ACCBLEPairingAccessoryInfo;
  v15 = -[_ACCBLEPairingAccessoryInfo init](&v19, "init");
  v16 = v15;
  if (v15)
  {
...
- (void)dealloc
{
  ...
  self->_blePairingUUID = 0LL;

  accInfoDict = self->_accInfoDict;
  self->_accInfoDict = 0LL;

  supportedPairTypes = self->_supportedPairTypes;
  self->_supportedPairTypes = 0LL;

  activeProvider = self->_activeProvider;
  self->_activeProvider = 0LL;

  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS____ACCBLEPairingAccessoryInfo;
  -[_ACCBLEPairingAccessoryInfo dealloc](&v8, "dealloc");
}

- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<_ACCBLEPairingAccessoryInfo>[%@, blePairingUUID=%@, activeProvider=%@]",  self->_accessoryUID,  self->_blePairingUUID,  self->_activeProvider);
}
