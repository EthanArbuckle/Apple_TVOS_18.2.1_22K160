...
- (ACCMediaLibraryServerRemote)initWithXPCConnection:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ACCMediaLibraryServerRemote;
  v9 = -[ACCMediaLibraryServerRemote init](&v12, "init");
  v10 = v9;
  if (v9)
  {
    if (v5)
...
{
  v4 = (void (**)(id, BOOL))a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[ACCMediaLibraryServer sharedServer](&OBJC_CLASS___ACCMediaLibraryServer, "sharedServer"));
  if ((objc_opt_respondsToSelector(v5, "shouldAcceptXPCConnection:") & 1) != 0)
  {
    BOOL v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACCMediaLibraryServerRemote XPCConnection](self, "XPCConnection"));
  ...
  if (v7)
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[ACCMediaLibraryServer sharedServer](&OBJC_CLASS___ACCMediaLibraryServer, "sharedServer"));
...
- (void)notifyAvailableLibraries:(id)a3 provider:(id)a4
{
  ...
  {
    BOOL v8 = (os_log_s *)*(id *)(gLogObjects + 32);
  }
...
LABEL_13:
    ...
    while (1)
    {
      ...
      v20 = -[ACCMediaLibraryUpdateLibraryInfo initWithDict:]( objc_alloc(&OBJC_CLASS___ACCMediaLibraryUpdateLibraryInfo),  "initWithDict:",  *(void *)(*((void *)&v27 + 1) + 8LL * (void)v16));
      -[NSMutableArray addObject:](v9, "addObject:", v20);
      id v21 = -[ACCMediaLibraryUpdateLibraryInfo copyDict](v20, "copyDict");
      -[NSMutableArray addObject:](v10, "addObject:", v21);

      if (v13 == ++v16)
      {
        v13 = (char *)[v11 countByEnumeratingWithState:&v27 objects:v31 count:16];
        int v14 = v23 + (_DWORD)v16;
        if (v13) {
          goto LABEL_13;
        }
        break;
  ...
  v22 = (void *)objc_claimAutoreleasedReturnValue(+[ACCMediaLibraryServer sharedServer](&OBJC_CLASS___ACCMediaLibraryServer, "sharedServer"));
...
uint64_t __58__ACCMediaLibraryServerRemote_notify_stateChange_enabled___block_invoke( uint64_t a1,  void *a2,  _BYTE *a3)
{
...
- (void)update:(id)a3 revision:(id)a4 content:(id)a5 accessory:(id)a6
{
  ...
  uint64_t v16 = (void *)objc_claimAutoreleasedReturnValue([v11 objectForKey:@"ACCMediaLibraryUpdatePlaylistContentStyle"]);
  int v17 = [v16 unsignedCharValue];

  int v18 = (void *)objc_claimAutoreleasedReturnValue([v11 objectForKey:@"ACCMediaLibraryUpdatePlaylistPersistentID"]);
  id v19 = [v18 unsignedLongLongValue];

  id v20 = (void *)objc_claimAutoreleasedReturnValue([v11 objectForKey:@"ACCMediaLibraryUpdatePlaylistItemList"]);
...
- (void)resetUpdate:(id)a3 accessory:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = (id)objc_claimAutoreleasedReturnValue(+[ACCMediaLibraryServer sharedServer](&OBJC_CLASS___ACCMediaLibraryServer, "sharedServer"));
