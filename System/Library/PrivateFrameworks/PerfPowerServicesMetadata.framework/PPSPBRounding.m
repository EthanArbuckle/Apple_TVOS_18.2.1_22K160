...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___PPSPBRounding;
  v4 = -[PPSPBRounding description](&v8, sel_description);
  v5 = -[PPSPBRounding dictionaryRepresentation](self, "dictionaryRepresentation");
