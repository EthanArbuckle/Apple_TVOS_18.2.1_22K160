...
- (id)description
{
  v3 = (void *)NSString;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___PPSPBMetricHistory;
  -[PPSPBMetricHistory description](&v8, sel_description);
  id v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[PPSPBMetricHistory dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = (void *)objc_msgSend( objc_alloc(MEMORY[0x189603FA8]),  "initWithCapacity:",  -[NSMutableArray count](self->_metrics, "count"));
    __int128 v12 = 0u;
    __int128 v13 = 0u;
    __int128 v14 = 0u;
    __int128 v15 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearMetrics];
    unint64_t v4 = -[PPSPBMetricHistory metricsCount](self, "metricsCount");
    if (v4)
    {
      unint64_t v5 = v4;
