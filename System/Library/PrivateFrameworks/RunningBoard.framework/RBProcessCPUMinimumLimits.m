...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___RBProcessCPUMinimumLimits;
...
- (id)unionLimit:(id)a3
{
  ...
  if (v4
    ...
    && ((unint64_t duration = self->_duration,
         unint64_t v7 = -[RBProcessCPUMinimumLimits duration](v4, "duration"),
         unint64_t percentage = self->_percentage,
         unint64_t v9 = -[RBProcessCPUMinimumLimits percentage](v5, "percentage"),
         v9 > percentage)
     || v7 > duration))
  {
    if (v9 <= percentage) {
    ...
    v10 = -[RBProcessCPUMinimumLimits initWithPercentage:duration:]( objc_alloc(&OBJC_CLASS___RBProcessCPUMinimumLimits),  "initWithPercentage:duration:",  v11,  v7);
  }
