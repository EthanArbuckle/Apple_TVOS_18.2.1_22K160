...
- (id)_initWithEntitlement:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___RBTargetEntitlementDomainRestriction;
...
+ (id)domainRestrictionForDictionary:(id)a3 withError:(id *)a4
{
  ...
  {
    a4 = -[RBTargetEntitlementDomainRestriction _initWithEntitlement:]( objc_alloc(&OBJC_CLASS___RBTargetEntitlementDomainRestriction),  "_initWithEntitlement:",  v6);
  }

  else if (a4)
  {
    v7 = (void *)MEMORY[0x189607870];
    [NSString stringWithFormat:@"RBTargetEntitlementDomainRestriction doesn't specify entitlement: %@", v5, *MEMORY[0x1896075F0]];
...
- (BOOL)allowsContext:(id)a3 withError:(id *)a4
{
  ...
  if (a4 && (v7 & 1) == 0)
  {
    ...
    [NSString stringWithFormat:@"target is not running or doesn't have entitlement %@", self->_entitlement, *MEMORY[0x1896075F0]];
    objc_super v10 = (void *)objc_claimAutoreleasedReturnValue();
    v14[0] = v10;
    [MEMORY[0x189603F68] dictionaryWithObjects:v14 forKeys:&v13 count:1];
