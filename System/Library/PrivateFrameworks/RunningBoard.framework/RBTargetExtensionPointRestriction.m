...
- (id)_initWithExtensionPoint:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___RBTargetExtensionPointRestriction;
...
+ (id)domainRestrictionForDictionary:(id)a3 withError:(id *)a4
{
  ...
  {
    a4 = -[RBTargetExtensionPointRestriction _initWithExtensionPoint:]( objc_alloc(&OBJC_CLASS___RBTargetExtensionPointRestriction),  "_initWithExtensionPoint:",  v6);
  }

  else if (a4)
  {
    v7 = (void *)MEMORY[0x189607870];
    [NSString stringWithFormat:@"RBTargetExtensionPointRestriction doesn't specify extensionPoint or doesn't have right class for extensionPoint: %@", v5, *MEMORY[0x1896075F0]];
...
- (BOOL)allowsContext:(id)a3 withError:(id *)a4
{
  ...
  if ((v8 & 1) == 0)
  {
    ...
    [NSString stringWithFormat:@"target isn't extension"];
...
LABEL_8:
  ...
  if ((extensionPoint & 1) == 0)
  {
    ...
    v12 = (void *)MEMORY[0x189607870];
    uint64_t v13 = *MEMORY[0x1896124C0];
    [NSString stringWithFormat:@"target doesn't have extensionPoint %@", self->_extensionPoint, *MEMORY[0x1896075F0]];
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = v14;
    v15 = (void *)MEMORY[0x189603F68];
    v16 = &v21;
