...
- (void)set:(id)a3 value:(id)a4 user:(id)a5 host:(id)a6 domain:(id)a7
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v25 = 2112;
    v26 = v15;
    _os_log_debug_impl( &dword_18876B000,  v16,  OS_LOG_TYPE_DEBUG,  "HIDPReferencesLocal Set Key:%@ Value:%@ User:%@ Host:%@ Domain:%@\n",  (uint8_t *)&v17,  0x34u);
  }
...
- (void)copy:(id)a3 user:(id)a4 host:(id)a5 domain:(id)a6 reply:(id)a7
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v25 = 2112;
    v26 = v14;
    _os_log_debug_impl( &dword_18876B000,  v16,  OS_LOG_TYPE_DEBUG,  "HIDPReferencesLocal Copy Key:%@ User:%@ Host:%@ Domain:%@\n",  (uint8_t *)&v19,  0x2Au);
  }
...
- (void)synchronize:(id)a3 host:(id)a4 domain:(id)a5
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v15 = 2112;
    v16 = v9;
    _os_log_debug_impl( &dword_18876B000,  v10,  OS_LOG_TYPE_DEBUG,  "HIDPReferencesLocal Synchronize User:%@ Host:%@ Domain:%@\n",  (uint8_t *)&v11,  0x20u);
  }
...
- (void)copyMultiple:(id)a3 user:(id)a4 host:(id)a5 domain:(id)a6 reply:(id)a7
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v25 = 2112;
    v26 = v14;
    _os_log_debug_impl( &dword_18876B000,  v16,  OS_LOG_TYPE_DEBUG,  "HIDPReferencesLocal Copy Multiple Keys:%@ User:%@ Host:%@ Domain:%@\n",  (uint8_t *)&v19,  0x2Au);
  }
...
- (void)setMultiple:(id)a3 keysToRemove:(id)a4 user:(id)a5 host:(id)a6 domain:(id)a7
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v25 = 2112;
    v26 = v15;
    _os_log_debug_impl( &dword_18876B000,  v16,  OS_LOG_TYPE_DEBUG,  "HIDPReferencesLocal Set Multiple KeysToSet:%@ KeysToRemove:%@ User:%@ Host:%@ Domain:%@\n",  (uint8_t *)&v17,  0x34u);
  }
...
- (void)setDomain:(id)a3 value:(id)a4 domain:(id)a5
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v8;
    _os_log_debug_impl( &dword_18876B000,  v10,  OS_LOG_TYPE_DEBUG,  "HIDPReferencesLocal Set Domain Value Key:%@ Domain:%@ Value : %@\n",  (uint8_t *)&v11,  0x20u);
  }
...
- (void)copyDomain:domain:reply:.cold.2()
{
  ...
  __int16 v3 = 2112;
  uint64_t v4 = v0;
  _os_log_debug_impl( &dword_18876B000,  v1,  OS_LOG_TYPE_DEBUG,  "HIDPReferencesLocal Copy Domain Value Key:%@ Domain:%@\n",  v2,  0x16u);
  OUTLINED_FUNCTION_4();
}
