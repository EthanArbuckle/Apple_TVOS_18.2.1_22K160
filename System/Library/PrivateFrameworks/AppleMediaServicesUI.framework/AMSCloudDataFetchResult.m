...
- (AMSCloudDataFetchResult)initWithResults:(id)a3 failures:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___AMSCloudDataFetchResult;
  v9 = -[AMSCloudDataFetchResult init](&v12, "init");
  v10 = v9;
  if (v9)
  {
...
- (NSString)hashedDescription
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[AMSCloudDataFetchResult results](self, "results"));
  uint64_t v6 = AMSHashIfNeeded();
  id v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
  [v4 appendFormat:@"  results = %@,\n", v7];

  id v8 = (void *)objc_claimAutoreleasedReturnValue(-[AMSCloudDataFetchResult failures](self, "failures"));
