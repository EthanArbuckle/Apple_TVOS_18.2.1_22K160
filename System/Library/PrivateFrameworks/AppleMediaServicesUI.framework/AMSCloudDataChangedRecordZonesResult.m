...
- (AMSCloudDataChangedRecordZonesResult)initWithChangedRecordZones:(id)a3 deletedRecordZones:(id)a4 changeToken:(id)a5
{
  ...
  id v11 = a5;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___AMSCloudDataChangedRecordZonesResult;
  v12 = -[AMSCloudDataChangedRecordZonesResult init](&v15, "init");
  v13 = v12;
  if (v12)
  {
...
- (NSString)hashedDescription
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[AMSCloudDataChangedRecordZonesResult changedRecordZones](self, "changedRecordZones"));
  uint64_t v6 = AMSHashIfNeeded();
  v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
  [v4 appendFormat:@"  changedRecordZones = %@,\n", v7];

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[AMSCloudDataChangedRecordZonesResult deletedRecordZones](self, "deletedRecordZones"));
  uint64_t v9 = AMSHashIfNeeded();
  id v10 = (void *)objc_claimAutoreleasedReturnValue(v9);
  [v4 appendFormat:@"  deletedRecordZones = %@,\n", v10];

  id v11 = (void *)objc_claimAutoreleasedReturnValue(-[AMSCloudDataChangedRecordZonesResult changeToken](self, "changeToken"));
