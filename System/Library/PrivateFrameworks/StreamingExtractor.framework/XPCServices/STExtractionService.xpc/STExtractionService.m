...
id sub_1000017FC(void *a1, uint64_t a2, void *a3, void *a4, void *a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  id v15 = a1;
  id v16 = a3;
  v17 = a4;
...
id sub_100001A10(void *a1, uint64_t a2, void *a3, void *a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  return sub_1000017FC(a1, a2, a3, a4, 0LL, a5, a6, a7);
}
...
void sub_100002240( void *a1, os_log_s *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
}
...
void sub_100002C48(uint64_t a1)
{
  ...
  if (v18)
  {
    ...
    if ((objc_opt_isKindOfClass(v18, v19) & 1) == 0)
    {
      ...
      id v93 = sub_100001A10( v92,  3LL,  v115,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withComplet ionBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  274LL);
  ...
  if ((objc_opt_isKindOfClass(v22, v23) & 1) == 0)
  {
    ...
    id v107 = sub_100001A10( v106,  3LL,  v25,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompleti onBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  282LL);
  ...
  if (v24)
  {
    ...
    id v112 = sub_100001A10( v110,  3LL,  v111,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompleti onBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  286LL);
...
LABEL_24:
  ...
  if (!v21)
  {
    ...
    id v62 = sub_100001A10( v60,  6LL,  v61,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompletio nBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  299LL);
...
LABEL_27:
  ...
  if (!v34)
  {
    ...
    id v67 = sub_100001A10( v65,  6LL,  v66,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompletio nBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  302LL);
...
LABEL_40:
  ...
  if ((-[objc_class conformsToProtocol:](v38, "conformsToProtocol:", &OBJC_PROTOCOL___STExtractionPlugin) & 1) == 0)
  {
    ...
    uint64_t v78 = 307LL;
LABEL_67:
    id v82 = sub_100001A10( v76,  6LL,  v77,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompletio nBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  v78);
    ...
    && (objc_msgSend( *v2, "setSandboxToken:", sandbox_extension_consume(objc_msgSend(v40, "UTF8String"))), objc_msgSend(*v2, "sandboxToken") == (id) -1))
  {
    ...
    id v102 = sub_100001A10( v97,  10LL,  v101,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompleti onBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  311LL);
...
LABEL_38:
      ...
      else
      {
        ...
        id v88 = sub_100001A10( v86,  6LL,  v87,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompl etionBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  323LL);
    ...
    id v56 = sub_100001A10( v53,  14LL,  v55,  0LL,  (uint64_t)"-[STExtractionService remote_prepareForExtractionToPath:sandboxExtensionToken:options:withCompletio nBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  319LL);
...
void sub_100003B30(uint64_t a1)
{
  if (processTerminated)
  {
    ...
    id v11 = sub_1000017FC( v9,  13LL,  v10,  0LL,  &off_100008B38,  (uint64_t)"-[STExtractionService remote_supplyBytes:withCompletionBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  351LL);
...
LABEL_5:
    ...
    id v23 = sub_100001A10( v16,  v17,  v18,  0LL,  (uint64_t)"-[STExtractionService remote_supplyBytes:withCompletionBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  v19);
...
void sub_100003EB4(uint64_t a1)
{
  ...
  else
  {
    ...
    id v8 = sub_100001A10( v6,  6LL,  v7,  0LL,  (uint64_t)"-[STExtractionService remote_suspendStreamWithCompletionBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  383LL);
...
void sub_100004058(uint64_t a1)
{
  ...
  else
  {
    ...
    id v8 = sub_100001A10( v6,  6LL,  v7,  0LL,  (uint64_t)"-[STExtractionService remote_finishStreamWithCompletionBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  408LL);
    id v9 = (void *)objc_claimAutoreleasedReturnValue(v8);
...
void sub_10000421C(uint64_t a1)
{
  ...
  else
  {
    ...
    id v8 = sub_100001A10( v6,  6LL,  v7,  0LL,  (uint64_t)"-[STExtractionService remote_terminateStreamWithError:completionBlock:]_block_invoke",  (uint64_t)"/Library/Caches/com.apple.xbs/Sources/StreamingExtractorService/STExtractionService/STExtractionService.m",  434LL);
    id v9 = (void *)objc_claimAutoreleasedReturnValue(v8);
...
void sub_100004508( void *a1, os_log_s *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
}
...
void sub_100004B9C(id *a1, uint64_t a2, os_log_s *a3)
{
