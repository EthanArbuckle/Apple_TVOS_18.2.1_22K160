...
+ (id)dataWithEncodedString:()KCJoiningMessages error:
{
  ...
  if (v6)
  {
    id v7 = [MEMORY[0x189603FB8] dataWithLength:v6];
    ...
    {
      KCJoiningErrorCreate(3LL, a4, @"extra data", v9, v10, v11, v12, v13, v16);
      id v14 = 0LL;
    }
  }
...
+ (id)dataWithEncodedSequenceData:()KCJoiningMessages data:error:
{
  ...
  if (v9)
  {
    id v10 = [MEMORY[0x189603FB8] dataWithLength:v9];
    ...
    {
      KCJoiningErrorCreate(3LL, a5, @"extra data", v12, v13, v14, v15, v16, v19);
      id v17 = 0LL;
    }
  }
