...
- (id)description
{
  id v3 = (void *)NSString;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___OTSupportSOSMessage;
  -[OTSupportSOSMessage description](&v8, sel_description);
  int v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = -[OTSupportSOSMessage dictionaryRepresentation](self, "dictionaryRepresentation");
