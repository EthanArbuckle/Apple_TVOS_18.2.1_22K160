...
- (void)initWithPredicates:(void *)a1
{
  ...
  {
    v7.receiver = a1;
    v7.super_class = (Class)&OBJC_CLASS___RBSCompoundAnyPredicate;
...
- (BOOL)matchesProcess:(id)a3
{
  ...
  if (-[NSSet count](self->_predicates, "count"))
  {
    ...
    uint64_t v6 = -[NSSet countByEnumeratingWithState:objects:count:]( v5,  "countByEnumeratingWithState:objects:count:",  &v10,  v14,  16LL);
    if (v6)
    {
...
- (RBSCompoundAnyPredicate)initWithRBSXPCCoder:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___RBSCompoundAnyPredicate;
  id v5 = -[RBSCompoundAnyPredicate init](&v10, sel_init);
  if (v5)
  {
