...
- (unint64_t)hash
{
  unint64_t v3 = -[RBSXPCServiceDefinition hash](self->_definition, "hash");
  NSUInteger v4 = -[NSString hash](self->_sessionID, "hash") ^ v3;
  unint64_t v5 = -[RBSProcessInstance hash](self->_host, "hash");
  uint64_t v6 = v4 ^ v5 ^ -[NSUUID hash](self->_uuid, "hash");
  NSUInteger v7 = -[NSString hash](self->_personaString, "hash");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (definition == (RBSXPCServiceDefinition *)v6
    || (definition ? (BOOL v8 = v6 == 0) : (BOOL v8 = 1), !v8 && -[RBSXPCServiceDefinition isEqual:](definition, "isEqual:", v6)))
  {
...
LABEL_23:
        ...
        else
        {
          ...
          if (validationToken && v23) {
            char v12 = -[NSData isEqual:](validationToken, "isEqual:", v23);
          }
        }
...
{
  id v4 = a3;
  id v5 = -[RBSXPCServiceIdentity init](self, "init");
  if (v5)
  {
