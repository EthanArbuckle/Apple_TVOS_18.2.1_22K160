...
- (RequesterRequest)initWithDate:(id)a3 requestIdentifier:(id)a4 uniqueIdentifier:(id)a5 itemIdentifier:(id)a6 localizations:(id)a7 offerName:(id)a8 status:(int64_t)a9
{
  ...
  id v18 = a8;
  v25.receiver = self;
  v25.super_class = (Class)&OBJC_CLASS___RequesterRequest;
...
- (id)compile
{
  ...
  id v4 = (void *)objc_claimAutoreleasedReturnValue(-[RequesterRequest date](self, "date"));
  ...
  uint64_t v6 = (void *)objc_claimAutoreleasedReturnValue(-[RequesterRequest uniqueIdentifier](self, "uniqueIdentifier"));
  -[NSMutableDictionary ap_setNullableObject:forKey:](v3, "ap_setNullableObject:forKey:", v6, @"uniqueIdentifier");

  id v7 = (void *)objc_claimAutoreleasedReturnValue(-[RequesterRequest itemIdentifier](self, "itemIdentifier"));
  -[NSMutableDictionary ap_setNullableObject:forKey:](v3, "ap_setNullableObject:forKey:", v7, @"itemIdentifier");

  uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue(-[RequesterRequest localizations](self, "localizations"));
  ...
  uint64_t v11 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( &OBJC_CLASS___NSNumber,  "numberWithInteger:",  -[RequesterRequest status](self, "status")));
...
- (NSString)description
{
  ...
  id v4 = (void *)objc_claimAutoreleasedReturnValue( -[RequesterRequest ap_generateDescriptionWithSubObjects:]( self,  "ap_generateDescriptionWithSubObjects:",  v3));
