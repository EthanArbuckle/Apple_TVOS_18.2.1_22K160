...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___GTTransportMessage_tools_diagnostics;
  v8 = -[GTTransportMessage_tools_diagnostics init](&v11, "init");
  v9 = v8;
  if (v8)
  {
    v8->_kind = a3;
...
- (GTTransportMessage_tools_diagnostics)initWithKind:(int)a3 attributes:(id)a4 BOOLPayload:(BOOL)a5
{
  ...
  {
    v9 = v8;
    v10 = -[GTTransportMessage_tools_diagnostics initWithKind:attributes:payload:]( self,  "initWithKind:attributes:payload:",  v6,  a4,  v8);
  }
...
- (GTTransportMessage_tools_diagnostics)initWithKind:(int)a3 attributes:(id)a4 plistPayload:(id)a5
{
  ...
  v10 = -[GTTransportMessage_tools_diagnostics initWithKind:attributes:payload:]( self,  "initWithKind:attributes:payload:",  v6,  a4,  v9);
...
- (GTTransportMessage_tools_diagnostics)initWithKind:(int)a3 attributes:(id)a4 stringPayload:(id)a5
{
  ...
  {
LABEL_5:
    CFDataRef v9 = -[GTTransportMessage_tools_diagnostics initWithKind:attributes:payload:]( self,  "initWithKind:attributes:payload:",  v6,  a4,  ExternalRepresentation);
...
- (GTTransportMessage_tools_diagnostics)initWithKind:(int)a3 attributes:(id)a4 objectPayload:(id)a5
{
  ...
  objc_super v11 = -[GTTransportMessage_tools_diagnostics initWithKind:attributes:payload:]( self,  "initWithKind:attributes:payload:",  v7,  a4,  v5);
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___GTTransportMessage_tools_diagnostics;
  -[GTTransportMessage_tools_diagnostics dealloc](&v3, "dealloc");
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___GTTransportMessage_tools_diagnostics;
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@ kind=0x%x serial=%u, reply serial=%u",  -[GTTransportMessage_tools_diagnostics description](&v3, "description"),  self->_kind,  self->_serial,  self->_replySerial);
}

- (BOOL)hasBeenSent
{
  return -[GTTransportMessage_tools_diagnostics serial](self, "serial") != -1;
}
...
- (id)attributeForKey:(id)a3
{
  return -[NSDictionary objectForKey:]( -[GTTransportMessage_tools_diagnostics attributes](self, "attributes"),  "objectForKey:",  a3);
}

- (unsigned)uint32ForKey:(id)a3
{
  return objc_msgSend( -[NSDictionary objectForKey:]( -[GTTransportMessage_tools_diagnostics attributes](self, "attributes"),  "objectForKey:",  a3),  "unsignedIntValue");
}

- (unint64_t)uint64ForKey:(id)a3
{
  return (unint64_t)objc_msgSend( -[NSDictionary objectForKey:]( -[GTTransportMessage_tools_diagnostics attributes](self, "attributes"),  "objectForKey:",  a3),  "unsignedLongLongValue");
}
...
- (BOOL)BOOLForKey:(id)a3
{
  return objc_msgSend( -[NSDictionary objectForKey:]( -[GTTransportMessage_tools_diagnostics attributes](self, "attributes"),  "objectForKey:",  a3),  "BOOLValue");
}
...
LABEL_7:
      ...
      case 0u:
        ...
        if (!v5)
        {
          id decodedPayload = -[GTTransportMessage_tools_diagnostics objectPayload](self, "objectPayload");
          if (decodedPayload) {
