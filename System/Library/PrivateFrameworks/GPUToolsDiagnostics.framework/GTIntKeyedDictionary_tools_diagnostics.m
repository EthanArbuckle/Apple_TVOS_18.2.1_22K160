...
- (GTIntKeyedDictionary_tools_diagnostics)init
{
  return -[GTIntKeyedDictionary_tools_diagnostics initWithCapacity:](self, "initWithCapacity:", 0LL);
}

- (GTIntKeyedDictionary_tools_diagnostics)initWithCapacity:(unint64_t)a3
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___GTIntKeyedDictionary_tools_diagnostics;
  v4 = -[GTIntKeyedDictionary_tools_diagnostics init](&v8, "init");
  if (v4)
  {
...
- (GTIntKeyedDictionary_tools_diagnostics)initWithIntKeyedDictionary:(id)a3
{
  v4 = -[GTIntKeyedDictionary_tools_diagnostics initWithCapacity:](self, "initWithCapacity:", [a3 count]);
  v5 = v4;
  if (v4)
  {
...
LABEL_8:
  ...
  v9 = v8;
  v10 = -[GTIntKeyedDictionary_tools_diagnostics initWithCapacity:]( self,  "initWithCapacity:",  [v8 count]);
  v11 = v10;
  if (v10)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5[3] = &unk_208C8;
  v5[4] = a3;
  -[GTIntKeyedDictionary_tools_diagnostics enumerateKeysAndObjectsUsingBlock:]( self,  "enumerateKeysAndObjectsUsingBlock:",  v5);
}
...
- (void)dealloc
{
  ...
  if (v3)
  {
    ...
    uint64_t v5 = (void *)std::__hash_table<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>,std::allocator<unsigned long>>::~__hash_table((uint64_t)v3);
    operator delete(v5);
  }

  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___GTIntKeyedDictionary_tools_diagnostics;
  -[GTIntKeyedDictionary_tools_diagnostics dealloc](&v6, "dealloc");
}
...
- (void)setObject:(id)a3 forIntKey:(int64_t)a4
{
  if (!a3)
  {
    -[GTIntKeyedDictionary_tools_diagnostics removeObjectForIntKey:](self, "removeObjectForIntKey:", a4);
    return;
  }
...
{
  v3 = self->_private;
  unint64_t v4 = std::__hash_table<std::__hash_value_type<unsigned long,std::vector<unsigned long>>,std::__unordered_map_hasher<unsigned long,std::__hash_value_type<unsigned long,std::vector<unsigned long>>,std::hash<unsigned long>,std::equal_to<unsigned long>,true>,std::__unordered_map_equal<unsigned long,std::__hash_value_type<unsigned long,std::vector<unsigned long>>,std::equal_to<unsigned long>,std::hash<unsigned long>,true>,std::allocator<std::__hash_value_type<unsigned long,std::vector<unsigned long>>>>::find<unsigned long>( v3,  a3);
  if (v4)
  {
    uint64_t v5 = v4;
...
- (id)objectForKey:(id)a3
{
  return -[GTIntKeyedDictionary_tools_diagnostics objectForIntKey:]( self,  "objectForIntKey:",  [a3 longLongValue]);
}
