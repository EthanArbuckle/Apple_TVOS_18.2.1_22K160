...
LABEL_30:
      ...
      if (([v85 isEqual:NAKey] & 1) == 0)
      {
        ...
        {
          [v103 addObject:&off_1000258D0];
        }

        else if ([v85 isEqual:orKey])
        {
          [v103 addObject:&off_1000258E8];
        }

        [v104 addObject:v85];
        [v105 addObject:&off_1000258E8];
        goto LABEL_67;
      }
      ...
      if ([v81 isEqual:HasLengthEqualTo])
      {
        id v48 = [v82 count];
          ...
          objc_storeStrong(&v79, &off_1000258E8);
        }
LABEL_50:
        if ([v103 count])
        {
...
LABEL_47:
        objc_storeStrong(&v79, &off_1000258D0);
      }
...
LABEL_15:
    if (v33
      ...
      && v30
      && v29
      && (([v30 isEqual:&off_1000258E8] & 1) != 0
       || ([v30 isEqual:&off_1000258D0] & 1) != 0))
    {
...
LABEL_31:
    if (v111 && v110)
    {
      ...
      if (v102)
      {
        ...
        id v94 = [v97 sortedArrayUsingComparator:&stru_100024258];
...
- (id)strideCopyArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v22) {
    objc_storeStrong(&v22, &off_1000258E8);
  }
  if (v24 && v23 && v25 && v26)
  {
...
- (id)strideCopyAndSplitArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v59) {
    objc_storeStrong(&v59, &off_1000258E8);
  }
