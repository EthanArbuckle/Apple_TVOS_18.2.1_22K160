...
LABEL_30:
      ...
      if (([v85 isEqual:NAKey] & 1) == 0)
      {
        ...
        {
          [v103 addObject:&off_10002DED0];
        }

        else if ([v85 isEqual:orKey])
        {
          [v103 addObject:&off_10002DEE8];
        }
      ...
      if ([v81 isEqual:HasLengthEqualTo])
      {
        id v48 = [v82 count];
          ...
          objc_storeStrong(&v79, &off_10002DEE8);
        }
LABEL_50:
        if ([v103 count])
        {
...
LABEL_47:
        objc_storeStrong(&v79, &off_10002DED0);
      }
...
LABEL_15:
    if (v33
      ...
      && v30
      && v29
      && (([v30 isEqual:&off_10002DEE8] & 1) != 0
       || ([v30 isEqual:&off_10002DED0] & 1) != 0))
    {
...
LABEL_31:
    if (v111 && v110)
    {
      ...
      if (v102)
      {
        ...
        id v94 = [v97 sortedArrayUsingComparator:&__block_literal_global];
...
- (id)spliceArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  else
  {
    ...
    id v6 = -[NSError initWithDomain:code:userInfo:](v5, "initWithDomain:code:userInfo:", v37, 47LL, 0LL);
    *id v38 = v6;
    id v41 = 0LL;
    int v27 = 1;
  }
...
- (id)strideCopyArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v22) {
    objc_storeStrong(&v22, &off_10002DEE8);
  }
  if (v24 && v23 && v25 && v26)
  {
  ...
  {
    id v5 = objc_alloc(&OBJC_CLASS___NSError);
    id v6 = -[NSError initWithDomain:code:userInfo:](v5, "initWithDomain:code:userInfo:", v27, 48LL, 0LL);
    *id v28 = v6;
    id v31 = 0LL;
    int v21 = 1;
  }
...
- (id)strideCopyAndSplitArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v59) {
    objc_storeStrong(&v59, &off_10002DEE8);
  }
  ...
  {
    id v5 = objc_alloc(&OBJC_CLASS___NSError);
    id v6 = -[NSError initWithDomain:code:userInfo:](v5, "initWithDomain:code:userInfo:", v63, 87LL, 0LL);
    *id v64 = v6;
    BOOL v67 = 0LL;
    int v57 = 1;
  }
...
- (id)twoArrayMathFunction:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  {
    id v5 = objc_alloc(&OBJC_CLASS___NSError);
    id v6 = -[NSError initWithDomain:code:userInfo:](v5, "initWithDomain:code:userInfo:", v56, 88LL, 0LL);
    *int v57 = v6;
    id v60 = 0LL;
    int v51 = 1;
    goto LABEL_35;
...
LABEL_38:
  ...
  id v5 = objc_alloc(&OBJC_CLASS___NSError);
  id v6 = -[NSError initWithDomain:code:userInfo:](v5, "initWithDomain:code:userInfo:", v63, 49LL, 0LL);
  *id v64 = v6;
  BOOL v67 = 0LL;
  int v55 = 1;
LABEL_40:
