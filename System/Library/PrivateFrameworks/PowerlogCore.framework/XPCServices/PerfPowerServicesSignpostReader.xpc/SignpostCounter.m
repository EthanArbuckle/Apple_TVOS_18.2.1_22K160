...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___SignpostCounter;
  result = -[SignpostCounter init](&v8, "init");
  if (result)
  {
    result->count = 0LL;
    result->mxSignpostIntervalCounts = 0LL;
    result->mxSignpostIntervalOverlaps = 0LL;
