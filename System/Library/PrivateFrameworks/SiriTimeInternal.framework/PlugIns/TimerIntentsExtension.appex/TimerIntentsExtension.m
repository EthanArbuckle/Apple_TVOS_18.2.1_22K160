uint64_t sub_100002C40()
{
  ...
  sub_100003804(v0, qword_100008158);
  sub_100002FC8(v0, (uint64_t)qword_100008158);
  return static SiriTimeLog.timerFlow.getter();
}

unint64_t sub_100002C88@<X0>(void *a1@<X0>, uint64_t *a2@<X8>)
{
  if (qword_100008150 != -1) {
    swift_once(&qword_100008150, sub_100002C40);
  }
  uint64_t v4 = type metadata accessor for Logger(0LL);
  sub_100002FC8(v4, (uint64_t)qword_100008158);
  id v5 = a1;
  ...
  if (os_log_type_enabled(v6, v7))
  {
    ...
    *(_DWORD *)v8 = 136315138;
    ...
    uint64_t v19 = sub_10000301C(v12, v14, &v20);
  ...
  uint64_t v16 = static TimerIntentHandlerRouter.getIntentHandler(intent:)(v5);
  unint64_t result = sub_100002FE0();
  a2[3] = result;
  *a2 = v16;
  return result;
}
...
{
  return objc_opt_self(&OBJC_CLASS____TtC21TimerIntentsExtension13IntentHandler);
}

void *sub_100002F84(void *result, uint64_t a2)
{
...
uint64_t sub_100002FA8(void *a1)
{
...
uint64_t sub_10000301C(uint64_t a1, unint64_t a2, uint64_t *a3)
{
  v6 = sub_1000030EC(v12, 0LL, 0LL, 1, a1, a2);
  uint64_t v7 = v12[0];
  if (v6)
  {
    v8 = v6;
...
void *sub_1000030EC(void *a1, char *__dst, uint64_t a3, char a4, uint64_t a5, unint64_t a6)
{
  if ((a6 & 0x2000000000000000LL) != 0)
  {
    if ((a4 & 1) == 0 && __dst && a3 - (uint64_t)__dst > (uint64_t)(HIBYTE(a6) & 0xF))
    {
      ...
      sub_100003240((char *)__src, HIBYTE(a6) & 0xF, __dst);
  ...
  {
LABEL_11:
    unint64_t result = sub_100003304(a5, a6);
    *a1 = v12;
    return result;
  }
...
void *sub_100003240(char *__src, size_t __n, char *__dst)
{
...
void *sub_100003304(uint64_t a1, unint64_t a2)
{
  objc_super v2 = sub_100003398(a1, a2);
  if ((swift_isUniquelyReferenced_nonNull_native() & 1) == 0) {
    objc_super v2 = sub_10000356C(0LL, v2[2] + 1LL, 1, (uint64_t)v2);
  }
  unint64_t v4 = v2[2];
  unint64_t v3 = v2[3];
  if (v4 >= v3 >> 1) {
    objc_super v2 = sub_10000356C((char *)(v3 > 1), v4 + 1, 1, (uint64_t)v2);
  }
  v2[2] = v4 + 1;
  *((_BYTE *)v2 + v4 + 32) = 0;
  return v2;
...
void *sub_100003398(uint64_t a1, unint64_t a2)
{
...
void *sub_100003508(uint64_t a1, uint64_t a2)
{
  if (a2 <= a1) {
    uint64_t v2 = a1;
  }
  ...
  uint64_t v4 = sub_1000037C0(&qword_100008148);
...
char *sub_10000356C(char *result, int64_t a2, char a3, uint64_t a4)
{
  char v5 = (char)result;
  if ((a3 & 1) != 0)
  {
  ...
  if (v9)
  {
    uint64_t v10 = sub_1000037C0(&qword_100008148);
  ...
  if ((v5 & 1) != 0)
  {
    sub_100003704(v14, v8, v13);
    *(void *)(a4 + 16) = 0LL;
  }

  else
  {
    sub_100003640(v14, v8, v13);
  }
...
void *sub_100003640(char *__src, size_t __n, char *__dst)
{
  if ((__n & 0x8000000000000000LL) != 0)
  {
...
char *sub_100003704(char *__src, size_t __len, char *__dst)
{
...
uint64_t sub_100003784(uint64_t a1, uint64_t a2)
{
