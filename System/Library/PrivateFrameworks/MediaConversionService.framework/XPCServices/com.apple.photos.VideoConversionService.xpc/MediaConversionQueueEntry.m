...
- (id)clientRequestForIdentifier:(id)a3
{
  ...
  unsigned __int8 v13 = sub_100009550;
  id v14 = sub_100009560;
  id v15 = 0LL;
...
- (int64_t)compareProcessingOrderToEntry:(id)a3
{
  ...
  id v7 = (void *)objc_claimAutoreleasedReturnValue([v6 sortedArrayUsingComparator:&stru_100030CE0]);

  id v8 = (void *)objc_claimAutoreleasedReturnValue([v5 clientRequestsSnapshot]);
  id v9 = (void *)objc_claimAutoreleasedReturnValue([v8 sortedArrayUsingComparator:&stru_100030CE0]);
