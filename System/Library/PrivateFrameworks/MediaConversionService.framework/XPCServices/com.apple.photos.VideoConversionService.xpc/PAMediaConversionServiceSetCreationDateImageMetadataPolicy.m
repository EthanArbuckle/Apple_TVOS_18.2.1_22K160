...
+ (id)policyWithCreationDate:(id)a3 inTimeZone:(id)a4
{
  ...
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSTimeZone defaultTimeZone](&OBJC_CLASS___NSTimeZone, "defaultTimeZone"));
    [v9 setTimeZone:v10];
  }
...
- (BOOL)metadataNeedsProcessing:(id)a3
{
  ...
  if (v5)
  {
    ...
    v25 = v6;
    int v15 = sub_1000041F8(v6, v11, v14);
    ...
    if (v15)
    {
      ...
      v18 = v7;
      int v19 = sub_1000041F8(v7, v12, v17);
      ...
      if (v19)
      {
        ...
        char v22 = sub_1000041F8(v24, v13, v21);
