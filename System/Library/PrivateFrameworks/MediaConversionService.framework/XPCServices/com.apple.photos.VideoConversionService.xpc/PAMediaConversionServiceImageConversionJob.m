...
- (void)_validate
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl( (void *)&_mh_execute_header,  (os_log_t)&_os_log_default,  OS_SIGNPOST_INTERVAL_BEGIN,  v3,  "com.apple.photos.mediaconversion.service.validate",  (const char *)&unk_10002DD8D,  buf,  2u);
  }
  ...
  {
    *(_WORD *)v8 = 0;
    _os_signpost_emit_with_name_impl( (void *)&_mh_execute_header,  (os_log_t)&_os_log_default,  OS_SIGNPOST_INTERVAL_END,  v3,  "com.apple.photos.mediaconversion.service.validate",  (const char *)&unk_10002DD8D,  v8,  2u);
  }
}
