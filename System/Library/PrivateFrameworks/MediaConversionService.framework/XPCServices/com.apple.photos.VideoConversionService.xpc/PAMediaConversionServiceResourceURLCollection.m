...
- (id)bookmarkDataDictionaryRepresentationWithError:(id *)a3
{
  ...
  unsigned int v21 = sub_100006CD0;
  v22 = sub_100006CE0;
  id v23 = 0LL;
  uint64_t v14 = 0LL;
...
- (id)logMessageSummaryWithFullPath:(BOOL)a3
{
  ...
  char v11 = sub_100006F9C;
  BOOL v12 = &unk_100030B00;
...
- (void)enumerateResourceURLReferences:(id)a3
{
  ...
  id v6 = (void *)objc_claimAutoreleasedReturnValue([v5 sortedArrayUsingComparator:&stru_100030B48]);
...
{
  id v4 = a3;
  id v6 = (void *)objc_opt_new(a1, v5);
  [v6 setResourceURL:v4 forRole:@"PAMediaConversionResourceRoleMainResource"];

  return (PAMediaConversionServiceResourceURLCollection *)v6;
}
...
+ (id)collectionForBookmarkDataDictionaryRepresentation:(id)a3 accessProvider:(id)a4 error:(id *)a5
{
  ...
  if (!v9)
  {
    unsigned __int8 v15 = (void *)objc_claimAutoreleasedReturnValue(+[NSAssertionHandler currentHandler](&OBJC_CLASS___NSAssertionHandler, "currentHandler"));
  ...
  {
    if (v11) {
      [v12 setAccessProviderDelegate:v11];
    }
    id v13 = v12;
  }
...
+ (BOOL)getSignatureString:(id *)a3 filenameSummary:(id *)a4 forDictionaryRepresentation:(id)a5
{
  ...
  id v12 = (void *)objc_claimAutoreleasedReturnValue([v11 sortedArrayUsingComparator:&stru_100030A60]);
  ...
  if (v13)
  {
    ...
    do
    {
      for (i = 0LL; i != v14; i = (char *)i + 1)
      {
        ...
        id v29 = 0LL;
        id v19 = v9;
        uint64_t v20 = (void *)objc_claimAutoreleasedReturnValue([v9 objectForKeyedSubscript:v18]);
...
+ (id)filenameSummaryStringForDictionaryRepresentation:(id)a3
{
  ...
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue([v4 componentsJoinedByString:@"|"]);
...
- (NSDictionary)blastDoorVideoComplementProperties
{
  ...
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue(-[PAMediaConversionServiceResourceURLCollection accessProviderDelegate](self, "accessProviderDelegate"));
