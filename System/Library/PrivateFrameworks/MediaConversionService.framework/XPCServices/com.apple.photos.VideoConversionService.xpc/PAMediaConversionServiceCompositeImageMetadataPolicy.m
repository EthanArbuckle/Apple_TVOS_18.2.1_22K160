...
+ (id)policyWithPolicies:(id)a3
{
  ...
  if (!v6)
  {
    ...
    [v9 handleFailureInMethod:a2, a1, @"PAMediaConversionServiceImageMetadataPolicy.m", 335, @"Invalid parameter not satisfying: %@", @"policies" object file lineNumber description];
  }

  id v7 = (void *)objc_opt_new(&OBJC_CLASS___PAMediaConversionServiceCompositeImageMetadataPolicy, v5);
  [v7 setPolicies:v6];
