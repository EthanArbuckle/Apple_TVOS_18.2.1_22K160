...
+ (id)referenceWithURL:(id)a3
{
  ...
  unsigned int v6 = objc_opt_new(&OBJC_CLASS___PAMediaConversionServiceResourceURLReference);
  -[PAMediaConversionServiceResourceURLReference setUrl:](v6, "setUrl:", v5);
