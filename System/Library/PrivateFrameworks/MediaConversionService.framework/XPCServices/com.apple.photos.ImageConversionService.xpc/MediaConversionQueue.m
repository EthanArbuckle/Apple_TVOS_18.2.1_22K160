...
- (void)scheduleQueueProcessing
{
  ...
  block[2] = sub_10000DBEC;
  block[3] = &unk_100028BD0;
  block[4] = self;
...
- (id)entriesSortedByExecutionOrderForPendingEntries:(id)a3
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue([v4 sortedArrayUsingComparator:&stru_100028C10]);
...
- (void)modifyRequestWithIdentifier:(id)a3 changeHandler:(id)a4
{
  ...
  BOOL v17 = sub_10000AE04;
  id v18 = sub_10000AE14;
  id v19 = 0LL;
...
- (BOOL)findAndRemoveCancelledRequest:(id *)a3 queueEntryWithoutRemainingClients:(id *)a4 forRequestIdentifier:(id)a5 shouldCancelCurrentQueueEntry:(BOOL *)a6
{
  ...
  id v30 = sub_10000AE04;
  uint64_t v31 = sub_10000AE14;
  id v32 = 0LL;
  uint64_t v21 = 0LL;
  id v22 = &v21;
  uint64_t v23 = 0x3032000000LL;
  unsigned int v24 = sub_10000AE04;
  uint64_t v25 = sub_10000AE14;
  id v26 = 0LL;
