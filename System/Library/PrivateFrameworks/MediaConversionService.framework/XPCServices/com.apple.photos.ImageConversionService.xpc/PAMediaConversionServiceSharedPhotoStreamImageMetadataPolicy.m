...
{
  BOOL v3 = a3;
  id v4 = objc_opt_new(&OBJC_CLASS___PAMediaConversionServiceSharedPhotoStreamImageMetadataPolicy);
  unsigned int v5 = v4;
  if (v3)
  {
    id v6 = v4;
  ...
  else
  {
    ...
    id v6 = (PAMediaConversionServiceSharedPhotoStreamImageMetadataPolicy *)objc_claimAutoreleasedReturnValue( +[PAMediaConversionServiceCompositeImageMetadataPolicy policyWithPolicies:]( &OBJC_CLASS___PAMediaConversionServiceCompositeImageMetadataPolicy,  "policyWithPolicies:",  v8));
  }
