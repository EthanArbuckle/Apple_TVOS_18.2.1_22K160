...
- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"pS: %llu pR: %llu bS: %llu bR: %llu",  self->_packetsSent,  self->_packetsReceived,  self->_bytesSent,  self->_bytesReceived);
}
