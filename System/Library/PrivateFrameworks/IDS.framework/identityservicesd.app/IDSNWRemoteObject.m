...
- (IDSNWRemoteObject)initWithFramer:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___IDSNWRemoteObject;
  v6 = -[IDSNWRemoteObject init](&v9, "init");
  v7 = v6;
  if (v6) {
...
- (IDSNWRemoteObject)initWithFramer:(id)a3 forIDSDestination:(id)a4
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___IDSNWRemoteObject;
  objc_super v9 = -[IDSNWRemoteObject init](&v12, "init");
  v10 = v9;
  if (v9)
  {
