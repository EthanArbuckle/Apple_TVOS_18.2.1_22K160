...
- (IDSOffGridCryptionResult)initWithEncryptedData:(id)a3 keyIndex:(unsigned int)a4 key:(id)a5 keyID:(id)a6 authTag:(id)a7 error:(id)a8
{
  ...
  id v17 = a8;
  v23.receiver = self;
  v23.super_class = (Class)&OBJC_CLASS___IDSOffGridCryptionResult;
  v18 = -[IDSOffGridCryptionResult init](&v23, "init");
  v19 = v18;
  if (v18)
  {
...
- (IDSOffGridCryptionResult)initWithDecryptedData:(id)a3 key:(id)a4 originalRecipientURI:(id)a5 error:(id)a6
{
  ...
  id v14 = a6;
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___IDSOffGridCryptionResult;
  id v15 = -[IDSOffGridCryptionResult init](&v18, "init");
  id v16 = v15;
  if (v15)
  {
