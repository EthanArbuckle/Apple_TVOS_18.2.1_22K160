...
+ (IDSGroupEncryptionController)sharedInstance
{
  if (qword_1009C0A80 != -1) {
    dispatch_once(&qword_1009C0A80, &stru_100900418);
  }
  return (IDSGroupEncryptionController *)(id)qword_1009C0A88;
}

- (IDSGroupEncryptionController)init
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___IDSGroupEncryptionController;
  v2 = -[IDSGroupEncryptionController init](&v10, "init");
  if (v2)
  {
    v2->_shouldUseGecko = _os_feature_enabled_impl("IDS", "Gecko");
    v3 = (void *)objc_claimAutoreleasedReturnValue(+[IDSServerBag sharedInstance](&OBJC_CLASS___IDSServerBag, "sharedInstance"));
    v4 = (void *)objc_claimAutoreleasedReturnValue([v3 objectForKey:@"ids-gecko2-sample-rate"]);
    ...
    if (v2->_shouldUseGecko)
    {
      ...
      {
        v6 = &OBJC_CLASS___IDSGroupEncryptionController2Shim;
LABEL_11:
        uint64_t v7 = objc_claimAutoreleasedReturnValue(-[__objc2_class sharedInstance](v6, "sharedInstance"));
    ...
    v6 = &OBJC_CLASS___IDSGroupEncryptionController1;
    goto LABEL_11;
  }
