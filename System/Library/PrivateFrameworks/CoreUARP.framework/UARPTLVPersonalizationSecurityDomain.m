...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationSecurityDomain;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationSecurityDomain tlvType](&OBJC_CLASS___UARPTLVPersonalizationSecurityDomain, "tlvType");
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationSecurityDomain;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationSecurityDomain;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationSecurityDomain tlvType](UARPTLVPersonalizationSecurityDomain, "tlvType"));
