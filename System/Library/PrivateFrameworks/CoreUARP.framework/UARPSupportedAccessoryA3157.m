...
- (UARPSupportedAccessoryA3157)init
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___UARPSupportedAccessoryA3157;
  v2 = -[UARPSupportedAccessoryBeatsBluetooth init](&v16, sel_init);
  if (v2)
  {
    v3 = +[UARPSupportedAccessoryA3157 appleModelNumber](&OBJC_CLASS___UARPSupportedAccessoryA3157, "appleModelNumber");
    ...
    __int128 v12 = 0u;
    __int128 v13 = 0u;
    v4 = +[UARPSupportedAccessoryA3157 alternativeAppleModelNumbers]( &OBJC_CLASS___UARPSupportedAccessoryA3157,  "alternativeAppleModelNumbers",  0LL);
    ...
    v9 = -[UARPAccessoryHardwareBluetooth initWithVendorIDSource:vendorID:productID:productVersion:]( objc_alloc(&OBJC_CLASS___UARPAccessoryHardwareBluetooth),  "initWithVendorIDSource:vendorID:productID:productVersion:",  1LL,  +[UARPSupportedAccessoryBeatsBluetooth vendorID]( &OBJC_CLASS___UARPSupportedAccessoryBeatsBluetooth,  "vendorID"),  +[UARPSupportedAccessoryA3157 productID](&OBJC_CLASS___UARPSupportedAccessoryA3157, "productID"),  1LL);
    hwID = v2->hwID;
    v2->hwID = v9;
...
+ (id)alternativeAppleModelNumbers
{
  return (id)objc_msgSend(MEMORY[0x189604010], "setWithObjects:", @"A3158", @"A3159", 0);
}
