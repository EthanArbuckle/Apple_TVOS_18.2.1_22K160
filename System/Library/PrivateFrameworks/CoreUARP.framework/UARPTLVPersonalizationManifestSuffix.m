...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationManifestSuffix;
...
- (id)description
{
  ...
  [v4 stringWithFormat:@"<%@: %@>", v5, self->_manifestSuffix];
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationManifestSuffix tlvType](&OBJC_CLASS___UARPTLVPersonalizationManifestSuffix, "tlvType");
  manifestSuffix = self->_manifestSuffix;
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationManifestSuffix;
...
- (id)tlvValue
{
  manifestSuffix = self->_manifestSuffix;
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationManifestSuffix;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationManifestSuffix tlvType](UARPTLVPersonalizationManifestSuffix, "tlvType"));
