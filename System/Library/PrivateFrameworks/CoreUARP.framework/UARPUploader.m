...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPUploader;
...
- (void)firmwareStagingComplete:(id)a3 assetID:(id)a4 withStatus:(unint64_t)a5
{
  ...
  if (os_log_type_enabled(xpcLog, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v8;
    _os_log_impl( &dword_187DC0000,  v11,  OS_LOG_TYPE_INFO,  "Firmware Staging Complete Status = %s for Asset = %@ Accessory = %@",  (uint8_t *)&v13,  0x20u);
  }
