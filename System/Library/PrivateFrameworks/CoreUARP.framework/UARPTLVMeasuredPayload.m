...
- (UARPTLVMeasuredPayload)initWithCoder:(id)a3
{
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)&OBJC_CLASS___UARPTLVMeasuredPayload;
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = objc_alloc_init(&OBJC_CLASS___UARPTLVMeasuredPayload);
  uint64_t v5 = -[NSString copy](self->_payload4cc, "copy");
  payload4cc = v4->_payload4cc;
  v4->_payload4cc = (NSString *)v5;

  uint64_t v7 = -[NSString copy](self->_payloadLongname, "copy");
