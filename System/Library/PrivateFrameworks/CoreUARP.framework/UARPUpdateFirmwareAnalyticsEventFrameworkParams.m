...
- (UARPUpdateFirmwareAnalyticsEventFrameworkParams)initWithCoder:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)&OBJC_CLASS___UARPUpdateFirmwareAnalyticsEventFrameworkParams;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    else
    {
      id v5 = v4;
      stagingUserInitiated = self->_stagingUserInitiated;
      v7 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams stagingUserInitiated](v5, "stagingUserInitiated");
      if (nullableObjectsEqual(stagingUserInitiated, (uint64_t)v7))
      {
        stagingDuration = self->_stagingDuration;
        v9 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams stagingDuration](v5, "stagingDuration");
        if (nullableObjectsEqual(stagingDuration, (uint64_t)v9))
        {
          stagingIterations = self->_stagingIterations;
          v11 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams stagingIterations](v5, "stagingIterations");
          if (nullableObjectsEqual(stagingIterations, (uint64_t)v11))
          {
            stagingStatus = self->_stagingStatus;
            v13 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams stagingStatus](v5, "stagingStatus");
            if (nullableObjectsEqual(stagingStatus, (uint64_t)v13))
            {
              stagingVendorError = self->_stagingVendorError;
              v15 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams stagingVendorError](v5, "stagingVendorError");
              if (nullableObjectsEqual(stagingVendorError, (uint64_t)v15))
              {
                applyUserInitiated = self->_applyUserInitiated;
                v17 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams applyUserInitiated](v5, "applyUserInitiated");
                if (nullableObjectsEqual(applyUserInitiated, (uint64_t)v17))
                {
                  applyDuration = self->_applyDuration;
                  uint64_t v19 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams applyDuration](v5, "applyDuration");
                  ...
                  if (nullableObjectsEqual(v20, v19))
                  {
                    ...
                    v27 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams applyStatus](v5, "applyStatus");
                    if (nullableObjectsEqual(applyStatus, (uint64_t)v27))
                    {
                      applyVendorError = self->_applyVendorError;
                      v24 = -[UARPUpdateFirmwareAnalyticsEventFrameworkParams applyVendorError](v5, "applyVendorError", v27);
