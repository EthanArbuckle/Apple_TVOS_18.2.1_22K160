...
- (UARPConsent)initWithAccessoryName:(id)a3 assetVersion:(id)a4
{
  ...
  id v7 = a4;
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___UARPConsent;
...
- (UARPConsent)initWithAccessoryName:(id)a3 appleModelNumber:(id)a4 assetVersion:(id)a5
{
  ...
  id v10 = a5;
  v21.receiver = self;
  v21.super_class = (Class)&OBJC_CLASS___UARPConsent;
  uint64_t v11 = -[UARPConsent init](&v21, sel_init);
  if (v11)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = -[UARPConsent initWithAccessoryName:appleModelNumber:assetVersion:]( objc_alloc(&OBJC_CLASS___UARPConsent),  "initWithAccessoryName:appleModelNumber:assetVersion:",  self->_accessoryName,  self->_appleModelNumber,  self->_assetVersion);
  v4->_isDownloadable = self->_isDownloadable;
  v4->_isRecommended = self->_isRecommended;
  uint64_t v5 = -[NSString copy](self->_warning, "copy");
  warning = v4->_warning;
  v4->_warning = (NSString *)v5;

  v4->_downloadSize = self->_downloadSize;
  uint64_t v7 = -[NSString copy](self->_consentDescription, "copy");
  ...
  uint64_t v9 = -[NSString copy](self->_installerProgressDescription, "copy");
  installerProgressDescription = v4->_installerProgressDescription;
  v4->_installerProgressDescription = (NSString *)v9;

  uint64_t v11 = -[NSString copy](self->_installerProgressPhase, "copy");
  ...
  uint64_t v13 = -[NSString copy](self->_assetBuildVersion, "copy");
...
{
  id v4 = a3;
  [v4 decodeObjectOfClass:objc_opt_class() forKey:@"accessoryName"];
  id v5 = (void *)objc_claimAutoreleasedReturnValue();
  [v4 decodeObjectOfClass:objc_opt_class() forKey:@"appleModelNumber"];
  id v6 = (void *)objc_claimAutoreleasedReturnValue();
  [v4 decodeObjectOfClass:objc_opt_class() forKey:@"asetVersion"];
  uint64_t v7 = (void *)objc_claimAutoreleasedReturnValue();
  id v8 = -[UARPConsent initWithAccessoryName:appleModelNumber:assetVersion:]( self,  "initWithAccessoryName:appleModelNumber:assetVersion:",  v5,  v6,  v7);
...
- (id)description
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue();
  [v3 stringWithFormat:@"<%@: _accessoryName=%@, _appleModelNumber=%@, _assetVersion=%@, _consentDescription=%@ _warning=%@ _needsPostLogoutMode=%d, _installerProgressDescription=%@, _installerOverallProgress=%@>", v5, self->_accessoryName, self->_appleModelNumber, self->_assetVersion, self->_consentDescription, self->_warning, self->_needsPostLogoutMode, self->_installerProgressDescription, self->_installerOverallProgress];
  id v6 = (void *)objc_claimAutoreleasedReturnValue();
