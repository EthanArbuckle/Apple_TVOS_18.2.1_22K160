...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___UARPAccessoryHIDPersonality;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    {
      v5 = v4;
      int v6 = -[UARPAccessoryHIDPersonality vendorID](self, "vendorID");
      if (v6 == -[UARPAccessoryHIDPersonality vendorID](v5, "vendorID"))
      {
        int v7 = -[UARPAccessoryHIDPersonality productID](self, "productID");
        BOOL v8 = v7 == -[UARPAccessoryHIDPersonality productID](v5, "productID");
      }
