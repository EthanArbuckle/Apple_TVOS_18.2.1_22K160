...
- (UARPAccessoryHardwareCHIP)initWithVendorID:(unsigned __int16)a3 productID:(unsigned __int16)a4 hardwareID:(unsigned __int16)a5 metadata:(id)a6
{
  id v11 = a6;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___UARPAccessoryHardwareCHIP;
  v12 = -[UARPAccessoryHardwareID initWithTransport:](&v15, sel_initWithTransport_, 6LL);
  v13 = v12;
  if (v12)
  {
    v12->_vendorID = a3;
...
- (UARPAccessoryMetadata)metadata
{
  return (UARPAccessoryMetadata *)objc_getProperty(self, a2, 24LL, 1);
}
