...
- (UARPSupportedAccessoryA3048)init
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___UARPSupportedAccessoryA3048;
  v2 = -[UARPSupportedAccessoryAirPodsBud init](&v16, sel_init);
  if (v2)
  {
    v3 = +[UARPSupportedAccessoryA3048 appleModelNumber](&OBJC_CLASS___UARPSupportedAccessoryA3048, "appleModelNumber");
    -[UARPSupportedAccessory setAppleModelNumber:](v2, "setAppleModelNumber:", v3);

    -[UARPSupportedAccessory setModelName:](v2, "setModelName:", @"AirPods Pro 2 (USB-C)");
    __int128 v14 = 0u;
    __int128 v15 = 0u;
    __int128 v12 = 0u;
    __int128 v13 = 0u;
    v4 = +[UARPSupportedAccessoryA3048 alternativeAppleModelNumbers]( &OBJC_CLASS___UARPSupportedAccessoryA3048,  "alternativeAppleModelNumbers",  0LL);
...
+ (id)alternativeAppleModelNumbers
{
  return (id)objc_msgSend(MEMORY[0x189604010], "setWithObjects:", @"A3047", @"A3049", 0);
}
