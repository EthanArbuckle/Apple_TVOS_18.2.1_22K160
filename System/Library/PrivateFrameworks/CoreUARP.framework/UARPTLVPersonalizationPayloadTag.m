...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationPayloadTag;
...
- (id)generateTLV
{
  ...
  int v8 = uarpHtonl(+[UARPTLVPersonalizationPayloadTag tlvType](&OBJC_CLASS___UARPTLVPersonalizationPayloadTag, "tlvType"));
  [v3 appendBytes:&v8 length:4];
  int v7 = uarpHtonl(4u);
  [v3 appendBytes:&v7 length:4];
  v4 = -[UARPTLVPersonalizationPayloadTag tlvValue](self, "tlvValue");
  [v3 appendData:v4];
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationPayloadTag tlvType](UARPTLVPersonalizationPayloadTag, "tlvType"));
