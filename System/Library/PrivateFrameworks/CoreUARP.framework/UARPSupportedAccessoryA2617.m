...
- (UARPSupportedAccessoryA2617)init
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___UARPSupportedAccessoryA2617;
  v2 = -[UARPSupportedAccessoryAirPodsCase init](&v17, sel_init);
  if (v2)
  {
    v3 = +[UARPSupportedAccessoryA2617 appleModelNumber](&OBJC_CLASS___UARPSupportedAccessoryA2617, "appleModelNumber");
    ...
    __int128 v13 = 0u;
    __int128 v14 = 0u;
    v5 = +[UARPSupportedAccessoryA2617 alternativeAppleModelNumbers]( &OBJC_CLASS___UARPSupportedAccessoryA2617,  "alternativeAppleModelNumbers",  0LL);
...
+ (id)alternativeAppleModelNumbers
{
  return (id)objc_msgSend(MEMORY[0x189604010], "setWithObjects:", @"A2617", 0);
}
