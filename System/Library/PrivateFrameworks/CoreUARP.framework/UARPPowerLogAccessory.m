...
- (UARPPowerLogAccessory)initWithModelNumber:(id)a3 uuid:(id)a4 stagingWindowPeriodSeconds:(unsigned int)a5
{
  ...
  id v9 = a4;
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___UARPPowerLogAccessory;
  ...
  if (v10)
  {
    ...
    dispatch_queue_t v15 = dispatch_queue_create("UARPPowerLogAccessory", 0LL);
    queue = v10->_queue;
    v10->_queue = (OS_dispatch_queue *)v15;

    v10->_stagingWindowTimerIntervalNS = 1000000000LL * a5;
  }
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPPowerLogAccessory;
...
void __85__UARPPowerLogAccessory_setReachableWithActiveFirmwareVersion_stagedFirmwareVersion___block_invoke( uint64_t a1)
{
  ...
  {
    *(_BYTE *)(v2 + 80) = 1;
    UARPPowerLogAccessoryReachable(*(void **)(*(void *)(a1 + 32) + 8LL), *(void **)(a1 + 40), *(void **)(a1 + 48));
    id v8 = *(os_log_s **)(*(void *)(a1 + 32) + 24LL);
  ...
  _os_log_impl(&dword_187DC0000, v6, OS_LOG_TYPE_INFO, v5, (uint8_t *)&v12, v7);
}
...
void __39__UARPPowerLogAccessory_setUnreachable__block_invoke(uint64_t a1)
{
  ...
  {
    *(_BYTE *)(v2 + 80) = 0;
    UARPPowerLogAccessoryUnreachable(*(void **)(*(void *)(a1 + 32) + 8LL));
    [*(id *)(a1 + 32) stagingStopped];
    objc_super v3 = *(os_log_s **)(*(void *)(a1 + 32) + 24LL);
    if (!os_log_type_enabled(v3, OS_LOG_TYPE_INFO)) {
      return;
    }
    uint64_t v4 = *(void *)(a1 + 32);
  ...
  _os_log_impl(&dword_187DC0000, v3, OS_LOG_TYPE_INFO, v5, (uint8_t *)&v7, 0xCu);
}
...
void __74__UARPPowerLogAccessory_setAssetOfferedWithVersion_activeFirmwareVersion___block_invoke(id *a1)
{
  ...
  if (*((_BYTE *)v1 + 81))
  {
    objc_super v3 = (os_log_s *)*((void *)v1 + 3);
  ...
  else
  {
    ...
    *((_BYTE *)a1[4] + 81) = 1;
    uint64_t v17 = (os_log_s *)*((void *)a1[4] + 3);
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v19;
      _os_log_impl( &dword_187DC0000,  v17,  OS_LOG_TYPE_INFO,  "%@ asset offered. offeredFW=%@, activeFW=%@",  (uint8_t *)&v21,  0x20u);
    }
  }
...
void __95__UARPPowerLogAccessory_setStagingCompleteForStagedFirmareVersion_activeFirmareVersion_status___block_invoke( uint64_t a1)
{
  ...
  if (*(_BYTE *)(v1 + 81))
  {
    ...
    [*(id *)(a1 + 32) stagingStopped];
    uint64_t v4 = *(os_log_s **)(*(void *)(a1 + 32) + 24LL);
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v6;
      _os_log_impl( &dword_187DC0000,  v4,  OS_LOG_TYPE_INFO,  "%@ staging complete. stagedFW=%@, activeFW=%@",  (uint8_t *)&v15,  0x20u);
    }
  }

  else
  {
    id v8 = *(os_log_s **)(v1 + 24);
...
- (void)startStagingWindowTimer
{
  objc_super v3 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x1895F8B78], 0LL, 0LL, (dispatch_queue_t)self->_queue);
  ...
  dispatch_time_t v6 = dispatch_time(0LL, self->_stagingWindowTimerIntervalNS);
...
- (void)stagingWindowTimeFired
{
  ...
  if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl( &dword_187DC0000,  log,  OS_LOG_TYPE_INFO,  "%@ staging timer fired. activeFW=%@, stagingFW=%@, off=%u, tx=%u",  (uint8_t *)&v8,  0x2Cu);
  }
...
void __82__UARPPowerLogAccessory_updateStagingProgressWithRequestedOffset_requestedLength___block_invoke( uint64_t a1)
{
  ...
  if (*(_BYTE *)(v2 + 81))
  {
    ...
    *(_DWORD *)(*(void *)(a1 + 32) + 56LL) += *(_DWORD *)(a1 + 44);
  }

  else
  {
    uint64_t v4 = *(os_log_s **)(v2 + 24);
...
- (void)stagingStopped
{
  ...
  {
    dispatch_source_cancel((dispatch_source_t)stagingWindowTimer);
    uint64_t v4 = self->_stagingWindowTimer;
    self->_stagingWindowTimer = 0LL;
  }

  stagingActiveFirmwareVersion = self->_stagingActiveFirmwareVersion;
  self->_stagingActiveFirmwareVersion = 0LL;

  stagingStagingFirmwareVersion = self->_stagingStagingFirmwareVersion;
  self->_stagingStagingFirmwareVersion = 0LL;
...
- (id)description
{
  ...
  uuid = self->_uuid;
  [MEMORY[0x189607968] numberWithBool:self->_reachable];
  uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue();
  [MEMORY[0x189607968] numberWithBool:self->_stagingInProgress];
  uint64_t v9 = (void *)objc_claimAutoreleasedReturnValue();
  [v3 stringWithFormat:@"<%@: %@ %@ reachable=%@, staging=%@>", v5, modelNumber, uuid, v8, v9];
...
void __74__UARPPowerLogAccessory_setAssetOfferedWithVersion_activeFirmwareVersion___block_invoke_cold_1( uint64_t a1,  os_log_s *a2,  uint64_t a3,  uint64_t a4,  uint64_t a5,  uint64_t a6,  uint64_t a7,  uint64_t a8)
{
}

void __95__UARPPowerLogAccessory_setStagingCompleteForStagedFirmareVersion_activeFirmareVersion_status___block_invoke_cold_1( uint64_t a1,  os_log_s *a2,  uint64_t a3,  uint64_t a4,  uint64_t a5,  uint64_t a6,  uint64_t a7,  uint64_t a8)
{
}

void __82__UARPPowerLogAccessory_updateStagingProgressWithRequestedOffset_requestedLength___block_invoke_cold_1( uint64_t a1,  os_log_s *a2,  uint64_t a3,  uint64_t a4,  uint64_t a5,  uint64_t a6,  uint64_t a7,  uint64_t a8)
{
}
