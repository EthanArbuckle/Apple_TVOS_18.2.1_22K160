...
- (UARPSupportedAccessoryA3053)init
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___UARPSupportedAccessoryA3053;
  v2 = -[UARPSupportedAccessoryAirPodsBud init](&v16, sel_init);
  if (v2)
  {
    v3 = +[UARPSupportedAccessoryA3053 appleModelNumber](&OBJC_CLASS___UARPSupportedAccessoryA3053, "appleModelNumber");
    ...
    __int128 v12 = 0u;
    __int128 v13 = 0u;
    v4 = +[UARPSupportedAccessoryA3053 alternativeAppleModelNumbers]( &OBJC_CLASS___UARPSupportedAccessoryA3053,  "alternativeAppleModelNumbers",  0LL);
...
+ (id)alternativeAppleModelNumbers
{
  return (id)objc_msgSend(MEMORY[0x189604010], "setWithObjects:", @"A3050", 0);
}
