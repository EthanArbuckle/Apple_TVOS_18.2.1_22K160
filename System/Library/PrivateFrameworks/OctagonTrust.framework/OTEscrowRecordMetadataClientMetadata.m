...
- (id)description
{
  ...
  v4 = -[OTEscrowRecordMetadataClientMetadata description](&v8, sel_description);
  v5 = -[OTEscrowRecordMetadataClientMetadata dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    [MEMORY[0x189607968] numberWithUnsignedLongLong:self->_secureBackupMetadataTimestamp];
...
LABEL_3:
  ...
  [MEMORY[0x189607968] numberWithUnsignedLongLong:self->_secureBackupNumericPassphraseLength];
