...
- (id)description
{
  v3 = (void *)NSString;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___OTWalrus;
  v4 = -[OTWalrus description](&v8, sel_description);
  v5 = -[OTWalrus dictionaryRepresentation](self, "dictionaryRepresentation");
