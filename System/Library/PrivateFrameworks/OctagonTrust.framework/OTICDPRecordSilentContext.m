...
- (id)description
{
  v3 = (void *)NSString;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___OTICDPRecordSilentContext;
  v4 = -[OTICDPRecordSilentContext description](&v8, sel_description);
  v5 = -[OTICDPRecordSilentContext dictionaryRepresentation](self, "dictionaryRepresentation");
