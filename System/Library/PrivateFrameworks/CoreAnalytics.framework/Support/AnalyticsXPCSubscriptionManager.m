...
{
  id v3 = a3;
  _s10analyticsd31AnalyticsXPCSubscriptionManagerC26subscribeToUserDataChanges9argumentsySo5NSSetC_tFZ_0((uint64_t)v3);
}

+ (id)AnalyticsQueryValuesWrapperWithArguments:(id)a3
{
  id v3 = a3;
  xpc_object_t v4 = AnalyticsQueryValuesFor(arguments:)((uint64_t)v3);
...
- (_TtC10analyticsd31AnalyticsXPCSubscriptionManager)init
{
  ...
  return -[AnalyticsXPCSubscriptionManager init](&v3, "init");
}
