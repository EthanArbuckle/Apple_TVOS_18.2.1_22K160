...
- (id)configurationClasses
{
  uint64_t v2 = sub_100003610(&qword_1000109C0);
  uint64_t v3 = swift_allocObject(v2, 40LL, 7LL);
  *(_OWORD *)(v3 + 16) = xmmword_100009D90;
  *(void *)(v3 + 32) = sub_100008C6C(0LL, &qword_1000109C8, &OBJC_CLASS___RMModelLegacyProfileDeclaration_ptr);
...
- (void)beginProcessingConfigurationsForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  v13[5] = v12;
  v14 = self;
  uint64_t v15 = sub_1000051C8((uint64_t)v8, (uint64_t)&unk_100010B78, (uint64_t)v13);
  swift_release(v15);
}
...
- (void)endProcessingConfigurations:(BOOL)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  *(void *)(v12 + 40) = self;
  ...
  v15[5] = v14;
  uint64_t v16 = self;
  uint64_t v17 = sub_1000051C8((uint64_t)v10, (uint64_t)&unk_100010B58, (uint64_t)v15);
  swift_release(v17);
}
...
- (void)allDeclarationKeysForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  v13[5] = v12;
  v14 = self;
  uint64_t v15 = sub_1000051C8((uint64_t)v8, (uint64_t)&unk_100010B28, (uint64_t)v13);
  swift_release(v15);
}
...
- (void)applyConfiguration:(RMSubscribedConfigurationReference *)a3 replaceKey:(RMStoreDeclarationKey *)a4 scope:(int64_t)a5 completionHandler:(id)a6
{
  ...
  v19 = a4;
  v20 = self;
  uint64_t v21 = sub_1000051C8((uint64_t)v12, (uint64_t)&unk_100010B00, (uint64_t)v17);
  swift_release(v21);
}
...
- (void)removeDeclarationKey:(RMStoreDeclarationKey *)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  uint64_t v16 = a3;
  uint64_t v17 = self;
  uint64_t v18 = sub_1000051C8((uint64_t)v10, (uint64_t)&unk_100010AD0, (uint64_t)v15);
  swift_release(v18);
}

- (id)declarationKeyForConfiguration:(id)a3
{
  uint64_t v3 = *(void **)((char *)self + OBJC_IVAR____TtC24LegacyProfilesSubscriber21LegacyProfilesAdapter_profilesController);
  if (v3)
  {
    id v4 = self;
    id v5 = a3;
