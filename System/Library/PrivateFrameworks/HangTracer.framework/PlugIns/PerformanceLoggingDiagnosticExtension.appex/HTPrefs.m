...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_100015FB0 != -1) {
    dispatch_once(&qword_100015FB0, &stru_1000103C8);
  }
  return (NSArray *)(id)qword_100015FB8;
}
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0LL; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = -[__CFString isEqualToString:](v14, "isEqualToString:", &stru_100010A08);
        if (v15) {
          v16 = v29;
        }
        else {
  ...
  if (os_log_type_enabled((os_log_t)obj, OS_LOG_TYPE_DEBUG)) {
    sub_1000090CC((uint64_t)v29, (uint64_t)a4, (os_log_t)obj);
  }
  v19 = 0LL;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (!-[NSString isEqualToString:](v9, "isEqualToString:", v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
      sub_100009150((uint64_t)v9, &self->_enablementPrefix, v11);
    }
  }
...
+ (id)sharedPrefs
{
  if (qword_100015FC8 != -1) {
    dispatch_once(&qword_100015FC8, &stru_1000103E8);
  }
  return (id)qword_100015FC0;
}
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *(_OWORD *)&result[13].var2.var0 = xmmword_10000AC80;
...
- (void)__createInternalSettings
{
  ...
  CFPreferencesSetValue( @"HangTracerInternalSettingsVersion",  &off_100011A18,  self->__htTaskingDomain,  @"mobile",  kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0LL;
  ...
  notify_register_dispatch(EPL_STATE_CHANGED_NOTIFICATION, v30 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch( HANGTRACER_TASKING_CHANGED_NOTIFICATION,  (int *)v39 + 6,  (dispatch_queue_t)self->__prefsQueue,  v20);
  notify_register_dispatch( HANGTRACER_TELEMETRY_CHANGED_NOTIFICATION,  v36 + 6,  (dispatch_queue_t)self->__prefsQueue,  v20);
  notify_register_dispatch( HANGTRACER_PROFILE_LIST_CHANGED_NOTIFICATION,  v33 + 6,  (dispatch_queue_t)self->__prefsQueue,  v20);
