...
- (id)initForSelector:(id)a3 withLocalContentURL:(id)a4 withAssetAttributes:(id)a5
{
  ...
  id v11 = a5;
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___MAAutoAssetLock;
...
- (MAAutoAssetLock)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___MAAutoAssetLock;
...
{
  id v4 = a3;
  v5 = -[MAAutoAssetLock fullAssetSelector](self, "fullAssetSelector");
  [v4 encodeObject:v5 forKey:@"fullAssetSelector"];
  v6 = -[MAAutoAssetLock localContentURL](self, "localContentURL");
...
- (id)summary
{
  ...
  v8 = -[MAAutoAssetLock assetAttributes](self, "assetAttributes");
  [v8 safeSummary];
