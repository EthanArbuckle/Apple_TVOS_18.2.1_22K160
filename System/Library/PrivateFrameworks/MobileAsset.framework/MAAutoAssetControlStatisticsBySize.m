...
- (MAAutoAssetControlStatisticsBySize)init
{
  return -[MAAutoAssetControlStatisticsBySize initWithInitialValue:](self, "initWithInitialValue:", 0LL);
}

- (MAAutoAssetControlStatisticsBySize)initWithInitialValue:(int64_t)a3
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___MAAutoAssetControlStatisticsBySize;
...
- (MAAutoAssetControlStatisticsBySize)initWithCoder:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___MAAutoAssetControlStatisticsBySize;
  objc_super v5 = -[MAAutoAssetControlStatisticsBySize init](&v7, sel_init);
  if (v5)
  {
...
- (id)copy
{
  v3 = objc_alloc_init(&OBJC_CLASS___MAAutoAssetControlStatisticsBySize);
