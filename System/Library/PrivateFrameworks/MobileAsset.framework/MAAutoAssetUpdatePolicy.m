...
- (id)initUpdatePolicy:(id)a3 forAssetType:(id)a4
{
  ...
  id v8 = a4;
  v19.receiver = self;
  v19.super_class = (Class)&OBJC_CLASS___MAAutoAssetUpdatePolicy;
  ...
  if (v9)
  {
    ...
    v10->_categoryList = 0LL;

    *(_WORD *)&v10->_checkForNewerAsUserInitiated = 0;
    v10->_newerFoundAutoDownloadPostponed = 0;
    *(_OWORD *)&v10->_checkForNewerIntervalSecs = xmmword_18720F560;
    *(_OWORD *)&v10->_newerFoundAutoDownloadJitterSecs = xmmword_18720F570;
    *(void *)&v10->_revokeIgnoredForUnlockedPurge = 0LL;
    v10->_allowLockWhenFilesystemSpaceCritical = 0;
    *(_OWORD *)&v10->_newerFoundUserInitiatedDownloadTimeoutSecs = xmmword_18720F580;
    *(_OWORD *)&v10->_maximumUnlockAfterUsageSecs = xmmword_18720F580;
    additionalUpdatePolicyControl = v10->_additionalUpdatePolicyControl;
    v10->_maximumPreventGarbageCollectionSecs = 900LL;
    v10->_additionalUpdatePolicyControl = 0LL;

    *(void *)&v10->_blockIfBeforeFirstUnlock = 0LL;
    *(void *)&v10->_allowAutoCheckForNewerWhenBatteryLow = 0LL;
    id limitCellularByRestrictedTimePeriods = v10->_limitCellularByRestrictedTimePeriods;
    v10->_id limitCellularByRestrictedTimePeriods = 0LL;

    id limitWiFiByRestrictedTimePeriods = v10->_limitWiFiByRestrictedTimePeriods;
    v10->_id limitWiFiByRestrictedTimePeriods = 0LL;

    id limitCellularByFeeAgreement = v10->_limitCellularByFeeAgreement;
    v10->_id limitCellularByFeeAgreement = 0LL;

    id limitByNetworkType = v10->_limitByNetworkType;
    v10->_id limitByNetworkType = 0LL;

    assetAudienceUUID = v10->_assetAudienceUUID;
    v10->_assetAudienceUUID = 0LL;
  }
...
- (MAAutoAssetUpdatePolicy)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)&OBJC_CLASS___MAAutoAssetUpdatePolicy;
...
{
  id v4 = a3;
  v5 = -[MAAutoAssetUpdatePolicy updatePolicyName](self, "updatePolicyName");
...
- (id)summary
{
  ...
  v5 = -[MAAutoAssetUpdatePolicy assetType](self, "assetType");
  if (v5)
  {
    -[MAAutoAssetUpdatePolicy assetType](self, "assetType");
  ...
  +[MAAutoAssetUpdatePolicy activityIntervalString:]( &OBJC_CLASS___MAAutoAssetUpdatePolicy,  "activityIntervalString:",  -[MAAutoAssetUpdatePolicy checkForNewerIntervalSecs](self, "checkForNewerIntervalSecs"));
  id v7 = (void *)objc_claimAutoreleasedReturnValue();
  +[MAAutoAssetUpdatePolicy activityIntervalString:]( &OBJC_CLASS___MAAutoAssetUpdatePolicy,  "activityIntervalString:",  -[MAAutoAssetUpdatePolicy newerFoundAutoDownloadJitterSecs](self, "newerFoundAutoDownloadJitterSecs"));
  uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue();
  BOOL v9 = -[MAAutoAssetUpdatePolicy blockIfBeforeFirstUnlock](self, "blockIfBeforeFirstUnlock");
  id v10 = @"N";
  if (v9) {
    id v10 = @"Y";
  }
  [v3 stringWithFormat:@"[%@(%@)|checkForNewerInterval:%@,newerFoundAutoDownloadJitter:%@,blockIfBeforeFirstUnlock:%@]", v4, v6, v7, v8, v10];
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)activityIntervalString:(int64_t)a3
{
  ...
  {
    uint64_t v3 = (uint64_t)(a3 % 0x15180uLL) % 3600;
    uint64_t v4 = v3 / 60;
    uint64_t v5 = v3 % 60;
    if ((unint64_t)a3 >> 7 >= 0x2A3)
    {
      else {
        id v7 = &stru_189FFC530;
      }
      [NSString stringWithFormat:@"%ld day%@ %02ld:%02ld:%02ld", a3 / 0x15180uLL, v7, (uint64_t)(a3 % 0x15180uLL) / 3600, v4, v5];
    }

    else
    {
      objc_msgSend( NSString,  "stringWithFormat:",  @"%02ld:%02ld:%02ld",  (uint64_t)(a3 % 0x15180uLL) / 3600,  v4,  v5,  v9,  v10);
    }
