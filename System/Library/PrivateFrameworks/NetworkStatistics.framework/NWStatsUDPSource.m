...
- (id)description
{
  ...
  v9 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatUDPUpdate->udp_desc.uuid);
  v10 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatUDPUpdate->udp_desc.euuid);
  v11 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatUDPUpdate->udp_desc.fuuid);
  -[NWStatsSource creationTimestamp](self, "creationTimestamp");
  dateStringMillisecondsFromReferenceInterval(v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = (void *)[v4 initWithFormat:@"NWStatsUDPSource %s attributed %@ pid %d epid %d uuid %@ euuid %@ fuuid %@ started %@", pname, v6, pid, epid, v9, v10, v11, v13];
...
- (void)deriveAttribution:(id)a3
{
  id v4 = a3;
  uint64_t v14 = 0LL;
  +[NWStatsProtocolSnapshot _referenceIntervalWithContinuousTime:]( &OBJC_CLASS___NWStatsProtocolSnapshot,  "_referenceIntervalWithContinuousTime:",  self->_nstatUDPUpdate.udp_desc.start_timestamp);
  -[NWStatsSource setCreationTimestamp:](self, "setCreationTimestamp:");
  v5 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", self->_nstatUDPUpdate.udp_desc.uuid);
  v6 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", self->_nstatUDPUpdate.udp_desc.euuid);
  [v4 bestIdentifierForUUID:v5 EUUID:v6 pid:self->_nstatUDPUpdate.udp_desc.pid epid:self->_nstatUDPUpdate.udp_desc.epid procname:self->_nstatUDPUpdate.udp_desc.pname derivation:(char *)&v14 + 4];
  ...
  {
    [v4 bestIdentifierForUUID:v5 EUUID:0 pid:self->_nstatUDPUpdate.udp_desc.pid epid:0 procname:self->_nstatUDPUpdate.udp_desc.pname derivation:&v14];
  ...
  if ([v4 debugMode])
  {
    [v4 allIdentifiersForUUID:v5 EUUID:v6 pid:self->_nstatUDPUpdate.udp_desc.pid epid:self->_nstatUDPUpdate.udp_desc.epid procname:self->_nstatUDPUpdate.udp_desc.pname];
...
- (NWStatsUDPSource)initWithUpdate:(nstat_msg_src_update_convenient *)a3 length:(int64_t)a4 monitor:(id)a5
{
  id v8 = a5;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___NWStatsUDPSource;
...
- (BOOL)updateWithUpdate:(nstat_msg_src_update_convenient *)a3 length:(int64_t)a4 monitor:(id)a5
{
  ...
  else
  {
    ...
    if (type == 10007)
    {
      ...
      BOOL v16 = -[NWStatsSource processExtendedUpdate:length:bluetoothCounts:]( self,  "processExtendedUpdate:length:bluetoothCounts:",  (char *)&a3->var0.conn + 280,  a4 - 432,  &self->_nstatBluetoothCounts);
    }
...
- (id)createSnapshot:(int)a3 firstOccurrence:(BOOL)a4
{
  BOOL v4 = a4;
  uint64_t v5 = *(void *)&a3;
  int v7 = objc_alloc(&OBJC_CLASS___NWStatsUDPSnapshot);
  -[NWStatsSource creationTimestamp](self, "creationTimestamp");
  v9 = -[NWStatsUDPSnapshot initWithUpdate:startTime:flowFlags:previously:bluetoothCounts:peerEgressCellularCounts:]( v7,  "initWithUpdate:startTime:flowFlags:previously:bluetoothCounts:peerEgressCellularCounts:",  &self->_nstatUDPUpdate,  -[NWStatsSource flowFlags](self, "flowFlags"),  -[NWStatsSource prevItemsPtr](self, "prevItemsPtr"),  &self->_nstatBluetoothCounts,  0LL,  v8);
