...
- (id)description
{
  return (id)objc_msgSend( objc_alloc(NSString),  "initWithFormat:",  @"NWStatsInterfaceSource with srcref %lld interface %u threshold %lld",  self->_srcRef,  self->_ifIndex,  self->_threshold);
}
