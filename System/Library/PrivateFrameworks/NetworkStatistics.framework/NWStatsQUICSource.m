...
- (id)description
{
  ...
  v9 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatQUICUpdate->quic_desc.uuid);
  v10 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatQUICUpdate->quic_desc.euuid);
  v11 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", p_nstatQUICUpdate->quic_desc.fuuid);
  -[NWStatsSource creationTimestamp](self, "creationTimestamp");
  dateStringMillisecondsFromReferenceInterval(v12);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = (void *)[v4 initWithFormat:@"NWStatsQUICSource %s attributed %@ pid %d epid %d uuid %@ euuid %@ fuuid %@ started %@", pname, v6, pid, epid, v9, v10, v11, v13];
...
- (void)deriveAttribution:(id)a3
{
  id v4 = a3;
  uint64_t v14 = 0LL;
  +[NWStatsProtocolSnapshot _referenceIntervalWithContinuousTime:]( &OBJC_CLASS___NWStatsProtocolSnapshot,  "_referenceIntervalWithContinuousTime:",  self->_nstatQUICUpdate.quic_desc.start_timestamp);
  -[NWStatsSource setCreationTimestamp:](self, "setCreationTimestamp:");
  v5 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", self->_nstatQUICUpdate.quic_desc.uuid);
  v6 = -[NWStatsSource _createNSUUIDForBytes:](self, "_createNSUUIDForBytes:", self->_nstatQUICUpdate.quic_desc.euuid);
  [v4 bestIdentifierForUUID:v5 EUUID:v6 pid:self->_nstatQUICUpdate.quic_desc.pid epid:self->_nstatQUICUpdate.quic_desc.epid procname:self->_nstatQUICUpdate.quic_desc.pname derivation:(char *)&v14 + 4];
  ...
  {
    [v4 bestIdentifierForUUID:v5 EUUID:0 pid:self->_nstatQUICUpdate.quic_desc.pid epid:0 procname:self->_nstatQUICUpdate.quic_desc.pname derivation:&v14];
  ...
  if ([v4 debugMode])
  {
    [v4 allIdentifiersForUUID:v5 EUUID:v6 pid:self->_nstatQUICUpdate.quic_desc.pid epid:self->_nstatQUICUpdate.quic_desc.epid procname:self->_nstatQUICUpdate.quic_desc.pname];
...
- (NWStatsQUICSource)initWithUpdate:(nstat_msg_src_update_convenient *)a3 length:(int64_t)a4 monitor:(id)a5
{
  id v8 = a5;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___NWStatsQUICSource;
