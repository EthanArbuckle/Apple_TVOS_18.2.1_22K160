...
- (id)uppTeamName
{
  ...
  if (v10)
  {
    v11 = (void *)MEMORY[0x1895E445C](v8, v10);
...
- (void)launchPreboardWithCompletion:(id)a3
{
  ...
  *(void *)(v9 + 24) = self;
  ...
  v12[2] = 0LL;
  v12[3] = 0LL;
  v12[4] = &_sIeghH_IeAgH_TRTA_53Tu;
  v12[5] = v11;
  v13 = self;
  _sScTss5NeverORs_rlE8priority9operationScTyxABGScPSg_xyYaYAcntcfCyt_Tgmq5( (uint64_t)v7,  (uint64_t)&_sIeAgH_ytIeAgHr_TRTA_58Tu,  (uint64_t)v12);
  swift_release();
}
...
- (void)enableCurrentUseCaseWithPasscode:(NSString *)a3 completion:(id)a4
{
  ...
  v14[2] = 0LL;
  v14[3] = 0LL;
  v14[4] = &_sIeghH_IeAgH_TRTA_38Tu;
  v14[5] = v13;
  v15 = a3;
  v16 = self;
  _sScTss5NeverORs_rlE8priority9operationScTyxABGScPSg_xyYaYAcntcfCyt_Tgmq5( (uint64_t)v9,  (uint64_t)&_sIeAgH_ytIeAgHr_TRTA_43Tu,  (uint64_t)v14);
  swift_release();
}
