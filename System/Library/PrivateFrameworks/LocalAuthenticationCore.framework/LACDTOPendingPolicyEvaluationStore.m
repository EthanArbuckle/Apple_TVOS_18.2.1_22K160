...
+ (NSString)storeKey
{
  return (NSString *)(id)MEMORY[0x1895E445C](0xD000000000000012LL, 0x80000001892BA5C0LL);
}
...
- (void)persistEvaluations
{
  ...
  v4 = *(uint64_t (**)(void))((*MEMORY[0x18961B398] & (uint64_t)self->super.isa) + 0x88);
  uint64_t v5 = self;
  uint64_t v6 = v4();
  ...
  v8[3] = v6;
  v8[4] = ObjectType;
  uint64_t v9 = *(void (**)(void *, void *))(*(void *)v7 + 120LL);
  uint64_t v10 = v5;
