...
- (LACUNManagerQueueDecorator)initWithManager:(id)a3 replyQueue:(id)a4
{
  ...
  v10 = +[LACConcurrencyUtilities createUserInitiatedSerialQueueWithIdentifier:]( &OBJC_CLASS___LACConcurrencyUtilities,  "createUserInitiatedSerialQueueWithIdentifier:",  v9);
...
- (LACUNManagerQueueDecorator)initWithManager:(id)a3 workQueue:(id)a4 replyQueue:(id)a5
{
  ...
  id v11 = a5;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___LACUNManagerQueueDecorator;
