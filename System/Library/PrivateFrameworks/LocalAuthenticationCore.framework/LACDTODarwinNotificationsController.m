...
- (LACDTODarwinNotificationsController)initWithNotificationCenter:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___LACDTODarwinNotificationsController;
...
- (void)handleEvent:(id)a3 sender:(id)a4
{
  ...
  if (![v5 rawValue] || objc_msgSend(v5, "rawValue") == 2 || objc_msgSend(v5, "rawValue") == 3) {
    -[LACDarwinNotificationCenter postNotification:]( self->_notificationCenter,  "postNotification:",  @"com.apple.LocalAuthentication.ratchet.StateDidChange");
  }
}
