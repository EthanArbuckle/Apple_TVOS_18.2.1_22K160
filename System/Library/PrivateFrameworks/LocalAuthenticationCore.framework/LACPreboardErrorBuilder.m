...
+ (id)notSupportedError
{
  id v2 = specialized static LACPreboardErrorBuilder.error(code:message:)(2LL, 0xD000000000000015LL, 0x80000001892BBDE0LL);
...
{
  id v4 = a3;
  id v5 = specialized static LACPreboardErrorBuilder.error(code:underlyingError:)(2LL, (unint64_t)a3);
...
+ (id)genericErrorWithMessage:(id)a3
{
  ...
  id v5 = specialized static LACPreboardErrorBuilder.error(code:message:)(2LL, v3, v4);
