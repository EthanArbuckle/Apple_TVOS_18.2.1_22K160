...
- (RPPrivateAdvertiser)init
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___RPPrivateAdvertiser;
  ...
  if (v3)
  {
    do
    {
      unsigned int v5 = __ldaxr((unsigned int *)&gRPPrivateAdvertiserClientIDNext);
...
uint64_t __27__RPPrivateAdvertiser_init__block_invoke()
{
  ...
  gRPPrivateAdvertiserClientIDNext = (unsigned __int16)word_18C6D513A << 16;
  return result;
}
...
- (RPPrivateAdvertiser)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___RPPrivateAdvertiser;
  unsigned int v5 = -[RPPrivateAdvertiser init](&v12, sel_init);
  unsigned int v6 = v5;
  if (v5)
  {
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___RPPrivateAdvertiser;
...
void __38__RPPrivateAdvertiser__activateDirect__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    uint64_t v7 = MEMORY[0x1895A4770](*(void *)(v4 + 56));
    id v8 = (void *)v7;
    if (v7) {
...
LABEL_8:
  ...
  BOOL v12 = a3;
  v11[4] = self;
  [v8 xpcPrivateAdvertiserActivate:self completion:v11];
}
...
LABEL_7:
  ...
  uint64_t v4 = MEMORY[0x1895A4770](*(void *)(*(void *)(a1 + 32) + 56LL));
  int v5 = (void *)v4;
  if (v4) {
...
void __36__RPPrivateAdvertiser__activateXPC___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  LogPrintF();
LABEL_21:
  uint64_t v5 = MEMORY[0x1895A4770](*(void *)(*(void *)(a1 + 32) + 56LL));
  id v6 = (void *)v5;
  if (v5) {
...
{
  int var0 = self->_ucat->var0;
  -[RPPrivateAdvertiser _activateXPC:](self, "_activateXPC:", 1LL);
}
...
- (void)_update
{
  if (!self->_invalidateCalled)
  {
    ...
    if (changesPending)
    {
      ...
      v9[3] = &unk_18A031AC0;
      v9[4] = v2;
      [v7 xpcPrivateAdvertiserUpdate:v2 completion:v9];
    }
