...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___RPFileTransferProgress;
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___RPFileTransferProgress;
...
- (id)description
{
  return -[RPFileTransferProgress descriptionWithLevel:](self, "descriptionWithLevel:", 50LL);
}
