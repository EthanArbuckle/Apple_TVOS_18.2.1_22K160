...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___RPStatusProvider;
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___RPStatusProvider;
...
LABEL_14:
  ...
  else
  {
    ...
    id v13 = v11;
    id v16 = v13;
    [v12 xpcStatusProviderActivate:self completion:v15];
...
- (void)_interrupted
{
  ...
  if (self->_activateCalled) {
    -[RPStatusProvider _activateWithCompletion:reactivate:](self, "_activateWithCompletion:reactivate:", 0LL, 1LL);
  }
