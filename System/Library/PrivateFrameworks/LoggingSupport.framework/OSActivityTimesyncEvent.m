...
- (OSActivityTimesyncEvent)initWithEntry:(os_activity_stream_entry_s *)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___OSActivityTimesyncEvent;
...
LABEL_15:
        -[OSActivityEvent fillFromStreamEntry:eventMessage:persisted:]( v4,  "fillFromStreamEntry:eventMessage:persisted:",  a3,  v6,  1LL);
        return v4;
      }
