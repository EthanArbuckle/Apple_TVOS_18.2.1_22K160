...
uint64_t __76___OSLogTracepointBuffer_insertTimesyncPoints_forBoot_oldestContinuousTime___block_invoke( uint64_t a1,  __int128 *a2)
{
  ...
  {
    snprintf(__str, 0x1AuLL, "%016llx.timesync", *(void *)(*(void *)(a1 + 48) + 24LL));
    ...
    uint64_t v8 = *(void *)(*(void *)(a1 + 32) + 8LL) + 104 * v7;
    ...
    *(_OWORD *)(v8 + 56) = v10;
    *(_OWORD *)(v8 + 72) = v12;
    *(_OWORD *)(*(void *)(*(void *)(a1 + 32) + 8LL) + 104 * v7 + 40) = *(_OWORD *)*(void *)(a1 + 56);
  }
