...
- (TBTileFetchRequest)initWithDescriptor:(id)a3 sourcePolicy:(unint64_t)a4 cacheable:(BOOL)a5
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___TBTileFetchRequest;
...
- (void)handlePreferLocalResponse:(id)a3
{
  ...
  if (v4)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (self->userInfo)
      {
        v10 = -[TBTileFetchRequest userInfo](self, "userInfo");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[TBTileFetchRequest descriptor](self, "descriptor");
  ...
  if (v10)
  {
    v11 = -[TBTileFetchRequest userInfo](self, "userInfo");
