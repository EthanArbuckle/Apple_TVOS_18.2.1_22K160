...
- (StringComparisonByChars)initWithString1:(id)a3 string2:(id)a4 reference:(id)a5
{
  ...
  id v9 = a4;
  v19.receiver = self;
  v19.super_class = (Class)&OBJC_CLASS___StringComparisonByChars;
  id v10 = -[ObjectComparisonByTokens initWithObj1:obj2:reference:](&v19, sel_initWithObj1_obj2_reference_, v8, v9, a5);
