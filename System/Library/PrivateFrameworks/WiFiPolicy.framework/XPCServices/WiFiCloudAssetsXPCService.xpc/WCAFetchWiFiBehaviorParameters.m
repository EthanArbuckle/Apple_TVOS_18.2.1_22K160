...
+ (void)fetchWiFiBehaviorWithCompletion:(id)a3
{
  ...
  id v7 = objc_alloc_init(&OBJC_CLASS___WCAFetchKeyValuesRequest);
  ...
  v9[7] = @"BeaconParsing";
  v3 = +[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", v9, 8LL);
  objc_msgSend(v7, "setKeys:");

  id v4 = +[WCAAsset wifiBehaviorPlistAsset](&OBJC_CLASS___WCAAsset, "wifiBehaviorPlistAsset");
  objc_msgSend(v7, "setAsset:");

  id v6 = location[0];
  objc_msgSend(v7, "setCompletionHandler:");
  id v5 = +[WCAClient sharedClient](&OBJC_CLASS___WCAClient, "sharedClient");
