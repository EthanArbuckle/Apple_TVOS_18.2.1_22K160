...
+ (id)dataComparisonByBitsWithData1:(id)a3 data2:(id)a4 reference:(id)a5
{
  id v8 = a5;
  id v9 = a4;
  v10 = +[WiFiUsagePrivacyFilter toBinString:](&OBJC_CLASS___WiFiUsagePrivacyFilter, "toBinString:", a3);
  v11 = +[WiFiUsagePrivacyFilter toBinString:](&OBJC_CLASS___WiFiUsagePrivacyFilter, "toBinString:", v9);
