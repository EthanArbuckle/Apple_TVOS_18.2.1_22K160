...
+ (id)sampleWithStruct:(apple80211_rx_ampdu_lqmct_stats *)a3 WithReferenceDate:(id)a4 AsNsec:(unint64_t)a5
{
  ...
  if ((_DWORD)var0)
  {
    NSLog( @"%s - Unknown version: %u",  "+[WiFiUsageLQMKernelSampleRxAmpdu sampleWithStruct:WithReferenceDate:AsNsec:]",  var0);
    v9 = 0LL;
  }

  else
  {
    v9 = -[WiFiUsageLQMKernelSampleRxAmpdu initWithStruct:WithReferenceDate:AsNsec:]( objc_alloc(&OBJC_CLASS___WiFiUsageLQMKernelSampleRxAmpdu),  "initWithStruct:WithReferenceDate:AsNsec:",  a3,  v7,  a5);
  }
...
{
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___WiFiUsageLQMKernelSampleRxAmpdu;
  id v7 = a4;
  v8 = -[WiFiUsageLQMKernelSampleRxAmpdu init](&v18, sel_init);
  uint64_t v9 = +[WiFiUsageLQMTransformations dateWithMachContinuousTime:WithRef:asNS:]( &OBJC_CLASS___WiFiUsageLQMTransformations,  "dateWithMachContinuousTime:WithRef:asNS:",  *(void *)(&a3->var0 + 1),  v7,  a5,  v18.receiver,  v18.super_class);
  ...
  v8->_rxMpduDensity = +[WiFiUsageLQMTransformations ratioWithValue:Over:WithScale:]( &OBJC_CLASS___WiFiUsageLQMTransformations,  "ratioWithValue:Over:WithScale:",  var2,  var1_high,  +[WiFiUsageLQMTransformations mpduDensityScale]( &OBJC_CLASS___WiFiUsageLQMTransformations,  "mpduDensityScale"));
  v8->_rxBarOverRxAmpdu = +[WiFiUsageLQMTransformations ratioWithValue:Over:WithScale:]( &OBJC_CLASS___WiFiUsageLQMTransformations,  "ratioWithValue:Over:WithScale:",  a3->var10,  v8->_rxAmpdu,  +[WiFiUsageLQMTransformations mpduDensityScale]( &OBJC_CLASS___WiFiUsageLQMTransformations,  "mpduDensityScale"));
  v8->_rxQueuedOverRxAmpdu = +[WiFiUsageLQMTransformations ratioWithValue:Over:WithScale:]( &OBJC_CLASS___WiFiUsageLQMTransformations,  "ratioWithValue:Over:WithScale:",  a3->var13,  v8->_rxAmpdu,  1LL);
...
+ (id)featureFromFieldName:(id)a3
{
  ...
  id v4 = a3;
  objc_msgSend( v3,  "dictionaryWithObjectsAndKeys:",  @"rxAmpdu",  @"median",  @"rxMpduDensity",  @"median",  @"rxBarOverRxAmpdu",  @"median",  @"rxQueuedOverRxAmpdu",  @"sum",  @"rxAddBaReq",  @"sum",  @"txAddBaResp",  @"sum",  @"txDelBa",  @"sum",  @"rxDelBa",  @"sum",  @"rxAmpduAll",  @"sum",  @"rxHoles",  @"sum",  @"rxDup",  @"sum",  @"rxStuck",  @"sum",  @"rxOow",  @"sum",  @"rxOos",  0);
