...
+ (id)sampleWithStruct:(rc2Coex *)a3 andTimestamp:(id)a4
{
  ...
  if ((_DWORD)var0)
  {
    NSLog( @"%s - Unknown version: %u",  "+[WiFiUsageLQMKernelSampleRC2Coex sampleWithStruct:andTimestamp:]",  var0);
    v7 = 0LL;
  }

  else
  {
    v7 = -[WiFiUsageLQMKernelSampleRC2Coex initWithStruct:andTimestamp:]( objc_alloc(&OBJC_CLASS___WiFiUsageLQMKernelSampleRC2Coex),  "initWithStruct:andTimestamp:",  a3,  v5);
  }
...
- (WiFiUsageLQMKernelSampleRC2Coex)initWithStruct:(rc2Coex *)a3 andTimestamp:(id)a4
{
  v6 = (NSDate *)a4;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___WiFiUsageLQMKernelSampleRC2Coex;
