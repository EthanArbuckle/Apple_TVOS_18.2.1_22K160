...
+ (id)sampleWithStruct:(rxSecurityInfo *)a3 andTimestamp:(id)a4
{
  ...
  if ((_DWORD)var0)
  {
    NSLog( @"%s - Unknown version: %u",  "+[WiFiUsageLQMKernelSampleSecurityErrors sampleWithStruct:andTimestamp:]",  var0);
    v7 = 0LL;
  }

  else
  {
    v7 = -[WiFiUsageLQMKernelSampleSecurityErrors initWithStruct:andTimestamp:]( objc_alloc(&OBJC_CLASS___WiFiUsageLQMKernelSampleSecurityErrors),  "initWithStruct:andTimestamp:",  a3,  v5);
  }
...
- (WiFiUsageLQMKernelSampleSecurityErrors)initWithStruct:(rxSecurityInfo *)a3 andTimestamp:(id)a4
{
  v6 = (NSDate *)a4;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___WiFiUsageLQMKernelSampleSecurityErrors;
