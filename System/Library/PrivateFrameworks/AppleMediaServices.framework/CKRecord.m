...
- (AMSDCloudDataRecordIdentifier)identifier
{
  return (AMSDCloudDataRecordIdentifier *)-[CKRecord recordID](self, "recordID");
}
...
- (NSString)hashedDescription
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[CKRecord encryptedValues](self, "encryptedValues"));
...
{
  id v4 = a3;
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue(-[CKRecord encryptedValues](self, "encryptedValues"));
