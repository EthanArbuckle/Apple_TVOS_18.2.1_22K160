...
- (AMSDCloudDataChangedRecordsResult)initWithChangedRecords:(id)a3 deletedRecords:(id)a4 errors:(id)a5 changeTokens:(id)a6
{
  ...
  id v14 = a6;
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___AMSDCloudDataChangedRecordsResult;
  v15 = -[AMSDCloudDataChangedRecordsResult init](&v18, "init");
  v16 = v15;
  if (v15)
  {
...
- (NSString)hashedDescription
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[AMSDCloudDataChangedRecordsResult changedRecords](self, "changedRecords"));
  uint64_t v6 = AMSHashIfNeeded(v5);
  v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
  [v4 appendFormat:@"  changedRecords = %@,\n", v7];

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[AMSDCloudDataChangedRecordsResult deletedRecords](self, "deletedRecords"));
  uint64_t v9 = AMSHashIfNeeded(v8);
  v10 = (void *)objc_claimAutoreleasedReturnValue(v9);
  [v4 appendFormat:@"  deletedRecords = %@,\n", v10];

  id v11 = (void *)objc_claimAutoreleasedReturnValue(-[AMSDCloudDataChangedRecordsResult errors](self, "errors"));
  uint64_t v12 = AMSHashIfNeeded(v11);
  id v13 = (void *)objc_claimAutoreleasedReturnValue(v12);
  [v4 appendFormat:@"  errors = %@,\n", v13];

  id v14 = (void *)objc_claimAutoreleasedReturnValue(-[AMSDCloudDataChangedRecordsResult changeTokens](self, "changeTokens"));
