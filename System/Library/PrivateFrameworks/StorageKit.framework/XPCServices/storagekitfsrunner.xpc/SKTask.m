...
- (SKTask)initWithExecutable:(id)a3 arguments:(id)a4
{
  ...
  id v7 = a4;
  v30.receiver = self;
  v30.super_class = (Class)&OBJC_CLASS___SKTask;
  v8 = -[SKTask init](&v30, "init");
  if (v8)
  {
    ...
    v23 = (void *)objc_opt_new(&OBJC_CLASS___SKTaskNOOPParser, v21, v22);
    -[SKTask setStderrParser:](v8, "setStderrParser:", v23);

    v26 = (void *)objc_opt_new(&OBJC_CLASS___SKTaskNOOPParser, v24, v25);
    -[SKTask setStdoutParser:](v8, "setStdoutParser:", v26);

    uint64_t v27 = objc_claimAutoreleasedReturnValue(+[NSProgress progressWithTotalUnitCount:](&OBJC_CLASS___NSProgress, "progressWithTotalUnitCount:", 100LL));
    progress = v8->_progress;
    v8->_progress = (NSProgress *)v27;
  }
