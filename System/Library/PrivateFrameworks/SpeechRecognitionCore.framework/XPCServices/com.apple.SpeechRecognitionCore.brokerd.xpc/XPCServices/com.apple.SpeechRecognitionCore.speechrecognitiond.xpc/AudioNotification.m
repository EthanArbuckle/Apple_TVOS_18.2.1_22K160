...
+ (void)sendLiveRecordingOnNotification
{
  if (byte_1000DDCE8 == 1)
  {
    ...
    CFNotificationCenterPostNotification( DarwinNotifyCenter,  @"com.apple.SpeechRecognitionCore.liveRecordingOnFromInterrupt",  0LL,  0LL,  0);
    v3 = (os_log_s *)RXOSLog();
  ...
  else
  {
    ...
    CFNotificationCenterPostNotification(v6, @"com.apple.SpeechRecognitionCore.liveRecordingOn", 0LL, 0LL, 0);
    v3 = (os_log_s *)RXOSLog();
    if (!os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT)) {
      return;
    }
...
+ (void)sendLiveRecordingOffNotificationWithInterrupt:(unsigned __int8)a3
{
  if (a3)
  {
    byte_1000DDCE8 = 1;
    DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterPostNotification( DarwinNotifyCenter,  @"com.apple.SpeechRecognitionCore.liveRecordingOffFromInterrupt",  0LL,  0LL,  0);
    v4 = (os_log_s *)RXOSLog();
  ...
  else
  {
    ...
    CFNotificationCenterPostNotification(v7, @"com.apple.SpeechRecognitionCore.liveRecordingOff", 0LL, 0LL, 0);
    v4 = (os_log_s *)RXOSLog();
    if (!os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT)) {
      return;
    }
