...
- (int64_t)_es_requiredCapabilityIdentifier
{
  return (int64_t)_objc_msgSend( objc_msgSend( -[MAAsset attributes](self, "attributes"),  "objectForKey:",  @"RequiredCapabilityIdentifier"),  "integerValue");
}
...
- (id)_es_path
{
  ...
  if (result) {
    return _objc_msgSend(-[MAAsset getLocalUrl](self, "getLocalUrl"), "path");
  }
  return result;
}
...
- (int64_t)_es_status
{
  id v2 = (char *)-[MAAsset state](self, "state");
    ...
    return qword_1000AC3B8[(void)(v2 - 1)];
  }
}
