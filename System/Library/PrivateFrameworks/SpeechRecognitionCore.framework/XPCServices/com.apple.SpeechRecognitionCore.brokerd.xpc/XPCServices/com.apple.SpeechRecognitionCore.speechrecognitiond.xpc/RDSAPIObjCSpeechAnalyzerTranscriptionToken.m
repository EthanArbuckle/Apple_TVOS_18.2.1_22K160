...
- (RDSAPIObjCSpeechAnalyzerTranscriptionToken)initWithTokenName:(id)a3 start:(double)a4 end:(double)a5 silenceStart:(double)a6 confidence:(double)a7 hasSpaceAfter:(BOOL)a8 hasSpaceBefore:(BOOL)a9 phoneSequence:(id)a10 ipaPhoneSequence:(id)a11
{
  ...
  id v22 = a11;
  v26.receiver = self;
  v26.super_class = (Class)&OBJC_CLASS___RDSAPIObjCSpeechAnalyzerTranscriptionToken;
  v23 = -[RDSAPIObjCSpeechAnalyzerTranscriptionToken init](&v26, "init");
  v24 = v23;
  if (v23)
  {
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setTokenName:](v23, "setTokenName:", v20);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setStart:](v24, "setStart:", a4);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setEnd:](v24, "setEnd:", a5);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setSilenceStart:](v24, "setSilenceStart:", a6);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setConfidence:](v24, "setConfidence:", a7);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setHasSpaceAfter:](v24, "setHasSpaceAfter:", v14);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setHasSpaceBefore:](v24, "setHasSpaceBefore:", v13);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setPhoneSequence:](v24, "setPhoneSequence:", v21);
    -[RDSAPIObjCSpeechAnalyzerTranscriptionToken setIpaPhoneSequence:](v24, "setIpaPhoneSequence:", v22);
  }
