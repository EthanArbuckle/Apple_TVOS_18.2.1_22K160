...
+ (id)sharedInstance
{
  if (qword_1000DDDB8 != -1) {
    dispatch_once(&qword_1000DDDB8, &stru_1000CF470);
  }
  return (id)qword_1000DDDB0;
}
      ...
      if (v15)
      {
        ...
        do
        {
          for (i = 0LL; i != v15; i = (char *)i + 1)
          {
            ...
            *(void *)buf = 0LL;
            if ([v19 length] && sub_10003FCC8(v19, buf, (uint64_t)@"DictationCC")) {
...
- (id)copyInstalledAssetPropertiesForLangaugeWithError:(id)a3 error:(id *)a4
{
  ...
  if (sub_10003FCC8(v7, 0LL, (uint64_t)@"DictationCC"))
  {
...
- (void)cancelDownloadForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)buf = 0LL;
    ...
    uint64_t v13 = sub_10003D510;
    uint64_t v14 = sub_10003D520;
    uint64_t v15 = 0LL;
    mainWorkQueue = self->_mainWorkQueue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472LL;
    block[2] = sub_10003DFB0;
...
- (void)setPurgeabilityForLanguages:(id)a3 withPurgeability:(BOOL)a4 error:(id *)a5
{
  if (a3)
  {
    ...
    *(void *)buf = 0LL;
    ...
    __int16 v21 = sub_10003D510;
    id v22 = sub_10003D520;
    uint64_t v23 = 0LL;
...
- (id)copyInstalledQuasarModelPathForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)buf = 0LL;
    ...
    id v22 = sub_10003D510;
    uint64_t v23 = sub_10003D520;
    uint64_t v24 = 0LL;
    uint64_t v13 = 0LL;
    double v14 = &v13;
    uint64_t v15 = 0x3052000000LL;
    uint64_t v16 = sub_10003D510;
    BOOL v17 = sub_10003D520;
    uint64_t v18 = 0LL;
    mainWorkQueue = self->_mainWorkQueue;
...
- (id)_assetPathForLanguage:(id)a3 error:(id *)a4
{
  ...
  int v20 = sub_10003D510;
  id v21 = sub_10003D520;
  uint64_t v22 = 0LL;
  uint64_t v11 = 0LL;
  unsigned int v12 = &v11;
  uint64_t v13 = 0x3052000000LL;
  double v14 = sub_10003D510;
  uint64_t v15 = sub_10003D520;
  uint64_t v16 = 0LL;
  ...
  v10[6] = &v17;
  v10[4] = v7;
  +[SFSpeechAssetManager fetchAssetsForLanguage:urgent:progress:completion:]( &OBJC_CLASS___SFSpeechAssetManager,  "fetchAssetsForLanguage:urgent:progress:completion:",  a3,  0LL,  &stru_1000CF578,  v10);
...
- (id)_installedLocalAssetForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    if (![v7 length]
      || (sub_10003FCC8(v7, 0LL, (uint64_t)@"DictationCC") & 1) == 0)
    {
      id v7 = 0LL;
    }
