...
+ (id)sharedInstance
{
  if (qword_1000DDDC8 != -1) {
    dispatch_once(&qword_1000DDDC8, &stru_1000CF660);
  }
  return (id)qword_1000DDDC0;
}
...
- (id)copyInstallationStatusForLangaugesWithError:(id *)a3
{
  ...
  block[2] = sub_100040B88;
  block[3] = &unk_1000CF498;
  block[4] = self;
  block[5] = &v14;
  block[6] = &v8;
...
- (void)cancelDownloadForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)id v12 = 0LL;
    ...
    id v15 = sub_100040B6C;
    uint64_t v16 = sub_100040B7C;
    uint64_t v17 = 0LL;
    queue = self->_queue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472LL;
    block[2] = sub_1000417D4;
    block[3] = &unk_1000CF4E8;
    block[4] = self;
    block[5] = v6;
    block[6] = v12;
    dispatch_sync((dispatch_queue_t)queue, block);
...
- (id)copyInstalledQuasarModelPathForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)buf = 0LL;
    ...
    id v22 = sub_100040B6C;
    __int128 v23 = sub_100040B7C;
    uint64_t v24 = 0LL;
    uint64_t v13 = 0LL;
    double v14 = &v13;
    uint64_t v15 = 0x3052000000LL;
    uint64_t v16 = sub_100040B6C;
    id v17 = sub_100040B7C;
    uint64_t v18 = 0LL;
    queue = self->_queue;
    ...
    switch((unint64_t)v12)
    {
      case 1uLL:
        ...
        if (v11)
        {
          ...
          v29[4] = self;
          v29[5] = a3;
          [a3 startDownload:sub_100040800(v6) then:v29];
          uint64_t v13 = 0LL;
        }
        ...
        else
        {
          ...
          uint64_t v13 = +[NSError errorWithDomain:code:userInfo:]( &OBJC_CLASS___NSError,  "errorWithDomain:code:userInfo:",  @"kRXAssetDownloadErrorDomain",  101LL,  &off_1000D6148);
          if (-[RDAssetManager sendCallback](self, "sendCallback"))
          {
...
- (id)installedAssetSizeWithError:(id *)a3
{
  return sub_10004341C(a3, (uint64_t)&stru_1000CF7B8);
}
...
- (id)purgeInstalledAssetsWithError:(id *)a3
{
  ...
  id v9 = &v8;
  uint64_t v10 = 0x3052000000LL;
  unsigned int v11 = sub_100040B6C;
  id v12 = sub_100040B7C;
  uint64_t v13 = 0LL;
  v7[0] = _NSConcreteStackBlock;
  v7[1] = 3221225472LL;
  v7[2] = sub_100043734;
  v7[3] = &unk_1000CF7E0;
  v7[4] = &v8;
  v4 = sub_10004341C(a3, (uint64_t)v7);
  if (a3)
  {
    id v5 = (void *)v9[5];
    if (v5) {
...
- (void)_sendDownloadCallbackDictionaryWithLanguage:(id)a3 downloadPhase:(__CFString *)a4 timeRemaining:(float)a5 bytesWritten:(float)a6 bytesTotal:(float)a7 error:(id)a8
{
  ...
  if (Mutable)
  {
    ...
    {
      CFArrayAppendValue(Mutable, &stru_1000D4C58);
    }
    ...
    if (v29 >= 1)
    {
      ...
      for (CFIndex i = 0LL; i != v30; ++i)
      {
        ...
        if (CFStringCompare(ValueAtIndex, &stru_1000D4C58, 0LL))
        {
...
- (id)_stateStringForAsset:(id)a3
{
  ...
  if (v4 >= 7) {
    return +[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", @"Unknown state: %@", a3);
  }
  else {
    return off_1000CFA28[v4];
  }
}
