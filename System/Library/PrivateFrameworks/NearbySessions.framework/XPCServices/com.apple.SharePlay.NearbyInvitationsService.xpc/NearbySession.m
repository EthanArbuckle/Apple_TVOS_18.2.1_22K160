...
- (_TtC44com_apple_SharePlay_NearbyInvitationsService13NearbySession)init
{
  result = (_TtC44com_apple_SharePlay_NearbyInvitationsService13NearbySession *)_swift_stdlib_reportUnimplementedInitializer( "com_apple_SharePlay_NearbyInvitationsS ervice.NearbySession",  58LL,  "init()",  6LL,  0LL);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(void *)&self->config[OBJC_IVAR____TtC44com_apple_SharePlay_NearbyInvitationsService13NearbySession_stableIdentifier]);
