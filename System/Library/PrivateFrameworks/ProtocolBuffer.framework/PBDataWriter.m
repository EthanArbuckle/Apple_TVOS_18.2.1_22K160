...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___PBDataWriter;
  v2 = -[PBDataWriter init](&v6, sel_init);
  if (v2)
  {
    v3 = -[PBMutableData initWithCapacity:](objc_alloc(&OBJC_CLASS___PBMutableData), "initWithCapacity:", 256LL);
    data = v2->_data;
    v2->_data = v3;
  }
...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___PBDataWriter;
  v4 = -[PBDataWriter init](&v10, sel_init);
  if (v4)
  {
    v5 = objc_alloc(&OBJC_CLASS___PBMutableData);
    if (a3 <= 0x100) {
      unint64_t v6 = 256LL;
    }
    else {
    ...
    uint64_t v7 = -[PBMutableData initWithCapacity:](v5, "initWithCapacity:", v6);
    data = v4->_data;
