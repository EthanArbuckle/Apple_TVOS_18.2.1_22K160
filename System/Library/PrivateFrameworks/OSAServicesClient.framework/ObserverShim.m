...
- (ObserverShim)initWithObserver:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___ObserverShim;
...
- (void)didWriteDiagnosticLog:(id)a3 ofType:(id)a4 toPath:(id)a5
{
  ...
  id v10 = a3;
  id WeakRetained = objc_loadWeakRetained((id *)p_observer);
  [WeakRetained didWriteDiagnosticLog:v9 logId:v10 logFilePath:v8 logInfo:MEMORY[0x189604A60] error:0];
}
...
- (void)failedToWriteDiagnosticLog:(id)a3 ofType:(id)a4 error:(id)a5
{
  ...
  id v10 = a3;
  id WeakRetained = objc_loadWeakRetained((id *)p_observer);
  [WeakRetained didWriteDiagnosticLog:v9 logId:v10 logFilePath:0 logInfo:MEMORY[0x189604A60] error:v8];
}
