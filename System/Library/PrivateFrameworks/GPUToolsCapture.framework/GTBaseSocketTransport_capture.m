...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___GTBaseSocketTransport_capture;
  return -[GTBaseStreamTransport_capture init](&v3, "init");
}
...
- (void)_readAndAccumulateLoop
{
  ...
  while (-[GTBaseStreamTransport_capture _readAndAccumulate](self, "_readAndAccumulate") > 0)
    ;
...
LABEL_15:
  ...
  if (smTransport)
  {
    id v12 = -[GTSharedMemoryTransport_capture connect](smTransport, "connect");
...
- (void)setPrioritizeOutgoingMessages:(BOOL)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___GTBaseSocketTransport_capture;
  -[GTTransport_capture setPrioritizeOutgoingMessages:](&v6, "setPrioritizeOutgoingMessages:", v3);
}
...
- (void)_invalidate
{
  ...
  -[GTBaseSocketTransport_capture _destroySharedMemoryTransport](self, "_destroySharedMemoryTransport");
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___GTBaseSocketTransport_capture;
  -[GTBaseStreamTransport_capture _invalidate](&v4, "_invalidate");
}

- (id)createNewSharedMemoryTransport
{
  return -[GTBaseSocketTransport_capture createNewSharedMemoryTransportWithURL:]( self,  "createNewSharedMemoryTransportWithURL:",  0LL);
}
...
- (BOOL)relayMessageOverSharedMemoryTransport:(id)a3 error:(id *)a4
{
  return -[GTTransport_capture relayMessage:error:](self->_smTransport, "relayMessage:error:", a3, a4);
}
...
- (unsigned)_nextMessageSerial
{
  ...
  if (smTransport)
  {
    unsigned int result = -[GTSharedMemoryTransport_capture _nextMessageSerial](smTransport, "_nextMessageSerial");
  ...
  {
    v9.receiver = self;
    v9.super_class = (Class)&OBJC_CLASS___GTBaseSocketTransport_capture;
    return -[GTTransport_capture _nextMessageSerial](&v9, "_nextMessageSerial");
  }
