...
void __GTAccelerationStructureDescriptorDownloader_postProcess_block_invoke( uint64_t a1,  void *a2,  uint64_t a3)
{
  uint64_t v38 = a3;
  id v39 = a2;
  v4 = (os_log_s *)g_signpostLog;
  if (os_signpost_enabled((os_log_t)g_signpostLog))
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl( &dword_0,  v4,  OS_SIGNPOST_INTERVAL_BEGIN,  0xEEEEB0B5B2B2EEEELL,  "GTAccelerationStructureDescriptorDownloader_postProcess_event",  "",  buf,  2u);
  }
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0LL; i != v7; i = (char *)i + 1)
      {
        ...
        v43 = *(void **)(*((void *)&v52 + 1) + 8LL * (void)i);
        v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v43, "stateBuffer", v38));
        v44 = v15;
        if (v15)
        {
          v16 = (const float *)((char *)[v15 contents] + 4);
          int32x4_t v17 = (int32x4_t)vld1q_dup_f32(v16);
          int16x4_t v18 = vmovn_s32(vtstq_s32(v17, (int32x4_t)xmmword_1CA4B0));
        }
        ...
        *(_DWORD *)(v47 + 8) = -10158;
        ...
        if (v51 > 0x20uLL)
        {
          ...
          ++HIBYTE(v51);
          v23 = (uint32x4_t *)(GTTraceMemPool_allocateBytes(v24, v48, v31 | 0x2000000000LL) + 16);
          char v22 = v31;
          uint64_t v5 = v30;
          uint64_t v8 = v29;
          v9 = v28;
        ...
        *(_BYTE *)(v21 + 13) = v22;
        ...
        v23->i64[0] = v33;
        v23->i64[1] = v35;
        v23[1] = vmovl_u16((uint16x4_t)vand_s8(v42, (int8x8_t)0x1000100010001LL));
        uint64_t *v11 = v49;
        *((_BYTE *)v11 + 8) = v50;
        *(_BYTE *)(v47 + 15) |= 8u;
      }
  ...
  v36 = (dispatch_group_s *)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 48) dispatchGroup]);
  dispatch_group_leave(v36);

  v37 = (os_log_s *)g_signpostLog;
  if (os_signpost_enabled((os_log_t)g_signpostLog))
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl( &dword_0,  v37,  OS_SIGNPOST_INTERVAL_END,  0xEEEEB0B5B2B2EEEELL,  "GTAccelerationStructureDescriptorDownloader_postProcess_event",  "",  buf,  2u);
  }
}

void __GTAccelerationStructureDescriptorDownloader_markChildren_block_invoke(uint64_t a1)
{
  id v1 = (id)objc_claimAutoreleasedReturnValue([*(id *)(a1 + 32) device]);
  BuildPipelines(v1);
}
