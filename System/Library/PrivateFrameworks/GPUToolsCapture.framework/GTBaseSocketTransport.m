...
_BYTE *__63__GTBaseSocketTransport_createNewSharedMemoryTransportWithURL___block_invoke(uint64_t a1)
{
  ...
  if (!result[52])
  {
    ...
    v3 = objc_alloc(&OBJC_CLASS___GTSharedMemoryTransport_capture);
    uint64_t v4 = atomic_load((unsigned int *)(*(void *)(a1 + 32) + 40LL));
    *(void *)(*(void *)(a1 + 32) + 248LL) = -[GTSharedMemoryTransport_capture initWithMode:initialMessageSerial:]( v3,  "initWithMode:initialMessageSerial:",  2LL,  v4);
    if (*(void *)(a1 + 40)) {
