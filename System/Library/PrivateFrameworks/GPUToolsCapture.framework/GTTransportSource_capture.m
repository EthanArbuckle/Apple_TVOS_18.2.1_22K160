...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___GTTransportSource_capture;
  -[GTTransportSource_capture dealloc](&v5, "dealloc");
}
...
- (void)_register
{
  ...
  if ((v3 & 1) == 0)
  {
    if (-[GTTransport_capture _activateSource:](self->_transport, "_activateSource:", self))
    {
      do
    ...
    {
      -[GTTransportSource_capture cancel](self, "cancel");
    }
  }
