...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___AppReceiptRefreshOperationOptions;
  result = -[AppReceiptRefreshOperationOptions init](&v5, "init");
  if (result)
  {
    result->_authenticationPromptStyle = 0LL;
    result->_flags = a3;
...
- (id)copyWithZone:(_NSZone *)a3
{
  objc_super v5 = objc_msgSend(objc_msgSend((id)objc_opt_class(self), "allocWithZone:", a3), "init");
  v5[1] = self->_authenticationPromptStyle;
  id v6 = -[NSString copy](self->_bundleIdentifier, "copy");
  v7 = (void *)v5[2];
  v5[2] = v6;

  v5[3] = self->_flags;
  *((_BYTE *)v5 + 32) = self->_needsAuthentication;
  *((_BYTE *)v5 + 33) = self->_performSinfMirartionCheckBeforeFailing;
  id v8 = -[NSNumber copyWithZone:](self->_targetAccount, "copyWithZone:", a3);
  v9 = (void *)v5[5];
  v5[5] = v8;
