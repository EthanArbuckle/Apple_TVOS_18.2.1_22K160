...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SKProductSubscriptionPeriod;
  v2 = -[SKProductSubscriptionPeriod init](&v6, "init");
  if (v2)
  {
    v3 = objc_alloc_init(&OBJC_CLASS___SKProductSubscriptionPeriodInternal);
...
- (SKProductSubscriptionPeriod)initWithISO8601String:(id)a3
{
  ...
  objc_super v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSScanner scannerWithString:](&OBJC_CLASS___NSScanner, "scannerWithString:", v4));
  id v17 = 0LL;
...
LABEL_18:
  ...
  *((void *)v5->_internal + 1) = v16;
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSCharacterSet characterSetWithCharactersInString:]( &OBJC_CLASS___NSCharacterSet,  "characterSetWithCharactersInString:",  @"DWMY"));
  id v15 = 0LL;
...
- (SKProductSubscriptionPeriod)initWithXPCEncoding:(id)a3
{
  ...
  {
    objc_super v6 = -[SKProductSubscriptionPeriod init](self, "init");
    if (v6)
    {
