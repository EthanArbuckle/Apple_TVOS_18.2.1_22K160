...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___DownloadsExternalTransaction;
  v4 = -[DownloadsSession initWithSessionDescriptor:](&v6, "initWithSessionDescriptor:");
  if (v4)
  {
    v4->_changeset = objc_alloc_init(&OBJC_CLASS___DownloadsChangeset);
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___DownloadsExternalTransaction;
