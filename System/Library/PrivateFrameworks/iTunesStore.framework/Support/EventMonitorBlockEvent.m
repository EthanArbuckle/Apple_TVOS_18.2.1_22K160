...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___EventMonitorBlockEvent;
  -[EventMonitorBlockEvent dealloc](&v3, "dealloc");
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___EventMonitorBlockEvent;
