...
- (unint64_t)hash
{
  return -[NSString hash](self->_activityIdentifier, "hash");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(-[MediaSocialStatusPollRequest activityIdentifier](self, "activityIdentifier"));
    v8 = (void *)objc_claimAutoreleasedReturnValue([v4 activityIdentifier]);
