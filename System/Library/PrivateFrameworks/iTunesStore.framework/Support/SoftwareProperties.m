...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___SoftwareProperties;
  -[SoftwareProperties dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  v5 = objc_msgSend(objc_msgSend((id)objc_opt_class(self), "allocWithZone:", a3), "init");
  v5[1] = -[NSData copyWithZone:](self->_appReceiptData, "copyWithZone:", a3);
  v5[2] = -[NSData copyWithZone:](self->_artworkData, "copyWithZone:", a3);
  ...
  v5[5] = -[NSNumber copyWithZone:](self->_installType, "copyWithZone:", a3);
  *((_BYTE *)v5 + 48) = self->_isFromStore;
  v5[7] = -[NSDictionary copyWithZone:](self->_iTunesMetadata, "copyWithZone:", a3);
  v5[8] = -[NSData copyWithZone:](self->_newsstandArtworkData, "copyWithZone:", a3);
  v5[9] = -[NSString copyWithZone:](self->_packagePath, "copyWithZone:", a3);
  v5[10] = -[NSData copyWithZone:](self->_sinfData, "copyWithZone:", a3);
  v5[11] = -[NSData copyWithZone:](self->_transitMapData, "copyWithZone:", a3);
  return v5;
}
