...
- (DirectUploadRequest)initWithEntity:(id)a3 accountIdentifier:(id)a4
{
  ...
  id v7 = a4;
  v27.receiver = self;
  v27.super_class = (Class)&OBJC_CLASS___DirectUploadRequest;
  v8 = -[DirectUploadRequest init](&v27, "init");
  if (v8)
  {
    v31[0] = @"asset_url";
    ...
    if ((void)v28)
    {
      ...
      v10 = -[NSURL initWithString:](v9, "initWithString:", (void)v28);
    ...
    {
      v20 = objc_alloc(&OBJC_CLASS___MediaSocialPostEntity);
      id v21 = [*((id *)&v29 + 1) longLongValue];
      v22 = (void *)objc_claimAutoreleasedReturnValue([v6 database]);
      accountIdentifier = -[MediaSocialPostEntity initWithPersistentID:inDatabase:]( v20,  "initWithPersistentID:inDatabase:",  v21,  v22);

      uint64_t v23 = objc_claimAutoreleasedReturnValue(-[MediaSocialPostEntity valueForProperty:](accountIdentifier, "valueForProperty:", @"account_id"));
