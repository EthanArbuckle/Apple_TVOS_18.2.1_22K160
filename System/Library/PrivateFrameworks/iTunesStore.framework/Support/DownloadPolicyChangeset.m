...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___DownloadPolicyChangeset;
  v4 = -[DownloadPolicyChangeset init](&v6, "init");
  if (v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___DownloadPolicyChangeset;
  -[DownloadPolicyChangeset dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  v5 = objc_msgSend(objc_msgSend((id)objc_opt_class(self), "allocWithZone:", a3), "init");
  v5[2] = -[NSDictionary copyWithZone:](self->_downloadProperties, "copyWithZone:", a3);
  v5[4] = -[NSSet copyWithZone:](self->_policyIDs, "copyWithZone:", a3);
  return v5;
}
