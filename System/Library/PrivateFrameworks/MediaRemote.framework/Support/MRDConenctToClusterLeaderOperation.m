...
- (MRDConenctToClusterLeaderOperation)initWithClusterLeaderID:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___MRDConenctToClusterLeaderOperation;
  v6 = -[MRDConenctToClusterLeaderOperation init](&v9, "init");
  v7 = v6;
  if (v6) {
...
- (void)execute
{
  v3 = -[MRRequestDetails initWithName:requestID:reason:]( objc_alloc(&OBJC_CLASS___MRRequestDetails),  "initWithName:requestID:reason:",  @"create remoteControlConnection to clusterLeader",  0LL,  @"PreemptiveRemoteControlConnectionManager.conenctToClusterLeaderOperation");
  ...
  if (self->_clusterLeaderID) {
    -[NSMutableString appendFormat:](v8, "appendFormat:", @" for %@", self->_clusterLeaderID);
  }
  ...
  v17[3] = &unk_10039F308;
  v17[4] = self;
  [v12 searchEndpointsForOutputDeviceUID:clusterLeaderID timeout:v14 details:v16 queue:v17 completion:30.0];
}
...
- (void)finishWithError:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      sub_1002BAC54((id *)self);
    }
  }

  else
  {
    v8 = (void *)objc_claimAutoreleasedReturnValue(-[MRDConenctToClusterLeaderOperation endpoint](self, "endpoint"));
    ...
    if (v9)
    {
      ...
      v15 = (void *)objc_claimAutoreleasedReturnValue(-[MRDConenctToClusterLeaderOperation endpoint](self, "endpoint"));
