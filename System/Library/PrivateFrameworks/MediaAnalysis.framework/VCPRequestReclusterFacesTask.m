...
- (VCPRequestReclusterFacesTask)initWithPhotoLibraryURL:(id)a3 andProgressHandler:(id)a4 andReply:(id)a5
{
  ...
  id v9 = a5;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___VCPRequestReclusterFacesTask;
  v10 = -[VCPRequestReclusterFacesTask init](&v15, "init");
  v11 = v10;
  if (v10)
  {
...
- (void)dealloc
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___VCPRequestReclusterFacesTask;
  -[VCPRequestReclusterFacesTask dealloc](&v11, "dealloc");
}
...
- (int)run
{
  ...
  if (v4)
  {
    ...
    v12[3] = &unk_1001B9E98;
    v12[4] = self;
    [v6 reclusterFacesWithContext:&__NSDictionary0__struct reply:reply extendTimeout:&stru_1001BDB30 cancel:v12];
    int v8 = 0;
  }
