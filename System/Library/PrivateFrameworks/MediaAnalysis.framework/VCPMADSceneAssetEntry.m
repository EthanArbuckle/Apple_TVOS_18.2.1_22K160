...
- (VCPMADSceneAssetEntry)initWithAsset:(id)a3 previousStatus:(unint64_t)a4 previousAttempts:(unint64_t)a5 andLastAttemptDate:(id)a6
{
  ...
  id v12 = a6;
  v24.receiver = self;
  v24.super_class = (Class)&OBJC_CLASS___VCPMADSceneAssetEntry;
  v13 = -[VCPMADSceneAssetEntry init](&v24, "init");
  v14 = v13;
  if (v13)
  {
    ...
    v17 = objc_alloc_init(&OBJC_CLASS___VCPMADSceneAssetEntryResults);
    results = v14->_results;
    v14->_results = v17;

    v19 = (void *)objc_claimAutoreleasedReturnValue(-[PHAsset sceneAnalysisProperties](v14->_asset, "sceneAnalysisProperties"));
    ...
    v21 = (void *)objc_claimAutoreleasedReturnValue(-[PHAsset mediaAnalysisProperties](v14->_asset, "mediaAnalysisProperties"));
