...
- (VCPResetPetClassificationModelTask)initWithPhotoLibraryURL:(id)a3 andProgressHandler:(id)a4 andReply:(id)a5
{
  ...
  id v9 = a5;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___VCPResetPetClassificationModelTask;
  v10 = -[VCPResetPetClassificationModelTask init](&v15, "init");
  v11 = v10;
  if (v10)
  {
...
- (void)dealloc
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___VCPResetPetClassificationModelTask;
  -[VCPResetPetClassificationModelTask dealloc](&v11, "dealloc");
}
