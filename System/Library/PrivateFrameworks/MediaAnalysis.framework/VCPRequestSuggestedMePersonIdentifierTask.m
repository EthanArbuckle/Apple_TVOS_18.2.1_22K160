...
- (VCPRequestSuggestedMePersonIdentifierTask)initWithContext:(id)a3 andPhotoLibraryURL:(id)a4 andProgressHandler:(id)a5 andReply:(id)a6
{
  ...
  id v12 = a6;
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___VCPRequestSuggestedMePersonIdentifierTask;
  v13 = -[VCPRequestSuggestedMePersonIdentifierTask init](&v18, "init");
  v14 = v13;
  if (v13)
  {
...
+ (id)taskWithContext:(id)a3 andPhotoLibraryURL:(id)a4 andProgressHandler:(id)a5 andReply:(id)a6
{
  ...
  id v12 = a5;
  id v13 = a6;
  id v14 = [objc_alloc((Class)objc_opt_class(a1)) initWithContext:v10 andPhotoLibraryURL:v11 andProgressHandler:v12 andReply:v13];
...
- (void)dealloc
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___VCPRequestSuggestedMePersonIdentifierTask;
  -[VCPRequestSuggestedMePersonIdentifierTask dealloc](&v11, "dealloc");
}
