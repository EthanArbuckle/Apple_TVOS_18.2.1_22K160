...
- (VCPMADTaskEntry)initWithTaskID:(unint64_t)a3 qos:(unsigned int)a4 background:(BOOL)a5 task:(id)a6 completionHandler:(id)a7
{
  ...
  id v14 = a7;
  v22.receiver = self;
  v22.super_class = (Class)&OBJC_CLASS___VCPMADTaskEntry;
  v15 = -[VCPMADTaskEntry init](&v22, "init");
  v16 = v15;
  if (v15)
  {
    v15->_taskID = a3;
...
+ (id)entryWithTaskID:(unint64_t)a3 qos:(unsigned int)a4 background:(BOOL)a5 task:(id)a6 completionHandler:(id)a7
{
  ...
  id v12 = a6;
  id v13 = a7;
  id v14 = [objc_alloc((Class)objc_opt_class(a1)) initWithTaskID:a3 qos:v9 background:v8 task:v12 completionHandler:v13];
