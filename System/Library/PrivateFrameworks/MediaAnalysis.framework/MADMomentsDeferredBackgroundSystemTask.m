...
+ (id)sharedTask
{
  ...
  block[2] = sub_10010F39C;
  block[3] = &unk_1001B9958;
  block[4] = a1;
  if (qword_1001E66C8 != -1) {
    dispatch_once(&qword_1001E66C8, block);
  }
  return (id)qword_1001E66C0;
}
...
+ (int64_t)taskGracePeriod
{
  if (qword_1001E66D0 != -1) {
    dispatch_once(&qword_1001E66D0, &stru_1001BDB70);
  }
  ...
  if ((int)v3 >= 7)
  {
    ...
    if (os_log_type_enabled(v6, v7))
    {
      ...
      __int16 v13 = 2048;
      uint64_t v14 = 3600LL;
      _os_log_impl((void *)&_mh_execute_header, v6, v7, "[%@] grace period %lld seconds", (uint8_t *)&v11, 0x16u);
    }
  }
...
+ (int64_t)taskPriority
{
  if (qword_1001E66E0 != -1) {
    dispatch_once(&qword_1001E66E0, &stru_1001BDB90);
  }
  uint64_t v3 = MediaAnalysisLogLevel(a1, a2);
  if ((int)v3 >= 7)
  {
    ...
    if (os_log_type_enabled(v6, v7))
    {
      ...
      v12 = v9;
      __int16 v13 = 1024;
      int v14 = byte_1001E66D8;
      _os_log_impl((void *)&_mh_execute_header, v6, v7, "[%@] priority: %d", (uint8_t *)&v11, 0x12u);
    }
  }

  return byte_1001E66D8;
}
...
- (void)submitTask:(id *)a3
{
  ...
  int v14 = (void *)objc_claimAutoreleasedReturnValue(+[BGSystemTaskScheduler sharedScheduler](&OBJC_CLASS___BGSystemTaskScheduler, "sharedScheduler"));
  ...
  else
  {
    ...
    objc_msgSend(v24, "setPriority:", objc_msgSend((id)objc_opt_class(self), "taskPriority"));
    [v24 setScheduleAfter:10.0];
    objc_msgSend( v24,  "setTrySchedulingBefore:",  (double)((uint64_t)objc_msgSend((id)objc_opt_class(self), "taskGracePeriod") + 10));
...
- (void)executeWithCancelBlock:(id)a3 progressHandler:(id)a4 completionHandler:(id)a5
{
  ...
  uint64_t v17 = (void *)objc_claimAutoreleasedReturnValue( +[MADMomentsDeferredProcessingTask taskWithCancelBlock:progressHandler:andCompletionHandler:]( &OBJC_CLASS___MADMomentsDeferredProcessingTask,  "taskWithCancelBlock:progressHandler:andCompletionHandler:",  v10,  v9,  v8));
