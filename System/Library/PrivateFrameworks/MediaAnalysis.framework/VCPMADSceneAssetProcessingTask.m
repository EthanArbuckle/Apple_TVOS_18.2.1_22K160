...
- (VCPMADSceneAssetProcessingTask)initWithLocalIdentifiers:(id)a3 fromPhotoLibraryWithURL:(id)a4 cancelBlock:(id)a5 progressHandler:(id)a6 completionHandler:(id)a7
{
  ...
  id v16 = a7;
  v75.receiver = self;
  v75.super_class = (Class)&OBJC_CLASS___VCPMADSceneAssetProcessingTask;
  v17 = -[VCPMADPhotoAssetProcessingTask initWithLocalIdentifiers:fromPhotoLibraryWithURL:cancelBlock:progressHandler:completionHandler:]( &v75,  "initWithLocalIdentifiers:fromPhotoLibraryWithURL:cancelBlock:progressHandler:completionHandler:",  v12,  v13,  v14,  v15,  v16);
  v18 = v17;
  if (!v17) {
    goto LABEL_8;
  }
  ...
  *(void *)(v17 + 52) = v20;
  ...
  if (!*(void *)(v17 + 52))
  {
    uint64_t v47 = MediaAnalysisLogLevel(v22, v23);
    if ((int)v47 < 3)
    {
LABEL_25:
      v46 = 0LL;
    ...
    {
      uint64_t v52 = objc_opt_class(v18);
      *(_DWORD *)buf = 138412290;
      uint64_t v77 = v52;
      _os_log_impl( (void *)&_mh_execute_header,  v50,  v51,  "[%@] Failed to create VCPPoolBasedPixelBufferCreator for monochrome",  buf,  0xCu);
    }
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___VCPMADSceneAssetProcessingTask;
  -[VCPMADSceneAssetProcessingTask dealloc](&v4, "dealloc");
}
...
- (BOOL)run:(id *)a3
{
  ...
  {
    v12.receiver = self;
    v12.super_class = (Class)&OBJC_CLASS___VCPMADSceneAssetProcessingTask;
    return -[VCPMADPhotoAssetProcessingTask run:](&v12, "run:", a3);
  }
  ...
  else
  {
    ...
    *a3 = v9;
    ...
    v11 = (void (**)(void, void, void))objc_claimAutoreleasedReturnValue( -[VCPMADSceneAssetProcessingTask completionHandler]( self,  "completionHandler"));
