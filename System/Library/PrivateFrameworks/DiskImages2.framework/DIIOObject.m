...
- (DIIOObject)initWithRegistryEntryID:(unint64_t)a3 error:(id *)a4
{
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"Cannot find registry entry ID 0x%llx", a3);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    +[DIError nilWithEnumValue:verboseInfo:error:]( &OBJC_CLASS___DIError,  "nilWithEnumValue:verboseInfo:error:",  153LL,  v11,  a4);
    objc_super v10 = (DIIOObject *)objc_claimAutoreleasedReturnValue();
  }
...
- (DIIOObject)initWithClassName:(id)a3 error:(id *)a4
{
  ...
  mach_port_t v7 = *MEMORY[0x1896086A8];
  id v8 = v6;
  v9 = IOServiceMatching((const char *)[v8 UTF8String]);
  ...
  {
    [NSString stringWithFormat:@"Cannot find IO object of class %@", v8];
...
{
  unsigned int v10 = 0;
  uint64_t v5 = MEMORY[0x1895BBE88](-[DIIOObject ioObj](self, "ioObj"), "IOService", *(void *)&a3, &v10);
  if ((_DWORD)v5)
  {
    objc_msgSend(NSString, "stringWithFormat:", @"Failed creating IO iterator, err code %d", v5);
    id v6 = (void *)objc_claimAutoreleasedReturnValue();
    +[DIError nilWithEnumValue:verboseInfo:error:]( &OBJC_CLASS___DIError,  "nilWithEnumValue:verboseInfo:error:",  153LL,  v6,  a4);
    mach_port_t v7 = (void *)objc_claimAutoreleasedReturnValue();
  }

  else
  {
    id v8 = objc_alloc(&OBJC_CLASS___DIIOIterator);
    return -[DIIOIterator initWithIOIterator:retain:](v8, "initWithIOIterator:retain:", v10, 0LL);
  }
...
- (unint64_t)registryEntryIDWithError:(id *)a3
{
  ...
  objc_msgSend( NSString,  "stringWithFormat:",  @"Failed to get registry entry ID, ret %d",  RegistryEntryID);
...
- (DIIOObject)ioObjectWithClassName:(id)a3 iterateParent:(BOOL)a4 error:(id *)a5
{
  ...
  if (v11)
  {
    ...
    [NSString stringWithFormat:@"Cannot find %@ entry", v8];
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    +[DIError nilWithEnumValue:verboseInfo:error:]( &OBJC_CLASS___DIError,  "nilWithEnumValue:verboseInfo:error:",  153LL,  v14,  a5);
...
- (id)copyPropertyWithClass:(Class)a3 key:(id)a4
{
  ...
  io_registry_entry_t v6 = -[DIIOObject ioObj](self, "ioObj");
...
- (id)copyParentWithError:(id *)a3
{
  ...
  {
    objc_msgSend( NSString,  "stringWithFormat:",  @"Failed to get parent registry entry, err code %d",  ParentEntry);
    uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue();
    +[DIError nilWithEnumValue:verboseInfo:error:]( &OBJC_CLASS___DIError,  "nilWithEnumValue:verboseInfo:error:",  153LL,  v5,  a3);
    io_registry_entry_t v6 = (void *)objc_claimAutoreleasedReturnValue();
  }

  else
  {
    mach_port_t v7 = objc_alloc(&OBJC_CLASS___DIIOObject);
...
+ (id)copyDiskImagesControllerWithError:(id *)a3
{
  ...
  {
    +[DIError nilWithEnumValue:verboseInfo:error:]( &OBJC_CLASS___DIError,  "nilWithEnumValue:verboseInfo:error:",  153LL,  @"Failed to find DiskImages2 controller, driver might not be installed",  a3);
    io_registry_entry_t v6 = (DIIOObject *)objc_claimAutoreleasedReturnValue();
  }
