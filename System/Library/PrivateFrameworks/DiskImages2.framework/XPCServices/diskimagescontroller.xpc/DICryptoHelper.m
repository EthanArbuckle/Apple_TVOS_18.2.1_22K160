...
LABEL_16:
  ...
  uint64_t v18 = sub_100042FD0(*ptr, (uint64_t)v27, *(void *)((char *)__p + 12), *(void *)((char *)__p + 4));
  if ((v18 & 0x80000000) != 0)
  {
...
+ (unique_ptr<crypto::auth_table_entry,)getAuthEntryWithBackend:(shared_ptr<Backend>)a3 authTableNumEntries:(int)a4 mechanism:(int)a5 error:(id *)a6
{
  ...
  bzero(v13, v12);
  uint64_t v14 = sub_100042FD0(*ptr, (uint64_t)v13, v12, 76LL);
  if ((v14 & 0x80000000) != 0)
  {
...
+ (BOOL)createPublicKeyHeaderWithBackendXPC:(id)a3 publicKeyHeader:(void *)a4 error:(id *)a5
{
  ...
  sub_100043B68((uint64_t)&v36, (uint64_t)v33);
  v17 = v34;
  if (v34 == v33)
  {
    uint64_t v18 = 4LL;
...
LABEL_20:
  uint64_t v20 = sub_100042FD0(v31, v35, 564LL, *(void *)((char *)__p + 4));
  if ((_DWORD)v20 == 564)
  {
    sub_1001155F4(v33, v35, v20);
    sub_10004378C((uint64_t)a4, (uint64_t)v33);
    BOOL v19 = 1;
  }
