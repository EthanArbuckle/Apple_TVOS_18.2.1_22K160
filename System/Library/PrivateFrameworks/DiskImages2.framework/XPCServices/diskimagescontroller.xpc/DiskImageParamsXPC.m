...
LABEL_3:
  ...
  if (!v15)
  {
    ...
    *__error() = v26;
    ...
    if (*(void *)buf && sub_100102F60(*(void *)(*(void *)buf + 40LL)))
    {
  ...
  sub_100096124(buf, (uint64_t)v16);
  v59 = *(DiskImageParamsPlugin_XPC **)buf;
  v17 = operator new[](0x20uLL);
  sub_100096200(&lpsrc, (uint64_t)v17);
...
+ (BOOL)getAEAKeyWithHelper:(void *)a3 keyBuffer:(char *)a4 bufferSize:(unint64_t)a5 error:(id *)a6
{
  ...
  uint64_t v13 = v8;
  return ((uint64_t (*)(void **, char *))off_100184818[v6])(&v13, (char *)a3 + 8);
}
...
+ (id)createAEABackendWithBackendXPC:(id)a3 error:(id *)a4
{
  ...
  __int128 v29 = v8;
  sub_1000E9F98(v28, &v29);
  unsigned int v9 = operator new[](0x20uLL);
  sub_100096200(&v26, (uint64_t)v9);
...
LABEL_7:
  ...
  sub_1000EE6D8(&lpsrc, &v25);
  if (sub_1000EE708((AAByteStream *)&lpsrc, &v25, 4uLL, 0LL) < 0)
  {
  ...
  int v13 = (int)v25;
  sub_1000EE6DC((AAByteStream *)&lpsrc);
  if (v13 == 826361153)
  {
    v14 = v6;
...
- (shared_ptr<DiskImage>)createShadowDiskImageWithBackend:(shared_ptr<Backend>)a3 numBlocks:(unint64_t)a4 sinkDiskImage:(const void *)a5 cache_only:(BOOL)a6 stack_size:(unint64_t)a7
{
  ...
  {
    exception = __cxa_allocate_exception(0x40uLL);
    sub_100005148((uint64_t)v36);
    sub_10000552C(v36, (uint64_t)"Shadow file cannot be used with a ", 34LL);
    uint64_t v23 = (*(uint64_t (**)(unint64_t))(*(void *)a4 + 24LL))(a4);
    std::ostream::operator<<(v36, v23);
    sub_10000552C(v36, (uint64_t)"-bytes block size", 17LL);
    sub_100006AA8((uint64_t)exception, (uint64_t)v36, 0x13u);
  }

  char v32 = 0;
  *(_DWORD *)&v33[7] = 0;
  *(void *)v33 = 256LL;
  int v14 = *((_DWORD *)sub_1000465AC() + 8);
  *(_DWORD *)&v33[3] = (v14 - (v8 > 3)) & ~((v14 - (v8 > 3)) >> 31);
  v33[7] = 1;
  if ((*(uint64_t (**)(uint64_t))(*(void *)*ptr + 40LL))(*ptr))
  {
    sub_1000D01A8(v36, *ptr);
    unint64_t v15 = (DiskImage *)sub_1000962DC(ptr, (uint64_t)v36, (uint64_t)&v32, &v34);
    if (((((*(_BYTE *)(v34 + 44) & 1) == 0) ^ v9) & 1) == 0)
    {
      uint64_t v24 = __cxa_allocate_exception(0x40uLL);
      void *v24 = &off_100196FC8;
  ...
  else
  {
    ...
    *(void *)&v36[0] = sub_100120D7C();
    *((void *)&v36[0] + 1) = v19;
    uint64_t v34 = sub_100062288((uint64_t (***)(void))a4);
    uint64_t v35 = v20;
    ...
    sub_10009640C( (unsigned __int16 *)&v28,  &dword_100146CAC,  (unint64_t *)&v30,  &v31,  ptr,  (uint64_t *)&v32,  v21,  &v29,  v36);
    unint64_t v15 = (DiskImage *)sub_1000D4038((uint64_t *)v29, (uint64_t)&v34);
    *(_OWORD *)int v13 = v29;
  }
...
LABEL_6:
  ...
  if (v111)
  {
    ...
    v11->__vftable = (std::__shared_weak_count_vtbl *)&off_10017ABD8;
    ...
    do
    {
      for (i = 0LL; i != v15; i = (char *)i + 1)
      {
        ...
        else
        {
          ...
          sub_10001C610(&v104, (uint64_t *)buf);
        }
        ...
        *(void *)&uint8_t buf[8] = 0LL;
        int v116 = v29;
        sub_100092124((uint64_t *)&v108, (uint64_t)v108, (__n128 *)v115);
  ...
  if (v90)
  {
    ...
    *(_OWORD *)buf = v95;
    __int128 v95 = 0uLL;
    *(_DWORD *)&buf[16] = 2;
    sub_100092290((uint64_t *)&v108, (uint64_t)buf);
  ...
  *(void *)&v115[8] = v107;
  ...
  int v116 = v71;
  sub_100092290((uint64_t *)&v108, (uint64_t)v115);
  ...
  sub_100095CC4((uint64_t)"config_t", v78, (int *)v114, 2LL);
  sub_100062D40((uint64_t)v77, &v108, &v96);
  *v89 = v77;
  v79 = v105;
  if (v105)
  {
...
- (NSUUID)instanceID
{
  ...
  if (v7)
  {
    ...
    if (v9 && [v9 count])
    {
      ...
      v25[0] = sub_100120C80((char *)&v25[-1] - v10, v10);
      v25[1] = v20;
...
- (BOOL)mountedOnAPFS
{
  ...
  sub_10011EBCC((uint64_t)&v17, &lpsrc);
  if (lpsrc
  {
    __int128 v21 = v4;
    __int128 v22 = v20;
