...
- (BOOL)shouldPerformInplaceSquash
{
  ...
  id v5 = v4;
  sub_100006174(&__p, (char *)[v5 fileSystemRepresentation]);
  uint64_t v6 = sub_100101F94((uint64_t)&__p, 0LL);
  sub_100052AA8((uint64_t)v35, v6, 0LL, 0);
  if (v34 < 0) {
    operator delete(__p);
  }
  ...
  sub_10011EBCC((uint64_t)&v28, &lpsrc);
  if (lpsrc
  {
    __p = v11;
    v33 = v31;
  ...
  *p_lpsrc = 0LL;
  ...
  if (__p && sub_1001057F4((uint64_t)__p, (uint64_t)v35))
  {
...
- (id)copyUpdatedOutputURLWithError:(id *)a3
{
  ...
  sub_100006174(__p, (char *)[v7 fileSystemRepresentation]);
  uint64_t v8 = sub_100101F94((uint64_t)__p, 0LL);
  sub_100052AA8((uint64_t)&v33, v8, 0LL, 0);
  if (v32 < 0) {
  ...
  *(_OWORD *)__p = *(_OWORD *)(v37 + 32);
  ...
  uint64_t v33 = off_1001920D8;
  uint64_t v35 = off_1001921B8;
  v36 = off_1001921F0;
  sub_100052E00((uint64_t)&v39);
  v24 = v38;
  if (v38)
  {
