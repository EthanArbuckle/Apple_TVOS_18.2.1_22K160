...
- (PluginBackendXPC)initWithURL:(id)a3 openMode:(int)a4
{
  ...
  if (v8)
  {
    ...
    v26 = v11;
    sub_1000BDD40(&v29, (uint64_t *)&v26, &v31, &v27);

    sub_1000BDEFC(&v27, &v24);
    __int128 v25 = v24;
    __int128 v24 = 0uLL;
...
- (PluginBackendXPC)initWithCoder:(id)a3
{
  ...
  if (v6)
  {
    ...
    __int128 v38 = *(_OWORD *)off_100189388;
    v39 = j__free_0;
    id v20 = objc_claimAutoreleasedReturnValue(-[DIURL pluginName](v6->_URL, "pluginName"));
    uint64_t v34 = 0LL;
    v35 = (char *)[v20 UTF8String];
    v33 = v19;
    sub_1000BE11C(&v35, (uint64_t)&v34, (uint64_t)&unk_100148397, (uint64_t)&v38, &v33, &v36);

    sub_1000BDEFC(&v36, &v31);
    __int128 v32 = v31;
    __int128 v31 = 0uLL;
