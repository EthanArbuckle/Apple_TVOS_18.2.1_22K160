...
- (AAS3DownloadRequest)initWithSession:(id)a3 size:(unint64_t)a4 atOffset:(int64_t)a5 destinationBuffer:(char *)a6 destinationStream:(AAAsyncByteStream_impl *)a7 completionSemaphore:(id)a8
{
  ...
  if (v16)
  {
    ...
    v18 = objc_alloc(&OBJC_CLASS___NSMutableURLRequest);
    id v19 = [v14 url];
    v20 = -[NSMutableURLRequest initWithURL:](v18, "initWithURL:", v19);
    ...
    v23 = v17->_urlRequest;
    v24 = +[NSString stringWithUTF8String:](&OBJC_CLASS___NSString, "stringWithUTF8String:", __str);
...
- (int)createAndResumeTask
{
  if (-[AAS3DownloadRequest remainingAttempts](self, "remainingAttempts"))
  {
    ...
    {
      sub_100037A20( (uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m",  (uint64_t)"-[AAS3DownloadRequest createAndResumeTask]",  164,  121,  0,  "dataTaskWithRequest",  v9,  v10,  (char)v13);
      int v11 = -1;
    }
  ...
  {
    sub_100037A20( (uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m",  (uint64_t)"-[AAS3DownloadRequest createAndResumeTask]",  150,  121,  0,  "no more attempts allowed",  v3,  v4,  (char)v13);
    return -1;
  }
