...
- (unique_ptr<DiskImage,)createSinkDiskImage
{
  ...
  if ((*(unsigned int (**)(uint64_t))(*(void *)v50[0] + 48LL))(v50[0]))
  {
    ...
    if (v8)
    {
      ...
      sub_1000966E8((uint64_t)v50, &__p, v47);
  ...
  *(void *)(v17 + 492) = *(void *)((char *)value + 492);
  __p = v17;
  sub_1000F97D4(v47, (uint64_t *)&__p, v50);
  v38 = __p;
  __p = 0LL;
  if (v38) {
    operator delete(v38);
  ...
  sub_100057768(v39, (uint64_t *)v47, v50);
  void *v4 = v39;
  v40 = v48;
  if (v48)
  {
...
- (DiskImageParamsUDIF_XPC)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!v6 || v32 != 500)
    {
      ...
      sub_100005148((uint64_t)v31);
      sub_10000552C(v31, (uint64_t)"Unexpected UDIF header length (", 31LL);
      std::ostream::operator<<(v31, v32);
      sub_10000552C(v31, (uint64_t)")", 1LL);
      sub_100006AA8((uint64_t)exception, (uint64_t)v31, 0x9Au);
    }
...
- (id)instanceID
{
  ...
  [v4 getUUIDBytes:v11];
  sub_1000F35CC((uint64_t)self->_header.__ptr_.__value_, (uint64_t)&v12);
  objc_super v5 = objc_alloc(&OBJC_CLASS___NSUUID);
  v10[0] = sub_100120C80(v11, 528LL);
  v10[1] = v6;
