...
+ (id)convertPrivateKeyToPEMWithX963PrivateKey:(id)a3 error:(id *)a4
{
  return sub_100124578( (uint64_t)a1,  (uint64_t)a2,  a3,  (uint64_t)a4,  (uint64_t (*)(uint64_t, unint64_t))sub_100124AF8);
}

+ (id)convertPrivateKeyTox963WithPemPrivateKey:(id)a3 error:(id *)a4
{
  return sub_100124578( (uint64_t)a1,  (uint64_t)a2,  a3,  (uint64_t)a4,  (uint64_t (*)(uint64_t, unint64_t))sub_100124D7C);
}
...
+ (id)unwrapEncryptionKeyWithWrappedKey:(id)a3 encapsulatedKey:(id)a4 privateKey:(id)a5 error:(id *)a6
{
  ...
  v21 = sub_100124FDC(v12, v14, v15, v17, v18, v20);
  unint64_t v23 = v22;
  sub_100125F04(v18, v20);
  sub_100125F04(v15, v17);
  sub_100125F04(v12, v14);
  Class isa = Data._bridgeToObjectiveC()().super.isa;
  sub_100125F04((uint64_t)v21, v23);
  return isa;
}
...
+ (id)wrappedDataDictionaryWithCertWithPlainText:(id)a3 certificate:(__SecCertificate *)a4 error:(id *)a5
{
  ...
  Class v12 = sub_1001254D0(v9, v11, v8);
  sub_100125F04(v9, v11);
