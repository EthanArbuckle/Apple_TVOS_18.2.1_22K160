...
{
  id v8 = a3;
  [v8 encodeBool:sub_1000BE308() forKey:@"debugLogsEnabled"];
  [v8 encodeBool:sub_1000BE2F0() forKey:@"forwardLogs"];
...
- (BOOL)requiresRootDaemon
{
  ...
  char v10 = sub_100052D24((uint64_t)(v11 + 3));
  id v7 = v22;
  if (v22)
  {
