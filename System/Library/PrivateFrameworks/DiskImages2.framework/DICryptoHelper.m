...
+ (id)getAuthValueWithBackend:(shared_ptr<Backend>)a3 authTableNumEntries:(int)a4 mechanism:(int)a5 error:(id *)a6
{
  ...
  v14 = (char *)valloc(*(void *)((char *)__p + 12));
  if (!v14)
  {
...
LABEL_16:
  ...
  uint64_t v18 = Backend::read(*ptr, v27, *(void *)((char *)__p + 12), *(void *)((char *)__p + 4));
  if ((v18 & 0x80000000) != 0)
  {
  ...
  {
    [MEMORY[0x189603F48] dataWithBytes:v27 length:*(void *)((char *)__p + 12)];
...
+ (unique_ptr<crypto::auth_table_entry,)getAuthEntryWithBackend:(shared_ptr<Backend>)a3 authTableNumEntries:(int)a4 mechanism:(int)a5 error:(id *)a6
{
  ...
  bzero(v13, v12);
  uint64_t v14 = Backend::read(*ptr, (char *)v13, v12, 76LL);
  if ((v14 & 0x80000000) != 0)
  {
  ...
  {
LABEL_8:
    std::__shared_weak_count *v11 = 0LL;
    goto LABEL_9;
  }
  ...
  while (1)
  {
    v17 = (crypto::auth_table_entry *)operator new(0x14uLL);
    crypto::auth_table_entry::auth_table_entry(v17, v16);
    std::__shared_weak_count *v11 = v17;
    if (*(_DWORD *)v17 == a4) {
      break;
    }
    std::__shared_weak_count *v11 = 0LL;
...
+ (BOOL)getPassphraseUsingSaksWithBackendXPC:(id)a3 passPhrase:(char *)a4 error:(id *)a5
{
  ...
  id v25 = 0LL;
  +[DICryptoHelper getAuthValueWithBackend:authTableNumEntries:mechanism:error:]( &OBJC_CLASS___DICryptoHelper,  "getAuthValueWithBackend:authTableNumEntries:mechanism:error:",  &v26,  v11,  9LL,  &v25);
...
LABEL_11:
    ...
    {
LABEL_12:
      unique_ptr<crypto::auth_table_entry, std::default_delete<crypto::auth_table_entry>> v19 = (void *)[objc_alloc(NSString) initWithData:v14 encoding:4];
...
+ (BOOL)createPublicKeyHeaderWithBackendXPC:(id)a3 publicKeyHeader:(void *)a4 error:(id *)a5
{
  ...
  uint64_t v16 = (char *)valloc(*(void *)((char *)__p + 12));
  if (!v16)
  {
    exception = (std::bad_alloc *)__cxa_allocate_exception(8uLL);
    v27 = std::bad_alloc::bad_alloc(exception);
    __cxa_throw(v27, MEMORY[0x189614708], MEMORY[0x189614690]);
  }
...
LABEL_20:
  uint64_t v20 = Backend::read(v31, v35, 564LL, *(void *)((char *)__p + 4));
  if ((_DWORD)v20 == 564)
  {
...
+ (BOOL)getPrivateKeyWithHeader:(void *)a3 privateKey:(__SecKey *)a4 error:(id *)a5
{
  ...
  [MEMORY[0x189603F48] dataWithBytes:(char *)a3 + 4 length:*(unsigned int *)a3];
  id v7 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v8 = (void *)MEMORY[0x189603FC8];
  uint64_t v9 = *MEMORY[0x18960B968];
  v16[0] = *MEMORY[0x18960BB38];
  v16[1] = v9;
  uint64_t v10 = *MEMORY[0x18960B970];
  v17[0] = *MEMORY[0x18960BB60];
  v17[1] = v10;
  uint64_t v11 = *MEMORY[0x18960BE30];
  v16[2] = *MEMORY[0x18960B878];
  v16[3] = v11;
  v17[2] = v7;
  v17[3] = MEMORY[0x189604A88];
  [MEMORY[0x189603F68] dictionaryWithObjects:v17 forKeys:v16 count:4];
  unint64_t v12 = (void *)objc_claimAutoreleasedReturnValue();
  [v8 dictionaryWithDictionary:v12];
  unint64_t v13 = (const __CFDictionary *)objc_claimAutoreleasedReturnValue();

  if (SecItemCopyMatching(v13, (CFTypeRef *)a4)) {
    BOOL v14 = +[DIError failWithPOSIXCode:description:error:]( &OBJC_CLASS___DIError,  "failWithPOSIXCode:description:error:",  22LL,  @"Couldn't find item in keychain",  a5);
  }
  else {
    BOOL v14 = 1;
  }
...
+ (BOOL)getPublicKeyWithCertificate:(id)a3 key:(__SecKey *)a4 error:(id *)a5
{
  ...
  if (v7 && a4)
  {
    uint64_t v9 = SecCertificateCreateWithData((CFAllocatorRef)*MEMORY[0x189604DB0], v7);
    uint64_t v10 = v9;
    if (v9)
    {
