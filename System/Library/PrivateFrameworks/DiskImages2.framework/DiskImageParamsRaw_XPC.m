...
- (unique_ptr<DiskImage,)createSinkDiskImage
{
  ...
  if (v65)
  {
    -[DiskImageParamsXPC setBlockSize:](self, "setBlockSize:", *(void *)(*((void *)v65 + 3) + 64LL));
    v17 = -[DiskImageParamsXPC backendXPC](self, "backendXPC");
    v18 = v17;
    if (v17)
    {
      [v17 backend];
    ...
    v20 = (di_utils *)operator new(0x58uLL);
    uint64_t v21 = di_utils::random_uuid(v20);
    *((_BYTE *)v20 + 8) = 0;
    *(void *)v20 = &off_18A1CA9B8;
    v23 = v64;
    *((void *)v20 + 2) = lpsrc;
    *((void *)v20 + 3) = v23;
    if (v23)
...
LABEL_37:
  ...
  v32 = -[DiskImageParamsXPC backendXPC](self, "backendXPC", v61);
  v33 = v32;
  if (v32)
  {
    [v32 backend];
...
LABEL_46:
  ...
  if (v65)
  {
    uint64_t compressed_blk_size = AEA_backend::get_compressed_blk_size((AEAContext **)v65);
    AEAIdentifier = AEAwrapper::Context::getAEAIdentifier((AEAContext_impl **)(*((void *)v39 + 7) + 8LL));
    uint64_t v43 = v42;
    v15 = (di_utils *)operator new(0x58uLL);
    v44 = v15;
    v45 = v66;
    if (v66)
    {
    ...
    *((void *)v15 + 9) = AEAIdentifier;
    *((void *)v15 + 10) = v43;
    *((void *)v15 + 4) = 512LL;
    *((void *)v15 + 5) = compressed_blk_size;
    *((void *)v15 + 6) = 1LL;
    *((void *)v15 + 7) = 2 * compressed_blk_size;
    *((void *)v15 + 8) = 0LL;
    if (v45)
    {
...
LABEL_69:
  ...
  v54 = -[DiskImageParamsXPC backendXPC](self, "backendXPC");
  v55 = v54;
  if (v54)
  {
    [v54 backend];
  ...
  v57 = (di_utils *)operator new(0x28uLL);
  DiskImageRaw::DiskImageRaw((uint64_t)v57, &v65, v56);
  *v4 = v57;
  v58 = v66;
  if (v66)
  {
