...
- (DBGClass)initWithClassName:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___DBGClass;
  v6 = -[DBGClass init](&v9, "init");
  v7 = v6;
  if (v6) {
...
- (NSString)description
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[DBGClass objectValue](self, "objectValue"));
...
- (NSString)debugDescription
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[DBGClass description](self, "description"));
...
+ (id)valueWithEncodedValue:(id)a3 format:(id)a4 error:(id *)a5
{
  ...
  {
    v11 = (void *)objc_claimAutoreleasedReturnValue([a1 withName:v8]);
  }
