...
- (MSOID)attributeType
{
  return +[MSOID OIDWithString:error:](&OBJC_CLASS___MSOID, "OIDWithString:error:", @"1.2.840.113549.1.9.5", 0LL);
}
...
- (MSCMSSigningTimeAttribute)initWithSigningTime:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___MSCMSSigningTimeAttribute;
  id v6 = -[MSCMSSigningTimeAttribute init](&v9, sel_init);
  v7 = v6;
  if (v6) {
...
- (id)encodeAttributeWithError:(id *)a3
{
  ...
  v12 = +[MSOID OIDWithString:error:](&OBJC_CLASS___MSOID, "OIDWithString:error:", @"1.2.840.113549.1.9.5", a3);
