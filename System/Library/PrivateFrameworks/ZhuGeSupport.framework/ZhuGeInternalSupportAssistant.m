...
+ (id)getInternalSupportPath
{
  ...
  {
    ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getInternalSupportPath]",  135LL,  @"Skip retrieving internal support path in restoreOS",  v4,  v5,  v6,  v37);
    id v7 = 0LL;
    __int128 v8 = 0LL;
LABEL_27:
    id v33 = 0LL;
  ...
  if (!v9)
  {
    ...
    ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getInternalSupportPath]",  142LL,  @"Retrieving unchanged internal supported path: %@",  v29,  v30,  v31,  (uint64_t)v8);
    id v7 = 0LL;
    goto LABEL_27;
  }
...
LABEL_29:
    ...
    ZhuGeLog( 524544,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getInternalSupportPath]",  174LL,  @"ZhuGe internal support path is updated to: %@",  v34,  v35,  v36,  (uint64_t)v8);
  ...
  if (a3)
  {
    *a3 = 0LL;
    ...
    if (![a1 dylibHandler])
    {
      ...
      if (!v10)
      {
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getDylibHandlerWithError:]",  207LL,  @"Failed to get ZhuGe internal support path for dylib handler!",  v11,  v12,  v13,  v23);
      ...
      if (![a1 dylibHandler])
      {
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getDylibHandlerWithError:]",  218LL,  @"Failed to dlopen ZhuGe internal armory dylib!",  v17,  v18,  v19,  v23);
...
LABEL_10:
  ...
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getDylibHandlerWithError:]",  194LL,  @"error p-pointer is nil!",  v5,  v6,  v7,  v23);
    __int128 v8 = 0LL;
    id v9 = 0LL;
  }
...
+ (id)getXpcProxyWithError:(id *)a3
{
  ...
  if (!a3)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getXpcProxyWithError:]",  273LL,  @"error p-pointer is nil!",  v5,  v6,  v7,  v40);
LABEL_9:
    id v9 = 0LL;
    id v10 = 0LL;
    uint64_t v11 = 0LL;
  ...
  *a3 = 0LL;
  ...
  if (!v13)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getXpcProxyWithError:]",  286LL,  @"Failed to get ZhuGe internal support path for xpc proxy!",  v14,  v15,  v16,  v40);
    [MEMORY[0x189607870] errorWithZhuGeErrorCode:43 underlyingError:0];
...
LABEL_13:
  ...
  if (!v11)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getXpcProxyWithError:]",  297LL,  @"Failed to connect %@!",  v20,  v21,  v22,  (uint64_t)@"com.apple.ZhuGeInternalService");
    [MEMORY[0x189607870] errorWithZhuGeErrorCode:67 underlyingError:0];
    id v37 = (id)objc_claimAutoreleasedReturnValue();
    goto LABEL_13;
  }

  [MEMORY[0x189607B48] interfaceWithProtocol:&unk_18C6E78B0];
  ...
  if (!v33)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getXpcProxyWithError:]",  339LL,  @"Failed to get proxy for %@!",  v34,  v35,  v36,  (uint64_t)@"com.apple.ZhuGeInternalService");
...
uint64_t __54__ZhuGeInternalSupportAssistant_getXpcProxyWithError___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m",  "+[ZhuGeInternalSupportAssistant getXpcProxyWithError:]_block_invoke_3",  333LL,  @"Internal connection failed to provide a synchronized proxy, error : %@!",  v5,  v6,  v7,  (uint64_t)v4);
