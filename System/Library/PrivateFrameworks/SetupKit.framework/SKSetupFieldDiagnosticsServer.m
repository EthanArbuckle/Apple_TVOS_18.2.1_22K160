...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SKSetupFieldDiagnosticsServer;
...
- (void)_activate
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___SKSetupFieldDiagnosticsServer;
...
- (void)_bleServerAcceptConnecton:(id)a3
{
  ...
  if (!v4)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:]( self,  "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:",  v5,  0LL,  0LL,  &__block_literal_global_1094);
    goto LABEL_8;
  }
...
- (void)_oobEnsureStarted
{
  if (!self->super._skCnx)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:]( self,  "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:",  v3,  0LL,  0LL,  &__block_literal_global_23);
  }
...
void __46__SKSetupFieldDiagnosticsServer__prepareSteps__block_invoke(uint64_t a1, void *a2)
{
  id v3 = *(void **)(a1 + 32);
  id v4 = a2;
  int v5 = -[SKEvent initWithEventType:error:](objc_alloc(&OBJC_CLASS___SKEvent), "initWithEventType:error:", 20LL, v4);
