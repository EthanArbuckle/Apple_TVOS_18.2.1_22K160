...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SKSetupMacSetupClient;
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___SKSetupMacSetupClient;
...
- (void)_run
{
  if (!self->super._invalidateCalled)
  {
    while (1)
    {
      ...
      {
        case 11:
          -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:]( self,  "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:",  0LL,  1LL,  1LL,  &__block_literal_global_2253);
