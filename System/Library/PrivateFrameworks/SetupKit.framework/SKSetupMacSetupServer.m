...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SKSetupMacSetupServer;
...
- (void)_activate
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___SKSetupMacSetupServer;
...
- (void)_bleServerAcceptConnecton:(id)a3
{
  ...
  if (!v4)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:]( self,  "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:",  v5,  0LL,  0LL,  &__block_literal_global_41);
    goto LABEL_8;
  }
...
- (void)_oobEnsureStarted
{
  if (!self->super._skCnx)
  {
    ...
    -[SKSetupBase _connectionStartWithSKConnection:clientMode:completeOnFailure:completion:]( self,  "_connectionStartWithSKConnection:clientMode:completeOnFailure:completion:",  v3,  0LL,  0LL,  &__block_literal_global_21);
  }
