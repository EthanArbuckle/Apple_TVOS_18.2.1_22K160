...
- (purgeOP)initWithUrgency:(int)a3 info:(id)a4 reply:(id)a5
{
  ...
  id v10 = a5;
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___purgeOP;
  v11 = -[purgeOP init](&v16, "init");
  v12 = v11;
  if (v11)
  {
    v11->_urgency = a3;
...
+ (id)purgeOpAtUrgency:(int)a3 info:(id)a4 reply:(id)a5
{
  ...
  id v7 = a5;
  id v8 = a4;
  id v9 = -[purgeOP initWithUrgency:info:reply:]( objc_alloc(&OBJC_CLASS___purgeOP),  "initWithUrgency:info:reply:",  v6,  v8,  v7);
