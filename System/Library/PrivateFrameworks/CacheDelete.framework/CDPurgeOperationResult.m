...
- (CDPurgeOperationResult)initWithVolumes:(id)a3 requestedBytes:(unint64_t)a4 mainVolume:(id)a5 clientProcName:(id)a6
{
  ...
  id v13 = a6;
  v22.receiver = self;
  v22.super_class = (Class)&OBJC_CLASS___CDPurgeOperationResult;
  v14 = -[CDResult init](&v22, "init");
  v15 = v14;
  if (v14)
  {
    ...
    v15->_noOfTimeouts = 0LL;
    v15->_timeoutTime = 0LL;
    ...
    {
      v15->_containerInitialFreespace = 0LL;
      v15->_containerSize = 0LL;
    }
  }
...
- (unint64_t)totalReportedBytes
{
  ...
  uint64_t v9 = 0LL;
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[CDPurgeOperationResult results](self, "results"));
...
- (unint64_t)totalMeasuredBytes
{
  unint64_t v3 = -[CDPurgeOperationResult endFreeSpace](self, "endFreeSpace");
  if (v3 < -[CDPurgeOperationResult beginFreeSpace](self, "beginFreeSpace")) {
    return 0LL;
  }
  unint64_t v5 = -[CDPurgeOperationResult endFreeSpace](self, "endFreeSpace");
  return v5 - -[CDPurgeOperationResult beginFreeSpace](self, "beginFreeSpace");
}
...
- (void)addResult:(id)a3
{
  ...
  if (v6 && (v4 & 1) == 0)
  {
    unint64_t v5 = (void *)objc_claimAutoreleasedReturnValue(-[CDPurgeOperationResult mutableResults](self, "mutableResults"));
    [v5 addObject:v6];
  }
}
