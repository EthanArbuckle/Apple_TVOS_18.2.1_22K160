...
- (id)init:(id)a3 options:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___SUCorePersistedActivity;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v6 = -[SUCorePersistedActivity activityName](v4, "activityName");
...
- (SUCorePersistedActivity)initWithCoder:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___SUCorePersistedActivity;
