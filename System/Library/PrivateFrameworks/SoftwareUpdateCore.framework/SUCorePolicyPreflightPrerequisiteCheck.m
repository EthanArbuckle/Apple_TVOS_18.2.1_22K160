...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___SUCorePolicyPreflightPrerequisiteCheck;
...
- (SUCorePolicyPreflightPrerequisiteCheck)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___SUCorePolicyPreflightPrerequisiteCheck;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[SUCorePolicyPreflightPrerequisiteCheck basePreflightOptions](self, "basePreflightOptions");
  objc_super v7 = (void *)[v6 copyWithZone:a3];
  [v5 setBasePreflightOptions:v7];
  v8 = -[SUCorePolicyPreflightPrerequisiteCheck additionalOptions](self, "additionalOptions");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      BOOL v5 = -[SUCorePolicyPreflightPrerequisiteCheck performPhase](v4, "performPhase");
      int v6 = v5 ^ -[SUCorePolicyPreflightPrerequisiteCheck performPhase](self, "performPhase") ^ 1;
    }
...
- (id)description
{
  ...
  {
    v8 = -[SUCorePolicyPreflightPrerequisiteCheck additionalOptions](self, "additionalOptions");
    [v3 stringWithFormat:@"SUCorePolicyPreflightPrerequisiteCheck(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, v8];
    objc_super v9 = (void *)objc_claimAutoreleasedReturnValue();
  }

  else
  {
    [v3 stringWithFormat:@"SUCorePolicyPreflightPrerequisiteCheck(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, @"none"];
    objc_super v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
