...
+ (id)blindSign:(id)a3 blindedBy:(__SecKey *)a4 with:(__SecKey *)a5 context:(id)a6 error:(id *)a7
{
  ...
  unint64_t v17 = (void *)sub_18764BDB4(v14, v16, v11, v12, v13);
...
+ (__SecKey)blindPublicKeyWithPublicKey:(__SecKey *)a3 with:(__SecKey *)a4 context:(id)a5 error:(id *)a6
{
  return (__SecKey *)sub_18764B048( (uint64_t)a1,  (uint64_t)a2,  a3,  a4,  a5,  (uint64_t)a6,  (uint64_t (*)(id, id, id))sub_18764C6B8);
}

+ (__SecKey)unblindPublicKey:(__SecKey *)a3 with:(__SecKey *)a4 context:(id)a5 error:(id *)a6
{
  return (__SecKey *)sub_18764B048( (uint64_t)a1,  (uint64_t)a2,  a3,  a4,  a5,  (uint64_t)a6,  (uint64_t (*)(id, id, id))sub_18764CC08);
}
