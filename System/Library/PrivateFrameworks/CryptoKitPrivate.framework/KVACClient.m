...
- (_TtC16CryptoKitPrivate10KVACClient)initWithTokenChallenge:(id)a3 error:(id *)a4
{
  return (_TtC16CryptoKitPrivate10KVACClient *)sub_187641130( (uint64_t)self,  (uint64_t)a2,  a3,  (uint64_t)a4,  (uint64_t (*)(uint64_t, uint64_t))KVACClient.init(tokenChallenge:));
}
...
- (id)makeCredentialWithIssuance:(id)a3 request:(id)a4 error:(id *)a5
{
  ...
  id v8 = a4;
  v9 = self;
  id v10 = sub_18763F6F0((uint64_t)v7, (uint64_t)v8);
