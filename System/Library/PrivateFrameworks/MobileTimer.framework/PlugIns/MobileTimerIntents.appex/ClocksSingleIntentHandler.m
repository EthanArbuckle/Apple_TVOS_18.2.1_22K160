...
- (void)provideCitiesOptionsCollectionForClocksSingle:(id)a3 searchTerm:(id)a4 withCompletion:(id)a5
{
  ...
  if ([v7 length])
  {
    ...
    v12[3] = &unk_1000041F0;
    id v13 = v8;
    -[ClocksSingleIntentHandler getCitiesMatchingSearch:completionHandler:]( self,  "getCitiesMatchingSearch:completionHandler:",  v7,  v12);
  }

  else
  {
    v9 = objc_alloc(&OBJC_CLASS___INObjectCollection);
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[ClocksSingleIntentHandler allClocks](self, "allClocks"));
...
- (id)allClocks
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[ClocksSingleIntentHandler clocksFromCities:](self, "clocksFromCities:", v4));
...
- (id)defaultCitiesForClocksSingle:(id)a3
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue([v4 citiesMatchingIdentifiers:&off_100004398]);
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[ClocksSingleIntentHandler clocksFromCities:](self, "clocksFromCities:", v5));
...
- (void)getCitiesMatchingSearch:(id)a3 completionHandler:(id)a4
{
  ...
  id v7 = (void *)objc_claimAutoreleasedReturnValue(-[ClocksSingleIntentHandler allClocks](self, "allClocks"));
  if ([v11 length])
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[ClocksSingleIntentHandler clocksFromCities:](self, "clocksFromCities:", v9));
...
- (id)userConfiguredClocks
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue(-[ClocksSingleIntentHandler clocksFromCities:](self, "clocksFromCities:", v4));
...
- (void)handleClocksSingle:(id)a3 completion:(id)a4
{
  ...
  id v33 = [[ClocksSingleIntentResponse alloc] initWithCode:4 userActivity:0];
  [v33 setClocks:v38];
  v34[2](v34, v33);
}
