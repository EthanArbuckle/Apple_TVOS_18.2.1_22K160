...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  uint64_t v12 = 0LL;
  v9 = (void *)objc_claimAutoreleasedReturnValue( +[ZhuGeSupportAssistant getSharedInstanceByName:withError:]( &OBJC_CLASS___ZhuGeSupportAssistant,  "getSharedInstanceByName:withError:",  @"OBJC_CLASS_$_AppleDeviceQueryLockerArmory",  &v12));
  v10 = v9;
  if (v9) {
