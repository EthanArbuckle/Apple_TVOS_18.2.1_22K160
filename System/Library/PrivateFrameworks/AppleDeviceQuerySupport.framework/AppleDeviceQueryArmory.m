...
- (void)initData
{
  ...
  v3 = objc_alloc(&OBJC_CLASS___AppleDeviceQueryArmoryHelperArmory);
...
- (BOOL)updateChangeablePropertiesForKey:(id)a3 andOption:(id)a4 withError:(id *)a5
{
  ...
  if (!a5)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory updateChangeablePropertiesForKey:andOption:withError:]",  38LL,  @"error p-pointer is nil!",  v10,  v11,  v12,  v32);
LABEL_12:
    BOOL v29 = 0;
    goto LABEL_13;
  }
  ...
  *a5 = 0LL;
  if (!v9)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory updateChangeablePropertiesForKey:andOption:withError:]",  44LL,  @"key pointer is nil!",  v10,  v11,  v12,  v32);
  ...
  v14 = -[AppleDeviceQueryArmory helper](self, "helper");
  key = self->_key;
  id v33 = 0LL;
  ...
  if (!self->_config)
  {
    ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory updateChangeablePropertiesForKey:andOption:withError:]",  55LL,  @"Failed to update config for key %@!",  v19,  v20,  v21,  (uint64_t)v9);
    id v30 = v17;
    *a5 = v30;
  ...
  if (isZhuGeInRestoreOS())
  {
    ...
    if (v25)
    {
      ...
      if ((v28 & 1) == 0)
      {
        ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory updateChangeablePropertiesForKey:andOption:withError:]",  64LL,  @"Key %@ isn't supported in restoreos!",  v22,  v23,  v24,  (uint64_t)v9);
  ...
  ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory updateChangeablePropertiesForKey:andOption:withError:]",  70LL,  @"Properties of key %@ is: %@",  v22,  v23,  v24,  (uint64_t)v9);
...
LABEL_5:
    ...
    while (1)
    {
      ...
      ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory convertReturnValue:ByItselfAndError:AndRevalues:]",  104LL,  @"Config of revalue %@ is not a dictionary",  v21,  v22,  v23,  v18);
LABEL_61:
      if (++v17 == v15)
      {
    ...
    else
    {
      ...
      if ((v27 & 1) == 0)
      {
        ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory convertReturnValue:ByItselfAndError:AndRevalues:]",  111LL,  @"Error config of revalue %@ is not an array",  v28,  v29,  v30,  v18);
...
LABEL_21:
        ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory convertReturnValue:ByItselfAndError:AndRevalues:]",  125LL,  @"Outcome config of revalue %@ is invalid!",  v40,  v41,  v42,  v18);
        int v46 = 8;
        uint64_t v15 = v31;
        goto LABEL_59;
      }
...
LABEL_43:
            if ((v52 & v58) == 1)
            {
              ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory convertReturnValue:ByItselfAndError:AndRevalues:]",  154LL,  @"Revalue %@ criteria are matched",  v47,  v48,  v49,  v18);
...
LABEL_54:
              ...
              {
                v59 = v78;
                v60 = (const __CFString *)&unk_18A3572C8;
                goto LABEL_54;
              }

              ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory convertReturnValue:ByItselfAndError:AndRevalues:]",  186LL,  @"Outcome config of revalue %@ is unsupported!",  v61,  v62,  v63,  v18);
            }
...
LABEL_84:
    ...
    objc_opt_class();
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory convertReturnValue:toFormat:]",  385LL,  @"Format %@ and class %@ mismatched!",  v34,  v35,  v36,  (uint64_t)v10);
    goto LABEL_8;
  }
...
LABEL_9:
      ...
      if ([v10 count] == 2)
      {
        ...
        [v9 stringByReplacingOccurrencesOfString:v11 withString:&stru_18A34F890];
        ...
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory getKeyAndOptionFromDependency:withError:]",  472LL,  @"dependency %@ doesn't contain a valid JSON string!",  v21,  v22,  v23,  (uint64_t)v9);
...
LABEL_12:
      ...
      ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory getKeyAndOptionFromDependency:withError:]",  477LL,  @"dependency %@ format is wrong!",  v17,  v18,  v19,  (uint64_t)v9);
    ...
    {
      ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory getKeyAndOptionFromDependency:withError:]",  456LL,  @"dependency pointer is nil!",  v6,  v7,  v8,  v25);
      [MEMORY[0x189607870] errorWithZhuGeErrorCode:45 underlyingError:0];
      id v16 = (id)objc_claimAutoreleasedReturnValue();
      id v11 = 0LL;
      uint64_t v14 = 0LL;
  ...
  ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory getKeyAndOptionFromDependency:withError:]",  450LL,  @"error p-pointer is nil!",  v6,  v7,  v8,  v25);
  id v11 = 0LL;
  uint64_t v14 = 0LL;
  uint64_t v10 = 0LL;
  uint64_t v12 = 0LL;
...
- (BOOL)checkDependency:(id)a3 withError:(id *)a4
{
  ...
  if (!a4)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  500LL,  @"error p-pointer is nil!",  v7,  v8,  v9,  v73);
    BOOL v14 = 0;
    goto LABEL_36;
  }
  ...
  *a4 = 0LL;
  ...
  if (v16)
  {
    ...
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  513LL,  @"Key %@ dependency got deadloop",  v18,  v19,  v20,  (uint64_t)v17);
  ...
  while (2)
  {
    ...
    do
    {
      ...
      ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  520LL,  @"Checking dependency \"%@\"",  v21,  v22,  v23,  v32);
      ...
      if (v34)
      {
        v74 = -[AppleDeviceQueryArmory key](self, "key");
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  523LL,  @"Duplicated dependency \"%@\" for key \"%@\"",  v53,  v54,  v55,  v32);
      ...
      if (!v24)
      {
        ...
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  530LL,  @"Failed to resolve dependency %@ for key %@!",  v56,  v57,  v58,  v32);
      ...
      id v85 = v35;
      v39 = -[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]( self,  "runForKey:andOptions:andPreferences:withError:",  v25,  v38,  0LL,  &v85);
      id v40 = v85;

      if (!v39)
      {
        v76 = -[AppleDeviceQueryArmory key](self, "key");
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  542LL,  @"Failed to run for dependency \"%@\" for key \"%@\"",  v59,  v60,  v61,  v32);
      ...
      if (!v26)
      {
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  552LL,  @"Failed to get config for dependency %@!",  v44,  v45,  v46,  v32);
        id v26 = v43;
        BOOL v14 = 0;
        *uint64_t v77 = v26;
        goto LABEL_32;
      ...
      if ((v48 & 1) == 0)
      {
        ...
        if ((isKindOfClass & 1) == 0)
        {
          ...
          ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  559LL,  @"Dependency %@ defines a non-array dependency",  v69,  v70,  v71,  (uint64_t)v68);
      ...
      v51 = (void *)objc_claimAutoreleasedReturnValue();
      id v83 = v43;
      BOOL v52 = -[AppleDeviceQueryArmory checkDependency:withError:](self, "checkDependency:withError:", v51, &v83);
      id v27 = v83;
      ...
      if (!v52)
      {
        ...
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory checkDependency:withError:]",  566LL,  @"Failed to verify for key \"%@\" in dependency \"%@\"",  v64,  v65,  v66,  (uint64_t)v63);
...
- (BOOL)verifyDependencyWithError:(id *)a3
{
  if (!a3)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory verifyDependencyWithError:]",  585LL,  @"error p-pointer is nil!",  v3,  v4,  v5,  v33);
    id v20 = 0LL;
    BOOL v21 = 0;
    goto LABEL_10;
  }
  ...
  *a3 = 0LL;
  ...
  if ((v13 & 1) == 0)
  {
    ...
    if ((isKindOfClass & 1) == 0)
    {
      ...
      ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory verifyDependencyWithError:]",  595LL,  @"Key %@ defines a non-array dependency",  v29,  v30,  v31,  (uint64_t)v28);
  ...
  id v35 = 0LL;
  BOOL v19 = -[AppleDeviceQueryArmory checkDependency:withError:](self, "checkDependency:withError:", v18, &v35);
  id v20 = v35;
  ...
  if (!v19)
  {
    ...
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory verifyDependencyWithError:]",  602LL,  @"Failed to check dependency for key \"%@\" in path \"%@\"",  v24,  v25,  v26,  (uint64_t)v22);
...
- (id)actForKey:(id)a3 andName:(id)a4 andConfig:(id)a5 andOptions:(id)a6 andPreferences:(id)a7 withError:(id *)a8
{
  ...
  if (!a8)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  648LL,  @"error p-pointer is nil!",  v19,  v20,  v21,  v203);
    uint64_t v25 = 0LL;
    v241 = 0LL;
    v238 = 0LL;
    v236 = 0LL;
    ...
    uint64_t v32 = 0LL;
LABEL_7:
    int v34 = &unk_18A3572E0;
    id v35 = &unk_18A3572E0;
    goto LABEL_18;
  }
  ...
  *a8 = 0LL;
  if (!v14)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  654LL,  @"key pointer is nil!",  v19,  v20,  v21,  v203);
    [MEMORY[0x189607870] errorWithZhuGeErrorCode:45 underlyingError:0];
  ...
  if (!v28)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  667LL,  @"Key \"%@\" doesn't define method for action \"%@\"",  v36,  v37,  v38,  (uint64_t)v14);
...
LABEL_17:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  675LL,  @"Key \"%@\" defines a non-string method for action \"%@\"",  v39,  v40,  v41,  (uint64_t)v14);
    goto LABEL_15;
  }

  if (isObjectNSStringAndZhuGeNull(v32))
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  681LL,  @"Key \"%@\" defines a empty method for action \"%@\"",  v42,  v43,  v44,  (uint64_t)v14);
LABEL_15:
    [MEMORY[0x189607870] errorWithZhuGeErrorCode:9 underlyingError:0];
    id v45 = (id)objc_claimAutoreleasedReturnValue();
    uint64_t v25 = 0LL;
...
LABEL_16:
  ...
  if (!v28)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  688LL,  @"Key \"%@\" doesn't define argument for action \"%@\"",  v47,  v48,  v49,  (uint64_t)v14);
    [MEMORY[0x189607870] errorWithZhuGeErrorCode:29 underlyingError:0];
    id v45 = (id)objc_claimAutoreleasedReturnValue();
    uint64_t v25 = 0LL;
    v241 = 0LL;
  ...
  if ((isKindOfClass & 1) == 0)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  694LL,  @"Key \"%@\" defines a non-array argument for action \"%@\"",  v52,  v53,  v54,  (uint64_t)v14);
    goto LABEL_15;
  }
  ...
  if (!v30)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  705LL,  @"Method %@ of key %@ doesn't exist!",  v56,  v57,  v58,  (uint64_t)v32);
  ...
  if (!v29)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]",  712LL,  @"Failed to get invocation method \"%@\" for key \"%@\"",  v59,  v60,  v61,  (uint64_t)v32);
...
void __90__AppleDeviceQueryArmory_actForKey_andName_andConfig_andOptions_andPreferences_withError___block_invoke( uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    {
      ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory actForKey:andName:andConfig:andOptions:andPreferences:withError:]_block_invoke",  962LL,  @"Method %@ of key %@ doesn't return anything!",  v4,  v5,  v6,  *(void *)(a1 + 56));
...
- (id)runForKey:(id)a3 andOptions:(id)a4 andPreferences:(id)a5 withError:(id *)a6
{
  ...
  if (a6)
  {
    *a6 = 0LL;
    if (!v10)
    {
      ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1027LL,  @"key pointer is nil!",  v12,  v13,  v14,  v134);
      [MEMORY[0x189607870] errorWithZhuGeErrorCode:45 underlyingError:0];
      id v26 = (id)objc_claimAutoreleasedReturnValue();
      id v27 = 0LL;
      id v22 = 0LL;
...
LABEL_22:
    ...
    if (v16 == v10)
    {
      ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1033LL,  @"Will invocate for key %@!",  v17,  v18,  v19,  (uint64_t)v10);
      -[AppleDeviceQueryArmory config](self, "config");
    ...
    {
      ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1036LL,  @"Will invocate for dependency %@!",  v17,  v18,  v19,  (uint64_t)v10);
      -[AppleDeviceQueryArmory helper](self, "helper");
      uint64_t v20 = (void *)objc_claimAutoreleasedReturnValue();
      id v146 = 0LL;
      ...
      if (!v21)
      {
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1039LL,  @"Failed to update config for key %@!",  v23,  v24,  v25,  (uint64_t)v10);
        id v26 = v22;
        id v22 = v26;
LABEL_21:
        id v27 = 0LL;
    ...
    else
    {
      ...
      if ((isKindOfClass & 1) == 0)
      {
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1048LL,  @"Key %@ defines a non-array user privilege",  v55,  v56,  v57,  (uint64_t)v10);
        [MEMORY[0x189607870] errorWithZhuGeErrorCode:9 underlyingError:0];
        id v26 = (id)objc_claimAutoreleasedReturnValue();
        goto LABEL_21;
      }
      ...
      if ((v60 & 1) == 0)
      {
        ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1055LL,  @"Current process priviledge is not allowed by Key \"%@\"",  v62,  v63,  v64,  (uint64_t)v10);
      ...
      if (v39)
      {
        ...
        if (v27)
        {
          ...
          else
          {
            ...
            if ((v72 & 1) == 0)
            {
              ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1091LL,  @"Key %@ is defined action sequence with non-array",  v73,  v74,  v75,  (uint64_t)v10);
              [MEMORY[0x189607870] errorWithZhuGeErrorCode:9 underlyingError:0];
              uint64_t v28 = 0LL;
...
LABEL_32:
            ...
            if ((v93 & 1) != 0)
            {
              ...
              if ((v99 & 1) == 0)
              {
                ...
                if ((v102 & 1) != 0)
                {
                  ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1142LL,  @"Key %@ original value is %@, error is %@",  v103,  v104,  v105,  (uint64_t)v10);
                  id v141 = v28;
                  id v106 = *v139;
                  [v21 objectForKeyedSubscript:@"RETURN"];
                  ...
                  if ((v106 & 1) != 0)
                  {
                    *uint64_t v139 = 0LL;
                    uint64_t v28 = v136;
                    ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1152LL,  @"Key %@ revalued value is %@, error is %@",  v109,  v110,  v111,  (uint64_t)v10);
                    a6 = v139;
                    uint64_t v29 = v137;
                    id v27 = obj;
                    v115 = v136;
                    if (!v136)
                    {
                      ZhuGeLog( 524800,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory runForKey:andOptions:andPreferences:withError:]",  1155LL,  @"Revalued key %@ to nil intentionally!",  v112,  v113,  v114,  (uint64_t)v10);
...
- (id)queryKey:(id)a3 andOptions:(id)a4 andPreferences:(id)a5 withError:(id *)a6
{
  ...
  if (!a6)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory queryKey:andOptions:andPreferences:withError:]",  1202LL,  @"error p-pointer is nil!",  v12,  v13,  v14,  v35);
    id v27 = 0LL;
    id v28 = 0LL;
    goto LABEL_13;
  }
  ...
  *a6 = 0LL;
  if (!v10)
  {
    ZhuGeLog( 1040,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory queryKey:andOptions:andPreferences:withError:]",  1208LL,  @"key pointer is nil!",  v12,  v13,  v14,  v35);
    [MEMORY[0x189607870] errorWithZhuGeErrorCode:45 underlyingError:0];
  ...
  ZhuGeLog( 262400,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory queryKey:andOptions:andPreferences:withError:]",  1213LL,  @"Querying the key: %@",  v12,  v13,  v14,  (uint64_t)v10);
  id v38 = 0LL;
  BOOL v16 = -[AppleDeviceQueryArmory updateChangeablePropertiesForKey:andOption:withError:]( self,  "updateChangeablePropertiesForKey:andOption:withError:",  v10,  v11,  &v38);
  id v17 = v38;
  uint64_t v21 = v17;
  if (!v16)
  {
    ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory queryKey:andOptions:andPreferences:withError:]",  1218LL,  @"Failed to update properties for key %@, error %@!",  v18,  v19,  v20,  (uint64_t)v10);
    char v33 = v21;
LABEL_11:
    id v32 = v33;
    id v28 = v32;
  ...
  id v37 = v17;
  BOOL v22 = -[AppleDeviceQueryArmory verifyDependencyWithError:](self, "verifyDependencyWithError:", &v37);
  id v23 = v37;

  if (!v22)
  {
    ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory queryKey:andOptions:andPreferences:withError:]",  1224LL,  @"Dependency of %@ is not ready, error %@",  v24,  v25,  v26,  (uint64_t)v10);
    char v33 = v23;
    goto LABEL_11;
  }
  ...
  if (!v27)
  {
    ZhuGeLog( 262656,  "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeSupport/ZhuGeArmory/ZhuGeArmory.m",  "-[AppleDeviceQueryArmory queryKey:andOptions:andPreferences:withError:]",  1234LL,  @"Failed to act for key %@!",  v29,  v30,  v31,  (uint64_t)v10);
    id v32 = v28;
    id v28 = v32;
LABEL_12:
    *a6 = v32;
...
- (AppleDeviceQueryArmoryHelperArmory)helper
{
  return (AppleDeviceQueryArmoryHelperArmory *)objc_getProperty(self, a2, 24LL, 1);
}
