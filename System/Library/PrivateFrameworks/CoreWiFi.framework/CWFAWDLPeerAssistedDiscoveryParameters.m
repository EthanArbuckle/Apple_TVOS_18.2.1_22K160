...
LABEL_13:
            ...
            if (peerMasterChannel == objc_msgSend_peerMasterChannel(v6, v32, v33, v34, v35)
              ...
              && (int peerSupportedChannelFlags = self->_peerSupportedChannelFlags,
                  peerSupportedChannelFlags == objc_msgSend_peerSupportedChannelFlags( v6,  v65,  v66,  v67,  v68))
              && (int followMode = self->_followMode,
                  followMode == objc_msgSend_followMode(v6, v70, v71, v72, v73)))
            {
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_( CWFAWDLPeerAssistedDiscoveryParameters,  a2,  (uint64_t)a3,  v3,  v4);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v6, v11, (uint64_t)v10, (uint64_t)@"_localMasterChannel", v12);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v13, self->_localPreferredChannel, v14, v15);
  uint64_t v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v17, (uint64_t)v16, (uint64_t)@"_localPreferredChannel", v18);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v19, self->_localSecondaryPreferredChannel, v20, v21);
  uint64_t v22 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v23, (uint64_t)v22, (uint64_t)@"_localSecondaryPreferredChannel", v24);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v25, self->_localAssistedDiscoveryMetric, v26, v27);
  uint64_t v28 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v29, (uint64_t)v28, (uint64_t)@"_localAssistedDiscoveryMetric", v30);

  objc_msgSend_encodeObject_forKey_(v6, v31, (uint64_t)self->_peerMACAddress, (uint64_t)@"_peerMACAddress", v32);
  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v33, self->_peerMasterChannel, v34, v35);
  v36 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v37, (uint64_t)v36, (uint64_t)@"_peerMasterChannel", v38);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v39, self->_peerPreferredChannel, v40, v41);
  v42 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v43, (uint64_t)v42, (uint64_t)@"_peerPreferredChannel", v44);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v45, self->_peerSecondaryPreferredChannel, v46, v47);
  v48 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v49, (uint64_t)v48, (uint64_t)@"_peerSecondaryPreferredChannel", v50);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v51, self->_peerAssistedDiscoveryMetric, v52, v53);
  v54 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v55, (uint64_t)v54, (uint64_t)@"_peerAssistedDiscoveryMetric", v56);

  objc_msgSend_encodeInteger_forKey_( v6,  v57,  self->_peerSupportedChannelFlags,  (uint64_t)@"_peerSupportedChannelFlags",  v58);
  objc_msgSend_encodeBool_forKey_(v6, v59, self->_followMode, (uint64_t)@"_followMode", v60);
  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v61, self->_followModePreferredBand, v62, v63);
  id v66 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v64, (uint64_t)v66, (uint64_t)@"_followModePreferredBand", v65);
}
...
- (CWFAWDLPeerAssistedDiscoveryParameters)initWithCoder:(id)a3
{
  id v4 = a3;
  v90.receiver = self;
  v90.super_class = (Class)&OBJC_CLASS___CWFAWDLPeerAssistedDiscoveryParameters;
  v5 = -[CWFAWDLPeerAssistedDiscoveryParameters init](&v90, sel_init);
  if (v5)
  {
    uint64_t v6 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, (uint64_t)@"_localMasterChannel", v8);
    uint64_t v9 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t localMasterChannel = objc_msgSend_unsignedIntegerValue(v9, v10, v11, v12, v13);

    uint64_t v14 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v15, v14, (uint64_t)@"_localPreferredChannel", v16);
    uint64_t v17 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t localPreferredChannel = objc_msgSend_unsignedIntegerValue(v17, v18, v19, v20, v21);

    uint64_t v22 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v23, v22, (uint64_t)@"_localSecondaryPreferredChannel", v24);
    uint64_t v25 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t localSecondaryPreferredChannel = objc_msgSend_unsignedIntegerValue(v25, v26, v27, v28, v29);

    uint64_t v30 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v31, v30, (uint64_t)@"_localAssistedDiscoveryMetric", v32);
    uint64_t v33 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t localAssistedDiscoveryMetric = objc_msgSend_unsignedIntegerValue(v33, v34, v35, v36, v37);

    uint64_t v38 = objc_opt_class();
    uint64_t v41 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v39, v38, (uint64_t)@"_peerMACAddress", v40);
    peerMACAddress = v5->_peerMACAddress;
    v5->_peerMACAddress = (NSString *)v41;

    uint64_t v43 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v44, v43, (uint64_t)@"_peerMasterChannel", v45);
    ...
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v52, v51, (uint64_t)@"_peerPreferredChannel", v53);
    v54 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t peerPreferredChannel = objc_msgSend_unsignedIntegerValue(v54, v55, v56, v57, v58);

    uint64_t v59 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v60, v59, (uint64_t)@"_peerSecondaryPreferredChannel", v61);
    ...
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v68, v67, (uint64_t)@"_peerAssistedDiscoveryMetric", v69);
    v70 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t peerAssistedDiscoveryMetric = objc_msgSend_unsignedIntegerValue(v70, v71, v72, v73, v74);

    v5->_int peerSupportedChannelFlags = objc_msgSend_decodeIntegerForKey_( v4,  v75,  (uint64_t)@"_peerSupportedChannelFlags",  v76,  v77);
    v5->_int followMode = objc_msgSend_decodeBoolForKey_(v4, v78, (uint64_t)@"_followMode", v79, v80);
    uint64_t v81 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v82, v81, (uint64_t)@"_followModePreferredBand", v83);
