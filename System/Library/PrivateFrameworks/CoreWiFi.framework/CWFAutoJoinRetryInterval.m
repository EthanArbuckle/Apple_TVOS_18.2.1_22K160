...
- (id)description
{
  objc_msgSend_stringWithFormat_( MEMORY[0x189607940],  a2,  (uint64_t)@"interval=%lu, count=%lu, BSSChannelsOnly=%d, maxBSSChannelAge=%lu, maxBSSChannelCount=%lu, passiveScan=%d, dwellTime=%lu, autoHotspotFallback=%d, includeAdjacent5GHzChannel=%d, alwaysIncludeRemainingNon2GHzChannels=%d",  v2,  v3,  self->_interval,  self->_count,  self->_BSSChannelsOnly,  self->_maxBSSChannelAge,  self->_maxBSSChannelCount,  self->_passiveScan,  self->_dwellTime,  self->_allowAutoHotspotFallback,  self->_includeAdjacent5GHzChannel,  self->_alwaysIncludeRemainingNon2GHzChannels);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_appendFormat_( v5,  v6,  (uint64_t)@", alwaysInclude6GHzPSCChannels=%d",  v7,  v8,  self->_alwaysInclude6GHzPSCChannels);
  uint64_t v13 = (void *)objc_msgSend_copy(v5, v9, v10, v11, v12);
