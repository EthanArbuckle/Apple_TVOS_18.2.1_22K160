...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFANQPParameters, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  scanResults = self->_scanResults;
  id v29 = a3;
  objc_msgSend_encodeObject_forKey_(v29, v5, (uint64_t)scanResults, (uint64_t)@"_scanResults", v6);
  objc_msgSend_encodeObject_forKey_( v29,  v7,  (uint64_t)self->_ANQPElementIDList,  (uint64_t)@"_ANQPElementIDList",  v8);
  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v9, self->_acceptableCacheAge, v10, v11);
  uint64_t v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v29, v13, (uint64_t)v12, (uint64_t)@"_acceptableCacheAge", v14);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v15, self->_maximumAge, v16, v17);
  uint64_t v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v29, v19, (uint64_t)v18, (uint64_t)@"_maximumAge", v20);

  objc_msgSend_numberWithUnsignedLongLong_(MEMORY[0x189607968], v21, self->_minimumTimestamp, v22, v23);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v29, v25, (uint64_t)v24, (uint64_t)@"_minimumTimestamp", v26);

  objc_msgSend_encodeBool_forKey_( v29,  v27,  self->_includeMatchingKnownNetworkProfiles,  (uint64_t)@"_includeMatchingKnownNetworkProfiles",  v28);
}
...
- (CWFANQPParameters)initWithCoder:(id)a3
{
  id v4 = a3;
  v56.receiver = self;
  v56.super_class = (Class)&OBJC_CLASS___CWFANQPParameters;
  ...
  if (v5)
  {
    ...
    uint64_t v12 = (void *)objc_claimAutoreleasedReturnValue();
    uint64_t v15 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v13, (uint64_t)v12, (uint64_t)@"_scanResults", v14);
    ...
    uint64_t v26 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v24, (uint64_t)v23, (uint64_t)@"_ANQPElementIDList", v25);
    ANQPElementIDList = v5->_ANQPElementIDList;
    v5->_ANQPElementIDList = (NSArray *)v26;

    uint64_t v28 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v29, v28, (uint64_t)@"_acceptableCacheAge", v30);
    uint64_t v31 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t acceptableCacheAge = objc_msgSend_unsignedIntegerValue(v31, v32, v33, v34, v35);

    uint64_t v36 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v37, v36, (uint64_t)@"_maximumAge", v38);
    uint64_t v39 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t maximumAge = objc_msgSend_unsignedIntegerValue(v39, v40, v41, v42, v43);

    uint64_t v44 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v45, v44, (uint64_t)@"_minimumTimestamp", v46);
    ...
    v5->_int includeMatchingKnownNetworkProfiles = objc_msgSend_decodeBoolForKey_( v4,  v52,  (uint64_t)@"_includeMatchingKnownNetworkProfiles",  v53,  v54);
  }
