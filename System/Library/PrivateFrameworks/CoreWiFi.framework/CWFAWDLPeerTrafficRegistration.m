...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFAWDLPeerTrafficRegistration, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  serviceName = self->_serviceName;
  id v37 = a3;
  objc_msgSend_encodeObject_forKey_(v37, v5, (uint64_t)serviceName, (uint64_t)@"_serviceName", v6);
  objc_msgSend_encodeBool_forKey_(v37, v7, self->_active, (uint64_t)@"_active", v8);
  objc_msgSend_encodeInteger_forKey_(v37, v9, self->_sessionFlags, (uint64_t)@"_sessionFlags", v10);
  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v11, self->_desiredBandwidth, v12, v13);
  uint64_t v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v37, v15, (uint64_t)v14, (uint64_t)@"_desiredBandwidth", v16);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v17, self->_desiredLatency, v18, v19);
  uint64_t v20 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v37, v21, (uint64_t)v20, (uint64_t)@"_desiredLatency", v22);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v23, self->_preferredChannel, v24, v25);
  uint64_t v26 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v37, v27, (uint64_t)v26, (uint64_t)@"_preferredChannel", v28);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v29, self->_secondaryPreferredChannel, v30, v31);
  uint64_t v32 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v37, v33, (uint64_t)v32, (uint64_t)@"_secondaryPreferredChannel", v34);

  objc_msgSend_encodeObject_forKey_(v37, v35, (uint64_t)self->_peerContextList, (uint64_t)@"_peerContextList", v36);
}
...
- (CWFAWDLPeerTrafficRegistration)initWithCoder:(id)a3
{
  id v4 = a3;
  v61.receiver = self;
  v61.super_class = (Class)&OBJC_CLASS___CWFAWDLPeerTrafficRegistration;
  v5 = -[CWFAWDLPeerTrafficRegistration init](&v61, sel_init);
  if (v5)
  {
    uint64_t v6 = objc_opt_class();
    uint64_t v9 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, (uint64_t)@"_serviceName", v8);
    serviceName = v5->_serviceName;
    v5->_serviceName = (NSString *)v9;

    v5->_BOOL active = objc_msgSend_decodeBoolForKey_(v4, v11, (uint64_t)@"_active", v12, v13);
    v5->_uint64_t sessionFlags = objc_msgSend_decodeIntegerForKey_(v4, v14, (uint64_t)@"_sessionFlags", v15, v16);
    uint64_t v17 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v18, v17, (uint64_t)@"_desiredBandwidth", v19);
    uint64_t v20 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t desiredBandwidth = objc_msgSend_unsignedIntegerValue(v20, v21, v22, v23, v24);

    uint64_t v25 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v26, v25, (uint64_t)@"_desiredLatency", v27);
    uint64_t v28 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t desiredLatency = objc_msgSend_unsignedIntegerValue(v28, v29, v30, v31, v32);

    uint64_t v33 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v34, v33, (uint64_t)@"_preferredChannel", v35);
    uint64_t v36 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t preferredChannel = objc_msgSend_unsignedIntegerValue(v36, v37, v38, v39, v40);

    uint64_t v41 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v42, v41, (uint64_t)@"_secondaryPreferredChannel", v43);
    ...
    uint64_t v58 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v56, (uint64_t)v55, (uint64_t)@"_peerContextList", v57);
...
- (id)serializedRegistrationInfo
{
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v6, v12, (uint64_t)v11, (uint64_t)@"TR_SRV_NAME", v13);
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v6, v24, (uint64_t)v23, (uint64_t)@"TR_ACTIVE", v25);
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v6, v36, (uint64_t)v35, (uint64_t)@"TR_SESSION_FLAGS", v37);

  uint64_t v38 = (void *)MEMORY[0x189607968];
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v6, v48, (uint64_t)v47, (uint64_t)@"TR_DESIRED_BW", v49);
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v6, v60, (uint64_t)v59, (uint64_t)@"TR_DESIRED_LATENCY", v61);
  ...
  v71 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setObject_forKeyedSubscript_(v6, v72, (uint64_t)v71, (uint64_t)@"AWDL_TR_CHANNEL", v73);
  ...
  v140 = v6;
  objc_msgSend_setObject_forKeyedSubscript_(v6, v84, (uint64_t)v83, (uint64_t)@"AWDL_TR_SEC_CHANNEL", v85);
  ...
  if (v97)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v105 = *(void **)(*((void *)&v141 + 1) + 8 * v104);
        objc_msgSend_dictionary(MEMORY[0x189603FC8], v98, v99, v100, v101);
        ...
        if (v111)
        {
          id v116 = objc_msgSend_MACAddress(v105, v112, v113, v114, v115);
          v121 = (const char *)objc_msgSend_UTF8String(v116, v117, v118, v119, v120);
          v122 = ether_aton(v121);

          if (v122)
          {
            objc_msgSend_dataWithBytes_length_(MEMORY[0x189603F48], v112, (uint64_t)v122, 6, v115);
            v123 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend_setObject_forKeyedSubscript_( v106,  v124,  (uint64_t)v123,  (uint64_t)@"TR_PEER_ADDRESS",  v125);
          }
        }

        objc_msgSend_interfaceName(v105, v112, v113, v114, v115);
        v126 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend_setObject_forKeyedSubscript_(v106, v127, (uint64_t)v126, (uint64_t)@"TR_IFNAME", v128);
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v140, v132, (uint64_t)v90, (uint64_t)@"TR_PEER_CONTEXTS", v133);
