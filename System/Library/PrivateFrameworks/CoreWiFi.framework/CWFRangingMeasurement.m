...
- (id)description
{
  return (id)objc_msgSend_stringWithFormat_( NSString,  a2,  (uint64_t)@"rtt=%ld rssi=%ld snr=%ld channel=%lu coreid=%lu",  v2,  v3,  self->_roundTripTime,  self->_RSSI,  self->_SNR,  self->_channel,  self->_coreID);
}
...
- (unint64_t)hash
{
  ...
  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v11, self->_RSSI, v12, v13);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v19 = objc_msgSend_hash(v14, v15, v16, v17, v18);
  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v20, self->_SNR, v21, v22);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v6, v11, (uint64_t)v10, (uint64_t)@"_roundTripTime", v12);

  objc_msgSend_encodeInteger_forKey_(v6, v13, self->_RSSI, (uint64_t)@"_RSSI", v14);
  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v15, self->_channel, v16, v17);
  uint64_t v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v19, (uint64_t)v18, (uint64_t)@"_channel", v20);

  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v21, self->_SNR, v22, v23);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v25, (uint64_t)v24, (uint64_t)@"_SNR", v26);

  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v27, self->_coreID, v28, v29);
  id v32 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v6, v30, (uint64_t)v32, (uint64_t)@"_coreID", v31);
}
...
- (CWFRangingMeasurement)initWithCoder:(id)a3
{
  id v4 = a3;
  v37.receiver = self;
  v37.super_class = (Class)&OBJC_CLASS___CWFRangingMeasurement;
  v5 = -[CWFRangingMeasurement init](&v37, sel_init);
  if (v5)
  {
    uint64_t v6 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, (uint64_t)@"_roundTripTime", v8);
    uint64_t v9 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_int64_t roundTripTime = objc_msgSend_integerValue(v9, v10, v11, v12, v13);

    v5->_int64_t RSSI = objc_msgSend_decodeIntegerForKey_(v4, v14, (uint64_t)@"_RSSI", v15, v16);
    uint64_t v17 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v18, v17, (uint64_t)@"_channel", v19);
    uint64_t v20 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t channel = objc_msgSend_unsignedIntegerValue(v20, v21, v22, v23, v24);

    v5->_int64_t SNR = objc_msgSend_decodeIntegerForKey_(v4, v25, (uint64_t)@"_SNR", v26, v27);
    uint64_t v28 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v29, v28, (uint64_t)@"_coreID", v30);
