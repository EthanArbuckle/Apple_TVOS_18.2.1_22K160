...
+ (id)rangingPeerWithMACAddress:(id)a3 PMK:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  v7 = objc_alloc_init(&OBJC_CLASS___CWFRangingPeer);
...
- (id)description
{
  ...
  if (identifier)
  {
    ...
    uint64_t v13 = (void *)objc_msgSend_initWithData_encoding_(v10, v11, (uint64_t)self->_identifier, 4, v12);
  ...
  objc_msgSend_stringWithFormat_(v3, v16, (uint64_t)@"mac=%@, id='%@' (%@)", v17, v18, v8, v13, v15);
...
- (unint64_t)hash
{
  ...
  objc_msgSend_numberWithBool_(MEMORY[0x189607968], v18, self->_useCoreRotation, v19, v20);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFRangingPeer, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  MACAddress = self->_MACAddress;
  id v5 = a3;
  objc_msgSend_encodeObject_forKey_(v5, v6, (uint64_t)MACAddress, (uint64_t)@"_MACAddress", v7);
  objc_msgSend_encodeObject_forKey_(v5, v8, (uint64_t)self->_PMK, (uint64_t)@"_PMK", v9);
  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v10, self->_numberOfMeasurements, v11, v12);
  uint64_t v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v5, v14, (uint64_t)v13, (uint64_t)@"_numberOfMeasurements", v15);

  objc_msgSend_encodeObject_forKey_(v5, v16, (uint64_t)self->_identifier, (uint64_t)@"_identifier", v17);
  objc_msgSend_numberWithBool_(MEMORY[0x189607968], v18, self->_useCoreRotation, v19, v20);
  id v23 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v5, v21, (uint64_t)v23, (uint64_t)@"_useCoreRotation", v22);
}
...
- (CWFRangingPeer)initWithCoder:(id)a3
{
  id v4 = a3;
  v38.receiver = self;
  v38.super_class = (Class)&OBJC_CLASS___CWFRangingPeer;
  id v5 = -[CWFRangingPeer init](&v38, sel_init);
  if (v5)
  {
    ...
    uint64_t v14 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, (uint64_t)@"_PMK", v13);
    PMK = v5->_PMK;
    v5->_PMK = (NSData *)v14;

    uint64_t v16 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v17, v16, (uint64_t)@"_numberOfMeasurements", v18);
    uint64_t v19 = (void *)objc_claimAutoreleasedReturnValue();
    v5->_unint64_t numberOfMeasurements = objc_msgSend_unsignedIntegerValue(v19, v20, v21, v22, v23);

    uint64_t v24 = objc_opt_class();
    uint64_t v27 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v25, v24, (uint64_t)@"_identifier", v26);
    identifier = v5->_identifier;
    v5->_identifier = (NSData *)v27;

    uint64_t v29 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v30, v29, (uint64_t)@"_useCoreRotation", v31);
