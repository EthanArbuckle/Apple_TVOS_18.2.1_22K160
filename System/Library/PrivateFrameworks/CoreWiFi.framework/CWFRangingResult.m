...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_( v3,  v16,  (uint64_t)@"mac=%@, id='%@' (%@), dist=%f, stddev=%f, measurements=[%@]",  v17,  v18,  v8,  v13,  v15,  *(void *)&self->_distance,  *(void *)&self->_standardDeviation,  self->_measurements);
...
LABEL_37:
  ...
  objc_msgSend_numberWithDouble_(MEMORY[0x189607968], v28, v29, v30, v31, self->_distance);
  v44 = (void *)objc_claimAutoreleasedReturnValue();
  v45 = (void *)MEMORY[0x189607968];
  ...
  uint64_t v62 = objc_msgSend_numberWithDouble_(MEMORY[0x189607968], v58, v59, v60, v61, self->_standardDeviation);
...
- (unint64_t)hash
{
  ...
  objc_msgSend_numberWithDouble_(MEMORY[0x189607968], v17, v18, v19, v20, self->_distance);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v26 = v16 ^ objc_msgSend_hash(v21, v22, v23, v24, v25);
  objc_msgSend_numberWithDouble_(MEMORY[0x189607968], v27, v28, v29, v30, self->_standardDeviation);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFRangingResult, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  MACAddress = self->_MACAddress;
  id v19 = a3;
  objc_msgSend_encodeObject_forKey_(v19, v5, (uint64_t)MACAddress, (uint64_t)@"_MACAddress", v6);
  objc_msgSend_encodeObject_forKey_(v19, v7, (uint64_t)self->_identifier, (uint64_t)@"_identifier", v8);
  objc_msgSend_encodeDouble_forKey_(v19, v9, (uint64_t)@"_distance", v10, v11, self->_distance);
  objc_msgSend_encodeDouble_forKey_(v19, v12, (uint64_t)@"_standardDeviation", v13, v14, self->_standardDeviation);
  objc_msgSend_encodeInteger_forKey_(v19, v15, self->_status, (uint64_t)@"_status", v16);
  objc_msgSend_encodeObject_forKey_(v19, v17, (uint64_t)self->_measurements, (uint64_t)@"_measurements", v18);
}
...
- (CWFRangingResult)initWithCoder:(id)a3
{
  id v4 = a3;
  v39.receiver = self;
  v39.super_class = (Class)&OBJC_CLASS___CWFRangingResult;
  uint64_t v5 = -[CWFRangingResult init](&v39, sel_init);
  if (v5)
  {
    uint64_t v6 = objc_opt_class();
    uint64_t v9 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, (uint64_t)@"_MACAddress", v8);
    MACAddress = v5->_MACAddress;
    v5->_MACAddress = (NSString *)v9;

    uint64_t v11 = objc_opt_class();
    uint64_t v14 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, (uint64_t)@"_identifier", v13);
    identifier = v5->_identifier;
    v5->_identifier = (NSData *)v14;

    objc_msgSend_decodeDoubleForKey_(v4, v16, (uint64_t)@"_distance", v17, v18);
    v5->_distance = v19;
    objc_msgSend_decodeDoubleForKey_(v4, v20, (uint64_t)@"_standardDeviation", v21, v22);
    v5->_standardDeviation = v23;
    v5->_int status = objc_msgSend_decodeIntegerForKey_(v4, v24, (uint64_t)@"_status", v25, v26);
    uint64_t v27 = (void *)MEMORY[0x189604010];
    uint64_t v28 = objc_opt_class();
    uint64_t v29 = objc_opt_class();
    objc_msgSend_setWithObjects_(v27, v30, v28, v31, v32, v29, 0);
    uint64_t v33 = (void *)objc_claimAutoreleasedReturnValue();
    uint64_t v36 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v34, (uint64_t)v33, (uint64_t)@"_measurements", v35);
