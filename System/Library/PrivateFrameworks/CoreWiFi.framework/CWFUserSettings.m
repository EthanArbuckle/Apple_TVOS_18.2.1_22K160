...
{
  v5 = (void *)NSString;
  __int128 v14 = *(_OWORD *)&self->_askToJoinMode;
  ...
  objc_msgSend_stringWithFormat_( v5,  v9,  (uint64_t)@"askToJoinMode=%ld, autoHotspotMode=%ld, syncMode=%ld, compatibilityMode=%ld, OSSpecificAttributes=%@",  v10,  v11,  v14,  syncMode,  compatibilityMode,  v8);
...
LABEL_13:
  ...
  if (askToJoinMode == objc_msgSend_askToJoinMode(v6, v12, v13, v14, v15)
    && (int64_t autoHotspotMode = self->_autoHotspotMode, autoHotspotMode == objc_msgSend_autoHotspotMode( v6,  v29,  v30,  v31,  v32))
    && (int64_t compatibilityMode = self->_compatibilityMode,
        compatibilityMode == objc_msgSend_compatibilityMode(v6, v34, v35, v36, v37)))
  {
    int64_t syncMode = self->_syncMode;
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v7 = (void *)objc_msgSend_allocWithZone_(CWFUserSettings, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  int64_t askToJoinMode = self->_askToJoinMode;
  id v15 = a3;
  objc_msgSend_encodeInteger_forKey_(v15, v5, askToJoinMode, (uint64_t)@"_askToJoinMode", v6);
  objc_msgSend_encodeInteger_forKey_(v15, v7, self->_autoHotspotMode, (uint64_t)@"_autoHotspotMode", v8);
  objc_msgSend_encodeInteger_forKey_(v15, v9, self->_syncMode, (uint64_t)@"_syncMode", v10);
  objc_msgSend_encodeInteger_forKey_(v15, v11, self->_compatibilityMode, (uint64_t)@"_compatibilityMode", v12);
  objc_msgSend_encodeObject_forKey_( v15,  v13,  (uint64_t)self->_OSSpecificAttributes,  (uint64_t)@"_OSSpecificAttributes",  v14);
}
...
- (CWFUserSettings)initWithCoder:(id)a3
{
  id v4 = a3;
  v34.receiver = self;
  v34.super_class = (Class)&OBJC_CLASS___CWFUserSettings;
  uint64_t v8 = -[CWFUserSettings init](&v34, sel_init);
  if (v8)
  {
    v8->_int64_t askToJoinMode = objc_msgSend_decodeIntegerForKey_(v4, v5, (uint64_t)@"_askToJoinMode", v6, v7);
    v8->_int64_t autoHotspotMode = objc_msgSend_decodeIntegerForKey_(v4, v9, (uint64_t)@"_autoHotspotMode", v10, v11);
    v8->_int64_t syncMode = objc_msgSend_decodeIntegerForKey_(v4, v12, (uint64_t)@"_syncMode", v13, v14);
    v8->_int64_t compatibilityMode = objc_msgSend_decodeIntegerForKey_(v4, v15, (uint64_t)@"_compatibilityMode", v16, v17);
    ...
    uint64_t v31 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v29, (uint64_t)v28, (uint64_t)@"_OSSpecificAttributes", v30);
