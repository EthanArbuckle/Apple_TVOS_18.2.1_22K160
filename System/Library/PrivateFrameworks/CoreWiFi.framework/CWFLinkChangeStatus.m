...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_( v3,  v7,  (uint64_t)@"link %s,  intf=%@ timestamp=%@ reason=%d sub=%ld debounce=%d rssi=%ld noise=%ld cca=%lu",  v8,  v9,  v4,  interfaceName,  v6,  self->_reason,  self->_subreason,  self->_linkDownDebounceInProgress,  self->_RSSI,  self->_noise,  self->_CCA);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFLinkChangeStatus, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  interfaceName = self->_interfaceName;
  id v5 = a3;
  objc_msgSend_encodeObject_forKey_(v5, v6, (uint64_t)interfaceName, (uint64_t)@"_interfaceName", v7);
  objc_msgSend_encodeObject_forKey_(v5, v8, (uint64_t)self->_timestamp, (uint64_t)@"_timestamp", v9);
  objc_msgSend_encodeBool_forKey_(v5, v10, self->_linkDown, (uint64_t)@"_linkDown", v11);
  objc_msgSend_encodeBool_forKey_(v5, v12, self->_involuntaryLinkDown, (uint64_t)@"_involuntaryLinkDown", v13);
  objc_msgSend_encodeInteger_forKey_(v5, v14, self->_reason, (uint64_t)@"_reason", v15);
  objc_msgSend_encodeInteger_forKey_(v5, v16, self->_subreason, (uint64_t)@"_subreason", v17);
  objc_msgSend_encodeBool_forKey_( v5,  v18,  self->_linkDownDebounceInProgress,  (uint64_t)@"_linkDownDebounceInProgress",  v19);
  objc_msgSend_encodeInteger_forKey_(v5, v20, self->_RSSI, (uint64_t)@"_RSSI", v21);
  objc_msgSend_encodeInteger_forKey_(v5, v22, self->_noise, (uint64_t)@"_noise", v23);
  objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x189607968], v24, self->_CCA, v25, v26);
  id v29 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v5, v27, (uint64_t)v29, (uint64_t)@"_CCA", v28);
}
...
- (CWFLinkChangeStatus)initWithCoder:(id)a3
{
  id v4 = a3;
  v46.receiver = self;
  v46.super_class = (Class)&OBJC_CLASS___CWFLinkChangeStatus;
  id v5 = -[CWFLinkChangeStatus init](&v46, sel_init);
  if (v5)
  {
    uint64_t v6 = objc_opt_class();
    uint64_t v9 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, (uint64_t)@"_interfaceName", v8);
    ...
    v5->_int linkDown = objc_msgSend_decodeBoolForKey_(v4, v16, (uint64_t)@"_linkDown", v17, v18);
    v5->_int involuntaryLinkDown = objc_msgSend_decodeBoolForKey_(v4, v19, (uint64_t)@"_involuntaryLinkDown", v20, v21);
    v5->_int reason = objc_msgSend_decodeIntegerForKey_(v4, v22, (uint64_t)@"_reason", v23, v24);
    v5->_subint reason = objc_msgSend_decodeIntegerForKey_(v4, v25, (uint64_t)@"_subreason", v26, v27);
    v5->_int linkDownDebounceInProgress = objc_msgSend_decodeBoolForKey_( v4,  v28,  (uint64_t)@"_linkDownDebounceInProgress",  v29,  v30);
    v5->_int64_t RSSI = objc_msgSend_decodeIntegerForKey_(v4, v31, (uint64_t)@"_RSSI", v32, v33);
    v5->_int64_t noise = objc_msgSend_decodeIntegerForKey_(v4, v34, (uint64_t)@"_noise", v35, v36);
    uint64_t v37 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v38, v37, (uint64_t)@"_CCA", v39);
