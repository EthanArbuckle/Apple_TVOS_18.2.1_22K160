...
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___CWFNearbyDeviceDiscoveryReport;
  v6 = -[CWFNearbyDeviceDiscoveryReport init](&v12, sel_init);
  if (v6)
  {
    uint64_t v7 = objc_msgSend_date(MEMORY[0x189603F50], v2, v3, v4, v5);
    v8 = (void *)*((void *)v6 + 2);
    *((void *)v6 + 2) = v7;
...
- (id)description
{
  ...
  objc_msgSend_appendFormat_(v6, v7, (uint64_t)@"timeStamp=%@, ", v8, v9, self->_timeStamp);
  objc_msgSend_appendFormat_(v6, v10, (uint64_t)@"macId=%@, ", v11, v12, self->_macId);
  if (objc_msgSend_count(self->_rssi, v13, v14, v15, v16))
  {
    ...
    do
    {
      ...
      objc_msgSend_appendFormat_(v6, v22, (uint64_t)@"rssi%d = %@, ", v23, v24, v20, v21);
  ...
  objc_msgSend_appendFormat_(v6, v17, (uint64_t)@"frameType=%ld, ", v18, v19, self->_frameType);
  objc_msgSend_appendFormat_(v6, v29, (uint64_t)@"bandwidth=%ld, ", v30, v31, self->_bandwidth);
  objc_msgSend_appendFormat_(v6, v32, (uint64_t)@"channel=%ld, ", v33, v34, self->_channel);
  objc_msgSend_appendFormat_(v6, v35, (uint64_t)@"band=%ld, ", v36, v37, self->_band);
  objc_msgSend_appendFormat_(v6, v38, (uint64_t)@"rateMbps=%ld, ", v39, v40, self->_rateMbps);
  objc_msgSend_appendFormat_(v6, v41, (uint64_t)@"isLowConfidence=%d, ", v42, v43, self->_isLowConfidence);
  return v6;
}
...
- (unint64_t)hash
{
  ...
  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v17, self->_frameType, v18, v19);
  uint64_t v20 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v25 = v16 ^ objc_msgSend_hash(v20, v21, v22, v23, v24);
  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v26, self->_bandwidth, v27, v28);
  uint64_t v29 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v34 = objc_msgSend_hash(v29, v30, v31, v32, v33);
  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v35, self->_channel, v36, v37);
  v38 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v43 = v25 ^ v34 ^ objc_msgSend_hash(v38, v39, v40, v41, v42);
  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v44, self->_band, v45, v46);
  uint64_t v47 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v52 = objc_msgSend_hash(v47, v48, v49, v50, v51);
  objc_msgSend_numberWithInteger_(MEMORY[0x189607968], v53, self->_rateMbps, v54, v55);
  uint64_t v56 = (void *)objc_claimAutoreleasedReturnValue();
  uint64_t v61 = v52 ^ objc_msgSend_hash(v56, v57, v58, v59, v60);
  objc_msgSend_numberWithBool_(MEMORY[0x189607968], v62, self->_isLowConfidence, v63, v64);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFNearbyDeviceDiscoveryReport, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  timeStamp = self->_timeStamp;
  id v23 = a3;
  objc_msgSend_encodeObject_forKey_(v23, v5, (uint64_t)timeStamp, (uint64_t)@"_timeStamp", v6);
  objc_msgSend_encodeObject_forKey_(v23, v7, (uint64_t)self->_macId, (uint64_t)@"_macId", v8);
  objc_msgSend_encodeObject_forKey_(v23, v9, (uint64_t)self->_rssi, (uint64_t)@"_rssi", v10);
  objc_msgSend_encodeInteger_forKey_(v23, v11, self->_frameType, (uint64_t)@"_frameType", v12);
  objc_msgSend_encodeInteger_forKey_(v23, v13, self->_bandwidth, (uint64_t)@"_bandwidth", v14);
  objc_msgSend_encodeInteger_forKey_(v23, v15, self->_channel, (uint64_t)@"_channel", v16);
  objc_msgSend_encodeInteger_forKey_(v23, v17, self->_band, (uint64_t)@"_band", v18);
  objc_msgSend_encodeInteger_forKey_(v23, v19, self->_rateMbps, (uint64_t)@"_rateMbps", v20);
  objc_msgSend_encodeBool_forKey_(v23, v21, self->_isLowConfidence, (uint64_t)@"_isLowConfidence", v22);
}
...
- (CWFNearbyDeviceDiscoveryReport)initWithCoder:(id)a3
{
  id v4 = a3;
  v56.receiver = self;
  v56.super_class = (Class)&OBJC_CLASS___CWFNearbyDeviceDiscoveryReport;
  id v5 = -[CWFNearbyDeviceDiscoveryReport init](&v56, sel_init);
  if (v5)
  {
    ...
    uint64_t v14 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v12, (uint64_t)v11, (uint64_t)@"_timeStamp", v13);
    ...
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    uint64_t v24 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v22, (uint64_t)v21, (uint64_t)@"_macId", v23);
    macId = v5->_macId;
    ...
    uint64_t v35 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v33, (uint64_t)v32, (uint64_t)@"_rssi", v34);
    rssi = v5->_rssi;
    v5->_rssi = (NSArray *)v35;

    v5->_int64_t frameType = objc_msgSend_decodeIntegerForKey_(v4, v37, (uint64_t)@"_frameType", v38, v39);
    v5->_int64_t bandwidth = objc_msgSend_decodeIntegerForKey_(v4, v40, (uint64_t)@"_bandwidth", v41, v42);
    v5->_int64_t channel = objc_msgSend_decodeIntegerForKey_(v4, v43, (uint64_t)@"_channel", v44, v45);
    v5->_int64_t band = objc_msgSend_decodeIntegerForKey_(v4, v46, (uint64_t)@"_band", v47, v48);
    v5->_int64_t rateMbps = objc_msgSend_decodeIntegerForKey_(v4, v49, (uint64_t)@"_rateMbps", v50, v51);
    v5->_int isLowConfidence = objc_msgSend_decodeIntegerForKey_(v4, v52, (uint64_t)@"_isLowConfidence", v53, v54) != 0;
  }
