...
+ (id)AWDLPeerContextWithMACAddress:(id)a3 interfaceName:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  v7 = objc_alloc_init(&OBJC_CLASS___CWFAWDLPeerContext);
...
- (id)description
{
  return (id)objc_msgSend_stringWithFormat_( NSString,  a2,  (uint64_t)@"MACAddress=%@, interfaceName=%@",  v2,  v3,  self->_MACAddress,  self->_interfaceName);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFAWDLPeerContext, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  MACAddress = self->_MACAddress;
  id v9 = a3;
  objc_msgSend_encodeObject_forKey_(v9, v5, (uint64_t)MACAddress, (uint64_t)@"_MACAddress", v6);
...
- (CWFAWDLPeerContext)initWithCoder:(id)a3
{
  id v4 = a3;
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___CWFAWDLPeerContext;
  id v5 = -[CWFAWDLPeerContext init](&v17, sel_init);
  if (v5)
  {
