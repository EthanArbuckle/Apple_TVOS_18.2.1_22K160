...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___CWFActivity;
...
{
  id v5 = a4;
  v6 = objc_alloc_init(&OBJC_CLASS___CWFActivity);
...
+ (id)activityWithType:(int64_t)a3 reason:(id)a4 UUID:(id)a5
{
  id v7 = a5;
  id v8 = a4;
  uint64_t v9 = objc_alloc_init(&OBJC_CLASS___CWFActivity);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_( v5,  v14,  (uint64_t)@"type=%ld reason=%@ timeout=%lluns uuid=%@",  v15,  v16,  type,  reason,  timeout,  v13);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = (void *)objc_msgSend_allocWithZone_(CWFActivity, a2, (uint64_t)a3, v3, v4);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v5, v8, (uint64_t)self->_reason, (uint64_t)@"_reason", v9);
  objc_msgSend_encodeInteger_forKey_(v5, v10, self->_type, (uint64_t)@"_type", v11);
  objc_msgSend_numberWithUnsignedLongLong_(MEMORY[0x189607968], v12, self->_timeout, v13, v14);
  id v17 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v5, v15, (uint64_t)v17, (uint64_t)@"_timeout", v16);
}
...
- (CWFActivity)initWithCoder:(id)a3
{
  id v4 = a3;
  v28.receiver = self;
  v28.super_class = (Class)&OBJC_CLASS___CWFActivity;
  id v5 = -[CWFActivity init](&v28, sel_init);
  if (v5)
  {
    ...
    uint64_t v14 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, (uint64_t)@"_reason", v13);
    reason = v5->_reason;
    v5->_reason = (NSString *)v14;

    v5->_int64_t type = objc_msgSend_decodeIntegerForKey_(v4, v16, (uint64_t)@"_type", v17, v18);
    uint64_t v19 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v20, v19, (uint64_t)@"_timeout", v21);
