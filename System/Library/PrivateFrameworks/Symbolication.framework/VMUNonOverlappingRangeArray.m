...
LABEL_5:
    v12.receiver = self;
    v12.super_class = (Class)&OBJC_CLASS___VMUNonOverlappingRangeArray;
...
- (void)sortAndMergeRanges
{
  ...
  {
    v6.receiver = self;
    v6.super_class = (Class)&OBJC_CLASS___VMUNonOverlappingRangeArray;
  ...
  self->super._max = 8;
  self->super._ranges = (_VMURange *)malloc(0x80uLL);
  if ((_DWORD)count)
  {
...
- (void)mergeRanges:(id)a3
{
  ...
  if (v3)
  {
    ...
    {
      uint64_t v7 = v6;
      unsigned int v8 = (void *)(*((void *)a3 + 2) + 16LL * v6);
...
- (void)mergeRange:(_VMURange)a3 excludingRanges:(id)a4
{
  uint64_t v5 = [a4 subrangeNotExcludedBySelfForRange:a3.location, a3.length];
  if (v6) {
...
- (void)mergeRanges:(id)a3 excludingRanges:(id)a4
{
  ...
  if (v4)
  {
    ...
    {
      uint64_t v9 = v8;
      unint64_t v10 = (void *)(*((void *)a3 + 2) + 16LL * v8);
...
- (id)subtract:(id)a3 mergeRanges:(BOOL)a4
{
  ...
  if (self->super._count)
  {
    ...
    {
      ++v9;
      [v7 _mergeAllBitsOfRange:self->super._ranges[v8].location, self->super._ranges[v8].length, v6, v4];
      ++v8;
    }
