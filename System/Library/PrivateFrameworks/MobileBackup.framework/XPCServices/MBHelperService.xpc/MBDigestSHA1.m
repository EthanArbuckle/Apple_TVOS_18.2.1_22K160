...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___MBDigestSHA1;
  v2 = -[MBDigestSHA1 init](&v5, "init");
  v3 = v2;
  if (v2) {
...
- (id)final
{
  return +[NSData dataWithBytes:length:](&OBJC_CLASS___NSData, "dataWithBytes:length:", v3, 20LL);
}
