...
LABEL_25:
  ...
  if (!a3)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 136315906;
      ...
      __int16 v42 = 1024;
      int v43 = a5;
      _os_log_error_impl( &dword_186C92000,  v23,  OS_LOG_TYPE_ERROR,  "%s: inlining 0-length source info %s:%d,%d",  buf,  0x22u);
    }
  ...
  if (!v11)
  {
    uint64_t v12 = [objc_alloc(MEMORY[0x189603FA8]) initWithCapacity:1];
    id v13 = v10[4];
    v10[4] = (id)v12;
  ...
  if (v14)
  {
    ...
    while (1)
    {
      [v10[4] objectAtIndexedSubscript:v16];
...
- (id)addNonInlineSourceInfoWithOffsetIntoSegment:(uint64_t)a3 length:(int)a4 lineNum:(int)a5 columnNum:(void *)a6 filePath:
{
  ...
  if (!v13)
  {
    uint64_t v14 = [objc_alloc(MEMORY[0x189603FA8]) initWithCapacity:1];
    id v15 = v12[4];
    v12[4] = (id)v14;
  ...
  int v17 = a5;
  [v12[4] objectAtIndexedSubscript:v16];
  v18 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (a3 + a2 > [v18 offsetIntoSegment])
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&v40[2] = a2;
        ...
        uint64_t v44 = v32;
        v33 = (void *)v32;
        _os_log_error_impl( &dword_186C92000,  v21,  OS_LOG_TYPE_ERROR,  "new source info %@:%d,%d (0x%llx-0x%llx) overlaps existing %@",  buf,  0x36u);
      }
...
LABEL_11:
    if (v16)
    {
      int v34 = a4;
      int v22 = a5;
      [v12[4] objectAtIndexedSubscript:v16 - 1];
      ...
      if ([v23 length] + v24 > a2)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)&v40[6] = v22;
          ...
          __int16 v43 = 2048;
          uint64_t v44 = a3 + a2;
          _os_log_error_impl( &dword_186C92000,  v26,  OS_LOG_TYPE_ERROR,  "existing source info %@ overlaps new %@:%d,%d (0x%llx-0x%llx)",  buf,  0x36u);
        }
    ...
    v18 = +[SASourceInfo sourceInfoWithOffsetIntoSegment:length:lineNum:columnNum:filePath:]( (uint64_t)&OBJC_CLASS___SASourceInfo,  a2,  a3,  a4,  a5,  v11);
...
- (id)debugDescription
{
  ...
  return (id)[v3 initWithFormat:@"%@ (0x%llx-0x%llx, %lu source infos)", name, self->_offsetIntoSegment, self->_length + self->_offsetIntoSegment, -[NSMutableArray count](self->_sourceInfos, "count")];
}
