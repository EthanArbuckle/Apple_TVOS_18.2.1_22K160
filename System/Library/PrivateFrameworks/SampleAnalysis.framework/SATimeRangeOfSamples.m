...
- (SATimeRangeOfSamples)initWithStartTime:(id)a3 endTime:(id)a4 startSampleIndex:(unint64_t)a5 endSampleIndex:(unint64_t)a6
{
  ...
  id v12 = a4;
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___SATimeRangeOfSamples;
...
- (id)debugDescription
{
  ...
  v6 = -[SATimestamp debugDescription](self->_startTime, "debugDescription");
  v7 = -[SATimestamp debugDescription](self->_endTime, "debugDescription");
