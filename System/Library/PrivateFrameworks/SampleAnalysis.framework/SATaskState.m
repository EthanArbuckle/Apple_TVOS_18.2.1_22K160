...
- (id)debugDescriptionWithTask:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4 == v5)
    {
      ...
      v12 = (void *)[v6 initWithFormat:@"%@ @ sample index %lu\n%@", v7, v8, v10];
    }
    ...
    else
    {
      ...
      v12 = (void *)[v6 initWithFormat:@"%@ @ sample indexes %lu-%lu\nstart:%@\n  end:%@", v7, v8, v9, v10, v11];
    }
  }
...
LABEL_27:
    ...
    {
      unint64_t v25 = *((void *)v8 + 6);
      *(_DWORD *)buf = 134217984;
      unint64_t v33 = v25;
      _os_log_error_impl(&dword_186C92000, v24, OS_LOG_TYPE_ERROR, "_startSampleIndex %lu, end NSNotFound", buf, 0xCu);
    }

    *__error() = v23;
    _SASetCrashLogMessage( 2390,  "_startSampleIndex %lu, end NSNotFound",  v26,  v27,  v28,  v29,  v30,  v31,  *((void *)v8 + 6));
    _os_crash();
    __break(1u);
  }
...
- (BOOL)wqExceededConstrainedThreadLimit
{
  return (~LODWORD(self->_ssFlags) & 0xA0000LL) == 0;
}

- (BOOL)wqExceededTotalThreadLimit
{
  return (~LODWORD(self->_ssFlags) & 0xC0000LL) == 0;
}
...
+ (id)stateWithKCDataTask:(void *)a3 terminatedThreadsInstructionCycles:(uint64_t)a4 machTimebase:(void *)a5 donatingUniquePids:(void *)a6 startTimestamp:(void *)a7 endTimestamp:(uint64_t)a8 startSampleIndex:(uint64_t)a9 endSampleIndex:
{
  ...
  id v16 = a5;
  objc_opt_self();
  uint64_t v17 = objc_alloc(&OBJC_CLASS___SATaskState);
  id v18 = v16;
  if (v17)
  {
    uint64_t v19 = -[SATaskState initWithStartTimestamp:endTimestamp:startSampleIndex:endSampleIndex:]( v17,  "initWithStartTimestamp:endTimestamp:startSampleIndex:endSampleIndex:",  v15,  v14,  a8,  a9);
    uint64_t v20 = v19;
    if (v19)
    {
...
+ (SATaskStateInTransition)stateWithKCDataTransitioningTask:(uint64_t)a3 terminatedThreadsInstructionCycles:(uint64_t)a4 machTimebase:(void *)a5 donatingUniquePids:(void *)a6 startTimestamp:(void *)a7 endTimestamp:(uint64_t)a8 startSampleIndex:(uint64_t)a9 endSampleIndex:
{
  ...
  id v17 = a5;
  objc_opt_self();
  id v18 = -[SATaskStateInTransition initWithKCDataTransitioningTask:andTerminatedThreadsInstructionCycles:machTimebase:andDonatingUniquePids:startTimestamp:endTimestamp:startSampleIndex:endSampleIndex:]( objc_alloc(&OBJC_CLASS___SATaskStateInTransition),  "initWithKCDataTransitioningTask:andTerminatedThreadsInstructionCycles:machTimebase:andDonatingUniquePids:start Timestamp:endTimestamp:startSampleIndex:endSampleIndex:",  a2,  a3,  a4,  v17,  v16,  v15,  a8,  a9);
...
+ (void)stateWithStackshotTaskV1:(uint64_t)a3 machTimebase:(unsigned int)a4 hwPageSize:(void *)a5 startTimestamp:(void *)a6 endTimestamp:(uint64_t)a7 startSampleIndex:(uint64_t)a8 endSampleIndex:
{
  ...
  id v15 = a5;
  objc_opt_self();
  id v16 = objc_alloc(&OBJC_CLASS___SATaskState);
  if (v16)
  {
    uint64_t v17 = -[SATaskState initWithStartTimestamp:endTimestamp:startSampleIndex:endSampleIndex:]( v16,  "initWithStartTimestamp:endTimestamp:startSampleIndex:endSampleIndex:",  v15,  v14,  a7,  a8);
    id v18 = (void *)v17;
    if (v17)
    {
...
- (SATaskState)initWithStartTimestamp:(id)a3 endTimestamp:(id)a4 startSampleIndex:(unint64_t)a5 endSampleIndex:(unint64_t)a6
{
  ...
  id v12 = a4;
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___SATaskState;
  uint64_t v13 = -[SATaskState init](&v16, sel_init);
  id v14 = v13;
  if (v13)
  {
    objc_storeStrong((id *)&v13->_startTimestamp, a3);
    objc_storeStrong((id *)&v14->_endTimestamp, a4);
    v14->_unint64_t startSampleIndex = a5;
    v14->_unint64_t endSampleIndex = a6;
  }
...
- (BOOL)addSelfToBuffer:(id *)a3 bufferLength:(unint64_t)a4 withCompletedSerializationDictionary:(id)a5
{
  ...
  if (-[SATaskState sizeInBytesForSerializedVersion](self, "sizeInBytesForSerializedVersion") != a4)
  {
    ...
    {
      id v19 = -[SATaskState debugDescription](self, "debugDescription");
      *(_DWORD *)buf = 136315650;
      uint64_t v72 = [v19 UTF8String];
      __int16 v73 = 2048;
      *(void *)v74 = -[SATaskState sizeInBytesForSerializedVersion](self, "sizeInBytesForSerializedVersion");
      *(_WORD *)&v74[8] = 2048;
      *(void *)&v74[10] = a4;
    ...
    *__error() = v5;
    id v20 = -[SATaskState debugDescription](self, "debugDescription");
...
LABEL_18:
    ...
    {
      id v30 = -[SATaskState debugDescription](self, "debugDescription");
      uint64_t v31 = [v30 UTF8String];
      NSUInteger v32 = -[NSSet count](self->_donatingUniquePids, "count");
      *(_DWORD *)buf = 136315394;
      uint64_t v72 = v31;
      __int16 v73 = 2048;
      *(void *)v74 = v32;
      _os_log_error_impl(&dword_186C92000, v29, OS_LOG_TYPE_ERROR, "%s: %lu donatingUniquePids", buf, 0x16u);
    }

    *__error() = v28;
    id v33 = -[SATaskState debugDescription](self, "debugDescription");
  ...
  uint64_t v12 = -[NSSet countByEnumeratingWithState:objects:count:]( v11,  "countByEnumeratingWithState:objects:count:",  &v67,  v75,  16LL);
  if (v12)
  {
    uint64_t v13 = v12;
    LOBYTE(v5) = 0;
    ...
    do
    {
      ...
      uint64_t v13 = -[NSSet countByEnumeratingWithState:objects:count:]( v11,  "countByEnumeratingWithState:objects:count:",  &v67,  v75,  16LL);
    }
...
LABEL_21:
    ...
    {
      id v43 = -[SATaskState debugDescription](self, "debugDescription");
      uint64_t v44 = [v43 UTF8String];
      NSUInteger v45 = -[NSSet count](self->_donatingUniquePids, "count");
      uint64_t v5 = v5;
      *(_DWORD *)buf = 136315650;
      uint64_t v72 = v44;
      __int16 v73 = 2048;
      ...
      *(_WORD *)&v74[8] = 1024;
      *(_DWORD *)&v74[10] = v5;
      _os_log_error_impl( &dword_186C92000,  v42,  OS_LOG_TYPE_ERROR,  "%s: %lu donatingUniquePids, but %u serialized",  buf,  0x1Cu);
    }
    ...
    *__error() = v41;
    ...
    a3 = ($2089E77EEE4A1EB652AD555C69D4CCDC *) objc_claimAutoreleasedReturnValue();
    char v46 = -[$2089E77EEE4A1EB652AD555C69D4CCDC UTF8String](a3, "UTF8String");
    -[NSSet count](self->_donatingUniquePids, "count");
...
LABEL_24:
    ...
    {
      id v55 = -[SATaskState debugDescription](self, "debugDescription");
      uint64_t v56 = [v55 UTF8String];
      int v57 = BYTE6(a3->var14);
      unint64_t v58 = -[SATaskState sizeInBytesForSerializedVersion](self, "sizeInBytesForSerializedVersion");
      ...
      *(_WORD *)&v74[14] = 2048;
      *(void *)&v74[16] = v58;
      _os_log_error_impl( &dword_186C92000,  v54,  OS_LOG_TYPE_ERROR,  "%s: after serializing (with %u donating uniquepids), ended with length %ld, should be %lu",  buf,  0x26u);
    }

    *__error() = v53;
    id v59 = -[SATaskState debugDescription](self, "debugDescription");
  ...
  *(void *)objc_super v16 = -[SATaskState transitionType](self, "transitionType");
  ...
  if (a4 <= 0x66)
  {
    ...
    if (os_log_type_enabled((os_log_t)v5, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 134218240;
      ...
      __int16 v51 = 2048;
      uint64_t v52 = 103LL;
      _os_log_error_impl( &dword_186C92000,  (os_log_t)v5,  OS_LOG_TYPE_ERROR,  "bufferLength %lu < serialized SATaskState struct %lu",  buf,  0x16u);
    }
...
LABEL_25:
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 134218240;
      ...
      __int16 v51 = 1024;
      LODWORD(v52) = v32;
      _os_log_error_impl( &dword_186C92000,  v31,  OS_LOG_TYPE_ERROR,  "bufferLength %lu < serialized SATask struct with %u donatingUniquePids",  buf,  0x12u);
    }
...
LABEL_28:
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 134218240;
      ...
      __int16 v51 = 1024;
      LODWORD(v52) = v41;
      _os_log_error_impl( &dword_186C92000,  v40,  OS_LOG_TYPE_ERROR,  "bufferLength %lu < serialized SATaskState struct v2 with %u donating unique pids",  buf,  0x12u);
    }
    ...
    *__error() = v39;
    ...
    __break(1u);
LABEL_31:
    +[SAException exceptionWithName:reason:userInfo:]( &OBJC_CLASS___SAException,  "exceptionWithName:reason:userInfo:",  @"Decoding failure",  @"Unknown SATaskState version",  0LL);
...
LABEL_9:
    int v9 = 0;
    id v10 = off_189F60568;
    goto LABEL_10;
  }

  int v9 = 1;
  id v10 = off_189F60570;
LABEL_10:
  ...
  *((_DWORD *)v11 + 6) = *(_DWORD *)(v5 + 58);
  ...
  v11[12] = *(void *)(v5 + 86);
  v11[14] = *(void *)(v5 + 95);
  uint64_t v17 = (void *)[objc_alloc(MEMORY[0x189603FE0]) initWithCapacity:*(unsigned __int8 *)(v5 + 94)];
  if (*(_BYTE *)(v5 + 94))
  {
    unint64_t v18 = 0LL;
    do
    {
      [MEMORY[0x189607968] numberWithUnsignedLongLong:*(void *)&v7[8 * v18]];
  ...
  if (a4 <= 0x66)
  {
    ...
    if (os_log_type_enabled((os_log_t)a3, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 134218240;
      ...
      __int16 v40 = 2048;
      uint64_t v41 = 103LL;
      _os_log_error_impl( &dword_186C92000,  (os_log_t)a3,  OS_LOG_TYPE_ERROR,  "bufferLength %lu < serialized SATaskState struct %lu",  buf,  0x16u);
    }
...
LABEL_8:
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 134218240;
      ...
      __int16 v40 = 1024;
      LODWORD(v41) = v29;
      _os_log_error_impl( &dword_186C92000,  v28,  OS_LOG_TYPE_ERROR,  "bufferLength %lu < serialized SATask struct with %u donatingUniquePids",  buf,  0x12u);
    }
...
+ (SATaskState)stateWithPAStyleTaskPrivateData:(void *)a3 donatingUniquePids:
{
  ...
  id v5 = a2;
  objc_opt_self();
  uint64_t v6 = objc_alloc_init(&OBJC_CLASS___SATaskState);
  v7 = v6;
  if (v5)
  {
  ...
  {
    unint64_t v8 = 0LL;
    *(void *)&v6->_suspendCount = 0LL;
    *(void *)&v6->_pageins = 0LL;
    v6->_latencyQos = 0;
    *(_OWORD *)&v6->_taskSizeInBytes = 0u;
    *(_OWORD *)&v6->_terminatedThreadsSystemTimeInNs = 0u;
    v6->_terminatedThreadsCycles = 0LL;
  }
