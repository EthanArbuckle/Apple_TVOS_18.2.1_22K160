...
- (void)setOrderTasksBySampleCount:(BOOL)a3
{
  ...
  {
    if (v6 != 11) {
      -[NSMutableArray insertObject:atIndex:]( self->_processSortAttributes,  "insertObject:atIndex:",  &unk_189F82430,  0LL);
    }
  }
  ...
  else if (v6 == 11)
  {
    do
    {
      -[NSMutableArray removeObjectAtIndex:](self->_processSortAttributes, "removeObjectAtIndex:", 0LL);
      v7 = -[NSMutableArray firstObject](self->_processSortAttributes, "firstObject");
...
- (void)setDisplayAllHIDEvents:(BOOL)a3
{
  ...
  unint64_t v4 = hidEventDisplayOptions & 0xFFFFFFFFFFFFFFE7LL | 8;
...
- (BOOL)aggregateStacksByThread
{
  if (self)
  {
    ...
    {
      unint64_t callTreeAggregation = 3LL;
      if (!self->_microstackshotsFormat) {
        unint64_t callTreeAggregation = 1LL;
      }
    }
  }
  ...
  {
    unint64_t callTreeAggregation = 0LL;
  }
...
- (BOOL)aggregateProcessesByExecutable
{
  if (self)
  {
    ...
    if (!taskAggregation)
    {
      unint64_t taskAggregation = 1LL;
      if (self->_microstackshotsFormat) {
        unint64_t taskAggregation = 2LL;
      }
    }
  }
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___SASamplePrintOptions;
...
- (BOOL)verbose
{
  if (self->_displayKernelFrames
    ...
    && self->_callTreeTimestampsTimeDomain == -1LL
    && (~LODWORD(self->_hidEventDisplayOptions) & 0x12LL) == 0)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v8 = (void *)-[NSSet copy](self->_pidsToPrint, "copy");
  [v4 setPidsToPrint:v8];

  objc_super v9 = (void *)-[NSSet copy](self->_uniquePidsToPrint, "copy");
...
- (void)setOmitTasksBelowPercentOfTotalSamples:(char)a3
{
  ...
  if (a3 >= 0x65)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 67109120;
      int v13 = v3;
      _os_log_error_impl(&dword_186C92000, v5, OS_LOG_TYPE_ERROR, "omitTasksBelowPercentOfTotalSamples %d", buf, 8u);
    }
...
- (void)setOmitStacksBelowPercentOfTaskSamples:(char)a3
{
  ...
  if (a3 >= 0x65)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 67109120;
      int v13 = v3;
      _os_log_error_impl(&dword_186C92000, v5, OS_LOG_TYPE_ERROR, "omitStacksBelowPercentOfTaskSamples %d", buf, 8u);
    }
...
- (void)setOmitFramesBelowPercentOfStackSamples:(char)a3
{
  ...
  if (a3 >= 0x65)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 67109120;
      int v13 = v3;
      _os_log_error_impl(&dword_186C92000, v5, OS_LOG_TYPE_ERROR, "omitFramesBelowPercentOfStackSamples %d", buf, 8u);
    }
...
- (void)setSystemstatsFormat:(BOOL)a3
{
  if (a3)
  {
    -[SASamplePrintOptions setMicrostackshotsFormat:](self, "setMicrostackshotsFormat:", 1LL);
...
- (NSSet)processUUIDsToPrint
{
  return (NSSet *)objc_getProperty(self, a2, 112LL, 1);
}
