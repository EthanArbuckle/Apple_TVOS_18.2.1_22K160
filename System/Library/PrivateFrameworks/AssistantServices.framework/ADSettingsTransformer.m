...
{
  id v6 = a4;
  id v7 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(a3, "_ad_settingsRequestRepresentation"));
...
- (id)aceCommandForSiriResponse:(id)a3 responseError:(id)a4 forRequestCommand:(id)a5
{
  if (a4) {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(a5, "_ad_aceSettingsResponseCommandRepresentationForSiriResponse:", a3));
  }
  return v5;
}
