...
- (void)handleSiriRequest:(id)a3 deliveryHandler:(id)a4 completionHandler:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "_ad_preheatableServiceDomainForDomainSignalRequest"));
  ...
  if (v10)
  {
    v12 = (void *)objc_claimAutoreleasedReturnValue(+[ADCommandCenter sharedCommandCenter](&OBJC_CLASS___ADCommandCenter, "sharedCommandCenter"));
