...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS____ADPBDeviceStringKeyValuePair;
  id v3 = -[_ADPBDeviceStringKeyValuePair description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[_ADPBDeviceStringKeyValuePair dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_1003382C4((uint64_t)self, (uint64_t)a3);
}
