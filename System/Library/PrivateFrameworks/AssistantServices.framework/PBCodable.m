...
- (void)_ad_performWithPeerStreamConnection:(id)a3 context:(id)a4
{
  v4 = (os_log_s *)AFSiriLogContextIDS;
...
- (void)_ad_performWithCloudService:(id)a3 fromPeer:(id)a4 completion:(id)a5
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue( +[ADPeerCloudService _unexpectedMessageError]( &OBJC_CLASS___ADPeerCloudService,  "_unexpectedMessageError"));
  v5[2](v5, 0LL, 0xFFFFLL, v7);
}
