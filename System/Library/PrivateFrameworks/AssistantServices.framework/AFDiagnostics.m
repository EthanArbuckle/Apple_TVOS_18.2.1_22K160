...
- (void)flush
{
  ...
  dispatch_sync(v2, &stru_1004F6628);
}
...
+ (id)sharedDiagnostics
{
  if (qword_100578160 != -1) {
    dispatch_once(&qword_100578160, &stru_1004F6608);
  }
  return (id)qword_100578158;
}
