...
- (MCMContainerSchemaActionUnlink)initWithPathArgument:(id)a3 context:(id)a4
{
  ...
  id v6 = a3;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___MCMContainerSchemaActionUnlink;
...
- (BOOL)performWithError:(id *)a3
{
  ...
  url = self->_url;
  v11[0] = 0LL;
  BOOL v5 = -[MCMContainerSchemaActionBase fixAndRetryIfPermissionsErrorWithURL:error:duringBlock:]( self,  "fixAndRetryIfPermissionsErrorWithURL:error:duringBlock:",  url,  v11,  &__block_literal_global_2311);
  id v6 = v11[0];
  [v6 domain];
