...
{
  id v5 = a3;
  v6 = -[ICCollaborationJoinResponseParserDelegate init](self, "init");
  v7 = v6;
  if (v6) {
...
- (void)parser:(id)a3 didParseDataCode:(unsigned int)a4 bytes:(char *)a5 contentLength:(unsigned int)a6
{
  ...
  {
    id v10 = v9;
    -[ICCollaborationJoinResponse setUpdateRequired:](self->_joinResponse, "setUpdateRequired:", *a5 != 0);
    goto LABEL_6;
  }
  ...
  {
    id v10 = v9;
    -[ICCollaborationJoinResponse setCollaborationCloudLibraryID:]( self->_joinResponse,  "setCollaborationCloudLibraryID:",  bswap32(*(_DWORD *)a5));
LABEL_6:
    id v9 = v10;
  }
}
