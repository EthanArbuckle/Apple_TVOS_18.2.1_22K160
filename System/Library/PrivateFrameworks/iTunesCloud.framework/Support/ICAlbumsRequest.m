...
- (ICAlbumsRequest)initWithDatabaseID:(unsigned int)a3 paginationToken:(id)a4
{
  v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"databases/%u/groups?groupType=albums",  a4,  *(void *)&a3));
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___ICAlbumsRequest;
