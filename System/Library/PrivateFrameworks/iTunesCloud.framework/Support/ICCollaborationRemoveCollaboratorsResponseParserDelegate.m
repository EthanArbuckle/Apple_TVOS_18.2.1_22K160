...
{
  id v5 = a3;
  v6 = -[ICCollaborationRemoveCollaboratorsResponseParserDelegate init](self, "init");
  v7 = v6;
  if (v6) {
...
{
  if (a4 == 1836413042) {
    -[ICCollaborationRemoveCollaboratorsResponse setUpdateRequired:]( self->_removeResponse,  "setUpdateRequired:",  *a5 != 0);
  }
}
