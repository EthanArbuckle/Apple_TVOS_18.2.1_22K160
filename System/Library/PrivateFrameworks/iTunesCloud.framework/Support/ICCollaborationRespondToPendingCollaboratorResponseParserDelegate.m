...
{
  id v5 = a3;
  v6 = -[ICCollaborationRespondToPendingCollaboratorResponseParserDelegate init](self, "init");
  v7 = v6;
  if (v6) {
...
{
  if (a4 == 1836413042) {
    -[ICCollaborationRespondToPendingCollaboratorResponse setUpdateRequired:]( self->_collaborationResponse,  "setUpdateRequired:",  *a5 != 0);
  }
}
