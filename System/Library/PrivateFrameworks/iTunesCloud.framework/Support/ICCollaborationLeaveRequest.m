...
- (ICCollaborationLeaveRequest)initWithDatabaseID:(unsigned int)a3 globalPlaylistID:(id)a4
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ICCollaborationLeaveRequest;
  ...
  if (v9)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[ICCollaborationLeaveRequest _requestBody](v9, "_requestBody"));
...
- (id)canonicalResponseForResponse:(id)a3
{
  v3 = (void *)objc_claimAutoreleasedReturnValue( +[ICDResponse responseWithResponse:]( &OBJC_CLASS___ICCollaborationLeaveResponse,  "responseWithResponse:",  a3));
  ...
  if ([v4 length])
  {
    ...
    id v7 = -[ICCollaborationLeaveResponseParserDelegate initWithResponse:]( objc_alloc(&OBJC_CLASS___ICCollaborationLeaveResponseParserDelegate),  "initWithResponse:",  v3);
    [v6 setDelegate:v7];
    [v6 parse];
  }
