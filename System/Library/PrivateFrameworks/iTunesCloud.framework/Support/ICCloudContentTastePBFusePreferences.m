...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___ICCloudContentTastePBFusePreferences;
  id v3 = -[ICCloudContentTastePBFusePreferences description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[ICCloudContentTastePBFusePreferences dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = -[NSMutableArray initWithCapacity:]( objc_alloc(&OBJC_CLASS___NSMutableArray),  "initWithCapacity:",  -[NSMutableArray count](self->_preferences, "count"));
    __int128 v12 = 0u;
    __int128 v13 = 0u;
    __int128 v14 = 0u;
    __int128 v15 = 0u;
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      __int128 v13 = objc_alloc_init(&OBJC_CLASS___ICCloudContentTastePBFuseItemPreference);
      sub_1001140DC((uint64_t)self, v13);
      if (!PBReaderPlaceMark(a3, v16) || (sub_10006DF00((uint64_t)v13, (uint64_t)a3) & 1) == 0)
      {
