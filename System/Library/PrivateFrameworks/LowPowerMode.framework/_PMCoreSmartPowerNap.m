...
{
  v40.receiver = self;
  v40.super_class = (Class)&OBJC_CLASS____PMCoreSmartPowerNap;
  ...
  uint64_t v5 = [objc_alloc(MEMORY[0x189607B30]) initWithMachServiceName:@"com.apple.powerd.coresmartpowernap" options:4096];
  connection = v2->_connection;
  v2->_connection = (NSXPCConnection *)v5;

  [MEMORY[0x189607B48] interfaceWithProtocol:&unk_18C6F6C70];
  ...
  [MEMORY[0x189607B48] interfaceWithProtocol:&unk_18C6F6CD0];
  ...
  uint64_t v12 = coresmartpowernap_log;
...
LABEL_7:
  ...
  uint64_t v16 = notify_register_dispatch("com.apple.system.powermanagement.assertionresync", &init_resync_token_0, v14, handler);

  if ((_DWORD)v16)
  {
    v17 = (os_log_s *)coresmartpowernap_log;
    if (coresmartpowernap_log)
    {
...
- (void)registerWithIdentifier:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = (os_log_s *)coresmartpowernap_log;
  if (v4)
  {
    if (coresmartpowernap_log)
    {
...
LABEL_9:
    ...
    v14 = -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &__block_literal_global_1,  *(_OWORD *)v15);
...
- (void)unregister
{
  ...
  {
    v2 = (os_log_s *)coresmartpowernap_log;
    if (coresmartpowernap_log)
    {
      if (os_log_type_enabled((os_log_t)coresmartpowernap_log, OS_LOG_TYPE_ERROR)) {
    ...
    uint64_t v18 = (os_log_s *)coresmartpowernap_log;
    if (os_log_type_enabled((os_log_t)coresmartpowernap_log, OS_LOG_TYPE_FAULT)) {
...
- (void)setState:(unsigned __int8)a3
{
  ...
  if (coresmartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)coresmartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      uint64_t v6 = (os_log_s *)v5;
LABEL_6:
      _os_log_impl(&dword_187DA9000, v6, OS_LOG_TYPE_DEFAULT, "Updating CSPN state to %d", (uint8_t *)&v8, 8u);
    }
  }
...
LABEL_6:
      _os_log_impl(&dword_187DA9000, v7, OS_LOG_TYPE_DEFAULT, "Updating CSPN Query delay", v6, 2u);
    }
  }
...
- (void)setCSPNRequeryDelta:(unsigned int)a3
{
  ...
  if (coresmartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)coresmartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      uint64_t v7 = (os_log_s *)v5;
LABEL_6:
      _os_log_impl(&dword_187DA9000, v7, OS_LOG_TYPE_DEFAULT, "Updating CSPN Re-query delay", v6, 2u);
    }
  }
...
- (void)setCSPNIgnoreRemoteClient:(unsigned int)a3
{
  ...
  if (coresmartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)coresmartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      uint64_t v6 = (os_log_s *)v5;
LABEL_6:
      _os_log_impl( &dword_187DA9000,  v6,  OS_LOG_TYPE_DEFAULT,  "Updating setCSPNIgnoreRemoteClient state to %d",  (uint8_t *)&v8,  8u);
    }
  }
...
- (void)setCSPNMotionAlarmThreshold:(unsigned int)a3
{
  ...
  if (coresmartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)coresmartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      uint64_t v7 = (os_log_s *)v5;
LABEL_6:
      _os_log_impl(&dword_187DA9000, v7, OS_LOG_TYPE_DEFAULT, "Updating CSPN motion alarm threshold", v6, 2u);
    }
  }
...
- (void)setCSPNMotionAlarmStartThreshold:(unsigned int)a3
{
  ...
  if (coresmartpowernap_log)
  {
    if (os_log_type_enabled((os_log_t)coresmartpowernap_log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      uint64_t v7 = (os_log_s *)v5;
LABEL_6:
      _os_log_impl(&dword_187DA9000, v7, OS_LOG_TYPE_DEFAULT, "Updating CSPN motion alarm start threshold", v6, 2u);
    }
  }
