...
- (BOOL)isEqual:(id)a3
{
    ...
    && (id v8 = -[SQLiteMemoryEntity databaseID](self, "databaseID"), v8 == [v4 databaseID]))
  {
    ...
    {
      id v11 = (void *)objc_claimAutoreleasedReturnValue(-[SQLiteMemoryEntity externalPropertyValues](self, "externalPropertyValues"));
      id v12 = (void *)objc_claimAutoreleasedReturnValue([v4 externalPropertyValues]);
