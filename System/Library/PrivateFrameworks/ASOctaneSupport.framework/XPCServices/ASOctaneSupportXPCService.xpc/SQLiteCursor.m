...
LABEL_8:
  ...
  if (!v6)
  {
    if (qword_1002BADC8 != -1) {
      dispatch_once(&qword_1002BADC8, &stru_10026EF20);
    }
    uint64_t v8 = (void *)qword_1002BADB0;
    if (os_log_type_enabled((os_log_t)qword_1002BADB0, OS_LOG_TYPE_ERROR))
    {
