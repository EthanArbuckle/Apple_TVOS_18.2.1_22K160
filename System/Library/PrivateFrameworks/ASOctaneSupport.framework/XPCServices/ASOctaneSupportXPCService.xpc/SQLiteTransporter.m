...
- (BOOL)canBeginTransportation
{
  ...
  {
    if (qword_1002BAE80 != -1) {
      dispatch_once(&qword_1002BAE80, &stru_10026F3D8);
    }
    v4 = (os_log_s *)qword_1002BAE68;
    if (os_log_type_enabled((os_log_t)qword_1002BAE68, OS_LOG_TYPE_ERROR)) {
      sub_1001EB9F0((uint64_t)p_databasePath, v4, v5, v6, v7, v8, v9, v10);
    }
  }
  ...
  else
  {
    ...
    v18 = (os_log_s *)qword_1002BAE68;
    if (os_log_type_enabled((os_log_t)qword_1002BAE68, OS_LOG_TYPE_ERROR)) {
      sub_1001EBA58((uint64_t)p_databasePath, v18, v19, v20, v21, v22, v23, v24);
    }
  }
...
- (BOOL)endTransporationAndRemoveDatabase
{
  if (-[SQLiteConnection close](self->_connection, "close") && sub_1000139E8(self->_databasePath))
  {
  ...
  else
  {
    ...
    v4 = (os_log_s *)qword_1002BAE68;
    BOOL v3 = os_log_type_enabled((os_log_t)qword_1002BAE68, OS_LOG_TYPE_ERROR);
    if (v3)
    {
      sub_1001EBAC0((uint64_t)self, v4, v5, v6, v7, v8, v9, v10);
      LOBYTE(v3) = 0;
    }
  }
...
{
  id v7 = a3;
  os_unfair_lock_lock((os_unfair_lock_t)&unk_1002BAE30);
...
LABEL_6:
  ...
  os_unfair_lock_unlock((os_unfair_lock_t)&unk_1002BAE30);
}
...
+ (BOOL)_isKnownDatabasePath:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      id v8 = (void *)objc_claimAutoreleasedReturnValue([v7 indexesOfObjectsPassingTest:&stru_10026F3B8]);
      if ([v8 count])
      {
