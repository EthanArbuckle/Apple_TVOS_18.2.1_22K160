...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___APSPayloadMessageStatsCount;
  v2 = -[APSPayloadMessageStatsCount init](&v6, "init");
  v3 = v2;
  if (v2)
  {
    v2->_buckets[0].interval = 300.0;
    v2->_buckets[0].count = 12;
    v2->_buckets[0].data = 0LL;
    v2->_buckets[1].interval = 3600.0;
    v2->_buckets[1].count = 24;
    v2->_buckets[1].data = 0LL;
    v4 = (unsigned __int16 *)calloc(0x24uLL, 2uLL);
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___APSPayloadMessageStatsCount;
  -[APSPayloadMessageStatsCount dealloc](&v4, "dealloc");
}
...
- (void)countTopic:(id)a3 now:(double)a4
{
  ...
  -[APSPayloadMessageStatsCount shiftBucketsBasedOnNow:](self, "shiftBucketsBasedOnNow:", a4);
