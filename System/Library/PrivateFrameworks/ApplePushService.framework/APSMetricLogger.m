...
{
  id v5 = a3;
  v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@.%@",  @"com.apple.APSD",  kAPSPushFilterSentMetricName));
  v7 = (__CFDictionary *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionary](&OBJC_CLASS___NSMutableDictionary, "dictionary"));
  v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( NSNumber,  "numberWithInteger:",  [v5 topicGroupChange]));
  if (v8) {
    CFDictionarySetValue(v7, @"changeType", v8);
  }

  v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInteger:]( NSNumber,  "numberWithUnsignedInteger:",  [v5 reason]));
  if (v9) {
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue([v5 triggeringTopic]);
  if (v11) {
...
+ (void)connectionConnectedWithDuration:(id)a3 interface:(int64_t)a4 linkQuality:(id)a5 dualChannelState:(unsigned int)a6 dnsResolutionTimeMilliseconds:(id)a7 tlsHandshakeTimeMilliseconds:(id)a8
{
  ...
  id v15 = a7;
  id v16 = a8;
  v17 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@.%@",  @"com.apple.APSD",  kAPSPushConnectionConnectedMetricName));
  v18 = (__CFDictionary *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionary](&OBJC_CLASS___NSMutableDictionary, "dictionary"));
  v19 = v18;
  if (v15) {
  ...
  v20 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", v10));
  if (v20) {
  ...
  v22 = (os_log_s *)objc_claimAutoreleasedReturnValue(+[APSLog courier](&OBJC_CLASS___APSLog, "courier"));
...
+ (void)connectionDisconnected:(int64_t)a3 linkQuality:(id)a4 reason:(unsigned int)a5
{
  uint64_t v5 = *(void *)&a5;
  id v7 = a4;
  v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@.%@",  @"com.apple.APSD",  kAPSPushConnectionDisconnectedMetricName));
  v9 = (__CFDictionary *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionary](&OBJC_CLASS___NSMutableDictionary, "dictionary"));
  uint64_t v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", v5));
  if (v10) {
...
{
  uint64_t v5 = *(void *)&a3;
  v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@.%@",  @"com.apple.APSD",  kAPSPushConnectionSSLError));
  id v7 = (__CFDictionary *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionary](&OBJC_CLASS___NSMutableDictionary, "dictionary"));
