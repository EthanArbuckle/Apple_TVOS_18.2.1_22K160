...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___APSUser;
  v4 = -[APSUser init](&v10, "init");
  v5 = v4;
  if (v4)
  {
    BOOL v6 = a3 == 0;
    ...
    v8 = (id *)CUTWeakLinkSymbol("PKNonMacTokenName", @"PushKit");
...
- (APSUser)initWithUserName:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___APSUser;
  BOOL v6 = -[APSUser init](&v9, "init");
  v7 = v6;
  if (v6)
  {
...
- (NSString)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<%@: %p; name: %@>",
...
- (id)aps_prettyDescription
{
  return +[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", @"<%@>", self->_name);
}
