...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___TASKNotifyAck;
  id v3 = -[TASKNotifyAck description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[TASKNotifyAck dictionaryRepresentation](self, "dictionaryRepresentation"));
