...
- (APSOutstandingTask)initWithDNSTask:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___APSOutstandingTask;
  v6 = -[APSOutstandingTask init](&v9, "init");
  v7 = v6;
  if (v6)
  {
    v6->_taskType = 1LL;
...
- (APSOutstandingTask)initWithDNSTask:(id)a3 messageId:(unint64_t)a4 taskId:(unint64_t)a5 taskStatus:(unint64_t)a6
{
  id v11 = a3;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___APSOutstandingTask;
  v12 = -[APSOutstandingTask init](&v15, "init");
  v13 = v12;
  if (v12)
  {
    v12->_taskType = 1LL;
    objc_storeStrong((id *)&v12->_dnsRequest, a3);
    -[APSOutstandingTask setMessageId:](v13, "setMessageId:", a4);
    -[APSOutstandingTask setTaskId:](v13, "setTaskId:", a5);
    -[APSOutstandingTask setTaskStatus:](v13, "setTaskStatus:", a6);
  }
