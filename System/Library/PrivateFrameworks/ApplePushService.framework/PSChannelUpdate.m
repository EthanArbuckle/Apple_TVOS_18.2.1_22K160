...
{
  if (!a3) {
    return @"CHANNEL_ID_DOES_NOT_EXIST";
  }
  if (a3 == 1) {
...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___PSChannelUpdate;
  id v3 = -[PSChannelUpdate description](&v8, "description");
  int v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PSChannelUpdate dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    {
      objc_super v8 = @"CHANNEL_ID_DOES_NOT_EXIST";
    }
  ...
  if ((has & 1) != 0)
  {
    v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedLongLong:]( &OBJC_CLASS___NSNumber,  "numberWithUnsignedLongLong:",  self->_checkpoint));
...
- (BOOL)readFrom:(id)a3
{
  return sub_10003C7DC((uint64_t)self, (uint64_t)a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 1) != 0)
  {
    PBDataWriterWriteUint64Field(v7, self->_checkpoint, 3LL);
    id v4 = v7;
  }
}
