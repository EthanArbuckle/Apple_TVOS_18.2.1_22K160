...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___PSAttribute;
  id v3 = -[PSAttribute description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PSAttribute dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000A7048((uint64_t)self, (uint64_t)a3);
}
