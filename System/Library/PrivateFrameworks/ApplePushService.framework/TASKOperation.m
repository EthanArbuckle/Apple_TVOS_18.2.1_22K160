...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___TASKOperation;
  id v3 = -[TASKOperation description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[TASKOperation dictionaryRepresentation](self, "dictionaryRepresentation"));
