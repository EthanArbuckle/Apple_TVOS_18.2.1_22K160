...
- (AKGrandslamTokenUpdateRequest)initWithTokens:(id)a3 accountManager:(id)a4 context:(id)a5 altDSID:(id)a6
{
  ...
  id v14 = a6;
  v20.receiver = self;
  v20.super_class = (Class)&OBJC_CLASS___AKGrandslamTokenUpdateRequest;
  v15 = -[AKGrandslamTokenUpdateRequest init](&v20, "init");
  v16 = v15;
  if (v15)
  {
    ...
    uint64_t v17 = objc_claimAutoreleasedReturnValue(-[AKAccountManager appleIDAccountWithAltDSID:](v16->_accountManager, "appleIDAccountWithAltDSID:", v14));
