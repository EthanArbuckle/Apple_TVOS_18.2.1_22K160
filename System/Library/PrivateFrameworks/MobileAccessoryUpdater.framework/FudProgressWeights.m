...
{
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___FudProgressWeights;
  ...
  {
    FudLog( 3,  (uint64_t)@"Can't create progress weights if total doesn't equal 1",  v8,  v9,  v10,  v11,  v12,  v13,  (uint64_t)v17.receiver);
    v15 = v14;
    return 0LL;
  }
