...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___EAHIDAccessory;
  v6 = -[EAHIDAccessory init](&v9, "init");
  v7 = v6;
  if (v6)
  {
    -[EAHIDAccessory setName:](v6, "setName:", a3);
    -[EAHIDAccessory setHIDDevice:](v7, "setHIDDevice:", a4);
  }
...
- (void)dealloc
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___EAHIDAccessory;
  -[EAHIDAccessory dealloc](&v12, "dealloc");
}
