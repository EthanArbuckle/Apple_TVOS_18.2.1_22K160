  ...
  if (a3)
  {
    ...
    else
    {
      if ([a3 responseFormat] == 1 || !objc_msgSend(a3, "responseAlignment"))
      {
        ...
        block[2] = sub_1000071E4;
        block[3] = &unk_100075480;
        block[5] = a3;
        block[6] = &v12;
        block[4] = self;
...
LABEL_55:
  ...
  if ([a3 requestPrefix])
  {
    ...
    sub_100006CC8(v8, @"ApBoardID", (const __CFString *)[a3 requestPrefix], @"BoardID");
    sub_100006CC8(v8, @"ApChipID", (const __CFString *)[a3 requestPrefix], @"ChipID");
    sub_100006CC8(v8, @"ApECID", (const __CFString *)[a3 requestPrefix], @"ECID");
    sub_100006CC8( v8,  @"ApSecurityDomain",  (const __CFString *)[a3 requestPrefix],  @"SecurityDomain");
    sub_100006CC8( v8,  @"ApProductionMode",  (const __CFString *)[a3 requestPrefix],  @"ProductionMode");
    sub_100006CC8( v8,  @"ApManifestEpoch",  (const __CFString *)[a3 requestPrefix],  @"ManifestEpoch");
    if ([a3 isSecurityModeSet]) {
      sub_100006CC8( v8,  @"ApSecurityMode",  (const __CFString *)[a3 requestPrefix],  @"SecurityMode");
    }
    sub_100006CC8(v8, @"ApNonce", (const __CFString *)[a3 requestPrefix], @"Nonce");
    uint64_t v9 = CFStringCreateMutable(kCFAllocatorDefault, 0LL);
    CFStringAppendFormat(v9, 0LL, @"@%@", @"ApImg4Ticket");
    sub_100006D50(v8, v9, (const __CFString *)[a3 requestPrefix], @"Ticket");
    CFRelease(v9);
  ...
  CFRelease(v10);
  sub_100006C60(v6, @"ApBoardID", (int)[a3 boardID]);
  sub_100006C60(v6, @"ApChipID", (int)[a3 chipID]);
  if ([a3 globalSigning])
  {
  ...
  else
  {
    if (![a3 extEcID])
    {
      sub_100006BF8(v6, @"ApECID", (uint64_t)[a3 ecID]);
      goto LABEL_20;
    }
...
LABEL_20:
  ...
  sub_100006C60(v6, @"ApSecurityDomain", v14);
  else {
...
- (BOOL)personalizeWithServer:(id)a3
{
  ...
  if (!self->_amai)
  {
    ...
    AMAuthInstallLogSetHandler(sub_100007F6C);
  }
