...
+ (id)sharedDatabase
{
  if (qword_10003DEA0 != -1) {
    dispatch_once(&qword_10003DEA0, &stru_10002D4A8);
  }
  return (id)qword_10003DE98;
}
...
- (void)updateAccessory:(id)a3 locationType:(unint64_t)a4
{
  ...
  if (-[AUDeveloperSettingsDatabase isValidLocationType:](self, "isValidLocationType:", a4))
  {
    ...
    v10 = +[NSString stringWithUTF8String:]( &OBJC_CLASS___NSString,  "stringWithUTF8String:",  AUDeveloperSettingsURLTypeToString(a4));
    ...
    {
      v13 = log;
      v14 = AUDeveloperSettingsURLTypeToString(a4);
          ...
          if ((isKindOfClass & 1) != 0)
          {
            ...
            if (v14)
            {
              ...
              if ((v17 & 1) == 0)
              {
                ...
                if (v27 <= 2)
                {
                  v20 = +[NSString stringWithUTF8String:]( &OBJC_CLASS___NSString,  "stringWithUTF8String:",  AUDeveloperSettingsAccessoryFusingTypeToString(v27));
