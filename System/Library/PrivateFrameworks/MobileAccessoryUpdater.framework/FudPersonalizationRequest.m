...
- (FudPersonalizationRequest)initWithName:(id)a3
{
  ...
  {
    v18.receiver = self;
    v18.super_class = (Class)&OBJC_CLASS___FudPersonalizationRequest;
    ...
    if (v8)
    {
      ...
      *((void *)v8 + 7) = 0LL;
      *((void *)v8 + 8) = 0LL;
      *(_OWORD *)(v8 + 20) = xmmword_1881F5AE0;
      *((_DWORD *)v8 + 9) = 0;
      *((_WORD *)v8 + 8) = 0;
      *((_DWORD *)v8 + 2) = 0;
      *((void *)v8 + 10) = 0LL;
  ...
  {
    FudLog( 3,  (uint64_t)@"%s(): requestName=nil\n",  0LL,  v3,  v4,  v5,  v6,  v7,  (uint64_t)"-[FudPersonalizationRequest initWithName:]");
  }
...
- (void)dealloc
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___FudPersonalizationRequest;
...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___FudPersonalizationRequest;
  uint64_t v4 = -[FudPersonalizationRequest init](&v10, sel_init);
  if (v4)
  {
