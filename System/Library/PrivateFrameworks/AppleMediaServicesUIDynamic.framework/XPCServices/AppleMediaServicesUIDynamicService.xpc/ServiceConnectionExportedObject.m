...
- (void)bootstrapWithAccount:(id)a3 bagData:(id)a4 clientInfo:(id)a5 mediaClientData:(id)a6 metricsContextData:(id)a7 url:(id)a8 completion:(id)a9
{
  ...
  v34 = v36;
  v35 = v37;
  sub_100034194(v38, v25, v27, v37, v28, v30, v31, v33, (uint64_t)v19, (unint64_t)v36, v20);
  _Block_release(v20);
  sub_100023DA8(v31, v33);
  sub_100023DA8(v28, v30);
  sub_100023DA8(v25, v27);
...
- (void)performWithRequestData:(id)a3 completion:(id)a4
{
  ...
  _Block_copy(v6);
  sub_100035DB4(v8, v10, (uint64_t)self, v6);
  _Block_release(v6);
  sub_100023DA8(v8, v10);
  swift_release(self);
}
...
- (void)updateWithAccount:(id)a3 completion:(id)a4
{
  ...
  id v7 = a3;
  swift_retain(self);
  sub_100036EF4(a3, (uint64_t)self, (void (**)(void, void))v6);
  _Block_release(v6);
