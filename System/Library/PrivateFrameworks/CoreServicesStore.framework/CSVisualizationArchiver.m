...
uint64_t __51___CSVisualizationArchiver_writeAllUnitsWithBlock___block_invoke( uint64_t a1,  uint64_t a2,  uint64_t a3,  uint64_t a4,  uint64_t a5,  _BYTE *a6)
{
  ...
  unsigned __int8 v9 = atomic_load((unsigned __int8 *)(*(void *)(a1 + 32) + 18LL));
  if ((v9 & 1) != 0) {
    *a6 = 1;
  }
  return result;
...
uint64_t __55___CSVisualizationArchiver_writeAllUnitsInTable_block___block_invoke_60( uint64_t result,  uint64_t a2)
{
  ...
  if ((v2 & 1) == 0)
  {
    ...
    unsigned __int8 v5 = atomic_load((unsigned __int8 *)(**(void **)(v3 + 48) + 18LL));
    if ((v5 & 1) != 0) {
      atomic_store(1u, *(unsigned __int8 **)(v3 + 32));
    }
  }
...
id __55___CSVisualizationArchiver_getWriteUnitState_forTable___block_invoke( uint64_t a1,  void *a2,  uint64_t a3,  uint64_t a4)
{
  ...
  {
    [v7 summaryOfUnit:a4 inTable:a3];
...
id __55___CSVisualizationArchiver_getWriteUnitState_forTable___block_invoke_2( uint64_t a1,  void *a2,  uint64_t a3,  uint64_t a4)
{
  ...
  if (!v8
    || ((*(void (**)(uint64_t, id, uint64_t, uint64_t))(v8 + 16))(v8, v7, a3, a4),
        (unint64_t v9 = (void *)objc_claimAutoreleasedReturnValue()) == 0LL))
  {
    [v7 descriptionOfUnit:a4 inTable:a3];
    unint64_t v9 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
void __141___CSVisualizationArchiver_CSRemoteVisualization__beginProvidingVisualizationArchivesWithMachServiceName_queue_creatingVisualizersWithBlock___block_invoke( uint64_t a1,  const void *a2,  uint64_t a3)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&v15[10] = a2;
    __int16 v16 = 2112;
    uint64_t v17 = a3;
    _os_log_impl( &dword_183DFE000,  v6,  OS_LOG_TYPE_DEFAULT,  "Received request for service %{public}@ from connection %p: %@",  (uint8_t *)&v14,  0x20u);
  }

  uint64_t v8 = (void *)os_transaction_create();
  unint64_t v9 = funopen( a2,  (int (__cdecl *)(void *, char *, int))CSStore2::readFromLockdownConnection,  (int (__cdecl *)(void *, const char *, int))CSStore2::writeToLockdownConnection,  0LL,  0LL);
  if (v9)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v15[4] = 2080;
      *(void *)&v15[6] = v13;
      _os_log_error_impl( &dword_183DFE000,  v10,  OS_LOG_TYPE_ERROR,  "Failed to open file handle for streaming visualization data: %i (%s)",  (uint8_t *)&v14,  0x12u);
    }
  }
...
void __106___CSVisualizationArchiver_CSRemoteVisualization__provideVisualizerToConnection_fileHandle_providerBlock___block_invoke( uint64_t a1)
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_alloc(&OBJC_CLASS____CSVisualizationArchiver);
    uint64_t v4 = *(void *)(a1 + 48);
    id v9 = 0LL;
    unsigned __int8 v5 = -[_CSVisualizationArchiver initWithVisualizer:fileHandle:closeWhenDone:allowCompression:error:]( v3,  "initWithVisualizer:fileHandle:closeWhenDone:allowCompression:error:",  v2,  v4,  0LL,  1LL,  &v9);
    char v6 = (CSStore2 *)v9;
    uint64_t v7 = v6;
    if (v5)
    {
      -[_CSVisualizationArchiver writeAllUnitsWithBlock:](v5, "writeAllUnitsWithBlock:", 0LL);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138543362;
        int v11 = v7;
        _os_log_error_impl( &dword_183DFE000,  v8,  OS_LOG_TYPE_ERROR,  "Failed to create _CSVisualizationArchiver for streaming visualization data: %{public}@",  buf,  0xCu);
      }
    }
  }
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl( &dword_183DFE000,  v7,  OS_LOG_TYPE_INFO,  "Callback block didn't vend a _CSVisualizer; no data will be returned to the Mac",
        buf,
        2u);
    }
  }
