...
{
  uint64_t v0 = [MEMORY[0x1896079C8] predicateWithFormat:@"$HAYSTACK LIKE[cd] $NEEDLE"];
  ...
  uint64_t v2 = [MEMORY[0x1896079C8] predicateWithFormat:@"$HAYSTACK MATCHES[cd] $NEEDLE"];
