...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___CLPCReportingStatSelection;
  v2 = -[CLPCReportingStatSelection init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
    *(void *)v2->selection.__elems_ = 0LL;
    *(void *)&v2->selection.__elems_[8] = 0LL;
    v2->selection.__elems_[24] = 0;
    *(void *)&v2->selection.__elems_[16] = 0LL;
    v4 = v2;
  }
...
- (void)selectAll
{
  *(void *)&self->selection.__elems_[8] = 0x101010101010101LL;
  *(void *)&self->selection.__elems_[16] = 0x101010101010101LL;
  *(void *)self->selection.__elems_ = 0x101010101010101LL;
  self->selection.__elems_[24] = 1;
}

- (void)deselectAll
{
  *(void *)self->selection.__elems_ = 0LL;
  *(void *)&self->selection.__elems_[8] = 0LL;
  self->selection.__elems_[24] = 0;
  *(void *)&self->selection.__elems_[16] = 0LL;
}
