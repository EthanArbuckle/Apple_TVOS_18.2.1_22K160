...
- (PDCloudStoreShareInvitationValidateRequestKeys)initWithInvitation:(id)a3 recipientHandle:(id)a4 completion:(id)a5
{
  ...
  id v10 = a4;
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___PDCloudStoreShareInvitationValidateRequestKeys;
  v11 = -[PDCloudStoreShareInvitationRequest initWithType:completion:](&v14, "initWithType:completion:", 1LL, a5);
  v12 = v11;
  if (v11)
  {
