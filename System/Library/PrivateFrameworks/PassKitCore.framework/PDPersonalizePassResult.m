...
- (PDPersonalizePassResult)initWithSignatureData:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___PDPersonalizePassResult;
  v5 = -[PDPersonalizePassResult init](&v9, "init");
  if (v5)
  {
    uint64_t v6 = objc_claimAutoreleasedReturnValue([v4 base64EncodedStringWithOptions:0]);
