...
- (PDAccountManagerPhysicalCardsRequest)initWithAccountIdentifier:(id)a3 force:(BOOL)a4
{
  id v7 = a3;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___PDAccountManagerPhysicalCardsRequest;
  v8 = -[PDAccountManagerPhysicalCardsRequest init](&v13, "init");
  v9 = v8;
  if (v8)
  {
...
- (id)requestIdentifier
{
  v3 = sub_1003DE65C(-[PDAccountManagerPhysicalCardsRequest requestType](self, "requestType"));
...
- (BOOL)coalesceWithRequest:(id)a3
{
  ...
  if (v5 != (id)-[PDAccountManagerPhysicalCardsRequest requestType](self, "requestType")) {
    goto LABEL_6;
  }
  v6 = (void *)objc_claimAutoreleasedReturnValue([v4 requestIdentifier]);
  id v7 = (void *)objc_claimAutoreleasedReturnValue(-[PDAccountManagerPhysicalCardsRequest requestIdentifier](self, "requestIdentifier"));
  id v8 = v6;
  id v9 = v7;
  if (v8 == v9)
  {
...
- (NSString)description
{
  ...
  id v5 = sub_1003DE65C(-[PDAccountManagerPhysicalCardsRequest requestType](self, "requestType"));
