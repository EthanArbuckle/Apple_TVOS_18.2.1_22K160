...
+ (id)insertUserInfoUpdate:(id)a3 forEventPID:(int64_t)a4 inDatabase:(id)a5
{
  ...
  id v12 = (void *)objc_claimAutoreleasedReturnValue([v9 updatedDate]);
...
- (id)userInfoUpdate
{
  v3 = objc_alloc_init(&OBJC_CLASS___PKAccountUserInfoUpdate);
  v4 = (void *)objc_claimAutoreleasedReturnValue( +[AccountUserInfoUpdate _propertySettersForUserInfoUpdate]( &OBJC_CLASS___AccountUserInfoUpdate,  "_propertySettersForUserInfoUpdate"));
