...
+ (id)insertPhysicalCardStatusUpdate:(id)a3 forEventPID:(int64_t)a4 inDatabase:(id)a5
{
  ...
  if (v12)
  {
    id v13 = (void *)objc_claimAutoreleasedReturnValue([v8 updatedPhysicalCards]);
...
- (id)physicalCardStatusUpdate
{
  v3 = objc_alloc_init(&OBJC_CLASS___PKAccountPhysicalCardStatusUpdate);
  v4 = (void *)objc_claimAutoreleasedReturnValue( +[AccountPhysicalCardStatusUpdate _propertySettersForAccountPhysicalCardStatusUpdate]( &OBJC_CLASS___AccountPhysicalCardStatusUpdate,  "_propertySettersForAccountPhysicalCardStatusUpdate"));
...
- (BOOL)deleteFromDatabase
{
  ...
  +[PhysicalCard deletePhysicalCardsForPhysicalCardStatusUpdatePID:inDatabase:]( &OBJC_CLASS___PhysicalCard,  "deletePhysicalCardsForPhysicalCardStatusUpdatePID:inDatabase:",  v3,  v4);

  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___AccountPhysicalCardStatusUpdate;
