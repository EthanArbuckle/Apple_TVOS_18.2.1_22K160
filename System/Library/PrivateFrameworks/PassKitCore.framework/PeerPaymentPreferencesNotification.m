...
+ (id)peerPaymentPeferencesNotificationsForPeerPaymentPreferencesPID:(int64_t)a3 inDatabase:(id)a4
{
  ...
  id v9 = (void *)objc_claimAutoreleasedReturnValue([a1 _peerPaymentPreferencesNotificationsWithQuery:v8]);
  return v9;
}
...
- (PeerPaymentPreferencesNotification)initWithPeerPaymentPreferencesNotification:(id)a3 forPeerPaymentPreferencesPID:(int64_t)a4 inDatabase:(id)a5
{
  ...
  id v13 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInteger:]( NSNumber,  "numberWithUnsignedInteger:",  [v9 notificationType]));
  -[NSMutableDictionary setObjectOrNull:forKey:](v10, "setObjectOrNull:forKey:", v13, @"notification_type");

  id v14 = [v9 value];
  -[NSMutableDictionary setBool:forKey:](v10, "setBool:forKey:", v14, @"value");
...
- (id)peerPaymentPreferencesNotification
{
  v3 = objc_alloc_init(&OBJC_CLASS___PKPeerPaymentPreferencesNotification);
  id v5 = objc_msgSend((id)objc_opt_class(self, v4), "_propertySettersForPeerPaymentPreferencesNotification");
...
{
  id v4 = a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue([a1 _propertySettersForPeerPaymentPreferencesNotification]);
