...
- (PKNotifiablePaymentMarket)initWithPaymentMarket:(id)a3 eligibleNotifiableState:(unint64_t)a4
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)&OBJC_CLASS___PKNotifiablePaymentMarket;
    v8 = -[PKNotifiablePaymentMarket init](&v10, "init");
    self = v8;
    if (v8)
    {
...
- (PKPaymentMarket)market
{
  return (PKPaymentMarket *)objc_getProperty(self, a2, 16LL, 1);
}
