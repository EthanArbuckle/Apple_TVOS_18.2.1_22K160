    ...
    if (serverDebugDescription)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        ...
        v10 = "PDNotificationServiceConnectionForbiddenErrorResponse failed to parse response data with error: %@";
        v11 = v9;
        uint32_t v12 = 12;
LABEL_13:
    ...
    if ((objc_opt_isKindOfClass(v5, v14) & 1) == 0)
    {
      ...
      {
        *(_WORD *)buf = 0;
        v10 = "PDNotificationServiceConnectionForbiddenErrorResponse body is not a dictionary";
        v11 = v9;
        uint32_t v12 = 2;
        goto LABEL_13;
      }
