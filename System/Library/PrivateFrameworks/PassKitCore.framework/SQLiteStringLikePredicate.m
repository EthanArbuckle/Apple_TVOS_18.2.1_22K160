...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  id v6 = (void *)objc_claimAutoreleasedReturnValue(-[SQLiteStringLikePredicate property](self, "property"));
  ...
  uint64_t v8 = (void *)objc_claimAutoreleasedReturnValue(-[SQLiteStringLikePredicate pattern](self, "pattern"));
  [v5 appendFormat:@"'%@'", v8];
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SQLiteStringLikePredicate;
...
- (BOOL)isEqual:(id)a3
{
  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___SQLiteStringLikePredicate;
