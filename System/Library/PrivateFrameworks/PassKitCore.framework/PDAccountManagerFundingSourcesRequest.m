...
- (PDAccountManagerFundingSourcesRequest)initWithAccountIdentifier:(id)a3 force:(BOOL)a4
{
  id v7 = a3;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___PDAccountManagerFundingSourcesRequest;
  v8 = -[PDAccountManagerFundingSourcesRequest init](&v13, "init");
  v9 = v8;
  if (v8)
  {
...
- (id)requestIdentifier
{
  v3 = sub_1003DE65C(-[PDAccountManagerFundingSourcesRequest requestType](self, "requestType"));
...
- (BOOL)coalesceWithRequest:(id)a3
{
  ...
  if (v5 != (id)-[PDAccountManagerFundingSourcesRequest requestType](self, "requestType")) {
    goto LABEL_6;
  }
  v6 = (void *)objc_claimAutoreleasedReturnValue([v4 requestIdentifier]);
  id v7 = (void *)objc_claimAutoreleasedReturnValue(-[PDAccountManagerFundingSourcesRequest requestIdentifier](self, "requestIdentifier"));
  id v8 = v6;
  id v9 = v7;
  if (v8 == v9)
  {
...
- (NSString)description
{
  ...
  id v5 = sub_1003DE65C(-[PDAccountManagerFundingSourcesRequest requestType](self, "requestType"));
