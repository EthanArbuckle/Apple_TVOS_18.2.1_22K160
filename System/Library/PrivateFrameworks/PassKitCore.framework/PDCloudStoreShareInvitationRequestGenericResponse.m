...
- (PDCloudStoreShareInvitationRequestGenericResponse)initWithSuccess:(BOOL)a3 error:(id)a4
{
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___PDCloudStoreShareInvitationRequestGenericResponse;
  v8 = -[PDCloudStoreShareInvitationRequestGenericResponse init](&v11, "init");
  v9 = v8;
  if (v8)
  {
    v8->_success = a3;
