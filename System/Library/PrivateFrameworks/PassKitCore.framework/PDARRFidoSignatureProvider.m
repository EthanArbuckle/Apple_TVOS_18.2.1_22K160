...
- (_TtC5passd26PDARRFidoSignatureProvider)init
{
  ...
  return -[PDARRFidoSignatureProvider init](&v3, "init");
}
...
- (void)generateKeyMaterialForRequirement:(id)a3 context:(id)a4 completion:(id)a5
{
  ...
  id v10 = a4;
  v11 = self;
  sub_10042791C(v9, v10, (void (**)(void, void, void, void))v8);
  _Block_release(v8);
  _Block_release(v8);
}
...
- (void)isRegisteredForRequirement:(id)a3 context:(id)a4 completion:(id)a5
{
  ...
  id v10 = a4;
  v11 = self;
  sub_100427DD4(v10, (void (**)(void, void))v8);
  _Block_release(v8);
  _Block_release(v8);
}
...
{
  v8 = _Block_copy(a5);
  uint64_t v9 = swift_allocObject(&unk_10065FB60, 24LL, 7LL);
  *(void *)(v9 + 16) = v8;
  id v10 = a3;
  id v11 = a4;
  v12 = self;
  sub_1004280E8(v11, (void (*)(uint64_t, void))sub_100427914, v9);
