...
+ (id)_associatedApplicationIdentifiersInDatabase:(id)a3 matchingPredicate:(id)a4
{
  ...
  id v9 = (void *)objc_claimAutoreleasedReturnValue([a1 _propertySettersForAssociatedApplicationIdentifier]);
  id v10 = (void *)objc_claimAutoreleasedReturnValue( +[SQLiteEntity queryWithDatabase:predicate:]( &OBJC_CLASS___AssociatedApplicationIdentifier,  "queryWithDatabase:predicate:",  v7,  v6));
...
+ (id)associatedApplicationIdentifiersInDatabase:(id)a3 forPass:(id)a4
{
  ...
  id v8 = (void *)objc_claimAutoreleasedReturnValue([a1 _associatedApplicationIdentifiersInDatabase:v6 matchingPredicate:v7]);
