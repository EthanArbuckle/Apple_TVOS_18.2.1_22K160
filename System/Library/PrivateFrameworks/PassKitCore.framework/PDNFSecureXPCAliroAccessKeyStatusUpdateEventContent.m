...
- (PDNFSecureXPCAliroAccessKeyStatusUpdateEventContent)initWithTerminalReaderIdentifier:(id)a3 operationSource:(unint64_t)a4
{
  id v7 = a3;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___PDNFSecureXPCAliroAccessKeyStatusUpdateEventContent;
  v8 = -[PDNFSecureXPCAliroAccessKeyStatusUpdateEventContent init](&v11, "init");
  v9 = v8;
  if (v8)
  {
