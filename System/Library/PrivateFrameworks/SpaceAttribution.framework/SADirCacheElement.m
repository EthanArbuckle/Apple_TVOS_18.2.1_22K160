...
+ (id)newWithBundleSet:(id)a3 purgeable:(BOOL)a4 cacheFolder:(BOOL)a5
{
  ...
  BOOL v6 = a4;
  id v7 = a3;
  v8 = objc_opt_new(&OBJC_CLASS___SADirCacheElement);
  -[SADirCacheElement setBundlesSet:](v8, "setBundlesSet:", v7);

  -[SADirCacheElement setPurgeable:](v8, "setPurgeable:", v6);
  -[SADirCacheElement setCacheFolder:](v8, "setCacheFolder:", v5);
  return v8;
}
