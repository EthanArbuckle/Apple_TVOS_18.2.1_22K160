...
- (SAActivity)initWithActivity:(id)a3 completionHandler:(id)a4
{
  ...
  id v8 = a4;
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___SAActivity;
  v9 = -[SAActivity init](&v14, "init");
  v10 = v9;
  if (v9)
  {
...
- (BOOL)shouldDefer
{
  ...
  if (activity) {
    unsigned __int8 deferActivity = -[NSBackgroundActivityScheduler shouldDefer](activity, "shouldDefer");
  }
  else {
...
- (NSBackgroundActivityScheduler)activity
{
  return (NSBackgroundActivityScheduler *)objc_getProperty(self, a2, 16LL, 1);
}
