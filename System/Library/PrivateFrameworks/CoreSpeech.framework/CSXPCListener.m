...
{
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___CSXPCListener;
  id v2 = -[CSXPCListener init](&v13, "init");
  if (v2)
  {
    dispatch_queue_t v3 = dispatch_queue_create("CSXPCListener", 0LL);
    v4 = (void *)*((void *)v2 + 1);
    *((void *)v2 + 1) = v3;
...
- (void)_handleListenerEvent:(id)a3
{
  ...
  if (v4)
  {
    if (xpc_get_type(v4) == (xpc_type_t)&_xpc_type_error) {
      -[CSXPCListener _handleListenerError:](self, "_handleListenerError:", v4);
    }
    else {
      -[CSXPCListener _handleNewRemoteConnection:](self, "_handleNewRemoteConnection:", v4);
    }
  }
...
- (void)_handleNewRemoteConnection:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      int v7 = 136315394;
      __int16 v8 = "-[CSXPCListener _handleNewRemoteConnection:]";
      __int16 v9 = 2050;
      id v10 = v4;
      _os_log_impl( (void *)&_mh_execute_header,  v5,  OS_LOG_TYPE_DEFAULT,  "%s Getting new client connection : %{public}p",  (uint8_t *)&v7,  0x16u);
    }

    if (+[CSUtils machXPCConnection:hasEntitlement:]( &OBJC_CLASS___CSUtils,  "machXPCConnection:hasEntitlement:",  v4,  @"corespeech.corespeechd.xpc"))
    {
      int v6 = -[CSClientXPCConnection initWithConnection:]( objc_alloc(&OBJC_CLASS___CSClientXPCConnection),  "initWithConnection:",  v4);
      -[CSClientXPCConnection activateConnection](v6, "activateConnection");
      -[CSClientXPCConnection setDelegate:](v6, "setDelegate:", self);
      if (v6) {
