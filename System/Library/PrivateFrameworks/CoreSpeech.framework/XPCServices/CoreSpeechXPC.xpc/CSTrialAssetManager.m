  ...
  else
  {
    ...
    if (v4)
    {
      ...
      if (+[CSUtils supportTrialMitigationAssets](&OBJC_CLASS___CSUtils, "supportTrialMitigationAssets")) {
        v6 = +[NSArray arrayWithObjects:]( &OBJC_CLASS___NSArray,  "arrayWithObjects:",  &off_10001E110,  &off_10001E128,  0LL);
      }
      else {
        v6 = +[NSArray arrayWithObjects:]( &OBJC_CLASS___NSArray,  "arrayWithObjects:",  &off_10001E140,  &off_10001E158,  0LL);
      }
      __int128 v19 = 0u;
      __int128 v20 = 0u;
      __int128 v17 = 0u;
...
+ (id)sharedInstance
{
  if (qword_100022CF0 != -1) {
    dispatch_once(&qword_100022CF0, &stru_10001C568);
  }
  return (id)qword_100022CE8;
}
