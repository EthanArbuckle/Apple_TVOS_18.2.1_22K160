...
- (CSAttendingMagusNotSupportedHintInfo)initWithOrigin:(unint64_t)a3 reason:(unint64_t)a4 rootRequestId:(id)a5
{
  id v9 = a5;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___CSAttendingMagusNotSupportedHintInfo;
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___CSAttendingMagusNotSupportedHintInfo;
  id v4 = -[CSAttendingHintInfo description](&v8, "description");
  v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  [v3 appendFormat:@"%@", v5];
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[CSAttendingMagusNotSupportedHintInfo _reasonString](self, "_reasonString"));
