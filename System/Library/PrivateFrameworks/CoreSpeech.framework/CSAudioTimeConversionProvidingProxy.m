...
- (void)handleXPCMessage:(id)a3 messageBody:(id)a4 client:(id)a5 audioStreamHandleId:(unint64_t)a6
{
  ...
  if (int64 == 2)
  {
    -[CSAudioTimeConversionProvidingProxy _handleXPCTimeConvertProvidingTypeSampleCountFromHostTimeMessage:messageBody:client:streamHandleId:]( self,  "_handleXPCTimeConvertProvidingTypeSampleCountFromHostTimeMessage:messageBody:client:streamHandleId:",  v10,  v11,  v12,  a6);
  }
  ...
  else
  {
    ...
    if (int64 == 1)
    {
      -[CSAudioTimeConversionProvidingProxy _handleXPCTimeConvertProvidingTypeHostTimeFromSampleCountMessage:messageBody:client:streamHandleId:]( self,  "_handleXPCTimeConvertProvidingTypeHostTimeFromSampleCountMessage:messageBody:client:streamHandleId:",  v10,  v11,  v12,  a6);
    }
...
- (void)_handleXPCTimeConvertProvidingTypeHostTimeFromSampleCountMessage:(id)a3 messageBody:(id)a4 client:(id)a5 streamHandleId:(unint64_t)a6
{
  ...
  id v10 = a3;
  uint64_t int64 = xpc_dictionary_get_uint64(a4, "sampleCount");
  id v12 = (void *)objc_claimAutoreleasedReturnValue(+[CSAudioTimeConverterPool sharedInstance](&OBJC_CLASS___CSAudioTimeConverterPool, "sharedInstance"));
  v13 = (void *)objc_claimAutoreleasedReturnValue([v12 converterForAudioStreamId:a6]);
  ...
  {
    int v17 = 136315650;
    __int16 v18 = "-[CSAudioTimeConversionProvidingProxy _handleXPCTimeConvertProvidingTypeHostTimeFromSampleCountMessage:message"
...
- (void)_handleXPCTimeConvertProvidingTypeSampleCountFromHostTimeMessage:(id)a3 messageBody:(id)a4 client:(id)a5 streamHandleId:(unint64_t)a6
{
  v9 = (_xpc_connection_s *)a5;
  id v10 = a3;
  uint64_t int64 = xpc_dictionary_get_uint64(a4, "hostTime");
  id v12 = (void *)objc_claimAutoreleasedReturnValue(+[CSAudioTimeConverterPool sharedInstance](&OBJC_CLASS___CSAudioTimeConverterPool, "sharedInstance"));
  v13 = (void *)objc_claimAutoreleasedReturnValue([v12 converterForAudioStreamId:a6]);
  ...
  {
    int v17 = 136315650;
    __int16 v18 = "-[CSAudioTimeConversionProvidingProxy _handleXPCTimeConvertProvidingTypeSampleCountFromHostTimeMessage:message"
          "Body:client:streamHandleId:]";
    __int16 v19 = 2050;
    uint64_t v20 = uint64;
    __int16 v21 = 2050;
