...
- (id)allInstalledAssetsOfType:(unint64_t)a3 language:(id)a4
{
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      v17 = (void *)objc_claimAutoreleasedReturnValue([v10 sortedArrayUsingComparator:&stru_10022B978]);
...
- (void)assetOfType:(unint64_t)a3 language:(id)a4 compatibilityVersion:(unint64_t)a5 completion:(id)a6
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472LL;
  block[2] = sub_100081B24;
  block[3] = &unk_10022B9F0;
  void block[4] = self;
  unint64_t v18 = a3;
  unint64_t v19 = a5;
  id v16 = v10;
...
- (id)installedAssetOfType:(unint64_t)a3 withLanguage:(id)a4
{
  ...
  uint64_t v22 = sub_100081ACC;
  v23 = sub_100081ADC;
  id v24 = 0LL;
  queue = (dispatch_queue_s *)self->_queue;
  v11 = _NSConcreteStackBlock;
  uint64_t v12 = 3221225472LL;
  unint64_t v13 = sub_100081AE4;
  id v14 = &unk_10022D758;
  v17 = &v19;
  unint64_t v18 = a3;
  unint64_t v15 = self;
  id v8 = v6;
...
- (id)_defaultDownloadOptions
{
  v2 = (void *)objc_opt_new(&OBJC_CLASS___MADownloadOptions);
...
- (void)_downloadAsset:(id)a3 withComplete:(id)a4
{
  ...
  id v9 = v7;
  id v10 = v6;
  -[CSAssetController _startDownloadingAsset:progress:completion:]( self,  "_startDownloadingAsset:progress:completion:",  v10,  &stru_10022BAD0,  v11);
}
...
+ (id)sharedController
{
  if (qword_10027FE38 != -1) {
    dispatch_once(&qword_10027FE38, &stru_10022B938);
  }
  return (id)qword_10027FE30;
}
...
+ (id)getEndpointAssetTypeString
{
  ...
  id v3 = +[CSUtils shouldUseHorsemanSpeechEndpointAssets](&OBJC_CLASS___CSUtils, "shouldUseHorsemanSpeechEndpointAssets");
