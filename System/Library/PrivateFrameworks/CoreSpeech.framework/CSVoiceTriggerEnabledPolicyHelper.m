...
+ (BOOL)siriInCallPolicy
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(+[CSHangUpEnabledMonitor sharedInstance](&OBJC_CLASS___CSHangUpEnabledMonitor, "sharedInstance"));
  if ([v2 isEnabled])
  {
    unsigned int v3 = 1;
  }
  ...
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue( +[CSSiriInCallEnabledMonitor sharedInstance]( &OBJC_CLASS___CSSiriInCallEnabledMonitor,  "sharedInstance"));
    unsigned int v3 = [v4 isEnabled];
  }

  unsigned int v5 = +[CSUtils supportHangUp](&OBJC_CLASS___CSUtils, "supportHangUp");
  v6 = (void *)objc_claimAutoreleasedReturnValue( +[CSPhoneCallStateMonitorFactory phoneCallStateMonitor]( &OBJC_CLASS___CSPhoneCallStateMonitorFactory,  "phoneCallStateMonitor"));
  ...
  v12 = (char *)+[CSUtils fetchHypotheticalRouteType](&OBJC_CLASS___CSUtils, "fetchHypotheticalRouteType");
  ...
  if (v19)
  {
    unsigned __int8 v26 = +[CSUtils isIOSDeviceSupportingBargeIn]( &OBJC_CLASS___CSUtils,  "isIOSDeviceSupportingBargeIn");
    BOOL result = 1;
