...
- (BOOL)hasSCntrsPower
{
  return self->_sCntrsPower != 0LL;
}

- (id)description
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___AWDFlagstonePowerMetrics;
  id v3 = -[AWDFlagstonePowerMetrics description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[AWDFlagstonePowerMetrics dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if (sCntrsPower)
  {
    objc_super v8 = (void *)objc_claimAutoreleasedReturnValue(-[AWDCountersPowerS dictionaryRepresentation](sCntrsPower, "dictionaryRepresentation"));
...
- (void)writeTo:(id)a3
{
  ...
  if (sCntrsPower)
  {
    PBDataWriterWriteSubmessage(v7, sCntrsPower, 3LL);
    id v4 = v7;
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v9 = -[AWDCountersPowerS copyWithZone:](self->_sCntrsPower, "copyWithZone:", a3);
  v10 = (void *)v6[3];
  v6[3] = v9;
...
LABEL_13:
  ...
  sCntrsPower = self->_sCntrsPower;
  if (sCntrsPower || *((void *)v4 + 3)) {
    unsigned __int8 v8 = -[AWDCountersPowerS isEqual:](sCntrsPower, "isEqual:", *((void *)v4 + 3));
  }
  else {
