...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___AWDFlagstoneStabilityMetrics;
  id v3 = -[AWDFlagstoneStabilityMetrics description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[AWDFlagstoneStabilityMetrics dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if (sCntrsStability)
  {
    objc_super v8 = (void *)objc_claimAutoreleasedReturnValue(-[AWDCountersStabilityS dictionaryRepresentation](sCntrsStability, "dictionaryRepresentation"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v9 = -[AWDCountersStabilityS copyWithZone:](self->_sCntrsStability, "copyWithZone:", a3);
  v10 = (void *)v6[3];
  v6[3] = v9;
...
LABEL_13:
  ...
  if (sCntrsStability || *((void *)v4 + 3)) {
    unsigned __int8 v8 = -[AWDCountersStabilityS isEqual:](sCntrsStability, "isEqual:", *((void *)v4 + 3));
  }
  else {
