...
LABEL_11:
  ...
  if (-[NSFileManager fileExistsAtPath:]( +[NSFileManager defaultManager](NSFileManager, "defaultManager"),  "fileExistsAtPath:",  [v17 path]))
  {
    ...
    {
      uint64_t v19 = v16;
      id v17 = objc_msgSend( -[UMEventRecorder _eventDirectory](self, "_eventDirectory"),  "URLByAppendingPathComponent:",  objc_msgSend( v16[166],  "stringWithFormat:",  @"%@-%@-%@-%d.plist",  v14,  objc_msgSend(a3, "objectForKey:", @"event"),  objc_msgSend(a3, "objectForKey:", @"eventTime"),  v18));
...
- (id)_copyUnsubmittedEventsFromDirectory:(id)a3 skipEventsIfPreviouslySubmittedAndWithinBackoffTime:(BOOL)a4 previouslySubmittedEventSkipped:(BOOL *)a5
{
  ...
  if (v21)
  {
    ...
    while (1)
    {
      ...
      id v35 = [v25[156] dictionaryWithContentsOfURL:v34];
      if (v35)
      {
        uint64_t v42 = v35;
        id v43 = v23;
