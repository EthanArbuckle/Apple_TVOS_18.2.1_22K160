...
LABEL_29:
            ...
            if (!v64)
            {
              if (-[NSMutableArray count](v46, "count"))
              {
                ...
                uint64_t v10 = 0LL;
                id v36 = 0LL;
                id v36 =  -[NSMutableArray sortedArrayUsingComparator:]( v46,  "sortedArrayUsingComparator:",  &__block_literal_global_15);
...
- (BOOL)setName:(id)a3 withError:(id *)a4
{
  ...
  {
    uint64_t v14 = &v30;
    __int128 v30 = xmmword_100041F08;
    uint64_t v31 = 0LL;
    uint64_t v15 = v42;
    int v13 = v43;
...
- (id)deviceModel
{
  ...
  SEL v10 = a2;
  v14[0] = *(_OWORD *)&off_10005A3F8;
  v14[1] = *(_OWORD *)&off_10005A408;
