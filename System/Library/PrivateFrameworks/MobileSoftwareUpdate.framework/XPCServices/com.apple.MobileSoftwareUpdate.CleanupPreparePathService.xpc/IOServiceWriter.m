...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___IOServiceWriter;
...
- (int)writeBytes:(char *)a3 ofLength:(unint64_t)a4 withError:(id *)a5
{
  return -[IOServiceWriter writeData:withError:]( self,  "writeData:withError:",  +[NSData dataWithBytes:length:](&OBJC_CLASS___NSData, "dataWithBytes:length:", a3, a4),  a5);
}
...
- (int)writeData:(id)a3 withError:(id *)a4
{
  ...
  uint64_t v18;
  uint64_t v20;
  objc_super v6 = IORegistryEntrySetCFProperty(-[IOServiceWriter service](self, "service"), @"FLASH", a3);
  if (v6)
  {
    v7 = [a3 length];
    v13 = MSUBootFirmwareError( v6,  0LL,  (uint64_t)@"writeData: Failed writing %d bytes with error %d",  v8,  v9,  v10,  v11,  v12,  (uint64_t)v7);
    if (a4) {
      *a4 = MSUBootFirmwareError( 3LL,  (uint64_t)v13,  (uint64_t)@"FLASH operation failed while writing to single SPI.",  v14,  v15,  v16,  v17,  v18,  v20);
    }
  }
...
- (int)openService
{
  io_service_t v3 = -[IOServiceWriter service](self, "service");
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___IOServiceWriter;
