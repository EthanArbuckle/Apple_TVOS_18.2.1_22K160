...
+ (SWCSecurityGuard)sharedSecurityGuard
{
  if (qword_10002E898 != -1) {
    dispatch_once(&qword_10002E898, &stru_100028F80);
  }
  return (SWCSecurityGuard *)(id)qword_10002E890;
}
...
- (optional<SecTrustResultType>)_evaluateTrust:(__SecTrust *)a3 error:(id *)a4
{
  ...
  if (qword_10002E8A8 != -1) {
    dispatch_once(&qword_10002E8A8, &stru_100028FA0);
  }
  v25 = (os_log_s *)qword_10002E8A0;
  if (os_log_type_enabled((os_log_t)qword_10002E8A0, OS_LOG_TYPE_ERROR))
  {
...
LABEL_3:
  ...
  CFDictionaryRef v19 = (os_log_s *)qword_10002E8A0;
  if (os_log_type_enabled((os_log_t)qword_10002E8A0, OS_LOG_TYPE_DEBUG))
  {
    uint64_t v20 = @"NOT ";
    *(_DWORD *)buf = 138412802;
    v25 = a3;
    if (v6) {
      uint64_t v20 = &stru_10002A058;
    }
    __int16 v26 = 2114;
    int v27 = v20;
    __int16 v28 = 2048;
