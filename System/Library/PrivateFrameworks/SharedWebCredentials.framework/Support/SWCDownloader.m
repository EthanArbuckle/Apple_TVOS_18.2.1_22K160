...
LABEL_28:
    ...
    if (!v19)
    {
      ...
      v28 = (os_log_s *)qword_10002E828;
      if (os_log_type_enabled((os_log_t)qword_10002E828, OS_LOG_TYPE_ERROR))
      {
    ...
    if (v23)
    {
      ...
      if (v25)
      {
        ...
        if (os_log_type_enabled((os_log_t)qword_10002E828, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 138412546;
          id v41 = v10;
          __int16 v42 = 2112;
...
- (void)URLSession:(id)a3 task:(id)a4 willPerformHTTPRedirection:(id)a5 newRequest:(id)a6 completionHandler:(id)a7
{
  ...
  if (v16)
  {
    ...
    if (v18 && ![v18 caseInsensitiveCompare:@"https"])
    {
      ...
      id v19 = (os_log_s *)(id)qword_10002E828;
...
- (void)URLSession:(id)a3 dataTask:(id)a4 didReceiveResponse:(id)a5 completionHandler:(id)a6
{
  ...
  if (v15)
  {
    ...
    id v16 = (os_log_s *)(id)qword_10002E828;
    ...
    if (v26)
    {
      if (v27 <= 0x63)
      {
        ...
        v33 = (os_log_s *)(id)qword_10002E828;
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          v47 = (char *)objc_claimAutoreleasedReturnValue(-[os_log_s URL](v19, "URL"));
          v48 = sub_100006280((uint64_t)-[__CFString downloadRoute](v15, "downloadRoute"));
...
LABEL_49:
      ...
      v39 = (os_log_s *)qword_10002E828;
      if (os_log_type_enabled((os_log_t)qword_10002E828, OS_LOG_TYPE_DEBUG))
      {
...
LABEL_43:
    ...
    else
    {
      if (v27 < 0xC8)
      {
        ...
        v38 = (os_log_s *)(id)qword_10002E828;
      ...
      if ((unint64_t)(v55 - 200) >= 0x64)
      {
        ...
        __int16 v42 = (os_log_s *)qword_10002E828;
        if (os_log_type_enabled((os_log_t)qword_10002E828, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 134218242;
          v59 = v55;
...
- (void)URLSession:(id)a3 dataTask:(id)a4 didReceiveData:(id)a5
{
  ...
  if (v12)
  {
    ...
    if ((unint64_t)v15 > 0x20000)
    {
      ...
      id v16 = (os_log_s *)qword_10002E828;
...
- (unint64_t)_maximumActiveTaskCountForSessionID:(unsigned __int8)a3
{
  if (a3 > 3u) {
    ...
    return qword_1000206B0[(char)a3];
  }
}
...
- (id)_taskStateForDomain:(id)a3 downloadRoute:(unsigned __int8)a4
{
  ...
  uint64_t v18 = sub_100004008;
  id v19 = sub_100004018;
  id v20 = 0LL;
...
- (void)_processDownloadedDataForState:(id)a3
{
  ...
  id v6 = (os_log_s *)(id)qword_10002E828;
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    v22 = (void *)objc_claimAutoreleasedReturnValue([v4 domain]);
    id v23 = sub_100006280((uint64_t)[v4 downloadRoute]);
  ...
  else
  {
    ...
    id v21 = (os_log_s *)qword_10002E828;
    if (os_log_type_enabled((os_log_t)qword_10002E828, OS_LOG_TYPE_ERROR))
    {
      int __buf = 138412546;
      unint64_t v27 = v7;
