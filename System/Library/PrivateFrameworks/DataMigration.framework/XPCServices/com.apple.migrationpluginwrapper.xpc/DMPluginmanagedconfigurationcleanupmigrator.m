...
- (id)activity
{
  return  _os_activity_create( (void *)&_mh_execute_header,  "plugin.managedconfigurationcleanupmigrator",  (os_activity_t)&_os_activity_current,  OS_ACTIVITY_FLAG_DEFAULT);
}
