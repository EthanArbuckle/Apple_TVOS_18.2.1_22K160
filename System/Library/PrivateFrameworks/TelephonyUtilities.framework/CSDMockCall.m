...
+ (id)mockCall
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue([a1 mockCallWithNotificationCenter:v3 fromBlock:0]);
...
+ (id)mockCallFromBlock:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue([a1 mockCallWithNotificationCenter:v5 fromBlock:v4]);
...
- (CSDMockCall)initWithUniqueProxyIdentifier:(id)a3 endpointOnCurrentDevice:(BOOL)a4 notificationCenter:(id)a5
{
  ...
  id v9 = a3;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___CSDMockCall;
  v10 = -[CSDMockCall initWithUniqueProxyIdentifier:endpointOnCurrentDevice:notificationCenter:]( &v15,  "initWithUniqueProxyIdentifier:endpointOnCurrentDevice:notificationCenter:",  v9,  v6,  a5);
  v11 = v10;
  if (v10)
  {
    ...
    v11->_mockAudioInterruptionProviderType = 1LL;
    id v12 = objc_alloc_init(&OBJC_CLASS___TUMutableCallDisplayContext);
    [v12 setName:@"name"];
...
{
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___CSDMockCall;
  id v4 = a3;
  -[CSDMockCall updateWithCall:](&v16, "updateWithCall:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "provider", v16.receiver, v16.super_class));
  -[CSDMockCall setMockProvider:](self, "setMockProvider:", v5);

  BOOL v6 = (void *)objc_claimAutoreleasedReturnValue([v4 handle]);
  -[CSDMockCall setMockHandle:](self, "setMockHandle:", v6);
  ...
  -[CSDMockCall setMockUniqueProxyIdentifier:](self, "setMockUniqueProxyIdentifier:", v7);

  id v8 = (void *)objc_claimAutoreleasedReturnValue([v4 callUUID]);
  -[CSDMockCall setMockCallUUID:](self, "setMockCallUUID:", v8);
  ...
  id v9 = (void *)objc_claimAutoreleasedReturnValue([v4 callerNameFromNetwork]);
  -[CSDMockCall setMockCallerNameFromNetwork:](self, "setMockCallerNameFromNetwork:", v9);

  v10 = (void *)objc_claimAutoreleasedReturnValue([v4 sourceIdentifier]);
  -[CSDMockCall setSourceIdentifier:](self, "setSourceIdentifier:", v10);
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue([v4 contactIdentifiers]);
  -[CSDMockCall setMockContactIdentifiers:](self, "setMockContactIdentifiers:", v11);
  ...
  id v12 = (void *)objc_claimAutoreleasedReturnValue([v4 screenShareAttributes]);
  -[CSDMockCall setMockScreenShareAttributes:](self, "setMockScreenShareAttributes:", v12);
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue([v4 blockedByExtension]);
  -[CSDMockCall setMockBlockedByExtension:](self, "setMockBlockedByExtension:", v13);

  v14 = (void *)objc_claimAutoreleasedReturnValue([v4 callDirectoryIdentityExtension]);
  -[CSDMockCall setMockCallDirectoryIdentityExtension:](self, "setMockCallDirectoryIdentityExtension:", v14);

  id v15 = [v4 filteredOutReason];
  -[CSDMockCall setMockFilteredOutReason:](self, "setMockFilteredOutReason:", v15);
...
- (TUCallDisplayContext)displayContext
{
  ...
  if (mockDisplayContext) {
    return mockDisplayContext;
  }
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___CSDMockCall;
...
- (void)setMockCallStatus:(int)a3
{
  ...
  if (a3 == 1)
  {
    id v4 = (void *)objc_claimAutoreleasedReturnValue(-[CSDMockCall dateConnected](self, "dateConnected"));

    if (!v4)
    {
      id v5 = (id)objc_claimAutoreleasedReturnValue(+[NSDate date](&OBJC_CLASS___NSDate, "date"));
      -[CSDMockCall setMockDateConnected:](self, "setMockDateConnected:", v5);
    }
  }
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___CSDMockCall;
  -[CSDMockCall answerWithRequest:](&v6, "answerWithRequest:", a3);
  -[CSDMockCall setMockCallStatus:](self, "setMockCallStatus:", 1LL);
  ...
  -[CSDCall setDateConnected:](self, "setDateConnected:", v5);
...
- (void)performUplinkMuted:(BOOL)a3
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue(-[CSDMockCall didPerformUplinkMuted](self, "didPerformUplinkMuted"));

  if (v5)
  {
    objc_super v6 = (void (**)(id, BOOL))objc_claimAutoreleasedReturnValue(-[CSDMockCall didPerformUplinkMuted](self, "didPerformUplinkMuted"));
    v6[2](v6, v3);
  }
...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___CSDMockCall;
  id v6 = a3;
  -[CSDCall dialWithRequest:displayContext:](&v11, "dialWithRequest:displayContext:", v6, a4);
  -[CSDMockCall setMockCallStatus:](self, "setMockCallStatus:", 1LL, v11.receiver, v11.super_class);
  id v7 = (void *)objc_claimAutoreleasedReturnValue([v6 provider]);
  -[CSDMockCall setMockProvider:](self, "setMockProvider:", v7);

  id v8 = (void *)objc_claimAutoreleasedReturnValue([v6 handle]);
  -[CSDMockCall setMockHandle:](self, "setMockHandle:", v8);
  ...
  -[CSDMockCall setMockEndpointOnCurrentDevice:](self, "setMockEndpointOnCurrentDevice:", v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSDate date](&OBJC_CLASS___NSDate, "date"));
  -[CSDCall setDateStartedConnecting:](self, "setDateStartedConnecting:", v10);

  -[CSDCall setSoundRegion:](self, "setSoundRegion:", 1LL);
  -[CSDMockCall setMockNeedsManualInCallSounds:](self, "setMockNeedsManualInCallSounds:", 0LL);
  -[CSDCall propertiesChanged](self, "propertiesChanged");
}
...
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___CSDMockCall;
  -[CSDMockCall disconnectWithReason:](&v4, "disconnectWithReason:", *(void *)&a3);
  -[CSDMockCall setMockCallStatus:](self, "setMockCallStatus:", 6LL);
  -[CSDCall propertiesChanged](self, "propertiesChanged");
}
...
- (void)setSharingScreen:(BOOL)a3 attributes:(id)a4
{
  BOOL v4 = a3;
  id v6 = a4;
  -[CSDMockCall setMockSharingScreen:](self, "setMockSharingScreen:", v4);
  -[CSDMockCall setMockScreenShareAttributes:](self, "setMockScreenShareAttributes:", v6);
