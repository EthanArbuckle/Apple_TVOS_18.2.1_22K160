...
- (id)description
{
  ...
  unsigned int v4 = -[CSDAVConferenceConfiguration isCaller](self, "isCaller");
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[CSDAVConferenceConfiguration capabilities](self, "capabilities"));
  v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<%@ %p caller=%d capabilities=%@ deviceRole=%d>",  v3,  self,  v4,  v5,  -[CSDAVConferenceConfiguration deviceRole](self, "deviceRole")));
...
- (int)deviceRole
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[CSDAVConferenceConfiguration capabilities](self, "capabilities"));
