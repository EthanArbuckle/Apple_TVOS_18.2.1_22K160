...
- (CSDProviderCallConfiguration)initWithProviderIdentifier:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___CSDProviderCallConfiguration;
  v5 = -[CSDProviderCallConfiguration init](&v9, "init");
  if (v5)
  {
    if (!v4) {
      +[NSException raise:format:]( &OBJC_CLASS___NSException,  "raise:format:",  NSInvalidArgumentException,  @"%s: parameter '%@' cannot be nil",  "-[CSDProviderCallConfiguration initWithProviderIdentifier:]",  @"providerIdentifier");
    }
