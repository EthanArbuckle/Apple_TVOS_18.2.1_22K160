...
- (UARPServiceUpdaterMatchedIOKitRule)initWithCoder:(id)a3
{
  ...
  return -[UARPServiceUpdaterMatchedIOKitRule initWithIdentifier:registryEntryID:]( self,  "initWithIdentifier:registryEntryID:",  v5,  objc_msgSend( (id)objc_msgSend(a3, "decodeObjectOfClass:forKey:", objc_opt_class(), @"registryEntryID"),  "unsignedLongLongValue"));
}
