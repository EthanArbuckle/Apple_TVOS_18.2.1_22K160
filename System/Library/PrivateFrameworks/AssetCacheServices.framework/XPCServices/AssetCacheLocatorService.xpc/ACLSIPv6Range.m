...
- (ACLSIPv6Range)initWithFirst:(const in6_addr *)a3 andLast:(const in6_addr *)a4
{
  ...
  {
    v13.receiver = self;
    v13.super_class = (Class)&OBJC_CLASS___ACLSIPv6Range;
    v10 = -[ACLSIPv6Range init](&v13, "init");
    v11 = v10;
    if (v10)
    {
...
- (id)description
{
  ...
  uint64_t v5 = objc_claimAutoreleasedReturnValue(+[ACLSNetworkUtilities stringFromInaddr6:](&OBJC_CLASS___ACLSNetworkUtilities, "stringFromInaddr6:"));
  unint64_t v6 = (void *)v5;
  if (v4)
  {
    unint64_t v7 = (void *)objc_claimAutoreleasedReturnValue( +[ACLSNetworkUtilities stringFromInaddr6:]( &OBJC_CLASS___ACLSNetworkUtilities,  "stringFromInaddr6:",  p_last));
    unint64_t v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", @"%@-%@", v6, v7));
  }

  else
  {
    unint64_t v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", @"%@", v5));
  }
...
{
  in6_addr v3 = a3;
  objc_copyStruct(&self->_first, &v3, 16LL, 1, 0);
}
...
{
  in6_addr v3 = a3;
  objc_copyStruct(&self->_last, &v3, 16LL, 1, 0);
}
