...
- (ACLSFileHandleInputStream)initWithFileHandle:(id)a3 fileOffset:(int64_t)a4 length:(int64_t)a5
{
  id v9 = a3;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___ACLSFileHandleInputStream;
  v10 = -[ACLSFileHandleInputStream init](&v13, "init");
  v11 = v10;
  if (v10)
  {
...
- (unint64_t)streamStatus
{
  ...
  if (-[ACLSFileHandleInputStream hasBytesAvailable](self, "hasBytesAvailable")) {
    return self->_status;
  }
...
- (int64_t)read:(char *)a3 maxLength:(unint64_t)a4
{
  ...
  int64_t result = pread(-[NSFileHandle fileDescriptor](self->_fileHandle, "fileDescriptor"), a3, v5, self->_fileOffset);
  if (result >= 1) {
