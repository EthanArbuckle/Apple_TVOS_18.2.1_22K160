...
{
  id v3 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue( +[IDEDataProvider_SceneKit sharedDataProvider]( &OBJC_CLASS___IDEDataProvider_SceneKit,  "sharedDataProvider"));
...
- (id)sampleAttributes:(id)a3 forPIDs:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  v7 = (void *)objc_claimAutoreleasedReturnValue( +[IDEDataProvider_SceneKit sharedDataProvider]( &OBJC_CLASS___IDEDataProvider_SceneKit,  "sharedDataProvider"));
