...
- (id)sampleAttributes:(id)a3 forPIDs:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  v7 = (void *)objc_claimAutoreleasedReturnValue( +[IDEDataProvider_NetworkStatistics sharedDataProvider]( &OBJC_CLASS___IDEDataProvider_NetworkStatistics,  "sharedDataProvider"));
