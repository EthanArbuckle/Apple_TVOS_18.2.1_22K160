...
- (void)encodeWithCoder:(id)a3
{
  ...
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSAssertionHandler currentHandler](&OBJC_CLASS___NSAssertionHandler, "currentHandler"));
...
- (DTCPUClusterInfo)initWithCoder:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___DTCPUClusterInfo;
  id v6 = -[DTCPUClusterInfo init](&v9, "init");
  if (v6)
  {
...
- (id)description
{
  ...
  id v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<%@: %p> cluster id: %lu, flags: 0x%lx",  v5,  self,  self->_clusterID,  self->_clusterFlags));
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___DTCPUClusterInfo;
  result = -[DTCPUClusterInfo init](&v7, "init");
  if (result)
  {
