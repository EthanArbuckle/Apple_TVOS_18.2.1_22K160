...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___OS_remote_device;
  v2 = -[OS_remote_device init](&v6, sel_init);
  if (v2)
  {
    dispatch_queue_t v3 = dispatch_queue_create("remote_device_t", 0LL);
    dq = v2->_dq;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___OS_remote_device;
