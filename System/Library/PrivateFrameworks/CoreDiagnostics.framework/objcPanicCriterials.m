...
- (objcPanicCriterials)initWithCriterials:(id)a3 :(id)a4 :(id)a5 :(id)a6
{
  ...
  id v12 = a4;
  id v13 = a3;
  v14 = -[_SwiftPanicCriterials initWithCriterials::::]( objc_alloc(&OBJC_CLASS____SwiftPanicCriterials),  "initWithCriterials::::",  v13,  v12,  v11,  v10);
...
- (objcPanicCriterials)initWithSwiftPanicCriterials:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___objcPanicCriterials;
