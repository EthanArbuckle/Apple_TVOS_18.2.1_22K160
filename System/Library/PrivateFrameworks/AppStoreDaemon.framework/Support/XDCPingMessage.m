...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___XDCPingMessage;
  id v3 = -[XDCPingMessage description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[XDCPingMessage dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (void)writeTo:(id)a3
{
  uuid = self->_uuid;
  if (uuid) {
    PBDataWriterWriteStringField(a3, uuid, 1LL);
  }
}
