...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___XDCInstallResponse;
  id v3 = -[XDCInstallResponse description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[XDCInstallResponse dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", self->_error));
...
LABEL_34:
    ...
    else if ((v7 >> 3) == 1)
    {
      ...
      if (v14) {
        sub_1001EFD9C((uint64_t)self, v14);
      }
    }
...
- (void)writeTo:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0) {
    PBDataWriterWriteInt32Field(v4, self->_error, 2LL);
  }
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) != 0 && self->_error == *((_DWORD *)v4 + 2))
    {
      BOOL v7 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  unint64_t v3 = (unint64_t)-[NSMutableArray hash](self->_externalIDStrings, "hash");
  if ((*(_BYTE *)&self->_has & 1) != 0) {
    uint64_t v4 = 2654435761LL * self->_error;
  }
  else {
    uint64_t v4 = 0LL;
  }
