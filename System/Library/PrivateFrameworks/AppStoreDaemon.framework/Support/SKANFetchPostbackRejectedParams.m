...
- (_TtC9appstored31SKANFetchPostbackRejectedParams)initWithError:(id)a3 params:(id)a4
{
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC9appstored31SKANFetchPostbackRejectedParams_params) = (Class)a4;
  ...
  id v8 = a3;
  id v9 = a4;
  return -[SKANFetchPostbackRejectedParams init](&v11, "init");
}

- (_TtC9appstored31SKANFetchPostbackRejectedParams)init
{
  result = (_TtC9appstored31SKANFetchPostbackRejectedParams *)_swift_stdlib_reportUnimplementedInitializer( "appstored.SKANFetchPostbackRejectedParams",  41LL,  "init()",  6LL,  0LL);
  __break(1u);
  return result;
}
