...
{
  v31.receiver = self;
  v31.super_class = (Class)&OBJC_CLASS___IAPInfoManager;
  v2 = -[IAPInfoManager init](&v31, "init");
  if (v2)
  {
    v3 = objc_alloc(&OBJC_CLASS___IAPInfoDatabaseStore);
    ...
    dispatch_queue_t v12 = dispatch_queue_create("com.apple.AppStoreFoundation.IAPInfoManager", v11);
    ...
    if ((v5 & 1) == 0)
    {
      ...
      sub_10028EF00((uint64_t)v29, v2, 23LL);
    }
  }
...
{
  id v6 = a5;
  v7 = sub_100316A0C((uint64_t)&OBJC_CLASS___XPCRequestToken, 1);
