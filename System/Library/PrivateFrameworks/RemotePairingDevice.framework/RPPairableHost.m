...
- (void)registerChangeHandlerOnTargetQueue:(id)a3 handler:(id)a4
{
  ...
  *(void *)(v7 + 16) = v6;
  id v8 = a3;
  v9 = self;
  RPPairableHost.registerChangeHandler(on:handler:)(a3, (uint64_t)sub_188467C4C, v7);
...
- (void)pairInvokingHandlersOnQueue:(id)a3 handlingPairingChallengesUsing:(id)a4 handlingCompletionUsing:(id)a5
{
  ...
  *(void *)(v11 + 16) = v9;
  id v12 = a3;
  v13 = self;
  RPPairableHost.pair(invokingHandlersOn:handlingPairingChallengesUsing:completionHandler:)( a3,  (uint64_t)sub_188467C3C,  v10,  (uint64_t)sub_1884294D8,  v11);
