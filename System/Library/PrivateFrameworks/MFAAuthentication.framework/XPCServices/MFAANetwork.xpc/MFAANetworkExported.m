...
- (void)requestMetadataForToken:(id)a3 withUUID:(id)a4 requestedLocale:(id)a5 requestInfo:(id)a6 withReply:(id)a7
{
  ...
  id v14 = a4;
  id v15 = a3;
  id v16 = (id)objc_claimAutoreleasedReturnValue(+[MFAANetwork sharedInstance](&OBJC_CLASS___MFAANetwork, "sharedInstance"));
...
- (void)requestActivationForToken:(id)a3 withUUID:(id)a4 withReply:(id)a5
{
  ...
  id v8 = a4;
  id v9 = a3;
  id v10 = (id)objc_claimAutoreleasedReturnValue(+[MFAANetwork sharedInstance](&OBJC_CLASS___MFAANetwork, "sharedInstance"));
...
- (void)requestMetadataForCertSerial:(id)a3 issuerSeq:(id)a4 ppid:(id)a5 requestedLocale:(id)a6 requestInfo:(id)a7 withReply:(id)a8
{
  ...
  id v17 = a4;
  id v18 = a3;
  id v19 = (id)objc_claimAutoreleasedReturnValue(+[MFAANetwork sharedInstance](&OBJC_CLASS___MFAANetwork, "sharedInstance"));
...
- (void)validateCertSerial:(id)a3 issuerSeq:(id)a4 ppid:(id)a5 withReply:(id)a6
{
  ...
  id v11 = a4;
  id v12 = a3;
  id v13 = (id)objc_claimAutoreleasedReturnValue(+[MFAANetwork sharedInstance](&OBJC_CLASS___MFAANetwork, "sharedInstance"));
...
- (void)addPairingWithToken:(id)a3 withReply:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = (id)objc_claimAutoreleasedReturnValue(+[MFAANetwork sharedInstance](&OBJC_CLASS___MFAANetwork, "sharedInstance"));
