...
- (id)description
{
  v3 = (void *)NSString;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___TPPBSecureElementIdentity;
  v4 = -[TPPBSecureElementIdentity description](&v8, sel_description);
  v5 = -[TPPBSecureElementIdentity dictionaryRepresentation](self, "dictionaryRepresentation");
