...
- (_CPLCloudKitSimpleCacheEntry)initWithKey:(id)a3 object:(id)a4 expirationDate:(id)a5
{
  ...
  id v11 = a5;
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS____CPLCloudKitSimpleCacheEntry;
  v12 = -[_CPLCloudKitSimpleCacheEntry init](&v17, "init");
  v13 = v12;
  if (v12)
  {
...
- (int64_t)compare:(id)a3
{
  return -[NSDate compare:](self->_expirationDate, "compare:", *((void *)a3 + 3));
}
