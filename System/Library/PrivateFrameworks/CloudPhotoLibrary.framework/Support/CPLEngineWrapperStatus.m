...
- (CPLEngineWrapperStatus)initWithWrapper:(id)a3 clientCount:(unint64_t)a4 isOpened:(BOOL)a5 openError:(id)a6
{
  BOOL v6 = a5;
  id v10 = a6;
  v11 = (void *)objc_claimAutoreleasedReturnValue([a3 parameters]);
  v12 = -[CPLEngineWrapperStatus initWithParameters:clientCount:isOpened:openError:]( self,  "initWithParameters:clientCount:isOpened:openError:",  v11,  a4,  v6,  v10);
