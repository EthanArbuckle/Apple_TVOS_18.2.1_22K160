...
+ (Class)featuresType
{
  return (Class)objc_opt_class(&OBJC_CLASS___CPLCKAvailabilityRequest);
}

- (NSString)description
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___CPLCKFeatureAvailabilityRequest;
  v3 = -[CPLCKFeatureAvailabilityRequest description](&v8, "description");
  id v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[CPLCKFeatureAvailabilityRequest dictionaryRepresentation](self, "dictionaryRepresentation"));
...
{
  id v8 = a3;
  if (-[CPLCKFeatureAvailabilityRequest featuresCount](self, "featuresCount"))
  {
    [v8 clearFeatures];
    unint64_t v4 = -[CPLCKFeatureAvailabilityRequest featuresCount](self, "featuresCount");
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0LL; i != v5; ++i)
      {
        id v7 = (void *)objc_claimAutoreleasedReturnValue(-[CPLCKFeatureAvailabilityRequest featuresAtIndex:](self, "featuresAtIndex:", i));
        [v8 addFeatures:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[CPLCKFeatureAvailabilityRequest addFeatures:]( self,  "addFeatures:",  *(void *)(*((void *)&v9 + 1) + 8LL * (void)v8),  (void)v9);
        id v8 = (char *)v8 + 1;
      }
