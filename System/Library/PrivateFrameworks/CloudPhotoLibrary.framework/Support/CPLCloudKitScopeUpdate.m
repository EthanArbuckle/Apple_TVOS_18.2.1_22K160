...
- (CPLCloudKitScopeUpdate)initWithCloudKitScope:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___CPLCloudKitScopeUpdate;
  v6 = -[CPLCloudKitScopeUpdate init](&v9, "init");
  v7 = v6;
  if (v6) {
...
- (NSData)updatedTransportScope
{
  return -[CPLCloudKitScope transportScope](self->_cloudKitScope, "transportScope");
}
