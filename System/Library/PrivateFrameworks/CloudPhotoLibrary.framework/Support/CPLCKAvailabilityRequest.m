...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___CPLCKAvailabilityRequest;
  id v3 = -[CPLCKAvailabilityRequest description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[CPLCKAvailabilityRequest dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = sub_100040C48(self->_feature);
...
{
  if ((*(_BYTE *)&self->_has & 1) != 0) {
    PBDataWriterWriteInt32Field(a3, self->_feature, 1LL);
  }
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 12) & 1) != 0 && self->_feature == *((_DWORD *)v4 + 2))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
...
{
  if ((*(_BYTE *)&self->_has & 1) != 0) {
    return 2654435761LL * self->_feature;
  }
  else {
    return 0LL;
  }
