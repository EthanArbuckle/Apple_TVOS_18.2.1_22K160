...
- (id)description
{
  ...
  if (trashed) {
    v6 = -[NSString initWithFormat:]( v4,  "initWithFormat:",  @"+%lu/%lu/-%lu (%lu trashed)",  adds,  self->_modifies,  self->_deletes,  self->_trashed);
  }
  else {
    v6 = -[NSString initWithFormat:]( v4,  "initWithFormat:",  @"+%lu/%lu/-%lu",  adds,  self->_modifies,  self->_deletes,  v8);
  }
  return v6;
}
