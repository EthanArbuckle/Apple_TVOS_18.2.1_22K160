...
{
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___CPLProcessSpecification;
  result = -[CPLProcessSpecification init](&v13, "init");
  if (result)
  {
...
+ (id)baseProcessSpecification
{
  return  [objc_alloc((Class)a1) initWithShouldSignal:0 shouldSample:1 shouldRunMemoryTools:1 shouldRunTaskInfo:1 requiresRoot:0];
}

+ (id)priviledgedProcessSpecification
{
  return  [objc_alloc((Class)a1) initWithShouldSignal:0 shouldSample:1 shouldRunMemoryTools:1 shouldRunTaskInfo:1 requiresRoot:1];
}

+ (id)signalProcessSpecification
{
  return  [objc_alloc((Class)a1) initWithShouldSignal:1 shouldSample:1 shouldRunMemoryTools:1 shouldRunTaskInfo:1 requiresRoot:0];
}
