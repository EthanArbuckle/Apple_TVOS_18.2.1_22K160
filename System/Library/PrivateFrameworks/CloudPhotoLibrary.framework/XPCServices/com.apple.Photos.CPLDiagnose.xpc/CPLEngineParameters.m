...
- (BOOL)matchesParameters:(id)a3
{
  ...
  if (sub_100002AD8((uint64_t)self, clientLibraryBaseURL, v6))
  {
    ...
    if (sub_100002AD8((uint64_t)self, cloudLibraryStateStorageURL, v8))
    {
      ...
      if (sub_100002AD8((uint64_t)self, cloudLibraryResourceStorageURL, v10))
      {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (!v7) {
    sub_10001C738(self, (uint64_t)v8, (uint64_t)a2);
  }
