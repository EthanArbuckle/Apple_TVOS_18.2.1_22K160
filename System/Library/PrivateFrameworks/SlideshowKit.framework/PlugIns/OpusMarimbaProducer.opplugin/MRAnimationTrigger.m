...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MRAnimationTrigger;
  v4 = -[MRAnimationTrigger init](&v6, "init");
  if (v4)
  {
    v4->_action = (MRAction *)a3;
    *(int64x2_t *)&v4->_startValue = vdupq_n_s64(0xC76DB51CC0000000LL);
  }
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRAnimationTrigger;
  -[MRAnimationTrigger dealloc](&v3, "dealloc");
}
