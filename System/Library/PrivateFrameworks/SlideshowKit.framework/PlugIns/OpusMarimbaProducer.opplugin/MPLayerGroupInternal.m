...
- (void)dealloc
{
  ...
  self->backgroundAudioID = 0LL;
  self->authoredVersionInfo = 0LL;

  self->liveLock = 0LL;
  self->uuid = 0LL;

  self->layerKeyDictionary = 0LL;
  self->initialState = 0LL;
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___MPLayerGroupInternal;
  -[MPLayerGroupInternal dealloc](&v4, "dealloc");
}
