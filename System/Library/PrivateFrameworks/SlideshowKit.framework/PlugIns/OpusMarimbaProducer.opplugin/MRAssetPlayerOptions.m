...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___MRAssetPlayerOptions;
  result = -[MRAssetPlayerOptions init](&v8, "init");
  if (result)
  {
...
- (void)dealloc
{
  self->_initialImage = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRAssetPlayerOptions;
  -[MRAssetPlayerOptions dealloc](&v3, "dealloc");
}
...
- (void)setInitialImage:(id)a3
{
  ...
  if (initialImage != a3)
  {
    -[MRImage releaseByUser](initialImage, "releaseByUser");
