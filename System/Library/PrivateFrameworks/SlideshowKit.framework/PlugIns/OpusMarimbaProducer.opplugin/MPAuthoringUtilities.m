...
+ (BOOL)ignoreClusteringForImages:(id)a3 withOptions:(id)a4
{
  ...
  v6 = (const __CFString *)[a4 objectForKey:kMPAuthoringStyleID];
  if (v6) {
    v7 = v6;
  }
  else {
...
+ (unint64_t)croppingModeFromOptions:(id)a3
{
  ...
  unint64_t result = (unint64_t)objc_msgSend( objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "descriptionForStyleID:",  objc_msgSend(a1, "styleFromOptions:", a3)),  "objectForKey:",  @"croppingMode");
  if (result) {
    return (unint64_t)[(id)result unsignedIntegerValue];
  }
  return result;
...
+ (double)kenBurnsLikelihoodFromOptions:(id)a3
{
  ...
  objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "defaultAutoKenBurnsLikelihoodForZIndex:ofStyle:",  +[MPAuthoringUtilities layerIndexFromOptions:](MPAuthoringUtilities, "layerIndexFromOptions:", a3),  +[MPAuthoringUtilities styleFromOptions:](MPAuthoringUtilities, "styleFromOptions:", a3));
  return result;
}
...
+ (BOOL)alignToBeatsFromOptions:(id)a3
{
  BOOL v4 = (char *)+[MPAuthoringUtilities audioScalingModeFromOptions:]( &OBJC_CLASS___MPAuthoringUtilities,  "audioScalingModeFromOptions:",  a3) == (char *)&dword_0 + 1;
...
+ (CGColor)backgroundColorFromOptions:(id)a3
{
  ...
  if (!v4)
  {
    ...
    return +[MPUtilities blackCGColor](&OBJC_CLASS___MPUtilities, "blackCGColor");
  }
  ...
  int64_t result = +[MPUtilities CGColorFromString:](&OBJC_CLASS___MPUtilities, "CGColorFromString:", v6);
  if (!result) {
    return +[MPUtilities blackCGColor](&OBJC_CLASS___MPUtilities, "blackCGColor");
  }
  return result;
...
+ (double)durationPerEffectFromOptions:(id)a3
{
  ...
  if (!v5 || ([v5 doubleValue], result == -1.0)) {
    objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "defaultEffectDurationForLayer:ofStyle:",  objc_msgSend(a1, "layerIndexFromOptions:", a3),  objc_msgSend(a1, "styleFromOptions:", a3));
  }
  return result;
}
...
+ (double)transitionDurationFromOptions:(id)a3
{
  ...
  if (!v5 || ([v5 doubleValue], result == -1.0))
  {
    id v7 = +[MPStyleManager sharedManager](&OBJC_CLASS___MPStyleManager, "sharedManager");
...
{
  time_t v4 = time(0LL);
  if ((char *)+[MPAuthoringUtilities presentationOrderFromOptions:]( &OBJC_CLASS___MPAuthoringUtilities,  "presentationOrderFromOptions:",  a3) == (char *)&dword_0 + 3) {
    return v4;
  }
...
+ (id)effectListFromOptions:(id)a3
{
  ...
  if (!result) {
    return objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "effectPresetsForLayerIndex:ofStyleID:",  +[MPAuthoringUtilities layerIndexFromOptions:]( MPAuthoringUtilities,  "layerIndexFromOptions:",  a3),  +[MPAuthoringUtilities styleFromOptions:](MPAuthoringUtilities, "styleFromOptions:", a3));
  }
  return result;
}
...
+ (id)transitionListFromOptions:(id)a3
{
  ...
  if (!result) {
    return objc_msgSend( objc_msgSend( a1,  "layerDescriptionForLayerWithZIndex:forStyle:",  objc_msgSend(a1, "layerIndexFromOptions:", a3),  objc_msgSend(a1, "styleFromOptions:", a3)),  "objectForKey:",  @"transitionPresets");
  }
  return result;
}
...
+ (id)outroEffectIDFromOptions:(id)a3
{
  ...
  return objc_msgSend( +[MPAuthoringUtilities layerDescriptionForLayerWithZIndex:forStyle:]( MPAuthoringUtilities,  "layerDescriptionForLayerWithZIndex:forStyle:",  objc_msgSend(a1, "layerIndexFromOptions:", a3),  objc_msgSend(a1, "styleFromOptions:", a3)),  "objectForKey:",  @"outroEffect");
}
...
+ (id)introEffectIDFromOptions:(id)a3
{
  ...
  if (!result) {
    return objc_msgSend( +[MPAuthoringUtilities layerDescriptionForLayerWithZIndex:forStyle:]( MPAuthoringUtilities,  "layerDescriptionForLayerWithZIndex:forStyle:",  objc_msgSend(a1, "layerIndexFromOptions:", a3),  objc_msgSend(a1, "styleFromOptions:", a3)),  "objectForKey:",  @"introEffect");
  }
  return result;
}
...
+ (id)titleEffectFromOptions:(id)a3
{
  ...
  if (!v5) {
    return objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "titleEffectLayoutForStyleID:",  objc_msgSend(a1, "styleFromOptions:", a3));
  }
  id v7 = v5;
  ...
  if ((objc_opt_isKindOfClass(v7, v11) & 1) != 0) {
    return +[NSDictionary dictionaryWithObjectsAndKeys:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjectsAndKeys:",  @"background",  @"layer",  v7,  @"presetID",  0LL);
  }
  else {
    return objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "titleEffectLayoutForStyleID:",  objc_msgSend(a1, "styleFromOptions:", a3));
  }
...
+ (id)idFromPresetID:(id)a3
{
  if ([a3 rangeOfString:@"/"] == (id)0x7FFFFFFFFFFFFFFFLL) {
    ...
    return objc_msgSend(a3, "substringToIndex:", objc_msgSend(a3, "rangeOfString:", @"/"));
  }
}
...
+ (id)lastPresetFromOptions:(id)a3
{
  ...
  if (!result) {
    return objc_msgSend( +[MPAuthoringUtilities layerDescriptionForLayerWithZIndex:forStyle:]( MPAuthoringUtilities,  "layerDescriptionForLayerWithZIndex:forStyle:",  objc_msgSend(a1, "layerIndexFromOptions:", a3),  objc_msgSend(a1, "styleFromOptions:", a3)),  "objectForKey:",  @"lastPreset");
  }
  return result;
}
...
+ (id)loopTransitionIDFromOptions:(id)a3
{
  return objc_msgSend( +[MPAuthoringUtilities layerDescriptionForLayerWithZIndex:forStyle:]( MPAuthoringUtilities,  "layerDescriptionForLayerWithZIndex:forStyle:",  objc_msgSend(a1, "layerIndexFromOptions:"),  objc_msgSend(a1, "styleFromOptions:", a3)),  "objectForKey:",  @"loopTransition");
}

+ (id)exportTransitionIDFromOptions:(id)a3
{
  return objc_msgSend( +[MPAuthoringUtilities layerDescriptionForLayerWithZIndex:forStyle:]( MPAuthoringUtilities,  "layerDescriptionForLayerWithZIndex:forStyle:",  objc_msgSend(a1, "layerIndexFromOptions:"),  objc_msgSend(a1, "styleFromOptions:", a3)),  "objectForKey:",  @"exportTransition");
}
...
+ (int64_t)numberOfLayersFromOptions:(id)a3
{
  ...
  if (v3) {
    return (int64_t)objc_msgSend( objc_msgSend( objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "descriptionForStyleID:",  v3),  "objectForKey:",  @"layout"),  "count");
  }
  else {
    return 1LL;
  }
...
+ (unint64_t)reorderModeFromOptions:(id)a3
{
  ...
  unint64_t result = (unint64_t)objc_msgSend( objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "descriptionForStyleID:",  v5),  "objectForKey:",  @"reorderMode");
  if (result) {
    return (unint64_t)[(id)result integerValue];
  }
  return result;
...
+ (BOOL)pickEffectsEvenlyByIDWithOptions:(id)a3
{
  ...
  else
  {
    ...
    if (v6
      ...
      && (id v9 = [v7 objectForKey:@"PlatformSpecific"], LODWORD(v6) = MRIsAppleTV(), (_DWORD)v6)
...
+ (unint64_t)presentationOrderFromOptions:(id)a3
{
  ...
  if (v5) {
    ...
    return (unint64_t)objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "mediaPresentationOrderForStyleID:",  v4);
  }
}
...
+ (unint64_t)regionOfInterestPickModeFromOptions:(id)a3
{
  ...
  if (v5) {
    ...
    return (unint64_t)objc_msgSend( +[MPStyleManager sharedManager](MPStyleManager, "sharedManager"),  "regionOfInterestPickModeForStyleID:",  v4);
  }
}
