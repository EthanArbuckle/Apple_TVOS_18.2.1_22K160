...
- (void)dealloc
{
  ...
  self->_previousSlideInfo = 0LL;
  self->_previousSlideID = 0LL;

  self->_nextSlideInfo = 0LL;
  self->_nextSlideID = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRSlideFocusState;
  -[MRSlideFocusState dealloc](&v3, "dealloc");
}
