...
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___MCMotionTrigger;
...
- (void)demolish
{
  self->_key = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MCMotionTrigger;
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___MCMotionTrigger;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MCMotionTrigger;
  -[MCAction _copySelfToSnapshot:](&v6, "_copySelfToSnapshot:");
  key = self->_key;
  if (key) {
    *((void *)a3 + 3) = -[NSString copy](key, "copy");
  }
