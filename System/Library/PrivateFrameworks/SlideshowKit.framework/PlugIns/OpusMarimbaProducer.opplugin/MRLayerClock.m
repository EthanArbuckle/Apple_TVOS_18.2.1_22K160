...
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___MRLayerClock;
  v4 = -[MRLayerClock init](&v12, "init");
  if (v4)
  {
    id v5 = [a3 container];
    uint64_t v7 = objc_opt_class(&OBJC_CLASS___MCContainerSerializer, v6);
    if ((objc_opt_isKindOfClass(v5, v7) & 1) != 0
      || (id v8 = [a3 container],
          uint64_t v10 = objc_opt_class(&OBJC_CLASS___MCContainerEffect, v9),
    ...
    -[MRLayerClock syncToPlug:](v4, "syncToPlug:", a3);
...
- (void)reactivateWithPlug:(id)a3
{
  ...
  *(_OWORD *)&self->_internalTimeOffset = xmmword_1F7000;
...
- (void)updateForExternalTime:(double)externalTimeForPauseInversion
{
  ...
  double phaseInDuration = self->_phaseInDuration;
  double loopDuration = self->_loopDuration;
...
LABEL_41:
  unint64_t v21 = flags & 0xFFFFFFFFFFFFFFE7LL;
  self->_unint64_t flags = flags & 0xFFFFFFFFFFFFFFE7LL;
