...
+ (void)initialize
{
  ...
  if (!qword_2B0580) {
    qword_2B0580 = objc_alloc_init(&OBJC_CLASS___MRShaderManager);
  }
}

+ (id)sharedManager
{
  return (id)qword_2B0580;
}

- (MRShaderManager)init
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MRShaderManager;
  objc_super v2 = -[MRShaderManager init](&v6, "init");
  if (v2)
  {
    v2->mGLShadersPerContext = objc_alloc_init(&OBJC_CLASS___NSMutableDictionary);
    v2->mShadersPerContext = objc_alloc_init(&OBJC_CLASS___NSMutableDictionary);
    v2->mShaderDescriptions = objc_alloc_init(&OBJC_CLASS___NSMutableDictionary);
    v3 = objc_alloc_init(&OBJC_CLASS___NSLock);
    v2->mGLShadersPerContextLock = v3;
    -[NSLock setName:](v3, "setName:", @"MRShaderManager.glShadersPerContextLock");
    v4 = objc_alloc_init(&OBJC_CLASS___NSLock);
    v2->mShadersPerContextLock = v4;
    -[NSLock setName:](v4, "setName:", @"MRShaderManager.shadersPerContextLock");
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRShaderManager;
  -[MRShaderManager dealloc](&v3, "dealloc");
}

- (void)cleanup
{
  self->mGLShadersPerContext = 0LL;
  self->mShadersPerContext = 0LL;

  self->mShaderDescriptions = 0LL;
}

- (void)releaseResources
{
  id v3 = -[NSMutableDictionary allKeys](self->mGLShadersPerContext, "allKeys");
  __int128 v8 = 0u;
  __int128 v9 = 0u;
  __int128 v10 = 0u;
  __int128 v11 = 0u;
  ...
  -[NSMutableDictionary removeAllObjects](self->mGLShadersPerContext, "removeAllObjects");
  -[NSMutableDictionary removeAllObjects](self->mShadersPerContext, "removeAllObjects");
}
...
- (void)forgetContext:(id)a3
{
  if (a3 && [a3 baseContext] == a3)
  {
    ...
    v7 = -[MURetainingKey initWithObject:](objc_alloc(&OBJC_CLASS___MURetainingKey), "initWithObject:", a3);
    mShadersPerContext = self->mShadersPerContext;
    objc_sync_enter(mShadersPerContext);
    -[NSMutableDictionary removeObjectForKey:](self->mShadersPerContext, "removeObjectForKey:", v7);
    ...
    __int128 v16 = 0u;
    __int128 v17 = 0u;
    id v10 = -[NSMutableDictionary objectForKey:](self->mGLShadersPerContext, "objectForKey:", v7, 0LL);
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0LL; i != v11; i = (char *)i + 1)
        {
          ...
          glDeleteShader((GLuint)[*(id *)(*((void *)&v14 + 1) + 8 * (void)i) intValue]);
        }
    ...
    -[NSMutableDictionary removeObjectForKey:](self->mGLShadersPerContext, "removeObjectForKey:", v7);
...
- (unsigned)_glShaderForID:(id)a3 inBaseContext:(id)a4 isFragmentShader:(BOOL)a5 withArguments:(id)a6
{
  ...
  mGLShadersPerContext = self->mGLShadersPerContext;
  objc_sync_enter(mGLShadersPerContext);
  uint64_t v12 = -[MURetainingKey initWithObject:](objc_alloc(&OBJC_CLASS___MURetainingKey), "initWithObject:", a4);
  v13 = (NSMutableDictionary *)-[NSMutableDictionary objectForKey:](self->mGLShadersPerContext, "objectForKey:", v12);
  __int128 v14 = v13;
  if (v13)
  {
    unsigned int Shader = objc_msgSend(-[NSMutableDictionary objectForKey:](v13, "objectForKey:", a3), "integerValue");
  }

  else
  {
    __int128 v14 = objc_alloc_init(&OBJC_CLASS___NSMutableDictionary);
    -[NSMutableDictionary setObject:forKey:](self->mGLShadersPerContext, "setObject:forKey:", v14, v12);
  ...
  if (!Shader)
  {
    ...
    if (v7)
    {
      ...
      for (uint64_t i = 0LL; i != 3; ++i)
      {
        ...
        if (v21)
        {
          ...
          if ((-[NSMutableSet containsObject:](v19, "containsObject:", v22) & 1) == 0)
          {
            id v23 = -[NSMutableDictionary objectForKey:]( self->mShaderDescriptions,  "objectForKey:",  +[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", @"Filter%@", v22));
            if (v23) {
              id v18 = [v18 stringByAppendingString:v23];
            }
          }

          -[NSMutableSet addObject:](v19, "addObject:", v22);
        }
      }
    ...
    if (string)
    {
      v25 = +[EAGLContext currentContext](&OBJC_CLASS___EAGLContext, "currentContext");
      v26 = v25;
      if (v25 != [a4 glContext]) {
      ...
      glShaderSource(Shader, 1, (const GLchar *const *)&string, 0LL);
      glCompileShader(Shader);
      -[NSMutableDictionary setObject:forKey:]( v14,  "setObject:forKey:",  +[NSNumber numberWithInteger:](&OBJC_CLASS___NSNumber, "numberWithInteger:", Shader),  a3);
      if (+[EAGLContext currentContext](&OBJC_CLASS___EAGLContext, "currentContext") != v25) {
        +[EAGLContext setCurrentContext:](&OBJC_CLASS___EAGLContext, "setCurrentContext:", v25);
      }
    }
...
- (id)shaderForShaderID:(id)a3 inContext:(id)a4 withArguments:(id)a5
{
  ...
  id v10 = +[MRShaderManager shaderKeyForShaderID:andArguments:]( &OBJC_CLASS___MRShaderManager,  "shaderKeyForShaderID:andArguments:",  a3,  a5);
  mShadersPerContext = self->mShadersPerContext;
  objc_sync_enter(mShadersPerContext);
  uint64_t v12 = -[MURetainingKey initWithObject:](objc_alloc(&OBJC_CLASS___MURetainingKey), "initWithObject:", v9);
  v13 = (NSMutableDictionary *)-[NSMutableDictionary objectForKey:](self->mShadersPerContext, "objectForKey:", v12);
  __int128 v14 = v13;
  if (v13)
  {
    __int128 v15 = (MRShader *)-[NSMutableDictionary objectForKey:](v13, "objectForKey:", v10);
  }

  else
  {
    __int128 v14 = objc_alloc_init(&OBJC_CLASS___NSMutableDictionary);
    -[NSMutableDictionary setObject:forKey:](self->mShadersPerContext, "setObject:forKey:", v14, v12);
  ...
  if (!v15)
  {
    uint64_t v16 = -[MRShaderManager _glShaderForID:inBaseContext:isFragmentShader:withArguments:]( self,  "_glShaderForID:inBaseContext:isFragmentShader:withArguments:",  v10,  v9,  1LL,  a5);
    if ((_DWORD)v16)
    {
      id v17 = -[NSMutableDictionary objectForKey:](self->mShaderDescriptions, "objectForKey:", a3);
      id v18 = (const __CFString *)[v17 objectForKey:@"vertexShader"];
      if (v18) {
        v19 = v18;
      }
      else {
      ...
      __int128 v15 = -[MRShader initWithShaderID:shaderKey:description:vertexShader:andFragmentShader:inContext:]( objc_alloc(&OBJC_CLASS___MRShader),  "initWithShaderID:shaderKey:description:vertexShader:andFragmentShader:inContext:",  a3,  v10,  v17,  -[MRShaderManager _glShaderForID:inBaseContext:isFragmentShader:withArguments:]( self,  "_glShaderForID:inBaseContext:isFragmentShader:withArguments:",  v19,  v9,  0LL,  a5),  v16,  v9);
      -[NSMutableDictionary setObject:forKey:](v14, "setObject:forKey:", v15, v10);
    }
  ...
  objc_sync_exit(mShadersPerContext);
  -[MRShader setUseContext:](v15, "setUseContext:", a4);
  return v15;
}
...
+ (id)shaderKeyForShaderID:(id)a3 andArguments:(id)a4
{
  ...
  {
    if (v12 || [v10 length]) {
      return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@|%d|%@|%@|%@",  a3,  v7,  v8,  v9,  v10);
    }
    else {
      return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@|%d|%@",  a3,  v7,  v8,  v15,  v16);
    }
  }

  else if (v12 || [v10 length])
  {
    return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@|%d||%@|%@",  a3,  v7,  v9,  v10,  v16);
  }

  else if (v7)
  {
    return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@|%d",  a3,  v7,  v14,  v15,  v16);
  }
...
- (void)registerVertexShaderWithVertexShaderSource:(id)a3 forShaderID:(id)a4
{
  if (-[NSMutableDictionary objectForKey:](self->mShaderDescriptions, "objectForKey:", a4)) {
    NSLog(@"### error: overriding vertex shader for shaderID '%@'", a4);
  }
  -[NSMutableDictionary setObject:forKey:]( self->mShaderDescriptions,  "setObject:forKey:",  +[NSDictionary dictionaryWithObjectsAndKeys:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjectsAndKeys:",  a3,  @"source",  0LL),  a4);
}

- (void)registerShaderWithFragmentShaderSource:(id)a3 andVertexShaderName:(id)a4 forShaderID:(id)a5
{
  if (-[NSMutableDictionary objectForKey:](self->mShaderDescriptions, "objectForKey:", a5)) {
    NSLog(@"### error: overriding shader for shaderID '%@'", a5);
  }
  -[NSMutableDictionary setObject:forKey:]( self->mShaderDescriptions,  "setObject:forKey:",  +[NSDictionary dictionaryWithObjectsAndKeys:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjectsAndKeys:",  a3,  @"source",  a4,  @"vertexShader",  0LL),  a5);
}
