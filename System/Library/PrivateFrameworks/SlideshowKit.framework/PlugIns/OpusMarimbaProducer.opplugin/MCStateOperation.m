...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MCStateOperation;
...
- (void)demolish
{
  self->_stateKey = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MCStateOperation;
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___MCStateOperation;
...
- (void)_copySelfToSnapshot:(id)a3
{
  ...
  stateKey = self->_stateKey;
  if (stateKey) {
    *((void *)a3 + 3) = -[NSString copy](stateKey, "copy");
  }
}
