...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___MRPanZoomRotationGestureRecognizer;
  result = -[MRGestureRecognizer initWithRenderer:startAction:andSender:]( &v8,  "initWithRenderer:startAction:andSender:",  a3,  a4,  a6);
  if (result)
  {
...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___MRPanZoomRotationGestureRecognizer;
  objc_super v8 = -[MRGestureRecognizer initWithRenderer:startAction:andSender:]( &v11,  "initWithRenderer:startAction:andSender:",  a3,  0LL,  a6);
  v9 = v8;
  if (v8)
  {
    v8->_direction = a5;
    -[MRGestureRecognizer setEndAction:](v8, "setEndAction:", a4);
  }
...
{
  v23.receiver = self;
  v23.super_class = (Class)&OBJC_CLASS___MRPanZoomRotationGestureRecognizer;
  objc_super v8 = -[MRGestureRecognizer initWithRenderer:startAction:andSender:]( &v23,  "initWithRenderer:startAction:andSender:",  a3,  0LL,  a6);
  v9 = v8;
  if (v8)
  {
    v8->_direction = a5;
    ...
    v9->_type = v11;
    if (-[NSString isEqualToString:](v11, "isEqualToString:", @"panTransition"))
    {
      id v12 = objc_msgSend(objc_msgSend(a4, "attributes"), "objectForKey:", @"transitionAction");
      v13 = objc_alloc_init(&OBJC_CLASS___MCActionTrigger);
      id v14 = [v12 objectForKey:@"targetIDInPage"];
      if (!v14) {
        id v14 = [a4 targetObjectID];
      }
      -[MCAction setTargetObjectID:](v13, "setTargetObjectID:", v14);
      -[MCActionTrigger setActionKey:](v13, "setActionKey:", [v12 objectForKey:@"actionKey"]);
      v15 = -[MRAction initWithAction:inRenderer:]( objc_alloc(&OBJC_CLASS___MRAction),  "initWithAction:inRenderer:",  v13,  v9->super._renderer);
      v9->super._automaticStartAction = v15;
      -[MRAction setSender:](v15, "setSender:", v9->super._sender);
    ...
    if (-[NSString isEqualToString:](v9->_type, "isEqualToString:", @"effectPan"))
    {
...
LABEL_13:
    ...
    if (-[NSString isEqualToString:](v9->_type, "isEqualToString:", @"fastScrub"))
    {
...
- (void)dealloc
{
  self->_type = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRPanZoomRotationGestureRecognizer;
  -[MRPanZoomRotationGestureRecognizer dealloc](&v3, "dealloc");
}

- (void)touchMoved:(id)a3
{
  v76.receiver = self;
  v76.super_class = (Class)&OBJC_CLASS___MRPanZoomRotationGestureRecognizer;
  -[MRGestureRecognizer touchMoved:](&v76, "touchMoved:", a3);
  int state = self->super._state;
  if ((state & 0x11) != 0)
  {
    if ((state & 4) == 0)
    {
      -[MRPanZoomRotationGestureRecognizer _postProcess](self, "_postProcess");
      ...
      if (trackingBoxRadius <= 0.0
        || ((double v5 = self->super._referenceSize.width
          ...
          : (_NF = 1),
            _NF))
      {
        -[MRGestureRecognizer _sendUpdateActions](self, "_sendUpdateActions", trackingBoxRadius, v5);
      }

      else
      {
        self->super._state |= 4u;
        -[MRGestureRecognizer _sendEndActions](self, "_sendEndActions", trackingBoxRadius, v5);
      }
    }
  }
  ...
  else
  {
    ...
    -[MRTouchSet scale](self->super._touchSet, "scale");
    double v21 = v19 * v20;
    ...
    int v42 = v41 | v39 | v35;
    if (-[MRGestureRecognizer requiredTouchCount](self, "requiredTouchCount", 0xBFA999999999999ALL))
    {
      unsigned int v43 = -[MRGestureRecognizer requiredTouchCount](self, "requiredTouchCount");
      BOOL v44 = (id)-[MRTouchSet countOfActiveTouches](self->super._touchSet, "countOfActiveTouches") == (id)v43;
    }
    ...
    if ((v42 & v44) != 0)
    {
      ...
      unint64_t v68 = -[MRTouchSet countOfActiveTouches](self->super._touchSet, "countOfActiveTouches", v64, v47);
...
- (void)touchEnded:(id)a3
{
  ...
  {
    if ((char *)-[NSSet count](-[MRTouchSet touches](self->super._touchSet, "touches"), "count") == (char *)&dword_0 + 1)
    {
      int state = self->super._state;
      if ((state & 1) == 0)
      {
    ...
    v6.receiver = self;
    v6.super_class = (Class)&OBJC_CLASS___MRPanZoomRotationGestureRecognizer;
...
- (void)recognize
{
  ...
  -[MRTouchSet rotation](self->super._touchSet, "rotation");
...
- (void)_addSpecificObjectToAction:(id)a3
{
  int v29 = objc_alloc_init(&OBJC_CLASS___MRGesturePanZoomRotation);
  [a3 time];
  v29->time = v5;
  *(CGPoint *)&v29->double x = self->super._centroidLocation;
  ...
  v29->countOfTouches = -[NSSet count]( -[MRTouchSet touches](self->super._touchSet, "touches"),  "count");
  v29->okToAnimate = 1;
