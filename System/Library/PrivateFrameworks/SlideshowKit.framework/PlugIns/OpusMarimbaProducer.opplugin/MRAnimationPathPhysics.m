...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MRAnimationPathPhysics;
  v4 = -[MRAnimationPathPhysics init](&v6, "init");
  if (v4)
  {
...
- (float)computeValueForTime:(double)a3 withContext:(id)a4
{
  ...
  if (v5 > 0.0)
  {
    ...
    {
      -[MCAnimationPathPhysics staticFriction](self, "staticFriction", a4);
    ...
    {
      -[MCAnimationPathPhysics kineticFriction](self, "kineticFriction", a4);
      double v17 = 1.0;
      ...
      -[MCAnimationPathPhysics skinFriction](self, "skinFriction");
