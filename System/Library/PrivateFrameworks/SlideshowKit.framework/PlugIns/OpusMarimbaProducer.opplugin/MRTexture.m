...
- (MRTexture)initWithSize:(id)a3 inGLContext:(id)a4 options:(id *)a5
{
  return (MRTexture *)-[MRTexture _initWithSize:inGLContext:isFBO:options:]( self,  "_initWithSize:inGLContext:isFBO:options:",  a3,  a4,  0LL,  a5);
}

- (id)initFBOWithSize:(id)a3 inGLContext:(id)a4 options:(id *)a5
{
  return -[MRTexture _initWithSize:inGLContext:isFBO:options:]( self,  "_initWithSize:inGLContext:isFBO:options:",  a3,  a4,  1LL,  a5);
}
...
- (id)_initWithSize:(id)a3 inGLContext:(id)a4 isFBO:(BOOL)a5 options:(id *)a6
{
  ...
  if (v11)
  {
    ...
    if (v7)
    {
      v12 = -[EAGLContext initWithAPI:sharegroup:]( objc_alloc(&OBJC_CLASS___EAGLContext),  "initWithAPI:sharegroup:",  2LL,  -[EAGLContext sharegroup](v11->_parenGLContext, "sharegroup"));
      v11->_glContext = v12;
    }

    if (v12)
    {
      v15 = +[EAGLContext currentContext](&OBJC_CLASS___EAGLContext, "currentContext");
      v16 = v15;
      if (v15 != v12) {
      ...
      glTexImage2D(v11->_textureTarget, 0, v18, v11->_size.width, v11->_size.height, 0, v19, v20, 0LL);
      if (v7)
      {
        ...
        v11->_innerState = objc_alloc_init(&OBJC_CLASS___MRContextState);
      }
...
- (MRTexture)initWithTextureName:(unsigned int)a3 textureTarget:(unsigned int)a4 size:(id)a5 inGLContext:(id)a6 options:(id *)a7
{
  int v13 = -[MRTexture init](self, "init");
  if (v13)
  {
    v14 = (EAGLContext *)a6;
    int v15 = 1111970369;
    ...
    v16 = +[EAGLContext currentContext](&OBJC_CLASS___EAGLContext, "currentContext");
    v17 = v16;
    ...
    if (+[EAGLContext currentContext](&OBJC_CLASS___EAGLContext, "currentContext") != v16) {
      +[EAGLContext setCurrentContext:](&OBJC_CLASS___EAGLContext, "setCurrentContext:", v16);
    }
  }
...
- (MRTexture)initWithData:(void *)a3 width:(unsigned int)a4 height:(unsigned int)a5 rowBytes:(unsigned int)a6 inGLContext:(id)a7 options:(id *)a8
{
  ...
  if (v14)
  {
    ...
    int v15 = +[EAGLContext currentContext](&OBJC_CLASS___EAGLContext, "currentContext");
    v16 = v15;
...
- (MRTexture)initWithDatas:(void *)a3 dataCount:(unint64_t)a4 width:(unsigned int)a5 height:(unsigned int)a6 rowBytes:(unsigned int)a7 inGLContext:(id)a8 options:(id *)a9
{
  ...
  objc_sync_enter(a8);
  int v15 = -[MRTexture init](self, "init");
  if (v15)
  {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRTexture;
  -[MRTexture dealloc](&v3, "dealloc");
}
...
- (void)cleanup
{
  ...
  if (self->_parenGLContext)
  {
    ...
    v6 = v5;
    if (v5 != glContext) {
      +[EAGLContext setCurrentContext:](&OBJC_CLASS___EAGLContext, "setCurrentContext:", glContext);
    }
    ...
    *(void *)&self->_textureName = 0LL;
    ...
    self->_parenGLContext = 0LL;
    self->_innerState = 0LL;
  }
...
- (void)uploadData:(void *)a3 rowBytes:(unint64_t)a4 toRect:(CGRect)a5
{
  ...
  parenGLContext = self->_parenGLContext;
  objc_sync_enter(parenGLContext);
  v12 = +[EAGLContext currentContext](&OBJC_CLASS___EAGLContext, "currentContext");
  int v13 = v12;
...
{
  if (a3) {
    glLabelObjectEXT(0x1702u, self->_textureName, 0, (const GLchar *)[a3 UTF8String]);
  }
}
