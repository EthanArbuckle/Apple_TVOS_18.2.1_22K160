...
- (void)dealloc
{
  ...
  self->_countOfVertices = 0LL;
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___MRHitZoneForVisualFeedback;
  -[MRHitZoneForVisualFeedback dealloc](&v4, "dealloc");
}
