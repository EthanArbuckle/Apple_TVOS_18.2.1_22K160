...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MRRenderArguments;
  v4 = -[MRRenderArguments init](&v6, "init");
  if (v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRRenderArguments;
  -[MRRenderArguments dealloc](&v3, "dealloc");
}
...
- (void)cleanup
{
  ...
  if (renderer)
  {
    ...
    self->_renderer = 0LL;
    self->_preloadQueue = 0LL;

    self->_forcedState = 0LL;
  }

- (id)copyForPreloading
{
  objc_super v3 = -[MRRenderArguments initWithRenderer:]( objc_alloc(&OBJC_CLASS___MRRenderArguments),  "initWithRenderer:",  self->_renderer);
...
- (MRRenderer)renderer
{
  return (MRRenderer *)objc_getProperty(self, a2, 8LL, 1);
}
