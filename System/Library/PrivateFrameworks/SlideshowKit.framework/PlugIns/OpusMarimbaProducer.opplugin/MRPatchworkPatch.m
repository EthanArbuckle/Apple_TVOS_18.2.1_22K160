...
- (MRPatchworkPatch)initWithImage:(id)a3 rectangle:(CGRect)a4 needsBlend:(BOOL)a5
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___MRPatchworkPatch;
  v11 = -[MRPatchworkPatch init](&v13, "init");
  if (v11)
  {
...
- (void)dealloc
{
  self->_image = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRPatchworkPatch;
  -[MRPatchworkPatch dealloc](&v3, "dealloc");
}
