...
+ (id)motionTriggerForTargetPlugObjectID:(id)a3 withKey:(id)a4 duration:(double)a5 andValue:(double)a6
{
  id result = +[MCMotionTrigger motionTriggerForTargetPlugObjectID:withKey:andDuration:]( &OBJC_CLASS___MCMotionTriggerScalar,  "motionTriggerForTargetPlugObjectID:withKey:andDuration:",  a3,  a4,  a5);
  *((double *)result + 7) = a6;
  return result;
}
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___MCMotionTriggerScalar;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MCMotionTriggerScalar;
  id v3 = -[MCMotionTrigger imprint](&v6, "imprint");
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___MCMotionTriggerScalar;
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MCMotionTriggerScalar;
