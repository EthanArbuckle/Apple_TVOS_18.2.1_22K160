...
+ (double)evaluateString:(id)a3 error:(id *)a4;
+ (double)invalidResult;
- (BOOL)isConstant;
- (BOOL)isValueIllegal:(double)a3;
- (MUMathExpressionDoubleBased)init;
- (MUMathExpressionDoubleBased)initWithString:(id)a3 error:(id *)a4;
- (double)evaluate;
...
- (void)cleanup;
- (void)dealloc;
- (void)replaceVariable:(id)a3 withValue:(double)a4;
- (void)resetAllVariables;
- (void)setValue:(double)a3 forVariable:(id)a4;
...
+ (double)evaluateString:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        (*(void (**)(void *, uint64_t, double))(*(void *)v9 + 352LL))(v9, v12, 0.0);
        uint64_t v12 = (v12 + 1);
      }
...
- (MUMathExpressionDoubleBased)init
{
  return -[MUMathExpressionDoubleBased initWithString:error:](self, "initWithString:error:", 0LL, 0LL);
}

- (MUMathExpressionDoubleBased)initWithString:(id)a3 error:(id *)a4
{
  double v6 = (char *)[a3 UTF8String];
  if (v6)
  {
    v7 = v6;
    v11.receiver = self;
    v11.super_class = (Class)&OBJC_CLASS___MUMathExpressionDoubleBased;
    v8 = -[MUMathExpressionBase init](&v11, "init");
    if (v8)
    {
      v9 = operator new(0x28uLL);
      sub_138C9C((int)v9, v7);
      v8->mInterpreter = v9;
      -[MUMathExpressionDoubleBased _resetVariableIndicies](v8, "_resetVariableIndicies");
      -[MUMathExpressionDoubleBased resetAllVariables](v8, "resetAllVariables");
    }
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MUMathExpressionDoubleBased;
...
- (void)_resetVariableIndicies
{
  int v3 = (*(uint64_t (**)(void *))(*(void *)self->mInterpreter + 296LL))(self->mInterpreter);
  if (v3 >= 1)
  {
    uint64_t v4 = 0LL;
    uint64_t v5 = v3;
...
- (void)setValue:(double)a3 forVariable:(id)a4
{
  ...
  if (v6) {
    (*(void (**)(void *, id, double))(*(void *)self->mInterpreter + 352))( self->mInterpreter,  [v6 intValue],  a3);
  }
}
...
- (void)resetAllVariables
{
  ...
  if (v3 >= 1)
  {
    ...
    do
    {
      (*(void (**)(void *, uint64_t, double))(*(void *)self->mInterpreter + 352LL))( self->mInterpreter,  v5,  0.0);
      uint64_t v5 = (v5 + 1);
    }
...
- (void)replaceVariable:(id)a3 withValue:(double)a4
{
  ...
  {
    id v7 = v6;
    uint64_t v8 = (double *)operator new(0x18uLL);
    sub_1387F0(v8);
    *(void *)uint64_t v8 = off_24E1B0;
    v8[2] = a4;
    (*(void (**)(void *, id, double *))(*(void *)self->mInterpreter + 80))( self->mInterpreter,  [v7 intValue],  v8);
    (*(void (**)(double *))(*(void *)v8 + 152LL))(v8);
  }

  -[MUMathExpressionDoubleBased _resetVariableIndicies](self, "_resetVariableIndicies");
}
