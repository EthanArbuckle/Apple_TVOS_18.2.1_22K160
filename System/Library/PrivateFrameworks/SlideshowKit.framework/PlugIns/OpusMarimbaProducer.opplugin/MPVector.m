...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MPVector;
  return -[MPVector init](&v3, "init");
}
...
- (id)CIColorString
{
  ...
  {
    case 1LL:
      id result = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%f",  *(void *)&self->_vector[0],  v3,  v4,  v5);
      break;
    case 2LL:
      id result = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%f %f",  *(void *)&self->_vector[0],  *(void *)&self->_vector[1],  v4,  v5);
      break;
    case 3LL:
      id result = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%f %f %f",  *(void *)&self->_vector[0],  *(void *)&self->_vector[1],  *(void *)&self->_vector[2],  v5);
      break;
    case 4LL:
      id result = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%f %f %f %f",  *(void *)&self->_vector[0],  *(void *)&self->_vector[1],  *(void *)&self->_vector[2],  *(void *)&self->_vector[3]);
      break;
    default:
      id result = &stru_259C60;
      break;
  }
...
- (CGColor)CGColor
{
  return +[MPUtilities CGColorWithRed:green:blue:alpha:]( &OBJC_CLASS___MPUtilities,  "CGColorWithRed:green:blue:alpha:",  self->_vector[0],  self->_vector[1],  self->_vector[2],  self->_vector[3]);
}
...
- (BOOL)isEqualTo:(id)a3
{
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___MPVector, a2);
...
{
  retstr->var1[3] = 0.0;
  *(void *)&retstr->var0 = 0LL;
  *(void *)&retstr->var1[1] = 0LL;
