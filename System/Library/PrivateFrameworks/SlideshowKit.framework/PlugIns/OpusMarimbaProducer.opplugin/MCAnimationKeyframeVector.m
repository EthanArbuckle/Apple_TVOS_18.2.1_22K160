...
{
  uint64_t v5 = *(void *)&a5;
  v8 = objc_alloc_init(&OBJC_CLASS___MCAnimationKeyframeVector);
  -[MCAnimationKeyframe setTimeOffset:](v8, "setTimeOffset:", a4);
  -[MCAnimationKeyframe setTimeOffsetKind:](v8, "setTimeOffsetKind:", v5);
  $421962E1114BB55FD51FACB03C2AC210 v10 = *a3;
  -[MCAnimationKeyframeVector setVector:](v8, "setVector:", &v10);
  return v8;
}
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___MCAnimationKeyframeVector;
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      ...
      do
      {
        objc_msgSend( objc_msgSend(a3, "objectForKey:", objc_msgSend(@"v0", "stringByAppendingFormat:", @"%d", v6)),  "floatValue");
        v4->mVector.v[v6++] = v7;
      }
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___MCAnimationKeyframeVector;
  ...
  if (self->mVector.length)
  {
    ...
    do
    {
      *(float *)&double v4 = self->mVector.v[v5];
      objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v4),  objc_msgSend(@"v0", "stringByAppendingFormat:", @"%d", v5++));
    }
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MCAnimationKeyframeVector;
