...
+ (id)stateOperationForTargetPlugObjectID:(id)a3 withStateKey:(id)a4 andScalar:(double)a5
{
  id result = +[MCStateOperation stateOperationForTargetPlugObjectID:withStateKey:]( &OBJC_CLASS___MCStateOperationScalarSet,  "stateOperationForTargetPlugObjectID:withStateKey:",  a3,  a4);
  *((double *)result + 4) = a5;
  return result;
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___MCStateOperationScalarSet;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___MCStateOperationScalarSet;
  id v3 = -[MCStateOperation imprint](&v6, "imprint");
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___MCStateOperationScalarSet;
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MCStateOperationScalarSet;
