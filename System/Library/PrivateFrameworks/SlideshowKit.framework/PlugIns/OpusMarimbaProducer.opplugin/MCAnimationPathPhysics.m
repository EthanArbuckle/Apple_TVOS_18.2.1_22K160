...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___MCAnimationPathPhysics;
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___MCAnimationPathPhysics;
  id v3 = -[MCAnimationPath imprint](&v5, "imprint");
