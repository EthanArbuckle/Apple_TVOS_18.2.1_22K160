...
+ (id)keyframeWithPoint:(CGPoint)a3 atTime:(double)a4 offsetKind:(int)a5
{
  ...
  double y = a3.y;
  double x = a3.x;
  v9 = objc_alloc_init(&OBJC_CLASS___MCAnimationKeyframe2D);
  -[MCAnimationKeyframe setTimeOffset:](v9, "setTimeOffset:", a4);
  -[MCAnimationKeyframe setTimeOffsetKind:](v9, "setTimeOffsetKind:", v5);
...
{
  v24.receiver = self;
  v24.super_class = (Class)&OBJC_CLASS___MCAnimationKeyframe2D;
...
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___MCAnimationKeyframe2D;
  id v3 = -[MCAnimationKeyframe imprint](&v12, "imprint");
...
- (id)description
{
  ...
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"(%f, %f) at %f (c1=(%f,%f), c2=(%f,%f))",  *(void *)&x,  *(void *)&y,  v5,  *(void *)&self->mC1.x,  *(void *)&self->mC1.y,  *(void *)&self->mC2.x,  *(void *)&self->mC2.y);
}

- (void)_copySelfToSnapshot:(id)a3
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___MCAnimationKeyframe2D;
