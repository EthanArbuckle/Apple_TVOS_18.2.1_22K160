...
- (void)dealloc
{
  self->_hitBlob = 0LL;
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___MRGesture;
  -[MRGesture dealloc](&v3, "dealloc");
}

- (MRHitBlob)hitBlob
{
  return (MRHitBlob *)objc_getProperty(self, a2, 8LL, 1);
}
...
{
  CGPoint v3 = a3;
  objc_copyStruct(&self->_locationInViewAtStart, &v3, 16LL, 1, 0);
}
...
{
  CGPoint v3 = a3;
  objc_copyStruct(&self->_locationInSlideAtStart, &v3, 16LL, 1, 0);
}
...
{
  CGPoint v3 = a3;
  objc_copyStruct(&self->_slideCenterAtStart, &v3, 16LL, 1, 0);
}
...
{
  CGPoint v3 = a3;
  objc_copyStruct(&self->_currentTranslation, &v3, 16LL, 1, 0);
}
