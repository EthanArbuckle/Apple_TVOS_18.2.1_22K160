...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___OKAutoLayoutTileMaker;
  result = -[OKAutoLayoutTileMaker init](&v3, "init");
  if (result)
  {
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___OKAutoLayoutTileMaker;
  -[OKAutoLayoutTileMaker dealloc](&v4, "dealloc");
}
...
- (void)_prepare:(double)a3
{
  ...
  self->_tileTable = -[OKAutoLayoutGrid initWithRows:columns:]( objc_alloc(&OBJC_CLASS___OKAutoLayoutGrid),  "initWithRows:columns:",  self->_rows,  self->_columns);
}
...
- (void)_oneUpLayouts:(id)a3
{
  v23 = +[NSValue valueWithCGRect:]( &OBJC_CLASS___NSValue,  "valueWithCGRect:",  0.0,  0.0,  (double)self->_columns,  (double)self->_rows);
    ...
    if (v7 >= 1)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          {
            v22 = +[NSValue valueWithCGRect:](&OBJC_CLASS___NSValue, "valueWithCGRect:", (double)v9, 0.0, v10, rows);
            double v12 = +[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", &v22, 1LL);
            if (-[OKAutoLayoutTileMaker _isQualifiedOneUpLayout:](self, "_isQualifiedOneUpLayout:", v12)) {
              [a3 addObject:v12];
            }
          }
    ...
    if (v15 >= 1)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          {
            v21 = +[NSValue valueWithCGRect:](&OBJC_CLASS___NSValue, "valueWithCGRect:", 0.0, (double)v17, columns, v19);
            v20 = +[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", &v21, 1LL);
            if (-[OKAutoLayoutTileMaker _isQualifiedOneUpLayout:](self, "_isQualifiedOneUpLayout:", v20)) {
              [a3 addObject:v20];
            }
          }
...
- (void)_findNextFrameFromGrid:(id)a3 curIndex:(unint64_t)a4 maxIndex:(unint64_t)a5 curFrames:(id)a6 layouts:(id)a7
{
  *(void *)&__int128 v25 = a5;
  *((void *)&v25 + 1) = a4;
  if (a4 <= a5)
  {
    if (v25 == 0)
    {
      -[OKAutoLayoutTileMaker _oneUpLayouts:](self, "_oneUpLayouts:", a7);
    }
        ...
        do
        {
          for (i = 0LL; i != v12; i = (char *)i + 1)
          {
            ...
            if (-[OKAutoLayoutTileMaker _isQualifiedFrame:](self, "_isQualifiedFrame:"))
            {
              ...
              [a6 addObject:v15];
              if (*((void *)&v25 + 1) + 1LL <= (unint64_t)v25)
              {
...
- (id)layoutsForFrames:(unint64_t)a3 inRect:(CGRect)a4 borderInPx:(unint64_t)a5
{
  ...
  -[OKAutoLayoutTileMaker _prepare:]( self,  "_prepare:",  (double)(unint64_t)width / (double)(unint64_t)height);
  -[OKAutoLayoutTileMaker _findNextFrameFromGrid:curIndex:maxIndex:curFrames:layouts:]( self,  "_findNextFrameFromGrid:curIndex:maxIndex:curFrames:layouts:",  self->_tileTable,  0LL,  a3 - 1,  v13,  v12);
  ...
  if (v15)
  {
    ...
    do
    {
      for (i = 0LL; i != v16; i = (char *)i + 1)
      {
        ...
        objc_msgSend( v14,  "addObject:",  -[OKAutoLayoutTileMaker convertTiles:toResolution::borderInPx:offsetX:offsetY:]( self,  "convertTiles:toResolution::borderInPx:offsetX:offsetY:",  *(void *)(*((void *)&v20 + 1) + 8 * (void)i),  (unint64_t)width,  (unint64_t)height,  a5,  (unint64_t)x,  (unint64_t)y));
      }
  ...
  if (v17)
  {
    ...
    do
    {
      for (i = 0LL; i != v18; i = (char *)i + 1)
      {
        ...
        [*(id *)(*((void *)&v39 + 1) + 8 * (void)i) CGRectValue];
