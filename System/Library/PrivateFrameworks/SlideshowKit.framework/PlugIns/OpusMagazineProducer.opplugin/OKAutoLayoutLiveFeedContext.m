...
- (void)dealloc
{
  ...
  if (primaryResolutionKey)
  {
    ...
    self->_primaryResolutionKey = 0LL;
  }

  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___OKAutoLayoutLiveFeedContext;
  -[OKAutoLayoutLiveFeedContext dealloc](&v5, "dealloc");
}
