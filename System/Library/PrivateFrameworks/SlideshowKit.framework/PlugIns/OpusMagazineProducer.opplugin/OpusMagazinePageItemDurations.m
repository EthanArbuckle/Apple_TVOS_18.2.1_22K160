...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___OpusMagazinePageItemDurations;
  result = -[OpusMagazinePageItemDurations init](&v3, "init");
  if (result) {
...
- (void)dealloc
{
  ...
  if (itemDurations)
  {
    ...
    self->_itemDurations = 0LL;
  }

  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___OpusMagazinePageItemDurations;
  -[OpusMagazinePageItemDurations dealloc](&v4, "dealloc");
}
