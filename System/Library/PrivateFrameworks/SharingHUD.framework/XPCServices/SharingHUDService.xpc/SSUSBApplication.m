...
+ (id)_systemUIServiceClientSettings
{
  v2 = (void *)objc_claimAutoreleasedReturnValue( +[UIMutableApplicationSceneClientSettings settings]( &OBJC_CLASS___UIMutableApplicationSceneClientSettings,  "settings"));
