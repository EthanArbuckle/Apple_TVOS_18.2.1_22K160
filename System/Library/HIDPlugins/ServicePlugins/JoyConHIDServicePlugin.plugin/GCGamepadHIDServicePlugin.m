  ...
  if (v4)
  {
    ...
    *(_WORD *)&v14->var0 = 25700;
    ...
    if (v4->_device)
    {
      ...
      CFNotificationCenterAddObserver( DarwinNotifyCenter,  v4,  (CFNotificationCallback)sub_5324,  PBSPowerManagerDeviceWillSleepManualDistributedNotification,  v4,  CFNotificationSuspensionBehaviorDeliverImmediately);
...
LABEL_17:
  ...
  if ([v6 isEqualToString:@"ServicePluginDebug"])
  {
    ...
    -[NSMutableDictionary setObject:forKeyedSubscript:](v9, "setObject:forKeyedSubscript:", v12, @"PluginName");
    ...
    -[NSMutableDictionary setObject:forKeyedSubscript:](v9, "setObject:forKeyedSubscript:", v13, @"cancelHandler");
    ...
    -[NSMutableDictionary setObject:forKeyedSubscript:](v9, "setObject:forKeyedSubscript:", v14, @"dispatchQueue");
    v15 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](&OBJC_CLASS___NSNumber, "numberWithBool:", self->_activated));
    -[NSMutableDictionary setObject:forKeyedSubscript:](v9, "setObject:forKeyedSubscript:", v15, @"activated");

    v16 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](&OBJC_CLASS___NSNumber, "numberWithBool:", self->_clientAdded));
    -[NSMutableDictionary setObject:forKeyedSubscript:](v9, "setObject:forKeyedSubscript:", v16, @"clientAdded");

    uint64_t v17 = (void *)objc_claimAutoreleasedReturnValue( -[GCGamepadHIDServicePlugin propertyForKey:client:]( self,  "propertyForKey:client:",  @"BatteryCapacity",  v7));
    -[NSMutableDictionary setObject:forKeyedSubscript:]( v9,  "setObject:forKeyedSubscript:",  v17,  @"BatteryCapacity");

    float v18 = (void *)objc_claimAutoreleasedReturnValue( -[GCGamepadHIDServicePlugin propertyForKey:client:]( self,  "propertyForKey:client:",  @"IsPowerSupplyConnected",  v7));
    -[NSMutableDictionary setObject:forKeyedSubscript:]( v9,  "setObject:forKeyedSubscript:",  v18,  @"IsPowerSupplyConnected");
  }
  ...
  else
  {
    ...
    unsigned int v20 = [v6 isEqualToString:@"DeviceUsagePairs"];
    ...
    if (v20)
    {
      ...
      {
        float v22 = (void *)objc_claimAutoreleasedReturnValue( +[NSPredicate predicateWithBlock:]( &OBJC_CLASS___NSPredicate,  "predicateWithBlock:",  &stru_24688));
        uint64_t v23 = objc_claimAutoreleasedReturnValue(-[NSMutableDictionary filteredArrayUsingPredicate:](v9, "filteredArrayUsingPredicate:", v22));

        dispatch_queue_t v9 = (NSMutableDictionary *)v23;
      }
    }
  }
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_4490())
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
      sub_1771C((uint64_t)v7, (uint64_t)v8, v15);
    }
  }
  ...
  {
    id v12 = (void *)objc_claimAutoreleasedReturnValue(-[GCGamepadHIDServicePlugin device](self, "device"));
    unsigned __int8 v11 = [v12 setProperty:v7 forKey:v8];
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if (-[GCGamepadHIDServicePlugin shouldCreateBatteryDevice](self, "shouldCreateBatteryDevice"))
  {
    ...
    [v5 setObject:&off_25F50 forKeyedSubscript:@"GameControllerType"];
...
- (void)sendBatteryReport
{
  if (self->_batteryUserDevice)
  {
    ...
    int v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSData dataWithBytesNoCopy:length:freeWhenDone:]( &OBJC_CLASS___NSData,  "dataWithBytesNoCopy:length:freeWhenDone:",  self->_batteryReport,  3LL,  0LL));
...
- (BOOL)isIdle
{
  ...
  if (qword_2B4D0 != -1) {
    dispatch_once(&qword_2B4D0, &stru_246D0);
  }
