  ...
  if (v4)
  {
    ...
    *(_WORD *)&v14->var0 = 25700;
    ...
    if (v4->_device)
    {
      ...
      CFNotificationCenterAddObserver( DarwinNotifyCenter,  v4,  (CFNotificationCallback)sub_4FAC,  PBSPowerManagerDeviceWillSleepManualDistributedNotification,  v4,  CFNotificationSuspensionBehaviorDeliverImmediately);
...
LABEL_17:
  ...
  else
  {
    ...
    if (v20)
    {
      ...
      {
        float v22 = (void *)objc_claimAutoreleasedReturnValue( +[NSPredicate predicateWithBlock:]( &OBJC_CLASS___NSPredicate,  "predicateWithBlock:",  &stru_18748));
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_4118())
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
      sub_FEF4((uint64_t)v7, (uint64_t)v8, v15);
    }
  }
...
- (void)setupRawReportHandling
{
  id v4 = (id)objc_claimAutoreleasedReturnValue(+[NSAssertionHandler currentHandler](&OBJC_CLASS___NSAssertionHandler, "currentHandler"));
...
- (void)createVirtualHIDDeviceForBattery
{
  if (-[GCGamepadHIDServicePlugin shouldCreateBatteryDevice](self, "shouldCreateBatteryDevice"))
  {
    ...
    [v5 setObject:&off_199B8 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_1F360 != -1) {
    dispatch_once(&qword_1F360, &stru_18790);
  }
