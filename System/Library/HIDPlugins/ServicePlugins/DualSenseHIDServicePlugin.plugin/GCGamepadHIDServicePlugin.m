  ...
  if (v4)
  {
    ...
    *(_WORD *)&v14->var0 = 25700;
    ...
    if (v4->_device)
    {
      ...
      CFNotificationCenterAddObserver( DarwinNotifyCenter,  v4,  (CFNotificationCallback)sub_3520,  PBSPowerManagerDeviceWillSleepManualDistributedNotification,  v4,  CFNotificationSuspensionBehaviorDeliverImmediately);
...
LABEL_17:
  ...
  else
  {
    ...
    if (v21)
    {
      ...
      {
        float v24 = (void *)objc_claimAutoreleasedReturnValue( +[NSPredicate predicateWithBlock:]( &OBJC_CLASS___NSPredicate,  "predicateWithBlock:",  &stru_14608));
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_1674())
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG)) {
      sub_BD50((uint64_t)v7, (uint64_t)v8, v16);
    }
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if (-[GCGamepadHIDServicePlugin shouldCreateBatteryDevice](self, "shouldCreateBatteryDevice"))
  {
    ...
    [v5 setObject:&off_15638 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_1B6C0 != -1) {
    dispatch_once(&qword_1B6C0, &stru_14650);
  }
  float v5 = (float)(v4 * dword_1B6C8 / *(unsigned int *)algn_1B6CC) / 1000000000.0;
