...
- (GCHapticMotor)initWithCoder:(id)a3
{
  ...
  id v7 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v6), @"_name");
  v8 = (void *)objc_claimAutoreleasedReturnValue(v7);
  id v9 = [v4 decodeIntegerForKey:@"_features"];
  ...
  LODWORD(v14) = v11;
  LODWORD(v15) = v13;
  uint64_t v16 = -[GCHapticMotor initWithIndex:name:features:frequency:amplitude:]( self,  "initWithIndex:name:features:frequency:amplitude:",  v5,  v8,  v9,  v14,  v15);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = (void *)objc_claimAutoreleasedReturnValue(-[GCHapticMotor name](self, "name"));
