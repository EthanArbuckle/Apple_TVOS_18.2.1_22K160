  ...
  if (v4)
  {
    ...
    *(_WORD *)&v14->var0 = 25700;
    ...
    if (v4->_device)
    {
      ...
      CFNotificationCenterAddObserver( DarwinNotifyCenter,  v4,  (CFNotificationCallback)sub_6FF4,  PBSPowerManagerDeviceWillSleepManualDistributedNotification,  v4,  CFNotificationSuspensionBehaviorDeliverImmediately);
...
LABEL_17:
  ...
  else
  {
    ...
    if (v21)
    {
      ...
      {
        float v24 = (void *)objc_claimAutoreleasedReturnValue( +[NSPredicate predicateWithBlock:]( &OBJC_CLASS___NSPredicate,  "predicateWithBlock:",  &stru_105F8));
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_4BB8())
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG)) {
      sub_A54C((uint64_t)v7, (uint64_t)v8, v16);
    }
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if (-[GCGamepadHIDServicePlugin shouldCreateBatteryDevice](self, "shouldCreateBatteryDevice"))
  {
    ...
    [v5 setObject:&off_10E20 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_16EC8 != -1) {
    dispatch_once(&qword_16EC8, &stru_10640);
  }
