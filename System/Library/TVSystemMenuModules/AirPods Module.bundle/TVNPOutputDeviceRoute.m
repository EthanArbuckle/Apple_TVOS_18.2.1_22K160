...
- (id)_imageForAVRoute:(id)a3 destination:(id)a4
{
  ...
  if ([location[0] routeSubtype] == (char *)&dword_8 + 2)
  {
...
- (void)_updateVolume
{
  ...
  BOOL v6 = -[MPAVOutputDeviceRoute routeSubtype](v5, "routeSubtype") == (char *)&dword_8 + 2;
  ...
  if (os_log_type_enabled((os_log_t)v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    BOOL v13 = v4;
    sub_B044((uint64_t)v23, (uint64_t)"-[TVNPOutputDeviceRoute _updateVolume]", (uint64_t)v13, v20 & 1, v19 & 1, v18, v17);
    _os_log_debug_impl( &dword_0,  log,  type,  "%s: Update output device route volume. title: %{public}@, isConnected: %d, isVolumeControlAvailable: %d, isGroupLe aderAppleTV: %d, isLocalHDMI: %d",  v23,  0x2Eu);
...
- (TVSBluetoothDevice)bluetoothDevice
{
  v16[2] = self;
  v16[1] = (id)a2;
  id v5 = -[TVNPOutputDeviceRoute outputDeviceRoute](self, "outputDeviceRoute");
  id v4 = objc_msgSend(-[MPAVOutputDeviceRoute logicalLeaderOutputDevice](v5, "logicalLeaderOutputDevice"), "uid");
  id v3 = [v4 componentsSeparatedByString:@"-"];
  v16[0] = [v3 firstObject];

  id v7 = +[TVSBluetoothManager sharedInstance](&OBJC_CLASS___TVSBluetoothManager, "sharedInstance");
  id v6 = -[TVSBluetoothManager connectedDevices](v7, "connectedDevices");
  ...
  BOOL v13 = &unk_50D38;
  id v14 = v16[0];
  id v15 = objc_msgSend(v6, "bs_firstObjectPassingTest:");

  id v8 = v15;
  objc_storeStrong(&v15, 0LL);
  objc_storeStrong(&v14, 0LL);
  objc_storeStrong(v16, 0LL);
  return (TVSBluetoothDevice *)v8;
}
