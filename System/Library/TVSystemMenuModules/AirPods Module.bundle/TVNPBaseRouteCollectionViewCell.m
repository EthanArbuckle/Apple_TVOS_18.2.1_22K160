...
- (void)updateConstraints
{
  ...
  if ((char *)-[TVNPBaseRouteCollectionViewCell cellState](v128, "cellState") == (char *)&dword_0 + 2)
  {
  ...
  if (v128->_volumeLevel
    || (char *)-[TVNPBaseRouteCollectionViewCell cellState](v128, "cellState") == (char *)&dword_0 + 2)
  {
...
- (void)setVolumeLevel:(id)a3
{
    ...
    && (-[NSNumber isEqual:](v9->_volumeLevel, "isEqual:", location[0]) & 1) == 0)
  {
    ...
    if (v7 && (char *)-[TVNPBaseRouteCollectionViewCell cellState](v9, "cellState") != (char *)&dword_0 + 2)
    {
...
+ (void)_configureFloatingContentViewAppearance
{
  double v3 = (dispatch_once_t *)&unk_5F948;
  id location = 0LL;
  objc_storeStrong(&location, &stru_51170);
  if (*v3 != -1) {
...
- (void)_configureAppearanceForControlState:(unint64_t)a3 withAnimationCoordinator:(id)a4
{
  ...
  id v39 = (dispatch_once_t *)&unk_5F980;
  id v38 = 0LL;
  objc_storeStrong(&v38, &stru_51190);
  if (*v39 != -1) {
    dispatch_once(v39, v38);
  }
  objc_storeStrong(&v38, 0LL);
  BOOL v33 = (v35 & qword_5F868) != 0;
  BOOL v10 = 0;
