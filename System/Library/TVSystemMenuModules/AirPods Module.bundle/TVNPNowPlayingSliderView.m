...
- (TVNPNowPlayingSliderView)initWithFrame:(CGRect)a3
{
  ...
  if (v42)
  {
    ...
    -[UITapGestureRecognizer setAllowedPressTypes:](v44, "setAllowedPressTypes:", &off_533A8);
    ...
    -[UITapGestureRecognizer setAllowedPressTypes:](v43, "setAllowedPressTypes:", &off_533C0);
  ...
  if (a3 != self->_value)
  {
    ...
    *(float *)&double v6 = v13;
    ...
    if (v16)
    {
      ...
      int v8 = -1073741824;
      int v9 = 0;
      double v10 = sub_10720;
      double v11 = &unk_50698;
      double v12 = v19;
...
- (id)_focusedProgressColor
{
  double v4 = (dispatch_once_t *)&unk_5F8C8;
  id location = 0LL;
  objc_storeStrong(&location, &stru_50940);
  if (*v4 != -1) {
    dispatch_once(v4, location);
  }
  objc_storeStrong(&location, 0LL);
  return (id)qword_5F8C0;
}

- (id)_unfocusedProgressColor
{
  double v4 = (dispatch_once_t *)&unk_5F8D8;
  id location = 0LL;
  objc_storeStrong(&location, &stru_50960);
  if (*v4 != -1) {
    dispatch_once(v4, location);
  }
  objc_storeStrong(&location, 0LL);
  return (id)qword_5F8D0;
}
