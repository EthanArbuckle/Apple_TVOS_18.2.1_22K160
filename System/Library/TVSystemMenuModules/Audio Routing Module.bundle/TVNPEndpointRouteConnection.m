...
- (TVNPEndpointRouteConnection)initWithRoute:(id)a3
{
  ...
  if (v11)
  {
    v17 = (dispatch_once_t *)&unk_5EE60;
    id v16 = 0LL;
    objc_storeStrong(&v16, &stru_51058);
    if (*v17 != -1) {
...
- (void)_updateMetadata
{
  ...
  if (v49)
  {
    ...
    os_log_t oslog = (os_log_t)(id)qword_5EE68;
    os_log_type_t type = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
    {
      sub_6838((uint64_t)v122, (uint64_t)val, (uint64_t)v88);
    ...
    if (([v77 isArtworkVisuallyIdenticalToCatalog:*((void *)val + 7)] & 1) == 0)
    {
      if (v77)
      {
        [v77 setCacheIdentifier:off_5EB00 forCacheReference:0];
      ...
      if (!v77)
      {
        ...
        os_log_t v67 = (os_log_t)(id)qword_5EE68;
        os_log_type_t v66 = OS_LOG_TYPE_DEBUG;
        if (os_log_type_enabled(v67, OS_LOG_TYPE_DEBUG))
        {
          sub_51B8((uint64_t)v121, (uint64_t)val);
      ...
      {
        id v65 = [val bundleID];
        os_log_t v64 = (os_log_t)(id)qword_5EE68;
        os_log_type_t v63 = OS_LOG_TYPE_DEBUG;
        if (os_log_type_enabled(v64, OS_LOG_TYPE_DEBUG))
        {
          sub_6838((uint64_t)v120, (uint64_t)val, (uint64_t)v65);
  ...
  else
  {
    ...
    id v104 = &dword_0 + 1;
    os_log_t v62 = (os_log_t)(id)qword_5EE68;
    os_log_type_t v61 = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled(v62, OS_LOG_TYPE_DEFAULT))
    {
      sub_51B8((uint64_t)v119, (uint64_t)val);
  ...
  *(float *)&double v16 = v100;
  ...
  {
    os_log_t v59 = (os_log_t)(id)qword_5EE68;
    os_log_type_t v58 = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled(v59, OS_LOG_TYPE_DEFAULT))
    {
      sub_6838((uint64_t)v118, (uint64_t)val, (uint64_t)v60);
...
- (void)_connectPairingIfNeeded:(BOOL)a3
{
  ...
  if (v20)
  {
    ...
    if ((v19 & 1) == 0 && !v23->_attemptingConnection)
    {
      ...
      id v16 = (id)qword_5EE68;
      os_log_type_t v15 = OS_LOG_TYPE_DEFAULT;
      if (os_log_type_enabled((os_log_t)v16, OS_LOG_TYPE_DEFAULT))
      {
        int v5 = -[TVNPEndpointRouteConnection route](v23, "route");
        id location = v5;
        sub_2B020((uint64_t)v24, (uint64_t)v23, (uint64_t)location, v21);
