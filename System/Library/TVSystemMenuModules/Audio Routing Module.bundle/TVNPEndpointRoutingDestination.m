...
- (TVNPEndpointRoutingDestination)initWithEndpointRoute:(id)a3
{
  ...
  if (v21)
  {
    ...
    *(NSCopying **)((char *)&v34->_routeConnectionObserverToken + 4) = v19;
    [*(id *)((char *)&v34->_endpointRoute + 4) addObserver:v34 forKeyPath:@"connectionState" options:0 context:off_5EAF8];
...
- (void)dealloc
{
  v4 = self;
  SEL v3 = a2;
  [*(id *)((char *)&self->_endpointRoute + 4) removeObserver:self forKeyPath:@"connectionState" context:off_5EAF8];
