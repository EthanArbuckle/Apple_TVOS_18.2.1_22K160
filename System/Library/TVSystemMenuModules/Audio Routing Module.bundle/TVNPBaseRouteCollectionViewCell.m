...
+ (void)_configureFloatingContentViewAppearance
{
  double v3 = (dispatch_once_t *)&unk_5EE20;
  id location = 0LL;
  objc_storeStrong(&location, &stru_50E48);
  if (*v3 != -1) {
...
- (void)_configureAppearanceForControlState:(unint64_t)a3 withAnimationCoordinator:(id)a4
{
  ...
  id v39 = (dispatch_once_t *)&unk_5EE58;
  id v38 = 0LL;
  objc_storeStrong(&v38, &stru_50E68);
  if (*v39 != -1) {
    dispatch_once(v39, v38);
  }
  objc_storeStrong(&v38, 0LL);
  BOOL v33 = (v35 & qword_5E900) != 0;
  BOOL v10 = 0;
