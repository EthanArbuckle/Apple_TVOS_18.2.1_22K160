...
- (void)setRoute:(id)a3
{
  ...
  {
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"title",  off_5E908);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"deviceImage",  off_5E910);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"deviceType",  off_5E918);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"selectionState",  off_5E920);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"volumeLevel",  off_5E928);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"canBeGrouped",  off_5E930);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"destination.isCurrentDestination",  off_5E938);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"destination.playbackState",  off_5E940);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"destination.singleLineTitle",  off_5E948);
    route = v8->_route;
    uint64_t v3 = objc_opt_class(&OBJC_CLASS___TVNPOutputDeviceRoute);
    if ((objc_opt_isKindOfClass(route, v3) & 1) != 0) {
      -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"batteryLevel",  off_5E950);
    }
    objc_storeStrong((id *)&v8->_route, location[0]);
    objc_msgSend(location[0], "addObserver:forKeyPath:options:context:", v8, @"title");
    [location[0] addObserver:v8 forKeyPath:@"deviceImage" options:4 context:off_5E910];
    [location[0] addObserver:v8 forKeyPath:@"deviceType" options:4 context:off_5E918];
    [location[0] addObserver:v8 forKeyPath:@"selectionState" options:4 context:off_5E920];
    [location[0] addObserver:v8 forKeyPath:@"volumeLevel" options:4 context:off_5E928];
    [location[0] addObserver:v8 forKeyPath:@"canBeGrouped" options:4 context:off_5E930];
    [location[0] addObserver:v8 forKeyPath:@"destination.isCurrentDestination" options:4 context:off_5E938];
    [location[0] addObserver:v8 forKeyPath:@"destination.playbackState" options:4 context:off_5E940];
    [location[0] addObserver:v8 forKeyPath:@"destination.singleLineTitle" options:4 context:off_5E948];
    id v5 = location[0];
    uint64_t v4 = objc_opt_class(&OBJC_CLASS___TVNPOutputDeviceRoute);
    if ((objc_opt_isKindOfClass(v5, v4) & 1) != 0) {
      [location[0] addObserver:v8 forKeyPath:@"batteryLevel" options:4 context:off_5E950];
    }
  }
...
- (id)_batteryTextForBatteryLevel:(id)a3
{
  ...
  {
    sub_561C((uint64_t)v70, (uint64_t)location[0]);
  ...
  if (v54)
  {
    if (-[TVNPRouteCollectionViewCell _shouldShowSeparateBatteryPercentagesForBatteryLevel:]( v68,  "_shouldShowSeparateBatteryPercentagesForBatteryLevel:",  location[0]))
    {
      ...
      v51 =  -[NSBundle localizedStringForKey:value:table:]( v52,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelCombinedFormat",  &stru_51CA0,  0LL);
    ...
    else
    {
      ...
      *(float *)&double v7 = v46;
      ...
      v42 =  -[NSBundle localizedStringForKey:value:table:]( v43,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelSingleFormat",  &stru_51CA0);
  ...
  else
  {
    ...
    if (v40)
    {
      ...
      v38 =  -[NSBundle localizedStringForKey:value:table:]( v39,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelLeftFormat",  &stru_51CA0,  0LL);
    ...
    else
    {
      ...
      if (v35)
      {
        ...
        v33 =  -[NSBundle localizedStringForKey:value:table:]( v34,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelRightFormat",  &stru_51CA0,  0LL);
      ...
      else
      {
        ...
        if (v30)
        {
          ...
          v28 =  -[NSBundle localizedStringForKey:value:table:]( v29,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelSingleFormat",  &stru_51CA0,  0LL);
  ...
  if (v25)
  {
    ...
    v23 =  -[NSBundle localizedStringForKey:value:table:]( v24,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelCaseFormat",  &stru_51CA0,  0LL);
    id v20 = v62;
