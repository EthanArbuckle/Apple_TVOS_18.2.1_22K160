...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___HIDLibElement;
...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___HIDLibElement;
  ...
  v6->_element = 0LL;
  CFMutableDataRef Mutable = CFDataCreateMutable((CFAllocatorRef)*MEMORY[0x189604DB0], 1LL);
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___HIDLibElement;
...
- (id)description
{
  ...
  return (id)objc_msgSend_stringWithFormat_( v6,  v29,  (uint64_t)@"element: %p type: %d uP: 0x%02x u: 0x%02x cookie: %d val: %ld",  v30,  v31,  element,  v8,  v13,  v18,  v23,  v28);
}
...
- (void)setIntegerValue:(int64_t)a3
{
  objc_super v5 = (const __CFAllocator *)*MEMORY[0x189604DB0];
  element = self->_element;
...
- (NSData)dataValue
{
  uint64_t v6 = (void *)objc_msgSend_valueRef(self, a2, v2, v3, v4);
  if (v6)
  {
...
- (void)setDataValue:(id)a3
{
  ...
  IOHIDValueRef v17 = IOHIDValueCreateWithBytes(v4, element, 0LL, v11, v16);
