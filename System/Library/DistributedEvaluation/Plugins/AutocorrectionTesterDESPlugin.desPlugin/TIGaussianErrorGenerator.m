...
- (TIGaussianErrorGenerator)initWithAttributes:(id)a3
{
  id v4 = a3;
  v24.receiver = self;
  v24.super_class = (Class)&OBJC_CLASS___TIGaussianErrorGenerator;
  v5 = -[TIErrorGenerator initWithAttributes:](&v24, "initWithAttributes:", v4);
  v6 = v5;
  if (v5)
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"GAUSSIAN_ERROR_STDDEV_X"]);

    if (v7)
    {
      v8 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKey:@"GAUSSIAN_ERROR_STDDEV_X"]);
      [v8 floatValue];
      v6->_perTouchStdevX = v9;
    }

    v10 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"GAUSSIAN_ERROR_STDDEV_Y"]);

    if (v10)
    {
      v11 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKey:@"GAUSSIAN_ERROR_STDDEV_Y"]);
      [v11 floatValue];
      v6->_perTouchStdevY = v12;
    }

    v13 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"SKEW_STDDEV_X"]);

    if (v13)
    {
      v14 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"SKEW_STDDEV_X"]);
      [v14 floatValue];
      v6->_globalStdevX = v15;
    }

    v16 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"SKEW_STDDEV_Y"]);

    if (v16)
    {
      v17 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"SKEW_STDDEV_Y"]);
      [v17 floatValue];
      v6->_globalStdevY = v18;
    }

    v19 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"SCALE_ERROR_UNITS_TO_POINTS"]);

    if (v19)
    {
      v20 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForKey:@"SCALE_ERROR_UNITS_TO_POINTS"]);
      [v20 floatValue];
      float v22 = v21;
    }
...
- (CGPoint)randomTargetForSpaceBarRect:(CGRect)a3
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___TIGaussianErrorGenerator;
  -[TIErrorGenerator persistentBiasForSpaceBarRect:](&v17, "persistentBiasForSpaceBarRect:");
  double v9 = v8;
  double v11 = v10;
  if ((char *)-[TIErrorGenerator spaceHorizontalErrorMode](self, "spaceHorizontalErrorMode") == (char *)&dword_0 + 1)
  {
...
- (CGPoint)randomErrorForKeyString:(id)a3 rect:(CGRect)a4
{
  ...
  *(float *)&double v11 = self->_perTouchStdevY;
  ...
  if ([v9 isEqualToString:@" "]
    && (char *)-[TIErrorGenerator spaceHorizontalErrorMode](self, "spaceHorizontalErrorMode") == (char *)&dword_0 + 1)
  {
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___TIGaussianErrorGenerator;
  -[TIErrorGenerator reset](&v7, "reset");
