...
- (TIMockUserModelDatabaseRow)initWithKey:(id)a3 inputMode:(id)a4 value:(id)a5 secondaryValue:(id)a6 realValue:(id)a7 properties:(id)a8 creationDate:(id)a9 lastUpdateDate:(id)a10
{
  ...
  id v17 = a10;
  v28.receiver = self;
  v28.super_class = (Class)&OBJC_CLASS___TIMockUserModelDatabaseRow;
  v18 = -[TIMockUserModelDatabaseRow init](&v28, "init");
  v19 = v18;
  if (v18)
  {
...
{
  id v4 = a3;
  BOOL v5 = !v4 || (char *)-[NSDate compare:](self->_lastUpdateDate, "compare:", v4) == (char *)&dword_0 + 1;
...
- (BOOL)isMatchForKey:(id)a3 forInputMode:(id)a4 sinceDate:(id)a5
{
  ...
  {
    BOOL v10 = -[TIMockUserModelDatabaseRow isMatchSinceDate:](self, "isMatchSinceDate:", v9);
  }
...
- (BOOL)isMatchForKeyPrefix:(id)a3 forInputMode:(id)a4 weeklyKeySuffixes:(id)a5 endDate:(id)a6
{
  ...
  {
    v14 = (void *)objc_claimAutoreleasedReturnValue(-[NSString substringFromIndex:](self->_key, "substringFromIndex:", [v10 length]));
    ...
    id v17 = (void *)objc_claimAutoreleasedReturnValue( +[NSDate dateWithTimeInterval:sinceDate:]( &OBJC_CLASS___NSDate,  "dateWithTimeInterval:sinceDate:",  v13,  -((double)kSecondsPerDay * (double)*v16)));
    if (-[TIMockUserModelDatabaseRow isMatchSinceDate:](self, "isMatchSinceDate:", v17)) {
      unsigned int v18 = !-[TIMockUserModelDatabaseRow isMatchSinceDate:](self, "isMatchSinceDate:", v13);
    }
    else {
      LOBYTE(v18) = 0;
    }
...
- (BOOL)isMatchForKeyPrefix:(id)a3 forInputMode:(id)a4 sinceDate:(id)a5
{
  id v8 = a4;
  id v9 = a5;
  if (-[NSString hasPrefix:](self->_key, "hasPrefix:", a3)
    && (!v8 || [v8 isEqualToString:self->_inputMode]))
  {
    BOOL v10 = -[TIMockUserModelDatabaseRow isMatchSinceDate:](self, "isMatchSinceDate:", v9);
  }
