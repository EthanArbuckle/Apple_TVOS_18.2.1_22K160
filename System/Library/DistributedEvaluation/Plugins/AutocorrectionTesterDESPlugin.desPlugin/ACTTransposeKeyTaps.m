...
- (ACTTransposeKeyTaps)initWithFirstTap:(id)a3 secondTap:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___ACTTransposeKeyTaps;
  v9 = -[ACTTransposeKeyTaps init](&v12, "init");
  v10 = v9;
  if (v9)
  {
...
- (id)description
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[ACTTransposeKeyTaps firstTap](self, "firstTap"));
  id v7 = (void *)objc_claimAutoreleasedReturnValue(-[ACTTransposeKeyTaps secondTap](self, "secondTap"));
...
- (void)applyWithTyper:(id)a3 log:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = (void *)objc_claimAutoreleasedReturnValue(-[ACTTransposeKeyTaps firstTap](self, "firstTap"));
  [v8 applyWithTyper:v7 log:v6];

  id v9 = (id)objc_claimAutoreleasedReturnValue(-[ACTTransposeKeyTaps secondTap](self, "secondTap"));
...
- (id)shortDescription
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"Transpose first/second: %@ ",  v2));
