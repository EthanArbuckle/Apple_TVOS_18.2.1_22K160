...
- (scoredRule)initWithLabel:(int64_t)a3 score:(float)a4 recipientUniqueID:(id)a5
{
  id v9 = a5;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___scoredRule;
  v10 = -[scoredRule init](&v13, "init");
  v11 = v10;
  if (v10)
  {
    v10->_ruleLabel = a3;
...
- (int64_t)compare:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithFloat:](&OBJC_CLASS___NSNumber, "numberWithFloat:"));
  [v4 ruleScore];
  int v7 = v6;
