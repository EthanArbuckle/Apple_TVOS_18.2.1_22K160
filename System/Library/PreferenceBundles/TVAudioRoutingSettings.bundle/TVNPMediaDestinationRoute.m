...
- (void)updateWithMediaDestination:(id)a3 selectionState:(unint64_t)a4
{
  ...
  BOOL v9 = [location[0] audioDestinationType] == (char *)&dword_0 + 2;
  uint64_t v10 = 3LL;
  if (!v9) {
    uint64_t v10 = 2LL;
  }
...
+ (id)_imageForMediaDestination:(id)a3
{
  ...
  {
    id v25 = location[0];
    id v24 = (char *)[v25 homePodVariant];
    if (v24 == (_BYTE *)&dword_0 + 1 || v24 == (_BYTE *)&dword_0 + 3)
    {
      id v27 = +[UIImage systemImageNamed:](&OBJC_CLASS___UIImage, "systemImageNamed:", @"homepod.fill");
      int v23 = 1;
    }

    else if (v24 == (_BYTE *)&dword_0 + 2)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)v22, OS_LOG_TYPE_FAULT))
      {
        ...
        sub_19974(v20);
        _os_log_fault_impl(&dword_0, log, type, "Icon requested for unknown HomePod variant", v20, 2u);
      }
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass(v11, v4) & 1) != 0)
    {
      ...
      id v18 = (char *)[v19 homePodVariant];
      if (v18 == (_BYTE *)&dword_0 + 1 || v18 == (_BYTE *)&dword_0 + 3)
      {
      ...
      else
      {
        ...
        if (os_log_type_enabled(oslog, OS_LOG_TYPE_FAULT))
        {
          ...
          sub_19974(v15);
          _os_log_fault_impl(&dword_0, v6, v7, "Icon requested for unknown HomePod variant", v15, 2u);
        }
