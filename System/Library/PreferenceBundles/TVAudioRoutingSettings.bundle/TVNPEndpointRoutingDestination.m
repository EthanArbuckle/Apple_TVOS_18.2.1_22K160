...
- (TVNPEndpointRoutingDestination)initWithEndpointRoute:(id)a3
{
  ...
  if (v21)
  {
    ...
    *(NSCopying **)((char *)&v34->_routeConnectionObserverToken + 4) = v19;
    [*(id *)((char *)&v34->_endpointRoute + 4) addObserver:v34 forKeyPath:@"connectionState" options:0 context:off_31840];
    ...
    *(TVNPEndpointRouteConnection **)((char *)&v34->_routeConnection + 4) = v15;
...
- (void)dealloc
{
  v4 = self;
  SEL v3 = a2;
  [*(id *)((char *)&self->_endpointRoute + 4) removeObserver:self forKeyPath:@"connectionState" context:off_31840];
...
- (BOOL)isConnected
{
  return (char *)-[TVNPEndpointRoutingDestination connectionState](self, "connectionState", a2, self) == (char *)&dword_0 + 2;
}

- (BOOL)isConnecting
{
  return (char *)-[TVNPEndpointRoutingDestination connectionState](self, "connectionState", a2, self) == (char *)&dword_0 + 1;
}

- (BOOL)isDisconnected
{
  return (char *)-[TVNPEndpointRoutingDestination connectionState](self, "connectionState", a2, self) == (char *)&dword_0 + 3;
}
