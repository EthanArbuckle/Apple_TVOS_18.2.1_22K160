...
{
  unsigned int v10 = *((_DWORD *)a1 + 2) + ((*((_BYTE *)a1 + 22) ^ 1) & 1);
  BOOL v2 = __CFADD__(v10, a2);
  ...
  else
  {
    ...
    else
    {
      if (v11 <= v5) {
        ...
        unsigned int v7 = v10 + a2;
      }
      if (*((_DWORD *)a1 + 4) >= v7)
      {
        if (v11 > v5) {
          unsigned int v5 = v10 + a2;
        }
      }
...
uint64_t os_trace_blob_add_slow(uint64_t a1, uint64_t a2, unint64_t a3)
{
  ...
  {
    unsigned int v4 = *(_DWORD *)(a1 + 12) - ((*(_BYTE *)(a1 + 22) ^ 1) & 1) - *(_DWORD *)(a1 + 8);
    if (v4 < a3)
    {
      if (*(_DWORD *)(a1 + 12) < *(_DWORD *)(a1 + 16)) {
        unsigned int v4 = os_trace_blob_grow((uint64_t *)a1, a3);
      }
      if (v4 < v5)
      {
        *(_WORD *)(a1 + 20) |= 2u;
    ...
    __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), a2, v5, -1LL);
    *(_DWORD *)(a1 + 8) += v5;
    if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
...
uint64_t os_trace_blob_addns(uint64_t a1, _BYTE *a2, unint64_t a3, void *a4)
{
  ...
  else
  {
    ...
    *(void *)&v10[1] = 0LL;
    uint64_t v21 = v15;
    int v20 = 0;
    int v20 = *(_DWORD *)(v15 + 8) + ((*(_BYTE *)(v15 + 22) ^ 1) & 1);
    if (*(_DWORD *)(v15 + 16))
    {
    ...
    if (v13 > v22)
    {
      uint64_t v18 = v15;
      int v17 = 0;
      int v17 = *(_DWORD *)(v15 + 8) + ((*(_BYTE *)(v15 + 22) ^ 1) & 1);
      if (*(_DWORD *)(v15 + 16))
      {
...
LABEL_26:
      ...
      else
      {
        ...
        {
          __memcpy_chk(*(void *)v58 + *(unsigned int *)(v58 + 8), v57, v56, -1LL);
          uint64_t v62 = v58;
          unint64_t v61 = v56;
          *(_DWORD *)(v58 + 8) += v56;
          if ((*(_BYTE *)(v62 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)v62 + *(unsigned int *)(v62 + 8)) = 0;
          }
          int v59 = v61;
        }
      ...
      *(void *)&v10[1] += v11;
      ...
      if (isascii(v10[0]))
      {
        ...
        else
        {
          ...
          {
            __memcpy_chk(*(void *)v51 + *(unsigned int *)(v51 + 8), v50, v49, -1LL);
            uint64_t v55 = v51;
            unint64_t v54 = v49;
            *(_DWORD *)(v51 + 8) += v49;
            if ((*(_BYTE *)(v55 + 22) & 1) == 0) {
              *(_BYTE *)(*(void *)v55 + *(unsigned int *)(v55 + 8)) = 0;
            }
            int v52 = v54;
          }
      ...
      else
      {
        ...
        if (v11 == -1)
        {
          ...
          if (iscntrl_l(v10[0], _c_locale))
          {
            ...
            else
            {
              ...
              {
                __memcpy_chk(*(void *)v44 + *(unsigned int *)(v44 + 8), v43, v42, -1LL);
                uint64_t v48 = v44;
                unint64_t v47 = v42;
                *(_DWORD *)(v44 + 8) += v42;
                if ((*(_BYTE *)(v48 + 22) & 1) == 0) {
                  *(_BYTE *)(*(void *)v48 + *(unsigned int *)(v48 + 8)) = 0;
                }
                int v45 = v47;
              }
          ...
          else
          {
            ...
            else
            {
              ...
              {
                __memcpy_chk(*(void *)v37 + *(unsigned int *)(v37 + 8), v36, v35, -1LL);
                uint64_t v41 = v37;
                unint64_t v40 = v35;
                *(_DWORD *)(v37 + 8) += v35;
                if ((*(_BYTE *)(v41 + 22) & 1) == 0) {
                  *(_BYTE *)(*(void *)v41 + *(unsigned int *)(v41 + 8)) = 0;
                }
                int v38 = v40;
              }
        ...
        else
        {
          ...
          else
          {
            ...
            {
              __memcpy_chk(*(void *)v30 + *(unsigned int *)(v30 + 8), v29, v28, -1LL);
              uint64_t v34 = v30;
              unint64_t v33 = v28;
              *(_DWORD *)(v30 + 8) += v28;
              if ((*(_BYTE *)(v34 + 22) & 1) == 0) {
                *(_BYTE *)(*(void *)v34 + *(unsigned int *)(v34 + 8)) = 0;
              }
              int v31 = v33;
            }
...
uint64_t os_trace_blob_addnws(uint64_t a1, int *a2, unint64_t a3, int **a4)
{
  ...
  else
  {
    ...
    uint64_t v17 = v11;
    int v16 = 0;
    int v16 = *(_DWORD *)(v11 + 8) + ((*(_BYTE *)(v11 + 22) ^ 1) & 1);
    if (*(_DWORD *)(v11 + 16))
    {
    ...
    if (v9 > v18)
    {
      uint64_t v14 = v11;
      int v13 = 0;
      int v13 = *(_DWORD *)(v11 + 8) + ((*(_BYTE *)(v11 + 22) ^ 1) & 1);
      if (*(_DWORD *)(v11 + 16))
      {
    ...
    while (*v10)
    {
      ...
      else
      {
        ...
        {
          __memcpy_chk(*(void *)v21 + *(unsigned int *)(v21 + 8), v20, v19, -1LL);
          uint64_t v25 = v21;
          unint64_t v24 = v19;
          *(_DWORD *)(v21 + 8) += v19;
          if ((*(_BYTE *)(v25 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)v25 + *(unsigned int *)(v25 + 8)) = 0;
          }
...
uint64_t os_trace_blob_vaddf(uint64_t a1, const char *a2, va_list a3)
{
  ...
  {
    unsigned int v5 = *(_DWORD *)(a1 + 12) - ((*(_BYTE *)(a1 + 22) ^ 1) & 1) - *(_DWORD *)(a1 + 8);
    *__error() = 0;
    ...
    else if (v4 > v5)
    {
      if (*(_DWORD *)(a1 + 12) < *(_DWORD *)(a1 + 16))
      {
        unsigned int v5 = os_trace_blob_grow((uint64_t *)a1, v4);
        *__error() = 0;
...
uint64_t os_trace_blob_add_hexdump(uint64_t result, uint64_t a2, unint64_t a3, char a4)
{
  ...
  else
  {
    ...
    {
      result = __memcpy_chk(*(void *)v59 + *(unsigned int *)(v59 + 8), v58, v57, -1LL);
      uint64_t v63 = v59;
      unint64_t v62 = v57;
      *(_DWORD *)(v59 + 8) += v57;
      if ((*(_BYTE *)(v63 + 22) & 1) == 0) {
        *(_BYTE *)(*(void *)v63 + *(unsigned int *)(v63 + 8)) = 0;
      }
      int v60 = v62;
    }
  ...
  for (unint64_t i = 0LL; i < a3; ++i)
  {
    ...
    if (i)
    {
      ...
      else
      {
        ...
        {
          result = __memcpy_chk(*(void *)v49 + *(unsigned int *)(v49 + 8), v48, v47, -1LL);
          uint64_t v53 = v49;
          unint64_t v52 = v47;
          *(_DWORD *)(v49 + 8) += v47;
          if ((*(_BYTE *)(v53 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)v53 + *(unsigned int *)(v53 + 8)) = 0;
          }
          int v50 = v52;
        }
    ...
    else
    {
      ...
      {
        result = __memcpy_chk(*(void *)v39 + *(unsigned int *)(v39 + 8), v38, v37, -1LL);
        uint64_t v43 = v39;
        unint64_t v42 = v37;
        *(_DWORD *)(v39 + 8) += v37;
        if ((*(_BYTE *)(v43 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)v43 + *(unsigned int *)(v43 + 8)) = 0;
        }
        int v40 = v42;
      }
    ...
    else
    {
      ...
      {
        result = __memcpy_chk(*(void *)v29 + *(unsigned int *)(v29 + 8), v28, v27, -1LL);
        uint64_t v33 = v29;
        unint64_t v32 = v27;
        *(_DWORD *)(v29 + 8) += v27;
        if ((*(_BYTE *)(v33 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)v33 + *(unsigned int *)(v33 + 8)) = 0;
        }
        int v30 = v32;
      }
  ...
  if ((a4 & 1) != 0)
  {
    ...
    v65 = "…'";
    uint64_t v64 = 0LL;
    return os_trace_blob_addns(v13, "…'", 0xFFFFFFFFFFFFFFFFLL, 0LL);
  }
  ...
  else
  {
    ...
    else
    {
      ...
      {
        result = __memcpy_chk(*(void *)v19 + *(unsigned int *)(v19 + 8), v18, v17, -1LL);
        uint64_t v23 = v19;
        unint64_t v22 = v17;
        *(_DWORD *)(v19 + 8) += v17;
        if ((*(_BYTE *)(v23 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)v23 + *(unsigned int *)(v23 + 8)) = 0;
        }
      }
...
{
  size_t v4 = result;
  for (__s = (char *)(*(void *)result + 2LL); *__s != 125; __s = &__sa[__n])
  {
    __sa = &__s[strspn(__s, ", ")];
    result = strcspn(__sa, ",}");
    size_t __n = result;
...
uint64_t _os_log_fmt_compute_mask(uint64_t a1, uint64_t a2)
{
  *(void *)&_BYTE v7[4] = a2;
  ...
  if (*(void *)&v7[4] > 8uLL)
  {
    uint64_t v5 = _os_assert_log(*(void *)&v7[4] <= 8uLL);
    _os_crash(v5);
    __break(1u);
  }

  uint64_t v4 = 0LL;
  for (unint64_t i = 0LL; i < *(void *)&v7[4]; ++i)
...
uint64_t _os_log_fmt_flatten_masked_data( _BYTE *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, unint64_t a7, _BYTE *a8)
{
  ...
  *a1 |= 2u;
  ...
  {
    case 0x68736168LL:
    case 0x68736168766564LL:
    case 0x786F626C69616DLL:
      goto LABEL_23;
    case 0x35646D6E69616C70LL:
      if ((*a8 & 1) != 0)
      {
        LOWORD(v14) = 0;
      }
      ...
      {
        uint64_t v8 = ccmd5_di();
        ccdigest(v8, a6, a5, v20);
        unint64_t v14 = _os_log_fmt_truncate_to_maxsz(0x10uLL, a7, a8);
        if ((*(_WORD *)(a4 + 20) & 2) == 0)
        {
          if (v14 <= *(_DWORD *)(a4 + 12) - ((*(_BYTE *)(a4 + 22) ^ 1) & 1u) - *(_DWORD *)(a4 + 8))
          {
            __memcpy_chk(*(void *)a4 + *(unsigned int *)(a4 + 8), v20, v14, -1LL);
            *(_DWORD *)(a4 + 8) += v14;
            if ((*(_BYTE *)(a4 + 22) & 1) == 0) {
              *(_BYTE *)(*(void *)a4 + *(unsigned int *)(a4 + 8)) = 0;
            }
          }
  ...
  *a7 = 0;
  if (v17 && v13)
  {
    ...
    else
    {
      ...
      {
        __memcpy_chk(*(void *)v35 + *(unsigned int *)(v35 + 8), v34, v33, -1LL);
        uint64_t v41 = v35;
        unint64_t v40 = v33;
        *(_DWORD *)(v35 + 8) += v33;
        if ((*(_BYTE *)(v41 + 22) & 1) == 0) {
  ...
  else if (v16 && v13)
  {
    ...
    *char v12 = *v9 != 0;
    ...
    else
    {
      ...
      {
        __memcpy_chk(*(void *)v28 + *(unsigned int *)(v28 + 8), v27, v26, -1LL);
        uint64_t v43 = v28;
        unint64_t v42 = v26;
        *(_DWORD *)(v28 + 8) += v26;
        if ((*(_BYTE *)(v43 + 22) & 1) == 0) {
  ...
  else
  {
    ...
    else
    {
      ...
      if (v19 <= *(_DWORD *)(v39 + 12) - ((*(_BYTE *)(v39 + 22) ^ 1) & 1u) - *(_DWORD *)(v39 + 8))
      {
        ...
        *(_DWORD *)(v21 + 8) += v19;
        if ((*(_BYTE *)(v45 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)v45 + *(unsigned int *)(v45 + 8)) = 0;
        }
        int v22 = v44;
      }
...
uint64_t os_log_fmt_flatten(_BYTE *a1, unsigned __int8 a2, uint64_t a3, uint64_t a4, uint64_t a5, int a6)
{
  ...
  if (!a2)
  {
    uint64_t v39 = _os_assert_log(v40);
    _os_crash(v39);
    __break(1u);
  }
  ...
  uint64_t v60 = v44;
  int v59 = 0;
  int v59 = *(_DWORD *)(v44 + 8) + ((*(_BYTE *)(v44 + 22) ^ 1) & 1);
  if (*(_DWORD *)(v44 + 16))
  {
  ...
  if (v61 >= v45)
  {
    uint64_t v57 = v43;
    int v56 = 0;
    int v56 = *(_DWORD *)(v43 + 8) + ((*(_BYTE *)(v43 + 22) ^ 1) & 1);
    if (*(_DWORD *)(v43 + 16)) {
    ...
    if (v58 >= v45)
    {
      uint64_t v54 = v42;
      int v53 = 0;
      int v53 = *(_DWORD *)(v42 + 8) + ((*(_BYTE *)(v42 + 22) ^ 1) & 1);
      if (*(_DWORD *)(v42 + 16))
      {
  ...
  if (!v6)
  {
    uint64_t v37 = _os_assert_log(0LL);
    _os_crash(v37);
    __break(1u);
  }
  ...
  else
  {
    ...
    {
      uint64_t result = __memcpy_chk(*(void *)v51 + *(unsigned int *)(v51 + 8), v50, v49, -1LL);
      uint64_t v106 = v51;
      unint64_t v105 = v49;
      *(_DWORD *)(v51 + 8) += v49;
      if ((*(_BYTE *)(v106 + 22) & 1) == 0) {
        *(_BYTE *)(*(void *)v106 + *(unsigned int *)(v106 + 8)) = 0;
      }
      int v52 = v105;
    }
  ...
  while (v28 < (int)v48[1])
  {
    ...
    switch(v27[0] >> 4)
    {
      ...
      case 1:
        ...
        {
          uint64_t v21 = 0LL;
          uint64_t v21 = _os_assert_log(v22);
          uint64_t result = _os_crash(v21);
          __break(1u);
        }
      ...
      case 7:
        ...
        {
          uint64_t v23 = 0LL;
          uint64_t v23 = _os_assert_log(v24);
          _os_crash(v23);
          __break(1u);
        }
      ...
      default:
        ...
        {
          uint64_t v19 = 0LL;
          uint64_t v19 = _os_assert_log(0LL);
          _os_crash(v19);
          __break(1u);
        }
        ...
        {
          uint64_t v17 = 0LL;
          uint64_t v17 = _os_assert_log(v18);
          _os_crash(v17);
          __break(1u);
        }
        ...
        if ((os_log_fmt_flatten_cmd_type_is_scalar[v27[0] >> 4] & 1) == 0 || (v27[0] & 1) != 0)
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                uint64_t result = __memcpy_chk(*(void *)v75 + *(unsigned int *)(v75 + 8), v74, v73, -1LL);
                uint64_t v104 = v75;
                unint64_t v103 = v73;
                *(_DWORD *)(v75 + 8) += v73;
                if ((*(_BYTE *)(v104 + 22) & 1) == 0) {
                  *(_BYTE *)(*(void *)v104 + *(unsigned int *)(v104 + 8)) = 0;
                }
                int v76 = v103;
              }
            ...
            else
            {
              ...
              {
                uint64_t result = __memcpy_chk(*(void *)v71 + *(unsigned int *)(v71 + 8), v70, v69, -1LL);
                uint64_t v102 = v71;
                unint64_t v101 = v69;
                *(_DWORD *)(v71 + 8) += v69;
                if ((*(_BYTE *)(v102 + 22) & 1) == 0) {
                  *(_BYTE *)(*(void *)v102 + *(unsigned int *)(v102 + 8)) = 0;
                }
                int v72 = v101;
              }
          ...
          {
            _BYTE *v26 = *v26 & 0xF | 0xF0;
            *v26 &= 0xF8u;
            _BYTE *v26 = *v26 & 0xF0 | *v26 & 0xD | 2;
          }
...
LABEL_105:
        ...
        else
        {
          ...
          else
          {
            ...
            {
              uint64_t result = __memcpy_chk(*(void *)v90 + *(unsigned int *)(v90 + 8), v89, v88, -1LL);
              uint64_t v100 = v90;
              unint64_t v99 = v88;
              *(_DWORD *)(v90 + 8) += v88;
              if ((*(_BYTE *)(v100 + 22) & 1) == 0) {
                *(_BYTE *)(*(void *)v100 + *(unsigned int *)(v100 + 8)) = 0;
              }
              int v91 = v99;
            }
          ...
          else
          {
            ...
            {
              uint64_t result = __memcpy_chk(*(void *)v86 + *(unsigned int *)(v86 + 8), v85, v84, -1LL);
              uint64_t v98 = v86;
              unint64_t v97 = v84;
              *(_DWORD *)(v86 + 8) += v84;
              if ((*(_BYTE *)(v98 + 22) & 1) == 0) {
                *(_BYTE *)(*(void *)v98 + *(unsigned int *)(v98 + 8)) = 0;
              }
              int v87 = v97;
            }
...
LABEL_107:
  unint64_t v13 = (_BYTE *)(*(void *)v44 + v34);
  *unint64_t v13 = __b[0];
  v13[1] = __b[1];
  return result;
}
...
uint64_t _os_log_fmt_flatten_data( _BYTE *a1, unsigned __int8 a2, uint64_t a3, uint64_t a4, unint64_t a5, uint64_t a6, uint64_t a7, unint64_t a8)
{
  ...
  if (!v8)
  {
    ...
    return (unsigned __int16)_os_log_fmt_flatten_to_blob(a1, a2, a3, a4, a5, a6, a7, v12, v11, 0LL);
  }
...
{
  uint64_t v10 = a2;
  unsigned __int8 v9 = *(_BYTE *)(a2 + a3 - 1);
  unint64_t v8 = a2 + a3 - v9 - 1;
  BOOL v6 = a1 + 2;
  *a1 = 0;
  a1[1] = v9;
  for (unint64_t i = 0LL; i < v9; ++i)
  {
    unsigned __int8 v4 = *(_BYTE *)(v8 + i) & 0x3F;
    *BOOL v6 = 0;
    v6[1] = v4;
    __memcpy_chk(v6 + 2, v10, v4, -1LL);
    v10 += v4;
    v6 += v4 + 2;
  }
...
uint64_t os_log_fmt_read_aster_if_necessary(uint64_t result, _WORD *a2, void *a3)
{
  ...
  if ((*(_WORD *)(result + 8) & 2) != 0)
  {
    ...
    unint64_t v12 = (_DWORD *)(result + 20);
    if (v10 && v10[1] == 4LL && (*v10 >> 4 == 1 || !(*v10 >> 4))) {
      uint64_t result = __memcpy_chk(v12, v10 + 2, 4LL, -1LL);
    }
    else {
      *unint64_t v12 = 0;
    }
  ...
  if ((*(_WORD *)(v5 + 8) & 8) != 0)
  {
    ...
    else
    {
      ...
      BOOL v11 = (_DWORD *)(v5 + 24);
      if (v7 && v7[1] == 4LL && (*v7 >> 4 == 1 || !(*v7 >> 4))) {
        return __memcpy_chk(v11, v7 + 2, 4LL, -1LL);
      }
      else {
        *BOOL v11 = -1;
      }
...
LABEL_63:
  ...
  if ((*(_BYTE *)v24 & 1) != 0)
  {
    unsigned __int8 v16 = privacy_flags2opt[*(_BYTE *)v24 & 7];
    if (!v16)
    {
      unsigned __int8 v17 = 3;
      goto LABEL_63;
...
BOOL os_log_fmt_validate_mask(uint64_t a1)
{
  return a1 == 1752392040
      || a1 == 0x68736168766564LL
      || a1 == 0x786F626C69616DLL
      || a1 == 0x35646D6E69616C70LL
...
{
  if (((*(_BYTE *)a1 & 1) != 0 || *(unsigned __int8 *)a1 >> 4 > 1u) && *((_BYTE *)a1 + 1) == 4LL)
  {
...
void os_log_fmt_compose( uint64_t a1, char *a2, uint64_t a3, unsigned __int8 a4, uint64_t a5, _BYTE *a6, __int16 *a7, unsigned __int16 a8, __int16 *a9, unsigned __int16 a10)
{
  ...
  while (1)
  {
    ...
    else
    {
      ...
      {
        __memcpy_chk(*(void *)v41 + *(unsigned int *)(v41 + 8), v40, v39, -1LL);
        uint64_t v61 = v41;
        unint64_t v60 = v39;
        *(_DWORD *)(v41 + 8) += v39;
        if ((*(_BYTE *)(v61 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)v61 + *(unsigned int *)(v61 + 8)) = 0;
        }
        int v42 = v60;
      }
    ...
    else
    {
      ...
      else
      {
        ...
        {
          __memcpy_chk(*(void *)v52 + *(unsigned int *)(v52 + 8), v51, v50, -1LL);
          uint64_t v59 = v52;
          unint64_t v58 = v50;
          *(_DWORD *)(v52 + 8) += v50;
          if ((*(_BYTE *)(v59 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)v59 + *(unsigned int *)(v59 + 8)) = 0;
          }
          int v53 = v58;
        }
...
size_t _os_log_fmt_compose_masked_digest( uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  else
  {
    ...
    if ((*(_WORD *)(a1 + 20) & 2) == 0)
    {
      ...
      {
        __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), "(null)", v14, -1LL);
        *(_DWORD *)(a1 + 8) += v14;
        if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
        }
  ...
  if ((*(_WORD *)(a1 + 20) & 2) == 0)
  {
    ...
    {
      size_t result = __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), ">", result, -1LL);
      *(_DWORD *)(a1 + 8) += v13;
      if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
        *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
      }
...
uint64_t _os_log_fmt_compose_masked_partial_redacted( uint64_t a1, uint64_t a2, _BYTE *a3, unsigned __int16 a4, char a5)
{
  ...
  if (a4 || (v34 & 1) != 0)
  {
    if (v35 >= 4uLL)
    {
      ...
      if (v6)
      {
        return os_trace_blob_addns(v38, v36 + 4, v35 - 4LL, 0LL);
      }
      ...
      else
      {
        ...
        else
        {
          ...
          {
            __memcpy_chk(*(void *)v106 + *(unsigned int *)(v106 + 8), v105, v104, -1LL);
            uint64_t v110 = v106;
            unint64_t v109 = v104;
            *(_DWORD *)(v106 + 8) += v104;
            if ((*(_BYTE *)(v110 + 22) & 1) == 0) {
              *(_BYTE *)(*(void *)v110 + *(unsigned int *)(v110 + 8)) = 0;
            }
            int v107 = v109;
          }
        ...
        if ((unint64_t)__b[0] + 4 < v35)
        {
          ...
          if (v15)
          {
            if (v30)
            {
              ...
              else
              {
                ...
                {
                  __memcpy_chk(*(void *)v97 + *(unsigned int *)(v97 + 8), v96, v95, -1LL);
                  uint64_t v101 = v97;
                  unint64_t v100 = v95;
                  *(_DWORD *)(v97 + 8) += v95;
                  if ((*(_BYTE *)(v101 + 22) & 1) == 0) {
                    *(_BYTE *)(*(void *)v101 + *(unsigned int *)(v101 + 8)) = 0;
                  }
                  int v98 = v100;
                }
            ...
            if (os_trace_blob_addns(v38, &v36[v29], v28, 0LL))
            {
              if (v31 || (v34 & 1) != 0)
              {
                uint64_t v85 = v38;
                ...
                else
                {
                  ...
                  {
                    __memcpy_chk(*(void *)v88 + *(unsigned int *)(v88 + 8), v87, v86, -1LL);
                    uint64_t v92 = v88;
                    unint64_t v91 = v86;
                    *(_DWORD *)(v88 + 8) += v86;
                    if ((*(_BYTE *)(v92 + 22) & 1) == 0) {
                      *(_BYTE *)(*(void *)v92 + *(unsigned int *)(v92 + 8)) = 0;
                    }
                    int v89 = v91;
                  }
            ...
            if (v25)
            {
              if (v30)
              {
                ...
                else
                {
                  ...
                  {
                    __memcpy_chk(*(void *)v79 + *(unsigned int *)(v79 + 8), v78, v77, -1LL);
                    uint64_t v83 = v79;
                    unint64_t v82 = v77;
                    *(_DWORD *)(v79 + 8) += v77;
                    if ((*(_BYTE *)(v83 + 22) & 1) == 0) {
                      *(_BYTE *)(*(void *)v83 + *(unsigned int *)(v83 + 8)) = 0;
                    }
                    int v80 = v82;
                  }
              ...
              if (os_trace_blob_addns(v38, &v36[v26], v25, 0LL))
              {
                if (v31)
                {
                  uint64_t v67 = v38;
                  ...
                  else
                  {
                    ...
                    {
                      __memcpy_chk(*(void *)v70 + *(unsigned int *)(v70 + 8), v69, v68, -1LL);
                      uint64_t v74 = v70;
                      unint64_t v73 = v68;
                      *(_DWORD *)(v70 + 8) += v68;
                      if ((*(_BYTE *)(v74 + 22) & 1) == 0) {
                        *(_BYTE *)(*(void *)v74 + *(unsigned int *)(v74 + 8)) = 0;
                      }
                      int v71 = v73;
                    }
          ...
          if ((v27 & 1) != 0)
          {
            ...
            else
            {
              ...
              {
                __memcpy_chk(*(void *)v61 + *(unsigned int *)(v61 + 8), v60, v59, -1LL);
                uint64_t v65 = v61;
                unint64_t v64 = v59;
                *(_DWORD *)(v61 + 8) += v59;
                if ((*(_BYTE *)(v65 + 22) & 1) == 0) {
                  *(_BYTE *)(*(void *)v65 + *(unsigned int *)(v65 + 8)) = 0;
                }
                int v62 = v64;
              }
        ...
        if (v21)
        {
          ...
          else
          {
            ...
            if (v50 <= *(_DWORD *)(v54 + 12) - ((*(_BYTE *)(v54 + 22) ^ 1) & 1u) - *(_DWORD *)(v54 + 8))
            {
              ...
              *(_DWORD *)(v52 + 8) += v50;
              if ((*(_BYTE *)(v56 + 22) & 1) == 0) {
                *(_BYTE *)(*(void *)v56 + *(unsigned int *)(v56 + 8)) = 0;
              }
              int v53 = v55;
            }
        ...
        else
        {
          ...
          {
            uint64_t result = __memcpy_chk(*(void *)v43 + *(unsigned int *)(v43 + 8), v42, v41, -1LL);
            uint64_t v47 = v43;
            unint64_t v46 = v41;
            *(_DWORD *)(v43 + 8) += v41;
            if ((*(_BYTE *)(v47 + 22) & 1) == 0) {
              *(_BYTE *)(*(void *)v47 + *(unsigned int *)(v47 + 8)) = 0;
            }
          }
    ...
    else
    {
      ...
      else
      {
        ...
        {
          uint64_t result = __memcpy_chk(*(void *)v115 + *(unsigned int *)(v115 + 8), v114, v113, -1LL);
          uint64_t v119 = v115;
          unint64_t v118 = v113;
          *(_DWORD *)(v115 + 8) += v113;
          if ((*(_BYTE *)(v119 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)v119 + *(unsigned int *)(v119 + 8)) = 0;
          }
          int v116 = v118;
        }
  ...
  else
  {
    ...
    else
    {
      ...
      {
        uint64_t result = __memcpy_chk(*(void *)v124 + *(unsigned int *)(v124 + 8), v123, v122, -1LL);
        uint64_t v128 = v124;
        unint64_t v127 = v122;
        *(_DWORD *)(v124 + 8) += v122;
        if ((*(_BYTE *)(v128 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)v128 + *(unsigned int *)(v128 + 8)) = 0;
        }
        int v125 = v127;
      }
  ...
  switch(a3)
  {
    case 1u:
      ...
      if ((*(_WORD *)(a1 + 20) & 2) == 0)
      {
        ...
        {
          __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), "<private>", v9, -1LL);
          *(_DWORD *)(a1 + 8) += v9;
          if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
          }
...
uint64_t _os_log_fmt_compose_scalar(uint64_t a1, void *a2, uint64_t a3, unsigned __int8 *a4, __int16 a5)
{
  ...
  __int16 v31 = a5;
  memset(&__b, 0, sizeof(__b));
  uint64_t __b = os_log_fmt_read_scalar((uint64_t)v34, v32, v31);
  int v29 = 0;
  if ((v34[1] & 2) != 0)
  {
    int v5 = *((_DWORD *)v34 + 5);
  ...
  if ((v34[1] & 4) != 0)
  {
    ...
    int v9 = *((unsigned __int16 *)v34 + 6) + 2;
  }
  uint64_t v10 = (v9 + 1);
  unint64_t v28 = v22;
  uint64_t v11 = &v22[-((v10 + 15) & 0x1FFFFFFF0LL)];
  uint64_t v27 = v10;
  unsigned __int16 v26 = 0;
  uint64_t result = _os_log_fmt_compose_format_copy(v11, v34);
  ...
  switch(*((_BYTE *)v34 + 10))
  {
    ...
    case 0x12:
    case 0x13:
      uint64_t result = _os_crash("Unexpected type");
      __break(1u);
      return result;
    case 1:
    case 2:
    ...
    case 8:
      ...
      else
      {
        ...
        {
          uint64_t result = __memcpy_chk(*(void *)v40 + *(unsigned int *)(v40 + 8), v39, v38, -1LL);
          uint64_t v44 = v40;
          unint64_t v43 = v38;
          *(_DWORD *)(v40 + 8) += v38;
          if ((*(_BYTE *)(v44 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)v44 + *(unsigned int *)(v44 + 8)) = 0;
          }
          int v41 = v43;
        }
        ...
        {
          uint64_t result = os_trace_blob_add_slow(v40, v39, v38);
          int v41 = result;
        }
      }
    ...
    case 0xD:
      if (v33 == 8)
      {
        uint64_t v24 = __b;
        if (!v29) {
          uint64_t result = os_trace_blob_addf(v35, v11, v13, v14, v15, v16, v17, v18, v24);
        }
        if (v29 == 1) {
          uint64_t result = os_trace_blob_addf(v35, v11, v13, v14, v15, v16, v17, v18, v45[0]);
        }
        if (v29 == 2) {
      ...
      if (v33 == 4)
      {
        uint64_t result = isupper(v23);
        if ((_DWORD)result)
        {
          uint64_t result = tolower(v23);
          v11[v26 - 1] = result;
        }
...
LABEL_9:
        int v25 = __b;
        if (!v29) {
          uint64_t result = os_trace_blob_addf(v35, v11, v13, v14, v15, v16, v17, v18, v25);
        }
        if (v29 == 1) {
          uint64_t result = os_trace_blob_addf(v35, v11, v13, v14, v15, v16, v17, v18, v45[0]);
        }
...
LABEL_32:
        if (!v29) {
          uint64_t result = os_trace_blob_addf(v35, v11, v13, v14, v15, v16, v17, v18, __b);
        }
        if (v29 == 1) {
          uint64_t result = os_trace_blob_addf(v35, v11, v13, v14, v15, v16, v17, v18, v45[0]);
        }
...
uint64_t _os_log_fmt_compose_data( uint64_t a1, uint64_t a2, _BYTE *a3, uint64_t a4, unsigned __int16 a5, char a6)
{
  ...
  int v29 = &v25;
  int v7 = (char *)&v25 - ((v6 + 18) & 0x1FFF0);
  uint64_t v28 = (v6 + 3);
  unsigned __int16 v27 = 0;
  uint64_t result = _os_log_fmt_compose_format_copy(v7, (void *)a2);
  unsigned __int16 v27 = result;
  if (*v34 >> 4 == 3)
  {
    uint64_t result = os_trace_blob_add_hexdump(v36, v33, v32, v31 & 1);
    int v26 = 1;
  }
  ...
  else
  {
    ...
    if (v32)
    {
      if ((*(_WORD *)(v35 + 8) & 8) != 0)
      {
        ...
        {
          int v25 = 0LL;
          int v25 = strrchr(v7, 46);
          uint64_t result = __memcpy_chk(v25, ".*s", 4LL, -1LL);
          int v20 = v30++;
          *(&v40 + v20) = v32;
        }
      }
      ...
      {
        uint64_t result = __memcpy_chk(&v7[v27 - 1], ".*s", 4LL, -1LL);
        int v19 = v30++;
        *(&v40 + v19) = v32;
      }
    }
    ...
    {
      if ((v31 & 1) != 0) {
        uint64_t v17 = (const char *)&unk_BE91;
      }
      else {
        uint64_t v17 = "(null)";
      }
    ...
    if (!v30) {
      uint64_t result = os_trace_blob_addf(v36, v7, v9, v10, v11, v12, v13, v14, v33);
    }
    if (v30 == 1)
    {
      HIBYTE(v24) = HIBYTE(v33);
      uint64_t result = os_trace_blob_addf(v36, v7, v9, v10, v11, v12, v13, v14, v40);
    }
    ...
    if ((v31 & 1) != 0)
    {
      ...
      unint64_t v38 = "<…>";
      uint64_t v37 = 0LL;
      return os_trace_blob_addns(v36, "<…>", 0xFFFFFFFFFFFFFFFFLL, 0LL);
    }
  }
...
{
  unsigned __int16 __n = *((_WORD *)a2 + 6);
  uint64_t v3 = memchr((const void *)*a2, 125, __n);
  if (v3)
  {
    __n -= (_WORD)v3 - *a2;
    __memcpy_chk(a1, v3, __n, -1LL);
    *a1 = 37;
  }

  else
  {
    __memcpy_chk(a1, *a2, __n, -1LL);
  }
  ...
  if ((_os_log_fmt_spec_is_integer(a3, 1) & 1) != 0)
  {
    ...
    if (**(_BYTE **)(v23 + 40) == 66)
    {
      ...
      else
      {
        ...
        if (v38 <= *(_DWORD *)(v42 + 12) - ((*(_BYTE *)(v42 + 22) ^ 1) & 1u) - *(_DWORD *)(v42 + 8))
        {
          __memcpy_chk(*(void *)v40 + *(unsigned int *)(v40 + 8), v39, v38, -1LL);
          uint64_t v44 = v40;
          unint64_t v43 = v38;
          *(_DWORD *)(v40 + 8) += v38;
          if ((*(_BYTE *)(v44 + 22) & 1) == 0) {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          __memcpy_chk(*(void *)v31 + *(unsigned int *)(v31 + 8), v30, v29, -1LL);
          uint64_t v35 = v31;
          unint64_t v34 = v29;
          *(_DWORD *)(v31 + 8) += v29;
          if ((*(_BYTE *)(v35 + 22) & 1) == 0) {
            *(_BYTE *)(*(void *)v35 + *(unsigned int *)(v35 + 8)) = 0;
          }
          int v32 = v34;
        }
...
{
  if ((_os_log_fmt_spec_is_integer(a3, 0) & 1) != 0 && a6 == 4LL)
  {
    int __errnum = *a5;
    if (*a5) {
      strerror(__errnum);
...
uint64_t _os_log_fmt_builtin_darwin_mode( uint64_t a1, uint64_t a2, uint64_t a3, _BYTE *a4, int *a5, unsigned __int16 a6)
{
  if ((_os_log_fmt_spec_is_integer(a3, 0) & 1) != 0 && a6 == 4LL)
  {
    ...
    if ((*(_WORD *)(a1 + 20) & 2) == 0)
    {
      ...
      {
        __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), v29, 10LL, -1LL);
        *(_DWORD *)(a1 + 8) += 10;
        if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
        }
...
uint64_t _os_log_fmt_builtin_time( tm *a1, uint64_t a2, uint64_t a3, _BYTE *a4, uint64_t a5, unsigned __int16 a6, char a7)
{
  ...
  if ((_os_log_fmt_spec_is_integer(a3, 0) & 1) != 0 && (v16 == 4 || v16 == 8))
  {
    ...
    {
      time_t v12 = 0LL;
      __memcpy_chk(&v12, v17, v16, 8LL);
      time_t v14 = v12;
    }

    os_trace_blob_add_localtime(v21, v14, 0LL, 3);
    char v22 = 1;
  }
...
LABEL_12:
  if ((v12 & 1) != 0)
  {
    ...
    if ((*(_WORD *)(a1 + 20) & 2) == 0)
    {
      ...
      {
        __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), __b, v11, -1LL);
        *(_DWORD *)(a1 + 8) += v11;
        if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
        }
...
uint64_t _os_log_to_kernel(char *a1, _BYTE *a2)
{
  ...
  memset(v3, 0, 0x18uLL);
  v3[0] = &v14;
  v3[1] = 0x40000000000LL;
  LODWORD(v3[2]) = 0;
  WORD2(v3[2]) = 0;
  BYTE6(v3[2]) = 0;
  os_log_fmt_compose( (uint64_t)v3,  v13,  2LL,  v10,  8LL,  __b[0],  v7[0],  (unsigned __int16)v7[1],  v5[0],  (unsigned __int16)v5[1]);
  return log_data_as_kernel(0LL, 0LL, v3[0], (LODWORD(v3[1]) + 1));
}

uint64_t _os_trace_realloc(uint64_t a1, uint64_t a2)
{
  uint64_t v4 = malloc_type_realloc(a1, a2, 995718784LL);
  if (!v4)
  {
    uint64_t v3 = _os_assert_log(0LL);
    _os_crash(v3);
    __break(1u);
  }
...
{
  uint64_t v3 = malloc_type_malloc(a1, 19701672LL);
  if (!v3)
  {
...
{
  uint64_t v2 = _os_trace_malloc(a2);
  return __memcpy_chk(v2, a1, a2, -1LL);
}
...
void _os_log_fmt_decode_cmd_mismatch( uint64_t a1, uint64_t a2, _BYTE *a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  {
    char v26 = _cmd_type2str[*a3 >> 4];
    size_t v25 = strlen(v26);
    if ((*(_WORD *)(a1 + 20) & 2) == 0)
    {
      if (v25 <= *(_DWORD *)(a1 + 12) - ((*(_BYTE *)(a1 + 22) ^ 1) & 1u) - *(_DWORD *)(a1 + 8))
      {
        __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), v26, v25, -1LL);
        *(_DWORD *)(a1 + 8) += v25;
        if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
        }
  ...
  if ((*a3 & 2) != 0)
  {
    ...
    if ((*(_WORD *)(a1 + 20) & 2) == 0)
    {
      ...
      {
        __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), " public", v24, -1LL);
        *(_DWORD *)(a1 + 8) += v24;
        if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
        }
  ...
  if ((*a3 & 1) != 0)
  {
    ...
    if ((*(_WORD *)(a1 + 20) & 2) == 0)
    {
      ...
      {
        __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), " private", v23, -1LL);
        *(_DWORD *)(a1 + 8) += v23;
        if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
          *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
        }
...
void _os_log_fmt_decode_error(uint64_t a1)
{
  ...
  if ((*(_WORD *)(a1 + 20) & 2) == 0)
  {
    ...
    {
      __memcpy_chk(*(void *)a1 + *(unsigned int *)(a1 + 8), "<decode: missing data>", v1, -1LL);
      *(_DWORD *)(a1 + 8) += v1;
      if ((*(_BYTE *)(a1 + 22) & 1) == 0) {
        *(_BYTE *)(*(void *)a1 + *(unsigned int *)(a1 + 8)) = 0;
      }
