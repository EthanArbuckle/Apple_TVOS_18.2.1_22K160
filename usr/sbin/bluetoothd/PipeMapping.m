...
- (PipeMapping)initWithIdentifier:(id)a3 handle:(unsigned __int16)a4
{
  id v7 = a3;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___PipeMapping;
...
- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"identifier:%@ handle:%#06x",  self->_identifier,  self->_pipeHandle);
}
