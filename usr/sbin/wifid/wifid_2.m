...
void sub_100124628(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 48) array] != v3)
  {
    ...
    {
      [ *(id *)(*(void *)(a1 + 32) + 56) setObject:[ *(id *)(a1 + 48) array] forKeyedSubscript: *(void *)(a1 + 40)];
...
{
  v2 = objc_autoreleasePoolPush();
  *(void *)(*(void *)(*(void *)(a1 + 48) + 8) + 40) = [ [ [ *(id *)(*(void *)(a1 + 32) + 56) objectForKeyedSubscript: [ *(id *)(a1 + 40) requestParameters] interfaceName] copy];
  objc_autoreleasePoolPop(v2);
}
    ...
    else
    {
      switch(v6)
      {
        ...
        case '9':
          ...
          break;
        case ':':
          [ *(id *)(a1 + 40) __getCurrentNetworkProfile:XPCConnection: *(void *)(a1 + 32),  *(void *)(a1 + 48)];
          break;
        case ';':
        ...
        case '<':
          ...
          break;
        case '=':
          [ *(id *)(a1 + 40) __updateKnownNetworkProfile:XPCConnection: *(void *)(a1 + 32),  *(void *)(a1 + 48)];
          break;
        case '>':
  ...
  else
  {
    switch(v6)
    {
      ...
      case 179LL:
        ...
        break;
      case 180LL:
        [ *(id *)(a1 + 40)  __setUserAutoJoinState:XPCConnection: *(void *)(a1 + 32),  *(void *)(a1 + 48)];
        break;
      case 181LL:
      case 184LL:
      case 191LL:
      ...
      case 236LL:
        ...
        break;
      case 238LL:
        [*(id *)(a1 + 40) __performNDD:*(void *)(a1 + 32) XPCConnection:*(void *)(a1 + 48)];
        break;
      case 243LL:
...
LABEL_12:
  ...
  if (*(_BYTE *)(a1 + 72))
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: timer is running. Will not signal cmdQueue" message:3];
    }
...
void sub_10012A0E0(id a1, id a2, NSError *a3)
{
  ...
  if (v4)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"Failed to register for WAGroupTypeWiFi with the WA daemon (wifianalyticsd). Error code: %ld. *** All message/met ric submission is likely broken." message:[NSError code:v4, "code"], v6];
    }
    objc_autoreleasePoolPop(v5);
  }
}
...
void sub_10012A44C(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    {
      [qword_100219F60 WFLog:@"%s Successfully submitted GEOWiFiConnectionQuality instance" message:3];
    }
...
void sub_10012A5C0(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    [qword_100219F60 WFLog:@"%s Successfully submitted WiFiDiagnostics instance" message:3];
  }
...
LABEL_4:
  ...
  if (!v10)
  {
    id v6 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s result is nil" message:4 -[WiFiManagerAnalytics getDeviceAnalyticsConfigurationWithCompletion:]_block_invoke v9];
    }
    goto LABEL_4;
  }
...
LABEL_15:
  ...
  if (!v12)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s result for triggerDeviceAnalyticsStoreMigration is nil" message:4];
    }
...
void sub_10012AD88(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    id v10 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s NULL reply supplied trying to process: %u" message:3];
    }
    objc_autoreleasePoolPop(v10);
  }
}
  ...
  switch(v3)
  {
    ...
    default:
      ...
      else
      {
        ...
        if (qword_100219F60) {
          [qword_100219F60 WFLog:@"[WiFiManagerAnalytics prepareMessageForSubmission] Unhandled message ID: %u" message:4 *[v257 count]];
        }
...
LABEL_4:
  ...
  if (!CFDictionaryGetValueIfPresent(*(CFDictionaryRef *)(a1 + 40), @"symptom", (const void **)&value))
  {
    id v7 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s Failed to get key kWiFiDPSSypmtom" message:4];
    }
    goto LABEL_4;
  }
...
id sub_10012DFAC(uint64_t a1)
{
  ...
  id v3 = objc_autoreleasePoolPush();
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"%s: Enter" message:3];
  }
  objc_autoreleasePoolPop(v3);
  if (v2) {
  ...
  else
  {
    id v10 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: User declined the TTR" message:3];
    }
    objc_autoreleasePoolPop(v10);
  }
...
LABEL_15:
  ...
  id v7 = objc_autoreleasePoolPush();
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"%s: Setting work NOI for %s to : %@(%d)", @"-[WiFiNOIManager setNetworkOfInterest:]_block_invoke", [v2 UTF8String], sub_10003B360(v3), v3 message];
  }
  objc_autoreleasePoolPop(v7);
  ...
  if (result)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*(void *)(a1 + 32) + 8) networkAttachmentInfoForScopedNOI:_NSConcreteStackBlock reply:3221225472 sub_10012EBA0:&unk_1001E5FB0 *(void *)(*((void *)&v7 + 1) + 8 * (void)v6) *(void *)(a1 + 32)];
  ...
  if (result)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [ *(id *)(*(void *)(a1 + 32) + 8) networkAttachmentInfoForScopedNOI:_NSConcreteStackBlock reply:3221225472 sub_10012EE48 unk_1001E5FB0 *(void *)(*((void *)&v7 + 1) + 8 * (void)v6) *(void *)(a1 + 32)];
        double v6 = (char *)v6 + 1;
      }
...
void sub_10012FA4C()
{
  ...
  if (v1)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"could not get apple languages array, assuming english\n"];
    }
    objc_autoreleasePoolPop(v3);
...
LABEL_28:
        ...
        [v10 WFLog:3 message:v11, v13, v14];
        goto LABEL_28;
      }
...
_OWORD *sub_10012FED8( uint64_t a1, uint64_t a2, const __CFDictionary *a3, uint64_t a4, void (*a5)(uint64_t, _OWORD *))
{
  ...
  if (!a3)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null intfDictionary." message:@"WiFiVirtualInterfaceCreateWithCompletion"];
    }
    goto LABEL_33;
  }
  ...
  if (!Instance)
  {
    v34 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"Cannot create interface instance" message:4];
    }
LABEL_33:
...
LABEL_35:
  ...
  {
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: APPLE80211_IOC_AWDL_PEER_TRAFFIC_REGISTRATION returned error %d." message:4, @"WiFiVirtualInterfaceStartAwdl", v25];
    }
...
LABEL_26:
  ...
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"%s: self(metric=%d): preferred=%d master=%d secondary channel=%d flags=0x%x; peer(metric=%d): preferred=%d master=", 3, "%s: self(metric=%d): preferred=%d master=%d secondary channel=%d flags=0x%x; peer(metric=%d): preferred=%d master="
  }
  ...
  if (v26 <= 0xE || !v31)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: reset: self(metric=%d): preferred=%d master=%d secondary channel=%d; peer(metric=%d): preferred=%d  master=%"
    }
  ...
  *(void *)bytes = 0xC064696669775F06LL;
  ...
  if (a3 && sub_1000951FC(a3, @"APPLE80211KEY_AWDL_INFO_ASSISTED_DISCOVERY_FOLLOW"))
  {
    ...
    if (!Mutable)
    {
      ...
      if (qword_100219F60) {
        [qword_100219F60 WFLog:@"%s: null follow mode policy." message:3];
      }
...
LABEL_18:
  ...
  if (!v6)
  {
    CFDataRef v12 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: Ioctls are not supported on this interface" message:3];
    }
...
void sub_1001343C0(uint64_t a1, unsigned int a2)
{
  if (a1)
  {
    if (*(_BYTE *)(a1 + 58))
    {
      BOOL v4 = objc_autoreleasePoolPush();
      if (qword_100219F60) {
        [qword_100219F60 WFLog:@"%s: Lockdown Mode is enabled, ignoring SetATJMode %ld" message:3,  "%s: Lockdown Mode is enabled, ignoring SetATJMode %ld",  "WiFiATJMgrSetATJMode",  a2];
      }
      objc_autoreleasePoolPop(v4);
    }
  ...
  if (a1)
  {
    *(_BYTE *)(a1 + 57) = a2;
    ...
    if (qword_100219F60)
    {
      ...
      [qword_100219F60 WFLog:@"ATJManager: atj test mode %s "];
    }
...
BOOL sub_10013451C(uint64_t a1, BOOL a2, const __CFArray *a3, uint64_t a4)
{
  ...
  if (qword_100219F60)
  {
    ...
    [qword_100219F60 WFLog:@"ATJManager: atjAction=%d atjEnabled=%d userInteractionMode=%s discovered %ld networks" message:3 a4,  *(unsigned __int8 *)(a1 + 16),  v11,  CFArrayGetCount((CFArrayRef)a2)];
  }
...
LABEL_33:
    ...
    if (a3 && Count && CFArrayGetCount(a3) && CFArrayGetCount((CFArrayRef)a2) >= 1)
    {
      ...
      if (qword_100219F60) {
        [qword_100219F60 WFLog:@"%s: in range of preferred network." message:3, "%s: in range of preferred network."];
      }
...
void sub_1001361B8(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    uint64_t v6 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: no delivered notifications, clearing visible request (%@) for recommendation %@", @"-[WiFiUserNotificationManager dispatchNotificationWithRecommendation:currentLocation:force:]_block_invoke", [*(id *)(a1 + 32) visibleRequest], v5 message];
    }
    objc_autoreleasePoolPop(v6);
...
void sub_100136350(uint64_t a1, void *a2)
{
  ...
  {
    if (qword_100219F60) {
      [qword_100219F60 WFLog:3, "%s: Error: %@", "-[WiFiUserNotificationManager dispatchNotificationWithRecommendation:currentLocation:force:]_block_invoke", [a2 localizedDescription] message];
    }
    objc_autoreleasePoolPop(v5);
  }
...
void sub_100136EA4(uint64_t a1, void *a2)
{
  ...
  {
    if (qword_100219F60) {
      [qword_100219F60 WFLog:3, "%s: Error: %@", "-[WiFiUserNotificationManager dispatchJoinAlertForNetwork:withProviderName:andReason:]_block_invoke_3", [a2 localizedDescription] message];
    }
    objc_autoreleasePoolPop(v5);
  }
...
void sub_100137434(uint64_t a1, void *a2)
{
  ...
  {
    if (qword_100219F60) {
      [qword_100219F60 WFLog:3, "%s: Error: %@", "-[WiFiUserNotificationManager dispatchLowDataModeAlertForNetwork:withReason:]_block_invoke_3", [a2 localizedDescription] message];
    }
    objc_autoreleasePoolPop(v5);
  }
...
void sub_100137F40(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (v5[8])
    {
      ...
      if (qword_100219F60) {
        [qword_100219F60 WFLog:@"%s: canceling timer" message:3, "-[WiFiUserNotificationManager dispatchNotificationWithAskToJoinHotspotRecommendation:]_block_invoke"];
      }
      objc_autoreleasePoolPop(v6);
...
void sub_100138024(uint64_t a1, void *a2)
{
  ...
  {
    if (qword_100219F60) {
      [qword_100219F60 WFLog:3, "%s: Error: %@", "-[WiFiUserNotificationManager dispatchNotificationWithAskToJoinHotspotRecommendation:]_block_invoke_2", [a2 localizedDescription] message];
    }
    objc_autoreleasePoolPop(v5);
  }
...
{
  BOOL v3 = (void *)[a2 lastPathComponent:a3];
...
BOOL sub_10013C1A0(uint64_t a1, char a2)
{
  ...
  id v5 = objc_autoreleasePoolPush();
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"WiFiDextCrashSoftError Enter"];
  }
  objc_autoreleasePoolPop(v5);
  if (v4 && (a2 & 1) == 0)
  {
  ...
  if (!*(_WORD *)(a1 + 50))
  {
    uint64_t v21 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: No Dext corefiles found isRetry:%d" message:3,  "%s: No Dext corefiles found isRetry:%d",  "WiFiDextCrashedSoftErrorHandler",  0];
    }
    goto LABEL_28;
  }
...
void sub_10013CC68(uint64_t a1)
{
  if (v2 >= 120.0)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"-[WiFi3BarsObserver _installDeferMonitorForActivity:proxy:]_block_invoke_2" message:3 "%s: activity exceeded max time of %d secs"];
    }
    objc_autoreleasePoolPop(v4);
...
id sub_10013CFF0(uint64_t a1)
{
  ...
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"-[WiFi3BarsObserver run3BarsObserver:withActivity:withCompletion:]_block_invoke_2" message:3];
  }
  objc_autoreleasePoolPop(v2);
  (*(void (**)(void))(*(void *)(a1 + 40) + 16LL))();
  return [*(id *)(a1 + 32) _cleanupMaintenanceTask];
...
void sub_10013E9DC(id a1)
{
  ...
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"_DiagnosticLogSubmissionEnabled_block_invoke" message:3 "%s: DiagnosticLogSubmissionEnabled: %d"];
  }
  ...
  if ((result & 1) == 0)
  {
    ...
    if (result)
    {
      ...
      if (result)
      {
        ...
        id v5 = result;
        return [v4 collectLogs:+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", &v5, 1) configuration:+[NSDictionary dictionaryWithObjects:forKeys:count:]( NSDictionary,  "dictionaryWithObjects:forKeys:count:",  v7,  v6,  2) update:0 reply:&stru_1001E6960];
      }
    }
  }
  ...
  if ((result & 1) == 0)
  {
    ...
    if (result)
    {
      ...
      if (result)
      {
        ...
        v7[1] = &__kCFBooleanTrue;
        id v5 = result;
        return [v4 collectLogs:[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", &v5, 1) dictionaryWithObjects:forKeys:count:]( NSDictionary,  "dictionaryWithObjects:forKeys:count:",  v7,  v6,  2) update:0 reply:&stru_1001E6980];
      }
    }
  }
...
void sub_10013FDF8(id a1, void *a2, unint64_t a3)
{
  ...
  __int128 v13 = 0u;
  __int128 v14 = 0u;
  id v4 = (void *)objc_claimAutoreleasedReturnValue([a2 clients]);
...
void sub_10013FF1C(uint64_t a1)
{
  ...
  uint64_t v2 = objc_autoreleasePoolPush();
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"%s: received com.apple.system.console_mode_changed (%llu)" message:3, "%s: received com.apple.system.console_mode_changed (%llu)", "-[WiFiUserInteractionMonitor _initPrivate]_block_invoke_2", state64];
  }
  objc_autoreleasePoolPop(v2);
  uint64_t v3 = state64;
  if (state64 != 1) {
...
void sub_100142D44(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if ((_DWORD)a2)
  {
    uint64_t v4 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: Error %d from Managed Event Fetch" message:4, "-[WiFiUserInteractionMonitor _handleManagedEventNotification]_block_invoke", a2];
    }
LABEL_4:
    objc_autoreleasePoolPop(v4);
    return;
...
LABEL_70:
  ...
  if (v5)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:3, "%s for <%@>", "WiFiNetworkSyncHelperCreateNetworkRef", [a1 objectForKey:@"SSID_STR"] message];
    }
    objc_autoreleasePoolPop(v16);
...
void sub_100144DA4(void *a1, uint64_t a2)
{
  if (a1)
  {
    if (a2)
    {
      ...
      id v7 = objc_autoreleasePoolPush();
      if (qword_100219F60) {
        [qword_100219F60 WFLog:@"%s: WPA3 not supported, will not add WPA3-only network" message:3];
      }
    }
...
uint64_t sub_100145088(void *a1)
{
  ...
  if ([v3 BOOLValue])
  {
    id v12 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"EAP network, not syncable" message:3];
    }
    goto LABEL_40;
  }
  ...
  if ([v5 BOOLValue])
  {
    id v12 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: configured network, not syncable" message:3];
    }
    goto LABEL_40;
  }
  ...
  if (v9 && [v9 BOOLValue])
  {
    id v12 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: carplay only network, not syncable" message:3];
    }
LABEL_40:
    objc_autoreleasePoolPop(v12);
    uint64_t v10 = 0LL;
...
void sub_100145508(uint64_t a1)
{
  ...
  else
  {
    id v8 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: WCM is disabled " message:3];
    }
  }
...
void sub_100145728(uint64_t a1, xpc_object_t object)
{
  ...
  if (object == &_xpc_error_connection_interrupted)
  {
    id v5 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: Re-Register" message:3];
    }
    objc_autoreleasePoolPop(v5);
    sub_100145508(v3);
  }
...
{
  return [a1 addRangingRttSampleWithRssi:rssi:rtt:snr:flags:channel:coreId:bitErrorRate:phyError:andPeerSnr:andPeerCoreId:andPe erBitErrorRate:andPeerPhyError:];
}
...
{
  return [a1 initWithClient:network:bundleId:localizedAppName:originator:poweredOff:wapi:sessionBased:useSSIDPrefix:callback:context:bypassPrompt:];
}
...
{
  return [a1 initWithManager:availabilityEngine:scanResults:disableProminentFiltering:blacklistedSSIDs:];
}
...
{
  return [a1 notifyDriverAvailability:available:version:flags:eventID:reason:subReason:minorReason:reasonString:];
}
...
{
  return [a1 populateWithTxFrames:RxFrames:TxFails:TxRetries:RxRetries:TxRate:RxRate:txRTS:txRTSFail:txMpdu:txAMPDU:];
}
...
{
  return [a1 rangingSessionRequestedWithSelfPreferredChannel:selfMainChannel:selfChannelFlags:peerPreferredChannel:peerMainChannel:peerChannelFlags:requester:];
}
...
{
  return [a1 receivedBssTransitionRequest:candidateListIncluded:isAbridged:disassociationImminent:bssTerminationIncluded:e ssDisassociationImminent:];
}
