...
- (void)__startAWDLPeerAssistedDiscovery:(id)a3 XPCConnection:(id)a4
{
  ...
  {
    BOOL v16 = ether_aton([[v10 peerMACAddress] UTF8String]);
    if (v16) {
  ...
  if ([v10 localSecondaryPreferredChannel])
  {
    ...
    [v17 setObject:[NSData dataWithBytes:&v25 length:2] forKeyedSubscript:@"AWDL_INFO_EXT"];
  }
...
- (void)__addKnownNetworkProfile:(id)a3
{
  id v5 = a3;
  id v6 = [a3 info];
  [ [ [ v6 objectForKeyedSubscript:CWFXPCNetworkProfilePropertiesKey] mutableCopy] addObjectsFromArray:&off_100205888];
  id v7 = [a3 info];
...
LABEL_29:
  ...
  if (v22)
  {
    ...
    if (((unint64_t)[v9 addReason] & 0xFFFFFFFFFFFFFFFELL) == 0xE)
    {
      ...
      [v24 setObject:sub_1000951FC((uint64_t)v23, @"NetworkOriginator") forKeyedSubscript:@"NetworkOriginator"];
      [v24 setObject:sub_1000951FC((uint64_t)v23, @"BundleIdentifier") forKeyedSubscript:@"BundleIdentifier"];
...
- (void)__setPower:(id)a3 XPCConnection:(id)a4
{
  ...
  if (v8 && (v9 = v8, (id v10 = objc_msgSend(objc_msgSend(a3, "requestParameters"), "interfaceName")) != 0))
  {
    ...
    {
      sub_10006FC28( (uint64_t)self->_managerRef,  (int)[v9 BOOLValue],  (const __CFString *)[a4 processName]);
      id v11 = 0LL;
      goto LABEL_5;
    }
  ...
  if (v9 && (v10 = v9, (id v11 = objc_msgSend(objc_msgSend(a3, "requestParameters"), "interfaceName")) != 0))
  {
    ...
    if (v13)
    {
      ...
      if ([v26 count])
      {
        v53 = @"SSID_STR";
        v54 = &stru_1001EB6E0;
        [v26 addObject:[NSDictionary dictionaryWithObjects:forKeys:count:&v54, &v53, 1]];
      }
      ...
      [v41 setObject:[NSNumber numberWithUnsignedInt:[v43 scanFlags]] forKeyedSubscript:@"SCAN_FLAGS"];
      if ([v43 shortSSID]) {
      ...
      [v41 setObject:[NSNumber numberWithUnsignedLongLong:[v43 minimumTimestamp]] forKeyedSubscript:@"SCAN_MIN_TIMESTAMP"];
...
- (void)sendInternetRelayLinkChangedEvent:(BOOL)a3 rssi:(int64_t)a4 interfaceName:(id)a5
{
  ...
  id v19 = v11;
  uint64_t v12 = CWFGetOSLog([v10 setInfo:[NSDictionary dictionaryWithObjects:forKeys:count:]( NSDictionary,  "dictionaryWithObjects:forKeys:count:",  &v19,  &v18,  1)]);
  if (v12) {
...
- (void)replayLinkUpEventWithInterfaceName:(id)a3
{
  ...
  id v13 = v7;
  uint64_t v8 = CWFGetOSLog( [v6 setInfo:+[NSDictionary dictionaryWithObjects:forKeys:count:]( NSDictionary,  "dictionaryWithObjects:forKeys:count:",  &v13,  &v12,  1)]);
  if (v8) {
...
- (id)__getSensingParams:(id)a3
{
  ...
  [v4 setObject:[a3 matchMACAddresses] forKeyedSubscript:@"SENSING_PARAMS_MATCH_MAC_ADDRESS"];
  ...
  [v4 setObject:[NSNumber numberWithBool:[a3 submitMetric]] forKeyedSubscript:@"SENSING_PARAMS_SUBMIT_METRIC"];
  ...
  [v4 setObject:[a3 placeLabels] forKeyedSubscript:@"SENSING_PARAMS_PLACE_LABELS"];
...
- (void)__startHostAPMode:(id)a3 XPCConnection:(id)a4
{
  ...
  [v15 setObject:[NSNumber numberWithUnsignedInt:[v10 PHYMode]] forKeyedSubscript:@"AP_MODE_PHY_MODE"];
  [v15 setObject:[NSNumber numberWithBool:[v10 forceBeaconInterval100ms]] forKeyedSubscript:@"AP_MODE_FORCE_BI_100"];
  [v15 setObject:[NSNumber numberWithBool:[v10 forceHiddenMode]] forKeyedSubscript:@"SOFTAP_SOFTAP_HIDDEN_NETWORK"];
...
- (void)__clearAutoJoinDenyList:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      uint64_t v7 = (uint64_t)v6;
      id v8 = [a3 info];
      uint64_t v9 = [(int)[v8 objectForKeyedSubscript:CWFAutoJoinDenyListRemoveReasonKey] intValue];
      id v10 = [a3 info];
      int v11 = sub_1000A1DEC([v10 objectForKeyedSubscript:CWFXPCNetworkProfileKey], 0);
