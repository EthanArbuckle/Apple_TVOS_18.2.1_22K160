...
- (void)_timeoutTimerDidFire:(id)a3
{
  ...
  if (-[NSString isEqualToString:]( -[WiFiUserNotificationManager visibleRequest](self, "visibleRequest"),  "isEqualToString:",  v6))
  {
    ...
    {
      -[WiFiUserNotificationManager _submitAnalyticsEventForJoinAlertReason:action:visibleDuration:]( self,  "_submitAnalyticsEventForJoinAlertReason:action:visibleDuration:",  objc_msgSend(objc_msgSend(v11, "objectForKey:", @"Reason"), "integerValue"),  3,  v13);
    }
