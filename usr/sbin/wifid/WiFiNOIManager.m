...
- (WiFiNOIManager)initWithQueue:(id)a3
{
  ...
  if (!v9)
  {
    v13 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null _trackedWorkNetworks" message:3 "%s: null _trackedWorkNetworks" "-[WiFiNOIManager initWithQueue:]"];
    }
    goto LABEL_23;
  }
...
- (void)armHomeNetworkTransitionTimer:(__WiFiDeviceManager *)a3
{
  ...
  if (!homeTransitionTimer)
  {
    ...
    uint64_t v10 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"_noiTransitionCheckTimer is NULL"];
    }
LABEL_15:
...
- (id)copyHomeNetworkTransitionDate
{
  ...
  if (!v5)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"null dateComponents" message:@"-[WiFiNOIManager copyHomeNetworkTransitionDate]"];
    }
    goto LABEL_11;
  }
