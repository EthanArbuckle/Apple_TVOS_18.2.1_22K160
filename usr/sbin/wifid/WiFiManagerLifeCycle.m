...
LABEL_10:
  ...
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"----- WiFiManager starting, version: %s -----" message:@"WiFiManager-1800.35 Nov 10 2024 02:31:40"];
  }
...
- (void)stopOnQueue:(id)a3
{
  objc_super v5 = objc_autoreleasePoolPush();
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"----- WiFiManager stopping, version: %s -----" message:@"WiFiManager-1800.35 Nov 10 2024 02:31:40"];
  }
  objc_autoreleasePoolPop(v5);
