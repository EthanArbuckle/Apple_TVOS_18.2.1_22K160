...
- (WiFiAppStateManager)init
{
  ...
  if (!v4)
  {
    v11 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null _activeApplications" message:3];
    }
    goto LABEL_25;
  }
...
LABEL_26:
  ...
  if (!v7)
  {
    v11 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null _applicationStateMonitor" message:3];
    }
    goto LABEL_25;
  }
...
- (void)_applicationStateMonitorHandler:(__CFDictionary *)a3
{
  ...
  if (!a3)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null userInfo" message:3];
    }
    goto LABEL_57;
  }
  ...
  if (!CFDictionaryGetValueIfPresent(a3, BKSApplicationStateKey, (const void **)&v39))
  {
    v19 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"Null BKSApplicationStateKey" message:3 "%s: Null BKSApplicationStateKey" "-[WiFiAppStateManager _applicationStateMonitorHandler:]"];
    }
LABEL_57:
...
- (void)_unRegisterApplication:(__CFString *)a3
{
  if (a3)
  {
    ...
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null _applications" message:3 "-[WiFiAppStateManager _unRegisterApplication:]"];
    }
  }
  ...
  else
  {
    CFMutableSetRef v4 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null bundleID" message:3 "-[WiFiAppStateManager _unRegisterApplication:]"];
    }
  }
...
- (void)_registerApplication:(__CFString *)a3 capabilities:(int)a4
{
  ...
  if (a3)
  {
    ...
    else
    {
      ...
      if (qword_100219F60) {
        [qword_100219F60 WFLog:@"%s: null capabilitiesRef" message:3];
      }
...
- (void)_setApplicationState:(__CFString *)a3 active:(BOOL)a4 underLock:(BOOL)a5 capabilities:(int)a6
{
  ...
  if (!activeApplications)
  {
    unsigned int v29 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s: null active applications" message:3];
    }
    goto LABEL_46;
  }
...
LABEL_12:
  ...
  if (qword_100219F60) {
    [qword_100219F60 WFLog:@"-[WiFiAppStateManager _setApplicationState:active:underLock:capabilities:] %d bgBefore=%d bgAfter=%d fgBefore=%d fgAfter=%d" message:401 v15 v20 Count v19];
  }
