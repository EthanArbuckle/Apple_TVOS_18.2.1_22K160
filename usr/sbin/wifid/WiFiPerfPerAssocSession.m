...
- (WiFiPerfPerAssocSession)initWithNetworkRecord:(void *)a3 managerRef:(void *)a4 andManagerQueue:(id)a5
{
  ...
  if (!a4)
  {
    v22 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s initWithNetworkRecord: without managerRef" message:3 "%s initWithNetworkRecord: without managerRef" message:3];
    }
    goto LABEL_12;
  }
  ...
  if (!v9)
  {
    v22 = objc_autoreleasePoolPush();
    if (qword_100219F60) {
      [qword_100219F60 WFLog:@"%s initWithNetworkRecord: without manager queue" message:3];
    }
LABEL_12:
...
- (id)_deltaStartScorecard:(id)a3 fromEndScorecard:(id)a4
{
  ...
  v12 = (void *)[v5 objectForKeyedSubscript:@"bytesIn"];
  uint64_t v13 = [v12 unsignedIntegerValue];
  v14 = (void *)[v6 objectForKeyedSubscript:@"bytesIn"];
  v15 = [NSNumber numberWithUnsignedInteger:v13 - [v14 unsignedIntegerValue]];
  [v7 setObject:v15 forKeyedSubscript:@"bytesIn"];

  uint64_t v16 = (void *)[v5 objectForKeyedSubscript:@"bytesOut"];
  v17 = [v16 unsignedIntegerValue];
  v18 = (void *)[v6 objectForKeyedSubscript:@"bytesOut"];
  ...
  v22 = [v6 objectForKeyedSubscript:@"connAttempts"];
  ...
  v27 = [NSNumber numberWithUnsignedInteger:v25 - [v26 unsignedIntegerValue]];
  [v7 setObject:v27 forKeyedSubscript:@"connSuccesses"];

  v28 = [v5 objectForKeyedSubscript:@"certErrors"];
  v29 = [v28 unsignedIntegerValue];
  v30 = (void *)[v6 objectForKeyedSubscript:@"certErrors"];
  v31 = [NSNumber numberWithUnsignedInteger:v29 - [v30 unsignedIntegerValue]];
  ...
  v43 = [NSNumber numberWithUnsignedInteger:v41 - [v42 unsignedIntegerValue]];
  [v7 setObject:v43 forKeyedSubscript:@"faultyStay"];

  v44 = [v5 objectForKeyedSubscript:@"lowLqmStay"];
  v45 = [v44 unsignedIntegerValue];
  v46 = (void *)[v6 objectForKeyedSubscript:@"lowLqmStay"];
  v47 = [NSNumber numberWithUnsignedInteger:v45 - [v46 unsignedIntegerValue]];
  [v7 setObject:v47 forKeyedSubscript:@"lowLqmStay"];

  v48 = [v5 objectForKeyedSubscript:@"lowqStay"];
  v49 = [v48 unsignedIntegerValue];
  v50 = (void *)[v6 objectForKeyedSubscript:@"lowqStay"];
  v51 = [NSNumber numberWithUnsignedInteger:v49 - [v50 unsignedIntegerValue]];
  ...
  v55 = [NSNumber numberWithUnsignedInteger:v53 - [v54 unsignedIntegerValue]];
  ...
  v58 = (void *)[v6 objectForKeyedSubscript:@"lqmTransitionRate"];
  v59 = [NSNumber numberWithUnsignedInteger:v57 - [v58 unsignedIntegerValue]];
  ...
  v64 = (void *)[v5 objectForKeyedSubscript:@"packetsIn"];
  v65 = [v64 unsignedIntegerValue];
  v66 = (void *)[v6 objectForKeyedSubscript:@"packetsIn"];
  v67 = [NSNumber numberWithUnsignedInteger:v65 - [v66 unsignedIntegerValue]];
  [v7 setObject:v67 forKeyedSubscript:@"packetsIn"];

  v68 = (void *)[v5 objectForKeyedSubscript:@"packetsOut"];
  v69 = [v68 unsignedIntegerValue];
  v70 = (void *)[v6 objectForKeyedSubscript:@"packetsOut"];
  v71 = [NSNumber numberWithUnsignedInteger:v69 - [v70 unsignedIntegerValue]];
  [v7 setObject:v71 forKeyedSubscript:@"packetsOut"];

  v72 = (void *)[v5 objectForKeyedSubscript:@"reTxBytes"];
  v73 = [v72 unsignedIntegerValue];
  v74 = (void *)[v6 objectForKeyedSubscript:@"reTxBytes"];
  v75 = [NSNumber numberWithUnsignedInteger:v73 - [v74 unsignedIntegerValue]];
  ...
  v79 = [NSNumber numberWithUnsignedInteger:v77 - [v78 unsignedIntegerValue]];
  [v7 setObject:v79 forKeyedSubscript:@"receivedDupes"];

  v80 = (void *)[v5 objectForKeyedSubscript:@"rxOutOfOrderBytes"];
  v81 = [v80 unsignedIntegerValue];
  v82 = [v6 objectForKeyedSubscript:@"rxOutOfOrderBytes"];
  v83 = [NSNumber numberWithUnsignedInteger:v81 - [v82 unsignedIntegerValue]];
  ...
  v86 = (void *)[v6 objectForKeyedSubscript:@"topDownloadRate"];
...
- (void)accumulateActiveUsageWithScorecard:(id)a3
{
  ...
  if (v56)
  {
    ...
    if (v4)
    {
      ...
      if (v11)
      {
        v12 = [v56 objectForKeyedSubscript:@"instant"];
        uint64_t v13 = (void *)[v12 allValues];
        v14 = (void *)[v13 objectAtIndex:0];
        v15 = (void *)[v14 objectForKeyedSubscript:@"bytesIn"];
        ...
        uint64_t v16 = (void *)[v56 objectForKeyedSubscript:@"instant"];
        v17 = (void *)[v16 allValues];
        v18 = (void *)[v17 objectAtIndex:0];
        uint64_t v19 = (void *)[v18 objectForKeyedSubscript:@"bytesOut"];
        ...
        v39 = [v38 allValues];
        v40 = (void *)[v39 objectAtIndex:0];
        v41 = (void *)[v40 objectForKeyedSubscript:@"rttMin"];
        [v41 doubleValue];
        double v43 = v42;
        ...
        v47 = (void *)[v56 objectForKeyedSubscript:@"instant"];
        v48 = (void *)[v47 allValues];
        v49 = (void *)[v48 objectAtIndex:0];
    ...
    if (v3)
    {
      ...
      if (Count)
      {
        ...
        if ((FirstIndexOfValue & 0x8000000000000000LL) == 0)
        {
          ...
          [v28 setChannel:[sub_100096A74((uint64_t)ValueAtIndex) integerValue]];
          ...
          uint64_t v13 = (void *)[v12 lowercaseString];
...
{
  id v12 = a3;
  uint64_t v4 = (void *)[v12 objectForKeyedSubscript:@"instant"];
  BOOL v5 = [v4 allValues];
  CFIndex v6 = (void *)objc_claimAutoreleasedReturnValue([v5 firstObject]);
  id v7 = (void *)[v6 objectForKeyedSubscript:@"rttVar"];
  [v7 doubleValue];
  ...
  v8 = [v12 objectForKeyedSubscript:@"instant"];
  double v9 = [v8 allValues];
  double v10 = [v9 firstObject];
  unsigned int v11 = (void *)[v10 objectForKeyedSubscript:@"rttAvg"];
  [v11 doubleValue];
...
{
  id v4 = a3;
  BOOL v5 = [v4 objectForKeyedSubscript:@"instant"];
  id v6 = (void *)objc_claimAutoreleasedReturnValue([v5 allValues]);
  id v7 = [v6 objectAtIndex:0];
  unsigned __int8 v8 = (void *)[v7 objectForKeyedSubscript:@"bytesIn"];
  ...
  double v9 = (void *)[v4 objectForKeyedSubscript:@"instant"];
  double v10 = [v9 allValues];
  unsigned int v11 = (void *)[v10 objectAtIndex:0];
  ...
  uint64_t v13 = (void *)[v4 objectForKeyedSubscript:@"instant"];
  uint64_t v14 = (void *)[v13 allValues];
  v15 = (void *)[v14 objectAtIndex:0];
  uint64_t v16 = (void *)[v15 objectForKeyedSubscript:@"rttAvg"];
  [v16 doubleValue];
  ...
  v18 = [v17 allValues];
  uint64_t v19 = (void *)[v18 objectAtIndex:0];
  ...
  CFRange v29 = [v32 allValues];
  v30 = [v29 objectAtIndex:0];
  v31 = [v30 objectForKeyedSubscript:@"bytesOut"];
...
- (double)_roundTimeInterval:(double)a3 toNearestNumberOfHours:(int64_t)a4
{
  BOOL v5 = [NSDate dateWithTimeIntervalSince1970:a3];
  double v6 = [NSCalendar currentCalendar];
  double v7 = (void *)[v6 components:124 fromDate:v5];
  ...
  double v12 = (void *)[v11 dateFromComponents:v7];
...
- (id)description
{
  v2 = -[WiFiPerfPerAssocSession scorecardIdentifier];
