...
BOOL __DPCHandleStoppedDNSQuestion_block_invoke(id a1, const mdns_subscriber_s *a2)
{
  ...
  {
    Value = (const __CFBag *)CFDictionaryGetValue( (CFDictionaryRef)gDPCSubscriberRegistries,  (const void *)*(unsigned int *)(*((void *)a2 + 7) + 96LL));
    if (Value)
    {
      v4 = Value;
      CFIndex CountOfValue = CFBagGetCountOfValue(Value, a2);
      if (CountOfValue >= 1)
      {
