...
- (SPReparsedProcess)initWithSampleStore:(id)a3
{
  ...
  {
    v8.receiver = self;
    v8.super_class = (Class)&OBJC_CLASS___SPReparsedProcess;
...
- (BOOL)setTargetProcessWithHint:(id)a3
{
  unsigned __int8 v4 = -[SASampleStore setTargetProcessWithHint:](self->_sampleStore, "setTargetProcessWithHint:", a3);
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___SPReparsedProcess;
