...
- (SPStackshotProvider)init
{
  ...
  if (v2)
  {
    ...
    v3->_sampleStore = v7;
    sub_10004C368( v7,  (byte_1000DFCFC >> 3) & 1,  (byte_1000DFCFC >> 2) & 1,  (byte_1000DFCFC & 0x10) == 0);
    ...
    if (byte_1000DFD39 && dword_1000DF4B8 <= 0)
    {
      ...
      {
        v27 = (os_log_s *)sub_10005C68C();
        if (os_log_type_enabled(v27, OS_LOG_TYPE_FAULT)) {
          sub_100088BF8();
        }
        if (qword_1000DFD40) {
          v28 = (FILE *)qword_1000DFD40;
        }
        else {
          v28 = __stderrp;
        }
...
- (void)dealloc
{
  ...
  if (self->_numClientsSampling)
  {
    ...
    if (v10)
    {
      ...
      {
        v13 = (os_log_s *)sub_10005C68C();
        if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT)) {
          sub_100088C7C();
        }
        if (qword_1000DFD40) {
          v14 = (FILE *)qword_1000DFD40;
        }
        else {
          v14 = __stderrp;
        }
    ...
    sub_10005C564( "-[SPStackshotProvider dealloc]",  "SPSampleProvider.m",  499,  "%s: Still have %d clients sampling when dealloc'ed",  v2,  v3,  v4,  v5,  (char)"_numClientsSampling == 0");
    abort();
  }
...
- (void)startSamplingThread
{
  if (self->_samplingThread)
  {
    ...
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        if (qword_1000DFD40) {
          objc_super v21 = (FILE *)qword_1000DFD40;
        }
        else {
  ...
  else
  {
    ...
    uint64_t v25 = pthread_create(&self->_samplingThread, 0LL, (void *(__cdecl *)(void *))sub_1000658C8, self);
    if ((_DWORD)v25)
    {
      *(void *)__errnum = v25;
      if (byte_1000DFD38)
      {
        int v31 = *__error();
        objc_super v32 = (os_log_s *)sub_10005C68C();
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          v33 = strerror(__errnum[0]);
          sub_100088DA4((uint64_t)v33, buf, __errnum[0]);
        }
      ...
      if (v26)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_FAULT))
          {
            ...
            sub_100088D5C((uint64_t)v39, v45, __errnum[0]);
          }
      ...
      strerror(__errnum[0]);
      sub_10005C564( "-[SPStackshotProvider startSamplingThread]",  "SPSampleProvider.m",  517,  "%s: Unable to create sampling thread: %d (%s)",  v27,  v28,  v29,  v30,  (char)"ret == 0");
      abort();
    }
  }
...
- (void)stopSamplingThread
{
  if (self->_samplingThread)
  {
    ...
    if (byte_1000DFD39)
    {
      ...
      else if ((byte_1000DFCFC & 0x18) == 0x10)
      {
        if (byte_1000DFD38)
        {
          int v18 = *__error();
      ...
      else
      {
        ...
        {
          int v25 = *__error();
          BOOL v26 = (os_log_s *)sub_10005C68C();
...
+ (id)sharedInstanceLock
{
  if (qword_1000DFC88 != -1) {
    dispatch_once(&qword_1000DFC88, &stru_1000D19D8);
  }
  return (id)qword_1000DFC90;
}
    ...
    if (a3)
    {
      if (sampleOnlyPids)
      {
        ...
        if ([v8 count])
        {
          ...
          {
            int v9 = *__error();
            unsigned int v10 = (os_log_s *)sub_10005C68C();
          ...
          if (byte_1000DFD39 && dword_1000DF4B8 <= 1)
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT)) {
                sub_100089258((uint64_t)objc_msgSend(objc_msgSend(v8, "description"), "UTF8String"), (uint64_t)buf, v34);
              }
              if (qword_1000DFD40) {
                v35 = (FILE *)qword_1000DFD40;
              }
              else {
                v35 = __stderrp;
              }
  ...
  else
  {
    ...
    if (byte_1000DFD38)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR)) {
        sub_1000891B0((uint64_t)[a3 description], v4, (uint64_t)buf, v17);
      }
      *__error() = v16;
    }
    ...
    if (v18)
    {
      ...
      if (v20)
      {
        ...
        if (qword_1000DFD40) {
          objc_super v32 = (FILE *)qword_1000DFD40;
        }
        else {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_FAULT)) {
          sub_100089164((uint64_t)[a3 description], (uint64_t)v50, v4, v30);
        }
        if (qword_1000DFD40) {
...
- (void)stopAndWaitForAllSamplingToComplete:(BOOL)a3 withCompletionCallbackOnQueue:(id)a4 withBlock:(id)a5
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472LL;
  block[2] = sub_100069508;
  block[3] = &unk_1000D0C20;
  block[4] = self;
