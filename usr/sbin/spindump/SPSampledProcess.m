...
{
  uint64_t v9 = *(void *)&a3;
  if (qword_1000DF510 != -1) {
    dispatch_once(&qword_1000DF510, &stru_1000D0B80);
  }
  ...
  BOOL v16 = a4;
  v13[6] = a6;
  dispatch_sync((dispatch_queue_t)qword_1000DF520, v13);
...
+ (id)allSampledProcesses
{
  return [(id)qword_1000DF518 allValues];
}
...
- (void)removeSelfFromPidCache
{
  if (self->super.super._isSelfInPidCache)
  {
    ...
    v3[4] = self;
    dispatch_async((dispatch_queue_t)qword_1000DF520, v3);
  }
...
- (void)createHIDExitSource
{
  ...
  if ((*p_targetProcessId & 0x80000000) == 0)
  {
    ...
    int v10 = *__error();
    v11 = sub_10005C628(*p_targetProcessId);
...
LABEL_24:
      ...
      int v11 = *__error();
      uint64_t v12 = sub_10005C628(*p_targetProcessId);
...
- (void)setSamplingIntervalUs:(unsigned int)a3
{
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    ...
    {
      int v5 = *__error();
      char v6 = (os_log_s *)sub_10005C68C();
      if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        v32 = sub_10005C628(self->super.super._targetProcessId);
    ...
    int v8 = *__error();
    int v9 = sub_10005C628(self->super.super._targetProcessId);
...
LABEL_51:
    ...
    {
      v24 = sub_10005C628(self->super.super._targetProcessId);
  ...
  if (self->super.super._timeoutTime <= a3)
  {
    ...
    if (targetProcessId < 0)
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_FAULT)) {
        sub_10007C5B4(v55, v56, v57, v58, v59, v60, v61, v62);
      }
    }
    ...
    else
    {
      if (byte_1000DFD38)
      {
        ...
        {
          v67 = sub_10005C628(*p_targetProcessId);
      ...
      int v24 = *__error();
      unsigned int v25 = sub_10005C628(*p_targetProcessId);
...
LABEL_103:
        ...
        block[2] = sub_100030734;
        block[3] = &unk_1000D0CC0;
        block[4] = self;
        *(double *)&block[5] = v18;
        *(double *)&block[6] = v17;
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT)) {
        sub_10007C520(&self->super.super._targetProcessId);
      }
    }
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    ...
    {
      int v6 = *__error();
      BOOL v7 = (os_log_s *)sub_10005C68C();
...
- (void)setSamplingCompletionHandlerQueue:(id)a3 andBlock:(id)a4
{
  if (!a3 || !a4)
  {
    ...
    if (self->super.super._targetProcessId < 0)
    {
      if (byte_1000DFD38)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR)) {
          sub_10007CB14(v23, v24, v25, v26, v27, v28, v29, v30);
        }
        *__error() = v22;
      }
      ...
      if (v31)
      {
        ...
        {
          v34 = (os_log_s *)sub_10005C68C();
          if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT)) {
            sub_10007CAA4(v34, v35, v36, v37, v38, v39, v40, v41);
          }
          if (qword_1000DFD40) {
            unsigned int v42 = (FILE *)qword_1000DFD40;
          }
          else {
      ...
      sub_10005C564( "-[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]",  "SPProcessEvent.m",  1121,  "%s: Must provide both queue and block",  v4,  v5,  v6,  v7,  (char)"queue && block");
    }
    ...
    else
    {
      ...
      {
        int v17 = *__error();
        double v18 = sub_10005C628(*p_targetProcessId);
      ...
      char v52 = sub_10005C628(*p_targetProcessId);
      sub_10005C564( "-[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]",  "SPProcessEvent.m",  1121,  "%s [%d]: %s: Must provide both queue and block",  v53,  v54,  v55,  v56,  v52);
    }
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472LL;
  block[2] = sub_1000314B8;
  block[3] = &unk_1000D0CE8;
  block[4] = self;
  block[5] = a3;
  block[6] = v11;
  dispatch_async((dispatch_queue_t)processingQueue, block);
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000DFD38)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
        sub_10007CECC(p_targetProcessId, v3, v8);
      }
      *__error() = v7;
    }
    ...
    int v10 = *__error();
    int v11 = sub_10005C628(*p_targetProcessId);
...
LABEL_51:
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT)) {
      sub_10007CE3C(p_targetProcessId);
    }
    goto LABEL_39;
  }
  ...
  {
    int v17 = *__error();
    double v18 = (os_log_s *)sub_10005C68C();
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG)) {
      sub_10007CFE8(v3, v18);
    }
    *__error() = v17;
  }
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_FAULT)) {
      sub_10007CF78(v3, v28);
    }
LABEL_39:
    if (qword_1000DFD40) {
      uint64_t v29 = (FILE *)qword_1000DFD40;
    }
    else {
...
LABEL_88:
        ...
        v122[1] = 3221225472LL;
        v122[2] = sub_100033864;
        v122[3] = &unk_1000D0D60;
        char v123 = v4;
        v122[4] = self;
        v122[5] = a3;
    ...
    else
    {
      ...
      int v22 = *__error();
      BOOL v23 = sub_10005C628(*p_targetProcessId);
...
LABEL_86:
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    ...
    {
      int v9 = *__error();
      int v10 = (os_log_s *)sub_10005C68C();
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        int v11 = sub_10005C628(*v8);
        int v12 = *v8;
...
LABEL_95:
  ...
  if (v39)
  {
    ...
    if (!v16)
    {
      char v52 = (os_log_s *)sub_10005C68C();
...
- (void)_saveReportToStream:(__sFILE *)a3
{
  if (!a3 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_10005C564( "-[SPSampledProcess _saveReportToStream:]",  "SPProcessEvent.m",  1417,  "%s: save report fail %d %d %d",  v3,  v4,  v5,  v6,  (char)"stream && !_isSampling && _hasSampled");
    }
    ...
    else
    {
      if (byte_1000DFD38)
      {
        ...
        {
          BOOL v39 = (const char *)sub_10005C628(self->super.super._targetProcessId);
          int targetProcessId = self->super.super._targetProcessId;
      ...
      if (v43)
      {
        BOOL v47 = a3 != 0LL;
        int v48 = *__error();
        v49 = sub_10005C628(self->super.super._targetProcessId);
        ...
        if (v50)
        {
          ...
          if (qword_1000DFD40) {
            __int16 v72 = (FILE *)qword_1000DFD40;
          }
          else {
        ...
        {
          v51 = (os_log_s *)sub_10005C68C();
          if (os_log_type_enabled(v51, OS_LOG_TYPE_FAULT))
          {
            char v52 = (const char *)sub_10005C628(self->super.super._targetProcessId);
      ...
      char v73 = sub_10005C628(self->super.super._targetProcessId);
      sub_10005C564( "-[SPSampledProcess _saveReportToStream:]",  "SPProcessEvent.m",  1417,  "%s [%d]: %s: save report fail %d %d %d",  v74,  v75,  v76,  v77,  v73);
    }
  ...
  if (!self->super.super._isUrgent)
  {
    ...
    if (self->super.super._targetProcessId < 0)
    {
      ...
      if (v25)
      {
        ...
        if (qword_1000DFD40) {
          uint64_t v35 = (FILE *)qword_1000DFD40;
        }
        else {
      ...
      BOOL v33 = (os_log_s *)sub_10005C68C();
    ...
    else
    {
      if (byte_1000DFD38)
      {
        ...
        {
          int v12 = (const char *)sub_10005C628(*p_targetProcessId);
      ...
      int v15 = *__error();
      BOOL v16 = sub_10005C628(*p_targetProcessId);
...
- (void)_performSamplePrinterWork:(id)a3
{
  if (!a3 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_10005C564( "-[SPSampledProcess _performSamplePrinterWork:]",  "SPProcessEvent.m",  1433,  "%s: save report fail %d %d %d",  v3,  v4,  v5,  v6,  (char)"callback && !_isSampling && _hasSampled");
    }
    ...
    else
    {
      ...
      char v73 = sub_10005C628(self->super.super._targetProcessId);
      sub_10005C564( "-[SPSampledProcess _performSamplePrinterWork:]",  "SPProcessEvent.m",  1433,  "%s [%d]: %s: save report fail %d %d %d",  v74,  v75,  v76,  v77,  v73);
    }
