...
- (void)handleMsg:(id)a3
{
  ...
  v8 = (void *)value;
  uint64_t v9 = [NSString stringWithFormat:@"handle%sMsg:" string];
...
- (void)handleConnectOnceMsg:(id)a3
{
  ...
  xpc_object_t xuuid = (xpc_object_t)[value autorelease];
...
- (void)handleConnectAlwaysMsg:(id)a3
{
  ...
  xpc_object_t xarray = [value autorelease];
...
{
  id v3 = a3;
  id v10 = [EndpointManager instance];
  id v4 = +[NSNumber numberWithUnsignedLongLong:]( &OBJC_CLASS___NSNumber,  "numberWithUnsignedLongLong:",  xpc_dictionary_get_uint64(v3, "kEasyPairingVersion"));
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  ...
  uint64_t v9 = (void *)[NSNumber numberWithUnsignedLongLong:uint64];
...
- (void)handleStoreClassicLinkKeyRequestMsg:(id)a3
{
  ...
  if (length)
  {
    ...
    id v11 = [EndpointManager instance];
...
- (void)handleStoreClassicLinkKeyRequestExtendedMsg:(id)a3
{
  ...
  if (length)
  {
    ...
    if (length)
    {
      for (size_t i = 0LL; i < length; ++i)
      {
        uint64_t v9 = (void *)[NSNumber numberWithUnsignedChar:v5[i]];
        id v10 = [v7 arrayByAddingObject:v9];
...
- (void)handleStoreClassicDeviceSettingsMsg:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((_DWORD)v13 != -1)
    {
      v29 = [NSNumber numberWithInt:v13];
    ...
    if ((_DWORD)v27 != -1)
    {
      v33 = [NSNumber numberWithInt:v27];
  ...
  v44 = [NSString stringWithUTF8String:string];
...
{
  xpc_object_t value = xpc_dictionary_get_value(a3, "kPeerIdentifier");
  xpc_object_t xuuid = [value autorelease];
  id v4 = -[NSUUID initWithUUIDBytes:](objc_alloc(&OBJC_CLASS___NSUUID), "initWithUUIDBytes:", xpc_uuid_get_bytes(xuuid));
...
- (void)handleUARPAACPTransportChangeMsg:(id)a3
{
  ...
  xpc_object_t v7 = [UARPServiceUARPControllerManager instance];
  id v8 = [NSNumber numberWithBool:YES];
...
- (void)handleUARPDataOverAACPMsg:(id)a3
{
  ...
  id v10 = +[UARPServiceUARPControllerManager instance];
...
- (void)handleLeaEasyPairRequestMsg:(id)a3
{
  ...
  if (v4)
  {
    ...
    xpc_object_t v11 = +[EndpointManager instance];
...
- (void)handleLeaStoreBondingInfoRequestMsg:(id)a3
{
  ...
  if (length)
  {
    for (size_t i = 0LL; i < length; ++i)
    {
      id v10 = [NSNumber numberWithUnsignedChar:data[i]];
  ...
  if (v30)
  {
    for (size_t j = 0LL; j < v30; ++j)
    {
      ...
      int64_t v16 = (void *)[v13 arrayByAddingObject:v15];
  ...
  if (v29)
  {
    ...
    {
      xpc_object_t v20 = [NSNumber numberWithUnsignedChar:v6[k]];
...
- (void)sendMsg:(id)a3 args:(id)a4
{
  ...
  uint64_t v12 = [_BTLEXpcConnection connection];
...
- (void)authenticationDidSucceed:(id)a3
{
  ...
  if (v6)
  {
    ...
    v14[0] = v9;
    v14[1] = v8;
    id v10 = [NSDictionary dictionaryWithObjects:forKeys:count:v14, v13, 2LL];
  ...
  else
  {
    ...
    xpc_object_t v8 = (void *)[v5 msgIdentifier];
    uint64_t v12 = v8;
    id v9 = [NSDictionary dictionaryWithObjects:forKeys:count:&v12, &v11, 1LL];
...
- (void)authenticationDidFail:(id)a3
{
  ...
  uint64_t v5 = (void *)[v4 msgIdentifier];
  xpc_object_t v8 = v5;
  id v6 = [NSDictionary dictionaryWithObjects:forKeys:count:v8, v7, 1LL];
