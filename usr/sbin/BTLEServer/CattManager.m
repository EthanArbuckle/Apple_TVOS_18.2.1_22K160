...
- (void)registerServices
{
  uint64_t v3 = [self centralManager];
  if (v3)
  {
    v4 = (void *)v3;
    v5 = [self centralManager];
    id v6 = [v5 state];
...
- (void)setOpportunisticConnection:(id)a3
{
  ...
  v9 = +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  &v11,  &v10,  1LL);
...
- (void)connectPeripheral:(id)a3
{
  ...
  if (v6 == (id)5)
  {
    ...
    uint64_t v10 = (void *)[self centralManager];
...
- (void)centralManagerDidUpdateState:(id)a3
{
  ...
  if (v9 != (id)5)
  {
    ...
    {
      int v11 = (void *)[self centralManager];
      id v12 = [v11 state];
    ...
    v13 = -[CattManager cattPeripheral];
    [v13 removeAllObjects];

    v14 = -[CattManager clientServiceManagerMap];
...
- (void)centralManager:(id)a3 didConnectPeripheral:(id)a4
{
  ...
  {
    [v7 setDelegate:self];
    v13 = -[CattManager clientServiceManagerMap];
    ...
    if (!v14)
    {
      ...
      uint64_t v16 = (void *)[self clientServiceManagerMap];
...
- (void)centralManager:(id)a3 didFailToConnectPeripheral:(id)a4 error:(id)a5
{
  ...
  unsigned int v12 = (void *)[self cattPeripheral];
  [v12 removeObject:v7];
}
...
- (void)peripheral:(id)a3 didModifyServices:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = -[CattManager clientServiceManagerMap];
...
- (void)peripheral:(id)a3 didUpdateValueForCharacteristic:(id)a4 error:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  int v11 = -[CattManager clientServiceManagerMap](self, "clientServiceManagerMap");
  id v12 = [v11 objectForKeyedSubscript:v10];
