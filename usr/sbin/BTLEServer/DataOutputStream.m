...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___DataOutputStream;
...
+ (id)outputStream
{
  return -[DataOutputStream initWithByteOrder:](objc_alloc(&OBJC_CLASS___DataOutputStream), "initWithByteOrder:", 0LL);
}

+ (id)outputStreamWithByteOrder:(int64_t)a3
{
  return -[DataOutputStream initWithByteOrder:](objc_alloc(&OBJC_CLASS___DataOutputStream), "initWithByteOrder:", a3);
}
...
{
  unsigned int v3 = a3;
  int64_t v5 = -[DataOutputStream byteOrder](self, "byteOrder");
