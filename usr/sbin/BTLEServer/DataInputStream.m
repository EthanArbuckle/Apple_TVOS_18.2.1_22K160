...
- (DataInputStream)initWithValue:(id)a3 byteOrder:(int64_t)a4
{
  id v6 = a3;
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___DataInputStream;
  ...
  if (v7)
  {
    if (v6)
    {
      v9 = -[NSInputStream initWithData:](objc_alloc(&OBJC_CLASS___NSInputStream), "initWithData:", v6);
      stream = v8->_stream;
      v8->_stream = v9;
...
{
  id v3 = a3;
  v4 = -[DataInputStream initWithValue:byteOrder:]( objc_alloc(&OBJC_CLASS___DataInputStream),  "initWithValue:byteOrder:",  v3,  0LL);
...
{
  id v5 = a3;
  id v6 = -[DataInputStream initWithValue:byteOrder:]( objc_alloc(&OBJC_CLASS___DataInputStream),  "initWithValue:byteOrder:",  v5,  a4);
