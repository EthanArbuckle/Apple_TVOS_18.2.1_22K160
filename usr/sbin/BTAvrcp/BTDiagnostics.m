...
+ (void)fileABCSnapshot:(id)a3 subTypeContext:(id)a4 duration:(double)a5
{
  id v7 = a4;
  id v8 = a3;
  id v10 = objc_alloc_init(&OBJC_CLASS___SDRDiagnosticReporter);
  v9 = (void *)objc_claimAutoreleasedReturnValue( [v10 signatureWithDomain:@"Bluetooth" type:@"Networking" subType:v8 subtypeContext:v7 detectedProcess:@"bluetoothd" triggerThresholdValues:0]);
