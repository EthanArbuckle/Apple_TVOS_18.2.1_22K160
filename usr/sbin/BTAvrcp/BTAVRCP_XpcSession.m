...
- (void)handleSendCommandMsg:(id)a3 replyBlock:(id)a4
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](&OBJC_CLASS___NSString, "stringWithUTF8String:", string));
  v18[1] = kMRMediaRemoteOptionRemoteControlInterfaceIdentifier;
  v19[0] = v10;
  v19[1] = @"com.apple.AVRCP";
  v11 = (void *)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  v19,  v18,  2LL));
...
- (void)handleGetSettingsMsg:(id)a3 replyBlock:(id)a4
{
  ...
  v11[1] = @"kShuffleMode";
  v12[0] = v8;
  v9 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", HIDWORD(v7)));
  v12[1] = v9;
...
- (void)handleGetPlayStatusMsg:(id)a3 replyBlock:(id)a4
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  unint64_t v7 = (void *)objc_claimAutoreleasedReturnValue([v6 trackDuration]);
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue([v8 trackPosition]);
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( NSNumber,  "numberWithInteger:",  [v10 playbackState]));
...
- (void)handleGetElementAttributesMsg:(id)a3 replyBlock:(id)a4
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  unint64_t v7 = (void *)objc_claimAutoreleasedReturnValue([v6 trackTitle]);

  if (v7) {
    [v5 setValue:v7 forKey:@"kTitle"];
  }
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  v9 = (void *)objc_claimAutoreleasedReturnValue([v8 trackAlbum]);

  if (v9) {
    [v5 setValue:v9 forKey:@"kAlbum"];
  }
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  v11 = (void *)objc_claimAutoreleasedReturnValue([v10 trackArtist]);

  if (v11) {
    [v5 setValue:v11 forKey:@"kArtist"];
  }
  id v12 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  uint64_t v13 = (void *)objc_claimAutoreleasedReturnValue([v12 trackGenre]);
  ...
  uint64_t v15 = (void *)objc_claimAutoreleasedReturnValue([v14 trackQueueIndex]);

  if (v15) {
    [v5 setValue:v15 forKey:@"kQueueIndex"];
  }
  v16 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  unsigned int v17 = (void *)objc_claimAutoreleasedReturnValue([v16 trackQueueCount]);
  ...
  v19 = (void *)objc_claimAutoreleasedReturnValue([v18 trackDuration]);
  ...
  v21 = (void *)objc_claimAutoreleasedReturnValue([v20 trackImageHandle]);
...
- (void)handleRegisterForPlayerChangesMsg:(id)a3 replyBlock:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", [v7 playerId]));
  v11 = v8;
...
- (void)handleRegisterForPlaybackStateChangesMsg:(id)a3 replyBlock:(id)a4
{
  ...
  id v6 = a4;
  unint64_t v7 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( NSNumber,  "numberWithInteger:",  [v7 playbackState]));
  v11 = v8;
  v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  &v11,  &v10,  1LL));
  (*((void (**)(id, uint64_t, void *))a4 + 2))(v6, 4LL, v9);
}
...
- (void)handleRegisterForTrackChangesMsg:(id)a3 replyBlock:(id)a4
{
  ...
  id v6 = a4;
  unint64_t v7 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedLongLong:]( NSNumber,  "numberWithUnsignedLongLong:",  [v7 trackId]));
  v11 = v8;
  v9 = (void *)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  &v11,  &v10,  1LL));
  (*((void (**)(id, uint64_t, void *))a4 + 2))(v6, 4LL, v9);
}
...
- (void)handleChangePathMsg:(id)a3 replyBlock:(id)a4
{
  ...
  {
    unsigned int v9 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession library](self, "library"));
  ...
  if (!v10)
  {
    switch(int64)
    {
      case 3:
        ...
        unsigned int v17 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
...
- (void)handleSearchMsg:(id)a3 replyBlock:(id)a4
{
  ...
  id v9 = (id)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession library](self, "library"));
  ...
  else
  {
    switch(int64)
    {
      case 3:
        ...
        unsigned int v11 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession library](self, "library"));
...
- (void)handleGetImagePropertiesMsg:(id)a3 replyBlock:(id)a4
{
  ...
  id v12 = (id)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionary](&OBJC_CLASS___NSMutableDictionary, "dictionary"));
  id v6 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  uint64_t v7 = (void *)objc_claimAutoreleasedReturnValue([v6 encodings]);
  ...
  __int16 v9 = (void *)objc_claimAutoreleasedReturnValue([v8 widths]);
  ...
  unsigned int v11 = (void *)objc_claimAutoreleasedReturnValue([v10 heights]);
...
- (void)handleGetImageMsg:(id)a3 replyBlock:(id)a4
{
  ...
  uint64_t v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
  unsigned int v11 = (void *)objc_claimAutoreleasedReturnValue([v10 widths]);
  id v12 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedLongLong:](&OBJC_CLASS___NSNumber, "numberWithUnsignedLongLong:", int64));
  ...
  unsigned int v15 = (void *)objc_claimAutoreleasedReturnValue([v14 heights]);
  id v16 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedLongLong:](&OBJC_CLASS___NSNumber, "numberWithUnsignedLongLong:", v9));
...
{
  id v6 = @"kPlayerId";
  id v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", *(void *)&a3));
  xpc_object_t v7 = v4;
...
- (void)settingsDidChange:(id)a3
{
  ...
  v8[0] = @"kRepeatMode";
  unsigned int v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:"));
  v8[1] = @"kShuffleMode";
  v9[0] = v5;
  id v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", var1));
  v9[1] = v6;
...
- (void)libraryDidChange
{
  id v3 = (id)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
...
- (void)getMediaPlayersFromStart:(unint64_t)a3 toEnd:(unint64_t)a4 replyBlock:(id)a5
{
  ...
  else
  {
    ...
    id v11 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
    id v12 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithInteger:]( NSNumber,  "numberWithInteger:",  [v11 playbackState]));
    v23[1] = v12;
    v22[2] = @"kIsBrowsable";
    id v13 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
    ...
    v22[3] = @"kName";
    unsigned int v15 = (void *)objc_claimAutoreleasedReturnValue(-[BTAVRCP_XpcSession nowPlayingInfo](self, "nowPlayingInfo"));
    id v16 = (void *)objc_claimAutoreleasedReturnValue([v15 playerName]);
    v23[3] = v16;
    id v6 = (id)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  v23,  v22,  4LL));

    id v19 = v6;
    BOOL v20 = @"kItems";
    id v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", &v19, 1LL));
    double v21 = v17;
