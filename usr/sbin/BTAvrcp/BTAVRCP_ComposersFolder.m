...
- (id)baseQuery
{
  BOOL v3 = [+[MPMediaQuery composersQuery](&OBJC_CLASS___MPMediaQuery, "composersQuery") autorelease];
  if (-[BTAVRCP_ComposersFolder isRecentlyAdded](self, "isRecentlyAdded")) {
...
LABEL_10:
  ...
  v8 = (void *)[v9 collectionWithUid:a3 property:MPMediaItemPropertyComposerPersistentID];
...
LABEL_11:
  ...
  if (v7)
  {
    ...
    v11 = (void *)[v7 representativeItem];
    ...
    v14 = -[BTAVRCP_VFSFolder replyFolderWithType:uid:name:](self, "replyFolderWithType:uid:name:", v13, v10, v12);
...
- (id)replyAttributesForUid:(unint64_t)a3 attributeIDs:(id)a4
{
  id v5 = -[BTAVRCP_VFSFolder query:a3, a4];
