...
- (BTAVRCP_RootFolder)init
{
  ...
  if (v2)
  {
    v3 = (void *)objc_claimAutoreleasedReturnValue( +[MPMediaPropertyPredicate predicateWithValue:forProperty:]( &OBJC_CLASS___MPMediaPropertyPredicate,  "predicateWithValue:forProperty:",  &off_100019B20,  MPMediaItemPropertyMediaType));
...
- (id)replyItemAtIndex:(unint64_t)a3 attributeIDs:(id)a4
{
  ...
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[MPMediaLibrary defaultMediaLibrary](&OBJC_CLASS___MPMediaLibrary, "defaultMediaLibrary", 0LL, a4));
    v7 = (void *)objc_claimAutoreleasedReturnValue([v6 name]);
