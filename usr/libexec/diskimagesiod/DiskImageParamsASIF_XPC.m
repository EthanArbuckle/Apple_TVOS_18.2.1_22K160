...
- (unique_ptr<DiskImage,)createSinkDiskImage
{
  ...
  while (1)
  {
    ...
    sub_100026A1C(&v87, (uint64_t *)lpsrc);
    sub_1001171D0((uint64_t)lpsrc, &v90);
    __int128 v10 = v90;
    __int128 v90 = 0uLL;
  ...
  *(void *)&__int128 v92 = 0x200000001LL;
  sub_10008DD20((uint64_t)"header_ignore_fields_t", 2, (int *)&v92, 2LL);
  v21[48] = 2;
  if (v22)
  {
...
- (DiskImageParamsASIF_XPC)initWithCoder:(id)a3
{
  ...
  if (v5 && [v4 containsValueForKey:@"sparseHeader"])
  {
    ...
    if (!v6 || v12 != 80)
    {
      ...
      sub_100004D60((uint64_t)v11);
      sub_100004E4C(v11, (uint64_t)"Unexpected ASIF header length (", 31LL);
      std::ostream::operator<<(v11, v12);
      sub_100004E4C(v11, (uint64_t)")", 1LL);
      sub_10001161C((uint64_t)exception, (uint64_t)v11, 0x9Au);
    }

    uint64_t v7 = (header *)operator new(0x50uLL);
    sub_1000CA584(v7, (uint64_t)v6);
    value = v5->_header.__ptr_.__value_;
