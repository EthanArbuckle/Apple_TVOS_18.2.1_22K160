...
LABEL_4:
  ...
  sub_1001188E8((char *)[v13 UTF8String], &v17, &__p);
...
- (BOOL)createEncryptionWithXPCHandler:(id)a3 error:(id *)a4
{
  ...
  if (-[DICreateParams encryptionMethod](self, "encryptionMethod"))
  {
    ...
    sub_100086034(&v19, v7);
    id v8 = operator new(0x4CuLL);
    int v20 = v19;
    sub_10010D02C(v8, &v20);
...
- (void)createDiskImageParamsXPC
{
  ...
  v3 = (void *)sub_100004870( (uint64_t)exception,  (uint64_t)"Invalid argument, please use one of the DICreateParams derived classes instead",  0x16u);
}
...
- (BOOL)resizeWithNumBlocks:(unint64_t)a3 error:(id *)a4
{
  ...
  *__error() = v17;
  ...
  uint64_t v26 = sub_100012650(v25);
  if (!(_DWORD)v26)
  {
    BOOL v14 = 1;
    if (!v25) {
