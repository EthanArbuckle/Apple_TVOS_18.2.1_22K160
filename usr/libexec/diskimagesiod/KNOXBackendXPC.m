...
- (KNOXBackendXPC)initWithURL:(id)a3 key:(void *)a4
{
  ...
  if (v8)
  {
    sub_100026A1C(&v8->_key.__ptr_, (uint64_t *)a4);
    ...
    sub_1000B7EA8(&v23, &v24);
    int v22 = 0;
    sub_1000B7FA0((uint64_t)&v24, &v22, &v26);
    __int128 v27 = v26;
    __int128 v26 = 0uLL;
...
- (KNOXBackendXPC)initWithCoder:(id)a3
{
  ...
  if (v6)
  {
    ...
    sub_10008E818(&v34, (uint64_t)v11);
    sub_100014DF0((uint64_t)&v6->_key, &v34);
    ...
    *((_OWORD *)ptr + 1) = v16;
    ...
    sub_1000B7EA8(&v31, &v34);
    int v30 = 0;
    sub_1000B7FA0((uint64_t)&v34, &v30, &v32);
    __int128 v33 = v32;
    __int128 v32 = 0uLL;
