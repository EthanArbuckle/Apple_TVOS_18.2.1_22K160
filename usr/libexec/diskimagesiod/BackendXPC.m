...
- (void)replaceWithBackendXPC:(id)a3
{
  ...
  sub_100014DF0((uint64_t)&self->_backend, &v10);
...
- (keys)generateNewImageKeysWithPassphrase:(SEL)a3 privateKey:(const char *)a4 pubKeyHeader:(__SecKey *)a5 header_backend:(public_key_header *)a6
{
  ...
  if (a4) {
    return (keys *)sub_10010F3B4(retstr, v11, v12, a4);
  }
  ...
  return (keys *)sub_10010F074(retstr, v11, v12, a5, &var0);
}
...
- (shared_ptr<crypto::format>)makeCryptoFormatWithIsNewImage:(BOOL)a3 pass:(const char *)a4 certificate:(id)a5 error:(id *)a6
{
  ...
  if (!v9)
  {
    ...
    if (a4)
    {
      sub_10010F3B4(&v29, v41, -[BackendXPC cryptoHeader](self, "cryptoHeader"), a4);
      sub_1000589DC(&v36);
      uint64_t v14 = v36;
      uint64_t v15 = v37;
      uint64_t v36 = 0LL;
    ...
    if (-[BackendXPC getPrivateKeyWithHeader:privateKey:error:]( self,  "getPrivateKeyWithHeader:privateKey:error:",  v49,  &v38,  a6))
    {
      ...
      sub_10010F074(&v29, v18, v19, v38, &v44);
      sub_1000589DC(&v36);
      uint64_t v14 = v36;
      uint64_t v15 = v37;
      uint64_t v36 = 0LL;
  ...
  else
  {
    ...
    *__error() = v10;
    if ((v23.st_mode & 0xF000) == 0x4000) {
      __int128 v17 = &off_100164740;
    }
    else {
      __int128 v17 = &off_1001645E8;
    }
