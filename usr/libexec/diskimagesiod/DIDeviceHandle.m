  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      if (RunLoopSource)
      {
        ...
        if (!IOServiceAddMatchingNotification( v10,  "IOServiceMatched",  v14,  (IOServiceMatchingCallback)sub_1000083E4,  &refCon,  &notification))
        {
          CFRunLoopMode v18 = kCFRunLoopDefaultMode;
          sub_1000083E4((uint64_t)&refCon, notification);
          while (!v22)
          {
