...
- (SparseBundleBackendXPC)initWithCoder:(id)a3
{
  ...
  if (v6)
  {
    ...
    sub_1000B2EB0(v4, (uint64_t *)-[BackendXPC cryptoHeader](v6, "cryptoHeader"), &v34);
    sub_1000B7200((unsigned int *)&v37, &v36, &v32);
    __int128 v33 = v32;
    __int128 v32 = 0uLL;
...
- (void)replaceWithBackendXPC:(id)a3
{
  ...
  *((void *)&v19 + 1) = v5;
  ...
  -[BackendXPC backend](self, "backend");
  sub_100026A1C((void *)(v16 + 96), (uint64_t *)&v19);
  if (v17)
  {
...
- (id)newWithCryptoFormat:(const void *)a3
{
  ...
  uint64_t v19 = v17;
  __int128 v20 = v18;
  sub_100026A1C((void *)(v17 + 96), (uint64_t *)a3);
  uint64_t v15 = v17;
  uint64_t v16 = v18;
  if (v18)
  {
