...
LABEL_3:
    ...
    while (1)
    {
      ...
      sub_100116E98((uint64_t)&v26, &v28);
      uint64_t v14 = sub_1000FDD34((uint64_t)&v28);
      BOOL v15 = v29;
      if (v29)
      {
...
- (NSArray)nonCacheNodes
{
  unsigned __int8 v3 = (void *)objc_claimAutoreleasedReturnValue(+[NSPredicate predicateWithBlock:](&OBJC_CLASS___NSPredicate, "predicateWithBlock:", &stru_10017C7F8));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[DIShadowChain nodes](self, "nodes"));
