...
- (CryptoBackendXPC)initWithFormat:(const void *)a3 baseBackendXPC:(id)a4
{
  ...
  if (v8)
  {
    ...
    sub_1000B7AA8((uint64_t)&v21, (uint64_t)a3, &v23);
    __int128 v24 = v23;
    __int128 v23 = 0uLL;
...
- (CryptoBackendXPC)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    sub_1000B2EB0(v4, (uint64_t *)-[BackendXPC cryptoHeader](v5, "cryptoHeader"), &v31);
    if (!v31)
    {
    ...
    sub_1000B7B68((uint64_t)&v27, (uint64_t)&v31, &v29);
    __int128 v30 = v29;
    __int128 v29 = 0uLL;
