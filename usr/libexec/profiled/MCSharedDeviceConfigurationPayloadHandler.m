...
- (BOOL)installWithInstaller:(id)a3 options:(id)a4 interactionClient:(id)a5 outError:(id *)a6
{
  ...
  uint64_t v9 = MCSharedDeviceConfigurationFilePath();
  ...
  uint64_t v12 = MCSharedDeviceConfigurationErrorDomain;
  uint64_t v13 = MCErrorArray(@"SHARED_DEVICE_CONFIGURATION_MULTIPLE_CONFIGURATIONS");
  v14 = (void *)objc_claimAutoreleasedReturnValue(v13);
  uint64_t v15 = MCErrorTypeFatal;
  v16 = (void *)objc_claimAutoreleasedReturnValue( +[NSError MCErrorWithDomain:code:descriptionArray:errorType:]( &OBJC_CLASS___NSError,  "MCErrorWithDomain:code:descriptionArray:errorType:",  v12,  46000LL,  v14,  MCErrorTypeFatal,  0LL));
...
- (void)_removeSharedDeviceConfiguration
{
  ...
  uint64_t v2 = MCSharedDeviceConfigurationFilePath();
