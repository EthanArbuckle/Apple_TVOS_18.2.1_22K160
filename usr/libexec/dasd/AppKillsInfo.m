...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___AppKillsInfo;
...
- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"Means kills because of springboard: %f, runningboard: %f, jetsam: %f, others: %f",  *(void *)&self->_meanSpringBoardKills,  *(void *)&self->_meanRunningBoardKills,  *(void *)&self->_meanJetsamKills,  *(void *)&self->_meanOtherKills);
}
