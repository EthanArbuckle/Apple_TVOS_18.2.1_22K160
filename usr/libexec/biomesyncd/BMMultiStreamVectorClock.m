...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___BMMultiStreamVectorClock;
...
{
  id v4 = a3;
  uint64_t v6 = objc_opt_class(&OBJC_CLASS___BMMultiStreamVectorClock, v5);
  if ((objc_opt_isKindOfClass(v4, v6) & 1) != 0)
  {
    id v7 = objc_alloc(&OBJC_CLASS___NSSet);
    id v8 = (void *)objc_claimAutoreleasedReturnValue(-[BMMultiStreamVectorClock allKeys](self, "allKeys"));
      ...
      if (v14)
      {
        ...
        while (2)
        {
          for (i = 0LL; i != v15; i = (char *)i + 1)
          {
            ...
            __int128 v19 = (void *)objc_claimAutoreleasedReturnValue( -[BMMultiStreamVectorClock vectorClockForStreamIdentifier:]( self,  "vectorClockForStreamIdentifier:",  v18));
            v20 = (void *)objc_claimAutoreleasedReturnValue([v4 vectorClockForStreamIdentifier:v18]);
            id v21 = [v19 compareToTimestampVector:v20];
...
- (BMMultiStreamVectorClock)initWithCoder:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___BMMultiStreamVectorClock;
  uint64_t v6 = -[BMMultiStreamVectorClock init](&v15, "init");
  if (v6)
  {
    v16[0] = objc_opt_class(&OBJC_CLASS___NSString, v5);
    v16[1] = objc_opt_class(&OBJC_CLASS___NSDictionary, v7);
    v16[2] = objc_opt_class(&OBJC_CLASS___CKDistributedTimestampVector, v8);
...
+ (id)deserialize:(id)a3 error:(id *)a4
{
  ...
  {
    id v5 = a3;
    id v7 = +[NSKeyedUnarchiver unarchivedObjectOfClass:fromData:error:]( &OBJC_CLASS___NSKeyedUnarchiver,  "unarchivedObjectOfClass:fromData:error:",  objc_opt_class(&OBJC_CLASS___BMMultiStreamVectorClock, v6),  v5,  a4);
