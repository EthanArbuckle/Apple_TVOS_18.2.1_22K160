...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_10001A370 != -1) {
    dispatch_once(&qword_10001A370, &stru_100014768);
  }
  return (NSArray *)(id)qword_10001A378;
}
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0LL; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = -[__CFString isEqualToString:](v14, "isEqualToString:", &stru_100014898);
        if (v15) {
          v16 = v29;
        }
        else {
  ...
  if (os_log_type_enabled((os_log_t)obj, OS_LOG_TYPE_DEBUG)) {
    sub_10000BC44((uint64_t)v29, (uint64_t)a4, (os_log_t)obj);
  }
  v19 = 0LL;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (!-[NSString isEqualToString:](v9, "isEqualToString:", v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
      sub_10000BCC8((uint64_t)v9, &self->_enablementPrefix, v11);
    }
  }
...
- (void)initPropertyReportPeriod:(HTPrefInit *)a3
{
  ...
  double v7 = v6 * 1000.0 / sub_10000B114();
...
+ (id)sharedPrefs
{
  if (qword_10001A388 != -1) {
    dispatch_once(&qword_10001A388, &stru_100014788);
  }
  return (id)qword_10001A380;
}
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *(_OWORD *)&result[13].var2.var0 = xmmword_10000DBD0;
...
- (void)__createInternalSettings
{
  ...
  CFPreferencesSetValue( @"HangTracerInternalSettingsVersion",  &off_100015BA8,  self->__htTaskingDomain,  @"mobile",  kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0LL;
  ...
  notify_register_dispatch(off_10001A348, v30 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001A330, (int *)v39 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001A338, v36 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001A340, v33 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001A350, v26 + 6, (dispatch_queue_t)self->__prefsQueue, v21);
  -[HTPrefs setShouldPostHTPrefsChangedNotification:](self, "setShouldPostHTPrefsChangedNotification:", 1LL);
