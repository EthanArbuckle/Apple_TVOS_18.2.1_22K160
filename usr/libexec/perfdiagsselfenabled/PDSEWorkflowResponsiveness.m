...
+ (BOOL)willEnableDiagnostics
{
  ...
  v4 = (const __CFString *)sub_100001F2C( (uint64_t)@"HangTracerEnableWorkflowResponsiveness",  (uint64_t)@"PDSEWorkflowResponsiveness");
  CFPreferencesSetValue(v4, kCFBooleanTrue, @"com.apple.da", @"mobile", kCFPreferencesAnyHost);
  id v5 = sub_10000AC04();
  v6 = (os_log_s *)objc_claimAutoreleasedReturnValue(v5);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG)) {
    sub_10000C23C( (uint64_t)@"HangTracerEnableWorkflowResponsiveness",  (uint64_t)@"PDSEWorkflowResponsiveness",  v6);
  }
...
+ (BOOL)didDisableDiagnostics
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v29 = @"PDSEWorkflowResponsiveness";
  ...
  __int128 v23 = 0u;
  __int128 v24 = 0u;
  v4 = sub_100001F60(@"com.apple.da", @"mobile", (uint64_t)@"PDSEWorkflowResponsiveness");
  ...
  v13 = sub_100001F60(@"com.apple.da", @"mobile", (uint64_t)@"PDSEWorkflowResponsiveness");
