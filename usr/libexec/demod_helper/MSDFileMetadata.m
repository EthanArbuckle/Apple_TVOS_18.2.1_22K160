...
- (BOOL)restoreAttribuesToPath:(id)a3
{
  ...
  id v84 = 0LL;
  unsigned __int8 v20 = [v5 setAttributes:v19 ofItemAtPath:v4 error:&v84];
  id v17 = v84;

  if ((v20 & 1) == 0)
  {
    id v58 = sub_100021D84();
    v59 = (os_log_s *)objc_claimAutoreleasedReturnValue(v58);
    if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
    {
      v68 = (void *)objc_claimAutoreleasedReturnValue([v17 localizedDescription]);
  ...
  id v83 = v17;
  unsigned __int8 v24 = [v5 setAttributes:v23 ofItemAtPath:v4 error:&v83];
  id v25 = v83;

  if ((v24 & 1) == 0)
  {
    id v62 = sub_100021D84();
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      v73 = (void *)objc_claimAutoreleasedReturnValue([v72 objectForKey:NSFileProtectionKey]);
      *(_DWORD *)buf = 138543874;
      id v87 = v4;
      __int16 v88 = 2114;
      v89 = v71;
...
LABEL_57:
  ...
  while (2)
  {
    for (i = 0LL; i != v29; i = (char *)i + 1)
    {
      ...
      v36 = (void *)objc_claimAutoreleasedReturnValue([v35 objectForKey:v33]);
      ...
      id v38 = v4;
      v39 = (const char *)[v4 fileSystemRepresentation];
      id v31 = v33;
      v40 = (const char *)[v31 UTF8String];
      id v30 = v36;
      if (setxattr(v39, v40, [v30 bytes], (size_t)objc_msgSend(v30, "length"), 0, 1))
      {
...
LABEL_34:
    ...
    id v29 = [obj countByEnumeratingWithState:&v79 objects:v85 count:16];
    if (v29) {
      continue;
    }
    break;
...
LABEL_21:
  ...
  unsigned __int8 v43 = [v42 isEqualToString:NSFileTypeSymbolicLink];
  ...
  if ((v43 & 1) == 0)
  {
    ...
    if (v45)
    {
      id v46 = objc_claimAutoreleasedReturnValue(-[MSDFileMetadata getAccessControlList](v41, "getAccessControlList"));
      v47 = acl_copy_int([v46 bytes]);
...
LABEL_52:
          ...
          id v4 = v57;
          v35 = (void *)objc_claimAutoreleasedReturnValue([v57 getExtendedAttributes]);
              ...
              if (v39)
              {
                ...
                while (2)
                {
                  for (j = 0LL; j != v40; j = (char *)j + 1)
                  {
                    ...
                    id v45 = (void *)objc_claimAutoreleasedReturnValue([v30 objectForKey:v43]);
...
LABEL_47:
              ...
              if (v20)
              {
                ...
                {
                  id v52 = v20;
                  id v53 = (void *)objc_claimAutoreleasedReturnValue(-[MSDFileMetadata getAccessControlList](v56, "getAccessControlList"));
                  BOOL v54 = (void *)objc_claimAutoreleasedReturnValue([v4 getAccessControlList]);
