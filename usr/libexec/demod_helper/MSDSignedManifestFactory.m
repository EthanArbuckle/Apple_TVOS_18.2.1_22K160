...
+ (id)readManifestFromFile:(id)a3
{
  ...
  if ((v5 & 1) == 0)
  {
    ...
    v10 = (os_log_s *)objc_claimAutoreleasedReturnValue(v19);
  ...
  [v7 open];
  id v25 = 0LL;
  v9 = (os_log_s *)objc_claimAutoreleasedReturnValue( +[NSPropertyListSerialization propertyListWithStream:options:format:error:]( &OBJC_CLASS___NSPropertyListSerialization,  "propertyListWithStream:options:format:error:",  v7,  2LL,  0LL,  &v25));
  v10 = (os_log_s *)v25;
  [v7 close];
  ...
  if (!v9)
  {
    ...
    v9 = (os_log_s *)objc_claimAutoreleasedReturnValue(v21);
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1000266F8(v10, v9);
    }
    goto LABEL_27;
  }
  ...
  uint64_t v13 = objc_claimAutoreleasedReturnValue(-[os_log_s objectForKey:](v9, "objectForKey:", @"Version"));
  if (!v13)
  {
...
LABEL_28:
  ...
  if ((int)[v14 intValue] < v15 || (int)objc_msgSend(v14, "intValue") >= 8)
  {
    id v17 = sub_100021D84();
    v18 = (os_log_s *)objc_claimAutoreleasedReturnValue(v17);
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR)) {
      sub_1000267F8(v14, v18);
    }
