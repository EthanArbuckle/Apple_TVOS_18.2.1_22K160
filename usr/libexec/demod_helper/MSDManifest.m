...
- (id)metadataForFile:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass(v3, v4) & 1) != 0) {
    objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( +[MSDFileMetadata fileMetaDataWithMetadataDictionary:]( &OBJC_CLASS___MSDFileMetadata,  "fileMetaDataWithMetadataDictionary:",  v3));
  }
  else {
    objc_super v5 = 0LL;
  }
...
- (BOOL)addFilesUsingSourceManifest:(id)a3
{
  ...
  if (os_log_type_enabled((os_log_t)obj, OS_LOG_TYPE_ERROR)) {
    sub_10002A5BC((os_log_s *)obj, v29, v30);
  }
  char v27 = 0;
LABEL_29:
...
- (BOOL)enumerateAndCollectMetaData:(id)a3 relativeTo:(id)a4 skip:(id)a5 superSet:(id)a6 handler:(id)a7
{
  ...
  id v24 = (void *)objc_claimAutoreleasedReturnValue( [v21 enumeratorAtURL:v22 includingPropertiesForKeys:v23 options:0 errorHandler:&stru_100044DF0]);
