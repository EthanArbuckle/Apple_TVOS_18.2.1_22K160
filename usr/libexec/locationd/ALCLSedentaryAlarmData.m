...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___ALCLSedentaryAlarmData;
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@ %@",  -[ALCLSedentaryAlarmData description](&v3, "description"),  -[ALCLSedentaryAlarmData dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  uint64_t type = self->_type;
    ...
    v5 = (NSString *)*(&off_10182C8A8 + type);
  }
...
- (BOOL)readFrom:(id)a3
{
  return sub_1002522C0((uint64_t)self, (uint64_t)a3);
}
