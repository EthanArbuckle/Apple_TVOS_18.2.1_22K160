...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___GPSCalCoreAnalyticsBin;
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___GPSCalCoreAnalyticsBin;
  double v6 = -[GPSCalCoreAnalyticsBin init](&v9, "init");
  double v7 = v6;
  if (v6)
  {
    v6->_speedLB = a3;
    v6->_speedUB = a4;
    *(_OWORD *)&v6->_mean = xmmword_1012E0180;
