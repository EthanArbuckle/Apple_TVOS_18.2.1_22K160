...
+ (id)getSilo
{
  if (qword_101999300 != -1) {
    dispatch_once(&qword_101999300, &stru_101860878);
  }
  return (id)qword_1019992F8;
}

- (CLOnBodyNotifierAdapter)init
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CLOnBodyNotifierAdapter;
...
+ (BOOL)isSupported
{
  if (qword_101999310 != -1) {
    dispatch_once(&qword_101999310, &stru_101860898);
  }
  return byte_101999308;
}
