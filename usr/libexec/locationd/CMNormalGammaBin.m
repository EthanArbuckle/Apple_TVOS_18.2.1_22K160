...
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___CMNormalGammaBin;
...
{
  v21.receiver = self;
  v21.super_class = (Class)&OBJC_CLASS___CMNormalGammaBin;
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___CMNormalGammaBin;
  ...
  if (result)
  {
    ...
    *(_OWORD *)&result->_maxMean = xmmword_101364B90;
  }
