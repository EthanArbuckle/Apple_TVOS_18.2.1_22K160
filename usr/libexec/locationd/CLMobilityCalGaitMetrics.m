...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___CLMobilityCalGaitMetrics;
...
{
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___CLMobilityCalGaitMetrics;
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___CLMobilityCalGaitMetrics;
...
- (id)description
{
  ...
  uint64_t v5 = -[CLMobilityCalGaitMetrics recordId](self, "recordId");
  -[CLMobilityCalGaitMetrics startTime](self, "startTime");
  uint64_t v7 = v6;
  unint64_t v8 = -[CLMobilityCalGaitMetrics timestamp](self, "timestamp");
  ...
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@,<recordId %d, startTime %f, timestamp %llu, walkingSpeed %f, stepLength %f, cycleTime %f>",  v4,  v5,  v7,  v8,  *(void *)&v10,  *(void *)&v12,  v13);
}
