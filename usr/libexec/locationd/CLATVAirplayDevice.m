...
{
  v15.receiver = a1;
  v15.super_class = (Class)&OBJC_CLASS___CLATVAirplayDevice;
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CLATVAirplayDevice;
...
- (id)cppObject
{
  ...
  size_t v5 = strlen(v4);
  uint64_t v6 = sub_1000E20CC((uint64_t)&v14, (unsigned __int8 *)v4, (unsigned __int8 *)&v4[v5]);
  uint64_t v8 = v7;
  [a1 timestamp];
  uint64_t v10 = v9;
