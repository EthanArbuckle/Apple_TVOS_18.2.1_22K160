...
- (BOOL)isRunningStateInWindow
{
  ...
  else
  {
    ...
    do
    {
      int isTypeRunning = CLMotionActivity::isTypeRunning(*((unsigned int *)begin + 2), a2);
      end = (double *)self->fActivityWindow.__end_;
      if (isTypeRunning)
      {
        if (begin == end - 2)
...
- (void)feedMotionStateData:(const NotificationData *)a3
{
  ...
  if (begin == end)
  {
    ...
    v29 = sub_100037038((uint64_t)&self->fActivityWindow.__end_cap_, v28);
    v31 = (char *)&v29[4 * v30];
    *(void *)v29 = *((void *)a3 + 10);
    v29[2] = *(_DWORD *)a3;
    v13 = v29 + 4;
...
LABEL_18:
  ...
  if (end >= v12)
  {
    ...
    v20 = (char *)sub_100037038((uint64_t)&self->fActivityWindow.__end_cap_, v19);
    v21 = &v20[16 * v16];
    v23 = &v20[16 * v22];
    *(void *)v21 = *((void *)a3 + 10);
