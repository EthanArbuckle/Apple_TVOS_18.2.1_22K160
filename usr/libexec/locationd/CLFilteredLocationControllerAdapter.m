...
+ (id)getSilo
{
  if (qword_101996190 != -1) {
    dispatch_once(&qword_101996190, &stru_10183D330);
  }
  return (id)qword_101996188;
}

- (CLFilteredLocationControllerAdapter)init
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CLFilteredLocationControllerAdapter;
