...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___CMPedometerEntry;
...
- (id)date
{
  return +[NSDate dateWithTimeIntervalSinceReferenceDate:]( &OBJC_CLASS___NSDate,  "dateWithTimeIntervalSinceReferenceDate:",  self->pedEntry.base.startTime);
}

- (id)firstStepTime
{
  return +[NSDate dateWithTimeIntervalSinceReferenceDate:]( &OBJC_CLASS___NSDate,  "dateWithTimeIntervalSinceReferenceDate:",  self->pedEntry.addition.firstStepTime);
}

- (id)lastStepTime
{
  return +[NSDate dateWithTimeIntervalSinceReferenceDate:]( &OBJC_CLASS___NSDate,  "dateWithTimeIntervalSinceReferenceDate:",  self->pedEntry.addition.lastStepTime);
}
