...
+ (id)getSilo
{
  if (qword_1019971F0 != -1) {
    dispatch_once(&qword_1019971F0, &stru_101841B10);
  }
  return (id)qword_1019971E8;
}

- (CLBacklightStateNotifierAdapter)init
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CLBacklightStateNotifierAdapter;
