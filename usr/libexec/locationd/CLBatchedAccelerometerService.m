...
+ (id)getSilo
{
  if (qword_101999FA0 != -1) {
    dispatch_once(&qword_101999FA0, &stru_101867D10);
  }
  return (id)qword_101999F98;
}
...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
  ...
  if (v2)
  {
    ...
    if (byte_101999F6F < 0)
    {
      sub_1010DD48C(__p, (void *)xmmword_101999F58, *((unint64_t *)&xmmword_101999F58 + 1));
    }

    else
    {
      *(_OWORD *)__p = xmmword_101999F58;
      uint64_t v8 = unk_101999F68;
    }

    int v9 = dword_101999F70;
    v6.receiver = v3;
    v6.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
...
- (void)registerForData:(id)a3
{
  ...
  v19.receiver = self;
  v19.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
  -[CLBatchedSensorService enableProvider](&v19, "enableProvider");
  if (qword_1019347C0 != -1) {
    dispatch_once(&qword_1019347C0, &stru_101867D30);
  }
  objc_super v5 = (os_log_s *)qword_1019347C8;
  if (os_log_type_enabled((os_log_t)qword_1019347C8, OS_LOG_TYPE_DEFAULT))
  {
    v18.receiver = self;
    v18.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
    -[CLBatchedSensorService info](&v18, "info");
    objc_super v6 = v23 >= 0 ? __p : (void **)__p[0];
    LODWORD(buf) = 136446210;
    *(void *)((char *)&buf + 4) = v6;
    _os_log_impl( (void *)&_mh_execute_header,  v5,  OS_LOG_TYPE_DEFAULT,  "[service-%{public}s] first client, creating manager",  (uint8_t *)&buf,  0xCu);
    if (SHIBYTE(v23) < 0) {
      operator delete(__p[0]);
    }
  }
  ...
  if (sub_1002921D0(115, 2))
  {
    ...
    v17.receiver = self;
    v17.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
    ...
    int v20 = 136446210;
    v21 = p_buf;
    _os_log_send_and_compose_impl( 2LL,  0LL,  __p,  1628LL,  &_mh_execute_header,  v12,  0LL,  "[service-%{public}s] first client, creating manager",  &v20,  12);
    v15 = v14;
    if (v26 < 0) {
      operator delete((void *)buf);
    }
    sub_10029211C("Generic", 1LL, 0, 2LL, "-[CLBatchedAccelerometerService registerForData:]", "%s\n", v15);
  }

  id v7 = objc_msgSend(-[CLBatchedAccelerometerService universe](self, "universe"), "silo");
  ...
  {
    *(_OWORD *)__p = xmmword_101999F58;
    uint64_t v23 = unk_101999F68;
  }

  int v24 = dword_101999F70;
  *(void *)&__int128 buf = &off_101867D60;
  *((void *)&buf + 1) = self;
  v27 = &buf;
  sub_100C160E8(v8, v7, __p, &buf);
  int v9 = v27;
  if (v27 == &buf)
  {
    uint64_t v10 = 4LL;
...
LABEL_23:
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
  -[CLBatchedSensorService unregisterForData:](&v8, "unregisterForData:", a3);
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
...
- (void)onBatchedData:(void *)a3 N:(int)a4
{
  ...
  {
    v24.receiver = self;
    v24.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
  ...
  if (sub_1002921D0(115, 2))
  {
    ...
    v23.receiver = self;
    v23.super_class = (Class)&OBJC_CLASS___CLBatchedAccelerometerService;
    ...
    sub_10029211C("Generic", 1LL, 0, 2LL, "-[CLBatchedAccelerometerService onBatchedData:N:]", "%s\n", v17);
  }

  int v9 = -[CLBatchedAccelerometerBufferWrapper initWithMovedBuffer:]( objc_alloc(&OBJC_CLASS___CLBatchedAccelerometerBufferWrapper),  "initWithMovedBuffer:",  a3);
  __int128 v21 = 0u;
  __int128 v22 = 0u;
  __int128 v19 = 0u;
  __int128 v20 = 0u;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0LL; i != v11; i = (char *)i + 1)
      {
        ...
        [*(id *)(*((void *)&v19 + 1) + 8 * (void)i) onBatchedAccelerometerData:v9];
      }
