...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___ALCLStairClimbingModel;
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@ %@",  -[ALCLStairClimbingModel description](&v3, "description"),  -[ALCLStairClimbingModel dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&double v4 = self->_machineFrequency;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v4),  @"machineFrequency");
  return v3;
}

- (BOOL)readFrom:(id)a3
{
  return sub_1006AA888((uint64_t)self, (uint64_t)a3);
}
