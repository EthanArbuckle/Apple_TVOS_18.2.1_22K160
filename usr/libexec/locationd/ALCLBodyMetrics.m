...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___ALCLBodyMetrics;
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@ %@",  -[ALCLBodyMetrics description](&v3, "description"),  -[ALCLBodyMetrics dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if (gender)
  {
    if (gender == 1) {
      ...
      v5 = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"(unknown: %i)",  self->_gender);
    }
  }
  ...
  *(float *)&double v6 = self->_heightM;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v6),  @"heightM");
  *(float *)&double v7 = self->_weightKG;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v7),  @"weightKG");
  *(float *)&double v8 = self->_vo2max;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v8),  @"vo2max");
  *(float *)&double v9 = self->_age;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v9),  @"age");
  *(float *)&double v10 = self->_hrmin;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v10),  @"hrmin");
  *(float *)&double v11 = self->_hrmax;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v11),  @"hrmax");
  *(float *)&double v12 = self->_hronset;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v12),  @"hronset");
  *(float *)&double v13 = self->_pal;
  objc_msgSend( v3,  "setObject:forKey:",  +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v13),  @"pal");
  return v3;
}

- (BOOL)readFrom:(id)a3
{
  return sub_10025D4FC((uint64_t)self, (uint64_t)a3);
}
...
- (unint64_t)hash
{
  ...
  return v12 ^ v30 ^ (2654435761LL * gender) ^ v21 ^ v39 ^ v48 ^ v57 ^ v66 ^ v74;
}
