...
+ (void)initialize
{
  if (qword_101993D98 != -1) {
    dispatch_once(&qword_101993D98, &stru_10182C438);
  }
}

+ (id)knownHosts
{
  return [(id)qword_101993DA0 allKeys];
}
...
+ (int)URLSession:(id)a3 didReceiveChallenge:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = (NSNull *)[(id)qword_101993DA0 objectForKeyedSubscript:v7];
  if (v9)
  {
    v10 = v9;
    if (v9 == +[NSNull null](&OBJC_CLASS___NSNull, "null"))
    {
      if (qword_101934A40 != -1) {
        dispatch_once(&qword_101934A40, &stru_10182C458);
      }
      v20 = (os_log_s *)qword_101934A48;
