...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___CLPedestrianFenceStatus;
...
- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"radius: %f, radialDisplacement: %f, duration: %f",  self->_radius,  self->_radialDisplacement,  *(void *)&self->_duration);
}
