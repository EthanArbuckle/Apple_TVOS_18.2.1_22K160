...
+ (id)getSilo
{
  if (qword_10199EE40 != -1) {
    dispatch_once(&qword_10199EE40, &stru_101889188);
  }
  return (id)qword_10199EE38;
}

- (CLSensorRecorderNotifierAdapter)init
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CLSensorRecorderNotifierAdapter;
...
+ (BOOL)isSupportedForType:(int)a3
{
  ...
  block[2] = sub_100E7D3E4;
  block[3] = &unk_1018891A8;
  int v5 = a3;
  if (qword_10199EE50 != -1) {
    dispatch_once(&qword_10199EE50, block);
  }
  return byte_10199EE48;
}
