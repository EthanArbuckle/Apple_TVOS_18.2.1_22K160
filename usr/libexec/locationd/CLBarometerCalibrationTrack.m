...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___CLBarometerCalibrationTrack;
...
- (id)description
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"Track: Type %d, startTime: %lf, stopTime: %lf, Coordinates: <%lf, %lf>",  self->_fType,  *(void *)&self->_fStartTime,  *(void *)&self->_fEndTime,  *(void *)&self->_fLocationCoordinates.latitude,  *(void *)&self->_fLocationCoordinates.longitude);
}
