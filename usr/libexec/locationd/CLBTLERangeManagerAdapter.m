...
+ (id)getSilo
{
  if (qword_10199F508 != -1) {
    dispatch_once(&qword_10199F508, &stru_10188C858);
  }
  return (id)qword_10199F500;
}

- (CLBTLERangeManagerAdapter)init
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CLBTLERangeManagerAdapter;
...
+ (BOOL)isSupported
{
  if (qword_10199F518 != -1) {
    dispatch_once(&qword_10199F518, &stru_10188C878);
  }
  return byte_10199F510;
}
