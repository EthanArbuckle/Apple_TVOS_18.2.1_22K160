...
- (id)initInSilo:(id)a3 withIdentifier:(void *)a4
{
  return -[CLDaemonStatusStateTracker initInSilo:withIdentifier:state:]( self,  "initInSilo:withIdentifier:state:",  a3,  a4,  0LL);
}

- (id)initInSilo:(id)a3 withIdentifier:(void *)a4 state:(id)a5
{
  return -[CLDaemonStatusStateTracker initWithQueue:identifier:state:]( self,  "initWithQueue:identifier:state:",  [a3 queue],  a4,  a5);
}

- (CLDaemonStatusStateTracker)initWithQueue:(id)a3 identifier:(void *)a4
{
  return -[CLDaemonStatusStateTracker initWithQueue:identifier:state:]( self,  "initWithQueue:identifier:state:",  a3,  a4,  0LL);
}

- (CLDaemonStatusStateTracker)initWithQueue:(id)a3 identifier:(void *)a4 state:(id)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___CLDaemonStatusStateTracker;
...
LABEL_5:
  ...
  {
    id v10 = -[CLDaemonStatusStateTracker identifier](v8, "identifier");
    *(_DWORD *)buf = 68290562;
    int v16 = 0;
    __int16 v17 = 2082;
    v18 = "";
    ...
    *(void *)&v28[6] = &v8->_state;
    _os_log_impl( (void *)&_mh_execute_header,  v9,  OS_LOG_TYPE_DEFAULT,  "{msg%{public}.0s:state transition, event:%{public, location:escape_only}s, state:%{public, locatio n:escape_only}s, id:%{public}p, property:%{public, location:escape_only}s, new:%{public, location: _CLDaemonStatusStateTrackerState}.*P}",  buf,  0x4Au);
LABEL_7:
    if (qword_101934980 != -1) {
      dispatch_once(&qword_101934980, &stru_101835EC8);
    }
  ...
  if (os_log_type_enabled((os_log_t)qword_101934988, OS_LOG_TYPE_DEFAULT))
  {
    id v12 = -[CLDaemonStatusStateTracker identifier](v8, "identifier");
    *(_DWORD *)buf = 68290562;
    int v16 = 0;
    __int16 v17 = 2082;
    v18 = "";
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled((os_log_t)qword_101934988, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 68290562;
    ...
    id v12 = "DaemonStatus";
    __int16 v13 = 2050;
    objc_super v14 = -[CLDaemonStatusStateTracker identifier](self, "identifier");
    __int16 v15 = 2082;
    int v16 = "lifecycle";
    __int16 v17 = 2050;
    v18 = self;
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___CLDaemonStatusStateTracker;
...
- (void)setBatteryData:(Battery *)a3
{
  if (!self->_inTransaction)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_101934988, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2050;
      __int16 v15 = -[CLDaemonStatusStateTracker identifier](self, "identifier");
      __int16 v16 = 2082;
      ...
      __int16 v24 = 2098;
      __int16 v25 = a3;
      _os_log_impl( (void *)&_mh_execute_header,  v5,  OS_LOG_TYPE_DEFAULT,  "{msg%{public}.0s:state transition, event:%{public, location:escape_only}s, state:%{public, locat ion:escape_only}s, id:%{public}p, property:%{public, location:escape_only}s, old:%{public, locat ion:CLDaemonStatus_Type::Battery}.*P, new:%{public, location:CLDaemonStatus_Type::Battery}.*P}",  (uint8_t *)v7,  0x5Au);
    }
  }
...
- (void)setReachability:(int)a3
{
  if (!self->_inTransaction)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_101934988, OS_LOG_TYPE_DEFAULT))
    {
      uint64_t v6 = -[CLDaemonStatusStateTracker identifier](self, "identifier");
      ...
      __int16 v21 = 2050;
      uint64_t v22 = a3;
      _os_log_impl( (void *)&_mh_execute_header,  v5,  OS_LOG_TYPE_DEFAULT,  "{msg%{public}.0s:state transition, event:%{public, location:escape_only}s, state:%{public, locat ion:escape_only}s, id:%{public}p, property:%{public, location:escape_only}s, old:%{public, locat ion:CLDaemonStatus_Type::Reachability}lld, new:%{public, location:CLDaemonStatus_Type::Reachability}lld}",  (uint8_t *)v8,  0x4Eu);
    }
  }
...
{
  p_state = &self->_state;
  __int128 v5 = *(_OWORD *)&self->_state.batteryData.wasConnected;
  __int128 v7 = *(_OWORD *)&self->_state.batteryData.level;
  __int128 v8 = v5;
  uint64_t v9 = *(void *)&self->_state.thermalPressure;
  if (self->_inTransaction)
  {
    ((void (*)(CLDaemonStatusStateTracker *, SEL, id))sub_101237AF4)(self, a2, a3);
  }
...
LABEL_3:
  ...
  if (os_log_type_enabled((os_log_t)qword_101934988, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 68291074;
    ...
    __int16 v18 = 2050;
    id v19 = -[CLDaemonStatusStateTracker identifier](v3, "identifier", v7, v8, v9);
    __int16 v20 = 2082;
...
- (BOOL)dumpState:(void *)a3 withSize:(unint64_t)a4 hints:(os_state_hints_s *)a5
{
  ...
  else
  {
    ...
    __int128 v7 = *(_OWORD *)&self->_state.batteryData.wasConnected;
...
- (id).cxx_construct
{
  *((void *)self + 2) = 0xBFF0000000000000LL;
  *((_WORD *)self + 12) = 0;
  *((_DWORD *)self + 7) = 0;
  *((_BYTE *)self + 32) = 0;
  *((_DWORD *)self + 9) = 0;
