...
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___CLBackgroundInertialOdometryClientSession;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___CLBackgroundInertialOdometryClientSession;
