...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___ALSCellTower;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___ALSCellTower;
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@ %@",  -[ALSCellTower description](&v3, "description"),  -[ALSCellTower dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_100B84A40((uint64_t)self, (uint64_t)a3);
}
