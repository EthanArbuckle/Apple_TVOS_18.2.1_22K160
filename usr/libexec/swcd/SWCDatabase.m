...
+ (SWCDatabase)sharedDatabase
{
  ...
  if (qword_1000371C0 != -1) {
    dispatch_once(&qword_1000371C0, &stru_100030BE8);
  }
  return (SWCDatabase *)(id)qword_1000371B8;
}
...
+ (OS_dispatch_queue)queue
{
  if (qword_1000371D0 != -1) {
    dispatch_once(&qword_1000371D0, &stru_100030C08);
  }
  return (OS_dispatch_queue *)(id)qword_1000371C8;
}
...
- (id)entryMatchingService:(id)a3 domain:(id)a4 appID:(id)a5
{
  ...
  __int128 v11 = sub_100010618;
  __int128 v12 = sub_100010628;
  id v13 = 0LL;
...
- (void)removeAllEntries
{
  ...
  id v5 = (os_log_s *)qword_1000371D8;
  if (os_log_type_enabled((os_log_t)qword_1000371D8, OS_LOG_TYPE_INFO))
  {
    *(_WORD *)buf = 0;
  ...
  if ((v6 & 1) == 0)
  {
    ...
    uint64_t v8 = (os_log_s *)qword_1000371D8;
    if (os_log_type_enabled((os_log_t)qword_1000371D8, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      id v11 = v7;
...
- (void)updateEntriesForDomain:(id)a3 canonicalEntries:(id)a4
{
  ...
  __int128 v12 = sub_100010CC4;
  id v13 = &unk_100030C80;
  id v9 = v7;
  id v14 = v9;
  id v15 = a4;
...
- (BOOL)saveReturningError:(id *)a3
{
  ...
  if ((*((_BYTE *)self + 40) & 1) != 0)
  {
    ...
    uint64_t v11 = (os_log_s *)(id)qword_1000371D8;
  ...
  else
  {
    ...
    id v7 = (os_log_s *)qword_1000371D8;
    if (os_log_type_enabled((os_log_t)qword_1000371D8, OS_LOG_TYPE_DEBUG))
    {
      *(_WORD *)buf = 0;
  ...
  if (!v9)
  {
    ...
    id v18 = (os_log_s *)qword_1000371D8;
    if (os_log_type_enabled((os_log_t)qword_1000371D8, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      id v23 = v8;
  ...
  if (v2)
  {
    ...
    *((_BYTE *)v2 + 40) |= 1u;
    ...
    if (v8)
    {
      ...
      if (v12)
      {
        ...
        else
        {
          ...
          __int128 v26 = (os_log_s *)(id)qword_1000371D8;
    ...
    if (!v2->_entries || !v2->_settings)
    {
      ...
      __int128 v30 = (os_log_s *)qword_1000371D8;
      if (os_log_type_enabled((os_log_t)qword_1000371D8, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138412290;
        id v40 = v13;
...
- (void)_scheduleSave
{
  if ((*((_BYTE *)self + 40) & 1) != 0)
  {
    ...
    *(void *)buf = 0x402E000000000000LL;
    ...
    sub_10001E9B4((dispatch_object_t *)&self->_saveTimer, (uint64_t)buf, v6);
    objc_destroyWeak(&v7);
  ...
  else
  {
    ...
    id v2 = (os_log_s *)qword_1000371D8;
    if (os_log_type_enabled((os_log_t)qword_1000371D8, OS_LOG_TYPE_DEBUG))
    {
      *(_WORD *)buf = 0;
      ...
      do
      {
        ...
        if (v15)
        {
          ...
          if (v16)
          {
            ...
            id v17 = (os_log_s *)qword_1000371D8;
            if (os_log_type_enabled((os_log_t)qword_1000371D8, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = v19;
              __int128 v25 = v16;
