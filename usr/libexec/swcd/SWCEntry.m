...
LABEL_5:
  ...
  v21 = (os_log_s *)(id)qword_100037170;
...
+ (id)entriesForBundleRecord:(id)a3 enterpriseContext:(id)a4 developerModeEnabled:(BOOL)a5
{
  ...
  if (v10)
  {
    ...
    if ([v15 count])
    {
      ...
      uint64_t v16 = (os_log_s *)(id)qword_100037170;
    ...
    else
    {
      ...
      double v19 = (os_log_s *)qword_100037170;
      if (os_log_type_enabled((os_log_t)qword_100037170, OS_LOG_TYPE_DEBUG))
      {
    ...
    if (v20 == 1)
    {
      ...
      if (v22)
      {
        ...
        int v23 = (os_log_s *)qword_100037170;
        if (os_log_type_enabled((os_log_t)qword_100037170, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          id v61 = v8;
  ...
  else
  {
    ...
    uint64_t v18 = (os_log_s *)qword_100037170;
    if (os_log_type_enabled((os_log_t)qword_100037170, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      id v61 = v8;
...
+ (void)enumerateJSONResourceURLsForDirectoryAtURL:(id)a3 block:(id)a4
{
  ...
  id v6 = (os_log_s *)(id)qword_100037170;
...
LABEL_33:
        ...
        do
        {
          ...
          if (v32)
          {
            ...
            if (v33 && -[_SWCDomain isValid](v33, "isValid"))
            {
              ...
              id v35 = (os_log_s *)(id)qword_100037170;
  ...
  uint64_t v22 = (os_log_s *)(id)qword_100037170;
...
LABEL_34:
      ...
      else
      {
        ...
        id v24 = (os_log_s *)qword_100037170;
      ...
      uint64_t v25 = (os_log_s *)qword_100037170;
      if (os_log_type_enabled((os_log_t)qword_100037170, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412290;
        id v29 = v11;
...
+ (void)_enumerateJSONFilesForBundleRecord:(id)a3 applicationIdentifier:(id)a4 block:(id)a5
{
  ...
  if (v11)
  {
    ...
    id v21 = sub_10000D53C;
    unsigned __int8 v22 = &unk_100030A28;
    id v23 = v10;
    id v24 = &v25;
...
+ (id)_entriesFromBuiltInJSONForBundleRecord:(id)a3 applicationIdentifier:(id)a4
{
  ...
  uint64_t v25 = sub_10000DA0C;
  id v26 = sub_10000DA1C;
  id v27 = 0LL;
...
+ (void)_addEntryToOrderedSet:(id)a3 forUniversalLinksFromSingleDetailsDictionary:(id)a4 domain:(id)a5 substitutionVariables:(id)a6 defaults:(id)a7
{
  ...
  if (v32 && _NSIsNSArray(v32))
  {
    ...
    id v21 = (os_log_s *)(id)qword_100037170;
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      id v22 = [v32 count];
  ...
  else
  {
    ...
    id v27 = (os_log_s *)qword_100037170;
    if (os_log_type_enabled((os_log_t)qword_100037170, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138412290;
      id v46 = v31;
