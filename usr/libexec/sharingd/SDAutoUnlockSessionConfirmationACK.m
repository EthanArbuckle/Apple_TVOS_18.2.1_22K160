...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___SDAutoUnlockSessionConfirmationACK;
  id v3 = -[SDAutoUnlockSessionConfirmationACK description](&v8, "description");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](&OBJC_CLASS___NSNumber, "numberWithBool:", self->_success));
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    PBDataWriterWriteBOOLField(v6, self->_success, 2LL);
    id v4 = v6;
  }
}
...
LABEL_3:
  uint64_t v3 = 2654435761LL * self->_success;
  return v3 ^ v2;
}
