...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___SDAuthenticationPreRequest;
  id v3 = -[SDAuthenticationPreRequest description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[SDAuthenticationPreRequest dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 1) != 0)
  {
    PBDataWriterWriteUint32Field(v7, self->_type, 2LL);
    id v4 = v7;
  }
  ...
  if (sessionID)
  {
    PBDataWriterWriteStringField(v7, sessionID, 3LL);
    id v4 = v7;
  }
}
