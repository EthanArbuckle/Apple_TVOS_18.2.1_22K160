...
- (SharingXPCHelperGroupContactIcon)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___SharingXPCHelperGroupContactIcon;
  v6 = -[SharingXPCHelperContactIcon initWithCoder:](&v9, "initWithCoder:", v4);
  if (v6)
  {
    uint64_t v7 = objc_opt_class(&OBJC_CLASS___CNContact, v5);
    NSDecodeNSArrayOfClassIfPresent(v4, @"SharingXPCHelperGroupContactIcon-Contacts", v7, &v6->_contacts);
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_super v9 = (void *)objc_claimAutoreleasedReturnValue([*(id *)(*((void *)&v12 + 1) + 8 * (void)v8) identifier]);
