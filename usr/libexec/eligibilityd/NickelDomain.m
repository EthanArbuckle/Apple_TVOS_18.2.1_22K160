...
- (void)_internal_doInit
{
  id v3 = (id)objc_claimAutoreleasedReturnValue(+[NSSet setWithObjects:](&OBJC_CLASS___NSSet, "setWithObjects:", @"iPhone", 0LL));
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___NickelDomain;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___NickelDomain;
...
- (void)updateParameters
{
  objc_super v6 = (void *)objc_claimAutoreleasedReturnValue(+[MobileAssetManager sharedInstance](&OBJC_CLASS___MobileAssetManager, "sharedInstance"));
  id v3 = (void *)objc_claimAutoreleasedReturnValue([v6 nickelAsset]);
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSSet setWithObjects:]( &OBJC_CLASS___NSSet,  "setWithObjects:",  @"AZ",  @"BH",  @"EG",  @"IR",  @"IQ",  @"JO",  @"KW",  @"MA",  @"NG",  @"OM",  @"PK",  @"QA",  @"RU",  @"SA",  @"ZA",  @"TR",  @"AE",  @"YE",  0LL));
  -[EligibilityDomain setDeviceLocalesOfInterest:isInverted:](self, "setDeviceLocalesOfInterest:isInverted:", v5, 1LL);
}

- (BOOL)computeWithError:(id *)a3
{
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue(-[EligibilityDomain status](self, "status"));
  objc_super v6 = v5;
  if (v5)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKeyedSubscript:@"OS_ELIGIBILITY_INPUT_DEVICE_LOCALE"]);
...
LABEL_6:
  ...
  else
  {
    ...
    {
      int v21 = 136315138;
      v22 = "-[NickelDomain computeWithError:]";
      _os_log_fault_impl( (void *)&_mh_execute_header,  v18,  OS_LOG_TYPE_FAULT,  "%s: Failed to get status for Nickel domain",  (uint8_t *)&v21,  0xCu);
    }
