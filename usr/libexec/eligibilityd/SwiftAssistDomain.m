...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___SwiftAssistDomain;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SwiftAssistDomain;
...
- (unint64_t)computeInputStatusForDeviceRegionCodesInput:(id)a3
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue([v4 swiftAssistAsset]);
