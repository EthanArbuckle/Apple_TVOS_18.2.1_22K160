...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___SeleniumDomain;
  v2 = -[EligibilityDomain init](&v5, "init");
  id v3 = v2;
  if (v2) {
    -[SeleniumDomain _internal_doInit](v2, "_internal_doInit");
  }
  return v3;
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SeleniumDomain;
  id v3 = -[EligibilityDomain initWithCoder:](&v6, "initWithCoder:", a3);
  v4 = v3;
  if (v3) {
    -[SeleniumDomain _internal_doInit](v3, "_internal_doInit");
  }
  return v4;
}
...
- (void)updateParameters
{
  ...
  id v3 = (void *)objc_claimAutoreleasedReturnValue([v5 seleniumAsset]);
