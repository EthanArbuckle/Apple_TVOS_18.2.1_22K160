...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___SearchMarketplacesDomain;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___SearchMarketplacesDomain;
...
- (void)updateParameters
{
  ...
  id v3 = (void *)objc_claimAutoreleasedReturnValue([v5 searchMarketplacesAsset]);
