...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___AluminumDomain;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___AluminumDomain;
...
- (void)updateParameters
{
  ...
  id v3 = (void *)objc_claimAutoreleasedReturnValue([v5 aluminumAsset]);
