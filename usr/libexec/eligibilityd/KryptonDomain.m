...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___KryptonDomain;
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___KryptonDomain;
...
- (id)status
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue([v17 kryptonAsset]);
  __int128 v21 = 0u;
  __int128 v22 = 0u;
  __int128 v23 = 0u;
  __int128 v24 = 0u;
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v18.receiver = self;
        v18.super_class = (Class)&OBJC_CLASS___KryptonDomain;
