uint64_t start()
{
  ...
  v5 = [[DMCPowerAssertion alloc] initWithReason:@"mdmd-Start"];
  v6 = [[MDMServerCore alloc] initWithChannelType:0];
  [v6 startOutError:0];
  v7 = [[MDMServiceDelegate alloc] initWithServer:v6];
  v8 = objc_alloc(&OBJC_CLASS___NSXPCListener);
  v9 = -[NSXPCListener initWithMachServiceName:](v8, "initWithMachServiceName:", kMDMServiceBootstrapName);
