...
- (TransparencyGPBUInt64EnumDictionary)init
{
  return -[TransparencyGPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:]( self,  "initWithValidationFunction:rawValues:forKeys:count:",  0LL,  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[TransparencyGPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:]( self,  "initWithValidationFunction:rawValues:forKeys:count:",  a3,  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unint64_t *)a5 count:(unint64_t)a6
{
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64EnumDictionary;
  ...
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      do
      {
        ...
        uint64_t v16 = *a5++;
        -[NSMutableDictionary setObject:forKey:]( dictionary,  "setObject:forKey:",  v15,  +[NSNumber numberWithUnsignedLongLong:](&OBJC_CLASS___NSNumber, "numberWithUnsignedLongLong:", v16));
        --a6;
      }
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64EnumDictionary;
  -[TransparencyGPBUInt64EnumDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt64EnumDictionary initWithDictionary:]( +[TransparencyGPBUInt64EnumDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt64EnumDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt64EnumDictionary, a2);
...
- (void)enumerateKeysAndRawValuesUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))( a3,  [v6 unsignedLongLongValue],  objc_msgSend( -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6),  "intValue"),  &v7);
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_10010FA10(2, v15) + v13);
      if (v7 == 4)
      {
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  uint64_t v8 = sub_100113F88(a4->var2, 1, a5);
  ...
  if (v5 == 4)
  {
    -[TransparencyGPBCodedOutputStream writeFixed64:value:](v10, "writeFixed64:value:", 1LL, var2);
  }

  else if (v5 == 12)
  {
    -[TransparencyGPBCodedOutputStream writeUInt64:value:](v10, "writeUInt64:value:", 1LL, var2);
  }

  -[TransparencyGPBCodedOutputStream writeEnum:value:](v11, "writeEnum:value:", 2LL, v7);
...
- (BOOL)getEnum:(int *)a3 forKey:(unint64_t)a4
{
  id v6 = -[NSMutableDictionary objectForKey:]( self->_dictionary,  "objectForKey:",  +[NSNumber numberWithUnsignedLongLong:](&OBJC_CLASS___NSNumber, "numberWithUnsignedLongLong:", a4));
  id v7 = v6;
  if (a3 && v6)
  {
...
- (void)setEnum:(int)a3 forKey:(unint64_t)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    +[NSException raise:format:]( &OBJC_CLASS___NSException,  "raise:format:",  NSInvalidArgumentException,  @"TransparencyGPBUInt64EnumDictionary: Attempt to set an unknown enum value (%d)",  v5);
  }
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  +[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", v5),  +[NSNumber numberWithUnsignedLongLong:](&OBJC_CLASS___NSNumber, "numberWithUnsignedLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator) {
    sub_10012DFA8(autocreator, (uint64_t)self);
  }
