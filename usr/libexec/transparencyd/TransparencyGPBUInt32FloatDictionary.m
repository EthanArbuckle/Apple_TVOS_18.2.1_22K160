...
- (TransparencyGPBUInt32FloatDictionary)init
{
  return -[TransparencyGPBUInt32FloatDictionary initWithFloats:forKeys:count:]( self,  "initWithFloats:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt32FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32FloatDictionary;
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          unsigned int v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:]( dictionary,  "setObject:forKey:",  v12,  +[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", v13));
          --a5;
        }
...
- (TransparencyGPBUInt32FloatDictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBUInt32FloatDictionary initWithFloats:forKeys:count:]( self,  "initWithFloats:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32FloatDictionary;
  -[TransparencyGPBUInt32FloatDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt32FloatDictionary initWithDictionary:]( +[TransparencyGPBUInt32FloatDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt32FloatDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt32FloatDictionary, a2);
...
{
  LODWORD(v4) = a3->var1;
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  +[NSNumber numberWithFloat:](&OBJC_CLASS___NSNumber, "numberWithFloat:", v4),  +[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", a4->var3));
}
