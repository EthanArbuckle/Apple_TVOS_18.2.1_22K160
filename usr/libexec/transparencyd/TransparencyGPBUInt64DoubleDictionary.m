...
- (TransparencyGPBUInt64DoubleDictionary)init
{
  return -[TransparencyGPBUInt64DoubleDictionary initWithDoubles:forKeys:count:]( self,  "initWithDoubles:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt64DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64DoubleDictionary;
...
- (TransparencyGPBUInt64DoubleDictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBUInt64DoubleDictionary initWithDoubles:forKeys:count:]( self,  "initWithDoubles:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64DoubleDictionary;
  -[TransparencyGPBUInt64DoubleDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt64DoubleDictionary initWithDictionary:]( +[TransparencyGPBUInt64DoubleDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt64DoubleDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt64DoubleDictionary, a2);
