...
- (TransparencyGPBInt32UInt64Dictionary)init
{
  return -[TransparencyGPBInt32UInt64Dictionary initWithUInt64s:forKeys:count:]( self,  "initWithUInt64s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt32UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32UInt64Dictionary;
...
- (TransparencyGPBInt32UInt64Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt32UInt64Dictionary initWithUInt64s:forKeys:count:]( self,  "initWithUInt64s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32UInt64Dictionary;
  -[TransparencyGPBInt32UInt64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32UInt64Dictionary initWithDictionary:]( +[TransparencyGPBInt32UInt64Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt32UInt64Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt32UInt64Dictionary, a2);
