...
- (TransparencyGPBUInt32Int64Dictionary)init
{
  return -[TransparencyGPBUInt32Int64Dictionary initWithInt64s:forKeys:count:]( self,  "initWithInt64s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32Int64Dictionary;
...
- (TransparencyGPBUInt32Int64Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBUInt32Int64Dictionary initWithInt64s:forKeys:count:]( self,  "initWithInt64s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32Int64Dictionary;
  -[TransparencyGPBUInt32Int64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt32Int64Dictionary initWithDictionary:]( +[TransparencyGPBUInt32Int64Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt32Int64Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt32Int64Dictionary, a2);
...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))( a3,  [v6 unsignedIntValue],  objc_msgSend( -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6),  "longLongValue"),  &v7);
  }
