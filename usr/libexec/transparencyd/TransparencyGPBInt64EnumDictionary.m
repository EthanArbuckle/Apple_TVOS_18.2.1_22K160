...
- (TransparencyGPBInt64EnumDictionary)init
{
  return -[TransparencyGPBInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:]( self,  "initWithValidationFunction:rawValues:forKeys:count:",  0LL,  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt64EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[TransparencyGPBInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:]( self,  "initWithValidationFunction:rawValues:forKeys:count:",  a3,  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const int64_t *)a5 count:(unint64_t)a6
{
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64EnumDictionary;
  ...
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      do
      {
        ...
        uint64_t v16 = *a5++;
        -[NSMutableDictionary setObject:forKey:]( dictionary,  "setObject:forKey:",  v15,  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", v16));
        --a6;
      }
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64EnumDictionary;
  -[TransparencyGPBInt64EnumDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64EnumDictionary initWithDictionary:]( +[TransparencyGPBInt64EnumDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt64EnumDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt64EnumDictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      id v15 = [v13 intValue];
      int v16 = sub_1001147A4((unint64_t)v14, 1, v7);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  uint64_t v8 = sub_1001147A4(a4->var2, 1, a5);
  ...
  sub_100114940(v10, a4->var2, 1LL, v5);
...
- (BOOL)getEnum:(int *)a3 forKey:(int64_t)a4
{
  id v6 = -[NSMutableDictionary objectForKey:]( self->_dictionary,  "objectForKey:",  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", a4));
  id v7 = v6;
  if (a3 && v6)
  {
...
- (void)setEnum:(int)a3 forKey:(int64_t)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    +[NSException raise:format:]( &OBJC_CLASS___NSException,  "raise:format:",  NSInvalidArgumentException,  @"TransparencyGPBInt64EnumDictionary: Attempt to set an unknown enum value (%d)",  v5);
  }
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  +[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", v5),  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator) {
    sub_10012DFA8(autocreator, (uint64_t)self);
  }
