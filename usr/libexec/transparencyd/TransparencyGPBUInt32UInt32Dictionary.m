...
- (TransparencyGPBUInt32UInt32Dictionary)init
{
  return -[TransparencyGPBUInt32UInt32Dictionary initWithUInt32s:forKeys:count:]( self,  "initWithUInt32s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt32UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32UInt32Dictionary;
...
- (TransparencyGPBUInt32UInt32Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBUInt32UInt32Dictionary initWithUInt32s:forKeys:count:]( self,  "initWithUInt32s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32UInt32Dictionary;
  -[TransparencyGPBUInt32UInt32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt32UInt32Dictionary initWithDictionary:]( +[TransparencyGPBUInt32UInt32Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt32UInt32Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt32UInt32Dictionary, a2);
