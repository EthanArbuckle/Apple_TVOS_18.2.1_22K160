...
- (TransparencyGPBInt32Int32Dictionary)init
{
  return -[TransparencyGPBInt32Int32Dictionary initWithInt32s:forKeys:count:]( self,  "initWithInt32s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32Int32Dictionary;
...
- (TransparencyGPBInt32Int32Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt32Int32Dictionary initWithInt32s:forKeys:count:]( self,  "initWithInt32s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32Int32Dictionary;
  -[TransparencyGPBInt32Int32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32Int32Dictionary initWithDictionary:]( +[TransparencyGPBInt32Int32Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt32Int32Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt32Int32Dictionary, a2);
