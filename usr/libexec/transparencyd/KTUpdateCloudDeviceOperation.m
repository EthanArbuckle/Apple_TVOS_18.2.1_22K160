...
- (_TtC13transparencyd28KTUpdateCloudDeviceOperation)init
{
  result = (_TtC13transparencyd28KTUpdateCloudDeviceOperation *)_swift_stdlib_reportUnimplementedInitializer( "transparencyd.KTUpdateCloudDeviceOperation",  42LL,  "init()",  6LL,  0LL);
  __break(1u);
  return result;
}
