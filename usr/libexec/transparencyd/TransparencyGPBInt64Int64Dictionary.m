...
- (TransparencyGPBInt64Int64Dictionary)init
{
  return -[TransparencyGPBInt64Int64Dictionary initWithInt64s:forKeys:count:]( self,  "initWithInt64s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt64Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64Int64Dictionary;
...
- (TransparencyGPBInt64Int64Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt64Int64Dictionary initWithInt64s:forKeys:count:]( self,  "initWithInt64s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64Int64Dictionary;
  -[TransparencyGPBInt64Int64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64Int64Dictionary initWithDictionary:]( +[TransparencyGPBInt64Int64Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt64Int64Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt64Int64Dictionary, a2);
...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))( a3,  [v6 longLongValue],  objc_msgSend( -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6),  "longLongValue"),  &v7);
  }
