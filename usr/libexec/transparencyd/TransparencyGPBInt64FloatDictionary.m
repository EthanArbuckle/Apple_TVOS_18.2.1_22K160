...
- (TransparencyGPBInt64FloatDictionary)init
{
  return -[TransparencyGPBInt64FloatDictionary initWithFloats:forKeys:count:]( self,  "initWithFloats:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64FloatDictionary;
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          uint64_t v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:]( dictionary,  "setObject:forKey:",  v12,  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", v13));
          --a5;
        }
...
- (TransparencyGPBInt64FloatDictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt64FloatDictionary initWithFloats:forKeys:count:]( self,  "initWithFloats:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64FloatDictionary;
  -[TransparencyGPBInt64FloatDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64FloatDictionary initWithDictionary:]( +[TransparencyGPBInt64FloatDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt64FloatDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt64FloatDictionary, a2);
...
{
  LODWORD(v4) = a3->var1;
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  +[NSNumber numberWithFloat:](&OBJC_CLASS___NSNumber, "numberWithFloat:", v4),  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", a4->var2));
}
