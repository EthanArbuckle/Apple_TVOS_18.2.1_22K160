...
- (TransparencyGPBUInt64Int32Dictionary)init
{
  return -[TransparencyGPBUInt64Int32Dictionary initWithInt32s:forKeys:count:]( self,  "initWithInt32s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt64Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64Int32Dictionary;
...
- (TransparencyGPBUInt64Int32Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBUInt64Int32Dictionary initWithInt32s:forKeys:count:]( self,  "initWithInt32s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64Int32Dictionary;
  -[TransparencyGPBUInt64Int32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt64Int32Dictionary initWithDictionary:]( +[TransparencyGPBUInt64Int32Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt64Int32Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt64Int32Dictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_100113744(v16, 2, v7) + v14);
      if (v8 == 4)
      {
