...
- (TransparencyGPBUInt32EnumDictionary)init
{
  return -[TransparencyGPBUInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:]( self,  "initWithValidationFunction:rawValues:forKeys:count:",  0LL,  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt32EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[TransparencyGPBUInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:]( self,  "initWithValidationFunction:rawValues:forKeys:count:",  a3,  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt32EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unsigned int *)a5 count:(unint64_t)a6
{
  v18.receiver = self;
  v18.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32EnumDictionary;
  ...
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      do
      {
        ...
        unsigned int v16 = *a5++;
        -[NSMutableDictionary setObject:forKey:]( dictionary,  "setObject:forKey:",  v15,  +[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", v16));
        --a6;
      }
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt32EnumDictionary;
  -[TransparencyGPBUInt32EnumDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt32EnumDictionary initWithDictionary:]( +[TransparencyGPBUInt32EnumDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt32EnumDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt32EnumDictionary, a2);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  uint64_t v8 = sub_100112F20(a4->var1, 1, a5);
  ...
  if (v5 == 1)
  {
    -[TransparencyGPBCodedOutputStream writeFixed32:value:](v10, "writeFixed32:value:", 1LL, var3);
  }

  else if (v5 == 11)
  {
    -[TransparencyGPBCodedOutputStream writeUInt32:value:](v10, "writeUInt32:value:", 1LL, var3);
  }
...
- (BOOL)getEnum:(int *)a3 forKey:(unsigned int)a4
{
  id v6 = -[NSMutableDictionary objectForKey:]( self->_dictionary,  "objectForKey:",  +[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", *(void *)&a4));
  id v7 = v6;
  if (a3 && v6)
  {
...
- (void)setEnum:(int)a3 forKey:(unsigned int)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    +[NSException raise:format:]( &OBJC_CLASS___NSException,  "raise:format:",  NSInvalidArgumentException,  @"TransparencyGPBUInt32EnumDictionary: Attempt to set an unknown enum value (%d)",  v5);
  }
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  +[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", v5),  +[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", v4));
  autocreator = self->_autocreator;
  if (autocreator) {
    sub_10012DFA8(autocreator, (uint64_t)self);
  }
