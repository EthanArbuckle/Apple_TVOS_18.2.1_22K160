...
- (TransparencyGPBInt32BoolDictionary)init
{
  return -[TransparencyGPBInt32BoolDictionary initWithBools:forKeys:count:]( self,  "initWithBools:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt32BoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32BoolDictionary;
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          unsigned int v12 = *a4++;
          -[NSMutableDictionary setObject:forKey:]( dictionary,  "setObject:forKey:",  v11,  +[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", v12));
          --a5;
        }
...
- (TransparencyGPBInt32BoolDictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt32BoolDictionary initWithBools:forKeys:count:]( self,  "initWithBools:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32BoolDictionary;
  -[TransparencyGPBInt32BoolDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32BoolDictionary initWithDictionary:]( +[TransparencyGPBInt32BoolDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt32BoolDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt32BoolDictionary, a2);
...
- (void)enumerateKeysAndBoolsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))( a3,  [v6 intValue],  objc_msgSend( -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6),  "BOOLValue"),  &v7);
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_10010FAAC(2) + v16];
