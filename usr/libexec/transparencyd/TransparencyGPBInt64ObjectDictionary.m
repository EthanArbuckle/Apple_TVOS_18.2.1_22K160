...
- (TransparencyGPBInt64ObjectDictionary)init
{
  return -[TransparencyGPBInt64ObjectDictionary initWithObjects:forKeys:count:]( self,  "initWithObjects:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt64ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64ObjectDictionary;
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          uint64_t v10 = *a4++;
          -[NSMutableDictionary setObject:forKey:]( v8->_dictionary,  "setObject:forKey:",  v9,  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", v10));
          ++a3;
          --a5;
        }
...
- (TransparencyGPBInt64ObjectDictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt64ObjectDictionary initWithObjects:forKeys:count:]( self,  "initWithObjects:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64ObjectDictionary;
  -[TransparencyGPBInt64ObjectDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64ObjectDictionary initWithDictionary:]( +[TransparencyGPBInt64ObjectDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt64ObjectDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt64ObjectDictionary, a2);
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  uint64_t v5 = objc_alloc_init(&OBJC_CLASS___TransparencyGPBInt64ObjectDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      int v16 = sub_1001147A4((unint64_t)v15, 1, v8);
...
- (id)objectForKey:(int64_t)a3
{
  return -[NSMutableDictionary objectForKey:]( self->_dictionary,  "objectForKey:",  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", a3));
}
...
- (void)setObject:(id)a3 forKey:(int64_t)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  a3,  +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator) {
    sub_10012DFA8(autocreator, (uint64_t)self);
  }
