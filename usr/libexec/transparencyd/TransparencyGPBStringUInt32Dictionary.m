...
- (TransparencyGPBStringUInt32Dictionary)init
{
  return -[TransparencyGPBStringUInt32Dictionary initWithUInt32s:forKeys:count:]( self,  "initWithUInt32s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBStringUInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBStringUInt32Dictionary;
...
- (TransparencyGPBStringUInt32Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBStringUInt32Dictionary initWithUInt32s:forKeys:count:]( self,  "initWithUInt32s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBStringUInt32Dictionary;
  -[TransparencyGPBStringUInt32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBStringUInt32Dictionary initWithDictionary:]( +[TransparencyGPBStringUInt32Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBStringUInt32Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBStringUInt32Dictionary, a2);
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        objc_super v14 = &v13[sub_100112F20([v12 unsignedIntValue], 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_100112F20(v14, 2, v7) + v15);
...
- (void)setUInt32:(unsigned int)a3 forKey:(id)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  +[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:", v5),  a4);
  autocreator = self->_autocreator;
  if (autocreator) {
    sub_10012DFA8(autocreator, (uint64_t)self);
  }
