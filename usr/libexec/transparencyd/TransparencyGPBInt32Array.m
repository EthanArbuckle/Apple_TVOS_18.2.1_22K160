...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32Array;
  return -[TransparencyGPBInt32Array init](&v3, "init");
}

- (TransparencyGPBInt32Array)initWithValueArray:(id)a3
{
  return -[TransparencyGPBInt32Array initWithValues:count:]( self,  "initWithValues:count:",  *((void *)a3 + 2),  *((void *)a3 + 3));
}
...
- (TransparencyGPBInt32Array)initWithCapacity:(unint64_t)a3
{
  int v4 = -[TransparencyGPBInt32Array initWithValues:count:](self, "initWithValues:count:", 0LL, 0LL);
  v5 = v4;
  if (a3 && v4) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32Array initWithValues:count:]( +[TransparencyGPBInt32Array allocWithZone:](&OBJC_CLASS___TransparencyGPBInt32Array, "allocWithZone:", a3),  "initWithValues:count:",  self->_values,  self->_count);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt32Array, a2);
...
{
  int v3 = a3;
  -[TransparencyGPBInt32Array addValues:count:](self, "addValues:count:", &v3, 1LL);
}
...
- (void)addValues:(const int *)a3 count:(unint64_t)a4
{
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity) {
      -[TransparencyGPBInt32Array internalResizeToCapacity:]( self,  "internalResizeToCapacity:",  (v8 & 0xFFFFFFFFFFFFFFF0LL) + 16);
    }
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity) {
    -[TransparencyGPBInt32Array internalResizeToCapacity:]( self,  "internalResizeToCapacity:",  (v6 & 0xFFFFFFFFFFFFFFF0LL) + 16);
  }
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21) {
    -[TransparencyGPBInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", 16LL);
  }
}
