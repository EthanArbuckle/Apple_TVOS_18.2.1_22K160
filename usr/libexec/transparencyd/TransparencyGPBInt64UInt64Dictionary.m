...
- (TransparencyGPBInt64UInt64Dictionary)init
{
  return -[TransparencyGPBInt64UInt64Dictionary initWithUInt64s:forKeys:count:]( self,  "initWithUInt64s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64UInt64Dictionary;
...
- (TransparencyGPBInt64UInt64Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt64UInt64Dictionary initWithUInt64s:forKeys:count:]( self,  "initWithUInt64s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64UInt64Dictionary;
  -[TransparencyGPBInt64UInt64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64UInt64Dictionary initWithDictionary:]( +[TransparencyGPBInt64UInt64Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt64UInt64Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt64UInt64Dictionary, a2);
