...
- (TransparencyGPBInt32ObjectDictionary)init
{
  return -[TransparencyGPBInt32ObjectDictionary initWithObjects:forKeys:count:]( self,  "initWithObjects:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt32ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32ObjectDictionary;
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          unsigned int v10 = *a4++;
          -[NSMutableDictionary setObject:forKey:]( v8->_dictionary,  "setObject:forKey:",  v9,  +[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", v10));
          ++a3;
          --a5;
        }
...
- (TransparencyGPBInt32ObjectDictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt32ObjectDictionary initWithObjects:forKeys:count:]( self,  "initWithObjects:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt32ObjectDictionary;
  -[TransparencyGPBInt32ObjectDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32ObjectDictionary initWithDictionary:]( +[TransparencyGPBInt32ObjectDictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt32ObjectDictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt32ObjectDictionary, a2);
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  uint64_t v5 = objc_alloc_init(&OBJC_CLASS___TransparencyGPBInt32ObjectDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      id v15 = [v13 intValue];
      int v16 = sub_100113744(v15, 1, v8);
...
- (id)objectForKey:(int)a3
{
  return -[NSMutableDictionary objectForKey:]( self->_dictionary,  "objectForKey:",  +[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", *(void *)&a3));
}
...
- (void)setObject:(id)a3 forKey:(int)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:]( self->_dictionary,  "setObject:forKey:",  a3,  +[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", v4));
  autocreator = self->_autocreator;
  if (autocreator) {
    sub_10012DFA8(autocreator, (uint64_t)self);
  }
