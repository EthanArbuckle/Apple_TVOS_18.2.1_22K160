...
- (TransparencyGPBInt64UInt32Dictionary)init
{
  return -[TransparencyGPBInt64UInt32Dictionary initWithUInt32s:forKeys:count:]( self,  "initWithUInt32s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBInt64UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64UInt32Dictionary;
...
- (TransparencyGPBInt64UInt32Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBInt64UInt32Dictionary initWithUInt32s:forKeys:count:]( self,  "initWithUInt32s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBInt64UInt32Dictionary;
  -[TransparencyGPBInt64UInt32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64UInt32Dictionary initWithDictionary:]( +[TransparencyGPBInt64UInt32Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBInt64UInt32Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBInt64UInt32Dictionary, a2);
...
- (void)enumerateKeysAndUInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))( a3,  [v6 longLongValue],  objc_msgSend( -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6),  "unsignedIntValue"),  &v7);
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_1001147A4((unint64_t)v15, 1, v8);
