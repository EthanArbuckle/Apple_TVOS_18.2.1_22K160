...
- (TransparencyGPBUInt64UInt64Dictionary)init
{
  return -[TransparencyGPBUInt64UInt64Dictionary initWithUInt64s:forKeys:count:]( self,  "initWithUInt64s:forKeys:count:",  0LL,  0LL,  0LL);
}

- (TransparencyGPBUInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64UInt64Dictionary;
...
- (TransparencyGPBUInt64UInt64Dictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBUInt64UInt64Dictionary initWithUInt64s:forKeys:count:]( self,  "initWithUInt64s:forKeys:count:",  0LL,  0LL,  0LL);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TransparencyGPBUInt64UInt64Dictionary;
  -[TransparencyGPBUInt64UInt64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt64UInt64Dictionary initWithDictionary:]( +[TransparencyGPBUInt64UInt64Dictionary allocWithZone:]( &OBJC_CLASS___TransparencyGPBUInt64UInt64Dictionary,  "allocWithZone:",  a3),  "initWithDictionary:",  self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = objc_opt_class(&OBJC_CLASS___TransparencyGPBUInt64UInt64Dictionary, a2);
