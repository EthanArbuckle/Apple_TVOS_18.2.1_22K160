...
+ (id)displayNameForHangInfo:(id)a3
{
  ...
  {
    if (qword_10005B468 != -1) {
      dispatch_once(&qword_10005B468, &stru_100048EA8);
    }
    v5 = (void *)qword_10005B470;
    ...
    id v11 = objc_alloc((Class)&OBJC_CLASS___LSApplicationRecord);
...
- (HUDContext)initWithRenderContext:(id)a3 queue:(id)a4
{
  ...
  if (v9)
  {
    ...
    v9->_accessibilityReducesTransparency = sub_100026938() ^ 1;
    ...
    -[CAFilter setValue:forKey:](v9->_blurFilter, "setValue:forKey:", &off_100050980, kCAFilterInputRadius);
    ...
    -[CAFilter setValue:forKey:](v9->_saturationFilter, "setValue:forKey:", &off_100050A10, kCAFilterInputAmount);
    ...
    LOBYTE(v34) = 0;
    v23 = -[HTHangHUDInfo initWithHangStartTime:hangEndTime:receivedTimestamp:hangDurationMS:hudString:shortenedBundle:bundleId:timedOut:]( objc_alloc(&OBJC_CLASS___HTHangHUDInfo),  "initWithHangStartTime:hangEndTime:receivedTimestamp:hangDurationMS:hudString:shortenedBundle:bundleId:timedOut:",  0LL,  0LL,  0LL,  &stru_10004A8D0,  &stru_10004A8D0,  @"com.apple.HangHUD",  10000.0,  v34);
    v24 = objc_alloc(&OBJC_CLASS___HangHUDLine);
    queue = v9->_queue;
    currentTheme = v9->_currentTheme;
    sub_100025C2C();
    v27 = -[HangHUDLine initWithQueue:processName:theme:fontSize:lineDelegate:]( v24,  "initWithQueue:processName:theme:fontSize:lineDelegate:",  queue,  &stru_10004A8D0,  currentTheme,  0LL);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG)) {
    sub_10002C364(v4, v5, v6, v7, v8, v9, v10, v11);
  }
...
- (void)clearHUDLinesAnimated:(BOOL)a3 withCompletion:(id)a4
{
  ...
  else
  {
    ...
    else
    {
      ...
      [v16 enumerateKeysAndObjectsUsingBlock:&stru_100048F60];
...
- (void)updateHUD:(id)a3 withCompletion:(id)a4
{
  ...
  id v7 = a4;
  id v8 = v6;
  uint64_t v9 = sub_1000264C8(v8, 5u);
...
- (void)determineNewFrameForRootLayer:(CGSize)a3 numberOfLines:(unint64_t)a4
{
  ...
  {
    double v15 = height + sub_100025F14();
    double v16 = width + self->_sidePadding * 2.0;
    double v17 = (sub_100025FE0() - v16) * 0.5;
    if (v9 == (void *)kCADisplayOrientationRotation270)
    {
      double x = sub_100025AD4() - v15 - y;
  ...
  double v16 = height + sub_100025F14();
  double v13 = sub_100025AD4();
  if (v9 == v10)
  {
...
- (CGSize)layoutHUDLines:(unint64_t)a3 ids:(id)a4
{
  ...
  double v13 = v37[3];
  double v14 = sub_1000260D4();
  double v15 = v33[3];
  sub_100026084();
  double v17 = v16;
  double sidePadding = self->_sidePadding;
  double v19 = sub_100025F14();
