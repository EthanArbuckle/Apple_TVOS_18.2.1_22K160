...
+ (id)lightModeTheme
{
  if (qword_10005B478 != -1) {
    dispatch_once(&qword_10005B478, &stru_100049128);
  }
  return (id)qword_10005B480;
}

+ (id)darkModeTheme
{
  if (qword_10005B488 != -1) {
    dispatch_once(&qword_10005B488, &stru_100049148);
  }
  return (id)qword_10005B490;
}
