...
- (BKDisplayBrightnessUpdateTransaction)initWithIdentifier:(id)a3 transactionManager:(id)a4
{
  ...
  id v7 = a4;
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___BKDisplayBrightnessUpdateTransaction;
  ...
  if (v8)
  {
    ...
    uint64_t v11 = objc_claimAutoreleasedReturnValue( +[BKDisplayBrightnessUpdateTransaction _sharedQueue]( &OBJC_CLASS___BKDisplayBrightnessUpdateTransaction,  "_sharedQueue"));
    queue = v8->_queue;
...
- (void)dealloc
{
  ...
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"Invalid condition not satisfying: %@",  @"_invalidated == YES"));
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___BKDisplayBrightnessUpdateTransaction;
...
- (void)_queue_setTimerWithTimeIntervalSinceNow:(double)a3
{
  ...
  {
    id v6 = -[BSAbsoluteMachTimer initWithIdentifier:]( objc_alloc(&OBJC_CLASS___BSAbsoluteMachTimer),  "initWithIdentifier:",  @"BKDisplayBrightnessUpdateTransaction");
...
- (NSString)description
{
  return (NSString *)-[BKDisplayBrightnessUpdateTransaction descriptionWithMultilinePrefix:]( self,  "descriptionWithMultilinePrefix:",  0LL);
}
...
+ (void)beginImplicitTransaction
{
  v2 = (dispatch_queue_s *)objc_claimAutoreleasedReturnValue( +[BKDisplayBrightnessUpdateTransaction _sharedQueue]( &OBJC_CLASS___BKDisplayBrightnessUpdateTransaction,  "_sharedQueue"));
  dispatch_sync(v2, &stru_1000B7578);
}
