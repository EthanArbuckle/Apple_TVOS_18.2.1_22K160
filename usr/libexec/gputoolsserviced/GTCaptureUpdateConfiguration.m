...
- (GTCaptureUpdateConfiguration)initWithCoder:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___GTCaptureUpdateConfiguration;
  v5 = -[GTCaptureRequest initWithCoder:](&v10, "initWithCoder:", v4);
  if (v5)
  {
    uint64_t v6 = objc_claimAutoreleasedReturnValue([v4 decodeObjectForKey:@"configuration"]);
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___GTCaptureUpdateConfiguration;
  id v4 = a3;
