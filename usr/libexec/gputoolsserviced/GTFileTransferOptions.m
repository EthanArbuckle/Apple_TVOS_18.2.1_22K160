...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___GTFileTransferOptions;
  result = -[GTFileTransferOptions init](&v3, "init");
  if (result) {
    *(_OWORD *)&result->_chunkSize = xmmword_100027A50;
  }
  return result;
}
...
- (GTFileTransferOptions)initWithCoder:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___GTFileTransferOptions;
