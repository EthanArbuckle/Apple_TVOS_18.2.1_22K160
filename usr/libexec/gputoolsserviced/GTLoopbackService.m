...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___GTLoopbackService;
  ...
  if (v2)
  {
    ...
    dispatch_queue_t v5 = dispatch_queue_create("com.apple.gputools.loopback", 0LL);
...
- (void)echo:(id)a3 completionHandler:(id)a4
{
  ...
  {
    int v9 = log;
    id v10 = objc_claimAutoreleasedReturnValue([v6 description]);
    int v11 = 136315138;
...
- (void)echo:(id)a3 repeat:(unint64_t)a4 callback:(id)a5 complete:(id)a6
{
  ...
  {
    unint64_t v14 = log;
    id v15 = objc_claimAutoreleasedReturnValue([v10 description]);
  ...
  id v18 = v10;
  id v19 = v11;
  dispatch_async((dispatch_queue_t)serialQueue, v20);
}
