...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___GTCaptureDescriptor;
...
- (GTCaptureDescriptor)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___GTCaptureDescriptor;
  ...
  if (v5)
  {
    ...
    uint64_t v6 = objc_claimAutoreleasedReturnValue([v4 decodeObjectForKey:@"outputURL"]);
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___GTCaptureDescriptor;
  id v3 = -[GTCaptureDescriptor description](&v7, "description");
  id v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  id v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%@\n    sessionID: %llu",  v4,  self->_sessionID));
