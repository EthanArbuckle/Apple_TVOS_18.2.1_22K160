...
{
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___NIBluetoothHostTimeSyncResponse;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return [v4 initWithDeviceEventCount:self->_deviceEventCount uwbDeviceTimeUs:self->_uwbDeviceTimeUs uwbDeviceTimeUncertainty:self->_uwbDeviceTimeUncertainty uwbClockSkewMeasurementAvailable:self->_uwbClockSkewMeasurementAvailable deviceMaxP pm:self->_deviceMaxPpm success:self->_success retryDelay:v6];
}
