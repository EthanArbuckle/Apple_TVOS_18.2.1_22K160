...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = -[ConfiguratorClientInfo init]( +[ConfiguratorClientInfo allocWithZone:](&OBJC_CLASS___ConfiguratorClientInfo, "allocWithZone:", a3),  "init");
...
- (id)description
{
  ...
  unsigned __int8 v6 = (void *)objc_claimAutoreleasedReturnValue( +[NIInternalUtils NISystemPassiveAccessIntentToString:]( &OBJC_CLASS___NIInternalUtils,  "NISystemPassiveAccessIntentToString:",  self->_passiveAccessIntent));
  unsigned __int8 v7 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"[prewarm [UWB: %d, SE channel: %d], limits exceeded [CarKey: %d, ACWG: %d], passive access intent: %@]",  prewarmUWB,  prewarmSecureElementChannel,  carKeyRangingLimitExceeded,  acwgRangingLimitExceeded,  v6));
