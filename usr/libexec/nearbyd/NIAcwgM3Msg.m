...
{
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___NIAcwgM3Msg;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return [v4 initWithSelectedRanMultiplier:self->_selectedRanMultiplier selectedNumChapsPerSlot:self->_selectedNumChapsPerSlot numResponders:self->_numResponders numSlotsPerRound:self->_numSlotsPerRound supportedSyncCodeIndexBi tmask:self->_supportedSyncCodeIndexBitmask selectedHoppingConfigBitmask:self->_selectedHoppingConfigBitmask macMode:v6];
}
