...
{
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___NIAcwgM2Msg;
...
{
  LOBYTE(v11) = a9;
  result = -[NIAcwgM2Msg initWithSelectedUwbConfigId:selectedPulseShapeCombo:selectedChannelBitmask:supportedSyncCodeIndexBitmask:minRanMultiplier:supportedSlotBitmask:supportedHoppingConfigBitmask:]( self,  "initWithSelectedUwbConfigId:selectedPulseShapeCombo:selectedChannelBitmask:supportedSyncCodeIndexBitmask:mi nRanMultiplier:supportedSlotBitmask:supportedHoppingConfigBitmask:",  a3,  a4,  a5,  *(void *)&a6,  a7,  a8,  v11);
  if (result) {
...
+ (id)fromStruct:(AcwgM2MsgStruct)a3
{
  BYTE1(v4) = a3.var7;
  LOBYTE(v4) = a3.var6;
  return  objc_msgSend( objc_alloc((Class)a1),  "initWithSelectedUwbConfigId:selectedPulseShapeCombo:selectedChannelBitmask:supportedSyncCodeIndexBitmask:mi nRanMultiplier:supportedSlotBitmask:supportedHoppingConfigBitmask:selectedFinalData2Bitmask:",  a3.var0,  a3.var1,  a3.var2,  a3.var3,  a3.var4,  a3.var5,  v4);
}
