...
- (NIServerFindingRangingProviderPeerInfo)initWithAdvertisement:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___NIServerFindingRangingProviderPeerInfo;
...
- (void)setAlgorithmAidingData:(const void *)a3
{
  ...
  __int128 v4 = *(_OWORD *)a3;
  __int128 v5 = *((_OWORD *)a3 + 2);
  if (self->_algorithmAidingData.__engaged_)
  {
    ...
    *(_OWORD *)&p_algorithmAidingData->var0.__null_state_ = v4;
    ...
    __int128 v7 = *((_OWORD *)a3 + 4);
    __int128 v8 = *((_OWORD *)a3 + 6);
...
- (optional<rose::finding::FindeeData>)getAlgorithmAidingData
{
  __int128 v3 = *(_OWORD *)&self->var0.__val_.location_data.var0.__val_.uncertainty;
  ...
  *(double *)&retstr->__engaged_ = self[1].var0.__val_.bounded_displacement.var0.__val_.enterTimestamp;
  __int128 v4 = *(_OWORD *)&self->var0.__val_.measured_velocity_change.var0.__val_.applicabilityTimestamp;
  ...
  *(optional<double> *)&retstr->var0.__val_.measured_velocity_change.__engaged_ = mach_absolute_receipt_timestamp;
  __int128 v6 = *(_OWORD *)&self->var0.__val_.measured_displacement.var0.__null_state_;
  ...
  *(_OWORD *)&retstr->var0.__val_.bounded_displacement.__engaged_ = v6;
  __int128 v7 = *(_OWORD *)&self->var0.__val_.measured_displacement.var0.__val_.displacementH2;
