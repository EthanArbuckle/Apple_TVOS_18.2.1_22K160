...
- (PRBeaconRangingService)initWithQueue:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___PRBeaconRangingService;
...
{
  id v3 = a3;
  v4 = -[PRBeaconRangingService initWithQueue:](objc_alloc(&OBJC_CLASS___PRBeaconRangingService), "initWithQueue:", v3);
...
- (BOOL)shouldAcceptNewConnection:(id)a3
{
  ...
  BOOL v7 = -[PRBeaconRangingService validateClientEntitlements:](self, "validateClientEntitlements:", v4);
  ...
  if (v7)
  {
    ...
    v9 = -[PRBeaconRangingClientProxy initWithConnection:queue:]( objc_alloc(&OBJC_CLASS___PRBeaconRangingClientProxy),  "initWithConnection:queue:",  v4,  self->_queue);
    -[NSMutableSet addObject:](self->_xpcSessions, "addObject:", v9);
    id v10 = sub_100155398();
    v11 = (void *)objc_claimAutoreleasedReturnValue(v10);
    [v4 setRemoteObjectInterface:v11];

    id v12 = sub_100155CA0();
