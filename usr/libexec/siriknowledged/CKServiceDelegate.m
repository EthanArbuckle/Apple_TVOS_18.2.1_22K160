...
{
  id v4 = a4;
  v5 = (void *)objc_claimAutoreleasedReturnValue([v4 valueForEntitlement:@"com.apple.siriknowledged"]);

  if (v5)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue( +[_TtC13CoreKnowledge21CoreKnowledgeXPCUtils CKServiceXPCInterface]( &OBJC_CLASS____TtC13CoreKnowledge21CoreKnowledgeXPCUtils,  "CKServiceXPCInterface"));
    [v4 setExportedInterface:v6];

    v7 = (void *)objc_claimAutoreleasedReturnValue(+[CKDaemon sharedDaemon](&OBJC_CLASS___CKDaemon, "sharedDaemon"));
