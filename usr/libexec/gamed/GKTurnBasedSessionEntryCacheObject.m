...
- (id)internalRepresentation
{
  ...
  if (dispatch_queue_get_specific(v4, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%s not invoked on managed object context queue at %@",  "-[GKTurnBasedSessionEntryCacheObject internalRepresentation]",  v5));
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue( +[GKTurnBasedSessionCacheObject sessionWithID:inManagedObjectContext:]( &OBJC_CLASS___GKTurnBasedSessionCacheObject,  "sessionWithID:inManagedObjectContext:",  v10,  v11));

  v13 = (void *)objc_claimAutoreleasedReturnValue([v12 internalRepresentation]);
  return v13;
}
