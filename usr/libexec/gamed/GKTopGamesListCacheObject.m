...
- (void)updateWithServerRepresentation:(id)a3 expirationDate:(id)a4
{
  ...
  if (dispatch_queue_get_specific(v9, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%s not invoked on managed object context queue at %@",  "-[GKTopGamesListCacheObject updateWithServerRepresentation:expirationDate:]",  v10));
  ...
  -[GKListCacheObject updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:]( self,  "updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:",  v15,  &stru_100271538,  1LL);
}
...
+ (Class)entryClass
{
  return (Class)objc_opt_class(&OBJC_CLASS___GKTopGamesListEntryCacheObject, a2);
}
