...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___GKAchievementDescriptionListCacheObject;
  id v6 = a3;
  ...
  -[GKListCacheObject updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:]( self,  "updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:",  v7,  &stru_100271290,  1LL);
}

- (BOOL)isValid
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___GKAchievementDescriptionListCacheObject;
