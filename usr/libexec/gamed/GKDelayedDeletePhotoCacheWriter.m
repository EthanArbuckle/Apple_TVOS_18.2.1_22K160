...
- (GKDelayedDeletePhotoCacheWriter)initWithDatabaseConnection:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___GKDelayedDeletePhotoCacheWriter;
  id v5 = -[GKDelayedDeletePhotoCacheWriter init](&v8, "init");
  v6 = v5;
  if (v5) {
...
- (id)photosInsertSQL
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"INSERT INTO delete_photos(           request_id)             VALUES (%s);",
           ":request_id");
}
...
- (id)getOldPhotosSQL
{
  return +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"            SELECT request_id             FROM requests             INNER JOIN delete_photos USING (request_id)             WHERE player_gcid = %s;",
           ":player_gcid");
}
