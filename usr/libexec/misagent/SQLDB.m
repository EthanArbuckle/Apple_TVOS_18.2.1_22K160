...
- (SQLDB)initWithDatabaseURL:(id)a3 asReadOnly:(BOOL)a4
{
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      BOOL v13 = sub_10000AA90(v9->_db, 0LL);
      db = v9->_db;
    }
...
- (void)setupPermissions
{
  ...
  sub_10000AAAC((const char *)[v2 UTF8String]);
}
...
LABEL_39:
  ...
  if (ppStmt)
  {
    ...
    if (v48)
    {
      id v49 = sub_10000758C();
      v50 = (os_log_s *)objc_claimAutoreleasedReturnValue(v49);
      if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR)) {
        sub_10000B7A4(p_db, v50);
      }

      id v51 = sub_10000758C();
...
- (id)readSetting:(id)a3
{
  ...
  id v13 = sub_1000081B0;
  int v14 = sub_1000081C0;
  id v15 = 0LL;
...
- (id)lastInsertRowID
{
  ...
  return +[NSNumber numberWithLongLong:](&OBJC_CLASS___NSNumber, "numberWithLongLong:", insert_rowid);
}
