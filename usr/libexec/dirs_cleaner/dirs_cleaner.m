uint64_t start(int a1, uint64_t a2)
{
  ...
  if (!sub_100003550(v88, 0x14u, 0LL)) {
    v99 |= 1u;
  }
  v86[0] = 5;
  if (a1 > 2)
    ...
    while (1)
    {
      ...
      if (v11)
      {
        ...
        else
        {
          ...
          if (v16 == 12)
          {
            if (*(void *)v101.f_mntonname == 0x657461766972702FLL && *(_DWORD *)&v101.f_mntonname[8] == 1918989871) {
              goto LABEL_32;
            }
          }
          ...
          {
            v17 = *(void *)v101.f_mntonname == 0x657461766972702FLL
               && *(void *)&v101.f_mntonname[8] == 0x626F6D2F7261762FLL;
            if (v17 && *(void *)&v101.f_mntonname[11] == 0x656C69626F6D2F72LL)
            {
...
LABEL_33:
      v22 = __strlcpy_chk(v85, v19, 61LL, 64LL);
      v23 = v22;
...
LABEL_80:
        ...
        v53 = pthread_mutex_init(&v91, 0LL);
        if ((_DWORD)v53)
        {
          v54 = __stderrp;
          v77 = v53;
        ...
        {
          v61 = pthread_create(&v90, 0LL, (void *(__cdecl *)(void *))sub_10000369C, v84);
          if (v61)
          {
            v62 = v61;
            v63 = __stderrp;
...
uint64_t sub_100003380(const char *a1, int a2)
{
  if (a2) {
    v2 = a1;
  }
...
BOOL sub_100003440(uint64_t a1)
{
  BOOL result = sub_100003550((__darwin_time_t *)(a1 + 1128), *(_DWORD *)(a1 + 1272), (void *)(a1 + 1112));
  if (result)
  {
...
BOOL sub_100003550(__darwin_time_t *a1, unsigned int a2, void *a3)
{
  if (gettimeofday(&v12, 0LL))
  {
    int v6 = *__error();
