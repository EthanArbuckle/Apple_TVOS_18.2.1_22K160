...
+ (id)_LoggingQueue
{
  if (qword_100070840 != -1) {
    dispatch_once(&qword_100070840, &stru_100062E20);
  }
  return (id)qword_100070848;
}
...
- (id)initForIdentity:(id)a3
{
  id v4 = a3;
  v28.receiver = self;
  v28.super_class = (Class)&OBJC_CLASS___CMSLogger;
  ...
  if (v5)
  {
    ...
    uint64_t v19 = objc_opt_new(&OBJC_CLASS___NSMutableDictionary, v18);
    metadata = v5->metadata;
    v5->metadata = (NSMutableDictionary *)v19;

    uint64_t v22 = objc_opt_new(&OBJC_CLASS___NSMutableDictionary, v21);
    ...
    v5->_id sendEvent = &stru_100062E60;
  }
...
- (void)setReportFrequency:(double)a3
{
  ...
  block[2] = sub_10003ECBC;
  block[3] = &unk_100062EB0;
...
- (id)defaultSession
{
  return -[CMSLogger createNewSessionForType:withMetadata:]( self,  "createNewSessionForType:withMetadata:",  &stru_100063F90,  &__NSDictionary0__struct);
}
...
- (void)_sumbitFromSessionType:(id)a3 withMetadata:(id)a4 withEventDurations:(id)a5 withEventOccurance:(id)a6
{
  ...
  uint64_t v15 = (void *)objc_claimAutoreleasedReturnValue( -[NSMutableDictionary objectForKeyedSubscript:]( self->performanceDataCount,  "objectForKeyedSubscript:",  v13));
  uint64_t v16 = (void *)objc_claimAutoreleasedReturnValue( +[NSMutableDictionary dictionaryWithDictionary:]( &OBJC_CLASS___NSMutableDictionary,  "dictionaryWithDictionary:",  v14));
  ...
  v20 = (void *)objc_claimAutoreleasedReturnValue([v27 objectForKeyedSubscript:@"Count"]);
  uint64_t v21 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInteger:]( NSNumber,  "numberWithUnsignedInteger:",  (char *)[v20 unsignedIntegerValue] + 1));
  ...
  uint64_t v22 = (void *)objc_claimAutoreleasedReturnValue(-[NSMutableDictionary objectForKeyedSubscript:](self->occuranceData, "objectForKeyedSubscript:", v13));
