...
- (id)initForType:(id)a3 withMetadata:(id)a4
{
  ...
  id v7 = a4;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___CMSLoggingSession;
  ...
  if (v8)
  {
    ...
    uint64_t v12 = objc_opt_new(&OBJC_CLASS___NSMutableArray, v11);
    events = v8->events;
  ...
  if ((unint64_t)-[NSMutableArray count](self->events, "count") >= 2)
  {
    ...
    else
    {
      ...
      do
      {
        ...
        v14 = (void *)objc_claimAutoreleasedReturnValue([v3 objectForKeyedSubscript:v9]);
        if (v14)
        {
          objc_super v15 = (void *)objc_claimAutoreleasedReturnValue([v4 eventType]);
