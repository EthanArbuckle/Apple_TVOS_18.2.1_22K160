...
- (BOOL)waitWithError:(id *)a3
{
  ...
  [v5 enumerateObjectsUsingBlock:&stru_100044D20];

  v6 = (void *)objc_claimAutoreleasedReturnValue(-[SKTaskExecuter tasks](self, "tasks"));
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSPredicate predicateWithBlock:](&OBJC_CLASS___NSPredicate, "predicateWithBlock:", &stru_100044D60));
  ...
  if ([v8 count])
  {
    do
    {
      [v8 enumerateObjectsUsingBlock:&stru_100044D80];
      objc_super v9 = (void *)objc_claimAutoreleasedReturnValue(-[SKTaskExecuter tasks](self, "tasks"));
      v10 = (void *)objc_claimAutoreleasedReturnValue( +[NSPredicate predicateWithBlock:]( &OBJC_CLASS___NSPredicate,  "predicateWithBlock:",  &stru_100044DA0));
  ...
  [v12 enumerateObjectsUsingBlock:&stru_100044DC0];

  v13 = (void *)objc_claimAutoreleasedReturnValue(-[SKTaskExecuter tasks](self, "tasks"));
  [v13 enumerateObjectsUsingBlock:&stru_100044DE0];

  v14 = (void *)objc_claimAutoreleasedReturnValue(-[SKTaskExecuter tasks](self, "tasks"));
  v15 = (void *)objc_claimAutoreleasedReturnValue(+[NSPredicate predicateWithBlock:](&OBJC_CLASS___NSPredicate, "predicateWithBlock:", &stru_100044E00));
