...
- (void)populateOtherStats:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass(v4, v5) & 1) != 0)
  {
    ...
    __int128 v16 = 0u;
    __int128 v17 = 0u;
    id v7 = [&off_1000BD618 countByEnumeratingWithState:&v16 objects:v20 count:16];
    if (v7)
    {
      id v8 = v7;
      id v9 = 0LL;
      ...
      do
      {
        ...
        {
          if (*(void *)v17 != v10) {
            objc_enumerationMutation(&off_1000BD618);
          }
        ...
        while (v8 != v11);
        id v8 = [&off_1000BD618 countByEnumeratingWithState:&v16 objects:v20 count:16];
      }
...
LABEL_25:
        ...
        {
          -[NSMutableDictionary setObject:forKeyedSubscript:]( v14,  "setObject:forKeyedSubscript:",  &off_1000AD180,  @"ESR_page_i");
          -[NSMutableDictionary setObject:forKeyedSubscript:]( v14,  "setObject:forKeyedSubscript:",  &off_1000AD180,  @"ESR_page_i_status");
