...
- (CDRestrictedAccesssDidFinishAuthRequest)initWithRapportDictionary:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)&OBJC_CLASS___CDRestrictedAccesssDidFinishAuthRequest;
  v5 = -[CDRestrictedAccesssDidFinishAuthRequest init](&v20, "init");
  if (v5)
  {
    v5->_approved = CFDictionaryGetInt64(v4, @"authResponse", 0LL) != 0;
...
- (id)makeRapportDictionary
{
  ...
  id v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](&OBJC_CLASS___NSNumber, "numberWithBool:", self->_approved));
