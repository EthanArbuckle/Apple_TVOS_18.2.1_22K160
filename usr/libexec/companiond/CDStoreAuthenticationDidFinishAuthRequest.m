...
- (CDStoreAuthenticationDidFinishAuthRequest)initWithRapportDictionary:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)&OBJC_CLASS___CDStoreAuthenticationDidFinishAuthRequest;
  v5 = -[CDStoreAuthenticationDidFinishAuthRequest init](&v25, "init");
  if (v5)
  {
    uint64_t v6 = objc_opt_self(&OBJC_CLASS___AMSDelegateAuthenticateResult);
    v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
    id v8 = sub_10001AD0C(v4, @"storeAuthenticationResult", (uint64_t)v7);
...
- (id)makeRapportDictionary
{
  ...
  id v4 = sub_10001AFE4((uint64_t)self->_authenticationResult);
  v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  [v3 setObject:v5 forKeyedSubscript:@"storeAuthenticationResult"];
