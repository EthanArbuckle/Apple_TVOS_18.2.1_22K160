...
- (void)takeTransaction
{
  ...
  {
    v3 = (void *)sub_10002EDE8("Process Event [%d]", self->_targetProcessId);
...
- (SPProcessEvent)init
{
  ...
  if (v2)
  {
    *(_WORD *)&v2->_useDsymForUUIDForEverything = 0;
    ...
    unsigned int v4 = byte_1000E7D44;
    v3->_shouldSymbolicate = (byte_1000E7D44 & 8) != 0;
...
- (void)dealloc
{
  ...
  if ((self->_targetProcessId & 0x80000000) == 0)
  {
    ...
    {
      int v4 = *__error();
      unint64_t v5 = (os_log_s *)sub_10002EFA0();
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG)) {
        sub_10008EC68(p_targetProcessId);
      }
      *__error() = v4;
    }
    ...
    int v7 = *__error();
    v8 = sub_10002EF3C(self->_targetProcessId);
...
LABEL_49:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT)) {
      sub_10008EBE8(p_targetProcessId);
    }
    goto LABEL_37;
  }
  ...
  {
    int v14 = *__error();
    v15 = (os_log_s *)sub_10002EFA0();
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
      sub_10008ED50((uint64_t)self, v15, v16);
    }
    *__error() = v14;
  }
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_FAULT)) {
      sub_10008ECE8((uint64_t)&self->_transaction, v26, v27, v28, v29, v30, v31, v32);
    }
LABEL_37:
    if (qword_1000E7D38) {
      v33 = (FILE *)qword_1000E7D38;
    }
    else {
      v33 = __stderrp;
    }
...
- (double)dataDuration
{
  ...
  if (dataTimeRange) {
    return sub_10005E81C( -[SATimeRange startTime](dataTimeRange, "startTime"),  -[SATimeRange endTime](self->_dataTimeRange, "endTime"));
  }
  else {
    return 0.0;
  }
...
- (double)eventDuration
{
  ...
  if (eventTimeRange) {
    return sub_10005E81C( -[SATimeRange startTime](eventTimeRange, "startTime"),  -[SATimeRange endTime](self->_eventTimeRange, "endTime"));
  }
  else {
    return 0.0;
  }
...
- (double)overlapDuration
{
  ...
  if (dataTimeRange)
  {
    ...
    return sub_10005E81C(v7, -[SATimeRange endTime](*p_eventTimeRange, "endTime"));
  }
...
- (void)_setupSampleStore:(id)a3
{
  ...
  if (!a3)
  {
    if (targetProcessId < 0)
    {
      ...
      {
        int v61 = *__error();
        v62 = (os_log_s *)sub_10002EFA0();
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR)) {
          sub_10008EF24(v62, v63, v64, v65, v66, v67, v68, v69);
        }
        *__error() = v61;
      }

      if (byte_1000E7D31) {
        BOOL v70 = dword_1000E74E0 <= 3;
      }
      else {
        BOOL v70 = 0;
      }
      if (v70)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v73, OS_LOG_TYPE_FAULT)) {
            sub_10008EEB4(v73, v74, v75, v76, v77, v78, v79, v80);
          }
          if (qword_1000E7D38) {
            v81 = (FILE *)qword_1000E7D38;
          }
          else {
            v81 = __stderrp;
          }
      ...
      sub_10002EE78( "-[SPProcessEvent _setupSampleStore:]",  "SPProcessEvent.m",  267,  "%s: nil sampleStore",  v3,  v4,  v5,  v6,  (char)"sampleStore");
    }
    ...
    else
    {
      ...
      {
        int v56 = *__error();
        v57 = sub_10002EF3C(*p_targetProcessId);
      ...
      char v91 = sub_10002EF3C(*p_targetProcessId);
      sub_10002EE78( "-[SPProcessEvent _setupSampleStore:]",  "SPProcessEvent.m",  267,  "%s [%d]: %s: nil sampleStore",  v92,  v93,  v94,  v95,  v91);
    }
  ...
  if ((targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000E7D30)
    {
      ...
      {
        v13 = sub_10002EF3C(*p_targetProcessId);
    ...
    int v16 = *__error();
    BOOL v17 = sub_10002EF3C(*p_targetProcessId);
...
- (id)_samplePrinterForSampleStore:(id)a3
{
  ...
  if (!v5)
  {
    ...
    else
    {
      ...
      int v13 = *__error();
      int v14 = sub_10002EF3C(*p_targetProcessId);
...
LABEL_3:
  ...
  -[SASamplePrinter setHeaderNote:]( v6,  "setHeaderNote:",  sub_10004CD1C((int)-[SASamplePrintOptions printHeavyStacks](self->_printOptions, "printHeavyStacks"), v7));
LABEL_19:
      ...
      if (self->_targetProcessId < 0)
      {
        ...
        if (byte_1000E7D31 && dword_1000E74E0 <= 3)
        {
          ...
          if (v22)
          {
            ...
            if (qword_1000E7D38) {
              uint64_t v32 = (FILE *)qword_1000E7D38;
            }
            else {
              uint64_t v32 = __stderrp;
            }
...
LABEL_38:
      ...
      else
      {
        ...
        {
          int v11 = *__error();
          BOOL v12 = (os_log_s *)sub_10002EFA0();
        ...
        if (byte_1000E7D31 && dword_1000E74E0 <= 3)
        {
          ...
          if (v15)
          {
            ...
            if (qword_1000E7D38) {
              uint64_t v28 = (FILE *)qword_1000E7D38;
            }
            else {
...
LABEL_50:
          ...
          uint64_t v27 = (os_log_s *)sub_10002EFA0();
...
- (BOOL)targetProcessIsThirdParty
{
  ...
  do
  {
    unsigned __int8 v6 = -[NSString hasPrefix:]( self->_targetProcessAbsolutePath,  "hasPrefix:",  *(__CFString **)((char *)&off_1000D9860 + v5));
    if ((v6 & 1) != 0) {
      break;
    }
    BOOL v7 = v5 == 40;
