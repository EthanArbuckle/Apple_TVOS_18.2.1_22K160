...
+ (id)sampleStoreForFile:(const char *)a3 stackshotsOnly:(BOOL)a4 parsePastLastStackshot:(BOOL)a5
{
  ...
  sub_1000571C4( v8,  (byte_1000E7D44 >> 3) & 1,  (byte_1000E7D44 >> 2) & 1,  (byte_1000E7D44 & 0x10) == 0);
  id v66 = v8;
  if (v6)
  {
    v32 = v67;
