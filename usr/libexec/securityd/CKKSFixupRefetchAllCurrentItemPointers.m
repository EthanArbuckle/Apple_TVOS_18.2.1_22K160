...
- (CKKSFixupRefetchAllCurrentItemPointers)initWithOperationDependencies:(id)a3 ckoperationGroup:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___CKKSFixupRefetchAllCurrentItemPointers;
  ...
  if (v9)
  {
    ...
    objc_storeStrong((id *)&v10->super._startOperation, @"fixup_fetch_tlkshares");
...
- (id)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<CKKSFixup:RefetchAllCurrentItemPointers (%@)>",  v3));
...
- (void)groupStart
{
  ...
  __int128 v15 = 0u;
  __int128 v16 = 0u;
  id v7 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSFixupRefetchAllCurrentItemPointers deps](self, "deps"));
