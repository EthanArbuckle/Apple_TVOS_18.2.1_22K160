...
- (OctagonPendingFlag)initWithFlag:(id)a3 delayInSeconds:(double)a4
{
  id v7 = a3;
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___OctagonPendingFlag;
...
- (OctagonPendingFlag)initWithFlag:(id)a3 conditions:(unint64_t)a4 delayInSeconds:(double)a5
{
  id v9 = a3;
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___OctagonPendingFlag;
  uint64_t v10 = -[OctagonPendingFlag init](&v16, "init");
  v11 = v10;
  if (v10)
  {
...
- (OctagonPendingFlag)initWithFlag:(id)a3 after:(id)a4
{
  return -[OctagonPendingFlag initWithFlag:conditions:after:](self, "initWithFlag:conditions:after:", a3, 0LL, a4);
}

- (OctagonPendingFlag)initWithFlag:(id)a3 scheduler:(id)a4
{
  return -[OctagonPendingFlag initWithFlag:conditions:scheduler:]( self,  "initWithFlag:conditions:scheduler:",  a3,  0LL,  a4);
}
...
- (OctagonPendingFlag)initWithFlag:(id)a3 conditions:(unint64_t)a4 scheduler:(id)a5
{
  ...
  [v10 trigger];
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___OctagonPendingFlag;
...
- (OctagonPendingFlag)initWithFlag:(id)a3 conditions:(unint64_t)a4 after:(id)a5
{
  ...
  id v10 = a5;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___OctagonPendingFlag;
...
- (id)description
{
  ...
  if (v3)
  {
    ...
    uint64_t v5 = objc_claimAutoreleasedReturnValue(-[OctagonPendingFlag fireTime](self, "fireTime"));
LABEL_3:
    v6 = (void *)v5;
    id v7 = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<OctagonPendingFlag: %@: %@>",  v4,  v5);
    goto LABEL_4;
  }

  id v10 = (void *)objc_claimAutoreleasedReturnValue(-[OctagonPendingFlag afterOperation](self, "afterOperation"));

  if (!v10)
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(-[OctagonPendingFlag flag](self, "flag"));
    objc_super v15 = sub_1000C8C68(-[OctagonPendingFlag conditions](self, "conditions"));
    uint64_t v5 = objc_claimAutoreleasedReturnValue(v15);
    goto LABEL_3;
  }

  unint64_t v11 = -[OctagonPendingFlag conditions](self, "conditions");
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[OctagonPendingFlag flag](self, "flag"));
  uint64_t v12 = objc_claimAutoreleasedReturnValue(-[OctagonPendingFlag afterOperation](self, "afterOperation"));
  v6 = (void *)v12;
  if (v11)
  {
    v13 = sub_1000C8C68(-[OctagonPendingFlag conditions](self, "conditions"));
    uint64_t v14 = (void *)objc_claimAutoreleasedReturnValue(v13);
    v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<OctagonPendingFlag: %@: %@ %@>",  v4,  v6,  v14));

    goto LABEL_5;
  }

  id v7 = +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"<OctagonPendingFlag: %@: %@>",  v4,  v12);
LABEL_4:
...
- (OctagonFlagString)flag
{
  return (OctagonFlagString *)objc_getProperty(self, a2, 8LL, 1);
}
...
- (CKKSNearFutureScheduler)scheduler
{
  return (CKKSNearFutureScheduler *)objc_getProperty(self, a2, 40LL, 1);
}
