...
+ (NSError)errorWithDomain:(id)a3 code:(int64_t)a4 description:(id)a5 underlying:(id)a6
{
  ...
  -[NSMutableDictionary setObject:forKeyedSubscript:]( v12,  "setObject:forKeyedSubscript:",  v10,  NSLocalizedDescriptionKey);

  -[NSMutableDictionary setObject:forKeyedSubscript:](v12, "setObject:forKeyedSubscript:", v9, NSUnderlyingErrorKey);
  v13 = (void *)objc_claimAutoreleasedReturnValue( +[NSError errorWithDomain:code:userInfo:]( &OBJC_CLASS___NSError,  "errorWithDomain:code:userInfo:",  v11,  a4,  v12));
...
- (BOOL)ckksIsCKErrorRecordChangedError
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue([v3 objectForKeyedSubscript:CKPartialErrorsByItemIDKey]);
...
- (BOOL)isCKKSServerPluginError:(int64_t)a3
{
  ...
  if ([v9 isEqualToString:CKErrorDomain])
  {
    ...
    {
      id v11 = (void *)objc_claimAutoreleasedReturnValue([v6 domain]);
...
- (BOOL)isCuttlefishError:(int64_t)a3
{
  ...
  if (v6 == (id)15)
  {
    ...
    if (v9 == (id)6000)
    {
      ...
      id v8 = (void *)objc_claimAutoreleasedReturnValue([v10 objectForKeyedSubscript:NSUnderlyingErrorKey]);
...
- (BOOL)isRetryable
{
  ...
  id v8 = (void *)objc_claimAutoreleasedReturnValue(-[NSError userInfo](self, "userInfo"));
...
LABEL_9:
      ...
      if ((_DWORD)v9)
      {
        ...
        id v12 = (void *)objc_claimAutoreleasedReturnValue([v11 objectForKeyedSubscript:@"retryafter"]);
...
- (double)retryInterval
{
  ...
  __int128 v17 = sub_100164C84;
  __int128 v18 = sub_100164C94;
  id v19 = 0LL;
  BOOL v3 = (void *)objc_claimAutoreleasedReturnValue(-[NSError domain](v2, "domain"));
