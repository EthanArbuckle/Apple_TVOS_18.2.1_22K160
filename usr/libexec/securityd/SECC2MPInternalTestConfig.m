...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___SECC2MPInternalTestConfig;
  id v3 = -[SECC2MPInternalTestConfig description](&v8, "description");
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000C91B0((uint64_t)self, (uint64_t)a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  if (value)
  {
    PBDataWriterWriteStringField(v7, value, 102LL);
    id v4 = v7;
  }
}
