...
- (TrustedPeersHelperHealthCheckResult)initWithCoder:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___TrustedPeersHelperHealthCheckResult;
  ...
  if (v5)
  {
    ...
    id v6 = [v4 decodeObjectOfClass:objc_opt_class(OTEscrowMoveRequestContext) forKey:@"moveRequest"];
...
- (id)dictionaryRepresentation
{
  ...
  id v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithBool:]( &OBJC_CLASS___NSNumber,  "numberWithBool:",  -[TrustedPeersHelperHealthCheckResult resetOctagon](self, "resetOctagon")));
  -[NSMutableDictionary setObject:forKeyedSubscript:](v3, "setObject:forKeyedSubscript:", v6, @"resetOctagon");

  uint64_t v7 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithBool:]( &OBJC_CLASS___NSNumber,  "numberWithBool:",  -[TrustedPeersHelperHealthCheckResult leaveTrust](self, "leaveTrust")));
  -[NSMutableDictionary setObject:forKeyedSubscript:](v3, "setObject:forKeyedSubscript:", v7, @"leaveTrust");

  v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithBool:]( &OBJC_CLASS___NSNumber,  "numberWithBool:",  -[TrustedPeersHelperHealthCheckResult reroll](self, "reroll")));
  ...
  if (v9)
  {
    objc_super v10 = (void *)objc_claimAutoreleasedReturnValue(-[TrustedPeersHelperHealthCheckResult moveRequest](self, "moveRequest"));
