...
- (OTLeaveCliqueOperation)initWithDependencies:(id)a3 intendedState:(id)a4 errorState:(id)a5
{
  ...
  id v11 = a5;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___OTLeaveCliqueOperation;
...
- (void)groupStart
{
  ...
  *(void *)buf = 0xAAAAAAAAAAAAAAAALL;
  ...
  id v9 = (void *)objc_claimAutoreleasedReturnValue(-[OTLeaveCliqueOperation deps](self, "deps"));
  ...
  [v8 departByDistrustingSelfWithSpecificUser:v10 reply:v11];
