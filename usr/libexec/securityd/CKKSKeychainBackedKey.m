...
- (BOOL)wrapUnder:(id)a3 error:(id *)a4
{
  ...
  {
    id v11 = sub_1000AA6AC(@"ckkskey", 0LL);
...
- (BOOL)loadKeyMaterialFromKeychain:(id *)a3
{
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (v24)
      {
        id v13 = sub_1000AA6AC(@"ckkskey", 0LL);
        ...
        if (v15)
        {
          id v16 = sub_1000AA6AC(@"ckkskey", 0LL);
    ...
    {
      id v20 = sub_1000AA6AC(@"ckkskey", 0LL);
...
+ (id)key:(id)a3 wrappedByKey:(id)a4 uuid:(id)a5 parentKeyUUID:(id)a6 keyclass:(id)a7 zoneID:(id)a8 error:(id *)a9
{
  ...
  {
    id v22 = sub_1000AA6AC(@"ckkskey", 0LL);
...
LABEL_5:
  ...
  if (!v18 || [v18 code] == (id)-25300)
  {
    ...
    if (v27)
    {
      ...
      if (!v33)
      {
        id v47 = sub_1000AA6AC(@"ckkskey", 0LL);
