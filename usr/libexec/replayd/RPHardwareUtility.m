...
+ (BOOL)isIPad
{
  v2 = (const __CFBoolean *)MGCopyAnswer(@"ipad", 0LL);
  if (v2)
  {
    v3 = v2;
...
+ (unint64_t)chipId
{
  return MGGetSInt64Answer(@"ChipID", 0LL);
}

+ (BOOL)supportsShutterSound
{
  v2 = (const __CFBoolean *)MGCopyAnswer(@"RegionalBehaviorShutterClick", 0LL);
  if (!v2) {
    return 0;
  }
  v3 = v2;
...
+ (CGSize)limitRecordingWindowSizeFromSize:(CGSize)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue([v6 objectForKey:@"RPFullResCapture"]);
  ...
  {
    int v9 = 1920;
    if (+[RPHardwareUtility isIPad](&OBJC_CLASS___RPHardwareUtility, "isIPad"))
    {
...
+ (BOOL)isCompositionAvailable
{
  return +[RPHardwareUtility isAppleSiliconMac](&OBJC_CLASS___RPHardwareUtility, "isAppleSiliconMac");
}
