...
+ (id)newInstance
{
  return objc_alloc_init(&OBJC_CLASS___RPScreenCaptureManagerIOS);
}

- (RPScreenCaptureManager)initWithDelegate:(id)a3
{
  id v5 = a3;
  v6 = +[RPScreenCaptureManager newInstance](&OBJC_CLASS___RPScreenCaptureManager, "newInstance");
  ...
  if (v6)
  {
    ...
    v6->_id screenCaptureOutputHandler = 0LL;

    id didStartScreenCaptureHandler = v6->_didStartScreenCaptureHandler;
    v6->_id didStartScreenCaptureHandler = 0LL;
