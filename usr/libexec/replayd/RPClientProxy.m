...
- (RPClientProxy)initWithConnection:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___RPClientProxy;
...
- (void)dealloc
{
  ...
  if (connection)
  {
    -[NSXPCConnection setInvalidationHandler:](connection, "setInvalidationHandler:", 0LL);
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___RPClientProxy;
...
- (void)updateScreenRecordingStateWithCurrentState:(id)a3
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_100071480));
...
- (void)recordingDidStopWithError:(id)a3 movieURL:(id)a4
{
  ...
  objc_super v8 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_1000714A0));
...
- (void)updateBroadcastServiceInfo:(id)a3
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_1000714C0));
...
- (void)updateBroadcastURL:(id)a3
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_1000714E0));
...
- (void)captureHandlerWithSample:(id)a3 timingData:(id)a4
{
  ...
  objc_super v8 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_100071500));
...
- (void)captureHandlerWithAudioSample:(id)a3 bufferType:(int64_t)a4
{
  ...
  id v7 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_100071520));
...
- (void)recordingLockInterrupted:(id)a3
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_100071540));
...
- (void)shouldResumeSessionType:(id)a3
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_100071560));
...
- (void)recordingDidPause
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_100071580));
...
- (void)recordingTimerDidUpdate:(id)a3
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue( -[NSXPCConnection remoteObjectProxyWithErrorHandler:]( self->_connection,  "remoteObjectProxyWithErrorHandler:",  &stru_1000715A0));
