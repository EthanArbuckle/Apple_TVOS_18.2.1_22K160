...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___TSDgPTPUnicastLinkLayerPtPPort;
  v4 = -[TSDgPTPFDPtPPort initWithService:pid:](&v9, "initWithService:pid:", a3, *(void *)&a4);
  v5 = v4;
  if (v4)
  {
    uint64_t v6 = objc_claimAutoreleasedReturnValue(-[TSDgPTPUnicastLinkLayerPtPPort _destinationMACAddress](v4, "_destinationMACAddress"));
...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___TSDgPTPUnicastLinkLayerPtPPort;
...
+ (id)diagnosticInfoForService:(id)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", 2LL));
