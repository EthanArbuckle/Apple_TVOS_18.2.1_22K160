...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___TSDgPTPUnicastUDPv4PtPPort;
  v4 = -[TSDgPTPFDPtPPort initWithService:pid:](&v9, "initWithService:pid:", a3, *(void *)&a4);
  v5 = v4;
  if (v4)
  {
    uint64_t v6 = objc_claimAutoreleasedReturnValue(-[TSDgPTPUnicastUDPv4PtPPort _destinationIPv4Address](v4, "_destinationIPv4Address"));
...
{
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___TSDgPTPUnicastUDPv4PtPPort;
...
+ (id)diagnosticInfoForService:(id)a3
{
  ...
  unsigned int v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](&OBJC_CLASS___NSNumber, "numberWithInt:", 3LL));
