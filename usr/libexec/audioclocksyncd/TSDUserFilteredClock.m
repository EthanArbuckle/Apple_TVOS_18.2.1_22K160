...
- (BOOL)resetFilterToNominal:(BOOL)a3 error:(id *)a4
{
  BOOL v21 = a3;
  int v8 = 0;
  unsigned __int8 v5 = (void *)objc_claimAutoreleasedReturnValue(-[TSDKernelClock connection](self, "connection"));
...
- (unint64_t)nominalMachInterval
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue([v2 iodPropertyForKey:@"NominalMachInterval"]);
...
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[TSDKernelClock service](self, "service"));
  v3 = (void *)objc_claimAutoreleasedReturnValue([v2 iodPropertyForKey:@"NominalDomainInterval"]);
...
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[TSDKernelClock service](self, "service"));
  v3 = (void *)objc_claimAutoreleasedReturnValue([v2 iodPropertyForKey:@"FilterShift"]);
...
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[TSDKernelClock service](self, "service"));
  v3 = (void *)objc_claimAutoreleasedReturnValue([v2 iodPropertyForKey:@"Adaptive"]);
