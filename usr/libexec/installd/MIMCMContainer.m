...
- (BOOL)_doInitWithContainer:(container_object_s *)a3 error:(id *)a4
{
  ...
  if (!identifier)
  {
    id v18 = sub_1000130F4( (uint64_t)"-[MIMCMContainer _doInitWithContainer:error:]",  121LL,  MIContainerManagerErrorDomain,  18LL,  0LL,  0LL,  @"Failed to get identifier for the container",  v8,  v26);
  ...
  if (!v12)
  {
    if (last_error)
    {
      ...
      if (posix_errno)
      {
        ...
        id v26 = sub_1000130C8( (uint64_t)"-[MIMCMContainer initWithSerializedContainer:matchingWithOptions:error:]",  187LL,  NSPOSIXErrorDomain,  v23,  0LL,  0LL,  @"Underlying errno set by container manager is %s",  v25,  (uint64_t)v24);
      ...
      id v42 = sub_100006150();
      v43 = (void *)objc_claimAutoreleasedReturnValue(v42);
      id v45 = sub_1000130C8( (uint64_t)"-[MIMCMContainer initWithSerializedContainer:matchingWithOptions:error:]",  187LL,  v20,  type,  v27,  v43,  @"%@",  v44,  (uint64_t)v19);
    ...
    else
    {
      ...
      id v41 = sub_1000130C8( (uint64_t)"-[MIMCMContainer initWithSerializedContainer:matchingWithOptions:error:]",  190LL,  MIContainerManagerErrorDomain,  21LL,  0LL,  0LL,  @"%s",  v39,  (uint64_t)v40);
  ...
  if (!single_result)
  {
    ...
    if (last_error)
    {
      ...
      if (v32)
      {
        uint64_t v33 = v32;
        v34 = strerror(v32);
        id v36 = sub_1000130C8( (uint64_t)"-[MIMCMContainer initWithSerializedContainer:matchingWithOptions:error:]",  204LL,  NSPOSIXErrorDomain,  v33,  0LL,  0LL,  @"Underlying errno set by container manager is %s",  v35,  (uint64_t)v34);
      ...
      id v50 = sub_100006150();
      v51 = (void *)objc_claimAutoreleasedReturnValue(v50);
      id v53 = sub_1000130C8( (uint64_t)"-[MIMCMContainer initWithSerializedContainer:matchingWithOptions:error:]",  204LL,  v30,  v31,  v37,  v51,  @"%@",  v52,  (uint64_t)v29);
    ...
    else
    {
      ...
      id v49 = sub_1000130C8( (uint64_t)"-[MIMCMContainer initWithSerializedContainer:matchingWithOptions:error:]",  206LL,  MIContainerManagerErrorDomain,  21LL,  0LL,  0LL,  @"%s",  v47,  (uint64_t)v48);
...
- (BOOL)_refreshContainerMetadataWithError:(id *)a3
{
  ...
  else
  {
    ...
    objc_super v10 = sub_100006344();
    id v11 = (void *)objc_claimAutoreleasedReturnValue(v10);
    id v13 = sub_1000130F4( (uint64_t)"_ContainerURL",  87LL,  v9,  4LL,  0LL,  0LL,  @"Failed to fetch container URL from %@",  v12,  (uint64_t)v11);
...
LABEL_6:
  ...
  if (self->_containerURL)
  {
    ...
    id v22 = sub_1000130C8( (uint64_t)"-[MIMCMContainer _refreshContainerMetadataWithError:]",  277LL,  MIContainerManagerErrorDomain,  v18,  0LL,  0LL,  @"%s",  v20,  (uint64_t)v21);
...
- (BOOL)reclaimDiskSpaceWithError:(id *)a3
{
  ...
  if (v4)
  {
    ...
    if (posix_errno)
    {
      ...
      id v13 = sub_1000130C8( (uint64_t)"-[MIMCMContainer reclaimDiskSpaceWithError:]",  298LL,  NSPOSIXErrorDomain,  v10,  0LL,  0LL,  @"Underlying errno set by container manager is %s",  v12,  (uint64_t)v11);
    ...
    id v16 = sub_100006150();
    BOOL v17 = (void *)objc_claimAutoreleasedReturnValue(v16);
    id v19 = sub_1000130C8( (uint64_t)"-[MIMCMContainer reclaimDiskSpaceWithError:]",  298LL,  v7,  type,  v14,  v17,  @"%@",  v18,  (uint64_t)v6);
...
- (BOOL)regenerateDirectoryUUIDWithError:(id *)a3
{
  ...
  id v12 = sub_1000130C8( (uint64_t)"-[MIMCMContainer regenerateDirectoryUUIDWithError:]",  321LL,  MIContainerManagerErrorDomain,  v8,  0LL,  0LL,  @"%s",  v10,  (uint64_t)v11);
...
- (unint64_t)diskUsage
{
  ...
  if (v12 != 1)
  {
    ...
    if (!qword_100095BF8 || *(int *)(qword_100095BF8 + 44) >= 3)
    {
      ...
      id v9 = sub_1000130C8( (uint64_t)"-[MIMCMContainer diskUsage]",  347LL,  MIContainerManagerErrorDomain,  v12,  0LL,  0LL,  @"%s",  v7,  (uint64_t)v8);
...
- (BOOL)purgeContentWithError:(id *)a3
{
  ...
  else
  {
    ...
    id v10 = sub_1000130F4( (uint64_t)"-[MIMCMContainer purgeContentWithError:]",  361LL,  v7,  v5,  0LL,  0LL,  @"Failed to wipe container for identifier %@",  v9,  (uint64_t)v8);
...
- (BOOL)replaceExistingContainer:(id)a3 error:(id *)a4
{
  ...
  id v17 = sub_1000130C8( (uint64_t)"-[MIMCMContainer replaceExistingContainer:error:]",  390LL,  MIContainerManagerErrorDomain,  v13,  0LL,  0LL,  @"%s",  v15,  (uint64_t)v16);
...
- (BOOL)setInfoValue:(id)a3 forKey:(id)a4 error:(id *)a5
{
  ...
  else
  {
    ...
    id v19 = sub_1000130C8( (uint64_t)"-[MIMCMContainer setInfoValue:forKey:error:]",  420LL,  MIContainerManagerErrorDomain,  v14,  0LL,  0LL,  @"%s",  v17,  (uint64_t)v18);
    id v15 = (id)objc_claimAutoreleasedReturnValue(v19);
    if (a5)
    {
      id v15 = v15;
...
- (id)infoValueForKey:(id)a3 error:(id *)a4
{
  ...
  if (v10)
  {
    ...
    id v21 = sub_1000130F4( (uint64_t)"-[MIMCMContainer infoValueForKey:error:]",  446LL,  MIInstallerErrorDomain,  4LL,  0LL,  0LL,  @"Failed to retrieve value for key %@ from the underlying xpc object",  v13,  (uint64_t)v8);
  ...
  else
  {
    ...
    id v19 = sub_1000130C8( (uint64_t)"-[MIMCMContainer infoValueForKey:error:]",  440LL,  MIContainerManagerErrorDomain,  24LL,  0LL,  0LL,  @"%s",  v17,  (uint64_t)v18);
...
- (BOOL)recreateDefaultStructureWithError:(id *)a3
{
  ...
  else
  {
    ...
    id v10 = sub_1000130C8( (uint64_t)"-[MIMCMContainer recreateDefaultStructureWithError:]",  465LL,  MIContainerManagerErrorDomain,  v5,  0LL,  0LL,  @"%s",  v8,  (uint64_t)v9);
    id v6 = (id)objc_claimAutoreleasedReturnValue(v10);
    if (a3)
    {
      id v6 = v6;
...
+ (id)_enumeratorWithContainerClass:(unint64_t)a3 forPersona:(id)a4 isTransient:(BOOL)a5 identifiers:(id)a6 groupIdentifiers:(id)a7 create:(BOOL)a8 usingBlock:(id)a9
{
  ...
  if (!v17)
  {
    id v45 = sub_1000130F4( (uint64_t)"+[MIMCMContainer _enumeratorWithContainerClass:forPersona:isTransient:identifiers:groupIdentifiers: create:usingBlock:]",  487LL,  MIContainerManagerErrorDomain,  110LL,  0LL,  0LL,  @"Failed to create container query for querying containers for identifier: %@ groupIdentifiers: %@ containerType: %llu",  v18,  (uint64_t)v15);
  ...
  if ((v34 & 1) == 0)
  {
    ...
    if (last_error)
    {
      ...
      if (posix_errno)
      {
        ...
        id v43 = sub_1000130C8( (uint64_t)"+[MIMCMContainer _enumeratorWithContainerClass:forPersona:isTransient:identifiers:groupIdentifi ers:create:usingBlock:]",  549LL,  NSPOSIXErrorDomain,  v40,  0LL,  0LL,  @"Underlying errno set by container manager is %s",  v42,  (uint64_t)v41);
      ...
      id v48 = sub_100006150();
      id v49 = (void *)objc_claimAutoreleasedReturnValue(v48);
      id v51 = sub_1000130C8( (uint64_t)"+[MIMCMContainer _enumeratorWithContainerClass:forPersona:isTransient:identifiers:groupIdentifier s:create:usingBlock:]",  549LL,  MIContainerManagerErrorDomain,  type,  v44,  v49,  @"%@",  v50,  (uint64_t)v37);
...
+ (id)_allContainersForIdentifiers:(id)a3 groupIdentifiers:(id)a4 contentClass:(unint64_t)a5 forPersona:(id)a6 transient:(BOOL)a7 create:(BOOL)a8 error:(id *)a9
{
  ...
  xpc_object_t v27 = sub_1000073C4;
  id v28 = sub_1000073D4;
...
+ (id)_containerForIdentifier:(id)a3 contentClass:(unint64_t)a4 forPersona:(id)a5 transient:(BOOL)a6 create:(BOOL)a7 error:(id *)a8
{
  ...
  if (!v19)
  {
    id v24 = sub_1000130F4( (uint64_t)"+[MIMCMContainer _containerForIdentifier:contentClass:forPersona:transient:create:error:]",  594LL,  MIContainerManagerErrorDomain,  110LL,  0LL,  0LL,  @"Failed to create container query for querying containers for identifier %@",  v20,  (uint64_t)v14);
  ...
  if (!single_result)
  {
    ...
    if (last_error)
    {
      ...
      if (posix_errno)
      {
        ...
        id v39 = sub_1000130C8( (uint64_t)"+[MIMCMContainer _containerForIdentifier:contentClass:forPersona:transient:create:error:]",  621LL,  NSPOSIXErrorDomain,  v36,  0LL,  0LL,  @"Underlying errno set by container manager is %s",  v38,  (uint64_t)v37);
      ...
      id v41 = sub_100006150();
      uint64_t v42 = (void *)objc_claimAutoreleasedReturnValue(v41);
      id v44 = sub_1000130C8( (uint64_t)"+[MIMCMContainer _containerForIdentifier:contentClass:forPersona:transient:create:error:]",  621LL,  v33,  type,  v40,  v42,  @"%@",  v43,  (uint64_t)v32);
    ...
    id v49 = sub_1000130C8( (uint64_t)"+[MIMCMContainer _containerForIdentifier:contentClass:forPersona:transient:create:error:]",  623LL,  MIContainerManagerErrorDomain,  21LL,  0LL,  0LL,  @"%s",  v47,  (uint64_t)v48);
...
+ (BOOL)deleteContainers:(id)a3 waitForDeletion:(BOOL)a4 error:(id *)a5
{
  ...
  if (!v10)
  {
    id v21 = sub_1000130F4( (uint64_t)"+[MIMCMContainer deleteContainers:waitForDeletion:error:]",  677LL,  MIInstallerErrorDomain,  4LL,  0LL,  0LL,  @"Failed to allocate memory for deleting containers",  v9,  v38);
  ...
  if (!v17)
  {
    if (v43)
    {
      ...
      if (posix_errno)
      {
        ...
        id v30 = sub_1000130C8( (uint64_t)"+[MIMCMContainer deleteContainers:waitForDeletion:error:]",  693LL,  NSPOSIXErrorDomain,  v27,  0LL,  0LL,  @"Underlying errno set by container manager is %s",  v29,  (uint64_t)v28);
      ...
      id v33 = sub_100006150();
      char v34 = (void *)objc_claimAutoreleasedReturnValue(v33);
      id v36 = sub_1000130C8( (uint64_t)"+[MIMCMContainer deleteContainers:waitForDeletion:error:]",  693LL,  v24,  type,  v31,  v34,  @"%@",  v35,  (uint64_t)v23);
...
LABEL_17:
    ...
    id v32 = sub_1000130F4( (uint64_t)"+[MIMCMContainer deleteContainers:waitForDeletion:error:]",  696LL,  MIContainerManagerErrorDomain,  38LL,  0LL,  0LL,  @"container_operation_delete_array returned NULL but did not set an error",  v18,  v38);
...
+ (id)defaultDirectoriesForContainerType:(unint64_t)a3 error:(id *)a4
{
  ...
  if (!v6)
  {
    ...
    id v15 = sub_1000130C8( (uint64_t)"+[MIMCMContainer defaultDirectoriesForContainerType:error:]",  722LL,  MIContainerManagerErrorDomain,  v19,  0LL,  0LL,  @"%s",  v13,  (uint64_t)v14);
...
LABEL_9:
  ...
  if (!v9)
  {
    id v16 = sub_1000130F4( (uint64_t)"+[MIMCMContainer defaultDirectoriesForContainerType:error:]",  728LL,  MIInstallerErrorDomain,  4LL,  0LL,  0LL,  @"Failed to retrieve container subdirectories for class %llu",  v8,  a3);
