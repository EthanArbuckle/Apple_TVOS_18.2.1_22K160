...
- (BOOL)load
{
  ...
  if (v4)
  {
    ...
    v41[0] = v5;
    v41[1] = @"/Library/Apple";
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", v41, 2LL));
  ...
  else
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR)) {
        sub_10009713C(v33, v34, v35, v36, v37, v38, v39, v40);
      }
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue( +[MSDDomainsPlistPatcher patchDomainsPlist:]( &OBJC_CLASS___MSDDomainsPlistPatcher,  "patchDomainsPlist:",  v11));
  if (v13 && (uint64_t v14 = objc_opt_class(&OBJC_CLASS___NSDictionary, v12), (objc_opt_isKindOfClass(v13, v14) & 1) != 0))
  {
    v15 = (void *)objc_claimAutoreleasedReturnValue([v13 objectForKey:@"SystemDomains"]);
    v16 = (void *)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithDictionary:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithDictionary:",  v15));
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR)) {
      sub_100097108(v23, v25, v26, v27, v28, v29, v30, v31);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR)) {
      sub_100097098((uint64_t)v11, v23);
    }
  }
...
- (id)checkManifest:(id)a3
{
  ...
  __int128 v31 = 0u;
  id v7 = v4;
  id v27 = [v7 countByEnumeratingWithState:&v28 objects:v36 count:16];
  if (!v27) {
    goto LABEL_20;
  }
  uint64_t v26 = *(void *)v29;
  p_cache = &OBJC_CLASS___MSDAppHelper.cache;
  *(void *)&__int128 v8 = 136315394LL;
  ...
  do
  {
    for (i = 0LL; i != v27; i = (char *)i + 1)
    {
      ...
      uint64_t v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "objectForKey:", v11, v24));
      ...
      uint64_t v14 = (void *)objc_claimAutoreleasedReturnValue([p_cache + 418 sharedInstance]);
      unsigned int v15 = [v14 macOS];
      ...
      v16 = (void *)objc_claimAutoreleasedReturnValue([p_cache + 418 sharedInstance]);
      if ([v16 iOS])
      {

LABEL_12:
        unsigned __int8 v19 = -[WhitelistChecker checkFile_iOS:withMetaData:](self, "checkFile_iOS:withMetaData:", v13, v12);
        goto LABEL_14;
      }

      v17 = (void *)objc_claimAutoreleasedReturnValue([p_cache + 418 sharedInstance]);
      unsigned int v18 = [v17 rOS];

      if (v18) {
        goto LABEL_12;
      }
      unsigned __int8 v19 = -[WhitelistChecker checkFile_WatchAndTV:withMetaData:](self, "checkFile_WatchAndTV:withMetaData:", v13, v12);
LABEL_14:
      id v7 = v25;
      p_cache = (void **)(&OBJC_CLASS___MSDAppHelper + 16);
      if ((v19 & 1) != 0) {
        goto LABEL_18;
      }
LABEL_15:
    ...
    && !-[WhitelistChecker annotated:](self, "annotated:", v7))
  {
    ...
    while (1)
    {
      ...
      do
      {
        ...
        uint64_t v12 = *(void **)(*((void *)&v44 + 1) + 8LL * (void)v11);
        v13 = objc_autoreleasePoolPush();
        uint64_t v14 = (void *)objc_claimAutoreleasedReturnValue(-[WhitelistChecker domains](self, "domains"));
        unsigned int v15 = (void *)objc_claimAutoreleasedReturnValue([v14 objectForKey:v12]);
        ...
        v43 = v13;
        v17 = (void *)objc_claimAutoreleasedReturnValue([v15 objectForKey:@"RelativePathsToBackupAndRestore"]);
        id v18 = [v17 mutableCopy];

        unsigned __int8 v19 = (void *)objc_claimAutoreleasedReturnValue([v15 objectForKey:@"RelativePathsToOnlyBackupEncrypted"]);
        [v18 addObjectsFromArray:v19];

        id v20 = (void *)objc_claimAutoreleasedReturnValue([v15 objectForKey:@"RelativePathsToRestoreOnly"]);
        [v18 addObjectsFromArray:v20];

        v21 = (void *)objc_claimAutoreleasedReturnValue([v15 objectForKey:@"RelativePathsToBackupToDriveAndStandardAccount"]);
...
- (BOOL)checkFile_WatchAndTV:(id)a3 withMetaData:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  __int128 v8 = (void *)objc_claimAutoreleasedReturnValue(-[WhitelistChecker domains](self, "domains"));
  v9 = (void *)objc_claimAutoreleasedReturnValue([v8 objectForKey:@"ContentRootDomain"]);
  unsigned int v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableArray arrayWithArray:](&OBJC_CLASS___NSMutableArray, "arrayWithArray:", v9));

  uint64_t v11 = (void *)objc_claimAutoreleasedReturnValue( +[NSArray arrayWithObjects:]( &OBJC_CLASS___NSArray,  "arrayWithObjects:",  @"/var/mobile/Media",  @"/var/containers/",  0LL));
...
- (BOOL)annotated:(id)a3
{
  ...
  if (v9)
  {
    if ([v9 count])
    {
      unsigned int v10 = (void *)objc_claimAutoreleasedReturnValue([v9 objectForKey:v5]);
      uint64_t v11 = -[NSString initWithData:encoding:](objc_alloc(&OBJC_CLASS___NSString), "initWithData:encoding:", v10, 4LL);
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0LL; i != v8; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = (void *)objc_claimAutoreleasedReturnValue(+[NSCharacterSet whitespaceCharacterSet](&OBJC_CLASS___NSCharacterSet, "whitespaceCharacterSet"));
        v16 = (void *)objc_claimAutoreleasedReturnValue([v14 stringByTrimmingCharactersInSet:v15]);

        if ([v16 length])
        {
          v17 = (void *)objc_claimAutoreleasedReturnValue([v21 stringByAppendingPathComponent:v16]);
          [v22 addObject:v17];
        }
    ...
    || [v7 isEqualToString:@"NSFileTypeDirectory"])
  {
    ...
    if (([v5 isEqualToString:v8] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
        sub_100097170((uint64_t)v5, (uint64_t)v8, v10);
      }
    }
  }
...
- (BOOL)shouldRestoreSystemContainer_iOS:(id)a3 shared:(BOOL)a4
{
  ...
  {
    uint64_t v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", @"file://%s", v8));
...
- (BOOL)handleSystemContainerFiles:(id)a3 withMetadata:(id)a4
{
  ...
  BOOL v9 = v8 == 0;
  if (v8) {
    unsigned int v10 = &off_100106030;
  }
  else {
    unsigned int v10 = &off_100106060;
  }
  if (v9) {
    uint64_t v11 = &off_100106048;
  }
  else {
    uint64_t v11 = &off_100106018;
  }
  __int128 v43 = 0u;
  __int128 v44 = 0u;
  __int128 v41 = 0u;
    ...
    while (2)
    {
      for (i = 0LL; i != v14; i = (char *)i + 1)
      {
        ...
        if ([v5 rangeOfString:v17] != (id)0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          id v19 = (void *)objc_claimAutoreleasedReturnValue([v5 stringByReplacingOccurrencesOfString:v17 withString:&stru_1000FB848]);
          int v20 = 1;
          goto LABEL_20;
        }
      }
  ...
  if (v21)
  {
    ...
    while (2)
    {
      for (j = 0LL; j != v22; j = (char *)j + 1)
      {
        ...
        {
          uint64_t v28 = objc_claimAutoreleasedReturnValue([v5 stringByReplacingOccurrencesOfString:v25 withString:&stru_1000FB848]);
