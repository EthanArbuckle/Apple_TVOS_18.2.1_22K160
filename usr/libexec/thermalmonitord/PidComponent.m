...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___PidComponent;
  ...
  if (v4)
  {
    if (a3)
    {
      sub_100020FE0(a3, @"kp", kCFNumberFloatType, &v4->kp);
      sub_100020FE0(a3, @"ki", kCFNumberFloatType, &v5->ki);
      sub_100020FE0(a3, @"ts", kCFNumberFloatType, &v5->ts);
      sub_100020FE0(a3, @"intMin", kCFNumberFloatType, &v5->integratorMin);
      sub_100020FE0(a3, @"intMax", kCFNumberFloatType, &v5->integratorMax);
      sub_100020FE0(a3, @"target", kCFNumberFloatType, &v5->TARGET);
      v5->engageDelta = 0.0;
      sub_100020FE0(a3, @"engageDelta", kCFNumberFloatType, &v5->engageDelta);
    }

    v5->allowCEOverride = 0;
    v5->mitigationType = -1;
    v5->nameofComponent = 0LL;
    *(void *)&v5->boundCheckLow = 0xFF00000000LL;
  }
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___PidComponent;
