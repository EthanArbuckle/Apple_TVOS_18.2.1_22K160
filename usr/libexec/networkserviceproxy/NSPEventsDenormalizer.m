...
+ (id)URLOfModelInThisBundle
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue([v3 pathForResource:@"NSPEventsDenormalizer" ofType:@"mlmodelc"]);
...
- (NSPEventsDenormalizer)initWithMLModel:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___NSPEventsDenormalizer;
...
- (NSPEventsDenormalizer)init
{
  ...
  id v5 = -[NSPEventsDenormalizer initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v4, 0LL);
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v8 = (void *)objc_claimAutoreleasedReturnValue( -[NSPEventsDenormalizer predictionFromFeatures:options:error:]( self,  "predictionFromFeatures:options:error:",  v6,  v7,  a4));
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = (void *)objc_claimAutoreleasedReturnValue(-[NSPEventsDenormalizer model](self, "model"));
  v11 = (void *)objc_claimAutoreleasedReturnValue([v10 predictionFromFeatures:v9 options:v8 error:a5]);

  if (v11)
  {
    v12 = objc_alloc(&OBJC_CLASS___NSPEventsDenormalizerOutput);
...
{
  id v6 = a3;
  id v7 = -[NSPEventsDenormalizerInput initWithDenormalizer_input:]( objc_alloc(&OBJC_CLASS___NSPEventsDenormalizerInput),  "initWithDenormalizer_input:",  v6);

  id v8 = (void *)objc_claimAutoreleasedReturnValue(-[NSPEventsDenormalizer predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4));
  return v8;
}
  ...
  if (v12)
  {
    ...
    if ((uint64_t)[v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v16 = objc_alloc(&OBJC_CLASS___NSPEventsDenormalizerOutput);
