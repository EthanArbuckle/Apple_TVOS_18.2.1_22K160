...
- (void)main
{
  ...
  uint64_t v5 = objc_opt_respondsToSelector(v4, "configurationSourceController:fetchEventsWithCompletionHandler:");
  if ((v5 & 1) != 0)
  {
    ...
    v8[3] = &unk_10009E760;
    v8[4] = self;
    [v4 configurationSourceController:v3 fetchEventsWithCompletionHandler:v8];
  }
  ...
  else
  {
    ...
    -[DMDConfigurationSourceEventsOperation endOperationWithResultObject:](self, "endOperationWithResultObject:", 0LL);
  }
}
