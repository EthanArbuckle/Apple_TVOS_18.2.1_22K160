...
- (CEMImageInstallOperation)initWithImageDeclaration:(id)a3 resolver:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___CEMImageInstallOperation;
...
- (void)main
{
  id v3 = (id)objc_claimAutoreleasedReturnValue(-[CEMImageInstallOperation resolver](self, "resolver"));
  [v3 resolveAssetWithContext:self];
}

- (NSString)assetIdentifier
{
  id v3 = (void *)objc_claimAutoreleasedReturnValue(-[CEMImageInstallOperation imageDeclaration](self, "imageDeclaration"));
...
- (void)assetResolutionDidSucceedWithAssetURL:(id)a3
{
  ...
  if (-[CEMImageInstallOperation isExecuting](self, "isExecuting"))
  {
    if (v4)
    {
      v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSFileManager dmd_userImageDatabaseDirectoryURL]( &OBJC_CLASS___NSFileManager,  "dmd_userImageDatabaseDirectoryURL"));
      ...
      if ((v7 & 1) != 0)
      {
        ...
        if ((v11 & 1) != 0)
        {
          v15 = objc_opt_new(&OBJC_CLASS___CEMImageAssetInstallMetadata);
