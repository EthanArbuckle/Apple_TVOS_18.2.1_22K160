...
+ (id)whitelistedClassesForRequest
{
  return +[NSSet setWithObject:]( &OBJC_CLASS___NSSet,  "setWithObject:",  objc_opt_class(&OBJC_CLASS___DMFSetAppVPNUUIDRequest));
}

+ (id)requiredEntitlements
{
  return &off_1000A5BE0;
}
...
- (void)runWithRequest:(id)a3 bundleIdentifier:(id)a4
{
  ...
  if (v10)
  {
    ...
    -[DMDSetAppVPNUUIDOperation endOperationWithResultObject:](self, "endOperationWithResultObject:", 0LL);
  }
