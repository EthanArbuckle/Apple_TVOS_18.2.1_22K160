...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___AppleHPMUserClient;
...
- (int)createUserClientForService:(unsigned int)a3
{
  ...
  int result = +[IOKitUtilities uint32ForRegistryEntry:andKey:outValue:]( &OBJC_CLASS___IOKitUtilities,  "uint32ForRegistryEntry:andKey:outValue:",  -[AppleHPMUserClient service](self, "service"),  @"RID",  &v14);
  if (!result)
  {
    *(void *)theScore = 0LL;
    if (!+[IOKitUtilities uint64ForRegistryEntry:andKey:outValue:]( &OBJC_CLASS___IOKitUtilities,  "uint64ForRegistryEntry:andKey:outValue:",  -[AppleHPMUserClient service](self, "service"),  @"Route String",  theScore)) {
      -[AppleHPMUserClient setRouteString:](self, "setRouteString:", *(void *)theScore);
    }
    -[AppleHPMUserClient setRouterID:](self, "setRouterID:", v14);
    io_service_t v5 = -[AppleHPMUserClient service](self, "service");
    v6 = CFUUIDGetConstantUUIDWithBytes( 0LL,  0x12u,  0xA1u,  0xDCu,  0xCFu,  0xCFu,  0x7Au,  0x47u,  0x75u,  0xBEu,  0xE5u,  0x9Cu,  0x43u,  0x19u,  0xF4u,  0xCDu,  0x2Bu);
    ...
    if (!result)
    {
      ...
      v10 = CFUUIDGetConstantUUIDWithBytes( 0LL,  0xC1u,  0x3Au,  0xCDu,  0xD9u,  0x20u,  0x9Eu,  0x4Bu,  1u,  0xB7u,  0xBEu,  0xE0u,  0x5Cu,  0xD8u,  0x83u,  0xC7u,  0xB1u);
