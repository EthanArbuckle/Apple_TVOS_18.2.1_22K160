...
+ (id)supportedContentTypes
{
  ...
  if (a1 == (id)objc_opt_class())
  {
    ...
    id v6 = (id)[MEMORY[0x189603F18] arrayWithObjects:v7 count:3];
  }
...
- (int)role
{
  ...
  if (!location[0])
  {
    ...
    v8 = v3;
    uint64_t v7 = v9;
    id v6 = &v3[-((v9 + 15) & 0xFFFFFFFFFFFFFFF0LL)];
...
- (id)parent
{
  ...
  v19 = &v31;
  io_iterator_t v31 = 0;
  if (MEMORY[0x186E34AE0](-[LPMedia ioMedia](self, "ioMedia"), "IOService", 3LL, &v31))
  {
    uint64_t v30 = _os_log_pack_size();
    v29 = v6;
    uint64_t v28 = v30;
    v27 = (char *)v6 - ((v30 + 15) & 0xFFFFFFFFFFFFFFF0LL);
  ...
  else
  {
    ...
    while (1)
    {
      io_registry_entry_t v25 = IOIteratorNext(v31);
      int v16 = 0;
      if (v25) {
        int v16 = v24 ^ 1;
      }
      ...
      if (IOObjectConformsTo(v25, "IOMedia"))
      {
        ...
        if (CFProperty)
        {
          ...
          if (v15 == CFStringGetTypeID())
          {
            ...
            uint64_t v14 = [v13 countByEnumeratingWithState:v20 objects:v35 count:16];
            if (v14)
            {
              ...
              while (1)
              {
                ...
                {
                  uint64_t v10 = v17;
                  uint64_t v11 = [v13 countByEnumeratingWithState:v20 objects:v35 count:16];
                  if (!v11) {
                    break;
                  }
                }
...
- (id)container
{
  ...
  uint64_t v9 = &v19;
  io_iterator_t v19 = 0;
  if (MEMORY[0x186E34AE0](-[LPMedia ioMedia](self, "ioMedia"), "IOService", 1LL, &v19))
  {
    uint64_t v18 = _os_log_pack_size();
    uint64_t v17 = &v5;
    uint64_t v16 = v18;
    CFTypeID v15 = (char *)&v5 - ((v18 + 15) & 0xFFFFFFFFFFFFFFF0LL);
