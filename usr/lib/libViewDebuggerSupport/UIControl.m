...
+ (id)fallback_debugHierarchyObjectsInGroupWithID:(id)a3 onObject:(id)a4 outOptions:(id *)a5
{
  ...
  if ([a3 isEqualToString:@"com.apple.UIKit.UIView"])
  {
    ...
    v11 = @"visibility";
    v12 = &off_4F000;
    id v9 = objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary, "dictionaryWithObjects:forKeys:count:", &v12, &v11, 1LL));
    *a5 = v9;
  }
...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  v10[5] = v7;
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", v10, 6LL));
