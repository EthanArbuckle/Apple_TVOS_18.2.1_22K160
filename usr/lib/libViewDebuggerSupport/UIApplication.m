...
+ (id)fallback_debugHierarchyGroupingIDs
{
  v3 = @"com.apple.UIKit.UIApplication";
...
+ (id)fallback_debugHierarchyObjectsInGroupWithID:(id)a3 outOptions:(id *)a4
{
  uint64_t v4 = objc_claimAutoreleasedReturnValue(+[UIApplication sharedApplication](&OBJC_CLASS___UIApplication, "sharedApplication"));
  v5 = (void *)v4;
  if (v4)
  {
    uint64_t v8 = v4;
