...
id __31__GTFuture_timeoutAfter_label___block_invoke(uint64_t a1)
{
  ...
  if (!v3) {
    return objc_msgSend( *(id *)(a1 + 32),  "_setResult:error:notify_NOLOCK:",  0,  +[GTError_tools_diagnostics errorWithDomain:code:userInfo:]( GTError_tools_diagnostics,  "errorWithDomain:code:userInfo:",  @"DYErrorDomain",  5,  0),  1);
  }
  return result;
}
