...
uint64_t fRestoreUARPSendMessage(uint64_t a1, uint64_t a2, unsigned __int16 *a3, uint64_t a4)
{
  ...
  uarpNtohs(a3[1]);
  uarpNtohs(a3[2]);
  CoreUARPRestoreLogDebug( *(void *)(a1 + 1928),  1LL,  "UARP Restore: UARP TX: Buffer = %p, Payload Length = %u, Type = 0x%04x, Total Length = %u, ID = %u",  v7,  v8,  v9,  v10,  v11,  (char)a3);
...
uint64_t CoreUARPRestoreEndpointOfferSuperBinary(uint64_t a1, const char *a2)
{
  ...
  *((void *)v10 + 2) = v11;
  ...
  fseek(v11, 0LL, 2);
  *((_DWORD *)v10 + 77) = MEMORY[0x1895E9418](*((void *)v10 + 2));
...
{
  CoreUARPRestoreLogDebug( *(void *)(a1 + 1928),  1LL,  "UARP Restore: UARP RX: Buffer = %p, Payload Length = %u, Type = 0x%04x, Total Length = %u, ID = %u",  v6,  v7,  v8,  v9,  v10,  (char)a2);
  ...
  if (!v10)
  {
    *a4 = 0LL;
    if (a5)
    {
      ...
      char v16 = (const __CFString *)*MEMORY[0x189604F58];
      CFIndex v17 = 6LL;
LABEL_7:
      CFErrorRef v18 = CFErrorCreate(v15, v16, v17, 0LL);
      uint64_t v14 = 0LL;
      goto LABEL_8;
    }
...
LABEL_30:
  ...
  if ([v9 isEqualToString:@"queryTags"])
  {
    ...
    v25[1] = v12;
    uint64_t v13 = [MEMORY[0x189603F68] dictionaryWithObjects:v25 forKeys:v24 count:2];
...
LABEL_4:
  ...
  if (![v9 isEqualToString:@"queryInfo"])
  {
    if ([v9 isEqualToString:@"generateMeasurements"])
    {
      ...
      {
        [v10 personalizationRequests];
        uint64_t v21 = (void *)objc_claimAutoreleasedReturnValue();

        if (v21)
        {
          if (a4) {
            *a4 = CFDictionaryCreateCopy( (CFAllocatorRef)*MEMORY[0x189604DB0],  (CFDictionaryRef)[v10 personalizationRequests]);
          }
        }
        ...
        else
        {
          *a4 = 0LL;
          if (a5) {
            *a5 = CFErrorCreate((CFAllocatorRef)*MEMORY[0x189604DB0], (CFErrorDomain)*MEMORY[0x189604F58], 94LL, 0LL);
          }
        }
    ...
    else if ([v9 isEqualToString:@"performNextStage"])
    {
      if ([v10 offerPersonalizationDataWithDictionary:a3])
      {
        ...
        CFErrorRef v18 = CFErrorCreate((CFAllocatorRef)*MEMORY[0x189604DB0], (CFErrorDomain)*MEMORY[0x189604F58], 100LL, 0LL);
LABEL_8:
        *a5 = v18;
        goto LABEL_31;
      }
...
uint64_t CoreUARPRestorePersonalizationTssResponse( uint64_t a1, uint64_t a2, int a3, CFDictionaryRef theDict, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  if (theDict)
  {
    ...
    *(void *)(v10 + 64) = v13;
    ...
    uint64_t v15 = *(void (**)(void, void, void))(a1 + 48);
    if (v15) {
  ...
  else
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        int v7 = 136315138;
        uint64_t v8 = a3;
        _os_log_impl(&dword_18951B000, v6, OS_LOG_TYPE_INFO, "%s", (uint8_t *)&v7, 0xCu);
      }
    }
  }
...
void UARPSoCUpdaterLayer4UARPPropertyUpdate(uint64_t a1, uint64_t a2)
{
  ...
  objc_msgSend(v3, "verboseLog:", @"%s (%d)", "void UARPSoCUpdaterLayer4UARPPropertyUpdate(void *, uint32_t)", a2);
}
...
void UARPSoCUpdaterLayer4ApplePropertyUpdate(uint64_t a1, uint64_t a2)
{
  ...
  objc_msgSend( v4,  "verboseLog:",  @"%s (%d)",  "void UARPSoCUpdaterLayer4ApplePropertyUpdate(void *, uint32_t)",  a2);
...
void UARPSoCUpdaterLayer4PropertiesComplete(uint64_t a1)
{
  ...
  objc_msgSend(v1, "verboseLog:", @"%s", "void UARPSoCUpdaterLayer4PropertiesComplete(void *)");
...
void UARPSoCUpdaterStagingComplete(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  objc_msgSend(v5, "verboseLog:", @"%s", "void UARPSoCUpdaterStagingComplete(void *, uint32_t, uint32_t)");
...
void UARPSoCUpdaterApplyComplete(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  [v5 log];
  int v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend( v4,  "log:",  @"%s Update Finished For Unit (LUN:%d,RouterID:%hhu)",  "void UARPSoCUpdaterApplyComplete(void *, uint32_t, uint32_t)",  objc_msgSend(v5, "logicUnitNumber"),  objc_msgSend(v5, "routerID"));
...
void UARPSoCUpdaterFirmwareTssRequest(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  ...
  objc_msgSend( v10,  "verboseLog:",  @"%s",  "void UARPSoCUpdaterFirmwareTssRequest(void *, void *, void *, char *, UARPBool)");
  ...
  if (a5)
  {
    [v13 log];
    uint64_t v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend( v12,  "log:",  @"%s: More tss request for next round.",  "void UARPSoCUpdaterFirmwareTssRequest(void *, void *, void *, char *, UARPBool)");
  }
}
...
void UARPSoCUpdaterFirmwareLogCommon(uint64_t a1, unsigned int a2, uint64_t a3)
{
  ...
  objc_msgSend(v5, "log:", @"[%s:%s] %s", "com.apple.uarp.layer3.soc", uarpLoggingCategoryToString(a2), a3);
}

Ace3UpdateController *Ace3UpdaterCreate(uint64_t a1, uint64_t a2, uint64_t a3)
{
  return -[UARPSoCUpdaterController initWithOptions:logFunction:logContext:]( objc_alloc(&OBJC_CLASS___Ace3UpdateController),  "initWithOptions:logFunction:logContext:",  a1,  a2,  a3);
}
...
void uarpPlatformCleanupAssetsForRemoteEndpoint(uint64_t a1, uint64_t a2, int a3)
{
  if (*(_BYTE *)(a1 + 580) != 1)
  {
    ...
    for (*(void *)(a1 + 568) = 0LL; v4; *(void *)(a1 + 568) = v7)
    {
      while (1)
      {
        uint64_t v7 = v4;
...
LABEL_176:
    ...
    case 0xAu:
      ...
      *(_WORD *)(v69 + 8) = uarpHtons((unsigned __int16)v129);
      uint64_t v70 = a1;
      uint64_t v71 = a2;
...
const char *uarpProcessingStatusToString(int a1)
{
    ...
    return (&off_18A3BEE08)[(__int16)(a1 - 1)];
  }
}
...
void uarpPrintDataResponseDetails( uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4, int a5, int a6, int a7)
{
  ...
  if (v12)
  {
    ...
    uint64_t v14 = *(int *)(a1 + 552);
      ...
      uint64_t v15 = (&off_18A3BEE78)[v14];
    }
  ...
  if (v20)
  {
    uint64_t v21 = *(int *)(a1 + 552);
      ...
      uint64_t v22 = (&off_18A3BEE78)[v21];
    }
    if (*(_BYTE *)(a3 + 80) == 1) {
      uint64_t v25 = "YES";
    }
  ...
  else
  {
    uint64_t v23 = *(int *)(a1 + 552);
      ...
      uint64_t v24 = (&off_18A3BEE78)[v23];
    }
    if (*(_BYTE *)(a3 + 80) == 1) {
      int v26 = "YES";
    }
...
void uarpLogInfo(unsigned int a1, char *__format, ...)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315138;
    ...
    _os_log_impl(&dword_18951B000, v3, OS_LOG_TYPE_INFO, "%s\n", buf, 0xCu);
  }
...
void uarpPlatformDarwinLogInfo( uint64_t a1, unsigned int a2, const char *a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315138;
    ...
    _os_log_impl(&dword_18951B000, v10, OS_LOG_TYPE_INFO, "%s\n", buf, 0xCu);
  }
...
uint64_t UARPSuperBinaryPrepareDynamicAsset(int a1, char *a2, uint64_t a3, uint64_t a4, int a5)
{
  ...
  *(_OWORD *)(a2 + 28) = xmmword_18953CC60;
  *((_DWORD *)a2 + 12) = a5;
  *((_DWORD *)a2 + 112) = 0;
  *((void *)a2 + 79) = 0LL;
  *((void *)a2 + 90) = 0LL;
...
uint64_t simulationBackendCreate(uint64_t *a1)
{
  ...
  *(_OWORD *)(v2 + 24) = xmmword_18953CC80;
  uint64_t v3 = *a1;
  *(_DWORD *)(v3 + 40) = 1;
  *(_BYTE *)(v3 + 44) = 0;
  return 0LL;
...
uint64_t personalizationBackendFlash(uint64_t a1, uint64_t a2, unsigned int a3, __int128 *a4)
{
  if (inRestore && (logLevel & 2) != 0) {
  ...
  uint64_t result = DynamicAssetCreate(&v17);
  if (!(_DWORD)result)
  {
    uarpZero(v13, 0xE0uLL);
    __int128 v14 = DynamicAssetUARPGetBytes;
    __int16 v15 = DynamicAssetUARPSetBytes;
    __int128 v16 = fAssetProcessingNotification2_0;
    unsigned int v12 = 1297238342;
    uarpPlatformEndpointPrepareDynamicAsset(v8, v8 + 1080, v17, &v12, (uint64_t)v13);
    uint64_t result = uarpPersonalizationRequestAssetInitialize(v8, v17, 1);
    if (!(_DWORD)result)
    {
      ...
      if (!(_DWORD)result)
      {
        uint64_t result = uarpPersonalizationRequestAddRemoteAssetID(v8, v17, v11);
        if (!(_DWORD)result)
        {
          uint64_t result = UARPSuperBinaryPreparePayload(v8, v17, 0, &v12, a4);
          if (!(_DWORD)result)
          {
            uint64_t result = UARPSuperBinaryAddPayloadMetaData(v8, v17, 0, 0xCCD28111, 4u, (uint64_t)&v12);
            if (!(_DWORD)result)
            {
              uint64_t result = UARPSuperBinaryAddPayloadDataLarge(v8, v17, 0, a2, a3);
              if (!(_DWORD)result)
              {
                uint64_t result = UARPSuperBinaryFinalizeHeader(v8, v17);
                if (!(_DWORD)result)
                {
                  if (inRestore && (logLevel & 2) != 0) {
                  ...
                  uint64_t result = uarpPlatformEndpointOfferAsset(v8, v8 + 1080, v17);
                  if (!(_DWORD)result) {
                    *(_BYTE *)(a1 + 48) = 1;
                  }
                }
...
uint64_t BackendCreate(void *a1, unsigned __int8 *a2, uint64_t a3)
{
  ...
  uint8x8_t v7 = v6;
  uint64_t v8 = (const char *)*((void *)a2 + 3);
  if (!v8)
  {
...
LABEL_3:
  ...
  *a1 = v7;
  return v10;
    ...
    {
      IOObjectRelease(existing);
      uint64_t v3 = num_updatable_aces;
    }

    uint64_t result = &unk_18C79F000;
    if (v3 >= 2)
    {
      for (uint64_t i = 1LL; i != v3; ++i)
      {
        uint64_t v6 = 0LL;
        uint8x8_t v7 = lun_to_rid_lookup[0];
        do
        {
          uint64_t v8 = lun_to_rid_lookup[v6 + 1];
          if (v7 <= v8)
          {
            uint8x8_t v7 = lun_to_rid_lookup[v6 + 1];
          }
...
uint64_t getAHPMAddressForRID(char a1, void *a2)
{
  ...
  uint64_t v3 = IOServiceMatching("AppleHPMDeviceHALType3");
  uint64_t v4 = (const __CFAllocator *)*MEMORY[0x189604DB0];
  CFNumberRef v5 = CFNumberCreate((CFAllocatorRef)*MEMORY[0x189604DB0], kCFNumberSInt8Type, &valuePtr);
  add_property_match(v3, @"RID", v5);
  existing = 0;
  MatchingServices = IOServiceGetMatchingServices(*MEMORY[0x1896086B0], v3, &existing);
  if (MatchingServices)
  {
    CFProperty = 3758097136LL;
    if (inRestore) {
...
CFDictionaryRef add_property_match(const __CFDictionary *a1, const void *a2, const void *a3)
{
  ...
  if (v6)
  {
    Value = (const __CFDictionary *)CFDictionaryGetValue(a1, @"IOPropertyMatch");
    MutableCopy = CFDictionaryCreateMutableCopy(v7, 2LL, Value);
  }

  else
  {
    MutableCopy = CFDictionaryCreateMutable( (CFAllocatorRef)*MEMORY[0x189604DB0],  1LL,  MEMORY[0x189605240],  MEMORY[0x189605250]);
  }
...
uint64_t getAHPMLibInterfaceForRID(int a1, void *a2)
{
  ...
  uint64_t v3 = IOServiceMatching("AppleHPMARM");
  CFNumberRef v4 = CFNumberCreate((CFAllocatorRef)*MEMORY[0x189604DB0], kCFNumberSInt8Type, &valuePtr);
  ...
  else if (existing)
  {
    ...
    if (v7)
    {
      ...
      do
      {
        int v9 = CFUUIDGetConstantUUIDWithBytes( 0LL,  0x12u,  0xA1u,  0xDCu,  0xCFu,  0xCFu,  0x7Au,  0x47u,  0x75u,  0xBEu,  0xE5u,  0x9Cu,  0x43u,  0x19u,  0xF4u,  0xCDu,  0x2Bu);
        BOOL v10 = CFUUIDGetConstantUUIDWithBytes( 0LL,  0xC2u,  0x44u,  0xE8u,  0x58u,  0x10u,  0x9Cu,  0x11u,  0xD4u,  0x91u,  0xD4u,  0,  0x50u,  0xE4u,  0xC6u,  0x42u,  0x6Fu);
        if (!IOCreatePlugInInterfaceForService(v8, v9, v10, &theInterface, &theScore))
        {
          unint64_t v11 = theInterface;
          QueryInterface = (*theInterface)->QueryInterface;
          __int128 v13 = CFUUIDGetConstantUUIDWithBytes( 0LL,  0xC1u,  0x3Au,  0xCDu,  0xD9u,  0x20u,  0x9Eu,  0x4Bu,  1u,  0xB7u,  0xBEu,  0xE0u,  0x5Cu,  0xD8u,  0x83u,  0xC7u,  0xB1u);
...
uint64_t destroyAHPMLibInterface(uint64_t *a1)
{
  ...
  uint64_t result = (*(uint64_t (**)(uint64_t))(*(void *)v2 + 24LL))(v2);
  *a1 = 0LL;
  return result;
}
...
{
  uint64_t v1 = 1000LL * a1;
  if ((v1 & 0xFFFFFFFF00000000LL) != 0) {
    return 3758097090LL;
  }
  usleep(v1);
  return 0LL;
...
void *lookup_updatable_aces()
{
  ...
  uint64_t result = (void *)IOServiceGetMatchingServices(*MEMORY[0x1896086B0], edt_matching_dict, &existing);
  if (!(_DWORD)result)
  {
...
uint64_t get_tag_for_rid(int a1, int *a2)
{
  ...
  edt_matching_dict = get_edt_matching_dict();
  *(_DWORD *)bytes = a1;
  CFDataRef v5 = CFDataCreate((CFAllocatorRef)*MEMORY[0x189604DB0], bytes, 4LL);
  add_property_match(edt_matching_dict, @"rid", v5);
  io_iterator_t existing = 0;
  MatchingServices = IOServiceGetMatchingServices(*MEMORY[0x1896086B0], edt_matching_dict, &existing);
  if (MatchingServices)
  {
    unsigned int v7 = 3758097136LL;
    if (inRestore) {
...
{
  CFMutableDictionaryRef Mutable = CFArrayCreateMutable(0LL, 2LL, MEMORY[0x189605228]);
  CFArrayAppendValue(Mutable, @"usbc,sn201202x,spmi");
  CFArrayAppendValue(Mutable, @"usbc,sn201202x,iic");
  uint64_t v1 = CFDictionaryCreateMutable(0LL, 1LL, MEMORY[0x189605240], MEMORY[0x189605250]);
...
uint64_t get_u32_from_edt_prop(io_registry_entry_t a1, const __CFString *a2, UInt8 *a3)
{
  ...
  CFProperty = (const __CFData *)IORegistryEntryCreateCFProperty(a1, a2, (CFAllocatorRef)*MEMORY[0x189604DB0], 0);
  if (!CFProperty) {
    return 3758097136LL;
  }
...
uint64_t set_nvram_variable(const char *a1, const UInt8 *a2, CFIndex a3)
{
  ...
  io_registry_entry_t v7 = IORegistryEntryFromPath(*MEMORY[0x1896086B0], "IODeviceTree:/options");
  if (!v7) {
    return 3758097136LL;
  }
  io_registry_entry_t v8 = v7;
  io_registry_entry_t v9 = (const __CFAllocator *)*MEMORY[0x189604DB0];
  CFStringRef v10 = CFStringCreateWithCString((CFAllocatorRef)*MEMORY[0x189604DB0], a1, 0x600u);
  if (v10)
  {
    unint64_t v11 = v10;
    CFDataRef v12 = CFDataCreateWithBytesNoCopy(v9, a2, a3, (CFAllocatorRef)*MEMORY[0x189604DC8]);
    if (v12)
    {
      CFDataRef v13 = v12;
...
uint64_t get_number_of_uart_hpms(int a1, uint64_t a2, unsigned int a3, _BYTE *a4)
{
  ...
  *(_DWORD *)bytes = a1;
  ...
  CFDataRef v11 = CFDataCreate((CFAllocatorRef)*MEMORY[0x189604DB0], bytes, 4LL);
  add_property_match(edt_matching_dict, @"rid", v11);
  io_service_t MatchingService = IOServiceGetMatchingService(*MEMORY[0x1896086B0], edt_matching_dict);
  if (MatchingService)
  {
    CFProperty = (const __CFData *)IORegistryEntryCreateCFProperty(MatchingService, @"uart-hpm-rids", v10, 0);
    if (CFProperty)
    {
      unsigned int v14 = CFProperty;
...
uint64_t get_retimer_service(int a1, _DWORD *a2)
{
  *a2 = 0;
  edt_matching_dict = get_edt_matching_dict();
  *(_DWORD *)bytes = a1;
  CFDataRef v5 = (const __CFAllocator *)*MEMORY[0x189604DB0];
  CFDataRef v6 = CFDataCreate((CFAllocatorRef)*MEMORY[0x189604DB0], bytes, 4LL);
  add_property_match(edt_matching_dict, @"rid", v6);
  mach_port_t v7 = *MEMORY[0x1896086B0];
  io_service_t MatchingService = IOServiceGetMatchingService(*MEMORY[0x1896086B0], edt_matching_dict);
  if (MatchingService)
  {
    ...
    else if (v19 == 2)
    {
      ...
      *(_DWORD *)__int128 v21 = v18;
      CFDataRef v12 = IOServiceMatching("AppleARMIICDevice");
      CFMutableDictionaryRef Mutable = CFDictionaryCreateMutable(v5, 1LL, MEMORY[0x189605240], MEMORY[0x189605250]);
      CFDataRef v14 = CFDataCreate(v5, v21, 4LL);
      if (v14)
      {
        CFDataRef v15 = v14;
...
uint64_t get_retimer_nor_access(io_service_t a1, unsigned int a2)
{
  ...
  uint64_t v3 = IOServiceOpen(a1, *MEMORY[0x1895FBBE0], 0, &connect);
  if ((_DWORD)v3
    || (input = a2, outputCnt = 0, uint64_t v3 = IOConnectCallScalarMethod(connect, 3u, &input, 1u, 0LL, &outputCnt), (_DWORD)v3))
  {
    if (inRestore) {
...
{
  v25[2] = *MEMORY[0x1895F89C0];
  uint64_t result = DynamicAssetCreate(&v15);
  if (!(_DWORD)result)
  {
    uarpZero(v9, 0xE0uLL);
    CFStringRef v10 = DynamicAssetUARPGetBytes;
    uint64_t v11 = DynamicAssetUARPSetBytes;
    CFDataRef v12 = DynamicAssetUARPReleased;
    CFDataRef v13 = fAssetProcessingNotification2_1;
    CFDataRef v14 = fAssetProcessingNotificationAck_0;
    CFDataRef v5 = uarpAssetTagStructPersonalization();
    uarpPlatformEndpointPrepareDynamicAsset(a1, a1 + 1080, v15, v5, (uint64_t)v9);
    uint64_t v6 = v15;
    int v24 = 0;
    uint64_t result = uarpPersonalizationRequestAssetInitialize(a1, v15, 1);
    if (!(_DWORD)result)
    {
      unsigned __int16 v23 = 0;
      uint64_t result = uarpPlatformAssetQueryAssetID(*(void *)a2, &v23);
      if (!(_DWORD)result)
      {
        uint64_t result = uarpPersonalizationRequestAddRemoteAssetID(a1, v6, v23);
        if (!(_DWORD)result)
        {
              ...
              if (!(_DWORD)result)
              {
                ...
                if (!(_DWORD)result)
                {
                  ...
                  if (!(_DWORD)result)
                  {
                    ...
                    if (v22)
                    {
                      uint64_t result = uarpPersonalizationRequestAddLogicalUnitNumber(a1, v6, 0, v22);
                      if (!(_DWORD)result)
                      {
                        unsigned int v21 = 0;
                        ...
                        if (!(_DWORD)result)
                        {
                          uint64_t result = uarpPersonalizationRequestAddChipID(a1, v6, 0, v21);
                          if (!(_DWORD)result)
                          {
                            unint64_t v20 = 0LL;
                            uint64_t result = BackendGetPersParam(*(void **)(a1 + 1384));
                            if (!(_DWORD)result)
                            {
                              uint64_t result = uarpPersonalizationRequestAddBoardID64(a1, v6, 0, v20);
                              if (!(_DWORD)result)
                              {
                                unint64_t v19 = 0LL;
                                uint64_t result = BackendGetPersParam(*(void **)(a1 + 1384));
                                if (!(_DWORD)result)
                                {
                                  uint64_t result = uarpPersonalizationRequestAddECID(a1, v6, 0, v19);
                                  if (!(_DWORD)result)
                                  {
                                    ...
                                    if (!(_DWORD)result)
                                    {
                                      uint64_t result = uarpPersonalizationRequestAddSecurityDomain(a1, v6, 0, v18);
                                      if (!(_DWORD)result)
                                      {
                                        ...
                                        if (!(_DWORD)result)
                                        {
                                          uint64_t result = uarpPersonalizationRequestAddProductionMode(a1, v6, 0, v17);
                                          if (!(_DWORD)result)
                                          {
                                            ...
                                            if (!(_DWORD)result)
                                            {
                                              uint64_t result = uarpPersonalizationRequestAddSecurityMode(a1, v6, 0, v16);
                                              if (!(_DWORD)result)
                                              {
                                                v25[0] = 0LL;
                                                v25[1] = 0LL;
                                                ...
                                                if (!(_DWORD)result)
                                                {
                                                  uint64_t result = uarpPersonalizationRequestAddNonceHash( a1,  v6,  0,  (uint64_t)v25,  0x10u);
                                                  if (!(_DWORD)result)
                                                  {
                                                    ...
                                                    if (!(_DWORD)result)
                                                    {
                                                      ...
                                                      if (!(_DWORD)result)
                                                      {
                                                        ...
                                                        if (!(_DWORD)result)
                                                        {
                                                          ...
                                                          return uarpPlatformEndpointOfferAsset(a1, a1 + 1080, v15);
                                                        }
                                                      }
                                                    }
                                                  }
...
uint64_t DynamicAssetSetBytesAtOffset(unsigned int *a1, const void *a2, unsigned int a3, unsigned int a4)
{
  ...
  if (v11 + v4 <= v12)
  {
    unsigned __int8 v16 = (char *)*((void *)a1 + 1);
    goto LABEL_15;
  }
  ...
  uint64_t v15 = (char *)uarpZalloc(v14);
  if (v15)
  {
...
LABEL_7:
  unsigned __int8 v16 = (uint64_t *)uarpZalloc(0x70uLL);
  *a1 = v16;
  if (!v16) {
    return 11LL;
  }
  ...
  *((_BYTE *)v21 + 102) = v14;
  ...
  int v30 = 0;
  uint64_t v23 = (*(uint64_t (**)(uint64_t, void, void, int *, uint64_t, void, _BYTE *))(*(void *)**a1 + 40LL))( **a1,  0LL,  0LL,  &v30,  4LL,  0LL,  v29);
  if ((_DWORD)v23) {
    goto LABEL_30;
  }
  if (v30 != 40)
  ...
  uint64_t v23 = (*(uint64_t (**)(uint64_t, void, uint64_t, int *, uint64_t, void, _BYTE *))(*(void *)**a1 + 40LL))( **a1,  0LL,  1LL,  &v30,  4LL,  0LL,  v29);
  if ((_DWORD)v23) {
    goto LABEL_30;
  }
...
LABEL_34:
  ...
  *((_BYTE *)v24 + 104) = a5;
  if (a5)
  {
    ...
    int v36 = 1094993493;
    LOWORD(v27) = 0;
    uint64_t v23 = (*(uint64_t (**)(uint64_t, uint64_t, int *, char *, void, void, void, uint64_t, int, uint64_t, void, _DWORD))(*(void *)v25 + 104LL))( v25,  1LL,  &v36,  &v28,  0LL,  0LL,  0LL,  1LL,  v27,  10LL,  0LL,  0);
    if ((_DWORD)v23 || (uint64_t v23 = wait_for_mode(**a1, 1094993493, 0, 1), (_DWORD)v23))
    {
LABEL_30:
      uint64_t v18 = v23;
LABEL_35:
...
LABEL_7:
  ...
  uint64_t v6 = (*(uint64_t (**)(uint64_t, void, uint64_t, void))(*(void *)v5 + 128LL))(v5, v14, a2, 0LL);
  if ((_DWORD)v6)
  {
  ...
  uint64_t v11 = (*(uint64_t (**)(uint64_t, void, uint64_t, void))(*(void *)v10 + 120LL))(v10, v15, 1LL, 0LL);
  ...
  if ((_DWORD)v11)
  {
    ...
    (*(void (**)(uint64_t, void, void, void))(*(void *)v10 + 120LL))(v10, v15, 0LL, 0LL);
    if (inRestore) {
...
LABEL_23:
          ...
          uint64_t result = get_pers_params((void *)a1);
          if (!(_DWORD)result)
          {
            *(_BYTE *)(a1 + 16) = 1;
LABEL_27:
...
uint64_t get_pers_params(void *a1)
{
  ...
  uint64_t v2 = (*(uint64_t (**)(void))(*(void *)*a1 + 40LL))();
  if ((_DWORD)v2) {
    goto LABEL_47;
  }
  if (v21 == 48)
  {
    *(_DWORD *)((char *)a1 + 26) = *(_DWORD *)v26;
    uint64_t v3 = 32LL;
    a1[4] = *(void *)&v26[4];
    uint64_t v4 = 24LL;
    uint64_t v5 = 23LL;
  ...
  else
  {
    ...
    *((_WORD *)a1 + 13) = *(_WORD *)v26;
    *((_BYTE *)a1 + 28) = v26[2];
    a1[4] = 0LL;
    uint64_t v3 = 31LL;
    *((_DWORD *)a1 + 8) = *(_DWORD *)&v26[3];
    uint64_t v4 = 23LL;
    uint64_t v5 = 22LL;
    uint64_t v6 = 21LL;
    uint64_t v7 = 19LL;
  ...
  *((_BYTE *)a1 + 49) = (v8 & 2) != 0;
  *((_BYTE *)a1 + 48) = (v8 & 4) != 0;
  unsigned int v9 = v26[v6];
  *((_BYTE *)a1 + 51) = v9 & 7;
  *((_BYTE *)a1 + 50) = (v9 >> 4) & 7;
  uint64_t v10 = *(void *)&v26[v4];
  *((_BYTE *)a1 + 24) = v26[v5];
  a1[5] = v10;
  *(_OWORD *)((char *)a1 + 52) = *(_OWORD *)&v26[v3];
  *((_DWORD *)a1 + 17) = apBoardForAceBoard(a1[4]);
  *((_DWORD *)a1 + 18) = apChipForAceBoard(a1[4]);
  if (*((_BYTE *)a1 + 85))
  {
    if (inRestore) {
      puts("verify_only set; avoiding unnecessary SFWi calls");
    }
    else {
      uarpLogError(3u, "verify_only set; avoiding unnecessary SFWi calls\n");
    }
LABEL_25:
    uint64_t mode = 0LL;
    goto LABEL_28;
  ...
  uint64_t v2 = handle_shared_spi(a1, 1LL);
  if ((_DWORD)v2)
  {
LABEL_47:
    uint64_t mode = v2;
  ...
  int v20 = 0;
  uint64_t mode = get_mode(*a1, &v20);
  if (inRestore)
  {
    printf("HPM mode=0x%X\n", v20);
    if (!(_DWORD)mode) {
      goto LABEL_21;
    }
  }
...
LABEL_21:
      ...
      {
        if (inRestore) {
          puts("HPM in ADFU, yet boot-nonce found to be all 0s, blocking SFWi attempt");
        }
        else {
          uarpLogError(3u, "HPM in ADFU, yet boot-nonce found to be all 0s, blocking SFWi attempt\n");
        }
        goto LABEL_28;
      }
      ...
      int v22 = 1397118825;
      LOWORD(v18) = 64;
      int v15 = (*(uint64_t (**)(uint64_t, uint64_t, int *, int *, void, _OWORD *, void, uint64_t, int, uint64_t, void, _DWORD))(*(void *)v14 + 104LL))( v14,  1LL,  &v22,  &v19,  0LL,  v23,  0LL,  4LL,  v18,  10LL,  0LL,  0);
      int v16 = check_task_result(v23[0], 0x53465769u);
      if (v15 | v16)
      {
        if (inRestore) {
          printf("WARNING: SFWi failed status=0x%X, task_result=0x%X\n", v15, v16);
        }
        else {
          uarpLogError(3u, "WARNING: SFWi failed status=0x%X, task_result=0x%X\n", v15, v16);
        }
      }

      uint64_t v2 = (*(uint64_t (**)(void, void, uint64_t, _BYTE *, uint64_t, void, uint64_t *))(*(void *)*a1 + 40LL))( *a1,  0LL,  44LL,  v26,  48LL,  0LL,  &v21);
      if (!(_DWORD)v2)
      {
        if (v21 == 48)
        {
          uint64_t mode = 0LL;
          __int128 v17 = *(_OWORD *)&v27[1];
          goto LABEL_43;
        }
        ...
        {
          uint64_t mode = 0LL;
          __int128 v17 = *(_OWORD *)v27;
LABEL_43:
          *(_OWORD *)((char *)a1 + 52) = v17;
          goto LABEL_28;
        }

        if (inRestore) {
          printf("ERROR: Unexpected second read length for register 0x2c: 0x%llx\n");
        }
        else {
          uarpLogError(3u, "ERROR: Unexpected second read length for register 0x2c: 0x%llx\n");
        }
LABEL_27:
        uint64_t mode = 39LL;
        goto LABEL_28;
  ...
  if (inRestore) {
    printf("get_mode failed in get pers param status=0x%x\n", mode);
  }
  else {
    uarpLogError(3u, "get_mode failed in get pers param status=0x%x\n");
  }
LABEL_28:
  handle_shared_spi(a1, 0LL);
  return mode;
}
...
uint64_t internalBackendFlash(void *a1, uint64_t a2, uint64_t a3, unsigned int *a4)
{
  ...
  if (v33 == 1112493908)
  {
    ...
    unsigned int v9 = "Ace in boot mode: Can't be updated!";
    goto LABEL_12;
  }
  ...
  if (v33 != 1094993493)
  {
    if (a4)
    {
      ...
      if ((*(unsigned int (**)(void, void, uint64_t, int *, uint64_t, void, uint64_t *))(*(void *)*a1 + 40LL))( *a1,  0LL,  45LL,  &v37,  4LL,  0LL,  &v34))
      {
        if (inRestore) {
      ...
      else if (v34 == 4)
      {
        ...
        {
          if ((*(unsigned int (**)(void, void, uint64_t, unsigned int *, uint64_t, void, uint64_t *))(*(void *)*a1 + 40LL))( *a1,  0LL,  15LL,  &v35,  6LL,  0LL,  &v34))
          {
            if (inRestore) {
...
LABEL_64:
      ...
      int v18 = set_nvram_variable(__str, (const UInt8 *)&v34, 6LL);
      if (v18)
      {
        if (inRestore) {
...
LABEL_70:
      ...
      for (unint64_t i = 0LL; i < v38; ++i)
      {
        ...
        else if (*(void *)__str)
        {
          ...
          else if (v37 == 1094993493)
          {
            ...
            LOWORD(v32) = 0;
            (*(void (**)(void, uint64_t, unsigned int *, void, void, void, void, void, uint64_t, uint64_t, void, _DWORD))(**(void **)__str + 104LL))( *(void *)__str,  1LL,  &v35,  0LL,  0LL,  0LL,  0LL,  0LL,  v32,  10LL,  0LL,  0);
            if (inRestore && (logLevel & 2) != 0) {
  ...
  if (v8 == 4)
  {
    ...
    uint64_t v4 = 3758097129LL;
    unsigned int v9 = "HPM in ADFU in OTA stage2";
    goto LABEL_12;
  }
  ...
  if (*((_DWORD *)a1 + 27) == 3)
  {
    ...
    unsigned int v9 = "HPM in ADFU in OTA Stage 1";
LABEL_12:
    puts(v9);
    return v4;
  }
  ...
  LODWORD(v34) = 0;
  *(void *)__str = 0LL;
  uint64_t v4 = (*(uint64_t (**)(void, void, uint64_t, uint64_t *, uint64_t, void, char *))(*(void *)*a1 + 40LL))( *a1,  0LL,  45LL,  &v34,  4LL,  0LL,  __str);
  if (!(_DWORD)v4)
  {
    if ((BYTE1(v34) & 7) != 1)
    {
...
{
  unint64_t v4 = 0LL;
  uint64_t result = (*(uint64_t (**)(uint64_t, void, uint64_t, unsigned int *, uint64_t, void, unint64_t *))(*(void *)a1 + 40LL))( a1,  0LL,  3LL,  &v5,  4LL,  0LL,  &v4);
  if (!(_DWORD)result)
  {
    if (v4 < 4)
    {
...
int flash(void)
{
  ...
  int v10 = handle_shared_spi((uint64_t *)v3, 1LL);
  if (v10) {
    goto LABEL_67;
  }
LABEL_21:
  ...
  unsigned int v30 = v4;
  LOWORD(v25) = 64;
  int v10 = (*(uint64_t (**)(uint64_t, uint64_t, unsigned int *, __int128 *, void, _OWORD *, void, uint64_t, int, uint64_t, void, _DWORD))(*(void *)v11 + 104LL))( v11,  1LL,  &v30,  &v32,  0LL,  v31,  0LL,  64LL,  v25,  10LL,  0LL,  0);
  if (v10) {
    goto LABEL_67;
  }
  ...
  if ((v7 & 1) != 0 || v12 != 4)
  {
    ...
    if (v8)
    {
      ...
      while (1)
      {
        ...
        unsigned int v30 = v5;
        LOWORD(v27) = 64;
        int v21 = (*(uint64_t (**)(uint64_t, uint64_t, unsigned int *, __int128 *, void, _OWORD *, void, uint64_t, int, uint64_t, void, _DWORD))(*(void *)v20 + 104LL))( v20,  1LL,  &v30,  &v32,  0LL,  v31,  0LL,  64LL,  v27,  10LL,  0LL,  0);
        if (v21) {
          break;
        }
      ...
      int v9 = v21;
LABEL_65:
      handle_shared_spi((uint64_t *)v3, 0LL);
      if (v9 != -536870167) {
        return v9;
      }
      goto LABEL_60;
...
LABEL_53:
    ...
    LOWORD(v26) = 64;
    int v10 = (*(uint64_t (**)(uint64_t, uint64_t, unsigned int *, void, void, _OWORD *, void, void, int, uint64_t, void, _DWORD))(*(void *)v23 + 104LL))( v23,  1LL,  &v30,  0LL,  0LL,  v31,  0LL,  0LL,  v26,  10LL,  0LL,  0);
    if (!v10)
    {
...
uint64_t internalBackendGetActiveVersion(void *a1, _DWORD *a2, _WORD *a3)
{
  ...
  if (a1 && a2 && a3)
  {
    uint64_t v7 = 0LL;
    v8[0] = 0LL;
    uint64_t result = (*(uint64_t (**)(void, void, uint64_t, void *, uint64_t, void, uint64_t *))(*(void *)*a1 + 40LL))( *a1,  0LL,  15LL,  v8,  8LL,  0LL,  &v7);
    if (v7 == 8)
    {
      *a2 = v8[0];
      *a3 = WORD2(v8[0]);
...
uint64_t internalBackendApply(void *a1, _WORD *a2)
{
  ...
  if (a1 && a2)
  {
    int v5 = (*(uint64_t (**)(void, uint64_t, int *, void, void, void, void, void, _WORD, uint64_t, void, uint64_t))(*(void *)*a1 + 104LL))( *a1,  1LL,  &v6,  0LL,  0LL,  0LL,  0LL,  0LL,  0,  10LL,  0LL,  0x4741494400000000LL);
    if (v5)
    {
      if (inRestore) {
...
void print_fw_update_regs(uint64_t a1)
{
  ...
  if (v2)
  {
    uint64_t v3 = v2;
    uint64_t v5 = 0LL;
    (*(void (**)(uint64_t, void, uint64_t, unsigned __int8 *, uint64_t, void, uint64_t *))(*(void *)a1 + 40LL))( a1,  0LL,  45LL,  v2,  52LL,  0LL,  &v5);
    if (inRestore) {
      puts("otpBuf:");
    }
    else {
...
uint64_t USBCUpdateInfoUnsupported(int a1, int a2, _BYTE *a3, unsigned int a4, int *a5)
{
  ...
  generic_copyout(0LL, a3, v10, a5);
  return 0LL;
}

uint64_t externalBackendCreate(void *a1, const char *a2, uint64_t a3, char a4)
{
  ...
  *((_BYTE *)v9 + 43) = v21;
  ...
  v9[4] = 16LL;
  uint64_t result = parse_serial_string_buffer(a2, "NONC", v12, 16LL);
  if ((_DWORD)result) {
    return result;
  }
...
uint64_t externalBackendFlash(uint64_t a1, uint64_t a2, unsigned int a3, __int128 *a4)
{
  uint64_t v8 = *(void *)(a1 + 64);
  unsigned int v9 = *(uint64_t **)(v8 + 1368);
  uint64_t result = DynamicAssetCreate(&v18);
  if (!(_DWORD)result)
  {
    uarpZero(v14, 0xE0uLL);
    unint64_t v15 = DynamicAssetUARPGetBytes;
    char v16 = DynamicAssetUARPSetBytes;
    uint64_t v17 = fAssetProcessingNotification2_2;
    int v13 = 1297238342;
    uarpPlatformEndpointPrepareDynamicAsset(v8, v8 + 1080, v18, &v13, (uint64_t)v14);
    uint64_t result = uarpPersonalizationRequestAssetInitialize(v8, v18, 1);
    if (!(_DWORD)result)
    {
      unsigned __int16 v12 = 0;
      ...
      if (!(_DWORD)result)
      {
        uint64_t result = uarpPersonalizationRequestAddRemoteAssetID(v8, v18, v12);
        if (!(_DWORD)result)
        {
          unsigned int v11 = 1297238342;
          uint64_t result = UARPSuperBinaryPreparePayload(v8, v18, 0, &v11, a4);
          if (!(_DWORD)result)
          {
            uint64_t result = UARPSuperBinaryAddPayloadMetaData(v8, v18, 0, 0xCCD28111, 4u, (uint64_t)&v11);
            if (!(_DWORD)result)
            {
              uint64_t result = UARPSuperBinaryAddPayloadDataLarge(v8, v18, 0, a2, a3);
              if (!(_DWORD)result)
              {
                uint64_t result = UARPSuperBinaryFinalizeHeader(v8, v18);
                if (!(_DWORD)result)
                {
                  uint64_t result = uarpPlatformEndpointOfferAsset(v8, v8 + 1080, v18);
                  if (!(_DWORD)result) {
                    *(_BYTE *)(a1 + 72) = 1;
                  }
                }
        ...
        if (a4)
        {
          ...
          if (v9)
          {
            ...
            *(_OWORD *)((char *)v9 + 1320) = v11;
            ...
            unint64_t v15 = fSendMessage;
            int v19 = fSuperBinaryOffered;
            char v20 = fDynamicAssetOffered;
            unint64_t v21 = fApplyStagedAssets;
            ...
            *((void *)v9 + 113) = USBCUpdateRequiresPersonalization;
            if (uarpPlatformEndpointInit( (char *)v9,  (uint64_t)v9,  0,  (__int128 *)&v49,  v14,  (uint64_t)(v9 + 38),  (uint64_t)uarpPlatformEndpointCallbackAppleSpecific)
              || uarpPlatformRemoteEndpointAdd(v4, v4 + 1080, (__int128 *)&v49, v4)
              || (*a4 = _sendMsgToAccessory,
                  a4[1] = (uint64_t (*)(uint64_t, uint64_t, unsigned __int16 *, unsigned int))_USBCUpdateFinalize,
                  BackendCreate((void *)(v4 + 1384), (unsigned __int8 *)(v4 + 1288), v4)))
            {
              uarpFree((void *)v4);
              return 0LL;
            }
        ...
        *(void *)uint64_t v5 = a3;
        ...
        if (!(_DWORD)result)
        {
          *(_WORD *)(v5 + 32) = 0;
          ...
          memset(&v20[8], 0, 40);
          memset(&v19[8], 0, 48);
          *(void *)unint64_t v15 = fAssetReady_0;
          __int128 v17 = fPayloadData_0;
          *(void *)int v19 = fPayloadDataComplete2_0;
          *(void *)char v20 = fAssetAllHeadersAndMetaDataComplete_0;
          *(void *)&v19[56] = fAssetReleased2_0;
          *(void *)&v19[72] = fAssetProcessingNotificationAck_1;
          __int128 v7 = *(_OWORD *)&v15[32];
          *(_OWORD *)(v4 + 1472) = *(_OWORD *)v19;
          *(_OWORD *)(v4 + 1456) = (unint64_t)fPayloadData_0;
          *(_OWORD *)(v4 + 1440) = 0uLL;
          *(_OWORD *)(v4 + 1424) = v7;
          __int128 v8 = *(_OWORD *)v15;
          *(_OWORD *)(v4 + 1408) = *(_OWORD *)&v15[16];
          *(_OWORD *)(v4 + 1392) = v8;
          __int128 v9 = *(_OWORD *)&v19[16];
          __int128 v10 = *(_OWORD *)&v19[32];
          __int128 v11 = *(_OWORD *)&v19[48];
          *(_OWORD *)(v4 + 1536) = *(_OWORD *)&v19[64];
          *(_OWORD *)(v4 + 1520) = v11;
          *(_OWORD *)(v4 + 1504) = v10;
          *(_OWORD *)(v4 + 1488) = v9;
          __int128 v12 = *(_OWORD *)&v19[80];
          __int128 v13 = *(_OWORD *)v20;
          __int128 v14 = *(_OWORD *)&v20[16];
...
uint64_t fDynamicAssetOffered(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  if (uarpAssetTagCompare((unsigned __int8 *)v5, (unsigned __int8 *)(a3 + 48)))
  {
    *(void *)(a1 + 1376) = a3;
    uarpZero(v7, 0xE0uLL);
    *(void *)&v7[0] = IM4MReady;
    __int128 v8 = IM4MData;
    uint64_t v10 = 0LL;
    uint64_t v11 = 0LL;
    __int128 v12 = IM4MReleased;
    __int128 v14 = IM4MHeadersAndMetadataComplete;
    __int128 v13 = fAssetProcessingNotificationAck_1;
    __int128 v9 = IM4MDataComplete;
  ...
  else
  {
    ...
    return uarpPlatformEndpointAssetDeny(a1, a1 + 1080, a3, 3072, a3, 0LL);
  }
...
{
  int v4 = __n;
  if (!FWImageAddBytes(*(void *)(*(void *)(a1 + 1368) + 24LL), a3, __n))
  {
    if (inRestore && (logLevel & 2) != 0) {
...
uint64_t fAssetReady_0(uint64_t result, uint64_t a2)
{
  ...
  {
    uint64_t v3 = result;
    if ((BackendGetFlags(*(void **)(result + 1384)) & 1) != 0)
    {
      return uarpPlatformEndpointAssetFullyStaged(v3, *(void *)a2);
    }
    ...
    else
    {
      ...
      if ((_DWORD)result) {
        return uarpPlatformEndpointAssetAbandon(v3, v3 + 1080, *(void *)a2, 2304);
      }
    }
  }
...
LABEL_26:
    uarpPlatformEndpointAssetAbandon((uint64_t)a1, (uint64_t)a1 + 1080, *(void *)a2, 2304);
    return;
  }
...
LABEL_108:
  ...
  while (1)
  {
    unsigned int PersParam = uarpAssetQueryPayloadInfo(v5, *v4, v14, (uint64_t)&v68);
    if (PersParam) {
      goto LABEL_141;
    }
    unsigned int v15 = uarpTagStructPack32((unsigned int *)&v68);
          ...
          *((_WORD *)v4 + 7) = v46;
          if (v54 != 0xFFFF)
          {
            *((_WORD *)v4 + 8) = v54;
            ...
            unsigned int NumberOfPayloads = FWImageSetComponentSize((uint32x4_t *)v4[3], 0, v65);
            if (NumberOfPayloads) {
              goto LABEL_152;
            }
            *(_OWORD *)((char *)v4 + 52) = v64;
            int v62 = 0;
            unsigned int NumberOfPayloads = uarpVersionToAceVersion((unsigned int *)&v64, (unsigned int *)&v62, 0LL);
            if (NumberOfPayloads) {
              goto LABEL_152;
            }
            ...
            unsigned __int32 v49 = v65;
            *((_DWORD *)v4 + 16) = v64 | (BYTE4(v64) << 8);
            ...
            if (!*(_BYTE *)(v5 + 1298))
            {
              ...
              if (!NumberOfPayloads)
              {
                ...
                {
                  if (inRestore && (*(_BYTE *)(v8 + 1160) & 2) != 0) {
...
LABEL_152:
            ...
            if (v50)
            {
              ...
              if (!NumberOfPayloads)
              {
                unsigned int NumberOfPayloads = aceVersionToUARPVersion(v72, (unsigned __int16)v71, &v68);
                if (!NumberOfPayloads)
                {
                  if (inRestore && (*(_BYTE *)(v8 + 1160) & 2) != 0) {
                    printf( "validate_same_version: io_iterator_t existing = %d.%d.%d.%d, new = %d.%d.%d.%d\n",  v68,  HIDWORD(v68),  v69,  HIDWORD(v69),  *((_DWORD *)v4 + 13),  *((_DWORD *)v4 + 14),  *((_DWORD *)v4 + 15),  *((_DWORD *)v4 + 16));
                  }
                  else {
                    uarpLogInfo( 3u,  "validate_same_version: io_iterator_t existing = %d.%d.%d.%d, new = %d.%d.%d.%d\n",  v68,  HIDWORD(v68),  v69,  HIDWORD(v69),  *((_DWORD *)v4 + 13),  *((_DWORD *)v4 + 14),  *((_DWORD *)v4 + 15),  *((_DWORD *)v4 + 16));
                  }
                  if (uarpVersionCompare(&v68, (_DWORD *)v4 + 13))
                  {
                    unsigned int v3 = 24;
                    goto LABEL_110;
                  }
  ...
  if (!PersParam)
  {
    while (1)
    {
      ...
      if (*(_DWORD *)v17 == -2001563376)
      {
        ...
        __int128 v43 = uarpZalloc(*(unsigned int *)(v17 + 4));
        v4[5] = (uint64_t)v43;
        if (!v43)
        {
          unsigned int v3 = 11;
      ...
      else if (v22 == -2001563355)
      {
        ...
        __int128 v40 = *(unsigned int **)(v17 + 8);
        if (!v40) {
          goto LABEL_108;
        }
      ...
      else if (v22 == -2001563364)
      {
        ...
        if (v23 >= 9)
        {
          ...
          do
          {
            ...
            __int128 v33 = (unsigned int *)(v27 + 8);
            switch(v29)
            {
              case -2001563361:
                if (v31 != 9) {
...
LABEL_111:
  int v47 = inRestore;
  __int128 v48 = uarpStatusCodeToString(v3);
  if (v47) {
...
uint64_t IM4MHeadersAndMetadataComplete(void *a1, uint64_t a2, uint64_t a3)
{
  ...
  if (!(_DWORD)result && v8 == 1)
  {
    ...
    if (!(_DWORD)result)
    {
      FWImageSetComponentSize(*(uint32x4_t **)(a1[171] + 24LL), 2u, DWORD2(v7));
      FWImageSetActiveComponent(*(void *)(a1[171] + 24LL), 2);
...
uint64_t parse_serial_string_u64(const char *a1, const char *a2, unint64_t *a3)
{
  uint64_t result = 30LL;
  if (a1)
  {
    if (a2)
    {
      if (a3)
      {
        uint64_t v9 = 0LL;
        unint64_t v10 = 0LL;
        uint64_t result = parse_serial_string(a1, a2, (unsigned __int8 *)&v10, 8LL, &v9);
        if (!(_DWORD)result)
        {
          switch(v9)
          {
...
uint64_t parse_serial_string(const char *a1, const char *a2, unsigned __int8 *a3, uint64_t a4, uint64_t *a5)
{
  int v8 = strstr(a1, a2);
  if (!v8)
  {
...
uint64_t parse_serial_string_buffer(const char *a1, const char *a2, unsigned __int8 *a3, uint64_t a4)
{
  uint64_t result = 30LL;
  if (a1 && a2)
  {
...
uint64_t apBoardForAceBoard(uint64_t a1)
{
  ...
  {
    unint64_t v2 = -1LL;
    unsigned int v3 = &qword_18953CCF0;
    while (v2 != 6)
    {
      uint64_t v4 = *v3;
      v3 += 2;
...
uint64_t apChipForAceBoard(uint64_t a1)
{
  ...
  {
    unint64_t v2 = 0LL;
    unsigned int v3 = &qword_18953CD70;
    do
    {
      unint64_t v4 = v2;
      if (v2 == 3) {
...
void UarpRestoreLayer3LogError_cold_1(uint64_t a1, os_log_s *a2)
{
  ...
  int v2 = 136315138;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_18951B000, a2, OS_LOG_TYPE_ERROR, "%s", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void UarpRestoreLayer3LogDebug_cold_1(uint64_t a1, os_log_s *a2)
{
  ...
  int v2 = 136315138;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_18951B000, a2, OS_LOG_TYPE_DEBUG, "%s", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void UarpRestoreLayer3LogFault_cold_1(uint64_t a1, os_log_s *a2)
{
  ...
  int v2 = 136315138;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_18951B000, a2, OS_LOG_TYPE_FAULT, "%s", (uint8_t *)&v2, 0xCu);
  OUTLINED_FUNCTION_0();
}
...
void uarpPlatformDarwinLogFault_cold_1(os_log_t log)
{
  ...
  _os_log_fault_impl(&dword_18951B000, log, OS_LOG_TYPE_FAULT, "%s\n", (uint8_t *)&v1, 0xCu);
  OUTLINED_FUNCTION_0();
}
