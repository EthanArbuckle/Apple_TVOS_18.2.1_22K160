...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationSuperBinaryAssetID;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationSuperBinaryAssetID tlvType]( &OBJC_CLASS___UARPTLVPersonalizationSuperBinaryAssetID,  "tlvType");
  uint64_t v4 = *((unsigned __int16 *)&self->super.super._tlvLength + 2);
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationSuperBinaryAssetID;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationSuperBinaryAssetID;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationSuperBinaryAssetID tlvType]( UARPTLVPersonalizationSuperBinaryAssetID,  "tlvType"));
