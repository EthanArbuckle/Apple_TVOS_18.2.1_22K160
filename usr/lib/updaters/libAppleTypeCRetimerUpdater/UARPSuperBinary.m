...
- (BOOL)preparePayload:(UARPPayloadHeader2 *)a3
{
  v5 = -[UARPAssetTag initWithChar1:char2:char3:char4:]( objc_alloc(&OBJC_CLASS___UARPAssetTag),  "initWithChar1:char2:char3:char4:",  (char)a3->var1.var0,  (char)a3->var1.var1,  (char)a3->var1.var2,  (char)a3->var1.var3);
  unint64_t v6 = -[UARPAssetVersion initWithMajorVersion:minorVersion:releaseVersion:buildVersion:]( objc_alloc(&OBJC_CLASS___UARPAssetVersion),  "initWithMajorVersion:minorVersion:releaseVersion:buildVersion:",  a3->var2.var0,  a3->var2.var1,  a3->var2.var2,  a3->var2.var3);
...
- (id)getBver
{
  uint64_t v3 = -[UARPAssetTag initWithString:](objc_alloc(&OBJC_CLASS___UARPAssetTag), "initWithString:", @"FIRM");
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      id v7 = -[FTABFile initWithData:](objc_alloc(&OBJC_CLASS___FTABFile), "initWithData:", v6);
