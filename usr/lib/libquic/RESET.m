...
uint64_t __quic_frame_acknowledged_RESET_STREAM_block_invoke(uint64_t a1, uint64_t a2)
{
    ...
    && *(void *)(*(void *)(a1 + 32) + 1112LL))
  {
    ...
    v30 = &v28;
    v6 = (char *)&v28 - ((MEMORY[0x1895F8858](v5, v5) + 15) & 0xFFFFFFFFFFFFFFF0LL);
    ...
    *(_OWORD *)((char *)v11 + 25) = 0u;
    ...
    uint64_t v18 = *(void *)(*(void *)(a1 + 32) + 1112LL);
    if (v12 % 3 == 2) {
    ...
    *(_WORD *)(v7 + 52) = 1024;
    *(_DWORD *)(v7 + 54) = v25;
    qlog_internal(0, (uint64_t)v6, 590LL);
  }
...
BOOL __quic_frame_process_RESET_STREAM_block_invoke(uint64_t a1, uint64_t a2)
{
    ...
    && *(void *)(*(void *)(a1 + 40) + 1112LL))
  {
    ...
    v78 = &v76;
    uint64_t v5 = (char *)&v76 - ((MEMORY[0x1895F8858](v4, v4) + 15) & 0xFFFFFFFFFFFFFFF0LL);
    _ReadStatusReg(ARM64_SYSREG(3, 3, 13, 0, 3));
    ...
    *(_OWORD *)((char *)v10 + 25) = 0u;
    ...
    uint64_t v17 = *(void *)(*(void *)(a1 + 40) + 1112LL);
    if (v11 % 3 == 2) {
    ...
    *(_OWORD *)((char *)v19 + 25) = v13;
    ...
    uint64_t v30 = *(void *)(*(void *)(a1 + 32) + 32LL);
    ...
    *(_WORD *)(v6 + 98) = 2048;
    *(void *)(v6 + 100) = v30;
    qlog_internal(1, (uint64_t)v5, 493LL);
  }

  *(_DWORD *)(a2 + 352) |= 0x10000u;
  unint64_t v31 = *(void *)(a2 + 160);
  unint64_t v32 = *(void *)(*(void *)(a1 + 32) + 32LL);
    ...
    *(void *)(v34 + 928) = v35 + v33;
    if (__CFADD__(v35, v33))
    {
      ...
      if ((v37 & 1) != 0 || os_log_type_enabled((os_log_t)qlog_log, OS_LOG_TYPE_FAULT))
      {
        ...
        v39 = (char *)&v76 - ((MEMORY[0x1895F8858](v38, v38) + 15) & 0xFFFFFFFFFFFFFFF0LL);
        _ReadStatusReg(ARM64_SYSREG(3, 3, 13, 0, 3));
        uint64_t v40 = _os_log_pack_fill();
        uint64_t v41 = *(void *)(*(void *)(a1 + 40) + 928LL);
        ...
        *(_WORD *)(v40 + 42) = 2048;
        *(void *)(v40 + 44) = v41;
        qlog_internal(17, (uint64_t)v39, 509LL);
        int v36 = qlog_debug_enabled;
        char v37 = qlog_nwlog_enabled;
      }
    ...
    if (v36 || (v37 & 1) != 0 || os_log_type_enabled((os_log_t)qlog_log, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_WORD *)(v44 + 22) = 2048;
      *(void *)(v44 + 24) = v46;
      qlog_internal(2, (uint64_t)v43, 519LL);
    }
  }

  uint64_t v47 = *(void *)(*(void *)(a1 + 32) + 32LL);
  if (v47) {
    unint64_t v48 = v47 - 1;
  }
  else {
  ...
  if (updated == -1)
  {
      ...
      && *(void *)(*(void *)(a1 + 40) + 1112LL))
    {
      ...
      v78 = &v76;
      v53 = (char *)&v76 - ((MEMORY[0x1895F8858](v52, v52) + 15) & 0xFFFFFFFFFFFFFFF0LL);
      _ReadStatusReg(ARM64_SYSREG(3, 3, 13, 0, 3));
      ...
      *(_OWORD *)((char *)v58 + 25) = 0u;
      ...
      uint64_t v65 = *(void *)(*(void *)(a1 + 40) + 1112LL);
      if (v59 % 3 == 2) {
      ...
      *(_OWORD *)((char *)v67 + 25) = v61;
      ...
      uint64_t v72 = *(void *)(*(void *)(a1 + 32) + 32LL);
      ...
      *(_WORD *)(v54 + 52) = 2048;
      *(void *)(v54 + 54) = v72;
      qlog_internal(16, (uint64_t)v53, 535LL);
    }
  }
  ...
  else
  {
    ...
    if (*(unsigned __int8 *)(a2 + 251) - 1 <= 1)
    {
      ...
      if ((*(void *)a2 & 2) != 0)
      {
        if ((*(_BYTE *)(*(void *)(a1 + 40) + 1380LL) & 1) != 0)
        {
          if ((v73 & 1) == 0) {
            goto LABEL_94;
          }
