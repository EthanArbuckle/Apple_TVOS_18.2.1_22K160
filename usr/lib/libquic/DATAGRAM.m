...
{
  return quic_frame_write_data_frame( *(char ***)(a1 + 40),  *(_WORD **)(a1 + 48),  a2,  (uint64_t *)(*(void *)(*(void *)(a1 + 32) + 8LL) + 24LL),  *(void *)(a1 + 56));
}

uint64_t __quic_frame_process_DATAGRAM_block_invoke(void *a1, uint64_t a2)
{
  *(void *)a2 = *(void *)(a1[4] + 24LL);
...
void *__quic_frame_process_DATAGRAM_block_invoke_184(uint64_t a1, void *__dst, size_t a3)
{
  ...
  return memcpy(__dst, *(const void **)(*(void *)(a1 + 32) + 48LL), a3);
}
...
uint64_t __quic_frame_process_DATAGRAM_block_invoke_4(void *a1, uint64_t a2)
{
  ...
  if (!v5)
  {
    ...
    if ((v4 & 1) != 0 || os_log_type_enabled((os_log_t)qlog_log, OS_LOG_TYPE_DEBUG))
    {
      ...
      v9 = (char *)v13 - ((MEMORY[0x1895F8858](v8, v8) + 15) & 0xFFFFFFFFFFFFFFF0LL);
      ...
      *(_WORD *)(v10 + 22) = 2048;
      *(void *)(v10 + 24) = v12;
      qlog_internal(2, (uint64_t)v9, 3355LL);
    }
  }
