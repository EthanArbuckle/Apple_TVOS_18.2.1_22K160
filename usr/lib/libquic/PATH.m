...
{
  return *(void *)(a2 + 328) != *(void *)(*(void *)(a1 + 32) + 24LL);
}
...
{
  uint64_t v3 = quic_cid_array_find_by_cid(*(unsigned __int8 **)(*(void *)(a1 + 32) + 376LL), (_BYTE *)(a2 + 38));
  return quic_cid_entry_seq_number(v3) != *(void *)(*(void *)(a1 + 40) + 24LL);
}
