...
void ___MAPreferencesCopyValue_block_invoke_2(uint64_t a1)
{
  CFPropertyListRef v2 = CFPreferencesCopyValue( *(CFStringRef *)(a1 + 32),  @"com.apple.MobileAsset",  @"mobile",  kCFPreferencesAnyHost);
  uint64_t v3 = *(void *)(*(void *)(a1 + 40) + 8LL);
  v4 = *(void **)(v3 + 40);
  *(void *)(v3 + 40) = v2;
}
