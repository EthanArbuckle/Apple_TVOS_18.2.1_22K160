...
uint64_t __DPFUSessionWrite(uint64_t a1, char a2, uint64_t a3, unsigned int a4)
{
  ...
  for (unsigned int i = 0; i < a4; i += v8)
  {
    ...
    uint64_t v10 = v9;
    if ((_DWORD)v9 && (*(_DWORD *)(a1 + 48) & 0x80000000) == 0)
    {
...
void __DPFULog( int a1, const char *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
  if (isatty(2))
  {
    ...
    fputs("dpfu: ", (FILE *)*MEMORY[0x1895F89D0]);
    vfprintf(*v11, a2, &a9);
    fputc(10, *v11);
  }
...
{
  uint64_t v12 = *MEMORY[0x189604DB0];
  uint64_t v13 = (const void *)IODPDeviceCreate();
  uint64_t v14 = DPFUSessionCreate(v12, v13, a2);
  CFRelease(v13);
  if (v14)
  {
    *(void *)(v14 + 32) = a5;
    *(void *)(v14 + 40) = a6;
    uint64_t updated = DPFUSessionEnterUpdateMode(v14);
    if ((_DWORD)updated)
    {
    ...
    {
      uint64_t v27 = DPFUSessionInstallFilePayload(v14, a1, a3, v22, v23, v24, v25, v26);
      if (a4 && !*(_BYTE *)(v14 + 54)) {
        __DPFUDeviceSetProperty(*(void *)(v14 + 16));
      }
    }
  ...
  {
    uint64_t v27 = 3758097136LL;
    if ((MEMORY[0x30] & 0x80000000) == 0) {
      __DPFULog(0, "Can't create device update session", v15, v16, v17, v18, v19, v20, v29);
    }
  }
...
LABEL_42:
  ...
  if (*v2 > 0x77u)
  {
    if (v19 == 120)
    {
      v21 = "Eight-Byte Update Mode";
      goto LABEL_28;
    }

    if (v19 == 127)
    {
      v21 = "32-KByte Update Mode";
      goto LABEL_28;
    }
...
uint64_t IOAVDeviceSetProperty()
{
  return MEMORY[0x189607C70]();
}

uint64_t IODPDeviceCreate()
{
  return MEMORY[0x189607D40]();
}

uint64_t IODPDeviceGetAVDevice()
{
  return MEMORY[0x189607D50]();
}
