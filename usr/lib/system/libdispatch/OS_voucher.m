...
- (void)release
{
  qword_18C51C2A8 = (uint64_t)"API MISUSE: Voucher over-release";
  __break(1u);
}
...
- (void)dealloc
{
  ...
  -[OS_voucher dealloc](&v3, sel_dealloc);
}
...
- (id)debugDescription
{
  ...
  if (result)
  {
    ...
    if (result) {
      return (id)objc_msgSend(v4, "stringWithFormat:", result, object_getClassName(self), __str);
    }
  }
...
- (void)retain
{
  qword_18C51C2A8 = (uint64_t)"API MISUSE: Voucher resurrection";
  __break(1u);
}
