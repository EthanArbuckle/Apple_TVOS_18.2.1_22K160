...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationChipRevisionOS;
...
- (id)description
{
  id v3 =  +[UARPTLVPersonalizationChipRevisionOS metaDataTableEntry]( &OBJC_CLASS___UARPTLVPersonalizationChipRevisionOS,  "metaDataTableEntry");
  v4 = (void *)NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationChipRevisionOS tlvType](&OBJC_CLASS___UARPTLVPersonalizationChipRevisionOS, "tlvType");
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationChipRevisionOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationChipRevisionOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationChipRevisionOS tlvType]( UARPTLVPersonalizationChipRevisionOS,  "tlvType"));
  v6[1] = v2;
