...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationFTABSubfileTagOS;
...
- (id)description
{
  id v3 =  +[UARPTLVPersonalizationFTABSubfileTagOS metaDataTableEntry]( &OBJC_CLASS___UARPTLVPersonalizationFTABSubfileTagOS,  "metaDataTableEntry");
  id v4 = (void *)NSString;
...
- (id)generateTLV
{
  ...
  int v8 = uarpHtonl( +[UARPTLVPersonalizationFTABSubfileTagOS tlvType]( &OBJC_CLASS___UARPTLVPersonalizationFTABSubfileTagOS,  "tlvType"));
  [v3 appendBytes:&v8 length:4];
  int v7 = uarpHtonl(4u);
  [v3 appendBytes:&v7 length:4];
  id v4 = -[UARPTLVPersonalizationFTABSubfileTagOS tlvValue](self, "tlvValue");
  [v3 appendData:v4];
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationFTABSubfileTagOS tlvType]( UARPTLVPersonalizationFTABSubfileTagOS,  "tlvType"));
  v6[1] = v2;
