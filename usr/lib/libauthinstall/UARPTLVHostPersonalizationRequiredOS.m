...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVHostPersonalizationRequiredOS;
...
- (id)description
{
  id v3 =  +[UARPTLVHostPersonalizationRequiredOS metaDataTableEntry]( &OBJC_CLASS___UARPTLVHostPersonalizationRequiredOS,  "metaDataTableEntry");
  v4 = (void *)NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVHostPersonalizationRequiredOS tlvType](&OBJC_CLASS___UARPTLVHostPersonalizationRequiredOS, "tlvType");
  uint64_t v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVHostPersonalizationRequiredOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___UARPTLVHostPersonalizationRequiredOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVHostPersonalizationRequiredOS tlvType]( UARPTLVHostPersonalizationRequiredOS,  "tlvType"));
  v6[1] = v2;
