...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPMetaDataTLVStringOS;
...
- (id)generateTLV:(unsigned int)a3 tlvValue:(id)a4
{
  ...
  id v9 = -[UARPMetaDataTLVStringOS tlvValue:](self, "tlvValue:", v7);

  [v8 appendData:v9];
  id v10 = (id)[MEMORY[0x189603F48] dataWithData:v8];
