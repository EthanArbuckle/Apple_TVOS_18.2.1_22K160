...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS;
...
- (id)description
{
  id v3 =  +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS metaDataTableEntry]( &OBJC_CLASS___UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS,  "metaDataTableEntry");
  v4 = (void *)NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS tlvType]( &OBJC_CLASS___UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS,  "tlvType");
  uint64_t v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS tlvType]( UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS,  "tlvType"));
  v6[1] = v2;
