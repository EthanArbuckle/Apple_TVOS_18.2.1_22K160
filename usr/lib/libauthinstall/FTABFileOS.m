...
- (FTABFileOS)initWithContentsOfURL:(id)a3
{
  id v5 = a3;
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___FTABFileOS;
  v6 = -[FTABFileOS init](&v14, sel_init);
  if (!v6) {
    goto LABEL_5;
  }
  id v13 = 0LL;
  v7 = (NSData *)(id)[MEMORY[0x189603F48] dataWithContentsOfURL:v5 options:1 error:&v13];
  id v8 = v13;
...
- (FTABFileOS)initWithData:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)&OBJC_CLASS___FTABFileOS;
  id v5 = -[FTABFileOS init](&v10, sel_init);
  if (v5
    && (uint64_t v6 = [v4 copy],
...
- (BOOL)initFile
{
  ...
  v3 = (NSMutableArray *)(id)[MEMORY[0x189603FA8] array];
...
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___FTABFileOS;
  ...
  if (v2)
  {
    ...
    uint64_t v6 = (NSMutableArray *)(id)[MEMORY[0x189603FA8] array];
    subFileArray = v2->_subFileArray;
    v2->_subFileArray = v6;

    id v8 = (NSData *)(id)[MEMORY[0x189603F48] dataWithBytes:&kFTABMagicLowercase length:8];
    magic = v2->_magic;
    v2->_magic = v8;
  }
...
- (BOOL)parseFileData
{
  if (self->_fileLength > 0x2F)
  {
    ...
    {
      id v8 = (NSData *)(id)[MEMORY[0x189603F48] dataWithBytes:v7 length:8];
      magic = self->_magic;
      self->_magic = v8;

      self->_generation = *(_DWORD *)filePointer;
      self->_valid = *((_DWORD *)filePointer + 1);
      objc_super v10 = (NSData *)(id)[MEMORY[0x189603F48] dataWithBytes:filePointer + 8 length:8];
      ...
      if ((_DWORD)v12)
      {
        ...
        objc_super v14 = -[FTABSubfileOS initWithTag:dataPointer:dataLength:]( objc_alloc(&OBJC_CLASS___FTABSubfileOS),  "initWithTag:dataPointer:dataLength:",  @"Manifest",  &self->_filePointer[v13],  v12);
      ...
      for (uint64_t i = 0LL;
            -[FTABFileOS fileValidForOffset:length:](self, "fileValidForOffset:length:", (i + 48), 16LL);
            i += 16LL)
      {
        ...
        v21 = (void *)v20;
        v22 = -[FTABSubfileOS initWithTag:dataPointer:dataLength:]( objc_alloc(&OBJC_CLASS___FTABSubfileOS),  "initWithTag:dataPointer:dataLength:",  v20,  &self->_filePointer[v19],  v18);
...
- (void)removeSubfileWithTag:(id)a3
{
  id v4 = -[FTABFileOS subfileWithTag:](self, "subfileWithTag:", a3);
  if (v4) {
...
- (id)description
{
  ...
  id v5 = (id)-[NSData byteString](self->_bootNonce, "byteString");
...
- (BOOL)addSubfileWithTagName:(id)a3 contentsOfURL:(id)a4
{
  ...
  id v7 = a4;
  id v13 = 0LL;
  id v8 = (id)[MEMORY[0x189603F48] dataWithContentsOfURL:v7 options:1 error:&v13];
  id v9 = v13;
  if (v8)
  {
    BOOL v10 = -[FTABFileOS addSubfileWithTagName:subfileData:](self, "addSubfileWithTagName:subfileData:", v6, v8);
  }
...
- (BOOL)addSubfileWithTagName:(id)a3 subfileData:(id)a4
{
  ...
  id v8 = objc_alloc(&OBJC_CLASS___FTABSubfileOS);
  id v9 = v6;
  uint64_t v10 = [v9 bytes];
  uint64_t v11 = [v9 length];

  uint64_t v12 = -[FTABSubfileOS initWithTag:dataPointer:dataLength:](v8, "initWithTag:dataPointer:dataLength:", v7, v10, v11);
...
{
  id v4 = a3;
  uint64_t v5 = -[FTABSubfileOS initWithTag:data:]( objc_alloc(&OBJC_CLASS___FTABSubfileOS),  "initWithTag:data:",  @"Manifest",  v4);
...
LABEL_14:
  ...
  id v17 = 0LL;
  id v13 = (id)[MEMORY[0x189607898] fileHandleForWritingToURL:v3 error:&v17];
...
- (BOOL)configureFileHandleWriteDestinationForURL:(id)a3
{
  ...
  int v6 = (NSFileHandle *)-[FTABFileOS createFileHandleForWritingToURL:](self, "createFileHandleForWritingToURL:", v5);
...
- (void)configureDataWriteDestination
{
  ...
  id v4 = (NSMutableData *)(id)[MEMORY[0x189603FB8] data];
  dataWriteDestination = self->_dataWriteDestination;
...
- (BOOL)writeToDestination
{
  ...
  {
    int v5 = v3 + 48;
    unsigned int v6 = -[FTABSubfileOS dataLength](manifest, "dataLength");
  }
  ...
  if (!-[FTABFileOS writeBytes:length:](self, "writeBytes:length:", v50, 48LL))
  {
    id v7 = os_log_create("com.apple.accessoryupdater.ftab", "writing");
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      -[FTABFileOS writeToDestination].cold.4(v7, v22, v23, v24, v25, v26, v27, v28);
    }
    goto LABEL_31;
  }
  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0LL; i != v9; ++i)
      {
        ...
        if (!-[FTABFileOS writeBytes:length:](self, "writeBytes:length:", &v42, 16LL))
        {
...
LABEL_30:
    ...
    && !-[FTABFileOS writeBytes:length:]( self,  "writeBytes:length:",  -[FTABSubfileOS dataPointer](v15, "dataPointer"),  -[FTABSubfileOS dataLength](self->_manifest, "dataLength")))
  {
    id v7 = os_log_create("com.apple.accessoryupdater.ftab", "writing");
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      -[FTABFileOS writeToDestination].cold.2(v7, v31, v32, v33, v34, v35, v36, v37);
    }
LABEL_31:
    BOOL v21 = 0;
    goto LABEL_32;
  ...
  if (v16)
  {
    ...
    while (2)
    {
      for (uint64_t j = 0LL; j != v17; ++j)
      {
        ...
        if (!-[FTABFileOS writeBytes:length:]( self,  "writeBytes:length:",  objc_msgSend(v20, "dataPointer", (void)v38),  objc_msgSend(v20, "dataLength")))
        {
          v29 = os_log_create("com.apple.accessoryupdater.ftab", "writing");
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR)) {
...
- (BOOL)writeToURL:(id)a3
{
  ...
  {
    BOOL v5 = -[FTABFileOS writeToDestination](self, "writeToDestination");
    fileHandleWriteDestination = self->_fileHandleWriteDestination;
    self->_fileHandleWriteDestination = 0LL;
  }
...
- (id)writeToData
{
  id v3 = (id)[MEMORY[0x189603F48] dataWithData:self->_dataWriteDestination];
  dataWriteDestination = self->_dataWriteDestination;
  self->_dataWriteDestination = 0LL;
...
- (BOOL)writeSubfileToURL:(id)a3 tag:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = -[FTABFileOS subfileWithTag:](self, "subfileWithTag:", v7);
  if (v8)
  {
    id v9 = -[FTABFileOS createFileHandleForWritingToURL:](self, "createFileHandleForWritingToURL:", v6);
    if (v9) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v3 = -[FTABFileOS writeToData](self, "writeToData", a3);
  id v4 = -[FTABFileOS initWithData:](objc_alloc(&OBJC_CLASS___FTABFileOS), "initWithData:", v3);
...
- (FTABSubfileOS)manifest
{
  return (FTABSubfileOS *)objc_getProperty(self, a2, 88LL, 1);
}
...
- (void)initWithContentsOfURL:.cold.1()
{
  int v2 = 136315650;
  OUTLINED_FUNCTION_7();
  OUTLINED_FUNCTION_6(&dword_187CA0000, v0, v1, "%s: Unable to open file at %@ (%@)", v2);
...
- (void)createFileHandleForWritingToURL:(void *)a1 .cold.2(void *a1)
{
  id v1 = (id)[a1 path];
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_2(&dword_187CA0000, v2, v3, "Unable to create file at %@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_8();
...
- (void)createFileHandleForWritingToURL:(void *)a1 .cold.3(void *a1)
{
  id v1 = (id)[a1 path];
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_2(&dword_187CA0000, v2, v3, "Unable to delete file at %@", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_2_1();
}
...
- (void)writeToURL:(void *)a1 .cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_2(&dword_187CA0000, v2, v3, "Failed to open file handle for writing to '%@'", v4, v5, v6, v7, v8);
  OUTLINED_FUNCTION_8();
  OUTLINED_FUNCTION_2_1();
}
...
- (void)writeSubfileToURL:tag:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_1(&dword_187CA0000, v0, v1, "Unable to locate subfile with tag '%@'", v2);
  OUTLINED_FUNCTION_1();
}
