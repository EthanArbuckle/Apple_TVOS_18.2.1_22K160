...
- (UARPSuperBinaryPayloadOS)initWithData:(id)a3 metaData:(id)a4 tag:(id)a5 version:(id)a6
{
  ...
  id v13 = a6;
  v36.receiver = self;
  v36.super_class = (Class)&OBJC_CLASS___UARPSuperBinaryPayloadOS;
  ...
  if (v14)
  {
    ...
    v33 = -[FTABFileOS initWithData:](objc_alloc(&OBJC_CLASS___FTABFileOS), "initWithData:", v14->_payloadData);
    ftab = v14->_ftab;
    v14->_ftab = v33;
  }
...
- (id)composeTSSRequest:(unint64_t)a3
{
  return -[UARPSuperBinaryPayloadOS composeTSSRequest:asMeasurement:](self, "composeTSSRequest:asMeasurement:", a3, 0LL);
}
...
- (id)composeTSSRequest:(unint64_t)a3 asMeasurement:(BOOL)a4
{
  ...
  if (!v4)
  {
    ...
    id v30 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", @"BoardID", a3);
    id v12 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  -[UARPSuperBinaryPayloadOS boardID](self, "boardID"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v12, v30);

    id v28 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", @"ChipID", a3);
    id v13 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  -[UARPSuperBinaryPayloadOS chipID](self, "chipID"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v13, v28);

    id v14 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", @"ECID", a3);
    id v15 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedLongLong:",  -[UARPSuperBinaryPayloadOS ecID](self, "ecID"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v15, v14);

    id v16 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", @"Nonce", a3);
    __int128 v17 = -[UARPSuperBinaryPayloadOS nonce](self, "nonce");
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v17, v16);

    id v18 =  -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:]( self,  "tssKeyName:unitNumber:",  @"ProductionMode",  a3);
    int v19 = -[UARPSuperBinaryPayloadOS productionMode](self, "productionMode");
    ...
    id v23 =  -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:]( self,  "tssKeyName:unitNumber:",  @"SecurityDomain",  a3);
    id v24 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedChar:",  -[UARPSuperBinaryPayloadOS securityDomain](self, "securityDomain"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v24, v23);

    id v25 =  -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:]( self,  "tssKeyName:unitNumber:",  @"SecurityMode",  a3);
...
- (id)tatsuMeasurements:(unint64_t)a3
{
  ...
  if (v5) {
    id v5 =  -[UARPSuperBinaryPayloadOS composeTSSRequest:asMeasurement:]( self,  "composeTSSRequest:asMeasurement:",  a3,  1LL);
  }
  return v5;
}
...
- (UARPAssetTagOS)tag
{
  return (UARPAssetTagOS *)objc_getProperty(self, a2, 120LL, 1);
}

- (UARPAssetVersionOS)version
{
  return (UARPAssetVersionOS *)objc_getProperty(self, a2, 128LL, 1);
}
...
- (void)addSubfile:(id)a3 tag:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = -[FTABSubfileOS initWithTag:data:](objc_alloc(&OBJC_CLASS___FTABSubfileOS), "initWithTag:data:", v6, v7);
...
LABEL_3:
    ...
    while (1)
    {
      ...
      id v12 = (id)objc_msgSend(v11, "tag", (void)v15);
