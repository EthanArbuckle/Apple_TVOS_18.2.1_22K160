...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationNonceHashOS;
...
- (id)description
{
  id v3 =  +[UARPTLVPersonalizationNonceHashOS metaDataTableEntry]( &OBJC_CLASS___UARPTLVPersonalizationNonceHashOS,  "metaDataTableEntry");
  id v4 = (void *)NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationNonceHashOS tlvType](&OBJC_CLASS___UARPTLVPersonalizationNonceHashOS, "tlvType");
  nonceHash = self->_nonceHash;
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationNonceHashOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationNonceHashOS tlvType]( UARPTLVPersonalizationNonceHashOS,  "tlvType"));
  v6[1] = v2;
