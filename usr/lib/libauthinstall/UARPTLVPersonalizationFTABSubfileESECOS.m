...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationFTABSubfileESECOS;
...
- (id)description
{
  id v3 =  +[UARPTLVPersonalizationFTABSubfileESECOS metaDataTableEntry]( &OBJC_CLASS___UARPTLVPersonalizationFTABSubfileESECOS,  "metaDataTableEntry");
  v4 = (void *)NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationFTABSubfileESECOS tlvType]( &OBJC_CLASS___UARPTLVPersonalizationFTABSubfileESECOS,  "tlvType");
  uint64_t v4 = *((unsigned __int16 *)&self->super.super._tlvLength + 2);
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationFTABSubfileESECOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___UARPTLVPersonalizationFTABSubfileESECOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = (id)objc_msgSend( MEMORY[0x189607968],  "numberWithUnsignedInt:",  +[UARPTLVPersonalizationFTABSubfileESECOS tlvType]( UARPTLVPersonalizationFTABSubfileESECOS,  "tlvType"));
  v6[1] = v2;
