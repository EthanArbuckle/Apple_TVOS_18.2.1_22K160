...
LABEL_631:
        ...
        uint64_t CUSymAddr_DataBuffer_AppendF_sAddr = _GetCUSymAddr_DataBuffer_Append_sAddr(v109, "", 1LL);
        if (!(_DWORD)CUSymAddr_DataBuffer_AppendF_sAddr)
        {
...
uint64_t MDNSOLCopyFormattedStringD2DServiceEvent(void *a1)
{
  ...
  {
    id v2 = v1;
    id v3 = @"D2DServiceFound";
    switch([v2 longLongValue])
    {
      case 0LL:
        break;
      case 1LL:
        id v3 = @"D2DServiceLost";
        break;
      case 2LL:
        id v3 = @"D2DServiceResolved";
        break;
      case 3LL:
        id v3 = @"D2DServiceRetained";
        break;
      case 4LL:
        id v3 = @"D2DServiceReleased";
        break;
      case 5LL:
        id v3 = @"D2DServicePeerLost";
        break;
      default:
        id v3 = 0LL;
        break;
  ...
  uint64_t v4 = [objc_alloc((Class)&off_18C74B148) initWithString:v3];
...
uint64_t MDNSOLCopyFormattedStringDNSScopeType(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    uint64_t v4 = @"Service scoped";
    uint64_t v5 = @"Interface scoped";
    if (v3 != 1) {
      uint64_t v5 = 0LL;
    }
    if (v3 != 2) {
  ...
  uint64_t v7 = [objc_alloc((Class)&off_18C74B148) initWithString:v6];
...
uint64_t MDNSOLCopyFormattedStringmDNSLabelSequenceName(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    id v9 = objc_alloc((Class)&off_18C74B148);
    id v10 = objc_alloc((Class)&off_18C74B7A0);
    [v1 description];
    uint64_t v11 = (void *)objc_claimAutoreleasedReturnValue();
    size_t v12 = (void *)[v10 initWithFormat:@"<fail decode - data type> %@", v11];
  ...
  {
    uint64_t v7 = [objc_alloc((Class)&off_18C74B148) initWithString:@"<NULL DOMAIN NAME>"];
    uint64_t v5 = 0LL;
    goto LABEL_10;
  }
  ...
  bzero(v13, 0x3F1uLL);
  if (DomainNameToString(v3, v4, v13, 0LL))
  {
    uint64_t v5 = 0LL;
    goto LABEL_13;
  }

  +[NSString stringWithUTF8String:](&off_18C74B7A0, "stringWithUTF8String:", v13);
...
LABEL_13:
  ...
  uint64_t v6 = [objc_alloc((Class)&off_18C74B148) initWithString:v5];
  if (!v6) {
    uint64_t v6 = [objc_alloc((Class)&off_18C74B148) initWithString:@"<Could not create NSAttributedString>"];
  }
  uint64_t v7 = v6;
LABEL_10:
...
uint64_t MDNSOLCopyFormattedStringmDNSLabel(void *a1)
{
  ...
  if (![v2 bytes] || !objc_msgSend(v2, "length"))
  {
    uint64_t v7 = [objc_alloc((Class)&off_18C74B148) initWithString:@"<NULL DOMAIN LABEL>"];
LABEL_14:
    uint64_t v5 = 0LL;
    goto LABEL_15;
  }
  ...
  {
    id v13 = objc_alloc((Class)&off_18C74B148);
    uint64_t v14 = (void *)objc_msgSend( objc_alloc((Class)&off_18C74B7A0),  "initWithFormat:",  @"failed to decode - invalid domain label length - data length: %lu, label length: %lu",  objc_msgSend(v2, "length"),  v3);
  ...
  v16[[v2 length]] = 0;
  bzero(__s, 0x3F1uLL);
  if (DomainNameToString(v16, 0LL, (unsigned __int8 *)__s, 0LL))
  {
    uint64_t v5 = 0LL;
LABEL_19:
    uint64_t v7 = 0LL;
  ...
  +[NSString stringWithUTF8String:](&off_18C74B7A0, "stringWithUTF8String:", __s);
  uint64_t v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v5) {
    goto LABEL_19;
  }
...
uint64_t MDNSOLCopyFormattedStringHexSequence(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    id v5 = objc_alloc((Class)&off_18C74B148);
    id v6 = objc_alloc((Class)&off_18C74B7A0);
    [v1 description];
...
LABEL_7:
  ...
  {
    id v5 = objc_alloc((Class)&off_18C74B148);
    uint64_t v7 = objc_msgSend(objc_alloc((Class)&off_18C74B7A0), "initWithFormat:", @"<failed to decode - NIL data >", v9);
    goto LABEL_7;
  }
...
uint64_t MDNSOLCopyFormattedStringmDNSIPAddr(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    id v12 = objc_alloc((Class)&off_18C74B148);
    id v13 = objc_alloc((Class)&off_18C74B7A0);
    [v1 description];
...
LABEL_11:
  ...
  id v6 = objc_alloc((Class)&off_18C74B148);
  if (!v5)
  {
    uint64_t v16 = @"<Could not create NSString>";
LABEL_18:
    uint64_t v7 = objc_msgSend(v6, "initWithString:", v16, v17);
    goto LABEL_8;
  }

  uint64_t v7 = objc_msgSend(v6, "initWithString:", v5, &v18);
  if (!v7)
  {
    id v6 = objc_alloc((Class)&off_18C74B148);
...
uint64_t MDNSOLCopyFormattedStringDataLinkEvent(void *a1)
{
  ...
  {
LABEL_6:
    int v4 = &stru_18A2FAE20;
    goto LABEL_7;
  }

  int v4 = @"KEV_DL_SIFFLAGS";
  switch((int)v3)
  {
    case 1:
      break;
    case 2:
      int v4 = @"KEV_DL_SIFMETRICS";
      break;
    case 3:
      int v4 = @"KEV_DL_SIFMTU";
      break;
    case 4:
      int v4 = @"KEV_DL_SIFPHYS";
      break;
    case 5:
      int v4 = @"KEV_DL_SIFMEDIA";
      break;
    case 6:
      int v4 = @"KEV_DL_SIFGENERIC";
      break;
    case 7:
      int v4 = @"KEV_DL_ADDMULTI";
      break;
    case 8:
      int v4 = @"KEV_DL_DELMULTI";
      break;
    case 9:
      int v4 = @"KEV_DL_IF_ATTACHED";
      break;
    case 10:
      int v4 = @"KEV_DL_IF_DETACHING";
      break;
    case 11:
      int v4 = @"KEV_DL_IF_DETACHED";
      break;
    case 12:
      int v4 = @"KEV_DL_LINK_OFF";
      break;
    case 13:
      int v4 = @"KEV_DL_LINK_ON";
      break;
    case 14:
      int v4 = @"KEV_DL_PROTO_ATTACHED";
      break;
    case 15:
      int v4 = @"KEV_DL_PROTO_DETACHED";
      break;
    case 16:
      int v4 = @"KEV_DL_LINK_ADDRESS_CHANGED";
      break;
    case 17:
      int v4 = @"KEV_DL_WAKEFLAGS_CHANGED";
      break;
    case 18:
      int v4 = @"KEV_DL_IF_IDLE_ROUTE_REFCNT";
      break;
    case 19:
      int v4 = @"KEV_DL_IFCAP_CHANGED";
      break;
    case 20:
      int v4 = @"KEV_DL_LINK_QUALITY_METRIC_CHANGED";
      break;
    case 21:
      int v4 = @"KEV_DL_NODE_PRESENCE";
      break;
    case 22:
      int v4 = @"KEV_DL_NODE_ABSENCE";
      break;
    case 23:
      int v4 = @"KEV_DL_PRIMARY_ELECTED";
      break;
    case 24:
      int v4 = @"KEV_DL_ISSUES";
      break;
    case 25:
      int v4 = @"KEV_DL_IFDELEGATE_CHANGED";
      break;
    case 27:
      int v4 = @"KEV_DL_AWDL_UNRESTRICTED";
      break;
    case 28:
      int v4 = @"KEV_DL_RRC_STATE_CHANGED";
      break;
    case 29:
      int v4 = @"KEV_DL_QOS_MODE_CHANGED";
      break;
    case 30:
      int v4 = @"KEV_DL_LOW_POWER_MODE_CHANGED";
      break;
    default:
      int v4 = @"<Unknown Data-Link event>";
      break;
  }

LABEL_7:
  uint64_t v5 = [objc_alloc((Class)&off_18C74B148) initWithString:v4];
  return v5;
}
...
uint64_t MDNSOLCopyFormattedStringmDNSMACAddr(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    id v8 = objc_alloc((Class)&off_18C74B148);
    id v9 = objc_alloc((Class)&off_18C74B7A0);
    [v1 description];
  ...
  if (![v2 bytes] || !objc_msgSend(v2, "length"))
  {
    uint64_t v6 = [objc_alloc((Class)&off_18C74B148) initWithString:@"<NULL MAC ADDRESS>"];
LABEL_9:
    uint64_t v3 = 0LL;
    goto LABEL_10;
  }
  ...
  {
    id v12 = objc_alloc((Class)&off_18C74B148);
    id v13 = (void *)objc_msgSend( objc_alloc((Class)&off_18C74B7A0),  "initWithFormat:",  @"<fail decode - size> %zu != %d",  objc_msgSend(v2, "length"),  6);
  ...
  id v4 = objc_alloc((Class)&off_18C74B148);
  if (!v3)
  {
    uint64_t v14 = @"<Could not create NSString>";
LABEL_15:
    uint64_t v5 = objc_msgSend(v4, "initWithString:", v14, v15);
    goto LABEL_7;
  }

  uint64_t v5 = objc_msgSend(v4, "initWithString:", v3, v15);
  if (!v5)
  {
    id v4 = objc_alloc((Class)&off_18C74B148);
    uint64_t v14 = @"<Could not create NSAttributedString>";
    goto LABEL_15;
  }
...
{
  id v1 = a1;
  id v2 = (void *)[objc_alloc((Class)&off_18C74B8F0) initWithCapacity:0];
  if (!v2)
  {
    uint64_t v12 = 0LL;
    goto LABEL_12;
    ...
    if ([v3 bytes])
    {
      ...
      if (v5 >= 6)
      {
        ...
        do
        {
          ...
          if (v11) {
            objc_msgSend(v2, "appendFormat:", @"%s(%x %s)", v8, v9, v11);
          }
          else {
            objc_msgSend(v2, "appendFormat:", @"%s(%x TYPE%u)", v8, v9, v10);
          }
          v7 += 6LL;
          id v8 = " ";
          --v6;
      ...
      uint64_t v12 = [objc_alloc((Class)&off_18C74B148) initWithString:v2];
      id v1 = v19;
      goto LABEL_11;
    }

    id v14 = objc_alloc((Class)&off_18C74B148);
    uint64_t v16 = objc_msgSend( objc_alloc((Class)&off_18C74B7A0),  "initWithFormat:",  @"<failed to decode - NIL data >",  v18);
  }

  else
  {
    id v14 = objc_alloc((Class)&off_18C74B148);
    id v15 = objc_alloc((Class)&off_18C74B7A0);
    [v1 description];
...
uint64_t MDNSOLCopyFormattedStringNetworkChangeEventFlag(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    objc_msgSend(v2, "appendFormat:", @"0x%llX {", v4);
    uint64_t v5 = 0LL;
    unint64_t v6 = "";
    do
    {
      if ((v4 & (uint64_t)(&off_18A2FAB60)[v5 + 1]) != 0)
      {
        objc_msgSend(v2, "appendFormat:", @"%s%s", v6, (&off_18A2FAB60)[v5]);
        unint64_t v6 = ", ";
      }
  ...
  uint64_t v7 = [objc_alloc((Class)&off_18C74B148) initWithString:v2];
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    else if ((_DWORD)v3)
    {
      if ((_DWORD)v3 == -65548) {
        ...
        uint64_t v4 = (__CFString *)objc_msgSend( objc_alloc((Class)&off_18C74B7A0),  "initWithFormat:",  @"<Unknown register record result: %d>",  v3);
      }
    }
