    ...
    *((_OWORD *)v7 + 3) = 0u;
    ...
    if (*a2)
    {
      ...
      while (1)
      {
        ...
        v12 = 0LL;
        while (v9 > 0x20 || ((1LL << v9) & 0x100000201LL) == 0)
          v9 = v10[++v12];
        if (!v12) {
          goto LABEL_96;
        }
        ...
        {
          v21 = __c_2 == 13369 && v38 == 36;
          if (v21 && (v23 = v39) != 0 && !v40)
          {
            v24 = 2;
          }
          ...
          {
            v22 = __c_2 == 13881 && v38 == 36;
            if (v22 && (v23 = v39) != 0 && !v40)
            {
              v24 = 3;
            }

            else if (__c_2 != 13369 || (v23 = v38) == 0 || (v24 = v39) != 0)
            {
              if (__c_2 != 13881 || (v23 = v38) == 0 || v39)
              {
LABEL_97:
                free((void *)*v8);
                free((void *)v8[1]);
...
{
  uint64_t result = _ISO2022_sputwchar(*(void *)(a1 + 8), 0, __src, &v12, a4, (uint64_t *)&v10);
  size_t v9 = v10;
  if (!(_DWORD)result)
  {
    if (v10 <= 6 && (size_t v9 = v10 - 1, v10 - 1 <= a3))
    {
      memcpy(a2, __src, v9);
      uint64_t result = 0LL;
    }
...
{
  __int128 v1 = *(_OWORD *)&off_18C7497C8;
  *(_OWORD *)a1 = _citrus_ISO2022_stdenc_ops;
  *(_OWORD *)(a1 + 16) = v1;
  __int128 v2 = xmmword_18C7497D8;
  __int128 v3 = *(_OWORD *)&off_18C7497E8;
  __int128 v4 = xmmword_18C7497F8;
  *(void *)(a1 + 80) = qword_18C749808;
  *(_OWORD *)(a1 + 48) = v3;
  *(_OWORD *)(a1 + 64) = v4;
  *(_OWORD *)(a1 + 32) = v2;
  return 0LL;
  ...
  if (*a3)
  {
    ...
    if (v9 >= 8)
    {
      ...
      *(_WORD *)(a5 + 16) = v11 | *(_WORD *)(a5 + 16) & 0xFFC0;
      ...
      do
      {
        int v13 = (_BYTE *)(v12 + v10);
        char v14 = *(_BYTE *)(v12 + v10 - 1);
        if (v14)
        {
          int v15 = (_BYTE *)(a5 + 1 + v10);
          *(v15 - 1) = *(v13 - 2);
          *int v15 = v14;
          v15[1] = *v13;
        }
...
LABEL_50:
    ...
    int v39 = v37;
    unint64_t v42 = 0LL;
    int v27 = (_DWORD)__src - (_DWORD)v8 + v36;
    v8 = (char *)__src;
LABEL_40:
    *(void *)(a5 + 32) = v42;
    *a3 = v8;
...
LABEL_11:
    ...
    {
      uint64_t v16 = qword_188CC7EC0[v14] + a1[v15];
    }

    __int16 v19 = (_BYTE *)(a4 + 4 * v16);
    *__int16 v19 = v14;
    uint64_t v20 = v19 + 2;
    *(_WORD *)(v19 + 1) = 0;
    v21 = v19 + 1;
...
LABEL_101:
  ...
  int v35 = *(unsigned __int8 *)(a4 + 4LL * (__int16)v31);
  if ((v35 & 0xFE) != 2) {
    goto LABEL_64;
  }
...
LABEL_37:
      ...
      __int16 v19 = (unsigned __int8 *)(*v17 + 2LL);
      while (*(v19 - 2) != v9
           || (_BYTE)v10 && *(v19 - 1) != v10
           || (_BYTE)v11 && *v19 != v11)
      {
  ...
  uint64_t v16 = (unsigned __int8 *)(*v14 + 2LL);
...
LABEL_41:
  ...
  char v22 = (_BYTE *)(a5 + 4LL * (int)v13);
  if (*v22 != v9
    || (uint64_t v23 = a5 + 4LL * (int)v13, *(unsigned __int8 *)(v23 + 1) != v10)
