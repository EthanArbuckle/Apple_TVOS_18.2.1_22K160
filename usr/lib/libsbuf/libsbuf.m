...
uint64_t usbuf_vprintf(uint64_t a1, char *__format, va_list a3)
{
  ...
  if (*(void *)(a1 + 32) + ~v12 >= v7) {
    ...
    int v13 = *(_DWORD *)(a1 + 32) + ~(_DWORD)v12;
  }
  *(void *)(a1 + 40) = v12 + v13;
...
uint64_t sbuf_extend(uint64_t a1, int a2)
{
  ...
  uint64_t v6 = v5;
  unsigned int v7 = calloc(1uLL, v5);
  if (!v7) {
    return 0xFFFFFFFFLL;
  }
  uint64_t v8 = v7;
...
uint64_t usbuf_trim(uint64_t a1)
{
  ...
  if (v3 >= 1)
  {
    ...
    do
    {
      ...
      {
        uint64_t result = *(_DWORD *)(v5 + 4LL * v6 + 60) & 0x4000;
        if (!(_DWORD)result) {
          return result;
        }
      }
