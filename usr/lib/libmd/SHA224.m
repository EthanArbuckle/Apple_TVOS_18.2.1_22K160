...
uint64_t __SHA224_FdChunk_block_invoke(uint64_t a1, int a2)
{
  if (a2) {
...
uint64_t __SHA224_FdChunk_block_invoke_2(uint64_t result, int a2, dispatch_data_t data, int a4)
{
  v7 = (void *)result;
  if (data)
  {
...
uint64_t __SHA224_FdChunk_block_invoke_3(uint64_t a1, int a2, int a3, void *data, unint64_t len)
{
  ...
  CC_SHA224_Update((CC_SHA256_CTX *)(*(void *)(*(void *)(a1 + 32) + 8LL) + 24LL), data, len);
  return 1LL;
}
