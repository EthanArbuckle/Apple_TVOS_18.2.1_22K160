...
- (CaptureMTLLateEvalEvent)initWithBaseObject:(id)a3 captureDevice:(id)a4
{
  ...
  id v8 = a4;
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___CaptureMTLLateEvalEvent;
  v9 = -[CaptureMTLLateEvalEvent init](&v15, "init");
  v10 = v9;
  if (v9)
  {
...
- (id)newSharedEventHandle
{
  ...
  *(_BYTE *)(v4 + 13) = v5;
  v9 = -[CaptureMTLLateEvalEvent traceStream](self, "traceStream");
  if (v9) {
...
- (BOOL)waitUntilSignaledValue:(unint64_t)a3 timeoutMS:(unint64_t)a4
{
  ...
  block[4] = v6;
  if (waitUntilSignaledValue_timeoutMS__onceToken_9730 != -1) {
    dispatch_once(&waitUntilSignaledValue_timeoutMS__onceToken_9730, block);
  }
  ...
  *(_BYTE *)(v8 + 13) = v9;
  v13 = -[CaptureMTLLateEvalEvent traceStream](self, "traceStream");
  if (v13) {
...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___CaptureMTLLateEvalEvent;
  uint64_t v3 = -[CaptureMTLLateEvalEvent description](&v8, "description");
...
- (void)setLabel:(id)a3
{
  ...
  *(_BYTE *)(v5 + 13) = v6;
  v10 = -[CaptureMTLLateEvalEvent traceStream](self, "traceStream");
  if (v10) {
...
- (void)dealloc
{
  ...
  *(_BYTE *)(v3 + 13) = v4;
  uint64_t v8 = -[CaptureMTLLateEvalEvent traceStream](self, "traceStream");
  if (v8) {
  ...
  *(_BYTE *)(v15 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___CaptureMTLLateEvalEvent;
  -[CaptureMTLLateEvalEvent dealloc](&v12, "dealloc");
}
