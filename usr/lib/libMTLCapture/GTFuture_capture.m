...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___GTFuture_capture;
  id v2 = -[GTFuture_capture init](&v5, "init");
  if (v2)
  {
  ...
  return (GTFuture_capture *)v2;
}

- (void)dealloc
{
  id v3 = +[GTError_capture errorWithDomain:code:userInfo:]( &OBJC_CLASS___GTError_capture,  "errorWithDomain:code:userInfo:",  @"DYErrorDomain",  1028LL,  0LL);
  [*(id *)&self->super._private1 lock];
  if (!LOBYTE(self->_timeout))
  {
    [*(id *)&self->super._private1 unlock];
    -[GTFuture_capture _setResult:error:notify_NOLOCK:](self, "_setResult:error:notify_NOLOCK:", 0LL, v3, 1LL);
    [*(id *)&self->super._private1 lock];
  }
  ...
  *(void *)&self->super._private1 = 0LL;
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___GTFuture_capture;
  -[GTFuture_capture dealloc](&v5, "dealloc");
}
...
- (void)_start_NOLOCK
{
  ...
  [*(id *)&self->super._private1 unlock];
  -[GTFuture_capture didChangeValueForKey:](self, "didChangeValueForKey:", @"isExecuting");
}
...
- (void)waitUntilResolved
{
  if (+[GTFuture_capture logPerformance](&OBJC_CLASS___GTFuture_capture, "logPerformance"))
  {
  ...
  -[GTFuture_capture _start_NOLOCK](self, "_start_NOLOCK");
  -[GTFuture_capture waitUntilFinished](self, "waitUntilFinished");
  if (+[GTFuture_capture logPerformance](&OBJC_CLASS___GTFuture_capture, "logPerformance"))
  {
...
- (BOOL)BOOLResult
{
  id v2 = -[GTFuture_capture result](self, "result");
...
LABEL_16:
  ...
  -[GTFuture_capture didChangeValueForKey:](self, "didChangeValueForKey:", @"isFinished");
  -[GTFuture_capture didChangeValueForKey:](self, "didChangeValueForKey:", @"isExecuting");
}
...
- (void)cancel
{
  ...
  id v3 =  +[GTError_capture errorWithDomain:code:userInfo:]( &OBJC_CLASS___GTError_capture,  "errorWithDomain:code:userInfo:",  @"DYErrorDomain",  1027LL,  0LL);

  *(void *)&self->_resolved = v3;
  [*(id *)&self->super._private1 unlock];
  -[GTFuture_capture _setResult:error:notify_NOLOCK:]( self,  "_setResult:error:notify_NOLOCK:",  0LL,  *(void *)&self->_resolved,  1LL);
}
...
- (void)resolveWithFuture:(id)a3
{
  if (*((_BYTE *)a3 + 24))
  {
    ...
    [*((id *)a3 + 2) unlock];
    -[GTFuture_capture _setResult:error:notify_NOLOCK:](self, "_setResult:error:notify_NOLOCK:", v5, v6, 1LL);
  }
...
- (void)_addDependency_REQUIRESLOCK:(id)a3
{
  ...
  {
    uint64_t v7 = objc_opt_class(&OBJC_CLASS___GTFuture_capture, v6);
