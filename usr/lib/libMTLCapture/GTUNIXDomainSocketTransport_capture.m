...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___GTUNIXDomainSocketTransport_capture;
  result = -[GTBaseSocketTransport_capture init](&v5, "init");
  if (result) {
...
- (void)setUrl:(id)a3
{
  if (-[GTBaseSocketTransport_capture connected](self, "connected"))
  {
    if (s_logUsingOsLog)
    {
...
- (void)_connectServer:(id)a3 future:(id)a4
{
  ...
  if (v9 >= 0x69)
  {
    v10 = &OBJC_CLASS___GTError_capture;
    v11 = @"DYErrorDomain";
    uint64_t v12 = 39LL;
LABEL_20:
...
- (void)_connectClient:(id)a3 future:(id)a4
{
  if (!a3)
  {
    uint64_t v12 = &OBJC_CLASS___GTError_capture;
...
LABEL_7:
  ...
  {
    size_t v9 = &OBJC_CLASS___GTError_capture;
    v10 = @"DYErrorDomain";
    uint64_t v11 = 1LL;
LABEL_11:
  ...
  -[GTBaseSocketTransport_capture runWithSocket:](self, "runWithSocket:", v8);
  uint64_t v16 = 1LL;
LABEL_12:
...
- (void)_invalidate
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___GTUNIXDomainSocketTransport_capture;
  -[GTBaseSocketTransport_capture _invalidate](&v4, "_invalidate");
}
