...
- (CaptureMTLFunctionHandle)initWithBaseObject:(id)a3 captureComputePipelineState:(id)a4 captureFunction:(id)a5
{
  ...
  id v11 = a5;
  v20.receiver = self;
  v20.super_class = (Class)&OBJC_CLASS___CaptureMTLFunctionHandle;
  v12 = -[CaptureMTLFunctionHandle init](&v20, "init");
  v13 = v12;
  if (v12)
  {
    objc_storeStrong((id *)&v12->_baseObject, a3);
    objc_storeStrong((id *)&v13->_computePipelineState, a4);
    uint64_t v14 = objc_claimAutoreleasedReturnValue(-[CaptureMTLComputePipelineState device](v13->_computePipelineState, "device"));
    captureDevice = v13->_captureDevice;
    v13->_captureDevice = (CaptureMTLDevice *)v14;

    objc_storeStrong((id *)&v13->_captureFunction, a5);
    v16 = -[CaptureMTLComputePipelineState traceContext](v13->_computePipelineState, "traceContext");
...
- (CaptureMTLFunctionHandle)initWithBaseObject:(id)a3 captureRenderPipelineState:(id)a4 captureFunction:(id)a5
{
  ...
  if (v12)
  {
    ...
    uint64_t v14 = objc_claimAutoreleasedReturnValue(-[CaptureMTLRenderPipelineState device](v13->_renderPipelineState, "device"));
    captureDevice = v13->_captureDevice;
    v13->_captureDevice = (CaptureMTLDevice *)v14;

    objc_storeStrong((id *)&v13->_captureFunction, a5);
    v16 = -[CaptureMTLRenderPipelineState traceContext](v13->_renderPipelineState, "traceContext");
    v13->_traceContext = v16;
    id v17 = DEVICEOBJECT(v9);
    v18 = (void *)objc_claimAutoreleasedReturnValue(v17);
    v13->_traceStream = (GTTraceStream *)GTTraceContext_openStream( (uint64_t)v16,  (unint64_t)v18,  (unint64_t)v13);
...
- (unint64_t)functionType
{
  return (unint64_t)-[MTLFunctionHandleSPI functionType](self->_baseObject, "functionType");
}

- (NSString)name
{
  return (NSString *)-[MTLFunctionHandleSPI name](self->_baseObject, "name");
}
...
{
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS___CaptureMTLFunctionHandle;
  uint64_t v3 = -[CaptureMTLFunctionHandle description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  unint64_t v5 = (void *)objc_claimAutoreleasedReturnValue(-[MTLFunctionHandleSPI description](self->_baseObject, "description"));
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  v4 = (__objc2_prot *)a3;
  unsigned __int8 v5 = -[MTLFunctionHandleSPI conformsToProtocol:](baseObject, "conformsToProtocol:", v4);
...
- (void)dealloc
{
  ...
  *(_BYTE *)(v3 + 13) = v4;
  objc_super v8 = -[CaptureMTLFunctionHandle traceStream](self, "traceStream");
  if (v8) {
  ...
  *(_BYTE *)(v15 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___CaptureMTLFunctionHandle;
  -[CaptureMTLFunctionHandle dealloc](&v12, "dealloc");
}
