@interface TVHITunesUDataStore
- (NSArray)fetchRequests;
- (TVHCatalogueDataSource)catalogueDataSource;
- (TVHITunesUDataStore)init;
@end

@implementation TVHITunesUDataStore

- (TVHITunesUDataStore)init
{
  v29.receiver = self;
  v29.super_class = (Class)&OBJC_CLASS___TVHITunesUDataStore;
  v2 = -[TVHITunesUDataStore init](&v29, "init");
  if (v2)
  {
    v3 = (void *)objc_claimAutoreleasedReturnValue( +[TVHKMediaEntitiesFetchRequest mediaEntityCollectionsFetchRequestWithMediaEntityCollectionType:mediaCategoryType:]( &OBJC_CLASS___TVHKMediaEntitiesFetchRequest,  "mediaEntityCollectionsFetchRequestWithMediaEntityCollectionType:mediaCategoryType:",  1LL,  7LL));
    uint64_t v4 = TVHKCommonMediaEntityCollectionProperties([v3 setIdentifier:@"ITunesUCoursesFetchRequestIdentifier"]);
    ...
    v28 = (void *)objc_claimAutoreleasedReturnValue([v11 localizedStringForKey:@"ITUNES_U_TITLE" value:0 table:0]);
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue( +[TVHKMediaEntitiesFetchRequest tvh_toplevelPlaylistsFetchRequestWithIdentifier:playlistItemMediaCategoryTypes:]( &OBJC_CLASS___TVHKMediaEntitiesFetchRequest,  "tvh_toplevelPlaylistsFetchRequestWithIdentifier:playlistItemMediaCategoryTypes:",  @"ITunesUPlaylistsFetchRequestIdentifier",  &off_100106D88));
    v13 = objc_alloc(&OBJC_CLASS___TVHCataloguePlaylistsItem);
    v14 = (void *)objc_claimAutoreleasedReturnValue([v12 identifier]);
    v26 = -[TVHCataloguePlaylistsItem initWithPlaylistItemMediaCategoryTypes:fetchRequestIdentifier:]( v13,  "initWithPlaylistItemMediaCategoryTypes:fetchRequestIdentifier:",  &off_100106D70,  v14);
