@interface TVHITunesUCourseViewController
- (TVHITunesUCourseViewController)initWithAlbum:(id)a3 mediaLibrary:(id)a4 albumsFetchContext:(id)a5 albumItemsFetchRequest:(id)a6;
- (TVHITunesUCourseViewController)initWithCourse:(id)a3 mediaLibrary:(id)a4 coursesFetchContext:(id)a5;
@end

@implementation TVHITunesUCourseViewController
...
- (TVHITunesUCourseViewController)initWithCourse:(id)a3 mediaLibrary:(id)a4 coursesFetchContext:(id)a5
{
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue( +[TVHKMediaEntitiesFetchRequest mediaItemsFetchRequestWithMediaCategoryType:]( &OBJC_CLASS___TVHKMediaEntitiesFetchRequest,  "mediaItemsFetchRequestWithMediaCategoryType:",  7LL));
  uint64_t v13 = TVHKCommonMediaItemProperties([v12 setIdentifier:@"ITunesUCourseEpisodesFetchRequestIdentifier"]);
  ...
  v22.receiver = self;
  v22.super_class = (Class)&OBJC_CLASS___TVHITunesUCourseViewController;
  ...
  if (v18)
  {
    ...
    v20 = (void *)objc_claimAutoreleasedReturnValue( [v19 localizedStringForKey:@"NO_ITUNES_U_EPISODES_FOUND_ERROR_MESSAGE" value:0 table:0]);
