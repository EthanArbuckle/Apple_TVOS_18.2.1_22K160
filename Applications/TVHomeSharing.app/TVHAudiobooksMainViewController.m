@interface TVHAudiobooksMainViewController
- (TVHAudiobooksDataStore)dataStore;
- (TVHAudiobooksMainViewController)initWithMediaLibrary:(id)a3 fetchRequests:(id)a4 mode:(unint64_t)a5 sourceMediaEntity:(id)a6 sourceMediaEntitiesFetchContext:(id)a7;
- (TVHAudiobooksMainViewController)initWithMediaLibrary:(id)a3 showingInTabBar:(BOOL)a4;
...
@implementation TVHAudiobooksMainViewController
...
- (TVHAudiobooksMainViewController)initWithMediaLibrary:(id)a3 showingInTabBar:(BOOL)a4
{
  BOOL v4 = a4;
  id v6 = a3;
  v7 = objc_alloc_init(&OBJC_CLASS___TVHAudiobooksDataStore);
  if (!v4)
  {
    v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](&OBJC_CLASS___NSBundle, "mainBundle"));
    v9 = (void *)objc_claimAutoreleasedReturnValue([v8 localizedStringForKey:@"AUDIOBOOKS_TITLE" value:0 table:0]);

    v10 = (void *)objc_claimAutoreleasedReturnValue(-[TVHAudiobooksDataStore catalogueDataSource](v7, "catalogueDataSource"));
    [v10 setHeaderTitle:v9];
  }

  v11 = (void *)objc_claimAutoreleasedReturnValue(-[TVHAudiobooksDataStore fetchRequests](v7, "fetchRequests"));
  v16.receiver = self;
  v16.super_class = (Class)&OBJC_CLASS___TVHAudiobooksMainViewController;
  ...
  if (v12)
  {
    ...
    v14 = (void *)objc_claimAutoreleasedReturnValue( [v13 localizedStringForKey:@"NO_AUDIOBOOKS_FOUND_ERROR_MESSAGE" value:0 table:0]);
...
- (id)mediaEntitiesFetchViewController:(id)a3 contentViewControllerWithFetchControllerResultSet:(id)a4 sourceMediaEntity:(id)a5 sourceMediaEntityBackgroundImageInfo:(id)a6
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[TVHAudiobooksMainViewController dataStore](self, "dataStore"));
  ...
  -[TVHAudiobooksMainViewController setCatalogueViewController:](self, "setCatalogueViewController:", v12);
  -[TVHAudiobooksMainViewController _updateWithFetchControllerResultSet:]( self,  "_updateWithFetchControllerResultSet:",  v7);
...
- (void)catalogViewController:(id)a3 didSelectMediaEntity:(id)a4
{
  ...
  if (v6 == v7)
  {
    v10 = -[TVHKMediaEntitiesFetchContext initWithFetchControllerIdentifier:fetchRequestIdentifier:]( v8,  "initWithFetchControllerIdentifier:fetchRequestIdentifier:",  v9,  @"AudiobookPlaylistsFetchRequestIdentifier");

    v12 = (void *)objc_claimAutoreleasedReturnValue(-[TVHMediaEntitiesFetchViewController mediaLibrary](self, "mediaLibrary"));
    v13 = (TVHAudiobookViewController *)objc_claimAutoreleasedReturnValue( +[TVHPlaylistViewControllerFactory playlistViewControllerWithPlaylist:mediaLibrary:playlistsFetchContext:playlistItemMediaCategoryTypes:]( &OBJC_CLASS___TVHPlaylistViewControllerFactory,  "playlistViewControllerWithPlaylist:mediaLibrary:playlistsFetchContext:playli stItemMediaCategoryTypes:",  v16,  v12,  v10,  &off_100106D58));
  }

  else
  {
    v10 = -[TVHKMediaEntitiesFetchContext initWithFetchControllerIdentifier:fetchRequestIdentifier:]( v8,  "initWithFetchControllerIdentifier:fetchRequestIdentifier:",  v9,  @"AudiobooksFetchRequestIdentifier");

    v11 = objc_alloc(&OBJC_CLASS___TVHAudiobookViewController);
    v12 = (void *)objc_claimAutoreleasedReturnValue(-[TVHMediaEntitiesFetchViewController mediaLibrary](self, "mediaLibrary"));
    v13 = -[TVHAudiobookViewController initWithAudiobook:mediaLibrary:audiobooksFetchContext:]( v11,  "initWithAudiobook:mediaLibrary:audiobooksFetchContext:",  v16,  v12,  v10);
  }
  ...
  if (v14)
  {
    v15 = (void *)objc_claimAutoreleasedReturnValue(-[TVHAudiobooksMainViewController navigationController](self, "navigationController"));
...
{
  id v4 = a3;
  id v5 = (id)objc_claimAutoreleasedReturnValue(-[TVHAudiobooksMainViewController catalogueViewController](self, "catalogueViewController"));
