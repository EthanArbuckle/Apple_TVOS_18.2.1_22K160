@interface TVHPodcastsDataStore
- (NSArray)fetchRequests;
- (TVHCatalogueDataSource)catalogueDataSource;
- (TVHPodcastsDataStore)init;
@end

@implementation TVHPodcastsDataStore

- (TVHPodcastsDataStore)init
{
  v29.receiver = self;
  v29.super_class = (Class)&OBJC_CLASS___TVHPodcastsDataStore;
  v2 = -[TVHPodcastsDataStore init](&v29, "init");
  if (v2)
  {
    v3 = (void *)objc_claimAutoreleasedReturnValue( +[TVHKMediaEntitiesFetchRequest mediaEntityCollectionsFetchRequestWithMediaEntityCollectionType:mediaCategoryType:]( &OBJC_CLASS___TVHKMediaEntitiesFetchRequest,  "mediaEntityCollectionsFetchRequestWithMediaEntityCollectionType:mediaCategoryType:",  1LL,  6LL));
    uint64_t v4 = TVHKCommonMediaEntityCollectionProperties([v3 setIdentifier:@"PodcastsFetchRequestIdentifier"]);
    ...
    v28 = (void *)objc_claimAutoreleasedReturnValue([v11 localizedStringForKey:@"PODCASTS_TITLE" value:0 table:0]);
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue( +[TVHKMediaEntitiesFetchRequest tvh_toplevelPlaylistsFetchRequestWithIdentifier:playlistItemMediaCategoryTypes:]( &OBJC_CLASS___TVHKMediaEntitiesFetchRequest,  "tvh_toplevelPlaylistsFetchRequestWithIdentifier:playlistItemMediaCategoryTypes:",  @"PodcastPlaylistsFetchRequestIdentifier",  &off_100106DD0));
    v13 = objc_alloc(&OBJC_CLASS___TVHCataloguePlaylistsItem);
    v14 = (void *)objc_claimAutoreleasedReturnValue([v12 identifier]);
    v26 = -[TVHCataloguePlaylistsItem initWithPlaylistItemMediaCategoryTypes:fetchRequestIdentifier:]( v13,  "initWithPlaylistItemMediaCategoryTypes:fetchRequestIdentifier:",  &off_100106DB8,  v14);
