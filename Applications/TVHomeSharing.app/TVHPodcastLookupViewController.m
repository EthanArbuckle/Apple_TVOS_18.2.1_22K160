@interface TVHPodcastLookupViewController
- (TVHPodcastLookupViewController)initWithMediaLibrary:(id)a3 fetchRequests:(id)a4 mode:(unint64_t)a5 sourceMediaEntity:(id)a6 sourceMediaEntitiesFetchContext:(id)a7;
- (TVHPodcastLookupViewController)initWithPodcastIdentifier:(id)a3 mediaLibrary:(id)a4;
...
@implementation TVHPodcastLookupViewController
...
- (TVHPodcastLookupViewController)initWithPodcastIdentifier:(id)a3 mediaLibrary:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  v8 = (void *)objc_claimAutoreleasedReturnValue( +[TVHKMediaEntitiesFetchRequest mediaEntityCollectionsFetchRequestWithMediaEntityCollectionType:mediaCategoryType:]( &OBJC_CLASS___TVHKMediaEntitiesFetchRequest,  "mediaEntityCollectionsFetchRequestWithMediaEntityCollectionType:mediaCategoryType:",  1LL,  6LL));
  uint64_t v9 = TVHKCommonMediaEntityCollectionProperties([v8 setIdentifier:@"PodcastFetchRequestIdentifier"]);
  ...
  v17.receiver = self;
  v17.super_class = (Class)&OBJC_CLASS___TVHPodcastLookupViewController;
  ...
  if (v13)
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue( [v14 localizedStringForKey:@"NO_PODCAST_FOUND_ERROR_MESSAGE" value:0 table:0]);
...
- (id)mediaEntitiesFetchViewController:(id)a3 contentViewControllerWithFetchControllerResultSet:(id)a4 sourceMediaEntity:(id)a5 sourceMediaEntityBackgroundImageInfo:(id)a6
{
  ...
  v10 = -[TVHKMediaEntitiesFetchContext initWithFetchControllerIdentifier:fetchRequestIdentifier:]( v8,  "initWithFetchControllerIdentifier:fetchRequestIdentifier:",  v9,  @"PodcastFetchRequestIdentifier");
  ...
  v13 = -[TVHPodcastViewController initWithPodcast:mediaLibrary:podcastsFetchContext:]( v11,  "initWithPodcast:mediaLibrary:podcastsFetchContext:",  v7,  v12,  v10);
