@interface TVHGradientMaskProperties
...
@implementation TVHGradientMaskProperties

+ (id)defaultGradientMaskProperties
{
  v2 = objc_alloc_init(&OBJC_CLASS___TVHGradientMaskProperties);
  -[TVHGradientMaskProperties setMinPadding:](v2, "setMinPadding:", 100.0, 100.0, 150.0, 100.0);
  -[TVHGradientMaskProperties setMinLengths:](v2, "setMinLengths:", 90.0, 90.0);
  return v2;
}
