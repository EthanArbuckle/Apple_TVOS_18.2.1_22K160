@interface TVHMovieLookupViewController
- (TVHKMediaEntityIdentifier)movieIdentifier;
- (TVHMovieLookupViewController)initWithMediaLibrary:(id)a3 fetchRequests:(id)a4 mode:(unint64_t)a5 sourceMediaEntity:(id)a6 sourceMediaEntitiesFetchContext:(id)a7;
- (TVHMovieLookupViewController)initWithMovieIdentifier:(id)a3 mediaLibrary:(id)a4;
...
@implementation TVHMovieLookupViewController
...
- (TVHMovieLookupViewController)initWithMovieIdentifier:(id)a3 mediaLibrary:(id)a4
{
  id v7 = a3;
  id v8 = a4;
  v9 = -[TVHMoviesDataStore initWithMediaLibrary:mode:]( objc_alloc(&OBJC_CLASS___TVHMoviesDataStore),  "initWithMediaLibrary:mode:",  v8,  1LL);
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[TVHMoviesDataStore fetchRequests](v9, "fetchRequests"));
  v15.receiver = self;
  v15.super_class = (Class)&OBJC_CLASS___TVHMovieLookupViewController;
...
- (id)mediaEntitiesFetchViewController:(id)a3 contentViewControllerWithFetchControllerResultSet:(id)a4 sourceMediaEntity:(id)a5 sourceMediaEntityBackgroundImageInfo:(id)a6
{
  id v7 = (void *)objc_claimAutoreleasedReturnValue(-[TVHMovieLookupViewController dataStore](self, "dataStore"));
  id v8 = (void *)objc_claimAutoreleasedReturnValue([v7 moviesInfoCenter]);

  v9 = (void *)objc_claimAutoreleasedReturnValue([v8 movieByIdentifier]);
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[TVHMovieLookupViewController movieIdentifier](self, "movieIdentifier"));
  ...
  if (v11)
  {
    ...
    v14 = -[TVHKMediaEntitiesFetchContext initWithFetchControllerIdentifier:fetchRequestIdentifier:]( v12,  "initWithFetchControllerIdentifier:fetchRequestIdentifier:",  v13,  @"MoviesFetchRequestIdentifier");
...
{
  id v4 = a3;
  id v5 = (id)objc_claimAutoreleasedReturnValue(-[TVHMovieLookupViewController dataStore](self, "dataStore"));
