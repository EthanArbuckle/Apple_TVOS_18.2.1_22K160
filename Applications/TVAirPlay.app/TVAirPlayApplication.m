@interface TVAirPlayApplication
+ (id)sharedApplication;
- (TVAirPlayApplication)init;
- (id)keyCommands;
- (void)dealloc;
@end

@implementation TVAirPlayApplication

+ (id)sharedApplication
{
  v4.receiver = a1;
  v4.super_class = (Class)&OBJC_METACLASS___TVAirPlayApplication;
...
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVAirPlayApplication;
  id v2 = -[TVAirPlayApplication init](&v4, "init");
  if (v2) {
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVAirPlayApplication;
  -[TVAirPlayApplication dealloc](&v4, "dealloc");
}

- (id)keyCommands
{
  id v2 = (void *)qword_10003F7B8;
  if (!qword_10003F7B8)
  {
