@interface PBUserProfileManagerServiceListener
- (void)activate;
- (void)dealloc;
- (void)invalidate;
@end

@implementation PBUserProfileManagerServiceListener
...
- (void)dealloc
{
  if (self->_listener)
  {
    ...
    if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR)) {
      sub_100286B48(a2, (uint64_t)self, (uint64_t)v4);
    }
  ...
  {
    v5.receiver = self;
    v5.super_class = (Class)&OBJC_CLASS___PBUserProfileManagerServiceListener;
    -[PBUserProfileManagerServiceListener dealloc](&v5, "dealloc");
  }
