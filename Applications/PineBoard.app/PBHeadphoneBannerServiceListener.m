@interface PBHeadphoneBannerServiceListener
...
@implementation PBHeadphoneBannerServiceListener
...
- (void)listener:(id)a3 didReceiveConnection:(id)a4 withContext:(id)a5
{
  ...
  if ([v6 hasEntitlement:@"com.apple.appletv.pbs.headphone-banner-service-access"])
  {
    v12[0] = _NSConcreteStackBlock;
    v12[1] = 3221225472LL;
    v12[2] = sub_100200514;
    v12[3] = &unk_1003D2DF0;
    v7 = objc_alloc_init(&OBJC_CLASS___PBHeadphoneBannerService);
    v13 = v7;
