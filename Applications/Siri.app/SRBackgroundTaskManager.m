...
{
  v13.receiver = self;
  v13.super_class = (Class)&OBJC_CLASS___SRBackgroundTaskManager;
  ...
  if (v2)
  {
    ...
    {
      v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInteger:]( &OBJC_CLASS___NSNumber,  "numberWithUnsignedInteger:",  v2->_taskIdentifier,  v7,  v8,  v9,  v10));
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___SRBackgroundTaskManager;
...
- (void)_endBackgroundTask
{
  if (self->_taskIdentifier != UIBackgroundTaskInvalid)
  {
    ...
    if (os_log_type_enabled(AFSiriLogContextConnection, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v5 = v3;
      v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInteger:]( &OBJC_CLASS___NSNumber,  "numberWithUnsignedInteger:",  taskIdentifier));
      int v8 = 136315650;
    ...
    __int16 v7 = (void *)objc_claimAutoreleasedReturnValue(+[UIApplication sharedApplication](&OBJC_CLASS___UIApplication, "sharedApplication"));
