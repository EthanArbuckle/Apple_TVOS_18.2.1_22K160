...
- (id)sr_sirilandShim
{
  ...
  if (v3 && [v3 count])
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue( -[SAPhoneCallSnippet _searchCallHistoryIntentForVoicemail:]( self,  "_searchCallHistoryIntentForVoicemail:",  0LL));
    v65 = v11;
    ...
    *(void *)&double v36 = objc_opt_class(v13, v35).n128_u64[0];
    ...
    v45 = (SAPhoneCallSnippet *)objc_alloc_init(&OBJC_CLASS___SACardSnippet);
    ...
    if (AFIsInternalInstall(v50, v51))
    {
      ...
      if (v53)
      {
        id v54 = sub_1000348D4(@"CALL_HISTORY_SASH_TITLE");
