...
- (void)scene:(id)a3 willConnectToSession:(id)a4 options:(id)a5
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue([v7 _FBSScene]);
  v12 = (void *)objc_claimAutoreleasedReturnValue([v11 settings]);

  id v13 = [v12 interfaceOrientation];
  v14 = (void *)objc_claimAutoreleasedReturnValue(+[SRApplication sharedApplication](&OBJC_CLASS___SRApplication, "sharedApplication"));
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue([v16 appWindow]);
...
- (void)sceneDidDisconnect:(id)a3
{
  ...
  id v7 = (void *)objc_claimAutoreleasedReturnValue([v6 appWindow]);
