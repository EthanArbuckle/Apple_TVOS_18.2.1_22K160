...
- (SRCompactKeyboardAnimation)initWithDuration:(double)a3 curve:(int64_t)a4 beginningFrame:(CGRect)a5 endingFrame:(CGRect)a6
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)&OBJC_CLASS___SRCompactKeyboardAnimation;
...
- (SRCompactKeyboardAnimation)initWithKeyboardNotification:(id)a3
{
  ...
  if ((sub_10001450C(v4) & 1) != 0)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue([v5 objectForKey:UIKeyboardAnimationDurationUserInfoKey]);
    [v6 doubleValue];
    double v8 = v7;
    ...
    {
      v12 = (void *)objc_claimAutoreleasedReturnValue([v5 objectForKey:UIKeyboardAnimationCurveUserInfoKey]);
      id v13 = [v12 unsignedIntegerValue];

      objc_super v14 = (void *)objc_claimAutoreleasedReturnValue([v5 objectForKey:UIKeyboardFrameBeginUserInfoKey]);
      [v14 CGRectValue];
      double v32 = v15;
      double v17 = v16;
      double v19 = v18;
      ...
      v22 = (void *)objc_claimAutoreleasedReturnValue([v5 objectForKey:UIKeyboardFrameEndUserInfoKey]);
      [v22 CGRectValue];
      uint64_t v24 = v23;
      uint64_t v26 = v25;
      uint64_t v28 = v27;
