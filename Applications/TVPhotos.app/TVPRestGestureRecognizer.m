@interface TVPRestGestureRecognizer
- (CGPoint)digitizerLocation;
- (CGPoint)digitizerStartLocation;
- (NSTimer)pressDurationTimer;
- (TVPRestGestureRecognizer)initWithTarget:(id)a3 action:(SEL)a4;
...
@implementation TVPRestGestureRecognizer

- (TVPRestGestureRecognizer)initWithTarget:(id)a3 action:(SEL)a4
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___TVPRestGestureRecognizer;
  v4 = -[TVPRestGestureRecognizer initWithTarget:action:](&v7, "initWithTarget:action:", a3, a4);
  v5 = v4;
  if (v4)
  {
    -[TVPRestGestureRecognizer setDelaysTouchesEnded:](v4, "setDelaysTouchesEnded:", 0LL);
    -[TVPRestGestureRecognizer setAllowedPressTypes:](v5, "setAllowedPressTypes:", &off_1000D1B58);
    -[TVPRestGestureRecognizer setAllowedTouchTypes:](v5, "setAllowedTouchTypes:", &off_1000D1B70);
  }
...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  id v6 = a4;
  id v7 = a3;
  -[TVPRestGestureRecognizer minimumPressDuration](self, "minimumPressDuration");
...
- (void)touchesMoved:(id)a3 withEvent:(id)a4
{
  ...
  {
    if (-[TVPRestGestureRecognizer state](self, "state")) {
      -[TVPRestGestureRecognizer setState:](self, "setState:", 2LL);
    }
  }
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  if (!v11) {
    -[TVPRestGestureRecognizer setState:](self, "setState:", 3LL);
  }
}
...
- (void)touchesCancelled:(id)a3 withEvent:(id)a4
{
  ...
  self->_touchCount = v11;
  if (!v11) {
    -[TVPRestGestureRecognizer setState:](self, "setState:", 4LL);
  }
}
...
- (void)recognizeFingerRest
{
  ...
  -[TVPRestGestureRecognizer setState:](self, "setState:", self->_stateToEnter);
}
...
LABEL_3:
    ...
    id v13 = -[TVPRestGestureRecognizer state](self, "state");
    int64_t v14 = 1LL;
    if (v13 == (id)1) {
      int64_t v14 = 2LL;
    }
