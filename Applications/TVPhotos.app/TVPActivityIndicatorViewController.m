@interface TVPActivityIndicatorViewController
- (BOOL)isActivityIndicatorHidden;
- (NSString)activityText;
- (TVPActivityIndicatorViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
@implementation TVPActivityIndicatorViewController

- (TVPActivityIndicatorViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___TVPActivityIndicatorViewController;
  result = -[TVPActivityIndicatorViewController initWithNibName:bundle:](&v5, "initWithNibName:bundle:", a3, a4);
  if (result) {
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___TVPActivityIndicatorViewController;
  -[TVPActivityIndicatorViewController dealloc](&v5, "dealloc");
}
...
- (void)loadView
{
  ...
  -[TVPActivityIndicatorViewController setView:](self, "setView:", v15);
...
{
  v12.receiver = self;
  v12.super_class = (Class)&OBJC_CLASS___TVPActivityIndicatorViewController;
  -[TVPActivityIndicatorViewController viewWillAppear:](&v12, "viewWillAppear:", a3);
  ...
  if ((v4 & 1) == 0)
  {
    ...
    if (v8)
    {
      if (!activityTextLabel)
      {
        ...
        double v13 = (void *)objc_claimAutoreleasedReturnValue(+[TVPThemeManager title2Font](&OBJC_CLASS___TVPThemeManager, "title2Font"));
...
LABEL_11:
      double v17 = (void *)objc_claimAutoreleasedReturnValue(-[TVPActivityIndicatorViewController view](self, "view"));
      [v17 layoutIfNeeded];
