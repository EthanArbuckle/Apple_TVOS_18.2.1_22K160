@interface TVPDeckImageView
- (BOOL)isInOrder;
- (BOOL)isPaused;
- (BOOL)isShuffled;
- (CGRect)imageFrame;
- (NSArray)imageProxies;
- (TVPDeckImageView)initWithFrame:(CGRect)a3;
- (UIImage)placeholderImage;
- (double)cycleInterval;
- (double)newDataTransitionDuration;
- (double)transitionDuration;
- (unint64_t)_paradeThreshold;
- (unint64_t)_viewTypeForNumberOfImages:(int64_t)a3;
...
@implementation TVPDeckImageView
...
- (TVPDeckImageView)initWithFrame:(CGRect)a3
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___TVPDeckImageView;
  v5 = -[TVPDeckImageView initWithFrame:](&v11, "initWithFrame:", a3.origin.x, a3.origin.y);
  v6 = v5;
  if (v5)
  {
    ...
    [v7 addObserver:v6 selector:"_paradeViewReadyNotification:" name:off_100101600 object:0];
    ...
    [v8 addObserver:v6 selector:"_scrollingParadeViewReadyNotification:" name:@"TVPScrollingParadeViewWillDisplayNotification" object:0];
    ...
    [v9 addObserver:v6 selector:"_crossfadeViewReadyNotification:" name:off_100101C68 object:0];
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TVPDeckImageView;
  -[TVPDeckImageView dealloc](&v3, "dealloc");
}
...
- (void)layoutSubviews
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TVPDeckImageView;
  -[TVPDeckImageView layoutSubviews](&v3, "layoutSubviews");
  if (self->_viewType - 1 > 1) {
    -[TVPDeckImageView bounds](self, "bounds");
  }
  else {
    -[TVPDeckImageView imageFrame](self, "imageFrame");
  }
...
- (void)_crossfadeViewReadyNotification:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[TVPDeckImageView superview](self, "superview"));
  if (v4)
  {
    ...
    if (pendingDisplayView == v6)
    {
      ...
      -[TVPDeckImageView transitionDuration](self, "transitionDuration");
      -[UIView setCrossfadeDuration:](v6, "setCrossfadeDuration:");
      -[TVPDeckImageView _dissolveToPendingView](self, "_dissolveToPendingView");
    }
  }
}
...
{
  id v8 = a3;
  uint64_t v4 = objc_claimAutoreleasedReturnValue(-[TVPDeckImageView superview](self, "superview"));
  if (v4)
  {
    v5 = (void *)v4;
    pendingDisplayView = self->_pendingDisplayView;
...
{
  id v12 = a3;
  uint64_t v4 = (NSArray *)[v12 copy];
  imageProxies = self->_imageProxies;
  self->_imageProxies = v4;

  self->_unint64_t pendingViewType = -[TVPDeckImageView _viewTypeForNumberOfImages:]( self,  "_viewTypeForNumberOfImages:",  -[NSArray count](self->_imageProxies, "count"));
  if (self->_placeholderImage) {
    -[TVPDeckImageView _displayPlaceholderView](self, "_displayPlaceholderView");
  }
  else {
    -[TVPDeckImageView performSelector:withObject:afterDelay:]( self,  "performSelector:withObject:afterDelay:",  "_fadeToBlack",  0LL,  self->_imageLoadTimeout);
  }
  unint64_t pendingViewType = self->_pendingViewType;
  if (pendingViewType - 1 < 2)
  {
    v7 = objc_alloc(&OBJC_CLASS___TVPImageCrossfadeView);
    -[TVPDeckImageView imageFrame](self, "imageFrame");
    id v8 = -[TVPImageCrossfadeView initWithFrame:](v7, "initWithFrame:");
    -[TVPDeckImageView cycleInterval](self, "cycleInterval");
...
LABEL_10:
    ...
    -[UIView setImageProxies:](v11, "setImageProxies:", self->_imageProxies);
    goto LABEL_11;
  }

  if (pendingViewType == 3)
  {
    v10 = objc_alloc(&OBJC_CLASS___TVPScrollingParadeView);
    -[TVPDeckImageView bounds](self, "bounds");
    id v8 = -[TVPScrollingParadeView initWithFrame:](v10, "initWithFrame:");
    pendingDisplayView = self->_pendingDisplayView;
    self->_pendingDisplayView = v8;
    goto LABEL_10;
  }
...
- (void)setImageFrame:(CGRect)a3
{
  ...
  if (!CGRectEqualToRect(self->_imageFrame, a3))
  {
    ...
    -[TVPDeckImageView setNeedsLayout](self, "setNeedsLayout");
  }
...
- (void)setShuffled:(BOOL)a3
{
  BOOL v3 = a3;
  displayView = self->_displayView;
  uint64_t v6 = objc_opt_class(&OBJC_CLASS___TVPParadeView, a2);
...
{
  displayView = self->_displayView;
  uint64_t v4 = objc_opt_class(&OBJC_CLASS___TVPParadeView, a2);
...
- (void)_dissolveToPendingView
{
  ...
  -[TVPDeckImageView newDataTransitionDuration](self, "newDataTransitionDuration");
  double v8 = v7;
...
- (void)_fadeToBlack
{
  BOOL v3 = (void *)objc_claimAutoreleasedReturnValue(-[TVPDeckImageView superview](self, "superview"));
  if (v3)
  {
    displayView = self->_displayView;
...
- (unint64_t)_viewTypeForNumberOfImages:(int64_t)a3
{
  ...
  if (-[TVPDeckImageView _paradeThreshold](self, "_paradeThreshold") >= a3) {
    return 2LL;
  }
  return 3LL;
}
