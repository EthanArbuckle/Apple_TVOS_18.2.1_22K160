...
- (TVSSVPNMenuItemProvider)initWithNetworkController:(id)a3;
- (id)log;
- (id)newMenuItem;
- (void)dealloc;
...
@implementation TVSSVPNMenuItemProvider
...
- (TVSSVPNMenuItemProvider)initWithNetworkController:(id)a3
{
  ...
  if (!v31)
  {
    ...
    if (os_log_type_enabled((os_log_t)v27, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = v16;
      sub_10000583C( (uint64_t)v36,  (uint64_t)v13,  (uint64_t)v24,  (uint64_t)v34,  (uint64_t)@"TVSSVPNMenuItemProvider.m",  39,  (uint64_t)v28);
  ...
  if (((objc_opt_isKindOfClass(v31, v29) ^ 1) & 1) != 0)
  {
    ...
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = v11;
      sub_10000583C( (uint64_t)v35,  (uint64_t)v8,  (uint64_t)v19,  (uint64_t)v34,  (uint64_t)@"TVSSVPNMenuItemProvider.m",  39,  (uint64_t)v23);
  ...
  v34 = 0LL;
  v18.receiver = v5;
  v18.super_class = (Class)&OBJC_CLASS___TVSSVPNMenuItemProvider;
  v34 = -[TVSSMenuItemProvider initWithIdentifier:]( &v18,  "initWithIdentifier:",  @"com.apple.TVSystemUIService.vpn.provider");
...
- (void)dealloc
{
  ...
  v2.receiver = v4;
  v2.super_class = (Class)&OBJC_CLASS___TVSSVPNMenuItemProvider;
  -[TVSSVPNMenuItemProvider dealloc](&v2, "dealloc");
}
...
- (BOOL)shouldShowMenuItem
{
  ...
  char v3 = [v4[0] isVPNConfigured] & 1;
...
- (id)newMenuItem
{
  v8[2] = self;
  v8[1] = (id)a2;
  v8[0] = -[TVSSMenuItem initWithIdentifier:hasFocusableContent:platterViewControllerClass:]( objc_alloc(&OBJC_CLASS___TVSSMenuItem),  "initWithIdentifier:hasFocusableContent:platterViewControllerClass:",  @"com.apple.TVSystemUIService.vpn.item",  1LL,  objc_opt_class(&OBJC_CLASS___TVSSVPNPanelViewController));
...
- (id)log
{
  id v4 = (dispatch_once_t *)&unk_100221C08;
  id location = 0LL;
  objc_storeStrong(&location, &stru_1001B72B8);
  if (*v4 != -1) {
    dispatch_once(v4, location);
  }
  objc_storeStrong(&location, 0LL);
  return (id)qword_100221C00;
}
