...
@implementation _TVSSMenuBarHiddenToBannerAnimationTransaction
...
- (void)_begin
{
  ...
  SEL v12 = a2;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS____TVSSMenuBarHiddenToBannerAnimationTransaction;
  -[_TVSSMenuBarHiddenToBannerAnimationTransaction _begin](&v11, "_begin");
  ...
  if (TVSSBannerPresentableAppearsInsidePillView(v10))
  {
    ...
    -[_TVSSMenuBarHiddenToBannerAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v9);
    objc_storeStrong((id *)&v9, 0LL);
  }

  else
  {
    v2 = objc_alloc(&OBJC_CLASS____TVSSBannerPresentToastSubTransaction);
    ...
    -[_TVSSMenuBarHiddenToBannerAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v8);
