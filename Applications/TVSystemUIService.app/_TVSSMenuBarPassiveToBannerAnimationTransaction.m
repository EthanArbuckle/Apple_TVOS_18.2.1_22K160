...
@implementation _TVSSMenuBarPassiveToBannerAnimationTransaction
...
- (void)_begin
{
  ...
  SEL v12 = a2;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS____TVSSMenuBarPassiveToBannerAnimationTransaction;
  -[_TVSSMenuBarPassiveToBannerAnimationTransaction _begin](&v11, "_begin");
  ...
  if (TVSSBannerPresentableAppearsInsidePillView(v10))
  {
    ...
    -[_TVSSMenuBarPassiveToBannerAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v9);
  ...
  else
  {
    ...
    -[_TVSSMenuBarPassiveToBannerAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v8);
