...
@implementation _TVSSMenuBarPrivacyToInteractiveAnimationTransaction
...
- (void)_begin
{
  ...
  SEL v9 = a2;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS____TVSSMenuBarPrivacyToInteractiveAnimationTransaction;
  -[_TVSSMenuBarPrivacyToInteractiveAnimationTransaction _begin](&v8, "_begin");
  ...
  -[_TVSSMenuBarPrivacyToInteractiveAnimationTransaction addChildTransaction:withSchedulingPolicy:]( v10,  "addChildTransaction:withSchedulingPolicy:",  v7);
  ...
  -[_TVSSMenuBarPrivacyToInteractiveAnimationTransaction addChildTransaction:withSchedulingPolicy:]( v10,  "addChildTransaction:withSchedulingPolicy:",  v6,  0LL);
