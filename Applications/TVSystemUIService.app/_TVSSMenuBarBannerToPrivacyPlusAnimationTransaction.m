...
@implementation _TVSSMenuBarBannerToPrivacyPlusAnimationTransaction
...
- (void)_begin
{
  ...
  SEL v12 = a2;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS____TVSSMenuBarBannerToPrivacyPlusAnimationTransaction;
  -[_TVSSMenuBarBannerToPrivacyPlusAnimationTransaction _begin](&v11, "_begin");
  ...
  if (TVSSBannerPresentableAppearsInsidePillView(v10))
  {
    ...
    -[_TVSSMenuBarBannerToPrivacyPlusAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v9);
  ...
  else
  {
    ...
    -[_TVSSMenuBarBannerToPrivacyPlusAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v8);
