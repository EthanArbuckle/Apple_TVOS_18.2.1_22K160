...
@implementation _TVSSMenuBarBannerToHiddenAnimationTransaction
...
- (void)_begin
{
  ...
  SEL v9 = a2;
  v8.receiver = self;
  v8.super_class = (Class)&OBJC_CLASS____TVSSMenuBarBannerToHiddenAnimationTransaction;
  -[_TVSSMenuBarBannerToHiddenAnimationTransaction _begin](&v8, "_begin");
  ...
  {
    v2 = objc_alloc(&OBJC_CLASS____TVSSBannerDismissToastSubTransaction);
    ...
    -[_TVSSMenuBarBannerToHiddenAnimationTransaction addChildTransaction:](v10, "addChildTransaction:", v6);
