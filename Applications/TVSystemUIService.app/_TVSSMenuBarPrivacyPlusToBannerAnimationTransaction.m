...
@implementation _TVSSMenuBarPrivacyPlusToBannerAnimationTransaction
...
- (void)_begin
{
  ...
  SEL v12 = a2;
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS____TVSSMenuBarPrivacyPlusToBannerAnimationTransaction;
  -[_TVSSMenuBarPrivacyPlusToBannerAnimationTransaction _begin](&v11, "_begin");
  ...
  if (TVSSBannerPresentableAppearsInsidePillView(v10))
  {
    ...
    -[_TVSSMenuBarPrivacyPlusToBannerAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v9);
    objc_storeStrong((id *)&v9, 0LL);
  }

  else
  {
    v2 = objc_alloc(&OBJC_CLASS____TVSSBannerPresentToastFadeOutMenuTransaction);
    ...
    -[_TVSSMenuBarPrivacyPlusToBannerAnimationTransaction addChildTransaction:](v13, "addChildTransaction:", v8);
