...
+ (id)artworkURLFromTemplate:(id)a3 forSize:(CGSize)a4 cropCode:(id)a5 format:(id)a6
{
  ...
  id v11 = a6;
  v12 = (void *)objc_claimAutoreleasedReturnValue( +[WLKArtworkVariant artworkURLFromTemplate:forSize:cropCode:format:]( &OBJC_CLASS___WLKArtworkVariant,  "artworkURLFromTemplate:forSize:cropCode:format:",  a3,  a5,  v10,  width,  height));
