...
- (_TtC8AppStore28ScreenshotCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore28ScreenshotCollectionViewCell *)sub_10000F680( a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC8AppStore28ScreenshotCollectionViewCell_artworkView];
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore28ScreenshotCollectionViewCell_artworkView));
}
