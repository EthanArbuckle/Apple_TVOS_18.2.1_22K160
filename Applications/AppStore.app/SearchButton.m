...
- (_TtC8AppStore12SearchButton)initWithFrame:(CGRect)a3;
...
- (_TtC8AppStore12SearchButton)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC8AppStore12SearchButton *)_swift_stdlib_reportUnimplementedInitializer( "AppStore.SearchButton",  21LL,  "init(frame:)",  12LL,  0LL);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  swift_release(*(Class *)((char *)&self->super.super.super.super.super.super.isa
                         + OBJC_IVAR____TtC8AppStore12SearchButton_objectGraph));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore12SearchButton_backgroundEffectView));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore12SearchButton_imageView));
}
