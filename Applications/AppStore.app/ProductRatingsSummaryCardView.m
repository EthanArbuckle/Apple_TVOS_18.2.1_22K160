...
- (_TtC8AppStore29ProductRatingsSummaryCardView)initWithFrame:(CGRect)a3;
...
- (_TtC8AppStore29ProductRatingsSummaryCardView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore29ProductRatingsSummaryCardView *)sub_10004B94C( a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  uint64_t v3 = qword_1002E0448;
  v4 = self;
  if (v3 != -1) {
    swift_once(&qword_1002E0448, sub_10004B688);
  }
  unsigned __int128 v5 = xmmword_1002F2710;
...
- (UILabel)accessibilityCurrentRatingLabel
{
  return (UILabel *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.super.super.super.isa
                                                            + OBJC_IVAR____TtC8AppStore29ProductRatingsSummaryCardView_ratingLabel));
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore29ProductRatingsSummaryCardView_ratingLabel));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore29ProductRatingsSummaryCardView_outOfRatingLabel));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore29ProductRatingsSummaryCardView_starRatingView));
}
