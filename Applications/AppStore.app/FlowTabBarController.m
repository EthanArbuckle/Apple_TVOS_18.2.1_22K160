...
- (_TtC8AppStore20FlowTabBarController)initWithTabs:(id)a3
{
  uint64_t v5 = sub_10000DFD4(0LL, &qword_1002EE918, &OBJC_CLASS___UITab_ptr);
  uint64_t v6 = static Array._unconditionallyBridgeFromObjectiveC(_:)(a3, v5);
  v7 = (char *)self + OBJC_IVAR____TtC8AppStore20FlowTabBarController_flowController;
  *(_OWORD *)v7 = 0u;
  *((_OWORD *)v7 + 1) = 0u;
  *((void *)v7 + 4) = 0LL;
  *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore20FlowTabBarController_actionRunner) = 0LL;
...
- (_TtC8AppStore20FlowTabBarController)initWithNibName:(id)a3 bundle:(id)a4
{
  if (a3)
  {
    ...
    uint64_t v7 = v6;
    v8 = (char *)self + OBJC_IVAR____TtC8AppStore20FlowTabBarController_flowController;
    *(_OWORD *)v8 = 0u;
    *((_OWORD *)v8 + 1) = 0u;
    *((void *)v8 + 4) = 0LL;
    *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore20FlowTabBarController_actionRunner) = 0LL;
  ...
  {
    objc_super v11 = (char *)self + OBJC_IVAR____TtC8AppStore20FlowTabBarController_flowController;
