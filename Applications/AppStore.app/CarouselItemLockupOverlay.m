...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_focusGuide);
  v6 = self;
  objc_msgSend(v5, "_setManualLayoutFrame:", 0.0, 0.0, width, height);
  sub_100138DB8(1, v13, v7);
  double v8 = sub_100138268((uint64_t)v13, width, height);
  double v10 = v9;
...
- (void)didUpdateFocusInContext:(id)a3 withAnimationCoordinator:(id)a4
{
  ...
  double v9 = *(void **)&v8[OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_floatingView];
  else {
    uint64_t v10 = 0LL;
  }
...
- (void)pressesBegan:(id)a3 withEvent:(id)a4
{
  ...
  [*(id *)((char *)&v11->super.super.super.isa + OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_floatingView) setControlState:0 animated:1];
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_focusGuide));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_floatingView));
  objc_release(*(id *)((char *)&self->super.super.super.isa
  ...
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_chevronView));
  sub_10000A450( *(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_selectionHandler),  *(void *)&self->focusGuide[OBJC_IVAR____TtC8AppStore25CarouselItemLockupOverlay_selectionHandler]);
}
