...
- (_TtC8AppStore30ArcadeFooterCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore30ArcadeFooterCollectionViewCell *)sub_1000F968C( a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
...
- (NSArray)preferredFocusEnvironments
{
  ...
  else
  {
    ...
    *(_OWORD *)(v6 + 16) = xmmword_100236BD0;
    *(void *)(v6 + 32) = v2;
    v10 = (void *)v6;
...
- (BOOL)canBecomeFocused
{
  return [*(id *)((char *)&self->super.super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore30ArcadeFooterCollectionViewCell_buttonView) isFocused] ^ 1;
}

- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore30ArcadeFooterCollectionViewCell_wordmarkImageView));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore30ArcadeFooterCollectionViewCell_buttonView));
}
