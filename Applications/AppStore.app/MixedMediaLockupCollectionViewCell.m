...
- (_TtC8AppStore16DynamicTypeLabel)accessibilityTaglineLabel;
...
- (_TtC8AppStore34MixedMediaLockupCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore34MixedMediaLockupCollectionViewCell *)sub_1000CE4B0( a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
...
- (void)setTransform3D:(CATransform3D *)a3
{
  ...
  *(_OWORD *)&v15.m41 = v7;
  ...
  __int128 v6 = *(void **)&v5[OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_taglineLabel];
  [v5 transform3D];
...
- (_TtC8AppStore9VideoView)accessibilityVideoView
{
  return (_TtC8AppStore9VideoView *)objc_autoreleaseReturnValue((id)swift_unknownObjectWeakLoadStrong( *(char **)((char *)&(*(Class *)((char *)&self->super.super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_mediaView))->isa + OBJC_IVAR____TtC8AppStore15LockupMediaView_videoContainer)
                                                                    + OBJC_IVAR____TtC8AppStore18VideoViewContainer_view));
}

- (_TtC8AppStore15LockupMediaView)accessibilityMediaView
{
  return (_TtC8AppStore15LockupMediaView *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.super.super.super.isa
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_backdropView));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_lockupView));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_mediaView));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_taglineLabel));
  sub_1000077E0( (uint64_t)self + OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_overrideLockupPosition,  &qword_1002E8670);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore34MixedMediaLockupCollectionViewCell_pillView));
}
