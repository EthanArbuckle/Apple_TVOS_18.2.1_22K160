...
- (_TtC25AppStoreTopShelfExtension23TopShelfContentProvider)init;
...
{
  v4 = _Block_copy(a3);
  uint64_t v5 = swift_allocObject(&unk_100015400, 24LL, 7LL);
  *(void *)(v5 + 16) = v4;
  ...
  *(_OWORD *)(v11 + 16) = xmmword_100012CD0;
  LogMessage.init(stringLiteral:)(0xD000000000000019LL, 0x8000000100011CC0LL);
  Logger.info(_:)(v11, v8, &protocol witness table for OSLogger);
  swift_bridgeObjectRelease(v11);
  uint64_t v12 = swift_allocObject(&unk_100015428, 32LL, 7LL);
  *(void *)(v12 + 16) = sub_100006A4C;
  *(void *)(v12 + 24) = v5;
  uint64_t v13 = swift_allocObject(&unk_100015450, 32LL, 7LL);
  *(void *)(v13 + 16) = sub_100006A4C;
  *(void *)(v13 + 24) = v5;
  swift_retain_n(v5, 2LL);
  sub_10000E96C((uint64_t)sub_100006A80, v12, (uint64_t)sub_100006A88, v13);
...
- (void)performCustomActionWithURL:(id)a3 actionUserInfo:(id)a4 forItemWithIdentifier:(id)a5 itemUserInfo:(id)a6 completionHandler:(id)a7
{
  ...
  uint64_t v21 = swift_allocObject(&unk_100015310, 24LL, 7LL);
  *(void *)(v21 + 16) = v17;
  v22 = self;
  sub_100005DE8((uint64_t)v16, (uint64_t)a4, v18, v20, (void (*)(void))sub_100006D0C, v21);
...
- (_TtC25AppStoreTopShelfExtension23TopShelfContentProvider)init
{
  ...
  uint64_t v8 = OBJC_IVAR____TtC25AppStoreTopShelfExtension23TopShelfContentProvider_bootstrap;
  uint64_t v9 = qword_100019280;
  uint64_t v10 = self;
  if (v9 != -1) {
    swift_once(&qword_100019280, sub_100008014);
  }
  uint64_t v11 = sub_1000053B0(v4, (uint64_t)qword_10001A0D0);
  (*(void (**)(char *, uint64_t, uint64_t))(v5 + 16))(v7, v11, v4);
  uint64_t v12 = type metadata accessor for TopShelfBootstrap(0LL);
  swift_allocObject(v12, *(unsigned int *)(v12 + 48), *(unsigned __int16 *)(v12 + 52));
  *(void *)&v10->TVTopShelfContentProvider_opaque[v8] = sub_10000ED1C((uint64_t)v7);
