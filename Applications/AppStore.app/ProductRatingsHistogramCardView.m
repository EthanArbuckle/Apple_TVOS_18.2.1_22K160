...
- (_TtC8AppStore31ProductRatingsHistogramCardView)initWithFrame:(CGRect)a3;
...
- (_TtC8AppStore31ProductRatingsHistogramCardView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore31ProductRatingsHistogramCardView *)sub_1000F7160( a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  uint64_t v3 = qword_1002E0B70;
  v4 = self;
  if (v3 != -1) {
    swift_once(&qword_1002E0B70, sub_1000F6EDC);
  }
  unsigned __int128 v5 = xmmword_1002F4370;
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore31ProductRatingsHistogramCardView_titleLabel));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore31ProductRatingsHistogramCardView_subtitleLabel));
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.super.super.isa
                                     + OBJC_IVAR____TtC8AppStore31ProductRatingsHistogramCardView_starViews));
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.super.super.isa
