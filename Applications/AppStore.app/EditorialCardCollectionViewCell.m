...
- (_TtC8AppStore16DynamicTypeLabel)accessibilityCaptionLabel;
...
- (_TtC8AppStore31EditorialCardCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore31EditorialCardCollectionViewCell *)sub_10016BF48( a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
