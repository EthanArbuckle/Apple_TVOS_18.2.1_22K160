...
- (_TtC8AppStore22CardCollectionViewCell)initWithFrame:(CGRect)a3;
...
- (_TtC8AppStore22CardCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore22CardCollectionViewCell *)sub_100049B74(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
