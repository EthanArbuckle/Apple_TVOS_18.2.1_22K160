...
- (_TtC8AppStore28SnapshotPageTraitEnvironment)init
{
  UIEdgeInsets result = (_TtC8AppStore28SnapshotPageTraitEnvironment *)_swift_stdlib_reportUnimplementedInitializer( "AppStore.SnapshotPageTraitEnvironment",  37LL,  "init()",  6LL,  0LL);
  __break(1u);
  return result;
}
