...
- (_TtC8AppStore13SeparatorView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore13SeparatorView *)sub_100010A48(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore13SeparatorView)initWithCoder:(id)a3
{
  ...
  uint64_t v9 = OBJC_IVAR____TtC8AppStore13SeparatorView_lineColor;
  sub_10000EA38();
  *(Class *)((char *)&self->super.super.super.super.isa + v9) = (Class)static UIColor.defaultLine.getter(a3);
  ...
  result = (_TtC8AppStore13SeparatorView *)_assertionFailure(_:_:file:line:flags:)( "Fatal error",  11LL,  2LL,  0xD000000000000025LL,  0x8000000100247230LL,  "AppStore/SeparatorView.swift",  28LL,  2LL,  54LL,  0);
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  uint64_t v9 = (char *)self + OBJC_IVAR____TtC8AppStore13SeparatorView_separator;
  swift_beginAccess((char *)self + OBJC_IVAR____TtC8AppStore13SeparatorView_separator, v15, 0LL, 0LL);
...
- (CGSize)intrinsicContentSize
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR____TtC8AppStore13SeparatorView_separator, v13, 0LL, 0LL);
