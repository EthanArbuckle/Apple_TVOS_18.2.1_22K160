...
- (_TtC8AppStore31ArtworkDisplayingViewController)initWithCoder:(id)a3;
- (_TtC8AppStore31ArtworkDisplayingViewController)initWithNibName:(id)a3 bundle:(id)a4;
- (void)loadView;
@end
...
- (void)loadView
{
  ...
  {
    v3 = (_TtC8AppStore31ArtworkDisplayingViewController *)objc_msgSend( objc_allocWithZone(UIImageView),  "initWithFrame:",  0.0,  0.0,  0.0,  0.0);
