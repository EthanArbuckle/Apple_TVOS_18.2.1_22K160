...
- (_TtC8AppStore21SectionBackgroundView)initWithCoder:(id)a3;
- (_TtC8AppStore21SectionBackgroundView)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
...
- (void)layoutSubviews
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC8AppStore21SectionBackgroundView_artworkView];
  if (v3)
  {
    v4 = v3;
...
- (_TtC8AppStore21SectionBackgroundView)initWithFrame:(CGRect)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore21SectionBackgroundView_artworkView) = 0LL;
  v8.receiver = self;
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore21SectionBackgroundView_artworkView));
}
