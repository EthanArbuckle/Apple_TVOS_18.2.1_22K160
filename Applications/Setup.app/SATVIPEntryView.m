@interface SATVIPEntryView
- (CGSize)sizeThatFits:(CGSize)a3;
- (NSArray)digitViews;
- (NSArray)dotViews;
- (NSString)IPAddress;
- (NSString)ipString;
- (SATVIPEntryView)initWithIPAddress:(id)a3;
- (SATVIPEntryViewDelegate)delegate;
- (UIButton)doneButton;
...
@implementation SATVIPEntryView

- (SATVIPEntryView)initWithIPAddress:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)&OBJC_CLASS___SATVIPEntryView;
  v5 = -[SATVIPEntryView init](&v25, "init");
  if (v5)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue([v9 localizedStringForKey:@"DONE" value:&stru_1000CB560 table:0]);
    ...
    -[SATVIPEntryView addSubview:](v5, "addSubview:", v5->_doneButton);
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableArray array](&OBJC_CLASS___NSMutableArray, "array"));
    v12 = (void *)objc_claimAutoreleasedReturnValue( +[UIFont tvsk_fontFromTextStyle:]( &OBJC_CLASS___UIFont,  "tvsk_fontFromTextStyle:",  UIFontTextStyleTitle2));
    uint64_t v13 = 12LL;
    do
    {
      v14 = objc_alloc_init(&OBJC_CLASS___SATVPasscodeDigitView);
      -[SATVPasscodeDigitView setDelegate:](v14, "setDelegate:", v5);
      [v12 pointSize];
      -[SATVPasscodeDigitView setFontSize:](v14, "setFontSize:");
      [v11 addObject:v14];
      -[SATVIPEntryView addSubview:](v5, "addSubview:", v14);
    ...
    do
    {
      ...
      v18 = (void *)objc_claimAutoreleasedReturnValue(+[UIColor tvsk_opacityADynamicColor](&OBJC_CLASS___UIColor, "tvsk_opacityADynamicColor"));
      ...
      [v15 addObject:v17];
      -[SATVIPEntryView addSubview:](v5, "addSubview:", v17);
    ...
    -[SATVIPEntryView setIPAddress:](v5, "setIPAddress:", v4);
  }
...
- (void)setIPAddress:(id)a3
{
  ...
  -[SATVIPEntryView _updateDigitLimits](self, "_updateDigitLimits");
}

- (NSString)IPAddress
{
  double v3 = (void *)objc_opt_new(&OBJC_CLASS___NSMutableArray, a2);
  for (uint64_t i = 0LL; i != 4; ++i)
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"%ld",  -[SATVIPEntryView _octetForBlockIndex:](self, "_octetForBlockIndex:", i)));
    [v3 addObject:v5];
  }
...
- (void)passcodeDigitView:(id)a3 didChangeText:(id)a4
{
  ...
  -[SATVIPEntryView _updateDigitLimits](self, "_updateDigitLimits");
  id v10 = (id)objc_claimAutoreleasedReturnValue(-[SATVIPEntryView delegate](self, "delegate"));
...
- (void)doneButton:(id)a3
{
  id v4 = (id)objc_claimAutoreleasedReturnValue(-[SATVIPEntryView delegate](self, "delegate", a3));
...
- (void)_updateDigitLimits
{
  ...
  do
  {
    ...
    uint64_t v9 = -[SATVIPEntryView _octetForBlockIndex:](v4, "_octetForBlockIndex:", v3);
    uint64_t v10 = v9 % 100;
...
- (SATVIPEntryViewDelegate)delegate
{
  return (SATVIPEntryViewDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
