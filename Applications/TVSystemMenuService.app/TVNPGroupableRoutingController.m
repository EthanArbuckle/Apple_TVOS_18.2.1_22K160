...
- (TVNPGroupableRoutingController)initWithOutputContextUID:(id)a3 allowsRetargeting:(BOOL)a4 initalFetchCompletion:(id)a5
{
  ...
  if (obj)
  {
    v75 = (dispatch_once_t *)&unk_100056CD0;
    id v74 = 0LL;
    objc_storeStrong(&v74, &stru_100049168);
    if (*v75 != -1) {
    ...
    *((void *)v73 + 14) = v8;
    ...
    [*((id *)v73 + 14) addObserver:v73 forKeyPath:@"volumeControlTargetDeviceType" options:4 context:off_1000560E0];
    ...
    *((void *)v73 + 22) = v16;
    ...
    [*((id *)v73 + 19) addObserver:v73 forKeyPath:@"localAccessory" options:4 context:off_1000560E8];
...
- (void)dealloc
{
  objc_super v4 = self;
  SEL v3 = a2;
  -[TVCSHomeManager removeObserver:forKeyPath:context:]( self->_homeManager,  "removeObserver:forKeyPath:context:",  self,  @"localAccessory",  off_1000560E8);
  -[PBSMediaRemoteServiceInterface removeObserver:forKeyPath:context:]( v4->_pbsMediaRemoteProxy,  "removeObserver:forKeyPath:context:",  v4,  @"volumeControlTargetDeviceType",  off_1000560E0);
  v2.receiver = v4;
...
- (void)setCurrentDestination:(id)a3
{
  ...
  if (v14->_currentDestination != location[0])
  {
    ...
    {
      sub_10000F7D4((uint64_t)v15, (uint64_t)v12);
...
- (void)pickRoutes:(id)a3 forDestination:(id)a4
{
  ...
  if (v47)
  {
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass(v40, v4) & 1) != 0)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(oslog, OS_LOG_TYPE_ERROR))
          {
            ...
            sub_10000F7D4((uint64_t)v104, (uint64_t)v83);
      ...
      {
        os_log_t v80 = (os_log_t)(id)qword_100056CD8;
        os_log_type_t v79 = OS_LOG_TYPE_FAULT;
        if (os_log_type_enabled(v80, OS_LOG_TYPE_FAULT))
        {
          v34 = v80;
          sub_10000F7D4((uint64_t)v103, (uint64_t)v85);
  ...
  int v65 = -1073741824;
  int v66 = 0;
  id v67 = sub_1000108B4;
  id v68 = &unk_1000491B8;
  id v69 = v77;
  ...
  os_log_t v58 = (os_log_t)(id)qword_100056CD8;
  os_log_type_t v57 = OS_LOG_TYPE_DEFAULT;
  if (os_log_type_enabled(v58, OS_LOG_TYPE_DEFAULT))
  {
    sub_100010980((uint64_t)v100, v91 & 1, v92, v70, v63);
  ...
  {
    os_log_t v56 = (os_log_t)(id)qword_100056CD8;
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v54 = v12;
      sub_100007D84((uint64_t)v99, (uint64_t)v9, (uint64_t)v54);
    ...
    -[MPAVRoutingController selectRoutes:operation:completion:]( v97->_outputDeviceRoutingController,  "selectRoutes:operation:completion:",  v86,  1LL,  &stru_1000491F8);
  }

  else
  {
    os_log_t v53 = (os_log_t)(id)qword_100056CD8;
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v51 = v8;
      sub_100007D84((uint64_t)v98, (uint64_t)v5, (uint64_t)v51);
    ...
    -[MPAVRoutingController selectRoutes:operation:completion:]( v97->_outputDeviceRoutingController,  "selectRoutes:operation:completion:",  v86,  0LL,  &stru_100049218);
  }
...
- (void)unpickRoutes:(id)a3 forDestination:(id)a4
{
    ...
    && (v18 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v10 = v6;
      sub_100007D84((uint64_t)v24, (uint64_t)v14, (uint64_t)v10);
    ...
    objc_storeStrong((id *)&oslog, 0LL);
    -[MPAVRoutingController selectRoutes:operation:completion:]( v23->_outputDeviceRoutingController,  "selectRoutes:operation:completion:",  v14,  2LL,  &stru_100049238);
  }
...
- (void)selectOdeonDestination:(id)a3
{
  ...
  if ((_os_feature_enabled_impl("Home", "cce7c4ecef404121ae8971") & 1) != 0)
  {
    ...
    if (!v12)
    {
      ...
      int v14 = -1073741824;
      int v15 = 0;
      char v16 = sub_1000112F4;
      id v17 = &unk_100049260;
      char v18 = v24;
      id v19 = location[0];
...
- (void)targetDestination:(id)a3
{
  ...
  if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
  {
    sub_1000082C4((uint64_t)v11, (uint64_t)v9);
...
- (void)_updateAvailableRoutes
{
  ...
  int v25 = 838860800;
  int v26 = 48;
  id v27 = sub_100011DB8;
  uint64_t v28 = sub_100011E0C;
  id v29 = 0LL;
  dispatch_group_enter(v36);
  ...
  int v14 = -1073741824;
  int v15 = 0;
  char v16 = sub_100011E38;
  id v17 = &unk_100049300;
  char v18 = v23;
  v20[1] = v30;
    ...
    if (v136)
    {
      ...
      while (1)
      {
        ...
        if (!v261)
        {
          ...
          {
            id v259 = (id)qword_100056CD8;
            os_log_type_t type = OS_LOG_TYPE_ERROR;
            if (os_log_type_enabled((os_log_t)v259, OS_LOG_TYPE_ERROR))
            {
              log = (os_log_s *)v259;
              os_log_type_t v124 = type;
              sub_100015638((uint64_t)v290, (uint64_t)v263, (uint64_t)v263);
...
LABEL_81:
          ...
          else
          {
            ...
            if ((v81 & 1) == 0)
            {
              ...
              if (os_log_type_enabled((os_log_t)v202, OS_LOG_TYPE_ERROR))
              {
                ...
                sub_100015744((uint64_t)v285, (uint64_t)v226, (uint64_t)v228, (uint64_t)v228);
    ...
    id v181 =  +[NSSortDescriptor sortDescriptorWithKey:ascending:comparator:]( &OBJC_CLASS___NSSortDescriptor,  "sortDescriptorWithKey:ascending:comparator:",  0LL,  1LL,  &stru_1000493B8);
    ...
    char v171 = v46 & 1;
    id v170 = (id)qword_100056CD8;
    os_log_type_t v169 = OS_LOG_TYPE_INFO;
    if (os_log_type_enabled((os_log_t)v170, OS_LOG_TYPE_INFO))
    {
      sub_100015C20( (uint64_t)v279,  v171 & 1,  v270->_multipleSelectionEnabled,  v173,  v174 & 1,  v172,  (uint64_t)v175,  (uint64_t)v175);
    ...
    if (os_log_type_enabled((os_log_t)v164, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v162 = v44;
      sub_1000082C4((uint64_t)v277, (uint64_t)v162);
    ...
    if (os_log_type_enabled((os_log_t)v161, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v159 = v41;
      sub_1000082C4((uint64_t)v276, (uint64_t)v159);
    ...
    if (os_log_type_enabled((os_log_t)v158, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v156 = v38;
      sub_1000082C4((uint64_t)v275, (uint64_t)v156);
    ...
    if (os_log_type_enabled((os_log_t)v155, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v153 = v35;
      sub_1000082C4((uint64_t)v274, (uint64_t)v153);
    ...
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
    {
      sub_100015CDC( (uint64_t)v272,  (uint64_t)v142,  v141,  (uint64_t)v140,  v139,  v171 & 1,  v270->_allowsDestinationSelection,  (uint64_t)v175,  (uint64_t)v175);
...
- (void)_updateWithAvailableMediaDestinations:(id)a3
{
  ...
  if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v74 = v19;
    sub_1000082C4((uint64_t)v107, (uint64_t)v74);
  ...
  objc_storeStrong((id *)&oslog, 0LL);
  os_log_t v73 = (os_log_t)(id)qword_100056CD8;
  ...
  if (os_log_type_enabled(v73, OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v71 = v16;
    sub_1000082C4((uint64_t)v106, (uint64_t)v71);
  ...
  if (a6 == off_1000560E8)
  {
    if ((_os_feature_enabled_impl("Home", "cce7c4ecef404121ae8971") & 1) != 0)
    {
      ...
      if (v30->_homeDestinationController != v25)
      {
        ...
        id v24 = (id)qword_100056CD8;
        os_log_type_t v23 = OS_LOG_TYPE_DEFAULT;
        if (os_log_type_enabled((os_log_t)v24, OS_LOG_TYPE_DEFAULT))
        {
          sub_10000F7D4((uint64_t)v32, (uint64_t)v25);
      ...
      if ((v12 & 1) == 0)
      {
        id v21 = (id)qword_100056CD8;
        os_log_type_t v20 = OS_LOG_TYPE_DEFAULT;
        if (os_log_type_enabled((os_log_t)v21, OS_LOG_TYPE_DEFAULT))
        {
          sub_10000F7D4((uint64_t)v31, (uint64_t)v22);
...
- (void)accessoryDidUpdateControllable:(id)a3
{
  ...
  if (os_log_type_enabled((os_log_t)v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    sub_1000174A4((uint64_t)v11, (uint64_t)v6, (uint64_t)v3);
