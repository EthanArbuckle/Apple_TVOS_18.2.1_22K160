...
- (TVNPEndpointRouteConnection)initWithRoute:(id)a3
{
  ...
  if (v11)
  {
    v17 = (dispatch_once_t *)&unk_100056CC0;
    id v16 = 0LL;
    objc_storeStrong(&v16, &stru_100048D88);
    if (*v17 != -1) {
...
{
  char v4 = 0;
  if ((id)-[TVNPEndpointRouteConnection connectionState](self, "connectionState") == (id)2)
  {
...
- (void)_updateMetadata
{
  ...
  uint64_t v104 = (uint64_t)[v105[0] state];
  double v103 = 0.0;
  double v102 = 0.0;
  float v101 = 0.0;
  float v100 = 1.0;
  ...
  if (v49)
  {
    ...
    os_log_t oslog = (os_log_t)(id)qword_100056CC8;
    os_log_type_t type = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
    {
      sub_100007D84((uint64_t)v122, (uint64_t)val, (uint64_t)v88);
      _os_log_impl( (void *)&_mh_execute_header,  oslog,  type,  "METADATA: (%{public}@) update with song: %{public}@",  v122,  0x16u);
    }
    ...
    if (([v77 isArtworkVisuallyIdenticalToCatalog:*((void *)val + 7)] & 1) == 0)
    {
      if (v77)
      {
        [v77 setCacheIdentifier:off_100055F80 forCacheReference:0];
      ...
      if (!v77)
      {
        ...
        os_log_t v67 = (os_log_t)(id)qword_100056CC8;
        os_log_type_t v66 = OS_LOG_TYPE_DEBUG;
        if (os_log_type_enabled(v67, OS_LOG_TYPE_DEBUG))
        {
          sub_1000082C4((uint64_t)v121, (uint64_t)val);
          _os_log_debug_impl( (void *)&_mh_execute_header,  v67,  v66,  "METADATA: (%{public}@) artwork catalog changed to nil",  v121,  0xCu);
        }
      ...
      {
        id v65 = [val bundleID];
        os_log_t v64 = (os_log_t)(id)qword_100056CC8;
        os_log_type_t v63 = OS_LOG_TYPE_DEBUG;
        if (os_log_type_enabled(v64, OS_LOG_TYPE_DEBUG))
        {
          sub_100007D84((uint64_t)v120, (uint64_t)val, (uint64_t)v65);
          _os_log_debug_impl( (void *)&_mh_execute_header,  v64,  v63,  "METADATA: (%{public}@) using placeholder image for app: %{public}@",  v120,  0x16u);
        }
  ...
  else
  {
    ...
    uint64_t v104 = 1LL;
    os_log_t v62 = (os_log_t)(id)qword_100056CC8;
    os_log_type_t v61 = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled(v62, OS_LOG_TYPE_DEFAULT))
    {
      sub_1000082C4((uint64_t)v119, (uint64_t)val);
      _os_log_impl( (void *)&_mh_execute_header,  v62,  v61,  "METADATA: (%{public}@) no song, clearing out data",  v119,  0xCu);
    }
  ...
  *(float *)&double v16 = v100;
  ...
  {
    os_log_t v59 = (os_log_t)(id)qword_100056CC8;
    os_log_type_t v58 = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled(v59, OS_LOG_TYPE_DEFAULT))
    {
      sub_100007D84((uint64_t)v118, (uint64_t)val, (uint64_t)v60);
      _os_log_impl( (void *)&_mh_execute_header,  v59,  v58,  "METADATA: (%{public}@) apply updates with changed keys: %{public}@",  v118,  0x16u);
    }
...
- (void)_connectPairingIfNeeded:(BOOL)a3
{
  ...
  if (v20)
  {
    ...
    if ((v19 & 1) == 0 && !v23->_attemptingConnection)
    {
      ...
      id v16 = (id)qword_100056CC8;
      os_log_type_t v15 = OS_LOG_TYPE_DEFAULT;
      if (os_log_type_enabled((os_log_t)v16, OS_LOG_TYPE_DEFAULT))
      {
        int v5 = -[TVNPEndpointRouteConnection route](v23, "route");
        id location = v5;
        sub_100008880((uint64_t)v24, (uint64_t)v23, (uint64_t)location, v21);
        _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v16,  v15,  "(%{public}@) Connect to %{public}@ and Pair: %d",  v24,  0x1Cu);
      ...
      int v8 = -1073741824;
      int v9 = 0;
      id v10 = sub_1000088EC;
      double v11 = &unk_100048EA0;
