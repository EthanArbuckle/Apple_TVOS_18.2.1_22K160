...
+ (id)TVShowsLibraryRequest
{
  id v2 = objc_alloc_init(&OBJC_CLASS___MPModelLibraryRequest);
  ...
  [v2 setMediaLibrary:v3];

  id v4 = (void *)objc_claimAutoreleasedReturnValue(+[MPModelTVEpisode kindWithVariants:](&OBJC_CLASS___MPModelTVEpisode, "kindWithVariants:", 2LL));
...
+ (id)TVEpisodesLibraryRequestForShow:(id)a3 season:(id)a4
{
  ...
  id v8 = objc_alloc_init(&OBJC_CLASS___MPModelLibraryRequest);
...
+ (id)songsLibraryRequestForAlbum:(id)a3
{
  ...
  id v8 = (void *)objc_claimAutoreleasedReturnValue( +[NSSortDescriptor sortDescriptorWithKey:ascending:]( &OBJC_CLASS___NSSortDescriptor,  "sortDescriptorWithKey:ascending:",  MPModelPropertySongDiscNumber,  1LL));
  v16[0] = v8;
...
+ (id)songsLibraryRequestForArtist:(id)a3
{
  ...
  [v4 setItemKind:v19];
  id v5 = (void *)objc_claimAutoreleasedReturnValue([a1 propertySetForSongsWithDetails:1]);
  [v4 setItemProperties:v5];
  ...
  id v8 = (void *)objc_claimAutoreleasedReturnValue( +[MPModelSortDescriptor sortDescriptorWithKeyPath:ascending:]( &OBJC_CLASS___MPModelSortDescriptor,  "sortDescriptorWithKeyPath:ascending:",  v7,  1LL));
  v24[0] = v8;
  v22[0] = v6;
...
+ (id)songsLibraryRequestForContextMenu
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue([a1 propertySetForSongsInContextMenu]);
  [v3 setItemProperties:v5];
...
+ (id)songsLibraryRequestWithPlaylist:(id)a3 songProperties:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = objc_alloc_init(&OBJC_CLASS___MPModelLibraryRequest);
...
+ (id)TVEpisodeLibraryRequestWithAdamID:(int64_t)a3
{
  ...
  [v5 setItemKind:v6];
  id v7 = (void *)objc_claimAutoreleasedReturnValue( +[MPIdentifierSet tvm_identifierSetForModelKind:withStoreID:subscriptionID:]( &OBJC_CLASS___MPIdentifierSet,  "tvm_identifierSetForModelKind:withStoreID:subscriptionID:",  v6,  0LL,  a3));
  id v11 = v7;
...
+ (id)playlistsLibraryRequestWithParentPlaylistFolder:(id)a3 userEditableOnly:(BOOL)a4 allowEmptyPlaylists:(BOOL)a5
{
  ...
  if (v6) {
    return [a1 _playlistsLibraryRequestWithParentPlaylistFolder:a3 variants:v7 options:v5];
  }
  else {
    return [a1 _playlistsLibraryRequestWithParentPlaylistFolder:a3 variants:v7 options:v5 | 2];
  }
}

+ (id)personalizedMixPlaylists
{
  return [a1 _playlistsLibraryRequestWithParentPlaylistFolder:0 variants:64 options:0];
}
...
+ (id)_albumsLibraryRequestWithVariants:(unint64_t)a3
{
  ...
  id v8 = (void *)objc_claimAutoreleasedReturnValue([a1 propertySetForAlbumDetails]);
...
+ (id)albumsLibraryRequest
{
  return [a1 _albumsLibraryRequestWithVariants:3];
}

+ (id)albumsLibraryRequestForArtist:(id)a3
{
  id v4 = a3;
  id v5 = (void *)objc_claimAutoreleasedReturnValue([a1 albumsLibraryRequest]);
  id v8 = v4;
...
+ (id)compilationsLibraryRequest
{
  return [a1 _albumsLibraryRequestWithVariants:2];
}
...
+ (id)artistsLibraryRequest
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[MPModelArtist kindWithAlbumKind:](&OBJC_CLASS___MPModelArtist, "kindWithAlbumKind:", v4));
  [v2 setItemKind:v5];
...
+ (id)musicVideosLibraryRequest
{
  ...
  id v5 = (void *)objc_claimAutoreleasedReturnValue([a1 propertySetForSongsWithDetails:0]);
  [v3 setItemProperties:v5];
...
+ (id)genresLibraryRequest
{
  ...
  id v4 = (void *)objc_claimAutoreleasedReturnValue( +[MPModelAlbum kindWithVariants:songKind:]( &OBJC_CLASS___MPModelAlbum,  "kindWithVariants:songKind:",  3LL,  v3));
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[MPModelGenre kindWithAlbumKind:](&OBJC_CLASS___MPModelGenre, "kindWithAlbumKind:", v4));
  [v2 setItemKind:v5];
...
+ (id)composersLibraryRequest
{
  ...
  id v3 = (void *)objc_claimAutoreleasedReturnValue(+[MPModelSong kindWithVariants:](&OBJC_CLASS___MPModelSong, "kindWithVariants:", 1LL));
  id v4 = (void *)objc_claimAutoreleasedReturnValue( +[MPModelAlbum kindWithVariants:songKind:]( &OBJC_CLASS___MPModelAlbum,  "kindWithVariants:songKind:",  3LL,  v3));
  id v5 = (void *)objc_claimAutoreleasedReturnValue(+[MPModelComposer kindWithAlbumKind:](&OBJC_CLASS___MPModelComposer, "kindWithAlbumKind:", v4));
  [v2 setItemKind:v5];
