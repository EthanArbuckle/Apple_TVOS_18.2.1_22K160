...
- (TVImageView)initWithFrame:(CGRect)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___TVImageView;
  v3 = -[TVImageView initWithFrame:](&v9, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
    v3->_imageContentMode = 1LL;
    v5 = objc_alloc(&OBJC_CLASS___UIImageView);
    -[TVImageView bounds](v4, "bounds");
    ...
    -[TVImageView addSubview:](v4, "addSubview:", v4->_imageView);
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)&OBJC_CLASS___TVImageView;
  -[TVImageView dealloc](&v3, "dealloc");
}
...
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVImageView;
  -[TVImageView layoutSubviews](&v4, "layoutSubviews");
  imageView = self->_imageView;
  -[TVImageView bounds](self, "bounds");
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___TVImageView;
  -[TVImageView setFrame:](&v5, "setFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  imageView = self->_imageView;
  -[TVImageView bounds](self, "bounds");
  -[UIImageView setFrame:](imageView, "setFrame:");
}
...
- (void)willMoveToWindow:(id)a3
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___TVImageView;
  -[TVImageView willMoveToWindow:](&v5, "willMoveToWindow:");
  if (a3)
  {
    if (!-[TVImageView isImageLoaded](self, "isImageLoaded")) {
      -[TVImageView _loadImage](self, "_loadImage");
    }
  }
...
{
  id v4 = a3;
  -[TVImageView setImageProxy:](self, "setImageProxy:", 0LL);
  -[TVImageView _setImage:](self, "_setImage:", v4);
}
...
- (void)setImageProxy:(id)a3 completion:(id)a4
{
  ...
  if (self->_imageProxy != v17)
  {
    ...
    unsigned __int8 v9 = -[TVImageView isImageLoaded](self, "isImageLoaded");
    if (v8)
    {
      if ((v9 & 1) == 0)
      {
        v10 = (void *)objc_claimAutoreleasedReturnValue(-[TVImageView completion](self, "completion"));

        if (v10)
        {
          double v11 = (void (**)(void, void, void, void))objc_claimAutoreleasedReturnValue(-[TVImageView completion](self, "completion"));
          double v12 = (void *)objc_claimAutoreleasedReturnValue(-[TVImageView image](self, "image"));
          ((void (**)(void, void *, void, void))v11)[2](v11, v12, 0LL, 0LL);
        }
      }

      -[TVImageView setCompletion:](self, "setCompletion:", v7);
      objc_storeStrong((id *)&self->_imageProxy, a3);
      if (-[TVImageView isImageLoaded](self, "isImageLoaded"))
      {
        v13 = (void *)objc_claimAutoreleasedReturnValue(-[TVImageView completion](self, "completion"));

        if (v13)
        {
          v14 = (void (**)(void, void, void, void))objc_claimAutoreleasedReturnValue(-[TVImageView completion](self, "completion"));
          v15 = (void *)objc_claimAutoreleasedReturnValue(-[TVImageView image](self, "image"));
          ((void (**)(void, void *, void, uint64_t))v14)[2](v14, v15, 0LL, 1LL);

          -[TVImageView setCompletion:](self, "setCompletion:", 0LL);
        }
      }
    }
    ...
    else
    {
      ...
      -[TVImageView setImageLoaded:](self, "setImageLoaded:", 0LL);
      -[TVImageView _setImage:](self, "_setImage:", 0LL);
      -[TVImageView _updateImageViewWithPlaceholderImageIfNeeded](self, "_updateImageViewWithPlaceholderImageIfNeeded");
      -[TVImageView setCompletion:](self, "setCompletion:", v7);
      objc_storeStrong((id *)&self->_imageProxy, a3);
      v16 = (void *)objc_claimAutoreleasedReturnValue(-[TVImageView window](self, "window"));
...
- (void)setSelected:(BOOL)a3 animated:(BOOL)a4
{
  ...
  if (-[TVImageView _enableEdgeAntialiasingOnSelected](self, "_enableEdgeAntialiasingOnSelected"))
  {
    ...
    unsigned __int8 v9 = (void *)objc_claimAutoreleasedReturnValue(-[TVImageView layer](self, "layer"));
    [v9 setAllowsEdgeAntialiasing:v4];

    if (-[TVImageView _edgeAntialiasingOnSelectedRestrictedToLeftRightEdge]( self,  "_edgeAntialiasingOnSelectedRestrictedToLeftRightEdge"))
    {
      v10 = (void *)objc_claimAutoreleasedReturnValue(-[UIImageView layer](self->_imageView, "layer"));
      [v10 setEdgeAntialiasingMask:3];

      id v11 = (id)objc_claimAutoreleasedReturnValue(-[TVImageView layer](self, "layer"));
...
- (void)_loadImage
{
  ...
  {
    id v7 = (void *)objc_claimAutoreleasedReturnValue(-[TVImageView completion](self, "completion"));
    ...
    {
      unsigned int v8 = (void (**)(void, void, void, void))objc_claimAutoreleasedReturnValue(-[TVImageView completion](self, "completion"));
      v8[2](v8, 0LL, 0LL, 1LL);
...
{
  id v8 = a3;
  -[TVImageView setTintColor:](self, "setTintColor:", v8);
  id v4 = v8;
