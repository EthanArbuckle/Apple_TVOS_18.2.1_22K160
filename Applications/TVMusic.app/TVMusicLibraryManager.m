...
+ (TVMusicLibraryManager)sharedInstance
{
  if (qword_1002BE730 != -1) {
    dispatch_once(&qword_1002BE730, &stru_100268E08);
  }
  return (TVMusicLibraryManager *)(id)qword_1002BE728;
}
...
- (void)_updateInProgressDidChange:(id)a3
{
  ...
  else
  {
    ...
    *(void *)&buf[16] = sub_10000A3E0;
    int v12 = &unk_100268D60;
    v13 = v6;
