...
- (TVLabel)initWithFrame:(CGRect)a3;
...
- (TVLabel)initWithFrame:(CGRect)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___TVLabel;
  result = -[TVLabel initWithFrame:](&v9, "initWithFrame:");
  if (result)
  {
...
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVLabel;
  -[TVLabel setText:](&v4, "setText:", a3);
  -[TVLabel _clearCachedValues](self, "_clearCachedValues");
}
...
- (void)setLineBreakMode:(int64_t)a3
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVLabel;
  -[TVLabel setLineBreakMode:](&v4, "setLineBreakMode:", a3);
  -[TVLabel _clearCachedValues](self, "_clearCachedValues");
}
...
- (void)setNumberOfLines:(int64_t)a3
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVLabel;
  -[TVLabel setNumberOfLines:](&v4, "setNumberOfLines:", a3);
  -[TVLabel _clearCachedValues](self, "_clearCachedValues");
}
...
- (void)setAdjustsFontSizeToFitWidth:(BOOL)a3
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVLabel;
  -[TVLabel setAdjustsFontSizeToFitWidth:](&v4, "setAdjustsFontSizeToFitWidth:", a3);
  -[TVLabel _clearCachedValues](self, "_clearCachedValues");
}
...
- (void)setBaselineAdjustment:(int64_t)a3
{
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___TVLabel;
  -[TVLabel setBaselineAdjustment:](&v4, "setBaselineAdjustment:", a3);
  -[TVLabel _clearCachedValues](self, "_clearCachedValues");
}

- (BOOL)canBecomeFocused
{
  return -[TVLabel isUserInteractionEnabled](self, "isUserInteractionEnabled");
}
...
- (CGRect)textRectForBounds:(CGRect)a3 limitedToNumberOfLines:(int64_t)a4
{
  ...
  -[TVLabel previousBounds](self, "previousBounds");
  ...
  if (!CGRectEqualToRect(v15, v18)
    || -[TVLabel previousNumberOfLines](self, "previousNumberOfLines") != a4
    || (-[TVLabel cachedTextRectForBounds](self, "cachedTextRectForBounds"),
  ...
  {
    v14.receiver = self;
    v14.super_class = (Class)&OBJC_CLASS___TVLabel;
    -[TVLabel textRectForBounds:limitedToNumberOfLines:]( &v14,  "textRectForBounds:limitedToNumberOfLines:",  a4,  x,  y,  width,  height);
    -[TVLabel setCachedTextRectForBounds:](self, "setCachedTextRectForBounds:");
    -[TVLabel setPreviousBounds:](self, "setPreviousBounds:", x, y, width, height);
    -[TVLabel setPreviousNumberOfLines:](self, "setPreviousNumberOfLines:", a4);
  }
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  -[TVLabel previousTargetSize](self, "previousTargetSize");
  BOOL v8 = v7 == width && v6 == height;
  if (!v8
    || ((-[TVLabel cachedSizeThatFits](self, "cachedSizeThatFits"), v10 == CGSizeZero.width)
        ...
        v11))
  {
    v14.receiver = self;
    v14.super_class = (Class)&OBJC_CLASS___TVLabel;
    -[TVLabel sizeThatFits:](&v14, "sizeThatFits:", width, height);
    -[TVLabel setCachedSizeThatFits:](self, "setCachedSizeThatFits:");
    -[TVLabel setPreviousTargetSize:](self, "setPreviousTargetSize:", width, height);
  }

  -[TVLabel cachedSizeThatFits](self, "cachedSizeThatFits");
