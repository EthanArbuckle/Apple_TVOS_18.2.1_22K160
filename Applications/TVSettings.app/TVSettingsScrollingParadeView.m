@interface TVSettingsScrollingParadeView
- (BOOL)isPaused;
- (NSArray)imageProxies;
- (TVSettingsScrollingParadeView)initWithFrame:(CGRect)a3;
...
@implementation TVSettingsScrollingParadeView

- (TVSettingsScrollingParadeView)initWithFrame:(CGRect)a3
{
  v11.receiver = self;
  v11.super_class = (Class)&OBJC_CLASS___TVSettingsScrollingParadeView;
  v3 = -[TVSettingsScrollingParadeView initWithFrame:]( &v11,  "initWithFrame:",  a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
  if (v3)
  {
    ...
    v8 = objc_alloc_init(&OBJC_CLASS____TVSettingsImageLoaderQueue);
...
{
  v6.receiver = self;
  v6.super_class = (Class)&OBJC_CLASS___TVSettingsScrollingParadeView;
  -[TVSettingsScrollingParadeView didMoveToWindow](&v6, "didMoveToWindow");
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[TVSettingsScrollingParadeView window](self, "window"));
  if (v3 && (BOOL paused = self->_paused, v3, !paused))
  {
    -[TVSettingsScrollingParadeView _startAnimations](self, "_startAnimations");
  }

  else
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(-[TVSettingsScrollingParadeView window](self, "window"));

    if (!v5) {
      -[TVSettingsScrollingParadeView _stopAnimations](self, "_stopAnimations");
    }
  }
...
{
  v20.receiver = self;
  v20.super_class = (Class)&OBJC_CLASS___TVSettingsScrollingParadeView;
  -[TVSettingsScrollingParadeView layoutSubviews](&v20, "layoutSubviews");
  __int128 v18 = 0u;
  __int128 v19 = 0u;
  __int128 v16 = 0u;
  __int128 v17 = 0u;
  ...
  if (!self->_paused)
  {
    -[TVSettingsScrollingParadeView bounds](self, "bounds");
...
- (void)setImageProxies:(id)a3
{
  ...
  if (!-[NSArray isEqualToArray:](self->_imageProxies, "isEqualToArray:", v4))
  {
    ...
    if ([v4 count])
    {
      ...
      -[_TVSettingsImageLoaderQueue preloadImageCount:withCompletionHandler:]( loaderQueue,  "preloadImageCount:withCompletionHandler:",  v8,  v10);
...
- (void)_addImageToAnimationContainer:(id)a3
{
  if (a3)
  {
    ...
    -[TVSettingsScrollingParadeView addSubview:](self, "addSubview:", v10);
  }

- (void)_startAnimations
{
  v56.origin.x = CGRectZero.origin.x;
  v56.origin.y = CGRectZero.origin.y;
  v56.size.width = CGRectZero.size.width;
  v56.size.height = CGRectZero.size.height;
  if (!CGRectEqualToRect(v52, v56))
  {
    ...
    if (v3)
    {
      if (!self->_animating && !self->_paused)
      {
        ...
        id v11 = &selRef_respondsToSelector_;
        if (v10)
        {
          double v12 = 0LL;
          double v13 = 0.0;
          ...
          do
          {
            ...
            dispatch_group_enter(*(dispatch_group_t *)((char *)&self->super.super.super.isa + *((int *)v33 + 197)));
        ...
        -[_TVSettingsImageLoaderQueue setPauseImageLoad:](self->_loaderQueue, "setPauseImageLoad:", 0LL);
        objc_initWeak(&location, self);
        v42 = *(dispatch_group_s **)((char *)&self->super.super.super.isa + *((int *)v11 + 197));
        block[0] = _NSConcreteStackBlock;
        block[1] = 3221225472LL;
        block[2] = sub_10003214C;
...
{
  self->_animating = 0;
  -[_TVSettingsImageLoaderQueue setPauseImageLoad:](self->_loaderQueue, "setPauseImageLoad:", 1LL);
  __int128 v11 = 0u;
  __int128 v12 = 0u;
  __int128 v9 = 0u;
  __int128 v10 = 0u;
