...
- (UIView)dialogueView;
- (id)_headlineFont;
- (id)_title1FontEmphasized;
- (id)initDisplaySharedAlbums:(BOOL)a3;
- (id)onSelection;
...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___TVPiCloudPhotosWelcomeViewController;
  id result = -[TVPiCloudPhotosWelcomeViewController init](&v5, "init");
  if (result) {
    *((_BYTE *)result + 8) = a3;
  }
  return result;
...
- (void)_setupDialogueView
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController view](self, "view"));
  ...
  v21 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController _title1FontEmphasized](self, "_title1FontEmphasized"));
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue( [v25 localizedStringForKey:@"TVPiCloudWelcomeTitle" value:&stru_100195DD8 table:0]);
  ...
  v35 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController _headlineFont](self, "_headlineFont"));
  ...
  uint64_t v38 = PXLocalizedSharedLibraryString(@"PXSharedLibrary_tvOS_CloudWelcomeDescription");
  v144 = (void *)objc_claimAutoreleasedReturnValue(v38);
  v39 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController descriptionLabel](self, "descriptionLabel"));
  [v39 setText:v144];

  v40 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController dialogueView](self, "dialogueView"));
  v41 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController descriptionLabel](self, "descriptionLabel"));
  [v40 addSubview:v41];

  v42 = (void *)objc_claimAutoreleasedReturnValue(+[UIButton buttonWithType:](&OBJC_CLASS___UIButton, "buttonWithType:", 6LL));
  -[TVPiCloudPhotosWelcomeViewController setTurnOnButton:](self, "setTurnOnButton:", v42);

  v43 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController turnOnButton](self, "turnOnButton"));
  ...
  v46 = (void *)objc_claimAutoreleasedReturnValue( [v45 localizedStringForKey:@"TVPiCloudWelcomeTurnOniCloudPhotos" value:&stru_100195DD8 table:0]);
  [v44 setTitle:v46 forState:0];

  v47 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController _headlineFont](self, "_headlineFont"));
  v48 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController turnOnButton](self, "turnOnButton"));
  v49 = (void *)objc_claimAutoreleasedReturnValue([v48 titleLabel]);
  [v49 setFont:v47];

  v50 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController turnOnButton](self, "turnOnButton"));
  [v50 addTarget:self action:"_turnOniCloudSelected:" forControlEvents:0x2000];

  v51 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController dialogueView](self, "dialogueView"));
  v52 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController turnOnButton](self, "turnOnButton"));
  [v51 addSubview:v52];

  v53 = (void *)objc_claimAutoreleasedReturnValue(+[UIButton buttonWithType:](&OBJC_CLASS___UIButton, "buttonWithType:", 6LL));
  -[TVPiCloudPhotosWelcomeViewController setSharedAlbumsButton:](self, "setSharedAlbumsButton:", v53);

  v54 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController sharedAlbumsButton](self, "sharedAlbumsButton"));
  ...
  v57 = (void *)objc_claimAutoreleasedReturnValue( [v56 localizedStringForKey:@"TVPiCloudWelcomeTurnOnSharedAlbums" value:&stru_100195DD8 table:0]);
  [v55 setTitle:v57 forState:0];

  v58 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController _headlineFont](self, "_headlineFont"));
  v59 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController sharedAlbumsButton](self, "sharedAlbumsButton"));
  v60 = (void *)objc_claimAutoreleasedReturnValue([v59 titleLabel]);
  [v60 setFont:v58];

  v61 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController sharedAlbumsButton](self, "sharedAlbumsButton"));
  [v61 addTarget:self action:"_turnOnSharedAlbumsSelected:" forControlEvents:0x2000];
  ...
  objc_msgSend( v62,  "setHidden:",  -[TVPiCloudPhotosWelcomeViewController displaySharedAlbums](self, "displaySharedAlbums") ^ 1);
...
- (void)_setupAccessoryView
{
  ...
  objc_super v5 = (void *)objc_claimAutoreleasedReturnValue(+[UIImage imageNamed:](&OBJC_CLASS___UIImage, "imageNamed:", @"Welcome-Photos-Icon"));
  ...
  v39 = (void *)objc_claimAutoreleasedReturnValue([v41 leadingAnchor]);
...
- (void)_turnOniCloudSelected:(id)a3
{
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController onSelection](self, "onSelection", a3));

  if (v4)
  {
    objc_super v5 = (void (**)(id, void))objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController onSelection](self, "onSelection"));
    v5[2](v5, 0LL);
  }
...
- (void)_turnOnSharedAlbumsSelected:(id)a3
{
  ...
  if (v4)
  {
    objc_super v5 = (void (**)(id, uint64_t))objc_claimAutoreleasedReturnValue(-[TVPiCloudPhotosWelcomeViewController onSelection](self, "onSelection"));
    v5[2](v5, 1LL);
  }

- (id)_title1FontEmphasized
{
  if (qword_1001E1990 != -1) {
    dispatch_once(&qword_1001E1990, &stru_100192940);
  }
  return (id)qword_1001E1988;
}

- (id)_headlineFont
{
  if (qword_1001E19A0 != -1) {
    dispatch_once(&qword_1001E19A0, &stru_100192960);
  }
  return (id)qword_1001E1998;
}
...
- (BOOL)displaySharedAlbums
{
  return self->_displaySharedAlbums;
}
