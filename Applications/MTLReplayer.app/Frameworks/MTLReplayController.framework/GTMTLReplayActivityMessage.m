...
- (GTMTLReplayActivityMessage)initWithMessage:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)&OBJC_CLASS___GTMTLReplayActivityMessage;
  v6 = -[GTMTLReplayActivity initWithType:](&v9, "initWithType:", @"message");
  v7 = v6;
  if (v6) {
...
{
  v7.receiver = self;
  v7.super_class = (Class)&OBJC_CLASS___GTMTLReplayActivityMessage;
...
- (id)summary
{
  int v2 = -[GTTransportMessage_replayer kind](self->_message, "kind");
  if (v2 > 1791)
  {
    if (v2 <= 4095)
    {
...
LABEL_109:
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](&OBJC_CLASS___NSString, "stringWithUTF8String:", v3));
  objc_super v7 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"Responding to: %@",  v6));
...
- (id)jsonObject
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue([v3 base64EncodedStringWithOptions:1]);

  int v5 = (void *)objc_claimAutoreleasedReturnValue(-[GTTransportMessage_replayer attributes](self->_message, "attributes"));
  ...
  v18[1] = @"message";
  v16[0] = @"kind";
  v15 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInt:]( &OBJC_CLASS___NSNumber,  "numberWithUnsignedInt:",  -[GTTransportMessage_replayer kind](self->_message, "kind")));
  v17[0] = v15;
  v16[1] = @"serial";
  objc_super v7 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithUnsignedInt:]( &OBJC_CLASS___NSNumber,  "numberWithUnsignedInt:",  -[GTTransportMessage_replayer serial](self->_message, "serial")));
  v17[1] = v7;
  v16[2] = @"attributes";
  v8 = v6;
  if (!v6) {
  ...
  objc_super v9 = v4;
  if (!v4) {
    objc_super v9 = (void *)objc_claimAutoreleasedReturnValue(+[NSNull null](&OBJC_CLASS___NSNull, "null"));
  }
  v17[3] = v9;
  v10 = (void *)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  v17,  v16,  4LL));
  v19[1] = v10;
  v18[2] = @"activityStartTime";
  v11 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithDouble:]( &OBJC_CLASS___NSNumber,  "numberWithDouble:",  *(double *)&time_scale * (double)self->super._activityStartTime));
  v19[2] = v11;
  v18[3] = @"activityEndTime";
  v12 = (void *)objc_claimAutoreleasedReturnValue( +[NSNumber numberWithDouble:]( &OBJC_CLASS___NSNumber,  "numberWithDouble:",  *(double *)&time_scale * (double)self->super._activityEndTime));
  v19[3] = v12;
  v13 = (void *)objc_claimAutoreleasedReturnValue( +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  v19,  v18,  4LL));
...
- (void)outputToLog:(id)a3
{
  if (os_log_type_enabled((os_log_t)a3, OS_LOG_TYPE_INFO))
  {
    ...
    unsigned int v8 = -[GTTransportMessage_replayer kind](self->_message, "kind");
    objc_super v9 = (void *)objc_claimAutoreleasedReturnValue(-[GTTransportMessage_replayer attributes](self->_message, "attributes"));
    v10[0] = 67109890;
