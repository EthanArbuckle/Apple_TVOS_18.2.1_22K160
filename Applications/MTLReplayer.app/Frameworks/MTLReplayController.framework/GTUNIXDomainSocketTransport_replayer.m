...
{
  v5.receiver = self;
  v5.super_class = (Class)&OBJC_CLASS___GTUNIXDomainSocketTransport_replayer;
...
- (void)_connectServer:(id)a3 future:(id)a4
{
  ...
  if (v9 >= 0x69)
  {
    v10 = &OBJC_CLASS___GTError_replayer;
    v11 = @"DYErrorDomain";
    uint64_t v12 = 39LL;
LABEL_20:
...
- (void)_connectClient:(id)a3 future:(id)a4
{
  if (!a3)
  {
    uint64_t v12 = &OBJC_CLASS___GTError_replayer;
...
LABEL_7:
  ...
  {
    size_t v9 = &OBJC_CLASS___GTError_replayer;
    v10 = @"DYErrorDomain";
    uint64_t v11 = 1LL;
LABEL_11:
...
- (void)_invalidate
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)&OBJC_CLASS___GTUNIXDomainSocketTransport_replayer;
