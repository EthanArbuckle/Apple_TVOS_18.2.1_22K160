...
void __GTMTLReplayHost_computeDerivedCountersFromData_block_invoke_2(id a1, JSContext *a2, JSValue *a3)
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue( +[NSString stringWithFormat:]( &OBJC_CLASS___NSString,  "stringWithFormat:",  @"[DYJSScripting] %@ %@",  v4,  v5));
  v7 = __stdoutp;
  if (g_runningInCI) {
    v8 = "#CI_ERROR# ";
  }
...
{
  v2 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](&OBJC_CLASS___NSString, "stringWithFormat:", @"%@", a2));
  v3 = __stdoutp;
  if (g_runningInCI) {
    v4 = "#CI_ERROR# ";
  }
