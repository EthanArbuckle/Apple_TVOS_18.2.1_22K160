...
id __34__GTSharedMemoryTransport_connect__block_invoke(uint64_t a1)
{
  ...
  if (v2[52])
  {
    objc_msgSend( *(id *)(a1 + 40),  "setError:",  +[GTError_replayer errorWithDomain:code:userInfo:]( GTError_replayer,  "errorWithDomain:code:userInfo:",  @"DYErrorDomain",  32,  0));
    uint64_t v3 = 0LL;
  ...
  *(_BYTE *)(*(void *)(a1 + 32) + 304LL) = 0;
  ...
  if (result)
  {
    ...
    do
    {
      ...
      v13.receiver = v6;
      v13.super_class = (Class)&OBJC_CLASS___GTSharedMemoryTransport_replayer;
