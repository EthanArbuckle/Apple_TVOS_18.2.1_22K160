...
void __63__GTTransport_send_inReplyTo_error_replyQueue_timeout_handler___block_invoke_3(uint64_t a1)
{
  ...
  if (*(_BYTE *)(*(void *)(a1 + 32) + 52LL))
  {
    ...
    objc_msgSend( *(id *)(a1 + 40),  "dispatchError:",  +[GTError_replayer errorWithDomain:code:userInfo:]( GTError_replayer,  "errorWithDomain:code:userInfo:",  @"DYErrorDomain",  32,  0));
...
void *__34__GTTransport_newSourceWithQueue___block_invoke(void *result)
{
  ...
  {
    uint64_t v1 = result;
    result = -[GTTransportSource_replayer _initWithQueue:transport:]( objc_alloc(&OBJC_CLASS___GTTransportSource_replayer),  "_initWithQueue:transport:",  v1[5],  v1[4]);
