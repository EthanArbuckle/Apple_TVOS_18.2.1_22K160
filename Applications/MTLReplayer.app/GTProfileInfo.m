...
- (id)initFromProfileInfo:(id)a3
{
  id v4 = a3;
  v62.receiver = self;
  v62.super_class = (Class)&OBJC_CLASS___GTProfileInfo;
  v5 = -[GTProfileInfo init](&v62, "init");
  v6 = v5;
  if (v5)
  {
    v5->_version = 1;
    v7 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"gpuState"]);
    v6->_gpuState = [v7 unsignedIntValue];

    uint64_t v8 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"counters"]);
    counters = v6->_counters;
    v6->_counters = (NSArray *)v8;

    uint64_t v10 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"profileCounters"]);
    profileCounters = v6->_profileCounters;
    v6->_profileCounters = (NSArray *)v10;

    uint64_t v12 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"derivedCounterData"]);
    derivedCounterData = v6->_derivedCounterData;
    v6->_derivedCounterData = (NSDictionary *)v12;

    uint64_t v14 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"metalPluginName"]);
    metalPluginName = v6->_metalPluginName;
    v6->_metalPluginName = (NSString *)v14;

    uint64_t v16 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"gpuTarget"]);
    gpuTarget = v6->_gpuTarget;
    v6->_gpuTarget = (NSString *)v16;

    uint64_t v18 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"encoderBatchPriorityList"]);
    encoderBatchPriorityList = v6->_encoderBatchPriorityList;
    v6->_encoderBatchPriorityList = (NSArray *)v18;

    uint64_t v20 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"highPriorityBatches"]);
    highPriorityBatches = v6->_highPriorityBatches;
    v6->_highPriorityBatches = (NSArray *)v20;

    uint64_t v22 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"HighPriorityBatchInfo"]);
    highPriorityBatchInfo = v6->_highPriorityBatchInfo;
    v6->_highPriorityBatchInfo = (NSDictionary *)v22;

    uint64_t v24 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"batchFilteredDerivedCounters"]);
    batchFilteredDerivedCounters = v6->_batchFilteredDerivedCounters;
    v6->_batchFilteredDerivedCounters = (NSArray *)v24;

    v26 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"pause"]);
    v6->_pause = [v26 BOOLValue];

    v27 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"resume"]);
    v6->_resume = [v27 BOOLValue];

    v28 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"xpState"]);
    v6->_xpState = [v28 unsignedIntValue];

    v29 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"analyzeBinaries"]);
    v6->_analyzeBinaries = [v29 BOOLValue];

    uint64_t v30 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"perEncoderDrawCallCount"]);
    perEncoderDrawCallCount = v6->_perEncoderDrawCallCount;
    v6->_perEncoderDrawCallCount = (NSDictionary *)v30;

    uint64_t v32 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"perEncoderIndexDrawCallCount"]);
    perEncoderIndexDrawCallCount = v6->_perEncoderIndexDrawCallCount;
    v6->_perEncoderIndexDrawCallCount = (NSDictionary *)v32;

    uint64_t v34 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"withoutBlitEncoderToDrawCallCountDict"]);
    ...
    uint64_t v36 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"blitEncoderIndices"]);
    blitEncoderIndices = v6->_blitEncoderIndices;
    v6->_blitEncoderIndices = (NSArray *)v36;

    uint64_t v38 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"activePerEncoderDrawCallCount"]);
    activePerEncoderDrawCallCount = v6->_activePerEncoderDrawCallCount;
    v6->_activePerEncoderDrawCallCount = (NSArray *)v38;

    uint64_t v40 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"splitEncoderCommandCount"]);
    splitEncoderCommandCount = v6->_splitEncoderCommandCount;
    v6->_splitEncoderCommandCount = (NSArray *)v40;

    uint64_t v42 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"splitPerEncoderKickCount"]);
    splitPerEncoderKickCount = v6->_splitPerEncoderKickCount;
    v6->_splitPerEncoderKickCount = (NSArray *)v42;

    uint64_t v44 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"perFrameCommandBufferCount"]);
    perFrameCommandBufferCount = v6->_perFrameCommandBufferCount;
    v6->_perFrameCommandBufferCount = (NSArray *)v44;

    uint64_t v46 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"perEncoderKickCount"]);
    perEncoderKickCount = v6->_perEncoderKickCount;
    v6->_perEncoderKickCount = (NSArray *)v46;

    v48 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"totalDrawCallCount"]);
    v6->_totalDrawCallCount = [v48 unsignedIntValue];

    uint64_t v49 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"perCommandBufferEncoderCount"]);
    perCommandBufferEncoderCount = v6->_perCommandBufferEncoderCount;
    v6->_perCommandBufferEncoderCount = (NSArray *)v49;

    uint64_t v51 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"profilingConfig"]);
    profilingConfig = v6->_profilingConfig;
    v6->_profilingConfig = (NSDictionary *)v51;

    uint64_t v53 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"counterConfig"]);
    counterConfig = v6->_counterConfig;
    v6->_counterConfig = (NSDictionary *)v53;

    uint64_t v55 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"timelineConfig"]);
    timelineConfig = v6->_timelineConfig;
    v6->_timelineConfig = (NSDictionary *)v55;

    uint64_t v57 = objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"derivedCounterInfo"]);
    derivedCounterInfo = v6->_derivedCounterInfo;
    v6->_derivedCounterInfo = (NSDictionary *)v57;

    v59 = (void *)objc_claimAutoreleasedReturnValue([v4 objectForKeyedSubscript:@"useOverlap"]);
...
- (GTProfileInfo)initWithCoder:(id)a3
{
  id v4 = a3;
  v56.receiver = self;
  v56.super_class = (Class)&OBJC_CLASS___GTProfileInfo;
  v5 = -[GTProfileInfo init](&v56, "init");
  if (v5)
  {
    v57[0] = objc_opt_class(&OBJC_CLASS___NSArray);
    v57[1] = objc_opt_class(&OBJC_CLASS___NSString);
    v57[2] = objc_opt_class(&OBJC_CLASS___NSDictionary);
    v57[3] = objc_opt_class(&OBJC_CLASS___NSNumber);
    v57[4] = objc_opt_class(&OBJC_CLASS___NSMutableArray);
    v57[5] = objc_opt_class(&OBJC_CLASS___NSMutableDictionary);
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", v57, 6LL));
    ...
    uint64_t v8 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"counters"]);
    counters = v5->_counters;
    v5->_counters = (NSArray *)v8;

    uint64_t v10 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"profileCounters"]);
    profileCounters = v5->_profileCounters;
    v5->_profileCounters = (NSArray *)v10;

    uint64_t v12 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"derivedCounterData"]);
    derivedCounterData = v5->_derivedCounterData;
    v5->_derivedCounterData = (NSDictionary *)v12;

    uint64_t v14 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"metalPluginName"]);
    metalPluginName = v5->_metalPluginName;
    v5->_metalPluginName = (NSString *)v14;

    uint64_t v16 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"gpuTarget"]);
    gpuTarget = v5->_gpuTarget;
    v5->_gpuTarget = (NSString *)v16;

    uint64_t v18 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"encoderBatchPriorityList"]);
    encoderBatchPriorityList = v5->_encoderBatchPriorityList;
    v5->_encoderBatchPriorityList = (NSArray *)v18;

    uint64_t v20 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"highPriorityBatches"]);
    highPriorityBatches = v5->_highPriorityBatches;
    v5->_highPriorityBatches = (NSArray *)v20;

    uint64_t v22 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"HighPriorityBatchInfo"]);
    highPriorityBatchInfo = v5->_highPriorityBatchInfo;
    v5->_highPriorityBatchInfo = (NSDictionary *)v22;

    uint64_t v24 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"batchFilteredDerivedCounters"]);
    ...
    uint64_t v26 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"perEncoderDrawCallCount"]);
    perEncoderDrawCallCount = v5->_perEncoderDrawCallCount;
    v5->_perEncoderDrawCallCount = (NSDictionary *)v26;

    uint64_t v28 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"perEncoderIndexDrawCallCount"]);
    perEncoderIndexDrawCallCount = v5->_perEncoderIndexDrawCallCount;
    v5->_perEncoderIndexDrawCallCount = (NSDictionary *)v28;

    uint64_t v30 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"perEncoderIndexDrawCallCount"]);
    v31 = v5->_perEncoderIndexDrawCallCount;
    v5->_perEncoderIndexDrawCallCount = (NSDictionary *)v30;

    uint64_t v32 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"blitEncoderIndices"]);
    blitEncoderIndices = v5->_blitEncoderIndices;
    v5->_blitEncoderIndices = (NSArray *)v32;

    uint64_t v34 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"activePerEncoderDrawCallCount"]);
    activePerEncoderDrawCallCount = v5->_activePerEncoderDrawCallCount;
    v5->_activePerEncoderDrawCallCount = (NSArray *)v34;

    uint64_t v36 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"splitEncoderCommandCount"]);
    splitEncoderCommandCount = v5->_splitEncoderCommandCount;
    v5->_splitEncoderCommandCount = (NSArray *)v36;

    uint64_t v38 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"splitPerEncoderKickCount"]);
    splitPerEncoderKickCount = v5->_splitPerEncoderKickCount;
    v5->_splitPerEncoderKickCount = (NSArray *)v38;

    uint64_t v40 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"perFrameCommandBufferCount"]);
    perFrameCommandBufferCount = v5->_perFrameCommandBufferCount;
    v5->_perFrameCommandBufferCount = (NSArray *)v40;

    uint64_t v42 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"perEncoderKickCount"]);
    ...
    uint64_t v44 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"perCommandBufferEncoderCount"]);
    perCommandBufferEncoderCount = v5->_perCommandBufferEncoderCount;
    v5->_perCommandBufferEncoderCount = (NSArray *)v44;

    uint64_t v46 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"profilingConfig"]);
    profilingConfig = v5->_profilingConfig;
    v5->_profilingConfig = (NSDictionary *)v46;

    uint64_t v48 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"counterConfig"]);
    counterConfig = v5->_counterConfig;
    v5->_counterConfig = (NSDictionary *)v48;

    uint64_t v50 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"timelineConfig"]);
    timelineConfig = v5->_timelineConfig;
    v5->_timelineConfig = (NSDictionary *)v50;

    uint64_t v52 = objc_claimAutoreleasedReturnValue([v4 decodeObjectOfClasses:v7 forKey:@"derivedCounterInfo"]);
...
- (id)toDictionary
{
  ...
  if (self->_pause)
  {
    uint64_t v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](&OBJC_CLASS___NSNumber, "numberWithBool:", 1LL));
  ...
  if (self->_xpState)
  {
    uint64_t v16 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:"));
  ...
  {
    v27 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](&OBJC_CLASS___NSNumber, "numberWithUnsignedInt:"));
