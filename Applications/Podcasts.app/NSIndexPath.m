...
- (id)indexPathByChangingSection:(int64_t)a3
{
  return +[NSIndexPath indexPathForRow:inSection:]( &OBJC_CLASS___NSIndexPath,  "indexPathForRow:inSection:",  -[NSIndexPath row](self, "row"),  (char *)-[NSIndexPath section](self, "section") + a3);
}
