...
- (BOOL)hasLocalChanges
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_interestSyncStorage, &v9, 0LL, 0LL);
...
- (id)dataForSetTransaction:(id)a3 key:(id)a4 version:(id *)a5
{
  ...
  id v11 = a3;
  uint64_t v12 = self;
  uint64_t v13 = sub_10016A4DC(v8, v10, a5);
  unint64_t v15 = v14;
...
LABEL_6:
  uint64_t v25 = swift_allocObject(&unk_100248090, 24LL, 7LL);
  *(void *)(v25 + 16) = v11;
  v26 = sub_10016C0F8;
LABEL_9:
  sub_10016B7A4((uint64_t)a4, v18, v19, v21, v22, v24, (void (*)(void))v26, v25);
...
LABEL_6:
  uint64_t v25 = swift_allocObject(&unk_100248068, 24LL, 7LL);
  *(void *)(v25 + 16) = v11;
  v26 = sub_10016C0F8;
LABEL_9:
  sub_10016B9A0(v19, v21, v22, v24, (void (*)(void))v26, v25);
  sub_1001341FC((uint64_t)v26, v25);
  swift_bridgeObjectRelease(v21);
  swift_bridgeObjectRelease(v24);
  sub_100133558((uint64_t)a4, v18);
...
LABEL_6:
  uint64_t v25 = swift_allocObject(&unk_100248040, 24LL, 7LL);
  *(void *)(v25 + 16) = v11;
  v26 = sub_10016BFD8;
LABEL_9:
  sub_10016BB90((uint64_t)a4, v18, v19, v21, v22, v24, (uint64_t (*)(void))v26, v25);
  sub_1001341FC((uint64_t)v26, v25);
  swift_bridgeObjectRelease(v21);
  swift_bridgeObjectRelease(v24);
  sub_100133558((uint64_t)a4, v18);
...
- (void)transaction:(id)a3 didProcessResponseWithDomainVersion:(id)a4
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_interestSyncStorage, v15, 33LL, 0LL);
