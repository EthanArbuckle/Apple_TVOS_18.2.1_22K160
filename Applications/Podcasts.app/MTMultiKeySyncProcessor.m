...
- (MTMultiKeySyncProcessor)initWithKeysAndProcessors:(id)a3
{
  uint64_t v4 = type metadata accessor for KeyProcessorPair();
  uint64_t v5 = static Array._unconditionallyBridgeFromObjectiveC(_:)(a3, v4);
  return (MTMultiKeySyncProcessor *)MultiKeySyncProcessor.init(keysAndProcessors:)(v5);
}

- (NSArray)dirtyKeys
{
  return (NSArray *)sub_10015DE7C(self, (uint64_t)a2, (uint64_t (*)(void))MultiKeySyncProcessor.dirtyKeys.getter);
}

- (NSArray)cleanKeys
{
  return (NSArray *)sub_10015DE7C(self, (uint64_t)a2, (uint64_t (*)(void))MultiKeySyncProcessor.cleanKeys.getter);
}
...
- (MTMultiKeySyncProcessor)init
{
  result = (MTMultiKeySyncProcessor *)_swift_stdlib_reportUnimplementedInitializer( "Podcasts.MultiKeySyncProcessor",  30LL,  "init()",  6LL,  0LL);
  __break(1u);
  return result;
}
...
LABEL_6:
  uint64_t v25 = swift_allocObject(&unk_100247DE0, 24LL, 7LL);
  *(void *)(v25 + 16) = v11;
  v26 = sub_1001496E8;
LABEL_9:
...
LABEL_6:
  uint64_t v25 = swift_allocObject(&unk_100247DB8, 24LL, 7LL);
  *(void *)(v25 + 16) = v11;
  v26 = sub_1001496E8;
LABEL_9:
...
LABEL_6:
  uint64_t v25 = swift_allocObject(&unk_100247D90, 24LL, 7LL);
  *(void *)(v25 + 16) = v11;
  v26 = sub_100149510;
LABEL_9:
...
- (void)transaction:(id)a3 didProcessResponseWithDomainVersion:(id)a4
{
  ...
  type metadata accessor for SyncKeysRepository(0LL);
  id v9 = a3;
  uint64_t v10 = self;
  id v11 = (id)static SyncKeysRepository.shared.getter(v10);
