...
- (TVNPRoutingMainViewController)initWithRoutingController:(id)a3 options:(id)a4
{
  ...
  if (v27)
  {
    ...
    if (os_log_type_enabled((os_log_t)v51, OS_LOG_TYPE_DEFAULT))
    {
      ...
      sub_100005DD0(v49);
      _os_log_impl((void *)&_mh_execute_header, log, type, "ROUTING: Fetch Active Endpoint", v49, 2u);
    }
    ...
    -[TVNPGroupableRoutingController addObserver:forKeyPath:options:context:]( v55->_routingController,  "addObserver:forKeyPath:options:context:",  v55,  @"currentDestination.destinationName",  0LL,  off_10006AB90);
    -[TVNPRoutingRoutesCollectionViewController addObserver:forKeyPath:options:context:]( v55->_routesCollectionViewController,  "addObserver:forKeyPath:options:context:",  v55,  @"focusedRoute",  0LL,  off_10006AB98);
...
- (void)dealloc
{
  ...
  -[TVNPRoutingRoutesCollectionViewController removeObserver:forKeyPath:context:]( v6->_routesCollectionViewController,  "removeObserver:forKeyPath:context:",  v6,  @"focusedRoute",  off_10006AB98);
  -[TVNPGroupableRoutingController removeObserver:forKeyPath:context:]( v6->_routingController,  "removeObserver:forKeyPath:context:",  v6,  @"currentDestination.destinationName",  off_10006AB90);
...
- (void)viewDidLoad
{
  ...
  -[UITapGestureRecognizer setAllowedPressTypes:](v70, "setAllowedPressTypes:", &off_10005B510);
  ...
  -[UITapGestureRecognizer setAllowedPressTypes:](v69, "setAllowedPressTypes:", &off_10005B528);
  ...
  -[UITapGestureRecognizer setAllowedPressTypes:](v68, "setAllowedPressTypes:", &off_10005B540);
...
- (void)didPressMute:(id)a3
{
  ...
  if ([location[0] state] == (id)3)
  {
    ...
    BOOL v14 = [v17 selectionState] == (id)2;
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        sub_100005DD0(v9);
        _os_log_impl((void *)&_mh_execute_header, log, type, "Mute not available", v9, 2u);
      }
...
- (void)_updateHintText
{
  ...
  BOOL v21 = (id)-[TVNPRoute selectionState](v20, "selectionState") == (id)2;
  ...
  if ((v37 & 1) != 0)
  {
    ...
    BOOL v14 =  -[NSBundle localizedStringForKey:value:table:]( v15,  "localizedStringForKey:value:table:",  @"ShareAudioHintText",  &stru_100059F90,  0LL);
  ...
  else
  {
    ...
    if (v12)
    {
      ...
      int v30 = -1073741824;
      int v31 = 0;
      id v32 = sub_10002478C;
      id v33 = &unk_1000587D8;
      id v34 = v43;
      id v47 = (dispatch_once_t *)&unk_10006B018;
      id location = 0LL;
    ...
    else if (v40 && v39 && !editingVolume)
    {
      ...
      int v23 = -1073741824;
      int v24 = 0;
      id v25 = sub_100024D64;
      id v26 = &unk_1000587D8;
      id v27 = v43;
      id v45 = (dispatch_once_t *)&unk_10006B028;
      id v44 = 0LL;
...
+ (id)_destinationLayout
{
  ...
  id v5 = -[TVNPRoutingDestinationsCollectionViewLayout initWithSectionProvider:configuration:]( v2,  "initWithSectionProvider:configuration:",  &stru_100059290,  v6[0]);
  BOOL v4 = v5;
...
- (id)_routesLayout
{
  ...
  int v6 = -1073741824;
  int v7 = 0;
  unsigned __int8 v8 = sub_100025890;
  objc_super v9 = &unk_1000592B8;
