...
- (void)dealloc
{
  ...
  -[TVNPRoutingDestination removeObserver:forKeyPath:context:]( v4->_destinationForVolume,  "removeObserver:forKeyPath:context:",  v4,  @"volumeLevel",  off_10006A800);
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if ((-[TVNPRoutingController allowsDestinationSelection]( v33->_routingController,  "allowsDestinationSelection") & 1) != 0 && v33->_initialUIDProvider)
  {
    ...
    {
      sub_100007A94((uint64_t)v35, (uint64_t)v28);
      _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)location,  v26,  "ROUTING: Active Endpoint UID %{public}@",  v35,  0xCu);
    }
    ...
    int v20 = -1073741824;
    int v21 = 0;
    objc_super v22 = sub_100007AD4;
    SEL v23 = &unk_100058D10;
    id v24 = v28;
    ...
    if (v29 == 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
      {
        ...
        sub_100005DD0(v12);
        _os_log_impl((void *)&_mh_execute_header, v5, v6, "ROUTING: No Matching Active Endpoint", v12, 2u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        sub_100005DD0(v16);
        _os_log_impl((void *)&_mh_execute_header, v7, v8, "ROUTING: Found Active Endpoint", v16, 2u);
      }
  ...
  {
    sub_100007B78((uint64_t)v34, v33->_initialFocusIndex);
    _os_log_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_DEFAULT, "ROUTING: Initial Focus Index: %ld", v34, 0xCu);
  }
  ...
  if (a3 != self->_observingChanges)
  {
    if (v8 && v10->_shouldIgnoreChanges)
    {
      ...
      if (os_log_type_enabled((os_log_t)location, OS_LOG_TYPE_ERROR))
      {
        ...
        sub_100005DD0(v5);
        _os_log_error_impl( (void *)&_mh_execute_header,  log,  type,  "We tried to begin observing changes while we were ignoring changes, skip adding observer",  v5,  2u);
      }
    ...
    else
    {
      ...
      if (v8) {
        -[TVNPRoutingController addObserver:forKeyPath:options:context:]( v10->_routingController,  "addObserver:forKeyPath:options:context:",  v10,  @"availableDestinations",  3LL,  off_10006A808);
      }
      else {
        -[TVNPRoutingController removeObserver:forKeyPath:context:]( v10->_routingController,  "removeObserver:forKeyPath:context:",  v10,  @"availableDestinations",  off_10006A808);
      }
    }
  }
...
- (void)setVolumeEditingInProgress:(BOOL)a3
{
  ...
  if (self->_volumeEditingInProgress != a3)
  {
    ...
    int v10 = -1073741824;
    int v11 = 0;
    id v12 = sub_10000837C;
    os_log_type_t v13 = &unk_1000587D8;
    v14 = v20;
...
- (void)setConnectingRoutingDestination:(id)a3
{
  ...
  -[TVNPRoutingDestination addObserver:forKeyPath:options:context:]( v4->_connectingRoutingDestination,  "addObserver:forKeyPath:options:context:",  v4,  @"disconnected",  0LL,  &unk_10006AFA8);
  objc_storeStrong(location, 0LL);
}
...
- (void)updateCollectionViewWithDestinations:(id)a3
{
  ...
  [v34 appendSectionsWithIdentifiers:&off_10005B4E0];
    ...
    while (1)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(oslog, OS_LOG_TYPE_ERROR))
        {
          ...
          id v7 = [v32 title];
          id v27 = v7;
          sub_100008A8C((uint64_t)v37, (uint64_t)v27);
          _os_log_error_impl((void *)&_mh_execute_header, log, v9, "Destination %@ has no unique identifier", v37, 0xCu);
  ...
  int v21 = -1073741824;
  int v22 = 0;
  SEL v23 = sub_100008ACC;
  id v24 = &unk_1000589C8;
...
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)a3
{
  ...
  BOOL v8 =  -[NSBundle localizedStringForKey:value:table:]( v9,  "localizedStringForKey:value:table:",  @"ConnectionFailedAlertButton",  &stru_100059F90,  0LL);
...
- (BOOL)_ignoreVolumeChangesWhilePendingSelection
{
  ...
  if (v8)
  {
    ...
    while (1)
    {
      ...
      if ([v10 selectionState] == (id)1 || objc_msgSend(v10, "selectionState") == (id)3) {
        break;
      }
      ++v5;
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  if (a6 == off_10006A808)
  {
    if (v32->_shouldIgnoreChanges)
    {
      ...
      if (os_log_type_enabled((os_log_t)v26, OS_LOG_TYPE_DEFAULT))
      {
        ...
        sub_100005DD0(v24);
        _os_log_impl( (void *)&_mh_execute_header,  log,  type,  "Destinations updated while we were ignoring changes",  v24,  2u);
      }
  ...
  else if (v28 == off_10006A800)
  {
    ...
    if (v23)
    {
      ...
      {
        sub_10000967C((uint64_t)v34, (uint64_t)v32->_destinationForVolume, (uint64_t)v23);
        _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v22,  v21,  "Destination %@ volume level changed to %@, acquiring volume button assertion",  v34,  0x16u);
      }
    ...
    else
    {
      ...
      {
        sub_100008A8C((uint64_t)v33, (uint64_t)v32->_destinationForVolume);
        _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v20,  v19,  "Destination %@ volume level removed, relinquishing volume button assertion",  v33,  0xCu);
      }
...
- (void)collectionView:(id)a3 didUpdateFocusInContext:(id)a4 withAnimationCoordinator:(id)a5
{
  ...
  if (v26)
  {
    ...
    int v20 = -1073741824;
    int v21 = 0;
    id v22 = sub_100009BD8;
    id v23 = &unk_100058D38;
    id v24 = v31;
    v25[0] = v26;
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled((os_log_t)v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        id v14 = v7;
        sub_10000967C((uint64_t)v33, (uint64_t)v17, (uint64_t)v14);
        _os_log_impl( (void *)&_mh_execute_header,  log,  type,  "Focused destination %@ has a volume level of %@, acquiring volume button assertion",  v33,  0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
      {
        sub_100008A8C((uint64_t)v32, (uint64_t)v17);
        _os_log_impl( (void *)&_mh_execute_header,  oslog,  OS_LOG_TYPE_DEFAULT,  "Focused destination %@ has no volume level relinquishing volume button assertion",  v32,  0xCu);
      }
    ...
    [v17 addObserver:v31 forKeyPath:@"volumeLevel" options:3 context:off_10006A800];
  ...
  if ([v44 isPaired])
  {
    ...
    else if ([v44 playbackState])
    {
      if (v46)
      {
        ...
        int v26 = -1073741824;
        int v27 = 0;
        id v28 = sub_10000A36C;
        id v29 = &unk_100058D60;
        id v30 = v43;
      ...
      else
      {
        ...
        int v18 = -1073741824;
        int v19 = 0;
        int v20 = sub_10000A3A8;
        int v21 = &unk_100058D60;
        id v22 = v43;
...
- (void)bulletinService:(id)a3 didDismissBulletin:(id)a4 withReason:(unint64_t)a5
{
  ...
  int v9 = -1073741824;
  int v10 = 0;
  char v11 = sub_10000A570;
  objc_super v12 = &unk_100058D38;
  id v13 = v15;
  v14[0] = v17;
