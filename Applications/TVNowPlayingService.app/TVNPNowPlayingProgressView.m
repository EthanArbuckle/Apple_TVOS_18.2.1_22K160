...
- (void)drawRect:(CGRect)a3
{
  ...
  if ((id)+[UIView userInterfaceLayoutDirectionForSemanticContentAttribute:]( &OBJC_CLASS___UIView,  "userInterfaceLayoutDirectionForSemanticContentAttribute:",  -[TVNPNowPlayingProgressView semanticContentAttribute](self, "semanticContentAttribute")) == (id)1)
  {
    CGRectGetWidth(v17);
    sub_10001A0CC();
  }
