...
- (void)viewDidLoad
{
  ...
  -[UILongPressGestureRecognizer setAllowedPressTypes:]( v43->_longPressRecognizer,  "setAllowedPressTypes:",  &off_10005B558);
  ...
  -[UITapGestureRecognizer setAllowedPressTypes:](v43->_menuRecognizer, "setAllowedPressTypes:", &off_10005B570);
  ...
  -[UITapGestureRecognizer setAllowedPressTypes:](v43->_selectRecognizer, "setAllowedPressTypes:", &off_10005B588);
...
- (void)setObservingChanges:(BOOL)a3
{
  if (a3 != self->_observingChanges)
  {
    ...
    if (a3) {
      -[TVNPRoutingController addObserver:forKeyPath:options:context:]( self->_routingController,  "addObserver:forKeyPath:options:context:",  self,  @"availableRoutesAndGroups",  3LL,  off_10006AD80);
    }
    else {
      -[TVNPRoutingController removeObserver:forKeyPath:context:]( self->_routingController,  "removeObserver:forKeyPath:context:",  self,  @"availableRoutesAndGroups",  off_10006AD80);
    }
  }
...
- (void)updateCollectionViewWithRoutes:(id)a3
{
  ...
  [v90 appendSectionsWithIdentifiers:&off_10005B5A0];
  ...
  if ((v85 & 1) != 0 && v84 == 1)
  {
    if (MGGetBoolAnswer(@"2zyzecwSf2ZYRpB3tuQhOQ") & 1) {
      [v90 appendItemsWithIdentifiers:&off_10005B5B8 intoSectionWithIdentifier:@"TVNPHeadphonesSectionIdentifier"];
    }
  }
  ...
  {
    sub_100007A94((uint64_t)v94, (uint64_t)v90);
    _os_log_impl( (void *)&_mh_execute_header,  oslog,  type,  "TVNPRoutingRoutesCollectionViewController: Applying snapshot %{public}@",  v94,  0xCu);
  }
...
- (void)handleVolumeUp
{
  ...
  BOOL v34 = (id)-[TVNPRoute selectionState](v37->_focusedRoute, "selectionState") == (id)2;
  if (v37->_focusedRoute && v36[0] && v34)
  {
    ...
    if (os_log_type_enabled((os_log_t)location[0], OS_LOG_TYPE_DEFAULT))
    {
      ...
      [v36[0] floatValue];
      sub_10002B09C((uint64_t)v39, focusedRoute, COERCE__INT64(v3), *(uint64_t *)&v33);
      _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)location[0],  v29,  "Focused route %@ volume up from %f to %f",  v39,  0x20u);
    }
  ...
  else if (v35)
  {
    ...
    if (os_log_type_enabled(oslog[0], OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v23 = v10;
      [v35 floatValue];
      sub_10002B09C((uint64_t)v38, (uint64_t)v10, COERCE__INT64(v5), (uint64_t)v28);
      _os_log_impl((void *)&_mh_execute_header, v11, v12, "Focused destination %@ volume up from %f to %f", v38, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      sub_100005DD0(v20);
      _os_log_impl((void *)&_mh_execute_header, v6, v7, "Volume up not available", v20, 2u);
    }
...
- (void)handleVolumeDown
{
  ...
  if (v37->_focusedRoute && v36[0] && v34)
  {
    ...
    if (os_log_type_enabled((os_log_t)location[0], OS_LOG_TYPE_DEFAULT))
    {
      ...
      [v36[0] floatValue];
      sub_10002B09C((uint64_t)v39, focusedRoute, COERCE__INT64(v3), *(uint64_t *)&v33);
      _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)location[0],  v29,  "Focused route %@ volume down from %f to %f",  v39,  0x20u);
    }
  ...
  else if (v35)
  {
    ...
    if (os_log_type_enabled(oslog[0], OS_LOG_TYPE_DEFAULT))
    {
      ...
      [v35 floatValue];
      sub_10002B09C((uint64_t)v38, (uint64_t)v10, COERCE__INT64(v5), (uint64_t)v28);
      _os_log_impl( (void *)&_mh_execute_header,  v11,  v12,  "Focused destination %@ volume down from %f to %f",  v38,  0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      os_log_type_t v7 = v21;
      sub_100005DD0(v20);
      _os_log_impl((void *)&_mh_execute_header, v6, v7, "Volume down not available", v20, 2u);
    }
...
- (void)longPressSelect:(id)a3
{
  ...
  location[0] = 0LL;
  objc_storeStrong(location, a3);
  if ([location[0] state] == (id)1)
  {
    float v3 = -[TVNPRoute volumeLevel](v6->_focusedRoute, "volumeLevel");
    BOOL v4 = 0;
    if (v3) {
      BOOL v4 = (id)-[TVNPRoute selectionState](v6->_focusedRoute, "selectionState") == (id)2;
    }
...
- (void)handleEndVolumeControl:(id)a3
{
  ...
  if ([location[0] state] == (id)3) {
    -[TVNPRoutingRoutesCollectionViewController setRouteForVolume:](v4, "setRouteForVolume:", 0LL);
  }
  objc_storeStrong(location, 0LL);
}
...
- (void)routeCellDidSelectRouteView:(id)a3
{
  ...
  else
  {
    ...
    else
    {
      ...
      BOOL v18 = [v17 playbackState] == (id)1;
      ...
      else
      {
        ...
        id v5 =  -[NSBundle localizedStringForKey:value:table:]( v6,  "localizedStringForKey:value:table:",  @"RoutingHijackNagMessage",  &stru_100059F90,  0LL);
        ...
        id v11 =  -[NSBundle localizedStringForKey:value:table:]( v12,  "localizedStringForKey:value:table:",  @"RoutingHijackNagCancel",  &stru_100059F90,  0LL);
        ...
        id v15 =  -[NSBundle localizedStringForKey:value:table:]( v16,  "localizedStringForKey:value:table:",  @"RoutingHijackNagConfirm",  &stru_100059F90,  0LL);
        double v32 = _NSConcreteStackBlock;
        int v33 = -1073741824;
        int v34 = 0;
        id v35 = sub_10002CE04;
        id v36 = &unk_100059348;
        uint64_t v37 = v46;
        id v38 = v44;
...
- (void)_calculateVisibleVolumeCells
{
  ...
  if (v11)
  {
    ...
    while (1)
    {
      ...
      char v19 = 0;
      BOOL v4 = 0;
      if ([location selectionState] == (id)2)
      {
