...
- (void)setDestination:(id)a3
{
  ...
  [location[0] addObserver:v4 forKeyPath:@"deviceImage" options:4 context:off_10006AEE0];
  [location[0] addObserver:v4 forKeyPath:@"subtitle" options:4 context:off_10006AEE8];
  [location[0] addObserver:v4 forKeyPath:@"artworkImage" options:4 context:off_10006AEF0];
  [location[0] addObserver:v4 forKeyPath:@"paired" options:4 context:off_10006AEF8];
  [location[0] addObserver:v4 forKeyPath:@"playbackState" options:4 context:off_10006AF00];
  [location[0] addObserver:v4 forKeyPath:@"volumeLevel" options:4 context:off_10006AF08];
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  v10 = a6;
  if (a6 == off_10006AED8 || v10 == off_10006AEE0 || v10 == off_10006AEE8 || v10 == off_10006AEF0)
  {
LABEL_11:
  ...
  if (v10 != off_10006AEF8 && v10 != off_10006AF00)
  {
    if (v10 != off_10006AF08)
    {
      v9.receiver = v14;
...
- (void)_updateNowPlayingInfo
{
  ...
  else
  {
    ...
    if (-[TVNPRoutingDestination isConnecting](self->_destination, "isConnecting"))
    {
      ...
      char v19 = 1;
      v18 =  -[NSBundle localizedStringForKey:value:table:]( v20,  "localizedStringForKey:value:table:",  @"ConnectingTitle",  &stru_100059F90,  @"Localizable");
      char v17 = 1;
      v8 = v18;
    }
    ...
    else
    {
      if (-[TVNPRoutingDestination isConnected](self->_destination, "isConnected"))
      {
        ...
        char v15 = 1;
        v14 =  -[NSBundle localizedStringForKey:value:table:]( v16,  "localizedStringForKey:value:table:",  @"ChooseMusicTitle",  &stru_100059F90,  @"Localizable");
        char v13 = 1;
        v7 = v14;
      }
      ...
      else
      {
        ...
        char v11 = 1;
        v10 =  -[NSBundle localizedStringForKey:value:table:]( v12,  "localizedStringForKey:value:table:",  @"SelectToConnectTitle",  &stru_100059F90,  @"Localizable");
        char v9 = 1;
        v7 = v10;
      }
