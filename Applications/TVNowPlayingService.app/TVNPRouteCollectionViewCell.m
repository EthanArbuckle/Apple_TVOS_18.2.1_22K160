...
- (void)setRoute:(id)a3
{
  ...
  {
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"title",  off_10006A870);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"deviceImage",  off_10006A878);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"deviceType",  off_10006A880);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"selectionState",  off_10006A888);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"volumeLevel",  off_10006A890);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"canBeGrouped",  off_10006A898);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"destination.isCurrentDestination",  off_10006A8A0);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"destination.playbackState",  off_10006A8A8);
    -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"destination.singleLineTitle",  off_10006A8B0);
    route = v8->_route;
    uint64_t v3 = objc_opt_class(&OBJC_CLASS___TVNPOutputDeviceRoute);
    if ((objc_opt_isKindOfClass(route, v3) & 1) != 0) {
      -[TVNPRoute removeObserver:forKeyPath:context:]( v8->_route,  "removeObserver:forKeyPath:context:",  v8,  @"batteryLevel",  off_10006A8B8);
    }
    objc_storeStrong((id *)&v8->_route, location[0]);
    objc_msgSend(location[0], "addObserver:forKeyPath:options:context:", v8, @"title");
    [location[0] addObserver:v8 forKeyPath:@"deviceImage" options:4 context:off_10006A878];
    [location[0] addObserver:v8 forKeyPath:@"deviceType" options:4 context:off_10006A880];
    [location[0] addObserver:v8 forKeyPath:@"selectionState" options:4 context:off_10006A888];
    [location[0] addObserver:v8 forKeyPath:@"volumeLevel" options:4 context:off_10006A890];
    [location[0] addObserver:v8 forKeyPath:@"canBeGrouped" options:4 context:off_10006A898];
    [location[0] addObserver:v8 forKeyPath:@"destination.isCurrentDestination" options:4 context:off_10006A8A0];
    [location[0] addObserver:v8 forKeyPath:@"destination.playbackState" options:4 context:off_10006A8A8];
    [location[0] addObserver:v8 forKeyPath:@"destination.singleLineTitle" options:4 context:off_10006A8B0];
    id v5 = location[0];
    uint64_t v4 = objc_opt_class(&OBJC_CLASS___TVNPOutputDeviceRoute);
    if ((objc_opt_isKindOfClass(v5, v4) & 1) != 0) {
      [location[0] addObserver:v8 forKeyPath:@"batteryLevel" options:4 context:off_10006A8B8];
    }
  }
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  else if (v20 == off_10006A880)
  {
    -[TVNPBaseRouteCollectionViewCell setDeviceType:]( v24,  "setDeviceType:",  -[TVNPRoute deviceType](v24->_route, "deviceType"));
  }

  else if (v20 == off_10006A888)
  {
    BOOL v19 = (id)-[TVNPRoute selectionState](v24->_route, "selectionState") == (id)2;
    BOOL v18 = (id)-[TVNPRoute selectionState](v24->_route, "selectionState") == (id)1;
...
- (void)_updateMusicBarState
{
  ...
  id v10 = -[TVNPRoutingDestination playbackState](v9, "playbackState");
...
- (id)_batteryTextForBatteryLevel:(id)a3
{
  ...
  {
    sub_100008A8C((uint64_t)v70, (uint64_t)location[0]);
    _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v66,  v65,  "[TVNPRouteCollectionViewCell Module] Battery level: %@",  v70,  0xCu);
  }
  ...
  if (v54)
  {
    if (-[TVNPRouteCollectionViewCell _shouldShowSeparateBatteryPercentagesForBatteryLevel:]( v68,  "_shouldShowSeparateBatteryPercentagesForBatteryLevel:",  location[0]))
    {
      ...
      v51 =  -[NSBundle localizedStringForKey:value:table:]( v52,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelCombinedFormat",  &stru_100059F90,  0LL);
    ...
    else
    {
      ...
      *(float *)&double v7 = v46;
      ...
      v42 =  -[NSBundle localizedStringForKey:value:table:]( v43,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelSingleFormat",  &stru_100059F90);
  ...
  else
  {
    ...
    if (v40)
    {
      ...
      v38 =  -[NSBundle localizedStringForKey:value:table:]( v39,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelLeftFormat",  &stru_100059F90,  0LL);
    ...
    else
    {
      ...
      if (v35)
      {
        ...
        v33 =  -[NSBundle localizedStringForKey:value:table:]( v34,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelRightFormat",  &stru_100059F90,  0LL);
      ...
      else
      {
        ...
        if (v30)
        {
          ...
          v28 =  -[NSBundle localizedStringForKey:value:table:]( v29,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelSingleFormat",  &stru_100059F90,  0LL);
  ...
  if (v25)
  {
    ...
    v23 =  -[NSBundle localizedStringForKey:value:table:]( v24,  "localizedStringForKey:value:table:",  @"AirPodsBatteryLevelCaseFormat",  &stru_100059F90,  0LL);
    id v20 = v62;
