...
id sub_100003154(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "layoutIfNeeded", a1, a1);
}

void sub_100003B90(id a1)
{
  v1 = -[UIColor initWithWhite:alpha:](objc_alloc(&OBJC_CLASS___UIColor), "initWithWhite:alpha:", 1.0, 0.3);
  v2 = (void *)qword_10006AF88;
  qword_10006AF88 = (uint64_t)v1;
}

void sub_100003C68(id a1)
{
  v1 = +[UIColor blackColor](&OBJC_CLASS___UIColor, "blackColor", a1, a1);
  v2 = (void *)qword_10006AF98;
  qword_10006AF98 = (uint64_t)v1;
}

void sub_1000044F0(id *a1, void *a2)
{
  location[1] = a1;
  location[0] = 0LL;
...
_BYTE *sub_100005DD0(_BYTE *result)
{
  *result = 0;
  result[1] = 0;
  return result;
...
void sub_100005DEC(id *a1)
{
  ...
  if (v7[0])
  {
    ...
    if (os_log_type_enabled((os_log_t)location, OS_LOG_TYPE_DEFAULT))
    {
      ...
      sub_100005DD0(v4);
      _os_log_impl((void *)&_mh_execute_header, log, type, "ROUTING: Fetching initial endpoints (complete)", v4, 2u);
    }

    objc_storeStrong(&location, 0LL);
    v1 = (dispatch_group_s *)[v7[0] initialFetchGroup];
...
void sub_10000611C(id *a1)
{
  v4[2] = a1;
  v4[1] = a1;
  v4[0] = objc_loadWeakRetained(a1 + 5);
  if (v4[0] && ([v4[0] presentationEnded] & 1) == 0)
  {
    v1 = objc_alloc(&OBJC_CLASS___TVNPRoutingMainViewController);
    id v2 = [v4[0] routingController];
    id v3 = -[TVNPRoutingMainViewController initWithRoutingController:options:](v1, "initWithRoutingController:options:");

    -[TVNPRoutingMainViewController setDelegate:](v3, "setDelegate:", v4[0]);
    objc_msgSend(v4[0], "presentViewController:animated:completion:", v3, 1);
...
void sub_1000063C8(uint64_t a1)
{
  ...
  objc_storeStrong((id *)(*(void *)(a1 + 32) + 24LL), 0LL);
}

uint64_t sub_100006A7C(uint64_t result)
{
  if (*(void *)(result + 32)) {
...
void sub_10000737C( uint64_t a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, id *location)
{
  *(void *)(v13 - 64) = a1;
  *(_DWORD *)(v13 - 68) = a2;
...
id sub_1000073D8(id *a1, void *a2, void *a3, void *a4)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  id v10 = location[0];
  id v4 = (objc_class *)objc_opt_class(&OBJC_CLASS___TVNPRoutingDestinationCollectionViewCell);
...
uint64_t sub_100007A94(uint64_t result, uint64_t a2)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 1;
  *(_BYTE *)(result + 2) = 66;
...
uint64_t sub_100007AD4(void *a1, void *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
uint64_t sub_100007B78(uint64_t result, uint64_t a2)
{
  *(_BYTE *)result = 0;
  *(_BYTE *)(result + 1) = 1;
  *(_BYTE *)(result + 2) = 0;
...
uint64_t sub_10000A3A8(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 + 32) + 16LL))();
}

id *sub_10000A570(id *result)
{
...
LABEL_9:
  ...
  if (v7 == 1 || v16 == 2)
  {
    int v6 = -[TVNPRoute destination](v18->_route, "destination");
    int v5 = -[TVNPRoutingDestination singleLineTitle](v6, "singleLineTitle");
    id v2 = -[NSString copy](v5, "copy");
    id v3 = v11;
    v11 = v2;
  }
...
void sub_10000D85C(id a1)
{
  ...
  id v2 = (void *)qword_10006AFB8;
  qword_10006AFB8 = (uint64_t)v1;
}
...
uint64_t sub_10000ED6C(void *a1, void *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
uint64_t sub_10000EE38(uint64_t result, int a2, int a3, int a4, int a5)
{
  *(_BYTE *)result = 0;
  *(_BYTE *)(result + 1) = 4;
  *(_BYTE *)(result + 2) = 0;
...
uint64_t sub_10000EEA8(uint64_t result, uint64_t a2, uint64_t a3)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 2;
  *(_BYTE *)(result + 2) = 66;
...
void sub_10000EEF8(id a1, NSError *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  oslog[1] = (os_log_t)a1;
  oslog[0] = (os_log_t)(id)qword_10006AFB8;
  if (os_log_type_enabled(oslog[0], OS_LOG_TYPE_DEFAULT))
  {
    sub_100007A94((uint64_t)v5, (uint64_t)location[0]);
...
void sub_10000EFEC(id a1, NSError *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  if (os_log_type_enabled(oslog[0], OS_LOG_TYPE_DEFAULT))
  {
    sub_100008A8C((uint64_t)v5, (uint64_t)location[0]);
...
void sub_10000F444(id a1, NSError *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
void sub_10000F7FC(uint64_t a1, char a2, id obj)
{
  uint64_t v13 = a1;
  char v12 = a2 & 1;
  id location = 0LL;
  ...
  if (location)
  {
    os_log_t oslog = (os_log_t)(id)qword_10006AFB8;
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_ERROR))
    {
      sub_100008A8C((uint64_t)v14, (uint64_t)location);
  ...
  {
    id v9 = (id)qword_10006AFB8;
    os_log_type_t v8 = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled((os_log_t)v9, OS_LOG_TYPE_DEFAULT))
    {
      sub_100008A8C((uint64_t)v15, *(void *)(a1 + 40));
...
void sub_1000102C0(uint64_t a1, uint64_t a2)
{
...
void sub_100010340(uint64_t a1)
{
  id v16[2] = (id)a1;
  v16[1] = (id)a1;
  id v3 = *(void **)(a1 + 32);
  ...
  int v11 = -1073741824;
  int v12 = 0;
  uint64_t v13 = sub_1000104DC;
  id v14 = &unk_100058FE0;
  v15[1] = *(id *)(a1 + 56);
  ...
  int v5 = -1073741824;
  int v6 = 0;
  unsigned __int8 v7 = sub_10001057C;
  os_log_type_t v8 = &unk_100059008;
  v9[1] = *(id *)(a1 + 64);
  v9[0] = *(id *)(a1 + 40);
...
void sub_10001049C(uint64_t a1, int a2)
{
  *(void *)(v2 - 80) = a1;
  *(_DWORD *)(v2 - 84) = a2;
...
void sub_1000104DC(uint64_t a1, void *a2)
{
  location[1] = (id)a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
uint64_t sub_100013B40(uint64_t result, uint64_t a2, uint64_t a3)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 2;
  *(_BYTE *)(result + 2) = 0;
...
uint64_t sub_100013B90(void *a1, void *a2, void *a3, void *a4)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
uint64_t sub_100013C4C(uint64_t result, uint64_t a2, uint64_t a3, uint64_t a4)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 3;
  *(_BYTE *)(result + 2) = 66;
...
void sub_100013CB4(id *a1, void *a2, void *a3)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
int64_t sub_100013E2C(id a1, TVNPRoute *a2, TVNPRoute *a3)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
uint64_t sub_100014128(uint64_t result, int a2, int a3, int a4, int a5, int a6, uint64_t a7, uint64_t a8)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 7;
  *(_BYTE *)(result + 2) = 0;
...
uint64_t sub_1000141E4( uint64_t result, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, int a6, int a7, uint64_t a8, uint64_t a9)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 8;
  *(_BYTE *)(result + 2) = 0;
...
void sub_10001667C(uint64_t a1)
{
  ...
  id v2 = (void *)qword_10006AFC0;
  qword_10006AFC0 = (uint64_t)v1;
}
...
void sub_100016C38(uint64_t a1)
{
  ...
  else
  {
    ...
    id v2 =  +[NSError errorWithDomain:code:userInfo:]( &OBJC_CLASS___NSError,  "errorWithDomain:code:userInfo:",  @"TVServicesErrorDomain",  201LL);
    (*(void (**)(uint64_t, void, void, void, void))(v1 + 16))(v1, 0LL, 0LL, 0LL, 0LL);
  }
...
void sub_10001BDF8(id *a1, void *a2, void *a3)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
void sub_10001E604(id a1)
{
  ...
  id v2 = v4[0];
  uint64_t v3 =  +[_UIFocusAnimationConfiguration configurationWithStyle:]( &OBJC_CLASS____UIFocusAnimationConfiguration,  "configurationWithStyle:",  2LL);
...
void sub_10001FB10(id a1)
{
  uint64_t v1 = +[UIColor blackColor](&OBJC_CLASS___UIColor, "blackColor");
  id v2 = (void *)qword_10006AFD8;
  qword_10006AFD8 = (uint64_t)v1;

  uint64_t v3 = +[UIColor whiteColor](&OBJC_CLASS___UIColor, "whiteColor");
  id v4 = (void *)qword_10006AFE0;
  qword_10006AFE0 = (uint64_t)v3;

  uint64_t v5 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:");
  id v6 = (void *)qword_10006AFE8;
  qword_10006AFE8 = (uint64_t)v5;

  id v7 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:");
  id v8 = (void *)qword_10006AFF0;
  qword_10006AFF0 = (uint64_t)v7;

  id v9 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:", 0.0, 1.0);
  id v10 = (void *)qword_10006AFF8;
  qword_10006AFF8 = (uint64_t)v9;

  unsigned int v11 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:", 1.0, 0.5);
  id v12 = (void *)qword_10006B000;
  qword_10006B000 = (uint64_t)v11;
}

id sub_10001FC6C(uint64_t a1)
{
  int64_t v26 = *(void **)(*(void *)(a1 + 32) + 144LL);
  if ((*(_BYTE *)(a1 + 40) & 1) != 0) {
    [v26 setTextColor:qword_10006AFD8];
  }
  else {
    [v26 setTextColor:qword_10006AFE0];
  }
  id v24 = *(void **)(*(void *)(a1 + 32) + 152LL);
  if ((*(_BYTE *)(a1 + 40) & 1) != 0) {
    [v24 setTextColor:qword_10006AFE8];
  }
  else {
    [v24 setTextColor:qword_10006AFF0];
  }
  v23 = *(void **)(*(void *)(a1 + 32) + 136LL);
  if ((*(_BYTE *)(a1 + 40) & 1) != 0) {
    [v23 setTintColor:qword_10006AFE8];
  }
  else {
    [v23 setTintColor:qword_10006AFF0];
  }
  id v22 = *(void **)(*(void *)(a1 + 32) + 104LL);
  if ((*(_BYTE *)(a1 + 40) & 1) != 0) {
    [v22 setTintColor:qword_10006AFD8];
  }
  else {
    [v22 setTintColor:qword_10006AFE0];
  }
  id v21 = *(void **)(*(void *)(a1 + 32) + 112LL);
  if ((*(_BYTE *)(a1 + 40) & 1) != 0) {
    [v21 setTintColor:qword_10006AFD8];
  }
  else {
    [v21 setTintColor:qword_10006AFE0];
  }
  char v20 = *(void **)(*(void *)(a1 + 32) + 160LL);
  if ((*(_BYTE *)(a1 + 40) & 1) != 0) {
    [v20 setTintColor:qword_10006AFF8];
  }
  else {
    [v20 setTintColor:qword_10006B000];
  }
  id v19 = *(void **)(*(void *)(a1 + 32) + 120LL);
  if ((*(_BYTE *)(a1 + 40) & 1) != 0) {
    [v19 setTintColor:qword_10006AFD8];
  }
  else {
    [v19 setTintColor:qword_10006AFE0];
  }
  v16 = *(void **)(*(void *)(a1 + 32) + 120LL);
  ...
  unsigned int v11 = *(void **)(*(void *)(a1 + 32) + 152LL);
  if ((*(_BYTE *)(a1 + 43) & 1) != 0)
  {
    [v11 setAlpha:0.0];
  }
  ...
  if ((*(_BYTE *)(a1 + 46) & 1) != 0) {
    return [v10 setTintColor:qword_10006AFD8];
  }
  else {
    return [v10 setTintColor:qword_10006AFE0];
  }
}

void sub_100021828(_DWORD *a1, void *a2, unint64_t a3, void *a4)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  *((void *)&v30 + 1) = v7;
  __int128 v31 = v30;
  sub_100020E74();
  int64_t v26 = +[NSValue valueWithCGRect:](&OBJC_CLASS___NSValue, "valueWithCGRect:", v8, v9, v10, v11);
  v35[0] = v26;
  sub_100020E74();
  v25 = +[NSValue valueWithCGRect:](&OBJC_CLASS___NSValue, "valueWithCGRect:", v12, v13, v14, v15);
  v35[1] = v25;
  sub_100020E74();
  ...
  [v32[0] setKeyTimes:&off_10005B4F8];
...
void sub_10002279C(uint64_t a1, uint64_t a2)
{
  id location = (id *)(a2 + 40);
  double v2 = *(void **)(a2 + 40);
  double v3 = (id *)(a1 + 40);
  *double v3 = 0LL;
  objc_storeStrong(v3, v2);
  objc_storeStrong(location, 0LL);
...
void sub_1000227F0(uint64_t a1)
{
}
...
uint64_t sub_10002281C(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled(oslog[0], OS_LOG_TYPE_DEFAULT))
  {
    sub_100007A94((uint64_t)v10, v8);
    _os_log_impl( (void *)&_mh_execute_header,  oslog[0],  OS_LOG_TYPE_DEFAULT,  "ROUTING: Fetch Active Endpoint Complete: %{public}@",  v10,  0xCu);
  }
...
id sub_100022930(uint64_t a1)
{
  return *(id *)(*(void *)(*(void *)(a1 + 40) + 8LL) + 40LL);
}

void sub_10002478C(id *a1)
{
  v38[2] = a1;
  v38[1] = a1;
  ...
  unint64_t v33 =  +[UIImage imageNamed:inBundle:compatibleWithTraitCollection:]( &OBJC_CLASS___UIImage,  "imageNamed:inBundle:compatibleWithTraitCollection:",  @"nowplaying_volumebtn-dwn",  v11);
  ...
  __int16 v30 = -4;
  __int128 v31 = +[NSString stringWithCharacters:length:](&OBJC_CLASS___NSString, "stringWithCharacters:length:", &v30);
  double v14 = objc_alloc(&OBJC_CLASS___NSAttributedString);
  double v13 = v31;
  NSAttributedStringKey v43 = NSAttachmentAttributeName;
  v44 = v35;
  double v15 =  +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  &v44,  &v43,  1LL);
  v29 = -[NSAttributedString initWithString:attributes:](v14, "initWithString:attributes:", v13);

  double v17 = objc_alloc(&OBJC_CLASS___NSAttributedString);
  double v16 = v31;
  NSAttributedStringKey v41 = NSAttachmentAttributeName;
  v42 = v32;
  double v18 =  +[NSDictionary dictionaryWithObjects:forKeys:count:]( &OBJC_CLASS___NSDictionary,  "dictionaryWithObjects:forKeys:count:",  &v42,  &v41,  1LL);
  id v28 = -[NSAttributedString initWithString:attributes:](v17, "initWithString:attributes:", v16);

  double v20 = +[NSBundle bundleForClass:](&OBJC_CLASS___NSBundle, "bundleForClass:", objc_opt_class(a1[4]));
  v27 =  -[NSBundle localizedStringForKey:value:table:]( v20,  "localizedStringForKey:value:table:",  @"MasterVolumeText",  &stru_100059F90,  0LL);
  ...
  uint64_t v8 = (void *)qword_10006B010;
  qword_10006B010 = (uint64_t)v7;
...
void sub_100024D64(id *a1)
{
  ...
  double v20 = +[NSBundle bundleForClass:](&OBJC_CLASS___NSBundle, "bundleForClass:", objc_opt_class(a1[4]));
  v27 =  -[NSBundle localizedStringForKey:value:table:]( v20,  "localizedStringForKey:value:table:",  @"PressAndHoldForVolumeText",  &stru_100059F90,  0LL);
  ...
  id v7 = -[NSMutableAttributedString copy](v26, "copy");
  uint64_t v8 = (void *)qword_10006B020;
  qword_10006B020 = (uint64_t)v7;
...
NSCollectionLayoutSection *__cdecl sub_1000253F4(id a1, int64_t a2, NSCollectionLayoutEnvironment *a3)
{
  id location[2] = a1;
  location[1] = (id)a2;
  location[0] = 0LL;
  ...
  double v18 =  +[NSCollectionLayoutItem itemWithLayoutSize:]( &OBJC_CLASS___NSCollectionLayoutItem,  "itemWithLayoutSize:",  v19[0]);
  id v11 = v19[0];
  double v21 = v18;
  id v12 = +[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", &v21, 1LL);
  double v17 =  +[NSCollectionLayoutGroup horizontalGroupWithLayoutSize:subitems:]( &OBJC_CLASS___NSCollectionLayoutGroup,  "horizontalGroupWithLayoutSize:subitems:",  v11);

  double v16 =  +[NSCollectionLayoutSection sectionWithGroup:]( &OBJC_CLASS___NSCollectionLayoutSection,  "sectionWithGroup:",  v17);
...
void sub_100025834( uint64_t a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, id *location)
{
  *(void *)(v11 - 40) = a1;
  *(_DWORD *)(v11 - 44) = a2;
...
id sub_100025890(id *a1, void *a2, id obj)
{
  id location[2] = a1;
  location[1] = a2;
  location[0] = 0LL;
  ...
  if (!v24)
  {
    double v15 =  +[NSCollectionLayoutDimension fractionalWidthDimension:]( &OBJC_CLASS___NSCollectionLayoutDimension,  "fractionalWidthDimension:",  1.0);
    double v14 =  +[NSCollectionLayoutDimension estimatedDimension:]( &OBJC_CLASS___NSCollectionLayoutDimension,  "estimatedDimension:",  60.0);
    ...
    id v16 = v26;
    id v29 = v25[0];
    double v17 = +[NSArray arrayWithObjects:count:](&OBJC_CLASS___NSArray, "arrayWithObjects:count:", &v29, 1LL);
...
BOOL sub_100027590(id a1, UIPress *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
id sub_100029468(id *a1, void *a2, void *a3, void *a4)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  {
    double v5 = (objc_class *)objc_opt_class(&OBJC_CLASS___TVNPRouteCollectionViewCell);
    double v20 = NSStringFromClass(v5);
    char v19 = 1;
  ...
  if ((v22 & 1) != 0)
  {
    ...
    id v12 =  -[NSBundle localizedStringForKey:value:table:]( v13,  "localizedStringForKey:value:table:",  @"ShareAudioTitle",  &stru_100059F90,  0LL);
...
id sub_10002978C(id *a1, void *a2, void *a3, void *a4)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  if ([v16 isEqualToString:@"TVNPHeadphonesSectionIdentifier"])
  {
    ...
    id v8 =  -[NSBundle localizedStringForKey:value:table:]( v9,  "localizedStringForKey:value:table:",  @"RoutingHeadphonesSectionTitle",  &stru_100059F90,  0LL);
  ...
  else if ([v16 isEqualToString:@"TVNPSpeakersSectionIdentifier"])
  {
    ...
    uint64_t v6 =  -[NSBundle localizedStringForKey:value:table:]( v7,  "localizedStringForKey:value:table:",  @"RoutingSpeakersSectionTitle",  &stru_100059F90,  0LL);
    objc_msgSend(v17, "setTitle:");
  }
...
id sub_10002AB5C(uint64_t a1)
{
  return [*(id *)(a1 + 32) _calculateVisibleVolumeCells];
}

uint64_t sub_10002B09C(uint64_t result, uint64_t a2, uint64_t a3, uint64_t a4)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 3;
  *(_BYTE *)(result + 2) = 64;
...
void sub_10002C598(uint64_t a1)
{
  id v1 = [*(id *)(a1 + 32) collectionView];
  [v1 layoutIfNeeded];
}
...
id sub_10002F450(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "_updateVolume", a1, a1);
}

id sub_10002F564(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "_updateVolume", a1, a1);
}

id sub_10002F67C(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "_updateVolume", a1, a1);
}

uint64_t sub_10002FC44(uint64_t result, uint64_t a2, uint64_t a3, int a4, int a5, int a6, int a7)
{
  *(_BYTE *)result = 2;
  *(_BYTE *)(result + 1) = 6;
  *(_BYTE *)(result + 2) = 32;
...
uint64_t start(int a1, char **a2)
{
  ...
  id v2 = (objc_class *)objc_opt_class(&OBJC_CLASS___TVNowPlayingServiceAppDelegate);
...
id sub_100031974(uint64_t a1)
{
  return objc_msgSend( *(id *)(a1 + 32),  "_configureAppearanceForControlState:withAnimationCoordinator:",  objc_msgSend(*(id *)(a1 + 32), "_controlStateForCell"),  0);
}

void sub_100032278(id a1)
{
  id v4[2] = a1;
  v4[1] = a1;
  ...
  id v2 = v4[0];
  BOOL v3 =  +[_UIFocusAnimationConfiguration configurationWithStyle:]( &OBJC_CLASS____UIFocusAnimationConfiguration,  "configurationWithStyle:",  2LL);
  objc_msgSend(v2, "setFocusAnimationConfiguration:");
...
void sub_10003371C(id a1)
{
  id v1 = +[UIColor blackColor](&OBJC_CLASS___UIColor, "blackColor");
  id v2 = (void *)qword_10006B038;
  qword_10006B038 = (uint64_t)v1;

  BOOL v3 = +[UIColor whiteColor](&OBJC_CLASS___UIColor, "whiteColor");
  id v4 = (void *)qword_10006B040;
  qword_10006B040 = (uint64_t)v3;

  uint64_t v5 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:");
  uint64_t v6 = (void *)qword_10006B048;
  qword_10006B048 = (uint64_t)v5;

  id v7 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:");
  unsigned int v8 = (void *)qword_10006B050;
  qword_10006B050 = (uint64_t)v7;

  id v9 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:", 0.0, 1.0);
  id v10 = (void *)qword_10006B058;
  qword_10006B058 = (uint64_t)v9;

  id v11 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:", 1.0, 0.5);
  id v12 = (void *)qword_10006B060;
  qword_10006B060 = (uint64_t)v11;

  id v13 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:", 0.0, 0.05);
  id v14 = (void *)qword_10006B068;
  qword_10006B068 = (uint64_t)v13;

  id v15 = +[UIColor colorWithWhite:alpha:](&OBJC_CLASS___UIColor, "colorWithWhite:alpha:", 1.0, 0.1);
  id v16 = (void *)qword_10006B070;
  qword_10006B070 = (uint64_t)v15;
}

id sub_1000338E4(uint64_t a1)
{
  ...
  id v15 = *(void **)(*(void *)(a1 + 32) + 112LL);
  if ((*(_BYTE *)(a1 + 41) & 1) != 0) {
    [v15 setTextColor:qword_10006B038];
  }
  else {
    [v15 setTextColor:qword_10006B040];
  }
  id v13 = *(void **)(*(void *)(a1 + 32) + 88LL);
  if ((*(_BYTE *)(a1 + 41) & 1) != 0) {
    [v13 setTintColor:qword_10006B038];
  }
  else {
    [v13 setTintColor:qword_10006B040];
  }
  id v12 = *(void **)(*(void *)(a1 + 32) + 96LL);
  if ((*(_BYTE *)(a1 + 41) & 1) != 0) {
    [v12 setTintColor:qword_10006B038];
  }
  else {
    [v12 setTintColor:qword_10006B040];
  }
  id v11 = *(void **)(*(void *)(a1 + 32) + 120LL);
  if ((*(_BYTE *)(a1 + 41) & 1) != 0) {
    [v11 setTextColor:qword_10006B048];
  }
  else {
    [v11 setTextColor:qword_10006B050];
  }
  id v10 = *(void **)(*(void *)(a1 + 32) + 136LL);
  if ((*(_BYTE *)(a1 + 41) & 1) != 0) {
    [v10 setTintColor:qword_10006B048];
  }
  else {
    [v10 setTintColor:qword_10006B050];
  }
  id v9 = *(void **)(*(void *)(a1 + 32) + 80LL);
  if ((*(_BYTE *)(a1 + 41) & 1) != 0) {
    return objc_msgSend(v9, "setBackgroundColor:", qword_10006B068, qword_10006B068);
  }
  else {
    return objc_msgSend(v9, "setBackgroundColor:", qword_10006B070, qword_10006B070);
  }
}
...
void sub_10003459C(id *a1, void *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  if (v3[0]) {
    [v3[0] _nowPlayingInfoDidChange:location[0]];
  }
  objc_storeStrong(v3, 0LL);
  objc_storeStrong(location, 0LL);
}

void sub_100035214(id *a1, void *a2, void *a3)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  v11[1] = a1;
  v11[0] = [a1[4] mediaItemMetadataForProperty:location[0]];
  char v10 = v5;
  id v4 = v12;
  uint64_t v3 = objc_opt_class(&OBJC_CLASS___MPArtworkCatalog);
  if ((objc_opt_isKindOfClass(v4, v3) & 1) != 0) {
    char v10 = ([v12 isArtworkVisuallyIdenticalToCatalog:v11[0]] ^ 1) & 1;
  }
  if ((v10 & 1) != 0)
  {
    char v8 = 0;
    if (v12)
    {
      [a1[5] setObject:v12 forKeyedSubscript:location[0]];
    }

    else
    {
      id v9 = +[NSNull null](&OBJC_CLASS___NSNull, "null");
      char v8 = 1;
      [a1[5] setObject:v9 forKeyedSubscript:location[0]];
    }
...
void sub_1000353F4(uint64_t a1)
{
  ...
  if (v10)
  {
    ...
    while (1)
    {
      ...
      uint64_t v15 = *(void *)(__b[1] + 8 * v6);
      id v3 = [*(id *)(a1 + 32) objectForKeyedSubscript:v15];
      uint64_t v1 = objc_opt_class(&OBJC_CLASS___NSNull);
      char v11 = 0;
      if ((objc_opt_isKindOfClass(v3, v1) & 1) != 0)
      {
        id v2 = 0LL;
      }
      ...
      [*(id *)(a1 + 40) replaceMediaItemMetadata:v13 forProperty:v15];
      objc_storeStrong(&v13, 0LL);
      ++v6;
...
void sub_100035C48(id *a1, void *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  v34[1] = a1;
  v34[0] = objc_loadWeakRetained(a1 + 4);
  if (v34[0])
  {
    id v33 = [v34[0] view];
    id v32 = [v34[0] mediaRemoteObserver];
    [v32 prepareForPlaybackWithEndpoint:location[0]];
    id v10 = objc_alloc(&OBJC_CLASS___TVPMusicNowPlayingViewController);
    id v11 = [v32 player];
    uint64_t v31 = -[TVPMusicNowPlayingViewController initWithPlayer:](v10, "initWithPlayer:");

    -[TVPMusicNowPlayingViewController setSingleCoverOnly:](v31, "setSingleCoverOnly:", 1LL);
    -[TVPMusicNowPlayingViewController setEndpointRoute:](v31, "setEndpointRoute:", location[0]);
    [v34[0] setMusicViewController:v31];
    [v34[0] addChildViewController:v31];
    id v30 = -[TVPMusicNowPlayingViewController view](v31, "view");
    id v29 = +[TVSUIWallpaper wallpaperViewForVariant:](&OBJC_CLASS___TVSUIWallpaper, "wallpaperViewForVariant:", 1LL);
    [v34[0] setNowPlayingWallPaper:v29];
    id v12 = v30;
    [v33 frame];
    v28[5] = v2;
    v28[6] = v3;
    v28[7] = v4;
    v28[8] = v5;
    objc_msgSend(v12, "setFrame:", *(double *)&v2, *(double *)&v3, *(double *)&v4, *(double *)&v5);
    objc_msgSend(v30, "setAlpha:");
    id v13 = v29;
    [v33 frame];
    v28[1] = v6;
    v28[2] = v7;
    v28[3] = v8;
    v28[4] = v9;
    objc_msgSend(v13, "setFrame:", *(double *)&v6, *(double *)&v7, *(double *)&v8, *(double *)&v9);
    [v29 setAlpha:0.0];
    [v33 addSubview:v29];
    [v33 addSubview:v30];
    ...
    int v23 = -1073741824;
    int v24 = 0;
    uint64_t v25 = sub_100036034;
    id v26 = &unk_100058D38;
    id v27 = v29;
    v28[0] = v30;
    uint64_t v15 = _NSConcreteStackBlock;
    int v16 = -1073741824;
    int v17 = 0;
    id v18 = sub_100036084;
    id v19 = &unk_100059690;
    id v20 = v31;
    id v21 = v34[0];
    +[UIView animateWithDuration:animations:completion:]( &OBJC_CLASS___UIView,  "animateWithDuration:animations:completion:",  &v22,  &v15,  0.3);
    objc_storeStrong(&v21, 0LL);
...
void sub_1000360C8(id *a1)
{
  ...
  int v2 = -1073741824;
  int v3 = 0;
  uint64_t v4 = sub_10003616C;
  uint64_t v5 = &unk_1000596E0;
  v6[0] = a1[4];
  +[MPAVRoutingController getActiveRouteWithCompletion:]( &OBJC_CLASS___MPAVRoutingController,  "getActiveRouteWithCompletion:");
  objc_storeStrong(v6, 0LL);
}

void sub_10003616C(void *a1, void *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
{
  id v2 = [*(id *)(a1 + 32) mediaRemoteObserver];
  [v2 reset];

  [*(id *)(*(void *)(a1 + 32) + 8) removeFromParentViewController];
  objc_storeStrong((id *)(*(void *)(a1 + 32) + 8LL), 0LL);
  uint64_t result = a1;
  if (*(void *)(a1 + 48)) {
...
void sub_100037BBC(id *a1, void *a2, void *a3)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
id sub_100037FF8()
{
  qword_10006B080 = (uint64_t)objc_getClass("BTShareAudioViewController");
  off_10006AF18 = (uint64_t (*)())sub_1000380AC;
  return (id)qword_10006B080;
}

uint64_t sub_100038034()
{
  predicate = (dispatch_once_t *)&unk_10006B088;
  dispatch_block_t block = 0LL;
  objc_storeStrong(&block, &stru_100059750);
  if (*predicate != -1) {
    dispatch_once(predicate, block);
  }
  objc_storeStrong(&block, 0LL);
  return qword_10006B090;
}
...
void sub_1000380B8(id a1)
{
  qword_10006B090 = (uint64_t)dlopen( "/System/Library/PrivateFrameworks/BluetoothServicesUI.framework/BluetoothServicesUI",  2);
}

void sub_100038284(id a1)
{
  os_log_t v1 = os_log_create("com.apple.TVNowPlayingService.TVNPEndpointRouteConnection", "");
  id v2 = (void *)qword_10006B0A0;
...
void sub_100038CD0(uint64_t a1, uint64_t a2)
{
  ...
  uint64_t v11 = a2;
  oslog[1] = (os_log_t)a1;
  oslog[0] = (os_log_t)(id)qword_10006B0A0;
  ...
  if (os_log_type_enabled(oslog[0], OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v8 = v6;
    sub_100038E30((uint64_t)v13, v2, v3, (uint64_t)v8, v11);
...
uint64_t sub_100038E30(uint64_t result, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
...
void sub_10003B0C0(id *a1, void *a2, void *a3)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
...
void sub_10003B22C(uint64_t a1)
{
  id v14[2] = (id)a1;
  v14[1] = (id)a1;
...
id sub_10003B688(uint64_t *a1)
{
  ...
  if (os_log_type_enabled(oslog[0], OS_LOG_TYPE_DEFAULT))
  {
    sub_100007A94((uint64_t)v4, a1[4]);
...
uint64_t sub_10003BB2C(uint64_t result, uint64_t a2, uint64_t a3, int a4)
{
  *(_BYTE *)uint64_t result = 2;
  *(_BYTE *)(result + 1) = 3;
  *(_BYTE *)(result + 2) = 66;
...
void sub_10003BB98(id *a1, void *a2)
{
  location[1] = a1;
  location[0] = 0LL;
  objc_storeStrong(location, a2);
  ...
  int v5 = -1073741824;
  int v6 = 0;
  int v7 = sub_10003BC8C;
  int v8 = &unk_1000589F0;
...
void sub_10003BC8C(uint64_t a1)
{
  ...
  if (v8[0])
  {
    ...
    if (os_log_type_enabled((os_log_t)v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v3 = [v8[0] route];
      id v5 = v3;
      sub_10000EEA8((uint64_t)v9, (uint64_t)v5, *(void *)(a1 + 32));
