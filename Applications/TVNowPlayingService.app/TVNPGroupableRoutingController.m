...
- (TVNPGroupableRoutingController)initWithOutputContextUID:(id)a3 allowsRetargeting:(BOOL)a4 initalFetchCompletion:(id)a5
{
  ...
  if (obj)
  {
    v75 = (dispatch_once_t *)&unk_10006AFB0;
    id v74 = 0LL;
    objc_storeStrong(&v74, &stru_100058EC0);
    if (*v75 != -1) {
    ...
    *((void *)v73 + 14) = v8;
    ...
    [*((id *)v73 + 14) addObserver:v73 forKeyPath:@"volumeControlTargetDeviceType" options:4 context:off_10006A8D8];
    ...
    *((void *)v73 + 22) = v16;
    ...
    [*((id *)v73 + 19) addObserver:v73 forKeyPath:@"localAccessory" options:4 context:off_10006A8E0];
    ...
    *((void *)v73 + 12) = v33;
    ...
    if ((v32 & 1) == 0)
    {
      id v63 = (id)qword_10006AFB8;
      os_log_type_t v62 = OS_LOG_TYPE_ERROR;
      if (os_log_type_enabled((os_log_t)v63, OS_LOG_TYPE_ERROR))
      {
        sub_100007A94((uint64_t)v76, (uint64_t)v66);
        _os_log_error_impl( (void *)&_mh_execute_header,  (os_log_t)v63,  v62,  "Failed to select playback category on auxiliary context. %{public}@",  v76,  0xCu);
      }
...
- (void)dealloc
{
  objc_super v4 = self;
  SEL v3 = a2;
  -[TVCSHomeManager removeObserver:forKeyPath:context:]( self->_homeManager,  "removeObserver:forKeyPath:context:",  self,  @"localAccessory",  off_10006A8E0);
  -[PBSMediaRemoteServiceInterface removeObserver:forKeyPath:context:]( v4->_pbsMediaRemoteProxy,  "removeObserver:forKeyPath:context:",  v4,  @"volumeControlTargetDeviceType",  off_10006A8D8);
  v2.receiver = v4;
...
- (void)setCurrentDestination:(id)a3
{
  ...
  if (v14->_currentDestination != location[0])
  {
    ...
    {
      sub_100008A8C((uint64_t)v15, (uint64_t)v12);
      _os_log_impl( (void *)&_mh_execute_header,  oslog,  OS_LOG_TYPE_DEFAULT,  "Setting current destination to %@",  v15,  0xCu);
    }
...
- (void)pickRoutes:(id)a3 forDestination:(id)a4
{
  ...
  if (v47)
  {
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass(v40, v4) & 1) != 0)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(oslog, OS_LOG_TYPE_ERROR))
          {
            ...
            sub_100008A8C((uint64_t)v104, (uint64_t)v83);
            _os_log_error_impl( (void *)&_mh_execute_header,  log,  v36,  "TVNPOutputDeviceRoute picked with no MPAVOutputDeviceRoute %@",  v104,  0xCu);
          }
      ...
      {
        os_log_t v80 = (os_log_t)(id)qword_10006AFB8;
        os_log_type_t v79 = OS_LOG_TYPE_FAULT;
        if (os_log_type_enabled(v80, OS_LOG_TYPE_FAULT))
        {
          v34 = v80;
          sub_100008A8C((uint64_t)v103, (uint64_t)v85);
          _os_log_fault_impl((void *)&_mh_execute_header, v34, v79, "Unexpected route in pickRoutes: %@", v103, 0xCu);
        }
  ...
  int v65 = -1073741824;
  int v66 = 0;
  id v67 = sub_10000ED6C;
  id v68 = &unk_100058F10;
  id v69 = v77;
  ...
  os_log_t v58 = (os_log_t)(id)qword_10006AFB8;
  os_log_type_t v57 = OS_LOG_TYPE_DEFAULT;
  if (os_log_type_enabled(v58, OS_LOG_TYPE_DEFAULT))
  {
    sub_10000EE38((uint64_t)v100, v91 & 1, v92, v70, v63);
    _os_log_impl( (void *)&_mh_execute_header,  v58,  v57,  "ShouldUseGrouping: %d CanUseGrouping: %d RouteIsInRoom: %d AlwaysPickRatherThanAdd: %d",  v100,  0x1Au);
  }

  objc_storeStrong((id *)&v58, 0LL);
  if (([v78 supportsGrouping] & 1) != 0 && v92 && (v91 & 1) != 0 && !v63)
  {
    os_log_t v56 = (os_log_t)(id)qword_10006AFB8;
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v54 = v12;
      sub_10000EEA8((uint64_t)v99, (uint64_t)v9, (uint64_t)v54);
      _os_log_impl( (void *)&_mh_execute_header,  v10,  v11,  "Add Picked Route: %{public}@ to Endpoint: %{public}@",  v99,  0x16u);

      objc_storeStrong(&v54, 0LL);
    }

    objc_storeStrong((id *)&v56, 0LL);
    -[MPAVRoutingController selectRoutes:operation:completion:]( v97->_outputDeviceRoutingController,  "selectRoutes:operation:completion:",  v86,  1LL,  &stru_100058F50);
  }

  else
  {
    os_log_t v53 = (os_log_t)(id)qword_10006AFB8;
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v51 = v8;
      sub_10000EEA8((uint64_t)v98, (uint64_t)v5, (uint64_t)v51);
      _os_log_impl( (void *)&_mh_execute_header,  v6,  v7,  "Set Picked Route: %{public}@ for Endpoint: %{public}@",  v98,  0x16u);

      objc_storeStrong(&v51, 0LL);
    }

    objc_storeStrong((id *)&v53, 0LL);
    -[MPAVRoutingController selectRoutes:operation:completion:]( v97->_outputDeviceRoutingController,  "selectRoutes:operation:completion:",  v86,  0LL,  &stru_100058F70);
  }
...
- (void)unpickRoutes:(id)a3 forDestination:(id)a4
{
    ...
    && (v18 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v10 = v6;
      sub_10000EEA8((uint64_t)v24, (uint64_t)v14, (uint64_t)v10);
      _os_log_impl( (void *)&_mh_execute_header,  log,  v5,  "Remove Picked Route: %{public}@ from Endpoint: %{public}@",  v24,  0x16u);

      objc_storeStrong(&v10, 0LL);
    }

    objc_storeStrong((id *)&oslog, 0LL);
    -[MPAVRoutingController selectRoutes:operation:completion:]( v23->_outputDeviceRoutingController,  "selectRoutes:operation:completion:",  v14,  2LL,  &stru_100058F90);
  }
...
- (void)selectOdeonDestination:(id)a3
{
  ...
  if ((_os_feature_enabled_impl("Home", "cce7c4ecef404121ae8971") & 1) != 0)
  {
    ...
    if (!v12)
    {
      ...
      int v14 = -1073741824;
      int v15 = 0;
      char v16 = sub_10000F7FC;
      id v17 = &unk_100058FB8;
      char v18 = v24;
      id v19 = location[0];
...
- (void)targetDestination:(id)a3
{
  ...
  if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
  {
    sub_100007A94((uint64_t)v11, (uint64_t)v9);
    _os_log_impl((void *)&_mh_execute_header, oslog, OS_LOG_TYPE_DEFAULT, "Retarget to Endpoint: %{public}@", v11, 0xCu);
  }
...
- (BOOL)isLocalRouteAVR
{
  return -[PBSMediaRemoteServiceInterface volumeControlTargetDeviceType]( self->_pbsMediaRemoteProxy,  "volumeControlTargetDeviceType",  a2,  self) == (id)2;
}
...
- (void)_updateAvailableRoutes
{
  ...
  int v25 = 838860800;
  int v26 = 48;
  id v27 = sub_1000102C0;
  uint64_t v28 = sub_100010314;
  id v29 = 0LL;
  dispatch_group_enter(v36);
  ...
  int v14 = -1073741824;
  int v15 = 0;
  char v16 = sub_100010340;
  id v17 = &unk_100059030;
  char v18 = v23;
  v20[1] = v30;
...
- (void)_updateWithAvailableEndpoints:(id)a3 outputDevices:(id)a4
{
  ...
  if (![v268 count] || objc_msgSend(location[0], "count"))
  {
    ...
    if (v136)
    {
      ...
      while (1)
      {
        ...
        if (!v261)
        {
          ...
          {
            id v259 = (id)qword_10006AFB8;
            os_log_type_t type = OS_LOG_TYPE_ERROR;
            if (os_log_type_enabled((os_log_t)v259, OS_LOG_TYPE_ERROR))
            {
              log = (os_log_s *)v259;
              os_log_type_t v124 = type;
              sub_100013B40((uint64_t)v290, (uint64_t)v263, (uint64_t)v263);
              _os_log_error_impl( (void *)&_mh_execute_header,  log,  v124,  "Can't create destination, no MRAVEndpointRef. {endpointRoute_ptr=%p, endpointRoute=%{public}@}",  v290,  0x16u);
            }
        ...
        {
          id v257 = (id)qword_10006AFB8;
          os_log_type_t v256 = OS_LOG_TYPE_ERROR;
          if (os_log_type_enabled((os_log_t)v257, OS_LOG_TYPE_ERROR))
          {
            v122 = (os_log_s *)v257;
            sub_100013B40((uint64_t)v289, (uint64_t)v263, (uint64_t)v263);
            _os_log_error_impl( (void *)&_mh_execute_header,  v122,  v256,  "No destination for endpoint route. {endpointRoute_ptr=%p, endpointRoute=%{public}@}",  v289,  0x16u);
          }
    ...
    if (([v243 isLocal] & 1) == 0)
    {
      ...
      char v240 = 1;
      BOOL v105 = -[PBSAirPlaySettings securityType](v241, "securityType") == (id)1;
    }
...
LABEL_81:
            ...
            if ([v238 containsObject:v228])
            {
              ...
              {
                if ([v225 selectionState] == (id)2) {
                  uint64_t v206 = 3LL;
                }
                else {
                  uint64_t v206 = (uint64_t)[v225 selectionState];
                }
              }
            ...
            if ([v228 routeSubtype] == (id)10)
            {
              v205 = 0LL;
              if ([v220 isCurrentDestination])
              {
                if (-[PBSMediaRemoteServiceInterface volumeControlTargetDeviceType]( v270->_pbsMediaRemoteProxy,  "volumeControlTargetDeviceType") == (id)2)
                {
          ...
          else
          {
            ...
            if ((v81 & 1) == 0)
            {
              ...
              if (os_log_type_enabled((os_log_t)v202, OS_LOG_TYPE_ERROR))
              {
                ...
                sub_100013C4C((uint64_t)v285, (uint64_t)v226, (uint64_t)v228, (uint64_t)v228);
                _os_log_error_impl( (void *)&_mh_execute_header,  v79,  v201,  "No route for output device. {routeUID=%{public}@, outputDevice_ptr=%p, outputDevice=%{public}@}",  v285,  0x20u);
              }
    ...
    id v181 =  +[NSSortDescriptor sortDescriptorWithKey:ascending:comparator:]( &OBJC_CLASS___NSSortDescriptor,  "sortDescriptorWithKey:ascending:comparator:",  0LL,  1LL,  &stru_1000590E8);
    ...
    char v171 = v46 & 1;
    id v170 = (id)qword_10006AFB8;
    os_log_type_t v169 = OS_LOG_TYPE_INFO;
    if (os_log_type_enabled((os_log_t)v170, OS_LOG_TYPE_INFO))
    {
      sub_100014128( (uint64_t)v279,  v171 & 1,  v270->_multipleSelectionEnabled,  v173,  v174 & 1,  v172,  (uint64_t)v175,  (uint64_t)v175);
      _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v170,  v169,  "Should show routes. {shouldShowRoutes=%{BOOL}d, multipleSelectionEnabled=%{BOOL}d, controllerCanGroup=%{BOOL}d, canModifyGroupMembership=%{BOOL}d, currentDestinationIsLocalDestination=%{BOOL}d, endpointRoute_ptr=%p, endpoint Route=%{public}@}",  v279,  0x34u);
    }
    ...
    id v166 = (id)qword_10006AFB8;
    os_log_type_t v165 = OS_LOG_TYPE_DEFAULT;
    if (os_log_type_enabled((os_log_t)v166, OS_LOG_TYPE_DEFAULT))
    {
      sub_100008A8C((uint64_t)v278, (uint64_t)v167);
      _os_log_impl((void *)&_mh_execute_header, (os_log_t)v166, v165, "System output route: %@", v278, 0xCu);
    }

    objc_storeStrong(&v166, 0LL);
    id v164 = (id)qword_10006AFB8;
    ...
    if (os_log_type_enabled((os_log_t)v164, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v162 = v44;
      sub_100007A94((uint64_t)v277, (uint64_t)v162);
      _os_log_impl( (void *)&_mh_execute_header,  v42,  v43,  "Available endpoints from MediaRemote [%{public}@]",  v277,  0xCu);

      objc_storeStrong(&v162, 0LL);
    }

    objc_storeStrong(&v164, 0LL);
    id v161 = (id)qword_10006AFB8;
    ...
    if (os_log_type_enabled((os_log_t)v161, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v159 = v41;
      sub_100007A94((uint64_t)v276, (uint64_t)v159);
      _os_log_impl( (void *)&_mh_execute_header,  v39,  v40,  "Available endpoints after filtering [%{public}@]",  v276,  0xCu);

      objc_storeStrong(&v159, 0LL);
    }

    objc_storeStrong(&v161, 0LL);
    id v158 = (id)qword_10006AFB8;
    ...
    if (os_log_type_enabled((os_log_t)v158, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v156 = v38;
      sub_100007A94((uint64_t)v275, (uint64_t)v156);
      _os_log_impl( (void *)&_mh_execute_header,  v36,  v37,  "Available output routes from MediaRemote [%{public}@]",  v275,  0xCu);

      objc_storeStrong(&v156, 0LL);
    }

    objc_storeStrong(&v158, 0LL);
    id v155 = (id)qword_10006AFB8;
    ...
    if (os_log_type_enabled((os_log_t)v155, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v153 = v35;
      sub_100007A94((uint64_t)v274, (uint64_t)v153);
      _os_log_impl( (void *)&_mh_execute_header,  v33,  v34,  "Available output routes after filtering [%{public}@]",  v274,  0xCu);
    ...
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
    {
      sub_1000141E4( (uint64_t)v272,  (uint64_t)v142,  v141,  (uint64_t)v140,  v139,  v171 & 1,  v270->_allowsDestinationSelection,  (uint64_t)v175,  (uint64_t)v175);
      _os_log_impl( (void *)&_mh_execute_header,  oslog,  OS_LOG_TYPE_DEFAULT,  "Update Routing DataSource. {availableDestinations_input=%ld, availableDestinations_output=%ld, availableRoutes_i nput=%ld, availableRoutes_output=%ld, shouldShowRoutes=%{BOOL}d, allowsDestinationSelection=%{BOOL}d, endpointRo ute_ptr=%p, endpointRoute=%{public}@}",  v272,  0x4Au);
    }
...
- (void)_updateWithAvailableMediaDestinations:(id)a3
{
  ...
  if (!v99)
  {
    ...
    [v99 setLocal:1];
    [v99 setAvailable:1];
    if (-[PBSMediaRemoteServiceInterface volumeControlTargetDeviceType]( v105->_pbsMediaRemoteProxy,  "volumeControlTargetDeviceType") == (id)2)
    {
  ...
  if (v97)
  {
    ...
    if (!v96)
    {
      ...
      id v63 = [v62 unsignedIntegerValue];
  ...
  if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v74 = v19;
    sub_100007A94((uint64_t)v107, (uint64_t)v74);
    _os_log_impl( (void *)&_mh_execute_header,  log,  v18,  "Available Odeon destinations from HomeKit [%{public}@]",  v107,  0xCu);

    objc_storeStrong(&v74, 0LL);
  }

  objc_storeStrong((id *)&oslog, 0LL);
  os_log_t v73 = (os_log_t)(id)qword_10006AFB8;
  ...
  if (os_log_type_enabled(v73, OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v71 = v16;
    sub_100007A94((uint64_t)v106, (uint64_t)v71);
    _os_log_impl( (void *)&_mh_execute_header,  v14,  v15,  "Available Odeon destinations after filtering [%{public}@]",  v106,  0xCu);
  ...
  if (a6 == off_10006A8E0)
  {
    if ((_os_feature_enabled_impl("Home", "cce7c4ecef404121ae8971") & 1) != 0)
    {
      ...
      if (v30->_homeDestinationController != v25)
      {
        ...
        id v24 = (id)qword_10006AFB8;
        os_log_type_t v23 = OS_LOG_TYPE_DEFAULT;
        if (os_log_type_enabled((os_log_t)v24, OS_LOG_TYPE_DEFAULT))
        {
          sub_100008A8C((uint64_t)v32, (uint64_t)v25);
          _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v24,  v23,  "Updating Odeon destinations with destination controller %@",  v32,  0xCu);
        }
      ...
      if ((v12 & 1) == 0)
      {
        id v21 = (id)qword_10006AFB8;
        os_log_type_t v20 = OS_LOG_TYPE_DEFAULT;
        if (os_log_type_enabled((os_log_t)v21, OS_LOG_TYPE_DEFAULT))
        {
          sub_100008A8C((uint64_t)v31, (uint64_t)v22);
          _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v21,  v20,  "HMMediaDestinationController did update destination %@",  v31,  0xCu);
        }
...
- (void)accessoryDidUpdateControllable:(id)a3
{
  ...
  if (os_log_type_enabled((os_log_t)v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    sub_10000967C((uint64_t)v11, (uint64_t)v6, (uint64_t)v3);
    _os_log_impl( (void *)&_mh_execute_header,  (os_log_t)v8,  OS_LOG_TYPE_DEFAULT,  "%@ did update isControllable: %@",  v11,  0x16u);
  }
