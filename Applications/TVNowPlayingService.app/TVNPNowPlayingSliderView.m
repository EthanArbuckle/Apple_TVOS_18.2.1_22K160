...
- (TVNPNowPlayingSliderView)initWithFrame:(CGRect)a3
{
  ...
  if (v42)
  {
    ...
    -[UITapGestureRecognizer setAllowedPressTypes:](v44, "setAllowedPressTypes:", &off_10005B4B0);
    ...
    -[UITapGestureRecognizer setAllowedPressTypes:](v43, "setAllowedPressTypes:", &off_10005B4C8);
...
- (void)layoutSubviews
{
  ...
  [location sizeToFit];
  if ((id)+[UIView userInterfaceLayoutDirectionForSemanticContentAttribute:]( &OBJC_CLASS___UIView,  "userInterfaceLayoutDirectionForSemanticContentAttribute:",  -[TVNPNowPlayingSliderView semanticContentAttribute](v32, "semanticContentAttribute")) == (id)1)
  {
  ...
  if (a3 != self->_value)
  {
    ...
    *(float *)&double v6 = v13;
    ...
    if (v16)
    {
      ...
      int v8 = -1073741824;
      int v9 = 0;
      double v10 = sub_100003154;
      double v11 = &unk_1000587D8;
      double v12 = v19;
...
- (id)_focusedProgressColor
{
  double v4 = (dispatch_once_t *)&unk_10006AF90;
  id location = 0LL;
  objc_storeStrong(&location, &stru_100058818);
  if (*v4 != -1) {
    dispatch_once(v4, location);
  }
  objc_storeStrong(&location, 0LL);
  return (id)qword_10006AF88;
}

- (id)_unfocusedProgressColor
{
  double v4 = (dispatch_once_t *)&unk_10006AFA0;
  id location = 0LL;
  objc_storeStrong(&location, &stru_100058838);
  if (*v4 != -1) {
    dispatch_once(v4, location);
  }
  objc_storeStrong(&location, 0LL);
  return (id)qword_10006AF98;
}
