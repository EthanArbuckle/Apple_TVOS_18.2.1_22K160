...
+ (void)_configureFloatingContentViewAppearance
{
  BOOL v3 = (dispatch_once_t *)&unk_10006B030;
  id location = 0LL;
  objc_storeStrong(&location, &stru_1000594A8);
  if (*v3 != -1) {
...
- (void)_configureAppearanceForControlState:(unint64_t)a3 withAnimationCoordinator:(id)a4
{
  ...
  id v27 = (dispatch_once_t *)&unk_10006B078;
  id v26 = 0LL;
  objc_storeStrong(&v26, &stru_1000594C8);
  if (*v27 != -1) {
  ...
  int v12 = -1073741824;
  int v13 = 0;
  id v14 = sub_1000338E4;
  id v15 = &unk_1000594F0;
  id v16 = v25;
  BOOL v17 = v20;
  BOOL v18 = v21;
  ...
  -[UILabel setMarqueeEnabled:](v25->_subtitleLabel, "setMarqueeEnabled:", v5, &selRef_currentMediaItemIsStreaming);
  [*(id *)((char *)&v25->super.super.super.super.super.isa + *(int *)(v4 + 2480)) setMarqueeRunning:v5];
