...
- (_TtC6Arcade22HttpTemplateController)init;
- (void)dealloc;
...
- (void).cxx_destruct
{
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.isa
                                     + OBJC_IVAR____TtC6Arcade22HttpTemplateController_textFields));
}
...
- (BOOL)textField:(id)a3 shouldChangeCharactersInRange:(_NSRange)a4 replacementString:(id)a5
{
  ...
  id v11 = a3;
  v12 = self;
  sub_10009A824(v11, location, length);
  LOBYTE(length) = v13;
...
- (void)textFieldDidChange:(id)a3
{
  ...
  if (*((_BYTE *)&self->super.isa + OBJC_IVAR____TtC6Arcade22HttpTemplateController_hasRequiredParameters) == 1)
  {
    uint64_t v9 = self;
    sub_10009A564();
  }
...
- (_TtC6Arcade22HttpTemplateController)init
{
  result = (_TtC6Arcade22HttpTemplateController *)_swift_stdlib_reportUnimplementedInitializer( "Arcade.HttpTemplateController",  29LL,  "init()",  6LL,  0LL);
  __break(1u);
  return result;
}
