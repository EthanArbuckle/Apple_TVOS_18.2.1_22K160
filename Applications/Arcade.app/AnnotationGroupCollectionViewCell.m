...
- (_TtC6Arcade33AnnotationGroupCollectionViewCell)initWithFrame:(CGRect)a3;
...
- (_TtC6Arcade33AnnotationGroupCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC6Arcade33AnnotationGroupCollectionViewCell *)sub_1001D6B10( a3.origin.x,  a3.origin.y,  a3.size.width,  a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  id v3 = *(id *)&v2[OBJC_IVAR____TtC6Arcade33AnnotationGroupCollectionViewCell_informationColumnView];
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC6Arcade33AnnotationGroupCollectionViewCell_informationColumnView));
}
