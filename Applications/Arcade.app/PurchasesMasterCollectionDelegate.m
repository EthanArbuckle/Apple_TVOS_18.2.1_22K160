...
- (_TtC6Arcade33PurchasesMasterCollectionDelegate)init;
...
- (void)collectionView:(id)a3 willDisplayCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  id v14 = a4;
  v15 = self;
  sub_10004846C(v14, (uint64_t)v12);
...
- (id)collectionView:(id)a3 viewForSupplementaryElementOfKind:(id)a4 atIndexPath:(id)a5
{
  ...
  id v16 = a3;
  uint64_t v17 = self;
  id v18 = sub_100048704(v16, v13, v15);
...
- (CGSize)collectionView:(id)a3 layout:(id)a4 referenceSizeForHeaderInSection:(int64_t)a5
{
  ...
  if (v11.value._object)
  {
    ...
    double v13 = v12;
    double v15 = v14;
    if (qword_1002DCF28 != -1) {
      swift_once(&qword_1002DCF28, sub_1001698B0);
    }
    uint64_t v16 = type metadata accessor for TitleHeaderView.Style(0LL);
    uint64_t v17 = sub_1000061F4(v16, (uint64_t)qword_1002F1180);
    sub_100204774( 0LL,  0LL,  0LL,  v11.value._countAndFlagsBits,  (char *)v11.value._object,  0LL,  0LL,  0LL,  v13,  v15,  0.0,  0.0,  0.0,  20.0,  0.0,  20.0,  1LL,  v17,  v8);
    double v19 = v18;
...
- (_TtC6Arcade33PurchasesMasterCollectionDelegate)init
{
  CGSize result = (_TtC6Arcade33PurchasesMasterCollectionDelegate *)_swift_stdlib_reportUnimplementedInitializer( "Arcade.PurchasesMasterCollectionDelegate",  40LL,  "init()",  6LL,  0LL);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  swift_release(*(Class *)((char *)&self->super.isa
                         + OBJC_IVAR____TtC6Arcade33PurchasesMasterCollectionDelegate_presenter));
  swift_release(*(Class *)((char *)&self->super.isa
                         + OBJC_IVAR____TtC6Arcade33PurchasesMasterCollectionDelegate_showDetailsWorkItem));
}
