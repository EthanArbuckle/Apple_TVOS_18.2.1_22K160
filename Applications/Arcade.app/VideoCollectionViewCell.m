...
- (_TtC6Arcade23VideoCollectionViewCell)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
...
- (_TtC6Arcade23VideoCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC6Arcade23VideoCollectionViewCell *)sub_1001D607C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  objc_super v3 = *(void **)&v2[OBJC_IVAR____TtC6Arcade23VideoCollectionViewCell_videoContainer];
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC6Arcade23VideoCollectionViewCell_videoContainer));
}
