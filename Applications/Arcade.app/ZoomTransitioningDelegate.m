...
- (_TtC6Arcade25ZoomTransitioningDelegate)init;
...
- (id)animationControllerForPresentedController:(id)a3 presentingController:(id)a4 sourceController:(id)a5
{
  ...
  v10[OBJC_IVAR____TtC6Arcade13ZoomAnimation_direction] = 0;
  v17.receiver = v10;
  v17.super_class = v9;
  id v11 = a3;
  id v12 = a4;
...
- (id)animationControllerForDismissedController:(id)a3
{
  ...
  v6[OBJC_IVAR____TtC6Arcade13ZoomAnimation_direction] = 1;
  v11.receiver = v6;
  v11.super_class = v5;
  id v7 = a3;
  v8 = self;
