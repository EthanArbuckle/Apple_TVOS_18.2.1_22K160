...
- (_TtC6Arcade23FocusableCollectionView)initWithCoder:(id)a3;
- (_TtC6Arcade23FocusableCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4;
@end
...
- (BOOL)canBecomeFocused
{
  return *((_BYTE *)&self->super.super.super.super.super.isa
         + OBJC_IVAR____TtC6Arcade23FocusableCollectionView_allowFocus);
}
...
- (_TtC6Arcade23FocusableCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4
{
  ...
  *((_BYTE *)&self->super.super.super.super.super.isa + OBJC_IVAR____TtC6Arcade23FocusableCollectionView_allowFocus) = 1;
  v12.receiver = self;
