...
- (_TtC6Arcade24ComingSoonViewController)initWithCoder:(id)a3;
- (_TtC6Arcade24ComingSoonViewController)initWithNibName:(id)a3 bundle:(id)a4;
- (void)loadView;
@end
...
- (void)loadView
{
  ...
  else
  {
    ...
    sub_10010B5F8(0.0, 0.0, 0.0, 0.0, v5._countAndFlagsBits, (uint64_t)v5._object);
    v8 = v7;
    *((_BYTE *)&v7->super.super.super.isa + OBJC_IVAR____TtC6Arcade22ContentUnavailableView__canBecomeFocused) = 1;
