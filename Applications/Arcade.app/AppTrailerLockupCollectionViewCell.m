...
- (_TtC6Arcade34AppTrailerLockupCollectionViewCell)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
...
- (_TtC6Arcade34AppTrailerLockupCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.super.super.isa
           + OBJC_IVAR____TtC6Arcade34AppTrailerLockupCollectionViewCell_avatarShowcase) = 0LL;
  v10.receiver = self;
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC6Arcade34AppTrailerLockupCollectionViewCell_avatarShowcase));
}
